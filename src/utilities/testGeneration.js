...
(function () {
    ...
    Test.prototype = {
        ...
        toString: function () {
            ...
            for (var j = 0; j < constantVars.length; j++) {
                ...
                var constantString = typeof constant === "string" ? "\"" + constant + "\"" : constant;
            ...
            // assertion functions
            result += "function assertEqual(actual, expected) {\n  if (actual !== expected) {\n    throw 'Expected ' + expected + ' but found '+ actual;\n  }\n}\n";
    ...
    Call.prototype = {
        ...
        toString: function () {
            ...
            return this.retVar + " = " + this.baseVar + "." + this.filter + "(" + this.argVars.join() + ");";
        ...
        clone: function () {
            return new Call(this.fct, this.baseVar, this.argVars, this.retVar, this.filter);
        }
    };
    ...
    EqualityAssertion.isSupportedValue = function (val) {
        var type = typeof val;
        return val === val && (type === "number" || type === "boolean" || type === "string" ||
    ...
    EqualityAssertion.prototype = {
        execute: function (varStore) {
            ...
            if (actualVal !== this.expectedValue) throw "Expected " + this.expectedValue + " but found " + actualVal;
        },
        toString: function () {
            var type = typeof this.expectedValue;
            var expectedValueString;
            if (type === "number" || type === "boolean" || this.expectedValue === undefined || this.expectedValue === null) {
    ...
    function Random(seed) {
        ...
        if (typeof window === "undefined") seedrandom(seed, {
            global: "true"
        });
    ...
    function Decisions() {
        ...
        this.constantTypes = ["number", "number", "number", "string", "string", "string", "undefined", "null", "boolean", "boolean", "Array", "Object", "Array", "Object"];
        ...
        pickFunction: function (apiObject) {
            ...
            for (var i = 0; i < keys.length; i++) {
                ...
                if (typeof val === "function" &&
                    (apiObject.filter === undefined || apiObject.filter.indexOf(key) !== -1)) {
                    fcts.push(val);
                }
                /**
                ...
                if (key === filterSegements[0] && filterSegements.length > 1) {
                    ...
                    if (constructedMultiSegmentValue && typeof constructedMultiSegmentValue === 'function') {
    ...
    AppendAPICallTask.prototype.createCandidate = function () {
        ...
        var call = new Call(fct, apiObject.name, argVars, retVar, apiObject.filter[0]);
        ...
        for (var nbTests = 0; nbTests < maxNbTests; nbTests++) {
            ...
            for (var nbCalls = 0; nbCalls < maxNbCallsPerTest; nbCalls++) {
                ...
                if (EqualityAssertion.isSupportedValue(newCallsRetVal)) {
                    test.statements.push(new EqualityAssertion(newCallsRetVar, newCallsRetVal));
                }
            }
            if (test) {
                tests.push(test);
    ...
    if (0) {
        ...
        var myAPI2 = new APIObject("myAPI2", {
            bar: 23,
