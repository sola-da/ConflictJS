...
(function () {
    ...
    function allLibraries() {
        ...
        for (var i = 0; i < benchmarks.length; i++) {
            ...
            var rawLibraryInfo = fs.readFileSync(benchmarkDir + "/libraryInfo.json", {encoding: "utf8"});
    ...
    function libraryByName(name) {
        var rawLibraryInfo = fs.readFileSync(benchmarkBaseDir + "/" + name + "/libraryInfo.json", {encoding: "utf8"});
        var libraryInfo = JSON.parse(rawLibraryInfo);
