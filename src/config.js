...
(function () {
  ...
  exports.waitingTime = 30000; // Time to wait before killing the experiment
  ...
  exports.browserPath = "/Applications/Chromium.app/Contents/MacOS/Chromium";

  // The result file
  let currentDir = process.cwd();
  let resultDir = "results";

  if (!pathExists(currentDir + "/" + resultDir))
    fs.mkdirSync(currentDir + "/" + resultDir);
  exports.validatedProblematicLibrariesFile =
    currentDir + "/" + resultDir + "/validated-conflicts.json";
  exports.singleLibCrashingFile =
    currentDir + "/" + resultDir + "/filtered-InclusionCrash.json";
