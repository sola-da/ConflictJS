...
(function () {
  ...
  function za(a, b, c) {
    if (a && b && c) {
      ...
      if ("undefined" !== typeof Blob && new Blob()) {
        for (
          var g = a.replace(/^data:[a-z/]*;base64,/, ""),
            g = atob(g),
  ...
  function w(a, b, c) {
    ...
    (this._container =
      ...
      ? ((this._container.innerHTML = ""),
        (b = a = 0),
        (a = this._options.width
          ? this.width
          : 0 < this._container.clientWidth
          ? this._container.clientWidth
          : this.width),
        (b = this._options.height
          ? this.height
        ...
        (this._selectedColorSet =
          "undefined" !== typeof W[this.colorSet]
            ? W[this.colorSet]
            : W.colorSet1),
  ...
  function x(a, b, c, d) {
    ...
    "axisX" === c
      ? ((this.sessionVariables = this.chart.sessionVariables[c]),
    ...
    90 < this.labelAngle && 270 >= this.labelAngle
      ? (this.labelAngle -= 180)
      : 180 < this.labelAngle && 270 >= this.labelAngle
      ? (this.labelAngle -= 180)
      : 270 < this.labelAngle &&
        360 >= this.labelAngle &&
        (this.labelAngle -= 360);
    if (this._options.stripLines && 0 < this._options.stripLines.length)
      for (
        this.stripLines = [], b = 0;
        b < this._options.stripLines.length;
        b++
      )
        this.stripLines.push(
          new la(
            this.chart,
            this._options.stripLines[b],
            a.theme,
  ...
  var t = !!document.createElement("canvas").getContext,
    ...
    W = {
      ...
      colorSet2:
        "#4F81BC #C0504E #9BBB58 #23BFAA #8064A1 #4AACC5 #F79647 #33558B".split(
          " "
        ),
      colorSet3:
        ...
        return (l = p.replace(a, function (a) {
          switch (a) {
            ...
            case "K":
              return r
                ? "UTC"
                : (String(k).match(f) || [""]).pop().replace(g, "");
            case "z":
  ...
  F.prototype.updateOption = function (a) {
    ...
    a in b &&
      (e = a in this._options ? this._options[a] : d && a in d ? d[a] : b[a]);
  ...
  F.prototype.addEventListener = function (a, b, c) {
    a &&
      ...
      this._eventListeners[a].push({ context: c || this, eventHandler: b }));
  };
        ...
        this._resetButton ||
          ...
          E(this._resetButton, "click", function () {
            ...
            a.sessionVariables.axisX.internalMinimum =
              a._options.axisX && a._options.axisX.minimum
                ? a._options.axisX.minimum
                : null;
        ...
        this.zoomEnabled ||
          ...
          (this._zoomButton
            ? (a._zoomButton.getAttribute("state") === a._cultureInfo.zoomText
              ...
              pa(a._zoomButton, a._resetButton))
            : ((this.zoomEnabled = !0), (this.panEnabled = !1))))
      : (this.panEnabled = this.zoomEnabled = !1);
    "undefined" !== typeof this._options.exportFileName &&
      (this.exportFileName = this._options.exportFileName);
    "undefined" !== typeof this._options.exportEnabled &&
    ...
    this._options.height
      ...
      : (this.height = b =
          0 < this._container.clientHeight
            ? this._container.clientHeight
            : this.height);
    return this.canvas.width !== a * J || this.canvas.height !== b * J
      ? (ga(this.canvas, a, b),
        ga(this.overlaidCanvas, a, b),
        ga(this._eventManager.ghostCanvas, a, b),
        !0)
      : !1;
  };
  ...
  w.prototype.render = function (a) {
    ...
    this._processData();
    this._options.title &&
      ((this._title = new ca(this, this._options.title)),
    ...
    for (a = 0; a < this.plotInfo.plotTypes.length; a++)
      for (b = this.plotInfo.plotTypes[a], c = 0; c < b.plotUnits.length; c++) {
        ...
        f.targetCanvas = null;
        this.animatedRender &&
          ((f.targetCanvas = V(this.width, this.height)),
    ...
    this.animatedRender &&
      ...
      ((a = V(this.width, this.height).getContext("2d")),
        ...
        p._animator.animate(
          ...
          function (a) {
            ...
            p.ctx.drawImage(
              ...
              0,
              0,
              Math.floor(p.width * J),
              Math.floor(p.height * J),
              0,
              0,
              p.width,
              p.height
          ...
          function () {
            ...
            for (var a = 0; a < p.plotInfo.plotTypes.length; a++)
              for (
                var c = p.plotInfo.plotTypes[a], b = 0;
                b < c.plotUnits.length;
                b++
              )
    ...
    this.zoomEnabled ||
      ...
      T(this._zoomButton, this._resetButton);
  ...
  w.prototype.categoriseDataSeries = function () {
    for (var a = "", b = 0; b < this.data.length; b++)
      if (
        ...
        a.dataPoints &&
          ...
          a.visible &&
          0 <= w._supportedChartTypes.indexOf(a.type))
      ) {
        for (
          var c = null, d = !1, e = null, f = !1, g = 0;
          g < this.plotInfo.plotTypes.length;
          g++
        )
    ...
    for (b = 0; b < this.plotInfo.plotTypes.length; b++)
      for (
        c = this.plotInfo.plotTypes[b], g = a = 0;
        g < c.plotUnits.length;
        g++
      )
  ...
  w.prototype._processData = function () {
    ...
    for (var a = 0; a < this.plotInfo.plotTypes.length; a++)
      for (
        var b = this.plotInfo.plotTypes[a], c = 0;
        c < b.plotUnits.length;
        c++
      ) {
        var d = b.plotUnits[c];
        "line" === d.type ||
        ...
        "scatter" === d.type
          ...
          : ("candlestick" !== d.type &&
            ...
            this._processMultiYPlotUnit(d);
      }
  };
  w.prototype._processMultiseriesPlotUnit = function (a) {
    if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
      for (
        var b = a.axisY.dataInfo, c = a.axisX.dataInfo, d, e, f = !1, g = 0;
        ...
        if ("normal" === k.axisPlacement || "xySwapped" === k.axisPlacement)
          var n = this.sessionVariables.axisX.internalMinimum
        ...
        for (p = 0; p < k.dataPoints.length; p++) {
          ...
          k.dataPoints[p].x.getTime
            ? ((f = !0), (d = k.dataPoints[p].x.getTime()))
            : (d = k.dataPoints[p].x);
          e = k.dataPoints[p].y;
          d < c.min && (c.min = d);
          d > c.max && (c.max = d);
          ...
          if (!(d < n) || l) {
            ...
            k.dataPoints[p].label &&
              (a.axisX.labels[d] = k.dataPoints[p].label);
            d < c.viewPortMin && (c.viewPortMin = d);
            d > c.viewPortMax && (c.viewPortMax = d);
            null !== e &&
              (e < b.viewPortMin && (b.viewPortMin = e),
    ...
    if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
      for (
        ...
        if ("normal" === l.axisPlacement || "xySwapped" === l.axisPlacement)
          var q = this.sessionVariables.axisX.internalMinimum
              ...
              ? this._options.axisX.minimum
              : -Infinity,
            r = this.sessionVariables.axisX.internalMaximum
              ? this.sessionVariables.axisX.internalMaximum
              : this._options.axisX && this._options.axisX.maximum
              ? this._options.axisX.maximum
              : Infinity;
        ...
        for (h = 0; h < l.dataPoints.length; h++) {
          ...
          l.dataPoints[h].x.getTime
            ? ((f = !0), (d = l.dataPoints[h].x.getTime()))
            : (d = l.dataPoints[h].x);
          e = l.dataPoints[h].y;
          d < c.min && (c.min = d);
          d > c.max && (c.max = d);
          ...
          if (!(d < q) || n) {
            ...
            l.dataPoints[h].label &&
              (a.axisX.labels[d] = l.dataPoints[h].label);
            d < c.viewPortMin && (c.viewPortMin = d);
            d > c.viewPortMax && (c.viewPortMax = d);
            null !== e &&
              ((a.yTotals[d] = (a.yTotals[d] ? a.yTotals[d] : 0) + Math.abs(e)),
              0 <= e
                ? (g[d] = g[d] ? g[d] + e : e)
                : (k[d] = k[d] ? k[d] + e : e));
          }
      ...
      for (h in g)
        isNaN(h) ||
          ...
          h < c.viewPortMin ||
            h > c.viewPortMax ||
            (a < b.viewPortMin && (b.viewPortMin = a),
      ...
      for (
        ...
        if ("normal" === h.axisPlacement || "xySwapped" === h.axisPlacement)
          var r = this.sessionVariables.axisX.internalMinimum
              ...
              ? this._options.axisX.minimum
              : -Infinity,
            s = this.sessionVariables.axisX.internalMaximum
              ? this.sessionVariables.axisX.internalMaximum
              : this._options.axisX && this._options.axisX.maximum
              ? this._options.axisX.maximum
              : Infinity;
        ...
        for (n = 0; n < h.dataPoints.length; n++) {
          ...
          h.dataPoints[n].x.getTime
            ? ((f = !0), (d = h.dataPoints[n].x.getTime()))
            : (d = h.dataPoints[n].x);
          e = h.dataPoints[n].y;
          d < c.min && (c.min = d);
          d > c.max && (c.max = d);
          ...
          if (!(d < r) || m) {
            ...
            h.dataPoints[n].label &&
              (a.axisX.labels[d] = h.dataPoints[n].label);
            d < c.viewPortMin && (c.viewPortMin = d);
            d > c.viewPortMax && (c.viewPortMax = d);
            null !== e &&
              ((a.yTotals[d] = (a.yTotals[d] ? a.yTotals[d] : 0) + Math.abs(e)),
    ...
    if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
      for (
        ...
        for (h = 0; h < l.dataPoints.length; h++) {
          "undefined" === typeof l.dataPoints[h].x && (l.dataPoints[h].x = h);
          l.dataPoints[h].x.getTime
            ? ((k = !0), (d = l.dataPoints[h].x.getTime()))
            : (d = l.dataPoints[h].x);
          (e = l.dataPoints[h].y) &&
            e.length &&
            ((f = Math.min.apply(null, e)), (g = Math.max.apply(null, e)));
          d < c.min && (c.min = d);
          d > c.max && (c.max = d);
          f < b.min && (b.min = f);
          g > b.max && (b.max = g);
          ...
          if (!(d < q) || n) {
            ...
            d > c.viewPortMax && (c.viewPortMax = d);
            null !== e &&
              (f < b.viewPortMin && (b.viewPortMin = f),
  ...
  w.prototype.getDataPointAtXY = function (a, b, c) {
    ...
    for (c = 0; c < d.length; c++)
      if (
        "line" === d[c].dataSeries.type ||
        "stepLine" === d[c].dataSeries.type ||
        "area" === d[c].dataSeries.type ||
        "stepArea" === d[c].dataSeries.type
      )
        if (
          ((e = N("markerSize", d[c].dataPoint, d[c].dataSeries) || 8),
          d[c].distance <= e / 2)
        ) {
          b = !0;
          break;
      ...
      if (this._ignoreNextEvent) this._ignoreNextEvent = !1;
        ...
        if (!e) {
          ...
          this._toolTip &&
            ...
            ((c = this.plotArea),
            (b.x < c.x1 || b.x > c.x2 || b.y < c.y1 || b.y > c.y2) &&
              this._toolTip.hide());
  ...
  w.prototype._plotAreaMouseUp = function (a, b) {
    ...
    if (
      ...
      if (2 < Math.abs(e)) {
          ...
          (e = !1),
            ...
            this.axisX._absoluteMinimum
              ? ((d =
                  this.axisX._absoluteMinimum -
                  this.axisX.sessionVariables.internalMinimum),
                (this.axisX.sessionVariables.internalMinimum += d),
                (this.axisX.sessionVariables.internalMaximum += d),
                (e = !0))
          ...
          "xySwapped" === this.plotInfo.axisPlacement
            ? ((c = Math.min(this.dragStartPoint.y, b)),
              ...
              1 < Math.abs(c - d) &&
                ...
                (d =
                  this.axisX.maximum -
                  ((this.axisX.maximum - this.axisX.minimum) / e.height) *
                    (d - e.y1)),
                (e =
                  this.axisX.maximum -
                  ((this.axisX.maximum - this.axisX.minimum) / e.height) *
                ...
                Math.abs(e - d) > 2 * Math.abs(this.axisX.dataInfo.minDiff) &&
                  ((this.axisX.sessionVariables.internalMinimum = d),
                  (this.axisX.sessionVariables.internalMaximum = e),
                  this.render())))
            : "normal" === this.plotInfo.axisPlacement &&
              ...
              1 < Math.abs(d - c) &&
                ((e = this.axisX.lineCoordinates),
                (d =
                  ((this.axisX.maximum - this.axisX.minimum) / e.width) *
                    (d - e.x1) +
                  this.axisX.minimum),
                (e =
                  ((this.axisX.maximum - this.axisX.minimum) / e.width) *
        ...
        this.zoomEnabled &&
          "none" === this._zoomButton.style.display &&
          (pa(this._zoomButton, this._resetButton),
          P(this, this._zoomButton, "pan"),
          P(this, this._resetButton, "reset"));
      }
    }
  ...
  w.prototype._plotAreaMouseMove = function (a, b) {
    if (this.isDrag && "none" !== this.plotInfo.axisPlacement) {
      ...
      "xySwapped" === this.plotInfo.axisPlacement
        ? ((c = b - this.dragStartPoint.y),
          (d =
            (Math.abs(this.axisX.maximum - this.axisX.minimum) / d.height) * c))
        : ((c = this.dragStartPoint.x - a),
          (d =
            (Math.abs(this.axisX.maximum - this.axisX.minimum) / d.width) * c));
      2 < Math.abs(c) &&
      8 > Math.abs(c) &&
      ...
      if (2 < Math.abs(c) && (this.panEnabled || this.zoomEnabled))
        if (this.panEnabled) {
          ...
          this.axisX.sessionVariables.internalMaximum =
            this.dragStartPoint.xMaximum + d;
          c = 0;
          this.axisX.sessionVariables.internalMinimum <
          this.axisX._absoluteMinimum -
            $(this.axisX.interval, this.axisX.intervalType)
            ? ((c =
                this.axisX._absoluteMinimum -
                $(this.axisX.interval, this.axisX.intervalType) -
                this.axisX.sessionVariables.internalMinimum),
    ...
    this.axisX && b
      ? ((a.x1 =
          this.axisX.lineCoordinates.x1 < this.axisX.lineCoordinates.x2
            ...
            : b.lineCoordinates.x1),
        (a.y1 =
          this.axisX.lineCoordinates.y1 < b.lineCoordinates.y1
            ? this.axisX.lineCoordinates.y1
            : b.lineCoordinates.y1),
        (a.x2 =
          this.axisX.lineCoordinates.x2 > b.lineCoordinates.x2
        ...
        (a.y2 =
          this.axisX.lineCoordinates.y2 > this.axisX.lineCoordinates.y1
            ...
            : b.lineCoordinates.y2),
        (a.width = a.x2 - a.x1),
        (a.height = a.y2 - a.y1))
      : ((b = this.layoutManager.getFreeSpace()),
        (a.x1 = b.x1),
        (a.x2 = b.x2),
        (a.y1 = b.y1),
        (a.y2 = b.y2),
    ...
    for (
      ...
      if (null !== t && "" !== t) {
        ...
        if (
          ...
          if (
            l.dataPoint.x < u.minimum ||
            l.dataPoint.x > u.maximum ||
            l.dataPoint.y < v.minimum ||
            l.dataPoint.y > v.maximum
          )
            continue;
        ...
        e = g = 2;
        "horizontal" === r
          ? ((d = m.width), (k = m.height))
          : ((k = m.width), (d = m.height));
          ...
          "inside" !== c
            ? ((d = b.y1),
              ...
              0 < s
                ? ((n = l.point.y - k - g),
                  n < d &&
                    (n = "auto" === c ? Math.max(l.point.y, d) + g : d + g))
                : ((n = l.point.y + g),
                  n > e - k - g &&
                    (n =
                      "auto" === c
                        ? Math.min(l.point.y, e) - k - g
                        : e - k - g)))
            : ((d = Math.max(l.bounds.y1, b.y1)),
              ...
              (c =
                0 <= f.indexOf("range")
                  ? 0 < s
                    ? Math.max(l.bounds.y1, b.y1) + k / 2 + g
                    : Math.min(l.bounds.y2, b.y2) - k / 2 - g
                  : (Math.max(l.bounds.y1, b.y1) +
                      Math.min(l.bounds.y2, b.y2)) /
                    2),
              0 < s
                ? ((n = Math.max(l.point.y, c) - k / 2),
                  n < d &&
                    ("bubble" === f || "scatter" === f) &&
                    (n = Math.max(l.point.y - k - g, b.y1 + g)))
                : ((n = Math.min(l.point.y, c) - k / 2),
                  n > e - k - g &&
                    ("bubble" === f || "scatter" === f) &&
                    (n = Math.min(l.point.y + g, b.y2 - k - g))));
        } else
          0 <= f.indexOf("line") ||
          0 <= f.indexOf("area") ||
          0 <= f.indexOf("scatter")
            ...
            "inside" !== c
              ? ((f = b.x1),
                ...
                0 > s
                  ? ((h = l.point.x - d - e),
                    h < f &&
                      (h = "auto" === c ? Math.max(l.point.x, f) + e : f + e))
                  : ((h = l.point.x + e),
                    h > g - d - e &&
                      (h =
                        "auto" === c
                          ? Math.min(l.point.x, g) - d - e
                          : g - d - e)))
              : (Math.max(l.bounds.x1, b.x1),
                ...
                (c =
                  0 <= f.indexOf("range")
                    ? 0 > s
                      ? Math.max(l.bounds.x1, b.x1) + d / 2 + e
                      : Math.min(l.bounds.x2, b.x2) - d / 2 - e
                    : (Math.max(l.bounds.x1, b.x1) +
                        Math.min(l.bounds.x2, b.x2)) /
                      2),
                (h =
                  0 > s
                    ? Math.max(l.point.x, c) - d / 2
                    : Math.min(l.point.x, c) - d / 2));
        "vertical" === r && (n += k);
        m.x = h;
        m.y = n;
        m.render(!0);
      ...
      for (var d = [], e = 0; e < a.dataSeriesIndexes.length; e++) {
        ...
        if (0 < k.length) {
          for (var q = !1, h = 0; h < k.length; h++)
            if (
              ((n = k[h].x.getTime ? k[h].x.getTime() : k[h].x),
              !(
                ...
                n =
                  (a.axisX.conversionParameters.reference +
                    a.axisX.conversionParameters.pixelPerUnit *
                      (n - a.axisX.conversionParameters.minimum) +
                    0.5) <<
                  0;
                m =
                  (a.axisY.conversionParameters.reference +
                    a.axisY.conversionParameters.pixelPerUnit *
                      (k[h].y - a.axisY.conversionParameters.minimum) +
                    0.5) <<
                  0;
                ...
                l || q
                  ...
                  : (b.lineTo(n, m),
                    ...
                    0 == h % 500 &&
                      ...
                      b.beginPath(),
                      b.moveTo(n, m),
                      t && (c.stroke(), c.beginPath(), c.moveTo(n, m))));
    ...
    if (!(0 >= a.dataSeriesIndexes.length)) {
      ...
      for (var d = [], e = 0; e < a.dataSeriesIndexes.length; e++) {
        ...
        if (0 < k.length) {
          for (var q = !1, h = 0; h < k.length; h++)
            if (
              ((n = k[h].getTime ? k[h].x.getTime() : k[h].x),
              !(
                n < a.axisX.dataInfo.viewPortMin ||
                n > a.axisX.dataInfo.viewPortMax
              ))
      ...
      for (var e = [], f = 0; f < a.dataSeriesIndexes.length; f++) {
        ...
        if (0 < p.length)
          for (h = 0; h < p.length; h++)
            if (
              ((n = p[h].getTime ? p[h].x.getTime() : p[h].x),
              !(
                n < a.axisX.dataInfo.viewPortMin ||
                n > a.axisX.dataInfo.viewPortMax
              ))
              ...
              if ("number" !== typeof p[h].y) 0 < h && (b(q), (q = []));
                ...
                m =
                  (a.axisY.conversionParameters.reference +
                    a.axisY.conversionParameters.pixelPerUnit *
                      (p[h].y - a.axisY.conversionParameters.minimum) +
                    0.5) <<
                  0;
  ...
  w.prototype.renderColumn = function (a) {
    ...
    if (!(0 >= a.dataSeriesIndexes.length)) {
      var c = null,
        ...
        h =
          (0.9 *
            (((d.width / Math.abs(a.axisX.maximum - a.axisX.minimum)) *
              Math.abs(l)) /
      ...
      h > e
        ? (h = e)
        : Infinity === l
        ? (h = 0.9 * (e / a.plotType.totalDataSeries))
        : 1 > h && (h = 1);
      b.save();
      ...
      for (d = 0; d < a.dataSeriesIndexes.length; d++) {
        ...
        if (0 < m.length)
          for (
            var q = 5 < h && n.bevelEnabled ? !0 : !1, e = 0;
            e < m.length;
            e++
          )
            if (
              ...
              f =
                (a.axisX.conversionParameters.reference +
                  a.axisX.conversionParameters.pixelPerUnit *
                    (k - a.axisX.conversionParameters.minimum) +
                  0.5) <<
                0;
              g =
                (a.axisY.conversionParameters.reference +
                  a.axisY.conversionParameters.pixelPerUnit *
                    (m[e].y - a.axisY.conversionParameters.minimum) +
                  0.5) <<
                0;
              f =
                (f -
                  (a.plotType.totalDataSeries * h) / 2 +
                  (a.previousDataSeriesCount + d) * h) <<
                0;
              var r = (f + h) << 0,
                s;
              0 <= m[e].y ? (s = p) : ((s = g), (g = p));
      ...
      for (l = 0; l < a.dataSeriesIndexes.length; l++) {
        ...
        if (0 < q.length) {
          ...
          for (g = 0; g < q.length; g++)
            if (
              ((c = q[g].x.getTime ? q[g].x.getTime() : q[g].x),
              !(
              ...
              d =
                (a.axisX.conversionParameters.reference +
                  a.axisX.conversionParameters.pixelPerUnit *
                    (c - a.axisX.conversionParameters.minimum) +
                  0.5) <<
                0;
              k =
                a.axisY.conversionParameters.reference +
                a.axisY.conversionParameters.pixelPerUnit *
                  (q[g].y - a.axisY.conversionParameters.minimum);
              var s =
                  (d - (a.plotType.plotUnits.length * h) / 2 + a.index * h) <<
                  0,
                z = (s + h) << 0,
                u;
              if (0 <= q[g].y) {
  ...
  w.prototype.renderStackedColumn100 = function (a) {
    ...
    if (!(0 >= a.dataSeriesIndexes.length)) {
      ...
      for (l = 0; l < a.dataSeriesIndexes.length; l++) {
        ...
        if (0 < q.length)
          for (
            var r = 5 < h && m.bevelEnabled ? !0 : !1, g = 0;
            g < q.length;
            g++
          )
            if (
  ...
  w.prototype.renderBar = function (a) {
    ...
    if (!(0 >= a.dataSeriesIndexes.length)) {
      var c = null,
        ...
        h =
          (0.9 *
            (((d.height / Math.abs(a.axisX.maximum - a.axisX.minimum)) *
              Math.abs(l)) /
              a.plotType.totalDataSeries)) <<
          0;
      h > e
      ...
      for (k = 0; k < a.dataSeriesIndexes.length; k++) {
        ...
        if (0 < h.length) {
          ...
          for (var H = !0; m < h.length; m++)
            if (
              ((s = h[m].x.getTime ? h[m].x.getTime() : h[m].x),
              !(
              ...
              if ("number" !== typeof h[m].y) b(), (H = !0);
                ...
                q =
                  (a.axisX.conversionParameters.reference +
                    a.axisX.conversionParameters.pixelPerUnit *
                      (s - a.axisX.conversionParameters.minimum) +
                    0.5) <<
                  0;
                r =
                  (a.axisY.conversionParameters.reference +
                    a.axisY.conversionParameters.pixelPerUnit *
                      (h[m].y - a.axisY.conversionParameters.minimum) +
                    0.5) <<
                  0;
                n || H
                  ? (c.beginPath(),
                    c.moveTo(q, r),
                    (v = { x: q, y: r }),
                    t && (d.beginPath(), d.moveTo(q, r)),
                    (H = n = !1))
                  : (c.lineTo(q, r), t && d.lineTo(q, r), 0 == m % 250 && b());
                ...
                0 !== h[m].markerSize &&
                  ...
                  ((s = l.getMarkerProperties(m, q, r, c)),
                  g.push(s),
                  (D = A(D)),
                  t &&
                    g.push({
      ...
      for (k = 0; k < a.dataSeriesIndexes.length; k++) {
        ...
        if (0 < h.length) {
          ...
          for (
            ...
            if (
              ((m = h[n].x.getTime ? h[n].x.getTime() : h[n].x),
              !(
              ...
              if ("number" !== typeof h[n].y) 0 < n && (b(), (u = []));
                ...
                m =
                  (a.axisX.conversionParameters.reference +
                    a.axisX.conversionParameters.pixelPerUnit *
                      (m - a.axisX.conversionParameters.minimum) +
                    0.5) <<
                  0;
                q =
                  (a.axisY.conversionParameters.reference +
                    a.axisY.conversionParameters.pixelPerUnit *
                      (h[n].y - a.axisY.conversionParameters.minimum) +
                    0.5) <<
                  0;
                ...
                if (
                  0 !== h[n].markerSize &&
                  (0 < h[n].markerSize || 0 < l.markerSize)
                ) {
          ...
          for (k = 0; k < g.length; k++) {
            ...
            if (
              ...
              p =
                (a.axisX.conversionParameters.reference +
                  a.axisX.conversionParameters.pixelPerUnit *
                    (h - a.axisX.conversionParameters.minimum) +
                  0.5) <<
                0;
              l =
                a.axisY.conversionParameters.reference +
  ...
  w.prototype.renderStackedArea100 = function (a) {
    ...
    if (!(0 >= a.dataSeriesIndexes.length)) {
      var c = null,
        ...
        q =
          (((0.9 * d.width) / Math.abs(a.axisX.maximum - a.axisX.minimum)) *
            Math.abs(q)) <<
          0,
          ...
          for (k = 0; k < g.length; k++) {
            ...
            if (
              ...
              l =
                a.axisY.conversionParameters.reference +
                a.axisY.conversionParameters.pixelPerUnit *
                  (l - a.axisY.conversionParameters.minimum);
              var D = f[h] ? f[h] : 0;
              l -= D;
              C.push({ x: p, y: n - D });
              f[h] = n - l;
        ...
        for (
          ...
          (f = q[e].getTime ? (f = q[e].x.getTime()) : (f = q[e].x)),
            f < a.axisX.dataInfo.viewPortMin ||
              ...
              ((r = q[e].z), r > p && (p = r), r < l && (l = r));
      for (
        var s = 25 * Math.PI,
          d = Math.max(
            Math.pow((0.25 * Math.min(d.height, d.width)) / 2, 2) * Math.PI,
            s
          ),
          h = 0;
        h < a.dataSeriesIndexes.length;
          ...
          for (b.strokeStyle = "#4572A7 ", e = 0; e < q.length; e++)
            if (
              ...
              f =
                (a.axisX.conversionParameters.reference +
                  a.axisX.conversionParameters.pixelPerUnit *
                    (f - a.axisX.conversionParameters.minimum) +
                  0.5) <<
                0;
              g =
                (a.axisY.conversionParameters.reference +
                  a.axisY.conversionParameters.pixelPerUnit *
                    (q[e].y - a.axisY.conversionParameters.minimum) +
                  0.5) <<
                0;
              var r = q[e].z,
                z =
          ...
          for (var m = 0, q = 0, e = 0; e < n.length; e++)
            if (
              ...
              g =
                (a.axisY.conversionParameters.reference +
                  a.axisY.conversionParameters.pixelPerUnit *
                    (n[e].y - a.axisY.conversionParameters.minimum) +
                  0.5) <<
                0;
  ...
  w.prototype.renderCandlestick = function (a) {
    ...
    if (!(0 >= a.dataSeriesIndexes.length)) {
      ...
      var n =
        (((0.7 * d.width) / Math.abs(a.axisX.maximum - a.axisX.minimum)) *
          Math.abs(f)) <<
        0;
      ...
      for (var m = 0; m < a.dataSeriesIndexes.length; m++) {
        ...
        if (0 < s.length)
          for (
            var z = 5 < n && r.bevelEnabled ? !0 : !1, e = 0;
            e < s.length;
            e++
          )
            if (
              ...
              g =
                (a.axisY.conversionParameters.reference +
                  a.axisY.conversionParameters.pixelPerUnit *
                    (s[e].y[0] - a.axisY.conversionParameters.minimum) +
                  0.5) <<
                0;
              k =
                (a.axisY.conversionParameters.reference +
                  a.axisY.conversionParameters.pixelPerUnit *
                    (s[e].y[1] - a.axisY.conversionParameters.minimum) +
                  0.5) <<
                0;
              p =
                (a.axisY.conversionParameters.reference +
                  a.axisY.conversionParameters.pixelPerUnit *
                    (s[e].y[2] - a.axisY.conversionParameters.minimum) +
                  0.5) <<
                0;
              l =
                (a.axisY.conversionParameters.reference +
                  a.axisY.conversionParameters.pixelPerUnit *
                    (s[e].y[3] - a.axisY.conversionParameters.minimum) +
                  0.5) <<
                0;
              var u = (f - n / 2) << 0,
                v = (u + n) << 0,
              ...
              "candlestick" === r.type
                ? (b.moveTo(f - w, k),
                  ...
                  I(
                    ...
                    v,
                    Math.max(g, l),
                    s[e].y[0] <= s[e].y[3] ? r.risingColor : d,
                    C,
                    d,
                    z,
                    z,
  ...
  w.prototype.renderRangeColumn = function (a) {
    ...
    if (!(0 >= a.dataSeriesIndexes.length)) {
      ...
      k > e
        ? (k = e)
        : Infinity === f
        ? (k = 0.9 * (e / a.plotType.totalDataSeries))
        : 1 > k && (k = 1);
      b.save();
      t && this._eventManager.ghostCtx.save();
      b.beginPath();
      ...
      for (var p = 0; p < a.dataSeriesIndexes.length; p++) {
        ...
        if (0 < n.length)
          for (
            var m = 5 < k && h.bevelEnabled ? !0 : !1, e = 0;
            e < n.length;
            e++
          )
            if (
              ...
              c =
                (a.axisX.conversionParameters.reference +
                  a.axisX.conversionParameters.pixelPerUnit *
                    (g - a.axisX.conversionParameters.minimum) +
                  0.5) <<
                0;
              d =
                (a.axisY.conversionParameters.reference +
                  a.axisY.conversionParameters.pixelPerUnit *
                    (n[e].y[0] - a.axisY.conversionParameters.minimum) +
                  0.5) <<
                0;
              f =
                (a.axisY.conversionParameters.reference +
                  a.axisY.conversionParameters.pixelPerUnit *
                    (n[e].y[1] - a.axisY.conversionParameters.minimum) +
                  0.5) <<
                0;
              var q =
                  (c -
  ...
  w.prototype.renderRangeBar = function (a) {
    ...
    if (!(0 >= a.dataSeriesIndexes.length)) {
      ...
      p > e
        ? (p = e)
        : Infinity === f
        ? (p = 0.9 * (e / a.plotType.totalDataSeries))
        : 1 > p && (p = 1);
      b.save();
      t && this._eventManager.ghostCtx.save();
      b.beginPath();
          ...
          for (e = 0; e < m.length; e++)
            if (
              ...
              !(
                ...
                null !== m[e].y &&
                m[e].y.length &&
                "number" === typeof m[e].y[0] &&
                "number" === typeof m[e].y[1])
            ) {
              d =
                (a.axisY.conversionParameters.reference +
                  a.axisY.conversionParameters.pixelPerUnit *
                    (m[e].y[0] - a.axisY.conversionParameters.minimum) +
                  0.5) <<
                0;
              f =
                (a.axisY.conversionParameters.reference +
                  a.axisY.conversionParameters.pixelPerUnit *
                    (m[e].y[1] - a.axisY.conversionParameters.minimum) +
                  0.5) <<
                0;
              g =
                (a.axisX.conversionParameters.reference +
      ...
      for (f = 0; f < a.dataSeriesIndexes.length; f++) {
        ...
        if (0 < l.length) {
          ...
          for (var v = !0; n < l.length; n++)
            if (
              ((s = l[n].x.getTime ? l[n].x.getTime() : l[n].x),
              !(
                s < a.axisX.dataInfo.viewPortMin ||
                s > a.axisX.dataInfo.viewPortMax
              ))
              ...
              if (
                ...
                q =
                  (a.axisY.conversionParameters.reference +
                    a.axisY.conversionParameters.pixelPerUnit *
                      (l[n].y[0] - a.axisY.conversionParameters.minimum) +
                    0.5) <<
                  0;
                r =
                  (a.axisY.conversionParameters.reference +
                    a.axisY.conversionParameters.pixelPerUnit *
                      (l[n].y[1] - a.axisY.conversionParameters.minimum) +
                    0.5) <<
                  0;
                h || v
                  ? (c.beginPath(),
                ...
                if (
                  0 !== l[n].markerSize &&
                  (0 < l[n].markerSize || 0 < p.markerSize)
                ) {
      ...
      for (f = 0; f < a.dataSeriesIndexes.length; f++) {
        ...
        if (0 < p.length) {
          ...
          for (
            ...
            if (
              ((h = p[l].x.getTime ? p[l].x.getTime() : p[l].x),
              !(
                h < a.axisX.dataInfo.viewPortMin ||
                h > a.axisX.dataInfo.viewPortMax
              ))
              ...
              if (
                null !== p[l].y &&
                p[l].y.length &&
                "number" === typeof p[l].y[0] &&
                "number" === typeof p[l].y[1]
              ) {
                h =
                  (a.axisX.conversionParameters.reference +
                    a.axisX.conversionParameters.pixelPerUnit *
                ...
                n =
                  (a.axisY.conversionParameters.reference +
                    a.axisY.conversionParameters.pixelPerUnit *
                      (p[l].y[0] - a.axisY.conversionParameters.minimum) +
                    0.5) <<
                  0;
                m =
                  (a.axisY.conversionParameters.reference +
                    a.axisY.conversionParameters.pixelPerUnit *
                      (p[l].y[1] - a.axisY.conversionParameters.minimum) +
                    0.5) <<
                  0;
                ...
                if (
                  0 !== p[l].markerSize &&
                  (0 < p[l].markerSize || 0 < k.markerSize)
                ) {
  ...
  w.prototype.renderPie = function (a) {
    function b() {
      if (h && n) {
        ...
        for (x = 0; x < n.length; x++) {
          ...
          g.hemisphere =
            e > Math.PI / 2 && e <= (3 * Math.PI) / 2 ? "left" : "right";
        ...
        for (x = 0; x < n.length; x++)
          (g = s[(c + x) % n.length]),
            1 < a &&
              g.midAngle > Math.PI / 2 - v &&
              g.midAngle < Math.PI / 2 + v &&
              (e <= a / 2 && !k
                ? ((g.hemisphere = "right"), e++)
                : ((g.hemisphere = "left"), (k = !0)));
        k = !1;
        for (x = 0; x < n.length; x++)
          (g = s[(d + x) % n.length]),
            1 < b &&
    ...
    function c(a) {
      ...
      for (b = 0; b < n.length; b++) {
        ...
        if (d > c) {
          ...
          if (n[b].exploded) {
            if (
              1e-9 < Math.abs(s[b].center.x - (y.x + e)) ||
              1e-9 < Math.abs(s[b].center.y - (y.y + f))
            )
              (s[b].center.x = y.x + e * a),
                (s[b].center.y = y.y + f * a),
                (g = !0);
          } else if (
            0 < Math.abs(s[b].center.x - y.x) ||
            0 < Math.abs(s[b].center.y - y.y)
          )
        ...
        (c = s[b]),
          c.indexLabelText &&
            ...
            "inside" !== c.indexLabelPlacement &&
              ...
              a.setLineDash &&
                a.setLineDash(
                  M(c.indexLabelLineDashType, c.indexLabelLineThickness)
                ),
              a.beginPath(),
              a.moveTo(d, e),
              a.lineTo(c.indexLabelTextBlock.x, c.indexLabelTextBlock.y),
              a.lineTo(
                c.indexLabelTextBlock.x + ("left" === c.hemisphere ? -m : m),
    ...
    function d(a, b) {
      ...
      return a.indexLabelTextBlock.x + a.indexLabelTextBlock.width <
        b.indexLabelTextBlock.x - m ||
        c > g + m ||
        d > h + m ||
        e < f - m
        ? !1
    ...
    function f(a) {
      for (var b = null, c = 1; c < n.length; c++)
        if (
          ((b = (a + c + s.length) % s.length),
          s[b].hemisphere !== s[a].hemisphere)
        ) {
          b = null;
          break;
        } else if (
          ...
          b !== a &&
          (0 > e(s[b], s[a]) ||
            ("right" === s[a].hemisphere
              ? s[b].indexLabelTextBlock.y >= s[a].indexLabelTextBlock.y
              : s[b].indexLabelTextBlock.y <= s[a].indexLabelTextBlock.y))
        )
          break;
        else b = null;
    ...
    function g(a, b) {
      ...
      if (0 <= a && a < n.length) {
        ...
        var k = b,
          ...
          q = (m = m = 0);
        0 > k
          ? l.indexLabelTextBlock.y - l.indexLabelTextBlock.height / 2 > d &&
        ...
        d =
          "right" === l.hemisphere
            ? y.x + Math.sqrt(Math.pow(B, 2) - Math.pow(k - y.y, 2))
            : y.x - Math.sqrt(Math.pow(B, 2) - Math.pow(k - y.y, 2));
        ...
        for (h = 1; h < n.length; h++)
          if (
            ...
            (0 > e(s[d], s[a]) ||
              ("right" === s[a].hemisphere
                ? s[d].indexLabelTextBlock.y <= s[a].indexLabelTextBlock.y
                : s[d].indexLabelTextBlock.y >= s[a].indexLabelTextBlock.y))
          )
            break;
          else d = null;
          ...
          ? ((h = "right" === l.hemisphere ? q : m),
            ...
            null !== h &&
              ...
              (k =
                l.indexLabelTextBlock.y -
                l.indexLabelTextBlock.height / 2 -
                (s[h].indexLabelTextBlock.y +
                  s[h].indexLabelTextBlock.height / 2)),
              k - q < t &&
                ((d = -q),
                r++,
                (h = g(h, d)),
                +h.toFixed(w) > +d.toFixed(w) &&
                  (c = k > t ? -(k - t) : -(q - (h - d))))))
          : 0 < k &&
        ...
        c &&
          ...
          l.midAngle > Math.PI / 2 - v && l.midAngle < Math.PI / 2 + v
            ? ((h = (a - 1 + s.length) % s.length),
              ...
              "left" === l.hemisphere &&
              "right" === h.hemisphere &&
              d > h.indexLabelTextBlock.x
                ? (d = h.indexLabelTextBlock.x - 15)
                : "right" === l.hemisphere &&
                  "left" === q.hemisphere &&
                  d < q.indexLabelTextBlock.x &&
                  (d = q.indexLabelTextBlock.x + 15))
          ...
          (l.indexLabelAngle = Math.atan2(
            l.indexLabelTextBlock.y - y.y,
            l.indexLabelTextBlock.x - y.x
          )));
      }
      return c;
    }
            ...
            if (null !== v) {
              ...
              if (0 > x) {
                for (var A = (r = p = 0); A < n.length; A++)
                  A !== b &&
                    s[A].hemisphere === k.hemisphere &&
                    (s[A].indexLabelTextBlock.y < k.indexLabelTextBlock.y
                      ? p++
                      : r++);
                A = (x / (p + r || 1)) * r;
                p = -1 * (x - A);
                ...
                "right" === k.hemisphere
                  ? ((r = g(b, A)),
                    (p = -1 * (x - r)),
                    (E = g(v, p)),
                    +E.toFixed(w) < +p.toFixed(w) &&
                      +r.toFixed(w) <= +A.toFixed(w) &&
                      g(b, -(p - E)))
                  : ((r = g(v, A)),
                    (p = -1 * (x - r)),
                    (E = g(b, p)),
          ...
          (k = s[b]),
            ...
            0 !== x.height &&
              ...
              0 < x &&
                ...
                ((x /= Math.abs(Math.cos(k.indexLabelAngle))),
                9 < x && (x *= 0.3),
                x > c && (c = x)),
              (x = x = 0),
              0 < k.indexLabelAngle && k.indexLabelAngle < Math.PI
                ...
                : (x =
                    ...
                    (k.indexLabelTextBlock.y -
                      ...
                      5)),
              0 < x &&
                Math.abs(k.indexLabelTextBlock.x - y.x) < D &&
                ((x /= Math.abs(Math.sin(k.indexLabelAngle))),
                9 < x && (x *= 0.3),
                x > c && (c = x)));
        b = function (a, b, c) {
          for (
    ...
    function p() {
      ...
      l._title &&
        (l._title.dockInsidePlotArea ||
          ("center" === l._title.horizontalAlign &&
            "center" === l._title.verticalAlign)) &&
        l._title.render();
      if (l.subtitles)
        ...
        var h = this.data[a.dataSeriesIndexes[0]],
          ...
          D =
            "inside" === h.indexLabelPlacement
              ...
              : (0.8 * Math.min(q.width, q.height)) / 2,
          B = D * u,
          A = 0,
          x = 0;
        x < n.length;
  ...
  Z.prototype.registerSpace = function (a, b) {
    "top" === a
      ? (this._topOccupied += b.height)
      : "bottom" === a
      ? (this._bottomOccupied += b.height)
      : "left" === a
      ? (this._leftOccupied += b.width)
      : "right" === a && (this._rightOccupied += b.width);
  };
      ...
      (f = this._wrappedText.lines[c]),
        "right" === this.horizontalAlign
          ...
          : "center" === this.horizontalAlign &&
            (d =
              (this.width - 2 * this.padding) / 2 - f.width / 2 + this.padding),
  ...
  ca.prototype.render = function () {
    if (this.text) {
      ...
      "top" === this.verticalAlign || "bottom" === this.verticalAlign
        ? (null === this.maxWidth &&
            (this.maxWidth =
              b.width - 4 - g * ("center" === this.horizontalAlign ? 2 : 1)),
          (f = 0.5 * b.height - this.margin - 2),
          (e = 0))
        : "center" === this.verticalAlign &&
          ("left" === this.horizontalAlign || "right" === this.horizontalAlign
            ? (null === this.maxWidth && (this.maxWidth = b.height - 4),
              (f = 0.5 * b.width - this.margin - 2))
            : "center" === this.horizontalAlign &&
              (null === this.maxWidth && (this.maxWidth = b.width - 4),
              (f = 0.5 * b.height - 4)));
      this.wrap ||
        (f = Math.min(
          f,
      ...
      "top" === this.verticalAlign || "bottom" === this.verticalAlign
        ? ("top" === this.verticalAlign
            ...
            : "bottom" === this.verticalAlign &&
              ((d = b.y2 - 2 - l.height), (p = "bottom")),
          "left" === this.horizontalAlign
            ? (c = b.x1 + 2)
            : "center" === this.horizontalAlign
            ? (c = b.x1 + b.width / 2 - l.width / 2)
            : "right" === this.horizontalAlign && (c = b.x2 - 2 - l.width - g),
        ...
        : "center" === this.verticalAlign &&
          ("left" === this.horizontalAlign
            ? ((c = b.x1 + 2),
              (d = b.y2 - 2 - (this.maxWidth / 2 - l.width / 2)),
              (e = -90),
              (p = "left"),
              (this.width = l.height),
              (this.height = l.width))
            : "right" === this.horizontalAlign
            ? ((c = b.x2 - 2),
              (d = b.y1 + 2 + (this.maxWidth / 2 - l.width / 2)),
              (e = 90),
              (p = "right"),
              (this.width = l.height),
              (this.height = l.width))
            : "center" === this.horizontalAlign &&
              ((d = a.y1 + (a.height / 2 - l.height / 2)),
              (c = a.x1 + (a.width / 2 - l.width / 2)),
              (p = "center"),
              (this.width = l.width),
              (this.height = l.height)),
          (k = "center"));
      ...
      a.layoutManager.registerSpace(p, {
        width:
          this.width + ("left" === p || "right" === p ? this.margin + 2 : 0),
        height:
          this.height + ("top" === p || "bottom" === p ? this.margin + 2 : 0),
      });
  ...
  ka.prototype.render = function () {
    ...
    "top" === this.verticalAlign || "bottom" === this.verticalAlign
      ? ((this.orientation = "horizontal"),
        ...
        (g = null !== this.maxHeight ? this.maxHeight : 0.5 * b.height))
      : "center" === this.verticalAlign &&
    ...
    for (var l = 0; l < this.dataSeries.length; l++) {
      ...
      if ("pie" !== h.type && "doughnut" !== h.type && "funnel" !== h.type) {
        var n = h.legendMarkerType
          ...
          r =
            h.markerSize ||
            ("line" !== h.type && "stepLine" !== h.type && "spline" !== h.type)
              ? 0.6 * this.lineHeight
              : 0,
          s = h.legendMarkerBorderColor
            ? h.legendMarkerBorderColor
            : h.markerBorderColor,
          t = h.legendMarkerBorderThickness
            ? h.legendMarkerBorderThickness
            : h.markerBorderThickness
        ...
        for (var u = 0; u < h.dataPoints.length; u++) {
          var v = h.dataPoints[u],
            ...
            q = v.legendMarkerColor
              ...
              : h.color
              ? h.color
              : h._colorSet[u % h._colorSet.length],
          ...
          (v.showInLegend || (h.showInLegend && !1 !== v.showInLegend)) &&
            k.push(n);
        }
    }
    ...
    if (0 < k.length) {
                ...
                (n.textBlock.width =
                  ...
                  (r +
                    ...
                    "stepLine" === n.chartType
                      ...
                      : 0))),
              this.height <= g
                ? ((h = { items: [], width: 0 }), p.push(h))
                : ((h = p[v]), (v = (v + 1) % p.length)),
      ...
      this.height =
        !1 === this.itemWrap ? p.length * this.lineHeight : this.height + u;
    ...
    "top" === this.verticalAlign
      ...
      ? ((e =
          "left" === this.horizontalAlign
            ...
            ? b.x2 - this.width
            : b.x1 + b.width / 2 - this.width / 2),
        (d = b.y1 + b.height / 2 - this.height / 2))
      : "bottom" === this.verticalAlign &&
        ((e =
          "left" === this.horizontalAlign
            ? b.x1
    ...
    for (l = b = 0; l < p.length; l++) {
      ...
      for (k = u = 0; k < h.items.length; k++) {
        ...
        n.y2 = this.chart._eventManager.objectMap[n.id].y2 =
          n.textBlock.y + n.textBlock.height;
      }
      b += u;
    }
        ...
        if (m) {
          switch (this.type) {
            ...
            case "rangeSplineArea":
              ...
              t = c ? 20 : s;
              r = Math.min(
                Math.sqrt(Math.pow(m.x1 - a, 2) + Math.pow(m.y1 - b, 2)),
                Math.sqrt(Math.pow(m.x1 - a, 2) + Math.pow(m.y2 - b, 2))
              );
              r <= t &&
                d.push({
                  dataPoint: q,
            ...
            case "candlestick":
              if (
                (a >= m.x1 - m.borderThickness / 2 &&
                  ...
                  b >= m.y2 - m.borderThickness / 2 &&
                  b <= m.y3 + m.borderThickness / 2) ||
            ...
            case "ohlc":
              if (
                ...
                (a >= m.x1 &&
                  a <= (m.x2 + m.x1) / 2 &&
                  b >= m.y1 - m.borderThickness / 2 &&
                  b <= m.y1 + m.borderThickness / 2) ||
                (a >= (m.x1 + m.x2) / 2 &&
                  a <= m.x2 &&
                  b >= m.y4 - m.borderThickness / 2 &&
                  b <= m.y4 + m.borderThickness / 2)
              )
                d.push({
                  dataPoint: q,
  ...
  x.prototype.createLabels = function () {
    ...
    if ("bottom" === this._position || "top" === this._position)
      (b =
        ...
        (d = this.labelAutoFit
          ...
          : this.labelMaxWidth),
        (e =
          "undefined" === typeof this._options.labelWrap || this.labelWrap
    ...
    if (
      ...
      for (
        c = ua(new Date(this.maximum), this.interval, this.intervalType),
          b = this.intervalstartTimePercent;
        b < c;
        ua(b, this.interval, this.intervalType)
      )
        (a = b.getTime()),
      ...
      if (this.labels && this.labels.length) {
        ...
        for (
          var f = Math.ceil(this.intervalstartTimePercent), g = !1, b = f;
          b < this.maximum;
          b += a
        )
      ...
      for (
        b = this.intervalstartTimePercent;
        b <= c;
        b = parseFloat((b + this.interval).toFixed(14))
      )
        (a = this.labelFormatter
          ? this.labelFormatter({
              chart: this.chart,
    ...
    for (b = 0; b < this.stripLines.length; b++)
      (c = this.stripLines[b]),
        (a = new G(this.ctx, {
          ...
          maxHeight: e,
          angle: this.labelAngle,
          text: c.labelFormatter
            ? c.labelFormatter({ chart: this.chart, axis: this, stripLine: c })
            : c.label,
          horizontalAlign: "left",
  ...
  x.prototype.createLabelsAndCalculateWidth = function () {
    ...
    return (
      (this.title
        ? fa(this.titleFontFamily, this.titleFontSize, this.titleFontWeight) + 2
        : 0) +
      a +
      this.tickLength +
      5
  ...
  x.setLayoutAndRender = function (a, b, c, d, e) {
    ...
    if (
      ...
      k > h
        ? (c.maximum = c.interval * k + c.minimum)
        : h > k && (b.maximum = b.interval * h + b.minimum);
    }
    h = b ? b.margin : 0;
    if ("normal" === d) {
      a.lineCoordinates = {};
      ...
      g = Math.round(
        e.x2 - h > a.chart.width - 10 ? a.chart.width - 10 : e.x2 - h
      );
      ...
      b &&
        ...
        (k = Math.round(
          e.y2 - h > b.chart.height - 10 ? b.chart.height - 10 : e.y2 - h
        )),
    ...
    if ("bottom" === this._position) {
      for (var e = 0, f, e = 0; e < this._labels.length; e++)
        if (
          ...
          if (
            (this.tickThickness && !this._labels[e].stripLine) ||
            (this._labels[e].stripLine &&
              "pixel" === this._labels[e].stripLine._thicknessType)
          )
            this._labels[e].stripLine
              ? ((c = this._labels[e].stripLine),
          ...
          if (!a || 0 === d++ % 2 || this._labels[e].stripLine)
            0 === f.textBlock.angle
              ? ((b.x -= f.textBlock.width / 2),
                (b.y += this.tickLength + f.textBlock.fontSize / 2))
              : ((b.x -=
                  0 > this.labelAngle
                    ? f.textBlock.width *
                      Math.cos((Math.PI / 180) * this.labelAngle)
      ...
      for (e = 0; e < this._labels.length; e++)
        if (
          ...
          if (!a || 0 === d++ % 2 || this._labels[e].stripLine)
            0 === f.textBlock.angle
              ? ((b.x -= f.textBlock.width / 2),
                (b.y -= this.tickLength + f.textBlock.height / 2))
              : ((b.x -=
                  0 < this.labelAngle
                    ? f.textBlock.width *
                      Math.cos((Math.PI / 180) * this.labelAngle)
      ...
      for (e = 0; e < this._labels.length; e++)
        if (
          ...
          if (!a || 0 === d++ % 2 || this._labels[e].stripLine)
            (f.textBlock.x =
              b.x -
              f.textBlock.width * Math.cos((Math.PI / 180) * this.labelAngle) -
              this.tickLength -
              5),
              (f.textBlock.y =
                0 === this.labelAngle
            ...
            ? ((b = this.getPixelCoordinatesOnAxis(this._labels[e].position)),
              (c =
                e + 1 >= this._labels.length - 1
                  ? this.getPixelCoordinatesOnAxis(this.maximum)
  ...
  x.prototype.renderStripLinesOfThicknessType = function (a) {
    if (this.stripLines && 0 < this.stripLines.length && a)
      for (var b = 0, b = 0; b < this.stripLines.length; b++) {
        ...
        c._thicknessType === a &&
          (("pixel" === a &&
            (c.value < this.minimum || c.value > this.maximum)) ||
            (c.showOnTop
  ...
  x.prototype.renderGrid = function () {
    if (this.gridThickness && 0 < this.gridThickness) {
      ...
      if ("bottom" === this._position || "top" === this._position)
        ...
        for (
          var d = 0;
          d < this._labels.length && !this._labels[d].stripLine;
          d++
        )
          (0 === d &&
            "axisY" === this.type &&
  ...
  x.prototype.renderAxisLine = function () {
    ...
    if ("bottom" === this._position || "top" === this._position) {
      if (this.lineThickness) {
        ...
        a.setLineDash &&
          a.setLineDash(M(this.lineDashType, this.lineThickness));
        var b =
  ...
  x.prototype.calculateValueToPixelconversionParameters = function (a) {
    ...
    if ("left" === this._position || "right" === this._position)
      (a.pixelPerUnit = (-1 * c) / Math.abs(this.maximum - this.minimum)),
  ...
  x.prototype.calculateAxisParameters = function () {
    ...
    "axisX" === this.type
      ? ((c =
          null !== this.sessionVariables.internalMinimum
            ? this.sessionVariables.internalMinimum
            : this.dataInfo.viewPortMin),
        (d =
          null !== this.sessionVariables.internalMaximum
        ...
        Infinity !== this.dataInfo.minDiff
          ? (e = this.dataInfo.minDiff)
          : 1 < d - c
          ? (e = 0.5 * Math.abs(d - c))
          : ((e = 1),
            "dateTime" === this.chart.plotInfo.axisXValueType && (b = !0)))
      : "axisY" === this.type &&
        ((c =
          "undefined" === typeof this._options.minimum ||
          null === this._options.minimum
            ? this.dataInfo.viewPortMin
            : this._options.minimum),
        (d =
          "undefined" === typeof this._options.maximum ||
          null === this._options.maximum
            ? this.dataInfo.viewPortMax
        ...
        isFinite(c) || isFinite(d)
          ? 0 === c && 0 === d
            ? ((d += 9), (c = 0))
            : 0 === d - c
            ? ((f = Math.min(Math.abs(0.01 * Math.abs(d)), 5)),
              (d += f),
              (c -= f))
            : c > d
            ? ((f = Math.min(Math.abs(0.01 * Math.abs(d - c)), 5)),
              0 <= d ? (c = d - f) : (d = c + f))
            : ((f = Math.min(Math.abs(0.01 * Math.abs(d - c)), 0.05)),
              0 !== d && (d += f),
              0 !== c && (c -= f))
          : ((d =
              "undefined" === typeof this._options.interval
      ...
      ? ((f = d - c),
        this.intervalType ||
          (f / 1 <= a
            ...
            : ((this.interval =
                f / (1 * B.yearDuration) <= a
                  ? 1
                  : f / (2 * B.yearDuration) <= a
                  ? 2
                  : f / (4 * B.yearDuration) <= a
                  ? 4
                  : Math.floor(
                      x.getNiceNumber(f / (a - 1), !0) / B.yearDuration
                    )),
      ...
      : ((this.intervalType = "number"),
        ...
        (this.interval =
          this._options && this._options.interval
            ? this._options.interval
            : x.getNiceNumber(f / (a - 1), !0)),
        (this.minimum =
          null !== this.sessionVariables.internalMinimum
            ? this.sessionVariables.internalMinimum
            : Math.floor(c / this.interval) * this.interval),
        (this.maximum =
          null !== this.sessionVariables.internalMaximum
            ? this.sessionVariables.internalMaximum
        ...
        0 === this.maximum &&
          ...
          (0 === this._options.minimum
            ? (this.maximum += 10)
            : 0 === this._options.maximum && (this.minimum -= 10),
          this._options &&
            "undefined" === typeof this._options.interval &&
            (this.interval = x.getNiceNumber(
              (this.maximum - this.minimum) / (a - 1),
              !0
            ))),
        "axisX" === this.type
          ? (null === this.sessionVariables.internalMinimum &&
            ...
            (this.intervalstartTimePercent =
              Math.floor((this.minimum + 0.2 * this.interval) / this.interval) *
              this.interval))
          : "axisY" === this.type &&
            (this.intervalstartTimePercent = this.minimum));
    "axisX" === this.type &&
      ((this._absoluteMinimum =
        this._options && "undefined" !== typeof this._options.minimum
          ? this._options.minimum
          : this.dataInfo.min - e / 2),
      (this._absoluteMaximum =
        this._options && "undefined" !== typeof this._options.maximum
          ? this._options.maximum
          : this.dataInfo.max + e / 2));
    if (
      !this.valueFormatString &&
      ((this.valueFormatString = "#,##0.##"),
      (f = Math.abs(this.maximum - this.minimum)),
      1 > f)
    ) {
  ...
  Q.prototype.mouseMoveHandler = function (a, b) {
    (this._lastUpdated && 40 > new Date().getTime() - this._lastUpdated) ||
      ((this._lastUpdated = new Date().getTime()), this._updateToolTip(a, b));
  };
  Q.prototype._updateToolTip = function (a, b) {
    if (!this.chart.disableToolTip) {
      ...
      if (
        ...
        f =
          "xySwapped" === this.chart.plotInfo.axisPlacement
            ? ((this.chart.axisX.maximum - this.chart.axisX.minimum) /
                this.chart.axisX.lineCoordinates.height) *
                (this.chart.axisX.lineCoordinates.y2 - b) +
              this.chart.axisX.minimum
            : ((this.chart.axisX.maximum - this.chart.axisX.minimum) /
                this.chart.axisX.lineCoordinates.width) *
                (a - this.chart.axisX.lineCoordinates.x1) +
              this.chart.axisX.minimum;
        c = [];
        for (d = 0; d < this.chart.data.length; d++) {
          ...
          g &&
            0 <= g.index &&
            ((g.dataSeries = this.chart.data[d]),
            null !== g.dataPoint.y && c.push(g));
        }
        ...
        for (d = 0; d < c.length; d++)
          c[d].dataPoint.x.valueOf() === f.dataPoint.x.valueOf() &&
            e.push(c[d]);
        c = null;
      } else {
        if ((g = this.chart.getDataPointAtXY(a, b, !0)))
          ...
          if (
            ((g = xa(a, b, this.chart._eventManager.ghostCtx)),
            0 < g &&
            ...
            this.currentDataPointIndex =
              0 <= eventObject.dataPointIndex ? eventObject.dataPointIndex : -1;
      ...
      if (0 < e.length && (this.highlightObjects(e), this.enabled))
        if (
          ((f = ""), (f = this.getToolTipInnerHTML({ entries: e })), null !== f)
        ) {
              ...
              (this.contentDiv.style.borderRightColor =
                ...
                this.contentDiv.style.borderColor =
                  this.borderColor
                    ...
                    ? e[0].dataSeries.color
                    : e[0].dataSeries._colorSet[
                        e[0].index % e[0].dataSeries._colorSet.length
                      ]),
          ...
          "stackedBar100" === e[0].dataSeries.type
            ...
            : ((toolTipLeft =
                ((this.chart.axisX.lineCoordinates.width /
                  ...
                  Math.abs(e[0].dataPoint.x - this.chart.axisX.minimum) +
            ...
            ("line" !== e[0].dataSeries.type &&
              ...
              ? "bar" === e[0].dataSeries.type ||
                ...
                ? (e[0].dataSeries.axisX.lineCoordinates.y2 -
                    (e[0].dataSeries.axisX.lineCoordinates.height /
                      Math.abs(
                        e[0].dataSeries.axisX.maximum -
                          e[0].dataSeries.axisX.minimum
                      )) *
                      Math.abs(
                        e[0].dataPoint.x - e[0].dataSeries.axisX.minimum
                      ) +
                    0.5) <<
                  0
                : b
              : (e[0].dataSeries.axisY.lineCoordinates.y2 -
                  (e[0].dataSeries.axisY.lineCoordinates.height /
                    Math.abs(
                      e[0].dataSeries.axisY.maximum -
                        e[0].dataSeries.axisY.minimum
                    )) *
                    Math.abs(e[0].dataPoint.y - e[0].dataSeries.axisY.minimum) +
                  0.5) <<
                0;
          e = -e + 10;
  ...
  Q.prototype.getToolTipInnerHTML = function (a) {
    a = a.entries;
    for (
      var b = null, c = null, d = null, e = 0, f = "", g = !0, k = 0;
      k < a.length;
      k++
    )
    ...
    if (
      ...
      (a = { chart: this.chart, toolTip: this._options, entries: a }),
        (b = this.contentFormatter
      ...
      for (var p = "", k = 0; k < a.length; k++)
        if (
          ...
          0 === k &&
            ...
            !this.content &&
            ((p +=
              "undefined" !== typeof this.chart.axisX.labels[d.x]
                ? this.chart.axisX.labels[d.x]
                : "{x}"),
            (p += "</br>"),
            (p = this.chart.replaceKeywordsWithValue(p, d, c, e))),
          null !== d.toolTipContent &&
            ("undefined" !== typeof d.toolTipContent ||
          ...
          null === b && (b = "");
          !0 === this.reversed
            ? ((b = this.chart.replaceKeywordsWithValue(f, d, c, e) + b),
              k < a.length - 1 && (b = "</br>" + b))
  ...
  w.prototype.replaceKeywordsWithValue = function (a, b, c, d, e) {
    ...
    if (
      ...
      do {
        ...
        a = a.replace(
          "#total",
          X(k, c.yValueFormatString ? c.yValueFormatString : "#,##0.########")
        );
        ...
        ? f.axisX && "dateTime" === f.plotInfo.axisXValueType
          ? sa(
              ...
              b.xValueFormatString
                ...
                ? c.xValueFormatString
                : f.axisX && f.axisX.valueFormatString
                ? f.axisX.valueFormatString
                : "DD MMM YY",
              f._cultureInfo
            )
          : X(
  ...
  ba.prototype.mouseEventHandler = function (a) {
    if ("mousemove" === a.type || "click" === a.type) {
      var b = [],
        ...
        d = null;
      if (
        (d = this.chart.getObjectAtXY(c.x, c.y, !1)) &&
        "undefined" !== typeof this.objectMap[d]
      )
        if (((d = this.objectMap[d]), "dataPoint" === d.objectType)) {
          ...
          "legendItem" === d.objectType &&
            ...
            (f =
              null !== d.dataPointIndex
                ? e.dataPoints[d.dataPointIndex]
                : null),
            (d.eventParameter = {
              x: c.x,
              y: c.y,
      ...
      for (c = 0; c < b.length; c++) {
        ...
        e ||
          (this.fireEvent(b[c], "mouseover", a),
          this.mouseoveredObjectMaps.push(b[c]));
        "click" === a.type
          ? this.fireEvent(b[c], "click", a)
          : "mousemove" === a.type && this.fireEvent(b[c], "mousemove", a);
      }
    }
  };
  ...
  ra.prototype.animate = function (a, b, c, d, e) {
    ...
    for (a = []; 0 < this.animations.length; )
      if (
        ...
        (d = 0),
        b.startTime <= c &&
          ((d = e(Math.min(c - b.startTime, b.duration), 0, 1, b.duration)),
          (d = Math.min(d, 1)),
          isNaN(d) || !isFinite(d)) &&
          (d = 1),
        1 > d && a.push(b),
