  ...
  return (function (e) {
    ...
    function (e, t, o) {
      ...
      angular
        ...
        .factory("FileUploader", u["default"])
        .factory("FileLikeObject", c["default"])
        .factory("FileItem", d["default"])
        .factory("FileDirective", y["default"])
        .factory("FileSelect", _["default"])
        .factory("FileDrop", g["default"])
        .factory("FileOver", b["default"])
        .directive("nvFileSelect", C["default"])
        .directive("nvFileDrop", U["default"])
        .directive("nvFileOver", A["default"])
        .run([
          "FileUploader",
          "FileLikeObject",
          "FileItem",
      ...
      function i(e, t, o, n, i, s, a) {
        var m = n.File,
          ...
          v = (function () {
            ...
            return (
              (n.prototype.addToQueue = function (e, t, o) {
                var n = this,
              ...
              (n.prototype._transformResponse = function (e, t) {
                ...
                return (
                  p(o.defaults.transformResponse, function (t) {
                    e = t(e, n);
                  }),
                  e
                );
              ...
              (n.prototype._xhrTransport = function (e) {
                ...
                (n.upload.onprogress = function (t) {
                  var n = Math.round(
                    t.lengthComputable ? (100 * t.loaded) / t.total : 0
                  );
          ...
          return (
            (e.prototype._createFromFakePath = function (e) {
              (this.lastModifiedDate = null),
                (this.size = null),
                (this.type =
                  "like/" + e.slice(e.lastIndexOf(".") + 1).toLowerCase()),
                (this.name = e.slice(
                  e.lastIndexOf("/") + e.lastIndexOf("\\") + 2
                ));
            }),
      ...
      function a(e, t) {
        return (function (t) {
          function o(e) {
            ...
            return (
              s.uploader.isHTML5 || s.element.removeAttr("multiple"),
          ...
          return (
            ...
            (o.prototype.onChange = function () {
              var t = this.uploader.isHTML5
                  ? this.element[0].files
                  : this.element[0],
                o = this.getOptions(),
                n = this.getFilters();
              this.uploader.isHTML5 || this.destroy(),
                ...
                this.isEmptyAfterSelection() &&
                  ...
                  this.element.replaceWith(
                    e(this.element.clone())(this.scope)
                  ));
            }),
            o
          );
            ...
            (t.prototype.onDrop = function (e) {
              ...
              if (t) {
                ...
                this._preventAndStop(e),
                  c(
                    this.uploader._directives.over,
