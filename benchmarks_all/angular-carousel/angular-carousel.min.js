                ...
                function (m, o, q) {
                  ...
                  function w(a, b) {
                    if (
                      ...
                      (b = b || {}),
                      b.animate === !1 || "none" === K.transitionType)
                    )
                      return (
                        (S = !1),
                        (M = -100 * a),
                    ...
                    if (
                      ...
                      if (((M += (100 * -I) / P), K.isSequential)) {
                        var c = K.moveTreshold * P,
                          ...
                          g = Math.abs(e) > c;
                        O &&
                          f + m.carouselIndex >= O.length &&
                          (f = O.length - 1 - m.carouselIndex),
                          f + m.carouselIndex < 0 && (f = -m.carouselIndex);
                        var h = g ? f : 0;
                        (I = m.carouselIndex + h),
                          w(I),
                          void 0 !== q.rnCarouselOnInfiniteScrollRight &&
                            0 === f &&
                            0 !== m.carouselIndex &&
                            (d(q.rnCarouselOnInfiniteScrollRight)(m), w(0)),
                  ...
                  function E() {
                    ...
                    t
                      ? ((a =
                          m.carouselIndex <= b
                            ? 0
                            : O && O.length < m.carouselBufferSize
                            ? 0
                            : O &&
                              m.carouselIndex > O.length - m.carouselBufferSize
                            ? O.length - m.carouselBufferSize
                            : m.carouselIndex - b),
                  ...
                  if (
                    ...
                    var U =
                        (s ? m.$eval(p.replace("::", "")).length : O.length) > 1
                  ...
                  if (q.rnCarouselIndex) {
                    ...
                    angular.isFunction($.assign)
                      ? (m.$watch("carouselIndex", function (a) {
                        ...
                        (L = !0),
                        K.defaultIndex && w(K.defaultIndex, { animate: !T }))
                      : isNaN(q.rnCarouselIndex) ||
                        w(parseInt(q.rnCarouselIndex, 10), { animate: !1 });
                  } else w(K.defaultIndex, { animate: !T }), (T = !1);
                  if (
                    (q.rnCarouselLocked &&
                      m.$watch(q.rnCarouselLocked, function (a) {
                        S = a === !0 ? !0 : !1;
                      }),
                    s)
                  ) {
                    var _ = void 0 !== q.rnCarouselDeepWatch;
                    m[_ ? "$watch" : "$watchCollection"](
                      p,
                      function (a, b) {
                  ...
                  m.$on("$destroy", function () {
                    ...
                    (m.carouselBufferSize = K.bufferSize);
                  var ab = angular.element(b);
                  ab.bind("orientationchange", F),
                    ab.bind("resize", F),
                    m.$on("$destroy", function () {
                      A(),
                        ab.unbind("orientationchange", F),
                        ab.unbind("resize", F);
                    });
                }
              );
