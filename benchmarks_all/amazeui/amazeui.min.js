              ...
              var a,
                ...
                c = this.each(function () {
                  var c = n(this),
                    ...
                    p = n.extend(
                      {},
                      s.utils.parseOptions(c.attr(u)),
                      "object" == typeof o && o
                    );
                  (d || "destroy" !== o) &&
                    (d || c.data(h, (d = new e(this, p))),
                    i.methodCall
    ...
    function (t, e, i) {
      ...
      function a() {
        "#ath" == document.location.hash &&
          ...
          u.test(document.location.href) &&
            history.replaceState(
              "",
              window.document.title,
              document.location.href.replace(u, "$1")
            ),
        ...
        (a.prototype.fill = function () {
          ...
          for (var h, u, d, p = []; s.valueOf() < c; )
            s.getDay() === this.weekStart && p.push("<tr>"),
              ...
              (i > d && u === e) || e > u
                ? (h += " am-datepicker-old")
                : ((d > i && u === e) || u > e) && (h += " am-datepicker-new"),
              ...
              controlNav: {
                ...
                setupPaging: function () {
                  ...
                  s.controlsContainer
                    ...
                    g.controlNav.set(),
                    g.controlNav.active(),
                    s.controlNavScaffold.delegate("a, img", h, function (t) {
                ...
                setupManual: function () {
                  (s.controlNav = s.manualControls),
                    g.controlNav.active(),
                    s.controlNav.bind(h, function (t) {
                      if ((t.preventDefault(), "" === u || u === t.type)) {
                        var e = n(this),
                          i = s.controlNav.index(e);
                        e.hasClass(r + "active") ||
              ...
              directionNav: {
                setup: function () {
                  ...
                  s.customDirectionNav
                    ...
                    s.directionNav.bind(h, function (t) {
                      t.preventDefault();
                      var e;
                      ("" !== u && u !== t.type) ||
                        ...
                        (c =
                          m && p && s.animatingTo === s.last
                            ...
                            ? (s.itemW + s.vars.itemMargin) *
                              ...
                              s.currentSlide
                            : p
                            ? (s.last - s.currentSlide + s.cloneOffset) * h
                            : (s.currentSlide + s.cloneOffset) * h));
                }
                function n(i) {
                  i.stopPropagation();
                        ...
                        : void (
                            ...
                            !f &&
                              ...
                              (n.vars.animationLoop ||
                                (u =
                                  C /
                                  ((0 === n.currentSlide && 0 > C) ||
                                  (n.currentSlide === n.last && C > 0)
                                    ? Math.abs(C) / h + 2
                                    : 1)),
                              n.setProps(c + u, "setTouch")))
                          )
                    );
                  }
                }
                  ...
                  : ((g = function (e) {
                    ...
                    (y = function (t) {
                      (T = t.touches[0].pageX),
                        ...
                        (u = d ? a - x : a - T),
                        (b = d
                          ? Math.abs(u) < Math.abs(T - r)
                          : Math.abs(u) < Math.abs(x - r));
                      var e = 500;
                      (!b || Number(new Date()) - v > e) &&
                        ...
                        !f &&
                          ...
                          (s.vars.animationLoop ||
                            (u /=
                              (0 === s.currentSlide && 0 > u) ||
                              (s.currentSlide === s.last && u > 0)
                                ? Math.abs(u) / h + 2
                                : 1),
                          s.setProps(c + u, "setTouch")));
                    }),
                    (w = function (e) {
                      if (
                        (t.removeEventListener("touchmove", y, !1),
                        s.animatingTo === s.currentSlide && !b && null !== u)
                      ) {
                        var i = p ? -u : u,
            ...
            (s.flexAnimate = function (t, e, i, o, a) {
              if (
                ...
                if (
                  ...
                  m
                    ? ((h = s.vars.itemMargin),
                      (y = (s.itemW + h) * s.move * s.animatingTo),
                      (u = y > s.limit && 1 !== s.visible ? s.limit : y))
                    : (u =
                        0 === s.currentSlide &&
                        t === s.count - 1 &&
                        s.vars.animationLoop &&
          ...
          return (
            ...
            (e.isBadAndroid = (function () {
              ...
              if (/Android/.test(t) && !/Chrome\/\d/.test(t)) {
                ...
                return e && "object" == typeof e && e.length >= 2
          ...
          if (this.enabled && a.eventType[t.type] === this.initiated) {
            ...
            if (
              ...
              return (
                this.scrollTo(s, o),
                this.moved
                  ? this._events.flick && 200 > n && 100 > r && 100 > l
      ...
      (c.DEFAULTS = {
        ...
        (c.prototype.events = function () {
          ...
          this.options.cancelable &&
            i.on("keyup.modal.amui", function (t) {
              e.active &&
                27 === t.which &&
                (i.trigger("cancel.modal.amui"), e.close());
            }),
            this.options.dimmer &&
              this.options.closeViaDimmer &&
              !this.isLoading &&
              this.dimmer.$element.on("click.dimmer.modal.amui", function (t) {
                e.close();
              }),
            i.on(
              ...
              function (i) {
                ...
                var n = s(this);
                n.is(o)
                  ? t.closeOnConfirm && e.close()
                  : n.is(a)
                  ? t.closeOnCancel && e.close()
                  : e.close();
              }
            ),
            ...
            i
              .on("confirm.modal.amui", function (t) {
        ...
        (c.prototype.open = function (t) {
          ...
          if (i.length && !i.hasClass("am-active")) {
            ...
            c.addClass("am-offcanvas-bar-" + n),
              ...
              "overlay" !== n &&
                l.css({ "margin-left": c.outerWidth() * h }).width(),
          ...
          if (e && e.length) {
            ...
            e
              ...
              r - g < u.top + g
                ? (m = h.top - r - g)
                : r < d - u.top - u.height
                ? ((y = "bottom"), (m = h.top + c + a + g))
                : ((y = "middle"), (m = c / 2 + h.top - n / 2)),
              "top" === y || "bottom" === y
                ? ((f = l / 2 + h.left - i / 2),
                  (v = f),
                  5 > f && (f = 5),
      ...
      var n = i(1),
        ...
        l = function (t, e) {
          ...
          function c(t) {
            r &&
              (h || (h = t),
              (u = Math.min(1, Math.max((t - h) / y, 0))),
              (d = Math.round(f + g * i(u))),
              g > 0 && d > m && (d = m),
              0 > g && m > d && (d = m),
              v != d && p.scrollTop(d),
              (v = d),
        ...
        (o.prototype.init = function () {
          ...
          (this.$selector = n(s.template(this.options.tpl, o))),
            ...
            this.$element[0].disabled &&
              this.$selector.addClass(i.disabledClass),
      ...
      var c = i(1),
        ...
        d = function (t) {
          ...
          for (var e = null, i = 0, n = u.length; n > i; i++)
            if (
              u[i].text == this.options.text &&
              u[i].text.correctLevel == this.options.correctLevel
            ) {
              e = u[i].obj;
              break;
            }
      ...
      (o.DEFAULTS = {
        ...
        (o.prototype.init = function () {
          ...
          var i = this,
            o = this.$element,
            a = this.options;
          return a.H5validation && s.support.formValidation
            ? !1
        ...
        (o.prototype.validate = function (t) {
          ...
          var r = o.attr("pattern") || !1,
            ...
            c = null,
            h = null,
            u = o.is("[type=checkbox]")
              ? (h = i.find('input[name="' + t.name + '"]')).filter(":checked")
                  .length
              : o.is("[type=radio]")
          ...
          if (
            (s.debug &&
              ...
              console.log("Regex test: " + l.test(u) + ", Pattern: " + r)),
            !isNaN(p) && u.length > p && ((g.valid = !1), (g.tooLong = !0)),
            !isNaN(m) &&
              u.length < m &&
            ...
            r && !l.test(u) && u && ((g.valid = !1), (g.patternMismatch = !0));
          var b,
            T = function (t) {
              this.markField(t);
    ...
    function (t, e, i) {
      ...
      function n() {
        s('[data-am-widget="header"]').each(function () {
          return s(this).hasClass("am-header-fixed")
            ? (s("body").addClass("am-with-fixed-header"), !1)
            : void 0;
        });
      }
      var s = i(1),
        ...
        o == e && a == i
          ...
          : m.getLocation(h, function (t) {
              c.centerAndZoom(h, r),
                ...
                c.addOverlay(u),
                s
                  ? c.openInfoWindow(p, h)
                  : c.openInfoWindow(new BMap.InfoWindow(s, d), h);
            });
      }
      var o = i(1),
        a = i(2),
        ...
        i
          ...
          t.filter(".am-menu-one").each(function (t) {
            ...
            l.on("click", function () {
              ...
              (a ? h.left + h.width > u.left + u.width : h.left < u.left) &&
                ((o = r.offset()),
                c.scrollTo(
                  a ? u.width - h.left + o.left - h.width - d : o.left - h.left,
                  0,
                  400
                )),
                (e = n(this).index());
      ...
      function n() {
        ...
        function e() {
          return i() >= d
            ...
            : (!n.find(".am-navbar-actions").length && t(),
              b.show(),
              void (h.find("li").length < i()
                ? w
                    .find("li")
                    .slice(0, i() - h.find("li").length)
                    .insertBefore(b)
                : h.find("li").length > i() &&
                  (w.find("li").length
                    ? h
        ...
        if (n.length) {
          var l = s(window),
            ...
            p =
              (h.attr("class") &&
                parseInt(h.attr("class").match(/am-avg-sm-(\d+)/)[1])) ||
              3,
            m = 60,
            f = 16,
