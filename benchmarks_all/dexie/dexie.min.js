!(function (n, t) {
  ...
  function a(n, t) {
    return n === r
      ...
      : function () {
          ...
          return (
            r && (this.onsuccess = this.onsuccess ? u(r, this.onsuccess) : r),
            i && (this.onerror = this.onerror ? u(i, this.onerror) : i),
            void 0 !== o ? o : e
          );
        };
  }
    ...
    return n === r
      ...
      : function () {
          ...
          (this.onsuccess = this.onerror = null),
            ...
            e && (this.onsuccess = this.onsuccess ? u(e, this.onsuccess) : e),
            r && (this.onerror = this.onerror ? u(r, this.onerror) : r);
        };
  }
  function s(n, t) {
    return n === r
      ...
      : function (e) {
          ...
          return (
            i && (this.onsuccess = this.onsuccess ? u(i, this.onsuccess) : i),
            o && (this.onerror = this.onerror ? u(o, this.onerror) : o),
            void 0 === r ? (void 0 === a ? void 0 : a) : h(r, a)
          );
        };
  }
  function f(n, t) {
  ...
  function v(n, t, e, r) {
    Object.defineProperty(
      ...
      t,
      h(
        e && d(e, "get") && "function" == typeof e.get
    ...
    return {
      from: function (t) {
        return (
          ...
          v(n.prototype, "constructor", n),
          { extend: p.bind(null, n.prototype) }
        );
      },
    };
  }
  ...
  function C(n, t) {
    ...
    if (-1 !== u) {
      ...
      return void 0 === a ? void 0 : C(a, t.substr(u + 1));
    }
  }
  function O(n, t, e) {
    if (n && void 0 !== t && !("isFrozen" in Object && Object.isFrozen(n)))
      if ("string" != typeof t && "length" in t) {
        w("string" != typeof e && "length" in e);
        for (var r = 0, i = t.length; i > r; ++r) O(n, t[r], e[r]);
      } else {
        var o = t.indexOf(".");
        if (-1 !== o) {
          var u = t.substr(0, o),
  ...
  function T(n) {
    ...
    if (1 === arguments.length) {
      if (On(n)) return n.slice();
      if (this === Mn && "string" == typeof n) return [n];
      if ((i = Bn(n))) {
        for (e = []; (r = i.next()), !r.done; ) e.push(r.value);
        return e;
      }
      if (null == n) return [n];
    ...
    for (t = arguments.length, e = new Array(t); t--; ) e[t] = arguments[t];
    return e;
  }
  function K(n) {
    return Nn.apply([], n);
  ...
  function R(n) {
    function t(n, t, i) {
      ...
      var a = {
        ...
        subscribe: function (n) {
          -1 === a.subscribers.indexOf(n) &&
            (a.subscribers.push(n), (a.fire = t(a.fire, n)));
        },
    ...
    function e(n) {
      Cn(n).forEach(function (e) {
        var r = n[e];
        if (On(r)) t(e, n[e][0], n[e][1]);
        else {
          if ("asap" !== r)
            throw new Ln.InvalidArgument("Invalid event config");
    ...
    u.addEventType = t;
    for (var a = 1, c = arguments.length; c > a; ++a) t(arguments[a]);
    return u;
  }
  function U(n) {
    ...
    if (
      ...
      return (
        ...
        void (this._state === !1 && L(this, this._value))
      );
    }
  ...
  function W(n) {
    var t = n._listeners;
    n._listeners = [];
    for (var e = 0, r = t.length; r > e; ++e) H(n, t[e]);
    var i = n._PSD;
    --i.ref || i.finalize(),
      0 === ct &&
        (++ct,
  ...
  function G(n, t, e) {
    ...
    try {
      ...
      t._state
        ? (o = n(u))
        : (et.length && (et = []), (o = n(u)), -1 === et.indexOf(u) && en(t)),
        e.resolve(o);
    } catch (a) {
      e.reject(a);
    } finally {
  ...
  function J(n, t, r) {
    ...
    if (n._state === !1) {
      var o,
        ...
        a = n._value;
      null != a
        ? ((o = a.name || "Error"), (u = a.message || a), (i = e(a, 0)))
        : ((o = a), (u = "")),
        t.push(o + (u ? ": " + u : "") + i);
    }
    return (
      In &&
        ((i = e(n._stackHolder, 2)),
        i && -1 === t.indexOf(i) && t.push(i),
        n._prev && J(n._prev, t, r)),
      t
    );
  }
  function Q(n, t) {
  ...
  function Z() {
    ...
    for (var t = st.slice(0), e = t.length; e; ) t[--e]();
  }
  function nn(n) {
    function t() {
  ...
  function fn(n, e) {
      ...
      et.on("versionchange", function (n) {
        ...
        et.on("blocked", function (n) {
          !n.newVersion || n.newVersion < n.oldVersion
            ? console.warn("Dexie.delete('" + et.name + "') was blocked")
            : console.warn(
                "Upgrade '" +
                  et.name +
    ...
    function k(n, t, e) {
      function r() {
        return i.length
          ? U.resolve(i.shift()(t.idbtrans)).then(r)
          : U.resolve();
      }
      var i = [],
      ...
      for (r in t) {
        ...
        if (i) {
          ...
          if (i.primKey.src !== o.primKey.src)
            ...
            (u.del.length > 0 || u.add.length > 0 || u.change.length > 0) &&
              e.change.push(u);
          }
        } else e.add.push([r, o]);
      }
    ...
    function L(n, t, e) {
      ...
      if (!Xn) {
        if (!zn) return E(new Ln.DatabaseClosed(), V);
        et.open()["catch"](r);
      }
          ...
          A(
            function () {
              for (var r = 0; a > r; ++r) {
                ...
                (h._hookCtx = s),
                  (h.onerror = f),
                  r === c ? (h.onsuccess = pn(o)) : (h.onsuccess = l);
              }
            },
            function (n) {
    ...
    function Q(n, t, e, r) {
      ...
      (this.db = et),
        ...
        (this.storeNames = t),
        (this.idbtrans = null),
        (this.on = R(this, "complete", "error", "abort")),
        (this.parent = r || null),
        (this.active = !0),
        (this._tables = null),
        (this._reculock = 0),
        ...
        (this._resolve = null),
        (this._reject = null),
        (this._completion = new U(function (n, t) {
        ...
        this._completion.then(
          ...
          function (n) {
            return (
              ...
              i.parent
                ? i.parent._reject(n)
                : i.active && i.idbtrans && i.idbtrans.abort(),
              (i.active = !1),
              E(n)
            );
          }
    ...
    function $(n, t) {
      ...
      this._ctx = {
        ...
        isPrimKey:
          !o.index ||
          (u.schema.primKey.keyPath && o.index === u.schema.primKey.name),
        range: e,
        keysOnly: !1,
        dir: "next",
        unique: "",
    ...
    function en(n) {
      n.forEach(function (n) {
        for (var t in n) n[t] instanceof W && delete n[t];
      });
    }
    ...
    function Sn() {
      if (
        ((et.verno = Yn.version / 10),
        (et._dbSchema = Hn = {}),
        (Jn = g(Yn.objectStoreNames, 0)),
        0 !== Jn.length)
      ) {
        ...
        Jn.forEach(function (t) {
          for (
            var e = n.objectStore(t),
              r = e.keyPath,
              i = r && "string" == typeof r && -1 !== r.indexOf("."),
              o = new _n(
                r,
                r || "",
                !1,
    ...
    (this.version = function (n) {
      if (Yn || Xn)
        throw new Ln.Schema("Cannot add version when database is open");
      ...
      h(f.prototype, {
        stores: function (n) {
          ...
          return (
            ...
            (Hn = et._dbSchema = e),
            en([Qn, et, Q.prototype]),
            tn([Qn, et, Q.prototype, this._cfg.tables], Cn(e), tt, e),
            (Jn = Cn(e)),
            this
          );
        },
        upgrade: function (n) {
          ...
          return (
            _t(function () {
              n(
                et._createTransaction(tt, Cn(t._cfg.dbschema), t._cfg.dbschema)
              );
            }),
          ...
          Cn(n).forEach(function (e) {
            if (null !== n[e]) {
              var r = {},
                ...
                o = i.shift();
              if (o.multi)
                throw new Ln.Schema("Primary key cannot be multi-valued");
              o.keyPath && O(r, o.keyPath, o.auto ? 0 : o.keyPath),
      ...
      (this.open = function () {
        ...
        In && (it._stackHolder = t()), (Xn = !0), ($n = null), (Zn = !1);
        var e = Bn,
          r = null;
        return U.race([
          it,
          new U(function (t, e) {
            ...
            (i.onerror = un(vn(e))),
              (i.onblocked = un(Kn)),
              (i.onupgradeneeded = un(function (t) {
              ...
              (i.onsuccess = un(function () {
                if (((r = null), (Yn = i.result), vt.push(et), ot)) Sn();
                else if (Yn.objectStoreNames.length > 0)
                  try {
          ...
          ["catch"](function (n) {
            ...
            return (Xn = !1), et.close(), ($n = n), E($n, V);
          })
          ["finally"](function () {
            (Zn = !0), e();
          });
      ...
      _t(function () {
        et.on("populate").fire(et._createTransaction(tt, Jn, Hn)),
          et.on("error").fire(new Error());
      }),
      (this.transaction = function (n, t, e) {
                ...
                return U.follow(function () {
                  if ((o = e.apply(t, i)))
                    if (
                      ...
                      o = bn(o);
                    else if ("function" == typeof o.then && !d(o, "_PSD"))
                      throw new Ln.IncompatiblePromise(
                        "Incompatible Promise returned from transaction scope (read more at http://tinyurl.com/znyqjqc). Transaction scope: " +
                          e.toString()
                      );
                })
                  .uncaught(V)
        ...
        try {
          ...
          if ("r" == n || n == nt) n = nt;
            ...
            if ("rw" != n && n != tt)
              throw new Ln.InvalidArgument("Invalid transaction mode: " + n);
            n = tt;
          }
          if (a) {
            if (a.mode === nt && n === tt) {
              if (!c)
                throw new Ln.SubTransaction(
            ...
            a &&
              s.forEach(function (n) {
                if (!d(a.tables, n)) {
                  if (!c)
                    throw new Ln.SubTransaction(
                      "Table " + n + " not included in parent transaction."
                    );
                  a = null;
                }
              });
      ...
      (this.table = function (n) {
        ...
        if (!d(Qn, n))
          throw new Ln.InvalidTable("Table " + n + " does not exist");
        return Qn[n];
      }),
      p(W.prototype, {
      ...
      y(H)
        ...
        .extend({
          bulkDelete: function (n) {
            return this.hook.deleting.fire === r
              ? this._idbstore(tt, function (t, e, i, o) {
                  t(J(i, o, n, !1, r));
                })
              : this.where(":id")
                  .anyOf(n)
                    ...
                    m = v
                      ? h
                          ...
                          .then(function () {
                            ...
                            return (
                              e.reverse(), t && r.reverse(), h.bulkAdd(e, r)
                            );
                          })
                          .then(function (n) {
                            var t = v[v.length - 1];
          ...
          bulkAdd: function (n, t) {
            ...
            return this._idbstore(tt, function (o, u, a, c) {
              ...
              if (!a.keyPath && !e.schema.primKey.auto && !t)
                throw new Ln.InvalidArgument(
                  ...
                  A(
                    function () {
                      for (var e = 0, r = n.length; r > e; ++e) {
                        ...
                        var o = t && t[e],
                          u = n[e],
                          s = t ? o : y ? C(u, y) : void 0,
                          d = i.call(v, s, u, c);
                        null == s &&
                          null != d &&
                          (y ? ((u = D(u)), O(u, y, d)) : (o = d)),
                          (f = null != o ? a.add(u, o) : a.add(u)),
                          (f._hookCtx = v),
                          r - 1 > e &&
                            ((f.onerror = l), v.onsuccess && (f.onsuccess = h));
                      }
                    },
                    function (n) {
          ...
          add: function (n, t) {
            ...
            return this._idbstore(tt, function (i, o, u, a) {
              var c = { onsuccess: null, onerror: null };
              if (e !== r) {
                var s = null != t ? t : u.keyPath ? C(n, u.keyPath) : void 0,
                  f = e.call(c, s, n, a);
                null == s &&
                  null != f &&
                  (u.keyPath ? O(n, u.keyPath, f) : (t = f));
              }
              try {
                var l = null != t ? u.add(n, t) : u.add(n);
                (l._hookCtx = c),
                  (l.onerror = yn(o)),
                  (l.onsuccess = pn(function (t) {
                    var e = u.keyPath;
                    e && O(n, e, t), i(t);
                  }));
              } catch (h) {
          ...
          put: function (n, t) {
            ...
            return i !== r || o !== r
              ? this._trans(tt, function (r, i, o) {
                  var u =
                    void 0 !== t
                      ? t
                      : e.schema.primKey.keyPath &&
                        C(n, e.schema.primKey.keyPath);
                  null == u
                    ? o.tables[e.name].add(n).then(r, i)
                    : (o._lock(),
                      (n = D(n)),
                      o.tables[e.name]
                        .where(":id")
              ...
              : this._idbstore(tt, function (e, r, i) {
                  ...
                  (o.onerror = vn(r)),
                    (o.onsuccess = function (t) {
                      var r = i.keyPath;
                      r && O(n, r, t.target.result), e(o.result);
                    });
                });
          },
          delete: function (n) {
            return this.hook.deleting.subscribers.length
              ...
              : this._idbstore(tt, function (t, e, r) {
                  var i = r["delete"](n);
                  (i.onerror = vn(e)),
          ...
          clear: function () {
            return this.hook.deleting.subscribers.length
              ...
              : this._idbstore(tt, function (n, t, e) {
                  var r = e.clear();
                  (r.onerror = vn(t)),
          ...
          update: function (n, t) {
            if ("object" != typeof t || On(t))
              throw new Ln.InvalidArgument("Modifications must be an object.");
            if ("object" != typeof n || On(n))
              return this.where(":id").equals(n).modify(t);
            Cn(t).forEach(function (e) {
              O(n, e, t[e]);
            });
            var e = C(n, this.schema.primKey.keyPath);
            return void 0 === e
              ? E(
                  new Ln.InvalidArgument(
      ...
      p(Q.prototype, {
        _lock: function () {
          return (
            w(!ut.global),
            ++this._reculock,
            1 !== this._reculock || ut.global || (ut.lockOwnerFor = this),
            this
          );
        },
        _unlock: function () {
          if ((w(!ut.global), 0 === --this._reculock))
            for (
              ut.global || (ut.lockOwnerFor = null);
        ...
        create: function (n) {
          ...
          return (
            ...
            (n = this.idbtrans =
              n || Yn.transaction(kn(this.storeNames), this.mode)),
            (n.onerror = un(function (e) {
              mn(e), t._reject(n.error);
            })),
            (n.onabort = un(function (n) {
              mn(n),
                t.active && t._reject(new Ln.Abort()),
                (t.active = !1),
                t.on("abort").fire(n);
            })),
            ...
            return (
              r._locked()
                ...
                : ((i = r.active
                    ? new U(function (i, o) {
                        if (n === tt && r.mode !== tt)
                          throw new Ln.ReadOnly("Transaction is readonly");
                        !r.idbtrans && n && r.create(),
                          e && r._lock(),
                          t(i, o, r);
                      })
                    : E(new Ln.TransactionInactive())),
                  r.active &&
                    e &&
                    i["finally"](function () {
                      r._unlock();
        ...
        tables: {
          get: function () {
            return this._tables
              ? this._tables
              : (this._tables = x(this.storeNames, function (n) {
                  return [n, Qn[n]];
                }));
          },
        },
        ...
        table: function (n) {
          if (-1 === this.storeNames.indexOf(n))
            throw new Ln.InvalidTable("Table " + n + " not in transaction");
          return Qn[n];
        },
      }),
      p(Y.prototype, function () {
        function n(n, t, e) {
        ...
        return {
          between: function (e, r, i, o) {
            (i = i !== !1), (o = o === !0);
            try {
              return cn(e, r) > 0 || (0 === cn(e, r) && (i || o) && (!i || !o))
                ? t(this)
          ...
          anyOf: function () {
            ...
            o._ondirectionchange = function (n) {
              (r = "next" === n ? An : En), e.sort(r);
            };
            var u = 0;
            return (
              o._addAlgorithm(function (n, t, i) {
          ...
          inAnyRange: function (e, r) {
            ...
            if (
              !e.every(function (n) {
                return (
                  void 0 !== n[0] && void 0 !== n[1] && An(n[0], n[1]) <= 0
                );
              })
            )
              return n(
      ...
      p($.prototype, function () {
        ...
        return {
          _read: function (n, t) {
            var e = this._ctx;
            return e.error
              ? e.table._trans(null, function (n, t) {
                  t(e.error);
                })
          ...
          _write: function (n) {
            var t = this._ctx;
            return t.error
              ? t.table._trans(null, function (n, e) {
                  e(t.error);
                })
          ...
          each: function (n) {
            ...
            if (wt) {
              var e = a(t),
                ...
                i = C(
                  e,
                  t.index ? t.table.schema.idxByName[t.index].keyPath : r
                ),
                o = C(e, r);
              n(e, { key: i, primaryKey: o });
            }
          ...
          toArray: function (n) {
            ...
            return this._read(function (n, e, o) {
              if (
                (wt && n([a(t)]),
                qn && "next" === t.dir && X(t, !0) && t.limit > 0)
              ) {
                var c = t.table.hook.reading.fire,
                  s = r(t, o),
                  f =
                    t.limit < 1 / 0
                      ? s.getAll(t.range, t.limit)
                      : s.getAll(t.range);
                (f.onerror = vn(e)),
                  (f.onsuccess =
                    c === i
          ...
          primaryKeys: function (n) {
            var t = this._ctx;
            if (qn && "next" === t.dir && X(t, !0) && t.limit > 0)
              return this._read(function (n, e, i) {
                var o = r(t, i),
                  u =
                    t.limit < 1 / 0
                ...
                (u.onerror = vn(e)), (u.onsuccess = dn(n));
              }).then(n);
            t.keysOnly = !t.isMatch;
            var e = [];
            return this.each(function (n, t) {
            ...
            return (
              wt &&
                ...
                n.call(
                  ...
                  e.table.schema.instanceTemplate
                ),
              this._write(function (e, i, a, c) {
                function s(n, t) {
                  function e(n) {
                ...
                function f(n) {
                  return (
                    n && (w.push(n), k.push(x)),
                    i(new N("Error modifying one or more objects", w, b, k))
                  );
                }
                function l() {
  ...
  function wn(n, t, e, r) {
    (this.name = n),
      (this.primKey = t || new _n()),
      (this.indexes = e || [new _n()]),
      (this.instanceTemplate = r),
      (this.mappedClass = null),
      (this.idxByName = x(e, function (n) {
        return [n.name, n];
      }));
  }
  function kn(n) {
    ...
    .extend({
      stack: {
        get: function () {
          return (
            this._stack ||
            (this._stack = this.name + ": " + this.message + e(this._e, 2))
          );
        },
      },
      toString: function () {
    ...
    Ln = Rn.reduce(function (n, e) {
      function r(n, r) {
        (this._e = t()),
          ...
          n
            ? "string" == typeof n
              ? ((this.message = n), (this.inner = r || null))
              : "object" == typeof n &&
                ((this.message = n.name + " " + n.message), (this.inner = n))
            : ((this.message = Un[e] || i), (this.inner = null));
      }
      var i = e + "Error";
  ...
  p(U.prototype, {
    then: function (n, t) {
      ...
      return In && (!this._prev || null === this._state) && Q(r, this), r;
    },
    _then: function (n, t) {
    ...
    uncaught: function (n) {
      var t = this;
      return (
        (this.onuncatched = f(this.onuncatched, n)),
        this._state === !1 &&
          -1 === tt.indexOf(this) &&
          tt.some(function (n, e, r) {
  ...
  return (
    ...
    A(function () {
      fn.dependencies.localStorage =
        null !=
        ("undefined" != typeof chrome && null !== chrome
          ? chrome.storage
          : void 0)
          ? null
          : jn.localStorage;
