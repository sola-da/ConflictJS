  ...
  (function (a, b, c, d) {
    ...
    function i(a, b, c) {
      return {
        compileHtml: function (e) {
          return a(
            d.element('<div class="' + c + '">' + b.loadingTemplate + "</div>")
          )(e);
        },
          ...
          return (
            ...
            this.iterator("table", function (d) {
              ...
              (d.bDestroying = !0),
                ...
                b || new c.fn.DataTable.Api(d).columns().visible(!0),
                ...
                (d.aaSorting = []),
                (d.aaSortingFixed = []),
                c.fn.DataTable.ext.internal._fnSortingClasses(d),
      ...
      function h(h) {
        function i(b, c) {
          ...
          return (
            ...
            (r = b),
            (s = c),
            m(v.options.fnPromise, f.renderDataTable).then(function (a) {
        ...
        function p(a, b) {
          return (
            ...
            { id: t.id, DataTable: t.DataTable, dataTable: t.dataTable }
          );
        }
        var q,
          r,
      ...
      function f(b, e) {
        ...
        if (!d.isObject(b) || d.isArray(b)) f.resolve(b);
          ...
          a.all(h).then(function (a) {
            var b = 0;
            for (var d in i)
              i.hasOwnProperty(d) && -1 === c.inArray(d, j) && (i[d] = a[b++]);
            f.resolve(i);
          });
        }
        return f.promise;
    ...
    d
      ...
      d
        ...
        .constant("DT_DEFAULT_OPTIONS", { sAjaxDataProp: "", aoColumns: [] })
