 ...
 */ (function (a, b) {
  ...
  return (
    ...
    f(a.LocalStorage.prototype, {
      ...
      create: function (a) {
        return (
          !a.id && a.id !== 0 && ((a.id = c()), a.set(a.idAttribute, a.id)),
    ...
    (a.LocalStorage.sync =
      ...
      a.localSync =
        function (b, c, d) {
          var e = g(c, "localStorage") || g(c.collection, "localStorage"),
            f,
            h,
            i = a.$
          ...
          return (
            f
              ? (d &&
                  d.success &&
                  (a.VERSION === "0.9.10" ? d.success(c, f, d) : d.success(f)),
                i && i.resolve(f))
              : ((h = h ? h : "Record Not Found"),
                d &&
                  d.error &&
                  (a.VERSION === "0.9.10" ? d.error(c, h, d) : d.error(h)),
                i && i.reject(h)),
    ...
    (a.getSyncMethod = function (b, c) {
      var d = c && c.ajaxSync;
      return !d && (g(b, "localStorage") || g(b.collection, "localStorage"))
        ? a.localSync
        : a.ajaxSync;
    }),
