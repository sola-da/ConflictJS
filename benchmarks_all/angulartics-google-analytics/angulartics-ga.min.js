!(function (window, angular, undefined) {
  ...
  angular.module("angulartics.google.analytics", ["angulartics"]).config([
    ...
    function ($analyticsProvider) {
      function dimensionsAndMetrics(properties) {
        if (window.ga) {
          for (var customData = {}, idx = 1; 200 >= idx; idx++)
            "undefined" != typeof properties["dimension" + idx] &&
              (customData["dimension" + idx] = properties["dimension" + idx]),
              "undefined" != typeof properties["metric" + idx] &&
      ...
      function eventTrack(action, properties) {
        if (
          ((properties && properties.category) ||
            ((properties = properties || {}), (properties.category = "Event")),
          properties.value)
        ) {
        ...
        if (window.ga) {
          ...
          angular.extend(eventOptions, dimsAndMets),
            $analyticsProvider.settings.ga.transport &&
              angular.extend(
                eventOptions,
                $analyticsProvider.settings.ga.transport
              ),
      ...
      ($analyticsProvider.settings.pageTracking.trackRelativePath = !0),
        ...
        $analyticsProvider.registerPageTrack(function (path) {
          window._gaq &&
            ...
            window.ga &&
              ($analyticsProvider.settings.ga.userId &&
        ...
        $analyticsProvider.registerUserTimings(function (properties) {
          return properties &&
            ...
            "undefined" != typeof properties.timingValue
            ? void (window.ga && ga("send", "timing", properties))
            : void console.log(
