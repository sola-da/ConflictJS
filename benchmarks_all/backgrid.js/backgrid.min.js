(function (root, factory) {
  ...
  _.extend(DatetimeFormatter.prototype, {
    defaults: { includeDate: true, includeTime: true, includeMilli: false },
    DATE_RE: /^([+\-]?\d{4})-(\d{2})-(\d{2})$/,
  ...
  var BooleanCellEditor = (Backgrid.BooleanCellEditor = CellEditor.extend({
    tagName: "input",
    attributes: { tabIndex: -1, type: "checkbox" },
    events: {
      mousedown: function () {
        this.mouseDown = true;
      },
  ...
  var Row = (Backgrid.Row = Backbone.View.extend({
    ...
    makeCell: function (column) {
      return new (column.get("cell"))({ column: column, model: this.model });
    },
    render: function () {
      this.$el.empty();
  ...
  var Body = (Backgrid.Body = Backbone.View.extend({
    ...
    initialize: function (options) {
      ...
      this.rows = this.collection.map(function (model) {
        var row = new this.row({ columns: this.columns, model: model });
        return row;
      }, this);
      this.emptyText = options.emptyText;
