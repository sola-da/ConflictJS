...
!(function (root, factory) {
  ...
  return (
    ...
    (isEmpty = function (item) {
      return (
        null == item ||
        ((jQuery.isArray(item) || Util.isString(item)) && 0 === item.length) ||
        (jQuery.isPlainObject(item) && jQuery.isEmptyObject(item))
      );
    }),
    (allStrings = function (list) {
      var item, j, len;
      for (j = 0, len = list.length; len > j; j++)
    ...
    (isString = function (item) {
      return (
        "string" == typeof item ||
        "[object String]" === (null != item ? item.toString() : void 0)
      );
    }),
    (merge = function () {
      var args, i;
      return (
        (args = function () {
          var j, len, results;
          for (results = [], j = 0, len = arguments.length; len > j; j++)
            (i = arguments[j]), results.push(i);
          return results;
    ...
    (camelCase = function (source) {
      ...
      return (
        ...
        (words = (function () {
          var j, len, results;
          for (results = [], i = j = 0, len = words.length; len > j; i = ++j)
            (word = words[i]),
    ...
    (compact = function (arr) {
      ...
      for (results = [], j = 0, len = arr.length; len > j; j++)
        (item = arr[j]), item && results.push(item);
      return results;
    }),
    (cloneDeep = function () {
      var args;
    ...
    (contains = function (arr, item) {
      var i, j, len;
      for (j = 0, len = arr.length; len > j; j++)
        if (((i = arr[j]), i === item)) return !0;
      return !1;
    }),
    (defaults = function () {
      var a, args, first, j, len;
      if (((args = []), 1 === arguments.length)) return arguments[0];
      for (j = 0, len = arguments.length; len > j; j++)
        (a = arguments[j]), args.unshift(a);
      return (
        (first = args.pop()),
        args.unshift(first),
        jQuery.extend.apply(this, args)
    ...
    (difference = function (arr, values) {
      var item, j, len, results;
      for (results = [], j = 0, len = arr.length; len > j; j++)
        (item = arr[j]), contains(values, item) || results.push(item);
      return results;
    }),
      ...
      return (
        ...
        (Param.prototype.serialize = function () {
          ...
          return (
            (val = this.value()),
            (valid =
              Util.isArray(val) || Util.isPlainObject(val) || Util.isString(val)
                ? !Util.isEmpty(val)
                : null != val),
            null != this["short"] && valid ? this["short"] + "_" + val : ""
          );
        }),
              ...
              Util.isEmpty(array)
                ...
                : ((flat = function () {
                    ...
                    for (
                      ...
                      (t = ref[j]),
                        Util.isFunction(t.serialize)
                          ? results.push(t.serialize())
                          : results.push(t);
                    return results;
                  }.call(this)),
                  this["short"] + "_" + flat.join(this.sep)))
            : "";
        }),
        (ArrayParam.prototype.set = function (origValue) {
          return null == origValue || Util.isArray(origValue)
      ...
      return (
        ...
        (TransformationParam.prototype.serialize = function () {
          ...
          return Util.isEmpty(this.value())
            ? ""
            : Util.allStrings(this.value())
            ? ((joined = this.value().join(this.sep)),
              Util.isEmpty(joined) ? "" : this["short"] + "_" + joined)
            : ((result = function () {
                var j, len, ref, results;
                for (
                  ref = this.value(), results = [], j = 0, len = ref.length;
                  ...
                  (t = ref[j]),
                    null != t &&
                      (Util.isString(t) && !Util.isEmpty(t)
                        ? results.push(this["short"] + "_" + t)
                        : Util.isFunction(t.serialize)
                        ? results.push(t.serialize())
                        : Util.isPlainObject(t) && !Util.isEmpty(t)
      ...
      return (
        ...
        (Condition.prototype.normalize = function (value) {
          ...
          return (
            ...
            (list = (function () {
              var j, len, results;
              for (results = [], j = 0, len = list.length; len > j; j++)
                (v = list[j]),
                  null != Condition.OPERATORS[v]
        ...
        (Condition.prototype.predicate = function (name, operator, value) {
          return (
            null != Condition.OPERATORS[operator] &&
        ...
        null == options && (options = {}),
          ...
          this.toOptions ||
            (this.toOptions = function (withChain) {
              ...
              for (key in ref)
                (value = ref[key]), void 0 !== value && (opt[key] = value);
              return (
                withChain &&
          ...
          this.PARAM_NAMES ||
            (this.PARAM_NAMES = function () {
              var j, len, ref, results;
              for (
                ref = this.methods, results = [], j = 0, len = ref.length;
                len > j;
                j++
              )
      ...
      return (
          ...
          if (options instanceof TransformationBase)
            ...
            options || (options = {}),
              ...
              (options = Util.cloneDeep(options, function (value) {
                return value instanceof TransformationBase
        ...
        (TransformationBase.prototype.fromTransformation = function (other) {
          ...
          if (other instanceof TransformationBase)
            for (ref = other.keys(), j = 0, len = ref.length; len > j; j++)
        ...
        (TransformationBase.prototype.set = function (key, value) {
          ...
          return (
            ...
            Util.contains(this.methods, camelKey)
              ? this[camelKey](value)
        ...
        (TransformationBase.prototype.serialize = function () {
          ...
          switch (
            ...
            (transformationList = function () {
              ...
              for (results = [], j = 0, len = paramList.length; len > j; j++)
                (t = paramList[j]),
                  results.push(
                    null != (ref2 = this.get(t)) ? ref2.serialize() : void 0
                  );
              return results;
            }.call(this)),
            !1)
          ...
          return (
            (transformationList = (function () {
              var j, len, results;
              for (
                results = [], j = 0, len = transformationList.length;
                len > j;
                j++
              )
            ...
            (transformationString = transformationList.join(
        ...
        (TransformationBase.prototype.toHtmlAttributes = function () {
          ...
          for (key in ref)
            (value = ref[key]),
              Util.contains(this.PARAM_NAMES, key) ||
                ((attrName = /^html_/.test(key) ? key.slice(5) : key),
                (options[attrName] = value));
          for (ref1 = this.keys(), j = 0, len = ref1.length; len > j; j++)
            (key = ref1[j]),
              /^html_/.test(key) &&
      ...
      return (
        ...
        (Transformation.prototype["if"] = function (value) {
          ...
          switch ((null == value && (value = ""), value)) {
            ...
            case "end":
              for (
                this.chain(), i = j = ref = this.chained.length - 1;
                j >= 0 &&
                ((ifVal = this.chained[i].getValue("if")), "end" !== ifVal) &&
                (null == ifVal ||
        ...
        (Transformation.prototype.offset = function (value) {
          ...
          return (
            ...
            null != end_o ? this.endOffset(end_o) : void 0
          );
        }),
        ...
        (Transformation.prototype.size = function (value) {
          var height, ref;
          return Util.isFunction(null != value ? value.split : void 0)
            ? ((ref = value.split("x")),
              (width = ref[0]),
              (height = ref[1]),
              this.width(width),
      ...
      return (
        ...
        (Configuration.prototype.fromDocument = function () {
          ...
          if (
            ...
            for (j = 0, len = meta_elements.length; len > j; j++)
              (el = meta_elements[j]),
                (this.configuration[
          ...
          if (
            ((cloudinary_url =
              ...
              null != (ref1 = process.env)
                ...
                : void 0),
            null != cloudinary_url &&
              ((uri = require("url").parse(cloudinary_url, !0)),
              (this.configuration = {
                cloud_name: uri.host,
            ...
            ref2 = uri.query;
            for (k in ref2) (v = ref2[k]), (this.configuration[k] = v);
          }
          return this;
        }),
      ...
      return (
        ...
        (Cloudinary.prototype.url = function (publicId, options) {
          ...
          if (
            ...
            if (
              ((publicId = encodeURIComponent(decodeURIComponent(publicId))
                .replace(/%3A/g, ":")
                .replace(/%2F/g, "/")),
              options.url_suffix)
            ) {
        ...
        (Cloudinary.prototype.image = function (publicId, options) {
          ...
          return (
            ...
            null == options.src && img.setAttr("src", ""),
            (img = img.toDOM()),
          ...
          return (
            ...
            (responsiveResize =
              ...
              (ref1 =
                ...
                ? ref1
                : !0),
            responsiveResize && !this.responsiveResizeInitialized
          ...
          for (
            null == options && (options = {}),
              ...
              responsiveClass =
                null !=
                (ref =
                  null != (ref1 = this.responsiveConfig.responsive_class)
                    ? ref1
                    : options.responsive_class)
                  ? ref
                  : this.config("responsive_class"),
              roundDpr =
                null != (ref2 = options.round_dpr)
                  ? ref2
            ...
            (tag = elements[j]),
              (null != (ref3 = tag.tagName) ? ref3.match(/img/i) : void 0) &&
                ((setUrl = !0),
                options.responsive && Util.addClass(tag, responsiveClass),
                (src =
                ...
                Util.isEmpty(src) ||
                  ...
                  Util.hasClass(tag, responsiveClass) &&
                    /\bw_auto\b/.exec(src) &&
                    ((containerWidth = parentWidth(tag)),
                    0 !== containerWidth
                      ? ((requestedWidth = applyBreakpoints.call(
                          this,
                          tag,
                          containerWidth,
                          options
                      ...
                      : (setUrl = !1)),
                  setUrl && Util.setAttribute(tag, "src", src)));
          return this;
        }),
      ...
      return (
        ...
        (CloudinaryJQuery.prototype.responsive = function (options) {
          ...
          return (
            ...
            jQuery(
              "img." + responsiveClass + ", img.cld-hidpi"
            ).cloudinary_update(responsiveConfig),
            (responsive_resize =
              null !=
              (ref1 =
                ...
                ? ref1
                : !0),
            responsive_resize && !responsiveResizeInitialized
              ? ((responsiveConfig.resizing = responsiveResizeInitialized = !0),
                (timeout = null),
                jQuery(window).on(
                  "resize",
                  (function (_this) {
                    return function () {
                      ...
                      return (
                        (debounce =
                          ...
                          (ref3 =
                            null !=
                            (ref4 = responsiveConfig.responsive_debounce)
                              ? ref4
                              : _this.config("responsive_debounce"))
                            ? ref3
                            : 100),
        ...
        this.filter("img")
          .each(function () {
            ...
            return (
              ...
              (img_options = new Transformation(
                img_options
              ).toHtmlAttributes()),
              jQuery(this)
                .data("src-cache", url)
                .attr({ width: img_options.width, height: img_options.height })
            );
          })
    ...
    (jQuery.fn.cloudinary_update = function (options) {
      return (
        null == options && (options = {}),
        jQuery.cloudinary.cloudinary_update(
          this.filter("img").toArray(),
          options
        ),
        this
      );
    ...
    (jQuery.fn.webpify = function (options, webp_options) {
      ...
      return (
        null == options && (options = {}),
        (that = this),
        (webp_options = null != webp_options ? webp_options : options),
        webp ||
          ...
          return webp
            .done(function () {
              return jQuery(that).cloudinary(
                jQuery.extend({}, webp_options, { format: "webp" })
              );
            })
            .fail(function () {
    ...
    (jQuery.fn.fetchify = function (options) {
      return this.cloudinary(jQuery.extend(options, { type: "fetch" }));
    }),
    ...
    (jQuery.fn.cloudinary_fileupload = function (options) {
      ...
      return Util.isFunction(jQuery.fn.fileupload)
    ...
    (jQuery.fn.unsigned_cloudinary_upload = function (
      ...
      for (
        null == upload_params && (upload_params = {}),
          null == options && (options = {}),
          upload_params = Util.cloneDeep(upload_params),
          options = Util.cloneDeep(options),
          attrs_to_move = ["cloud_name", "resource_type", "type"],
          i = 0;
        i < attrs_to_move.length;

      )
        (attr = attrs_to_move[i]),
          upload_params[attr] &&
            ((options[attr] = upload_params[attr]), delete upload_params[attr]),
          i++;
        ...
        (value = upload_params[key]),
          Util.isPlainObject(value)
            ? (upload_params[key] = jQuery
                ...
                .join("|"))
            : Util.isArray(value) &&
              (value.length > 0 && jQuery.isArray(value[0])
                ? (upload_params[key] = jQuery
      ...
      return (
        ...
        options.multiple && (html_options.multiple = !0),
