  ...
  function A(A) {
    ...
    (this.options = A || {}),
      ...
      (this.add = function (A) {
        ...
        if (
          (e(this.options),
          (f = this.options.visible),
          "touch" === f && (f = this.isTouchDevice() ? "always" : "hover"),
        ...
        for (
          ...
          if (this.hasAnchorJSLink(o[r])) d.push(r);
          else {
            if (o[r].hasAttribute("id")) a = o[r].getAttribute("id");
            else {
              (h = this.urlify(o[r].textContent)), (u = h), (l = 0);
              do
                void 0 !== c && (u = h + "-" + l), (c = s.indexOf(u)), (l += 1);
              while (-1 !== c);
              (c = void 0), s.push(u), o[r].setAttribute("id", u), (a = u);
            }
            (g = a.replace(/-/g, " ")),
              (B = document.createElement("a")),
              (B.className = "anchorjs-link " + this.options.class),
              (B.href = "#" + a),
              B.setAttribute("aria-label", "Anchor link for: " + g),
              B.setAttribute("data-anchorjs-icon", this.options.icon),
              "always" === f && (B.style.opacity = "1"),
              "" === this.options.icon &&
                ((B.style.fontFamily = "anchorjs-icons"),
              ...
              "left" === this.options.placement
                ? ((B.style.position = "absolute"),
                  ...
                  o[r].insertBefore(B, o[r].firstChild))
                : ((B.style.paddingLeft = "0.375em"), o[r].appendChild(B));
          }
        for (r = 0; r < d.length; r++) o.splice(d[r] - r, 1);
        return (this.elements = this.elements.concat(o)), this;
      }),
      (this.remove = function (A) {
        for (var e, n, o = t(A), i = 0; i < o.length; i++)
          (n = o[i].querySelector(".anchorjs-link")),
            n &&
              ((e = this.elements.indexOf(o[i])),
