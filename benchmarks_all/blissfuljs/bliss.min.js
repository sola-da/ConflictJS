!(function () {
      ...
      1 >= i - r
        ? function () {
            ...
            for (var s in i) {
              ...
              o.splice(r, 1, s, i[s]), (t = e.apply(this, o));
            }
            return t;
          }
        : t(t(e, r + 1, i), r, i - 1)
  ...
  function e(t, e, r) {
    for (var i in e) {
      if (r) {
        var s = n.type(r);
        if (
          ("own" === r && !e.hasOwnProperty(i)) ||
          ("array" === s && -1 === r.indexOf(i)) ||
          ("regexp" === s && !r.test(i)) ||
          ("function" === s && !r.call(e, i))
        )
          continue;
      }
      ...
      !o || (o.writable && o.configurable && o.enumerable && !o.get && !o.set)
        ? (t[i] = e[i])
        : (delete t[i], Object.defineProperty(t, i, o));
    }
    return t;
  }
  ...
  e(n, {
    ...
    Class: function (t) {
      var e = ["constructor", "extends", "abstract", "static"].concat(
          Object.keys(n.classProps)
        ),
        r = t.hasOwnProperty("constructor") ? t.constructor : n.noop,
        i = function () {
          if (t["abstract"] && this.constructor === i)
            throw new Error(
              "Abstract classes cannot be directly instantiated."
            );
          i["super"] && i["super"].apply(this, arguments),
            r.apply(this, arguments);
        };
      (i["super"] = t["extends"] || null),
        (i.prototype = n.extend(
          Object.create(i["super"] ? i["super"].prototype : Object),
          { constructor: i }
        ));
      var s = function (t) {
      ...
      if (t["static"]) {
        n.extend(i, t["static"], s);
        for (var o in n.classProps)
          o in t["static"] && n.classProps[o](i, t["static"][o]);
      }
      n.extend(i.prototype, t, s);
      for (var o in n.classProps) o in t && n.classProps[o](i.prototype, t[o]);
      return (
        (i.prototype["super"] = i["super"] ? i["super"].prototype : null), i
      );
    },
    classProps: {
      ...
      live: t(function (t, e, r) {
        return (
          "function" === n.type(r) && (r = { set: r }),
          Object.defineProperty(t, e, {
            get: function () {
              var t = this["_" + e],
                n = r.get && r.get.call(this, t);
              return void 0 !== n ? n : t;
            },
            set: function (t) {
              var n = this["_" + e],
                i = r.set && r.set.call(this, t, n);
        ...
        (i.xhr.onload = function () {
          document.body.removeAttribute("data-loading"),
            ...
            304 === i.xhr.status
              ? t(i.xhr)
              : e(
                  n.extend(Error(i.xhr.statusText), {
                    get status() {
          ...
          (i.xhr.onerror = function () {
            document.body.removeAttribute("data-loading"),
              e(n.extend(Error("Network Error"), { xhr: i.xhr }));
          }),
          (i.xhr.ontimeout = function () {
            document.body.removeAttribute("data-loading"),
              e(n.extend(Error("Network Timeout"), { xhr: i.xhr }));
          }),
  ...
  (n.Element = function (t) {
    ...
    (n.Element.prototype = {
      ...
      fire: function (t, e) {
        ...
        return r.initEvent(t, !0, !0), this.dispatchEvent(n.extend(r, e));
      },
      unbind: t(function (t, e) {
        (t || "").split(/\s+/).forEach(function (t) {
          if (r in this && (t.indexOf(".") > -1 || !e)) {
            ...
            var n = t[1];
            t = t[0];
            var i = (this[r].bliss.listeners = this[r].bliss.listeners || {});
            for (var s in i)
              if (!t || s === t)
                for (var o, a = 0; (o = i[s][a]); a++)
                  (n && n !== o.className) ||
                    (e && e !== o.callback) ||
                    (this.removeEventListener.call(
                      this,
                      s,
                      o.callback,
                      o.capture
    ...
    (n.setProps = {
      ...
      events: function (t) {
        ...
        } else for (var c in t) n.events(this, c, t[c]);
      },
      once: t(function (t, e) {
        t = t.split(/\s+/);
        var n = this,
    ...
    (n.add = t(function (t, e, r, i) {
      (r = n.extend({ $: !0, element: !0, array: !0 }, r)),
        "function" == n.type(e) &&
          (!r.element ||
            (t in n.Element.prototype && i) ||
            (n.Element.prototype[t] = function () {
              return (
                this.subject &&
                n.defined(e.apply(this.subject, arguments), this.subject)
              );
            }),
          !r.array ||
            (t in n.Array.prototype && i) ||
            (n.Array.prototype[t] = function () {
              var t = arguments;
            ...
            (r.array || r.element) &&
              (n[t] = function () {
                var e = [].slice.apply(arguments),
                  i = e.shift(),
                  s = r.array && Array.isArray(i) ? "Array" : "Element";
                return n[s].prototype[t].apply({ subject: i }, e);
              })));
    }, 0)),
    n.add(n.Array.prototype, { element: !1 }),
    n.add(n.Element.prototype),
    n.add(n.setProps),
    n.add(n.classProps, { element: !1, array: !1 });
  var i = document.createElement("_");
  n.add(
    n.extend({}, HTMLElement.prototype, function (t) {
    ...
    if (Bliss && !Bliss.shy) {
      ...
      if (
        ...
        Object.defineProperty(Node.prototype, e, {
          get: function o() {
            return (
              Object.defineProperty(Node.prototype, e, { get: void 0 }),
              Object.defineProperty(this, e, { value: new t.Element(this) }),
              Object.defineProperty(Node.prototype, e, { get: o }),
              this[e]
            );
          },
          configurable: !0,
        ...
        Object.defineProperty(Array.prototype, e, {
          get: function () {
            return (
              Object.defineProperty(this, e, { value: new t.Array(this) }),
              this[e]
            );
          },
          configurable: !0,
        ...
        (EventTarget.prototype.addEventListener = function (t, r, s) {
          if (this && this[e] && r) {
            ...
            (o[t] = o[t] || []),
              0 === o[t].filter(i.bind(null, r, s)).length &&
                o[t].push({ callback: r, capture: s, className: a });
          }
