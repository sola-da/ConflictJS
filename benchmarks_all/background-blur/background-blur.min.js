    ...
    return this.each(function () {
      ...
      n || i.data("plugin.backgroundBlur", (n = new r(this, o))),
        "fadeIn" === e
          ...
          : "fadeOut" === e
          ? n.fadeOut()
          : "string" == typeof e && n.generateBlurredImage(e);
    });
  }
  var i = (function () {
      for (
    ...
    o = {
      ...
      setAttr: function (t, e) {
        for (var i in e)
          "href" === i
            ? t.setAttributeNS(o.xlink, i, e[i])
  ...
  (r.VERSION = "0.1.1"),
    ...
    (r.prototype.createIMG = function (t, e, i) {
      var n = this,
        ...
        r =
          2 * this.options.blurAmount > 100 ? 100 : 2 * this.options.blurAmount;
      return (
        o
          .css({
            filter:
              "progid:DXImageTransform.Microsoft.Blur(pixelradius=" + r + ") ",
