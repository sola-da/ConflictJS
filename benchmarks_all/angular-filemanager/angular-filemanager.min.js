  ...
  r.module("FileManagerApp", ["pascalprecht.translate", "ngFileUpload"]),
    ...
    n(e.document).on(
      ...
      function (r) {
        ...
        r.pageX >= e.innerWidth - i.width() && (r.pageX -= i.width()),
          ...
          i.hide().css({ left: r.pageX, top: r.pageY }).show(),
          r.preventDefault();
      }
    ),
    Array.prototype.find ||
      (Array.prototype.find = function (e) {
        ...
        for (
          var r, n = Object(this), i = n.length >>> 0, a = arguments[1], t = 0;
          i > t;
          t++
        )
        ...
        (e.config = t),
          ...
          e.$watch("temps", function () {
            e.singleSelection()
              ...
              : ((e.temp = new o({ rights: 644 })), (e.temp.multiple = !0)),
              e.temp.revert();
          }),
          ...
          (e.changeLanguage = function (e) {
            return e
              ...
              : void a.use(d.getItem("language") || t.defaultLang);
          }),
          ...
          (e.selectOrUnselect = function (r, n) {
            ...
            if (!(!r || (a && e.isSelected(r)))) {
              if (n && n.shiftKey && !a) {
                ...
                if (s && t.indexOf(s) < o) {
                  for (e.temps = []; o >= l; )
                    (d = t[l]), !e.isSelected(d) && e.temps.push(d), l++;
                  return;
                }
                if (s && t.indexOf(s) > o) {
                  for (e.temps = []; l >= o; )
              ...
              return n && !a && (n.ctrlKey || n.metaKey)
                ? void (e.isSelected(r)
                    ? e.temps.splice(i, 1)
                    : e.temps.push(r))
                : void (e.temps = [r]);
          ...
          (e.smartClick = function (r) {
            ...
            return r.isImage()
              ? e.config.previewImagesInModal
                ? e.openImagePreview(r)
                : e.apiMiddleware.download(r, !0)
              : r.isEditable()
              ? e.openEditItem(r)
              : void 0;
          }),
          ...
          (e.modalWithPathSelector = function (r) {
            return (
              (n.selectedModalPath = e.fileNavigator.currentPath), e.modal(r)
            );
          }),
          ...
          (e.changePermissions = function () {
            e.apiMiddleware
              .changePermissions(e.temps, e.temp)
              .then(function () {
          ...
          (e.download = function () {
            ...
            if (!e.selectionHas("dir"))
              return r
                ? e.apiMiddleware.download(r)
                : e.apiMiddleware.downloadMultiple(e.temps);
          }),
          (e.copy = function () {
            var r = e.singleSelection();
            if (r) {
              ...
              if (t && c(r))
                return (
                  (e.apiMiddleware.apiHandler.error = a.instant(
            ...
            e.apiMiddleware
              .copy(e.temps, n.selectedModalPath)
              .then(function () {
          ...
          (e.compress = function () {
            ...
            return i && c(e.temp)
              ...
              ? void e.apiMiddleware
                  .compress(e.temps, r, n.selectedModalPath)
                  .then(
                    function () {
                      return (
                        e.fileNavigator.refresh(),
                        e.config.compressAsync
          ...
          (e.move = function () {
            ...
            return r && c(r)
              ? ((e.apiMiddleware.apiHandler.error = a.instant(
                  "error_cannot_move_same_path"
                )),
                !1)
              : void e.apiMiddleware
                  .move(e.temps, n.selectedModalPath)
                  .then(function () {
          ...
          (e.uploadFiles = function () {
            e.apiMiddleware
              .upload(e.uploadFileList, e.fileNavigator.currentPath)
              .then(
                function () {
                  e.fileNavigator.refresh(),
                    (e.uploadFileList = []),
                ...
                function (r) {
                  var n =
                    ...
                    a.instant("error_uploading_files");
          ...
          (r.getSelectedPath = function () {
            ...
            return (
              e.singleSelection() &&
                ...
                (i += "/" + e.singleSelection().tempModel.name),
              i.replace(/\/\//, "/")
            );
          });
      },
      ...
      function (r, n) {
        ...
        return (
          ...
          (i.prototype.isEditable = function () {
            return (
              !this.isFolder() && r.isEditableFilePattern.test(this.model.name)
            );
          }),
          ...
          (i.prototype.isExtractable = function () {
            return (
              !this.isFolder() &&
              r.isExtractableFilePattern.test(this.model.name)
            );
          }),
          (i.prototype.isSelectable = function () {
            return (
              (this.isFolder() && r.allowedActions.pickFolders) ||
              (!this.isFolder() && r.allowedActions.pickFiles)
            );
          }),
          i
        );
    ...
    r.filter("strLimit", [
      ...
      r.filter("fileExtension", [
        ...
        function (e) {
          return function (r) {
            return (
              (/\./.test(r) && e("strLimit")(r.split(".").pop(), 3, "..")) || ""
            );
          };
        },
      ]),
        ...
        function () {
          return function (e) {
            return e instanceof Date
              ? e.toISOString().substring(0, 19).replace("T", " ")
        ...
        return (
          (o.prototype.deferredHandler = function (e, r, n, i) {
            return (
              (e && "object" == typeof e) ||
                (this.error =
                  "Error %s - Bridge response error, please check the API docs or this ajax response.".replace(
                    "%s",
                    n
                  )),
              404 == n &&
                (this.error =
                  "Error 404 - Backend bridge is not working, please check the ajax response."),
          ...
          (o.prototype.upload = function (e, r, i) {
            ...
            for (var s = { destination: r }, l = 0; l < i.length; l++)
              s["file-" + l] = i[l];
            return (
              i &&
                i.length &&
                t
                  ...
                  .then(
                    ...
                    function (e) {
                      a.progress =
                        Math.min(100, parseInt((100 * e.loaded) / e.total)) - 1;
                    }
                  )
                  ["finally"](function () {
              ...
              e
                ...
                .error(function (e, r) {
                  t.deferredHandler(
                    ...
                    o,
                    r,
                    a.instant("error_getting_content")
                  );
                })
                ["finally"](function () {
                  t.inprocess = !1;
          ...
          (o.prototype.download = function (r, t, o, s, l) {
            ...
            if (!s || l || !i.saveAs)
              return (
                !i.saveAs &&
                  i.console.log(
                    "Your browser dont support ajax download, downloading by default"
                  ),
                !!i.open(c, "_blank", "")
              );
            var p = n.defer();
              ...
              e
                ...
                .error(function (e, r) {
                  t.deferredHandler(
                    ...
                    o,
                    r,
                    a.instant("error_creating_folder")
                  );
                })
                ["finally"](function () {
                  t.inprocess = !1;
      ...
      function (e, r, n) {
        ...
        return (
          ...
          (i.prototype.download = function (e, n) {
            ...
            return e.isFolder()
              ? void 0
              : this.apiHandler.download(
                  r.downloadFileUrl,
                  i,
                  a,
                  r.downloadFilesByAjax,
                  n
                );
          }),
          ...
          (i.prototype.compress = function (e, n, i) {
            ...
            return this.apiHandler.compress(
              r.compressUrl,
              a,
              n,
              this.getPath(i)
      ...
      function (e, r, n) {
        ...
        return (
          ...
          (i.prototype.list = function () {
            return this.apiMiddleware.list(
              this.currentPath,
          ...
          (i.prototype.buildTree = function (e) {
            function r(e, n, i) {
              ...
              e.nodes = e.nodes.sort(function (e, r) {
                return e.name.toLowerCase() < r.name.toLowerCase()
                  ? -1
          ...
          (i.prototype.folderClick = function (e) {
            (this.currentPath = []),
              e &&
                e.isFolder() &&
                (this.currentPath = e.model.fullPath().split("/").splice(1)),
              this.refresh();
          }),
    ...
    e.module("FileManagerApp").provider("fileManagerConfig", function () {
      var r = {
        ...
        isEditableFilePattern:
          /\.(txt|diff?|patch|svg|asc|cnf|cfg|conf|html?|.html|cfm|cgi|aspx?|ini|pl|py|md|css|cs|js|jsp|log|htaccess|htpasswd|gitignore|gitattributes|env|json|atom|eml|rss|markdown|sql|xml|xslt?|sh|rb|as|bat|cmd|cob|for|ftn|frm|frx|inc|lisp|scm|coffee|php[3-6]?|java|c|cbl|go|h|scala|vb|tmpl|lock|go|yml|yaml|tsv|lst)$/i,
        ...
        e.useSanitizeValueStrategy(null),
          e.translations("en", {
            ...
            enter_folder_name_for_extraction:
              "Enter the folder name for the extraction of",
            ...
            error_compressing:
              "An error occurred compressing the file or folder",
            ...
            error_getting_content:
              "An error occurred getting the content of the file",
            error_changing_perms:
              "An error occurred changing the permissions of the file",
          ...
          e.translations("he", {
            ...
            compress: "כווץ",
            error_invalid_filename:
              "שם קובץ אינו תקין או קיים, ציין שם קובץ אחר",
          ...
          e.translations("pt", {
            ...
            extraction_started:
              "A extração começou em um processo em segundo plano",
            compression_started:
              "A compressão começou em um processo em segundo plano",
            enter_folder_name_for_extraction:
              "Digite o nome da pasta para a extração de",
            enter_file_name_for_compression:
              "Digite o nome do arquivo para a compressão de",
            ...
            compress: "Comprimir",
            error_invalid_filename:
              "Nome do arquivo inválido ou nome de arquivo já existe, especifique outro nome",
            ...
            error_compressing:
              "Ocorreu um erro ao comprimir o arquivo ou pasta",
            ...
            error_changing_perms:
              "Ocorreu um erro ao alterar as permissões do arquivo",
          ...
          e.translations("es", {
            ...
            extraction_started:
              "La extraccion ha comenzado en un proceso de segundo plano",
            compression_started:
              "La compresion ha comenzado en un proceso de segundo plano",
            enter_folder_name_for_extraction:
              "Ingrese el nombre de la carpeta para la extraccion de",
            enter_file_name_for_compression:
              "Ingrese el nombre del archivo para la compresion de",
            ...
            compress: "Comprimir",
            error_invalid_filename:
              "El nombre del archivo es invalido o ya existe",
            error_modifying:
              "Ocurrio un error al intentar modificar el archivo",
            ...
            error_compressing:
              "Ocurrio un error al intentar comprimir el archivo",
            error_extracting: "Ocurrio un error al intentar extraer el archivo",
            error_creating_folder:
              "Ocurrio un error al intentar crear la carpeta",
            error_getting_content:
              "Ocurrio un error al obtener el contenido del archivo",
            error_changing_perms:
              "Ocurrio un error al cambiar los permisos del archivo",
          ...
          e.translations("fr", {
            ...
            enter_folder_name_for_extraction:
              "Entrer le nom du dossier pour l'extraction de",
            enter_file_name_for_compression:
              "Entrez le nom de fichier pour la compression de",
            ...
            compress: "Compresser",
            error_invalid_filename:
              "Nom de fichier invalide ou déjà existant, merci de spécifier un autre nom",
            error_modifying:
              "Une erreur est survenue pendant la modification du fichier",
            error_deleting:
              "Une erreur est survenue pendant la suppression du fichier ou du dossier",
            error_renaming:
              "Une erreur est survenue pendant le renommage du fichier",
            error_copying:
              "Une erreur est survenue pendant la copie du fichier",
            error_compressing:
              "Une erreur est survenue pendant la compression du fichier ou du dossier",
            error_extracting:
              "Une erreur est survenue pendant l'extraction du fichier",
            error_creating_folder:
              "Une erreur est survenue pendant la création du dossier",
            error_getting_content:
              "Une erreur est survenue pendant la récupération du contenu du fichier",
            error_changing_perms:
              "Une erreur est survenue pendant le changement des permissions du fichier",
            error_uploading_files:
              "Une erreur est survenue pendant l'upload des fichiers",
            sure_to_start_compression_with:
              "Êtes-vous sûre de vouloir compresser",
            owner: "Propriétaire",
            group: "Groupe",
            others: "Autres",
            read: "Lecture",
          ...
          e.translations("de", {
            ...
            enter_folder_name_for_extraction:
              "Geben sie den verzeichnisnamen für die entpackung an, von",
            enter_file_name_for_compression:
              "Geben sie den dateinamen für die kompression von",
            ...
            error_invalid_filename:
              "Ungültiger Dateiname oder existiert bereits",
            error_modifying:
              "Beim Bearbeiten der Datei ist ein Fehler aufgetreten",
            error_deleting:
              "Beim Löschen der Datei oder des Ordners ist ein Fehler aufgetreten",
            error_renaming:
              "Beim Umbennenen der Datei ist ein Fehler aufgetreten",
            error_copying: "Beim Kopieren der Datei ist ein Fehler aufgetreten",
            error_compressing:
              "Beim Komprimieren der Datei oder des Ordners ist ein Fehler aufgetreten",
            error_extracting:
              "Beim Entpacken der Datei ist ein Fehler aufgetreten",
            error_creating_folder:
              "Beim Erstellen des Ordners ist ein Fehler aufgetreten",
            error_getting_content:
              "Beim Holen des Dateiinhalts ist ein Fehler aufgetreten",
            error_changing_perms:
              "Beim Ändern der Dateiberechtigungen ist ein Fehler aufgetreten",
            error_uploading_files:
              "Beim Hochladen der Dateien ist ein Fehler aufgetreten",
            sure_to_start_compression_with:
          ...
          e.translations("sk", {
            ...
            enter_folder_name_for_extraction:
              "Zadajte názov priečinka na rozbalenie",
            enter_file_name_for_compression:
              "Zadajte názov súboru pre kompresiu",
            ...
            no_folders_in_folder:
              "Tento priečinok neobsahuje žiadne ďalšie priećinky",
          ...
          e.translations("ru", {
            ...
            compress: "Сжать",
            error_invalid_filename:
              "Имя неверное или уже существует, выберите другое",
          ...
          e.translations("tr", {
            ...
            enter_folder_name_for_extraction:
              "Çıkarılması için klasör adı girin",
            enter_file_name_for_compression:
              "Sıkıştırılması için dosya adı girin",
            ...
            compress: "Sıkıştır",
            error_invalid_filename:
              "Geçersiz dosya adı, bu dosya adına sahip dosya mevcut",
            ...
            error_compressing:
              "Dosya veya klasör sıkıştırılırken bir hata oluştu",
            ...
            error_changing_perms:
              "Dosyanın izini değiştirilirken bir hata oluştu",
            error_uploading_files: "Dosyalar yüklenirken bir hata oluştu",
            sure_to_start_compression_with:
              "Sıkıştırmak istediğinden emin misin",
            owner: "Sahip",
            group: "Grup",
            others: "Diğerleri",
            read: "Okuma",
          ...
          e.translations("fa", {
            ...
            extraction_started:
              "یک پروسه در پس زمینه شروع به خارج کردن از حالت فشرده کرد",
            compression_started: "یک پروسه در پس زمینه شروع به فشرده سازی کرد",
            enter_folder_name_for_extraction:
              "نام پوشه مقصد برای خارج کردن از حالت فشرده را وارد کنید",
            enter_file_name_for_compression:
              "نام پوشه مقصد برای فشرده سازی را وارد کنید",
            ...
            compress: "فشرده سازی",
            error_invalid_filename:
              "نام فایل مورد درست نیست و یا قبلا استفاده شده است، لطفا نام دیگری وارد کنید",
            ...
            error_extracting:
              "در هنگام خارک کردن فایل از حالت فشرده خطایی پیش آمد",
            error_creating_folder: "در هنگام ساخت پوشه خطایی پیش امد",
            error_getting_content:
              "در هنگام بارگذاری محتویات فایل خطایی رخ داد",
