...
!(function (a, angular, b) {
  ...
  function d() {
    ...
    (this.broadcastPermissionStartEvent = function () {
      throw new Error(
        "Method broadcastPermissionStartEvent in TransitionEvents interface must be implemented"
      );
    }),
      (this.broadcastPermissionAcceptedEvent = function () {
        throw new Error(
          "Method broadcastPermissionAcceptedEvent in TransitionEvents interface must be implemented"
        );
      }),
      (this.broadcastPermissionDeniedEvent = function () {
        throw new Error(
          "Method broadcastPermissionDeniedEvent in TransitionEvents interface must be implemented"
        );
      });
  }
  function e(a, b) {
    ...
    return (
      (c.prototype.validatePermission = function () {
  ...
  function f(a, b, c) {
    ...
    function f(a, b) {
      ...
      if (!angular.isArray(b) && !angular.isFunction(b))
        throw new TypeError(
          'Parameter "validationFunction" must be array or function'
        );
    }
    return (
      (d.prototype.validateRole = function () {
  ...
  function g(a) {
    ...
    var i = {};
    (this.definePermission = b),
      (this.defineManyPermissions = c),
      (this.removePermissionDefinition = d),
      (this.hasPermissionDefinition = e),
      (this.getPermissionDefinition = f),
      (this.getStore = g),
      (this.clearStore = h);
  }
  function h(a) {
    ...
    var i = {};
    (this.defineRole = b),
      (this.defineManyRoles = c),
      (this.getRoleDefinition = f),
      (this.hasRoleDefinition = e),
      (this.removeRoleDefinition = d),
      (this.getStore = g),
      (this.clearStore = h);
  }
  function i(a, b, c, d) {
    ...
    return {
      ...
      controller: [
        ...
        function (e, f) {
          function g() {
            angular.isFunction(i.onAuthorized)
              ? i.onAuthorized()(f)
              : d.showElement(f);
          }
          function h() {
            angular.isFunction(i.onUnauthorized)
              ? i.onUnauthorized()(f)
              : d.hideElement(f);
          }
          var i = this;
  ...
  function k(a, b, c, d) {
    ...
    function e(a) {
      (a = a || {}),
        (this.only = h(a.only)),
        (this.except = h(a.except)),
        (this.redirectTo = a.redirectTo);
    }
    function f(c, d) {
    ...
    function g(b, c) {
      if (!angular.isDefined(b["default"]))
        throw new ReferenceError(
          'When used "redirectTo" as object, property "default" must be defined'
        );
      var d = b[c];
      return (
        angular.isDefined(d) || (d = b["default"]),
        angular.isFunction(d)
          ? f(d, c)
          : angular.isObject(d)
          ? a.resolve(d)
          : angular.isString(d)
    ...
    return (
      (e.prototype.resolveRedirectState = function (b) {
        return angular.isFunction(this.redirectTo)
          ? f(this.redirectTo, b)
          : angular.isObject(this.redirectTo)
          ? g(this.redirectTo, b)
          : angular.isString(this.redirectTo)
          ? a.resolve({ state: this.redirectTo })
          : a.reject();
      }),
  ...
  (c.$inject = ["$delegate"]),
    (e.$inject = ["$q", "TransitionProperties"]),
    (f.$inject = ["$q", "PermissionStore", "TransitionProperties"]),
    (g.$inject = ["Permission"]),
    (h.$inject = ["Role"]),
    (i.$inject = [
      "$log",
  ...
  var l = angular.module("permission", []);
  "undefined" != typeof module &&
    "undefined" != typeof exports &&
    module.exports === exports &&
    (module.exports = l.name),
    angular.module("permission").decorator("$q", c);
  var m = {
  ...
  angular.module("permission").value("PermissionStrategies", m);
  var n = {};
  angular.module("permission").value("TransitionProperties", n),
    angular.module("permission").service("TransitionEvents", d),
    angular.module("permission").factory("Permission", e),
    angular.module("permission").factory("Role", f),
    angular.module("permission").service("PermissionStore", g),
    angular.module("permission").service("RoleStore", h),
    angular.module("permission").directive("permission", i),
    angular.module("permission").service("Authorization", j),
    angular.module("permission").factory("PermissionMap", k);
