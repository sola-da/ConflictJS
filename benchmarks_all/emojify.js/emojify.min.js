 ...
 */ !(function (a, b) {
  ...
  var a = (function () {
    ...
    function d(a, b, c) {
      var d = l.createElement(p.emojify_tag_type || "img");
      p.emojify_tag_type && "img" !== p.emojify_tag_type
        ? d.setAttribute("class", "emoji emoji-" + c)
        : (d.setAttribute("class", "emoji"),
          d.setAttribute("src", p.img_dir + "/" + c + ".png")),
        d.setAttribute("title", ":" + c + ":"),
        d.setAttribute("alt", ":" + c + ":"),
        d.setAttribute("align", "absmiddle"),
        a.splitText(b.index),
        (a.nextSibling.nodeValue = a.nextSibling.nodeValue.substr(
          b[0].length,
          a.nextSibling.nodeValue.length
        )),
        d.appendChild(a.splitText(b.index)),
    ...
    function e(a) {
      if (a[1] && a[2]) {
        ...
        for (var c = 3; c < a.length - 1; c++) if (a[c]) return j[c - 2][1];
    }
    function f(a, b) {
      return this.config.emojify_tag_type &&
    ...
    function h(c, d) {
      ...
      d || (d = f), (j = a()), (k = b());
      var e = new g();
      return c.replace(k, function () {
        var a = Array.prototype.slice.call(arguments, 0, -2),
          b = arguments[arguments.length - 2],
          c = arguments[arguments.length - 1],
          f = e.validate(a, b, c);
        return f ? d.apply({ config: p }, [arguments[0], f]) : arguments[0];
      });
    }
    function i(c) {
      (j = a()),
        (k = b()),
        "undefined" == typeof c &&
          (c = p.only_crawl_id ? l.getElementById(p.only_crawl_id) : l.body);
      for (
        var f,
          h = p.ignored_tags,
          i = l.createTreeWalker(
            c,
            NodeFilter.SHOW_TEXT | NodeFilter.SHOW_ELEMENT,
            function (a) {
              return 1 !== a.nodeType
                ? NodeFilter.FILTER_ACCEPT
                : h[a.tagName] || a.classList.contains("no-emojify")
      ...
      m.forEach(function (a) {
        for (var b, c = [], f = new g(); null !== (b = k.exec(a.data)); )
          f.validate(b, b.index, b.input) && c.push(b);
    ...
    return (
      (g.prototype = {
        validate: function (a, b, d) {
          function f() {
            return (g.lastEmojiTerminatedAt = j + b), h;
          }
          var g = this,
            h = e(a);
          if (h) {
            var i = a[0],
              j = i.length;
            if (0 === b) return f();
            if (d.length === i.length + b) return f();
            var k = this.lastEmojiTerminatedAt === b;
            if (k) return f();
            if (c(d.charAt(b - 1))) return f();
            var l = c(d.charAt(i.length + b));
            return l && k ? f() : void 0;
          }
        },
      }),
