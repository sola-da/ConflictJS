      ...
      if (
        ...
        (u.add = function () {
          var e,
            ...
            r = t.length,
            a = !1;
          do (e = t[n] + ""), -1 === o(this, e) && (this.push(e), (a = !0));
          while (r > ++n);
        ...
        try {
          a.defineProperty(r, t, g);
        } catch (h) {
          -2146823252 === h.number &&
            ((g.enumerable = !1), a.defineProperty(r, t, g));
        }
      } else a[n].__defineGetter__ && r.__defineGetter__(t, d);
    }
  })(self),
  /*!
   ...
   */ (function () {
    ...
    function s(e) {
      e.classList.remove("collapsing"),
        ...
        "0px" !== e.style.height &&
          (e.classList.add("in"), (e.style.height = "auto"));
    }
    function l(e) {
      e.preventDefault();
      var n = t(e),
        r = n.dataTarget;
      return (
        r.classList.contains("in") ? i(r, n.evTarget) : a(r, n.evTarget), !1
      );
    }
    function o(e) {
      function n() {
        try {
          i.parentNode.removeChild(i), r(i, "closed.bs.alert");
        } catch (e) {
      ...
      var a = t(e),
        i = a.dataTarget;
      if (!i) {
        var s = a.evTarget.parentNode;
        s.classList.contains("alert")
          ? (i = s)
          : s.parentNode.classList.contains("alert") && (i = s.parentNode);
      }
      return (
        r(i, "close.bs.alert"),
        i.classList.remove("in"),
        d && i.classList.contains("fade")
          ? i.addEventListener(
              d,
              function () {
                n();
    ...
    function u(e) {
      ...
      return (
        ...
        e.relatedTarget &&
          "dropdown" !== e.relatedTarget.getAttribute("data-toggle") &&
    ...
    for (
      var d = e(),
        g = document.querySelectorAll("[data-toggle=collapse]"),
        h = 0,
        f = g.length;
      f > h;
      h++
    ...
    for (
      var y,
        E = document.querySelectorAll("[data-toggle=dropdown]"),
        w = 0,
        b = E.length;
      b > w;
      w++
