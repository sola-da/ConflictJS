    ...
    function ($parse, $cookieStore, $window, $log) {
      ...
      var publicMethods = {
        set: function (key, value) {
          if (!supported) {
            try {
              ...
              $log.log(
                "Local Storage not supported, make sure you have angular-cookies enabled."
              );
            }
          }
        ...
        bind: function ($scope, key, opts) {
          ...
          var defaultOpts = { defaultValue: "", storeName: "" };
          ...
          if (
            publicMethods.get(storeName) === null &&
            typeof scopeVal === "undefined"
          ) {
          ...
          watchers[watcherId] = $scope.$watch(
            key,
            function (val) {
