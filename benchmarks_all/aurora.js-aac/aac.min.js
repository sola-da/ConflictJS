...
})(
  {
        ...
        var ADTSDemuxer = AV.Demuxer.extend(function () {
          ...
          this.probe = function (stream) {
            ...
            while (stream.available(2)) {
              if ((stream.readUInt16() & 65526) === 65520) {
                stream.seek(offset);
                return true;
              }
            }
    ...
    2: [
      function (require, module, exports) {
        ...
        const CCE_SCALE = new Float32Array([
          1.0905077326652577, 1.189207115002721, 1.4142135623730951, 2,
        ]);
      ...
      function (require, module, exports) {
        ...
        var AACDecoder = AV.Decoder.extend(function () {
          ...
          this.prototype.setCookie = function (buffer) {
            ...
            switch (this.config.profile) {
              ...
              case AOT_AAC_LTP:
                ...
                if (stream.read(1)) stream.advance(14);
                if (stream.read(1)) {
          ...
          this.prototype.readChunk = function () {
            ...
            if (stream.peek(12) === 4095) ADTSDemuxer.readHeader(stream);
            this.cces = [];
            var elements = [],
              config = this.config,
    ...
    6: [
      function (require, module, exports) {
        ...
        function generateSineWindow(len) {
          ...
          for (var i = 0; i < len; i++) {
            d[i] = Math.sin((i + 0.5) * (Math.PI / (2 * len)));
          }
          return d;
        }
    ...
    8: [
      function (require, module, exports) {
        ...
        ICStream.ZERO_BT = 0;
        ICStream.FIRST_PAIR_BT = 5;
        ICStream.ESC_BT = 11;
        ICStream.NOISE_BT = 13;
        ICStream.INTENSITY_BT2 = 14;
        ICStream.INTENSITY_BT = 15;
    ...
    10: [
      function (require, module, exports) {
        exports.MDCT_TABLE_2048 = [
          [0.031249997702054, 11984224612e-15],
          ...
          [83889473581e-15, 0.031249887400697],
        ];
        ...
        exports.MDCT_TABLE_1920 = [
          [0.032274858518097, 13202404176e-15],
          ...
          [92416705518e-15, 0.032274728903884],
        ];
    ...
    12: [
      function (require, module, exports) {
        ...
        const TNS_MAX_ORDER = 20,
          SHORT_BITS = [1, 4, 3],
          LONG_BITS = [2, 6, 5];
        const TNS_COEF_1_3 = [0, -0.43388373, 0.64278758, 0.34202015],
          TNS_COEF_0_3 = [
            0, -0.43388373, -0.7818315, -0.9749279, 0.98480773, 0.86602539,
            0.64278758, 0.34202015,
          ],
          TNS_COEF_1_4 = [
            0, -0.2079117, -0.40673664, -0.58778524, 0.67369562, 0.52643216,
            0.36124167, 0.18374951,
          ],
          TNS_COEF_0_4 = [
            0, -0.2079117, -0.40673664, -0.58778524, -0.74314481, -0.86602539,
