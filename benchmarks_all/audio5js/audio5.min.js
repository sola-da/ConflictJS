...
(function (t, i, e) {
    ...
    r = {
      ...
      subscribe: function (t, i, e, s) {
        void 0 === this.channels && (this.channels = {}),
          ...
          this.channels[t].push({ fn: i, ctx: e, once: s || !1 });
      },
      trigger: function (t) {
        if (this.channels && this.channels.hasOwnProperty(t)) {
          for (
            var i = Array.prototype.slice.call(arguments, 1), e = [];
            this.channels[t].length > 0;

          ) {
            var s = this.channels[t].shift();
            "function" == typeof s.fn && s.fn.apply(s.ctx, i),
              s.once || e.push(s);
          }
          this.channels[t] = e;
        }
    ...
    d = {
      ...
      embedFlash: function (e, s) {
        ...
        if (
          ...
          "object" == typeof i.swfobject)
        ) {
          var a = {
              playerInstance: "window." + t + "_flash.instances['" + s + "']",
            },
            o = { allowscriptaccess: "always", wmode: "transparent" };
          (n.innerHTML = '<div id="' + s + '"></div>'),
            swfobject.embedSWF(
  ...
  var h,
    ...
    f = (i[t + "_flash"] = i[t + "_flash"] || { instances: {}, count: 0 });
  (u = function () {
    ...
    (u.prototype = {
      ...
      eiTimeUpdate: function (t, i, e) {
        (this.position = t),
          (this.duration = i),
          (this.seekable = e),
          this.trigger("timeupdate", t, this.seekable ? i : null);
      },
      ...
      volume: function (t) {
        return void 0 === t || isNaN(parseInt(t, 10))
          ? this.vol
          : (this.audio.setVolume(t), (this.vol = t), void 0);
      },
      seek: function (t) {
        try {
        ...
        if (this.audio && this.playing) {
          try {
            (this.position = this.audio.currentTime),
              (this.duration =
                1 / 0 === this.audio.duration ? null : this.audio.duration);
          } catch (t) {}
  ...
  return (
    ...
    (h.prototype = {
      ...
      getPlayer: function () {
        ...
        if (this.settings.use_flash)
          ...
          void 0 === e &&
            ...
            (e = this.settings.use_flash ? new u() : new l()),
      ...
      volume: function (t) {
        return void 0 === t || isNaN(parseInt(t, 10))
          ? this.vol
          : (this.audio.volume(t), (this.vol = t), void 0);
      },
      seek: function (t) {
      ...
      onTimeUpdate: function (t, i) {
        (this.position = this.settings.format_time ? d.formatTime(t) : t),
          this.duration !== i &&
            (this.duration =
              this.settings.format_time && null !== i ? d.formatTime(i) : i),
          this.trigger("timeupdate", this.position, this.duration);
      },
