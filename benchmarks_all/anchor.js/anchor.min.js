!(function (a) {
  (window.anchor = {
    ...
    init: function (b) {
      return (
        a(this).data("settings", a.extend(anchor.settings, b)),
        this.each(function () {
          var b = a(this);
          b.unbind("click").click(function (a) {
            a.preventDefault(),
              anchor.jumpTo(anchor.getTopOffsetPosition(b), b.data("settings"));
          });
        })
      );
    },
    ...
    (a.fn.anchor = function (b) {
      return anchor[b]
        ? anchor[b].apply(this, Array.prototype.slice.call(arguments, 1))
        : "object" != typeof b && b
        ? a.error("Method " + b + " does not exist on jQuery.anchor")
        : anchor.init.apply(this, arguments);
    });
})(jQuery);
