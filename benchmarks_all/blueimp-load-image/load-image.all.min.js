    ...
    (t.scale = function (e, i) {
      ...
      if (
        (S &&
          ...
          i.sourceWidth
            ? ((d = i.sourceWidth),
              void 0 !== i.right && void 0 === i.left && (c = b - d - i.right))
            : (d = b - c - (i.right || 0)),
          i.sourceHeight
            ? ((u = i.sourceHeight),
        ...
        S && r && n && i.crop
          ? ((y = r),
            ...
            0 > m
              ...
              : m > 0 &&
                ((d = (r * u) / n),
                void 0 === i.left && void 0 === i.right && (c = (b - d) / 2)))
          : ((i.contain || i.cover) && ((s = r = r || s), (l = n = n || l)),
            i.cover ? (o(), a()) : (a(), o())),
        S)
      ) {
        if (
          ...
          f > 1 &&
            ...
            (y *= f),
            (v *= f),
            p.getContext("2d").scale(f, f)),
          (h = i.downsamplingRatio),
          h > 0 && 1 > h && d > y && u > v)
        )
          for (; d * h > y; )
            (p.width = d * h),
  ...
  (function (e) {
    ...
    (e.hasCanvasOption = function (i) {
      ...
      (e.getTransformedOptions = function (t, i) {
        ...
        return (
          n.orientation > 4 &&
            ((o.maxWidth = n.maxHeight),
            (o.maxHeight = n.maxWidth),
            (o.minWidth = n.minHeight),
            (o.minHeight = n.minWidth),
            (o.sourceWidth = n.sourceHeight),
            (o.sourceHeight = n.sourceWidth)),
          o
        );
      });
  }),
            ...
            function (t) {
              ...
              if (65496 === c.getUint16(0)) {
                ...
                !a.disableImageHead &&
                  h > 6 &&
                  (u.slice
                    ? (n.imageHead = u.slice(0, h))
                    : (n.imageHead = new Uint8Array(u).subarray(0, h)));
