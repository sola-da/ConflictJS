...
(function (_1, _2) {
  ...
  if (1) {
    var _58 = function (_59) {
      ...
      _62 = function (_63, _64) {
        _9(_63, function (_65) {
          _64.push([
            _7(_65[0]) ? new RegExp("^" + _5f(_65[0]) + "$") : _65[0],
            _65[1],
          ]);
        });
      },
      ...
      _6a = function (_6b, _6c, _6d) {
        for (var p in _6b) {
          ...
          if (1 && p == "async") {
            var _6e = _6b[p];
            req.legacyMode = _26 =
              _7(_6e) && /sync|legacyAsync/.test(_6e)
                ? _6e
                : !_6e
                ? _27
                : false;
    ...
    if (has("dojo-cdn") || 1) {
      ...
      while (i < _74.length) {
        ...
        if (
          (src =
            _75.getAttribute("data-dojo-config") ||
            _75.getAttribute("djConfig"))
        ) {
  ...
  var _7b = function (_7c) {
    ...
    _87 = function (pid, mid, _a0, url) {
      if (1) {
        ...
        return { pid: pid, mid: mid, pack: _a0, url: url, executed: 0, def: 0 };
      }
    },
    ...
    _b6 = function (_b7, _b8, _b9) {
      return _b7.normalize
        ? _b7.normalize(_b8, function (mid) {
            return _ba(mid, _b9);
          })
        : _ba(_b8, _b9);
    },
    ...
    _32 = function (mid, _bc, _bd) {
      ...
      if (_be) {
        ...
        _c1 = { plugin: _bf, mid: mid, req: _5e(_bc), prid: _c0 };
      } else {
        _c1 = _5d(mid, _bc);
      }
    ...
    _c7 = { injected: _22, executed: _25, def: _23, result: _23 },
    _c8 = function (mid) {
      return (_30[mid] = _c({ mid: mid }, _c7));
    },
    _c9 = _c8("require"),
    _ca = _c8("exports"),
    _cb = _c8("module"),
    ...
    _d5 = function (_d6) {
      ...
      _9(_d6.loadQ, function (_d7) {
        var _d8 = _b6(_d6, _d7.prid, _d7.req.module),
          mid = _d6.dynamic
            ? _d7.mid.replace(/waitingForPlugin$/, _d8)
            : _d6.mid + "!" + _d8,
          _d9 = _c(_c({}, _d7), { mid: mid, prid: _d8, injected: 0 });
        if (!_30[mid]) {
          _eb((_30[mid] = _d9));
        }
        map[_d7.mid] = _30[mid];
  ...
  if (0) {
    req.undef = function (_e8, _e9) {
      var _ea = _32(_e8, _e9);
      _34(_ea);
      _c(_ea, { def: 0, executed: 0, injected: 0, node: 0 });
    };
  }
  if (1) {
    ...
    var _40 =
        ...
        if (has("config-dojo-loader-catches")) {
          try {
            if (_f0 === _8f) {
              ...
              req.eval(
                _f0,
                has("dojo-loader-eval-hint-url") ? _f1.url : _f1.mid
              );
            }
          } catch (e) {
      ...
      _33 = function (_f2) {
        ...
        if (
          ...
          _92[mid] ||
          (_f2.url &&
            ((_f2.pack && _92[_f2.url] === _f2.pack) || _92[_f2.url] == 1))
        ) {
          return;
        }
        _93(_f2);
                ...
                if (_26 == _27) {
                  ...
                  if (_f2.finish) {
                    ...
                    def(
                      ...
                      [
                        "dojo",
                        ("dojo/require!" + _f8.join(",")).replace(/\./g, "/"),
                      ],
                      function (_f9) {
                        _9(_f8, function (mid) {
                          _f9.require(mid);
    ...
    var _10d = (req.trace = function (_10e, args) {
      if (_10d.on && _10d.group[_10e]) {
        ...
        for (
          var arg,
            dump = [],
            text = "trace:" + _10e + (args.length ? ":" + args[0] : ""),
            i = 1;
          i < args.length;
  ...
  var def = function (mid, _112, _113) {
    ...
    if (0 && args[1] === _115) {
      args[2]
        .toString()
        .replace(/(\/\*([\s\S]*?)\*\/|\/\/(.*)$)/gm, "")
        .replace(/require\(["']([\w\!\-_\.\/]+)["']\)/g, function (_116, dep) {
          args[1].push(dep);
        });
    }
  ...
  cache: {
    ...
    "dojo/_base/fx": function () {
      define([
          ...
          _cycle: function () {
            ...
            if (_13e._active) {
              ...
              var step =
                _13e.duration === 0
                  ? 1
                  : (curr - _13e._startTime) / _13e.duration;
              if (step >= 1) {
                step = 1;
              }
              _13e._percent = step;
        ...
        _12b.fadeIn = function (args) {
          return _12b._fade(_12a({ end: 1 }, args));
        };
        _12b.fadeOut = function (args) {
          return _12b._fade(_12a({ end: 0 }, args));
        };
        ...
        _144.prototype.getValue = function (r) {
          ...
          for (var p in this._properties) {
            ...
            if (_146 instanceof _127) {
              ret[p] = _127
                .blendColors(_146, prop.end, r, prop.tempColor)
                .toCss();
            } else {
          ...
          _128.after(
            ...
            lang.hitch(anim, function () {
              ...
              for (var p in this.properties) {
                ...
                prop = pm[p] = _12a(
                  {},
                  lang.isObject(prop) ? prop : { end: prop }
                );
                ...
                if (_147) {
                  ...
                  prop.start =
                    p == "opacity" ? +prop.start : parseFloat(prop.start);
                }
              }
      ...
      define([
        ...
        if (has("dojo-preload-i18n-Api") || 1) {
          var _190 = (_15e.normalizeLocale = function (_191) {
            ...
            _194 = 0,
            _195 = [],
            _180 = (_15e._preloadLocalizations = function (
              _196,
              _197,
              _198,
              _199
        ...
        if (1) {
          ...
          _18e = function (_1bb) {
            for (
              var _1bc,
                _1bd = _1bb.split("/"),
                _1be = dojo.global[_1bd[0]],
                i = 1;
              _1be && i < _1bd.length - 1;
              _1be = _1be[_1bd[i++]]
            ) {}
            if (_1be) {
              _1bc = _1be[_1bd[i]];
    ...
    "dojo/_base/html": function () {
      define([
        ...
        dojo.contentBox = function contentBox(node, box) {
          return box
            ? geom.setContentSize(node, box)
            : geom.getContentBox(node);
        };
    ...
    "dojo/_base/kernel": function () {
      define(["../has", "./config", "require", "module"], function (
        ...
        var i,
          ...
          _1db = {},
          _1dc = {},
          dojo = { config: _1d7, global: _1da, dijit: _1db, dojox: _1dc };
        var _1dd = {
            dojo: ["dojo", dojo],
            dijit: ["dijit", _1db],
            dojox: ["dojox", _1dc],
              ...
              if (func) {
                try {
                  ...
                  if (_201 && typeof _201.then === "function") {
                    _201.then(
                      lang.hitch(_200.deferred, "resolve"),
                      lang.hitch(_200.deferred, "reject"),
                      lang.hitch(_200.deferred, "progress")
                    );
                    continue;
                  }
                  ...
                  _200.deferred[_202 && _1f9 ? "reject" : "resolve"](
                    _202 ? _1f5 : _201
                  );
                } catch (e) {
        ...
        lang.extend(_21e, {
          _normalize: function (_222, _223) {
            ...
            if (typeof _222.template == "string") {
              var _225 =
                _222.templateFunc || (dojo.string && dojo.string.substitute);
    ...
    "dojo/query": function () {
      define([
        ...
        dojo._filterQueryResult = _253._filterResult = function (
          _265,
          _266,
          root
        ) {
    ...
    "dojo/has": function () {
      define(["require", "module"], function (_267, _268) {
        ...
        if (!1) {
          ...
          has = function (name) {
            return typeof _26c[name] == "function"
              ? (_26c[name] = _26c[name](_26a, doc, _26b))
              : _26c[name];
          };
          has.cache = _26c;
    ...
    "dojo/_base/loader": function () {
      define([
        ...
        if (!1) {
          console.error(
            "cannot load the Dojo v1.x loader with a foreign loader"
          );
          return 0;
        }
        1 || has.add("dojo-fast-sync-require", 1);
        var _276 = function (id) {
            return { src: _274.id, id: id };
          },
          _277 = function (name) {
                  ...
                  for (mid in _283) {
                    ...
                    if (_28a.executed || _28a.noReqPluginCheck) {
                      ...
                      if (_28a.noReqPluginCheck !== 0) {
                        _28a.noReqPluginCheck =
                          /loadInit\!/.test(mid) || /require\!/.test(mid)
                            ? 1
                            : 0;
                      }
          ...
          _29d = function (text, _29e, _29f) {
            ...
            return [
              dojo.trim(text.substring(_29f, _2a0.lastIndex)) + ";\n",
              _2a0.lastIndex,
            ];
          },
          _2a3 = /(\/\*([\s\S]*?)\*\/|\/\/(.*)$)/gm,
          ...
          _2a6 = function (text, _2a7) {
            ...
            _2a7 =
              _2a7 ||
              text.replace(_2a3, function (_2af) {
          ...
          _2b0 = function (_2b1, text) {
            ...
            return (
              ...
              "});\n\n" +
              "define(" +
              json.stringify(_2b3.concat(["dojo/loadInit!" + id])) +
              ", function(" +
              _2b3.join(",") +
              "){\n" +
              _2b2[0] +
        ...
        dojo.platformRequire = function (_2cc) {
          var _2cd = (_2cc.common || []).concat(
              _2cc[dojo._name] || _2cc["default"] || []
            ),
            temp;
          while (_2cd.length) {
    ...
    "dojo/_base/declare": function () {
      define(["./kernel", "../has", "./lang"], function (dojo, has, lang) {
        ...
        function _2e4(_2e5, _2e6) {
          ...
          for (; i < l; ++i) {
            ...
            for (j = lin.length - 1; j >= 0; --j) {
              ...
              if (!_2e9.hasOwnProperty(name)) {
                _2e9[name] = { count: 0, refs: [], cls: lin[j] };
                ++_2ea;
              }
              rec = _2e9[name];
              if (top && top !== rec) {
          ...
          base = _2e5[0];
          _2e7[0] = base
            ? base._meta && base === _2e7[_2e7.length - base._meta.bases.length]
            ...
            if (_2f1.c !== _2ef) {
              ...
              if (meta.hidden[name] !== _2ef) {
                ...
                do {
                  ...
                  if (
                    meta &&
                    ((_2f0[name] === _2ef && _2f0.hasOwnProperty(name)) ||
                      meta.hidden[name] === _2ef)
                  ) {
                    break;
                  }
                } while ((base = _2ee[++pos]));
            ...
            if (base) {
              ...
              if (base._meta && _2f0.hasOwnProperty(name)) {
                ...
                do {
                  ...
                  if (
                    f &&
                    (base._meta ? _2f0.hasOwnProperty(name) : f !== opf)
                  ) {
                    break;
                  }
                } while ((base = _2ee[++pos]));
        ...
        function _301(_312, _313, _314) {
          ...
          _316[0] = ctor =
            _317 && _317.constructor === "manual"
              ? _30c(_316)
              : _316.length == 1
              ? _30a(_314.constructor, t)
              : _305(_316, t);
          ctor._meta = {
            bases: _316,
            hidden: _314,
      ...
      define([
        ...
        var _32b = function (_32c) {
          ...
          var _33c = function () {
            _33b();
            if (_331 >= 0) {
              _336.pseudos.push({ name: ts(_331 + 1, x) });
            }
            _336.loops =
              _336.pseudos.length || _336.attrs.length || _336.classes.length;
                  ...
                  if (cc == ".") {
                    ...
                    if (cc == ":") {
                      ...
                      if (cc == "[") {
                        ...
                        if (cc == "(") {
                          if (_331 >= 0) {
                            _337 = { name: ts(_331 + 1, x), value: null };
        ...
        var _33e = function (_33f, _340) {
          ...
          return function () {
            return (
              _33f.apply(window, arguments) && _340.apply(window, arguments)
            );
          };
        };
        ...
        var _344 = function (elem, attr) {
          ...
          return (
            (_329 ? elem.getAttribute(attr) : elem.getAttribute(attr, 2)) ||
            _343
          );
        };
        var _345 = {
          ...
          if (!("tag" in _366)) {
            if (_365.tag != "*") {
              ff = _33e(ff, function (elem) {
                return (
                  elem &&
                  (_329 ? elem.tagName : elem.tagName.toUpperCase()) ==
                    _365.getTag()
                );
              });
            }
        ...
        var _373 = function (_374) {
          ...
          var oper = io ? io.oper : "";
          var _376 = _360(_374, { el: 1 });
          var qt = _374.tag;
          var _377 = "*" == qt;
          var ecs = _326()["getElementsByClassName"];
          if (!oper) {
            if (_374.id) {
              _376 = !_374.loops && _377 ? _32a : _360(_374, { el: 1, id: 1 });
              ...
              if (
                ...
                _376 = _360(_374, { el: 1, classes: 1, id: 1 });
                ...
                if (!_377 && !_374.loops) {
                  ...
                  _376 = _360(_374, { el: 1, tag: 1, id: 1 });
                  _375 = function (root, arr, bag) {
                    var ret = _341(0, arr),
                      te,
                      x = 0;
        ...
        var _38b = function (_38c, _38d) {
          ...
          var _391 =
            ...
            !_38d &&
            _328.indexOf(qcz) == -1 &&
            (!has("ie") || _38c.indexOf(":") == -1) &&
            !(_327 && _38c.indexOf(".") >= 0) &&
            _38c.indexOf(":contains") == -1 &&
            _38c.indexOf(":checked") == -1 &&
            _38c.indexOf("|=") == -1;
          if (_391) {
            var tq =
              _328.indexOf(_38c.charAt(_38c.length - 1)) >= 0
                ? _38c + " *"
                : _38c;
    ...
    "dojo/errors/RequestTimeoutError": function () {
      define(["./create", "./RequestError"], function (_3a0, _3a1) {
        return _3a0("RequestTimeoutError", null, _3a1, { dojoType: "timeout" });
      });
    },
    "dojo/dom-style": function () {
      define(["./sniff", "./dom"], function (has, dom) {
        ...
        var _3b4 = { cssFloat: 1, styleFloat: 1, float: 1 };
      ...
      define(["./sniff", "./_base/window", "./dom", "./dom-style"], function (
            ...
            if (!isNaN(sl) && !isNaN(st)) {
              ...
              if (p && p.style) {
                ...
                if (pcs.overflow != "visible") {
                  l +=
                    pcs.borderLeftStyle != none
                      ? px(node, pcs.borderLeftWidth)
                      : 0;
                  t +=
                    pcs.borderTopStyle != none
                      ? px(node, pcs.borderTopWidth)
                      : 0;
                }
              }
            }
              ...
              if (p) {
                ...
                l -=
                  pcs.borderLeftStyle != none
                    ...
                    : 0;
                t -=
                  pcs.borderTopStyle != none ? px(node, pcs.borderTopWidth) : 0;
              }
            }
          }
          return {
        ...
        geom.fixIeBiDiScrollLeft = function fixIeBiDiScrollLeft(_3c3, doc) {
          ...
          if (ie && !geom.isBodyLtr(doc)) {
            ...
            return ie < 8 || qk
              ? _3c3 + de.clientWidth - de.scrollWidth
              : -_3c3;
          }
          return _3c3;
        };
        geom.position = function (node, _3c4) {
          ...
          if (has("ie") < 9) {
            ...
            ret.x -=
              _3c5.x + (has("quirks") ? db.clientLeft + db.offsetLeft : 0);
        ...
        geom.getMarginSize = function getMarginSize(node, _3c7) {
          ...
          var me = geom.getMarginExtents(
            node,
            _3c7 || _3b6.getComputedStyle(node)
          );
        ...
        geom.normalizeEvent = function (_3c8) {
          ...
          if (!has("dom-addeventlistener")) {
            ...
            _3c8.pageX =
              _3c8.clientX +
              geom.fixIeBiDiScrollLeft(_3c9.scrollLeft || 0, doc) -
              _3ca.x;
    ...
    "dojo/dom-attr": function () {
      define([
        ...
        _3e0.has = function hasAttr(node, name) {
          var lc = name.toLowerCase();
          return (
            _3e2[prop.names[lc] || name] ||
            _3e4(dom.byId(node), _3e3[lc] || name)
          );
        };
        _3e0.get = function getAttr(node, name) {
          ...
          if (
            _3e5 != "href" &&
            (typeof _3e7 == "boolean" || lang.isFunction(_3e7))
          ) {
            return _3e7;
          }
      ...
      define([
        ...
        _3ee.place = function place(node, _3ff, _400) {
          ...
          if (typeof node == "string") {
            node = /^\s*</.test(node)
              ? _3ee.toDom(node, _3ff.ownerDocument)
              : dom.byId(node);
          }
        ...
        function _404(node, _405) {
          ...
          if (_405) {
            has("ie") && _405.canHaveChildren && "removeNode" in node
              ? node.removeNode(false)
              : _405.removeChild(node);
          }
        }
    ...
    "dojo/request/xhr": function () {
      define([
        ...
        function _40b(_40c, _40d) {
          ...
          if (_40d) {
            ...
            if (util.checkStatus(_40e.status)) {
              ...
              _40d = new _406(
                "Unable to load " + _40c.url + " status: " + _40e.status,
                _40c
              );
              this.reject(_40d);
            }
        ...
        if (has("native-xhr2")) {
          ...
          _411 = function (_415, dfd, _416) {
            ...
            function _418(evt) {
              var _419 = evt.target;
              var _41a = new _406(
                "Unable to load " + _416.url + " status: " + _419.status,
                _416
              );
        ...
        var _422,
          _423 = { data: null, query: null, sync: false, method: "GET" };
        function xhr(url, _424, _425) {
          var _426 =
            has("native-formdata") &&
            _424 &&
            _424.data &&
            _424.data instanceof FormData;
    ...
    "dojo/text": function () {
      define(["./_base/kernel", "require", "./has", "./request"], function (
        dojo,
        _42e,
        has,
        _42f
        ...
        dojo.cache = function (_436, url, _437) {
          ...
          var val =
              _437 != undefined && typeof _437 != "string" ? _437.value : _437,
        ...
        if (!_445) {
          var _44b = [],
            _44c = function (evt) {
              ...
              if (
                _445 ||
                (evt.type == "readystatechange" && !_443[doc.readyState])
              ) {
                return;
              }
              if (_444) {
    ...
    "dojo/_base/lang": function () {
      define(["./kernel", "../has", "../sniff"], function (dojo, has) {
        ...
        var _450 = has("bug-for-in-skips-shadowed")
          ...
          _456 = function (obj, _457, _458) {
            return (_458 || []).concat(
              Array.prototype.slice.call(obj, _457 || 0)
            );
          },
          _459 = /\{([^\}]+)\}/g;
        var lang = {
          ...
          _mixin: function (dest, _45a, _45b) {
            ...
            for (name in _45a) {
              ...
              if (
                !(name in dest) ||
                (dest[name] !== s && (!(name in _45c) || _45c[name] !== s))
              ) {
    ...
    "dojo/request/util": function () {
      define([
        ...
        _46f.deferred = function deferred(_481, _482, _483, _484, _485, last) {
          ...
          if (_46f.notify) {
            _489.then(
              lang.hitch(_46f.notify, "emit", "load"),
              lang.hitch(_46f.notify, "emit", "error")
            );
          }
        ...
        _46f.addCommonMethods = function addCommonMethods(_48e, _48f) {
          _474.forEach(
            _48f || ["GET", "POST", "PUT", "DELETE"],
            function (_490) {
              _48e[(_490 === "DELETE" ? "DEL" : _490).toLowerCase()] =
                function (url, _491) {
    ...
    "dojo/_base/xhr": function () {
      define([
          ...
          dojo.contentHandlers =
            {
              ...
              xml: function (xhr) {
                ...
                if (
                  _4b5 &&
                  has("dom-qsa2.1") &&
                  !_4b5.querySelectorAll &&
                  has("dom-parser")
                ) {
                  _4b5 = new DOMParser().parseFromString(
                    xhr.responseText,
                    "application/xml"
                  );
                }
        ...
        dojo._ioSetArgs = function (args, _4b6, _4b7, _4b8) {
          var _4b9 = { args: args, url: args.url };
          var _4ba = null;
          if (args.form) {
          ...
          if (args.preventCache) {
            _4bc.push({ "dojo.preventCache": new Date().valueOf() });
          }
          ...
          if ("postData" in args) {
            ...
            if ("putData" in args) {
              ...
              if ("rawBody" in args) {
                ...
                if (
                  (arguments.length > 2 && !_4d0) ||
                  "POST|PUT".indexOf(_4cf.toUpperCase()) === -1
                ) {
    ...
    "dojo/_base/Color": function () {
      define(["./kernel", "./lang", "./array", "./config"], function (
        ...
        _516.fromString = dojo.colorFromString = function (str, obj) {
          ...
          return (
            (a && _516.fromArray(a, obj)) ||
            _516.fromRgb(str, obj) ||
            _516.fromHex(str, obj)
          );
        };
        return _516;
      });
        ...
        return function (_534) {
          ...
          if (_535) {
            ...
            if (_535 === "report-rejections") {
              ...
              if (
                _535 === "report-unhandled-rejections" ||
                _535 === true ||
                _535 === 1
              ) {
                ...
                throw new Error(
                  "Unsupported instrumentation usage <" + _535 + ">"
                );
              }
            }
          }
      ...
      define([
        ...
        on.selector = function (_57a, _57b, _57c) {
          return function (_57d, _57e) {
            var _57f = typeof _57a == "function" ? { matches: _57a } : this,
              _580 = _57b.bubble;
            function _581(_582) {
        ...
        if (has("dom-addeventlistener")) {
          ...
          on._fixEvent = function (evt, _594) {
            if (!evt) {
              var w =
                (_594 &&
                  (_594.ownerDocument || _594.document || _594).parentWindow) ||
                window;
              evt = w.event;
            }
            if (!evt) {
          ...
          var _575 = function (_59e, type, _59f) {
            ...
            if (
              ((_59e.ownerDocument
                ? _59e.ownerDocument.parentWindow
                : _59e.parentWindow || _59e.window || window) != top ||
                has("jscript") < 5.8) &&
              ...
              var _5a2;
              _5a0.listeners.push(
                (_5a2 = _5a0.global._dojoIEListeners_.push(_59f) - 1)
              );
    ...
    "dojo/dom-class": function () {
      define(["./_base/lang", "./_base/array", "./dom"], function (
        lang,
        _5cc,
        dom
      ) {
        ...
        cls = {
          contains: function containsClass(node, _5d1) {
            return (
              (" " + dom.byId(node)[_5cd] + " ").indexOf(" " + _5d1 + " ") >= 0
            );
          },
          ...
          if (!has("webkit")) {
            ...
            if (has("mozilla")) {
              has.add(
                "ff",
                parseFloat(
                  dua.split("Firefox/")[1] || dua.split("Minefield/")[1]
                ) || undefined
              );
            }
    ...
    "dojo/aspect": function () {
      define([], function () {
        ...
        return { before: _615, around: _616, after: _614 };
      });
    },
    "dojo/ready": function () {
      define([
        ...
        var _619 = 0,
          ...
          _61d = function () {
            ...
            while (
              _619 &&
              (!_618 || _618._Q.length == 0) &&
              (_617.idle ? _617.idle() : true) &&
              _61a.length
            ) {
              var f = _61a.shift();
              try {
        ...
        var _61e =
          ...
          dojo.addOnLoad =
            function (_61f, _620, _621) {
              ...
              for (
                var i = 0;
                i < _61a.length && _61f >= _61a[i].priority;
                i++
              ) {}
      ...
      define([
        ...
        has.add("events-keypress-typed", function () {
          ...
          try {
            ...
            (_626.initKeyboardEvent || _626.initKeyEvent).call(
              _626,
              "keypress",
              true,
              true,
        ...
        if (has("events-keypress-typed")) {
          ...
          _62c = function (_633, _634) {
            ...
            var _637 = on(_633, "keypress", function (evt) {
              var c = evt.charCode;
              c = c >= 32 ? c : 0;
              evt = _62f(evt, { charCode: c, faux: true });
          ...
          if (has("opera")) {
            _62c = function (_638, _639) {
              return on(_638, "keypress", function (evt) {
                ...
                return _639.call(this, _62f(evt, { charCode: c }));
              });
            };
          } else {
    ...
    "dojo/errors/CancelError": function () {
      define(["./create"], function (_648) {
        return _648("CancelError", null, null, { dojoType: "cancel" });
      });
    },
  },
});
