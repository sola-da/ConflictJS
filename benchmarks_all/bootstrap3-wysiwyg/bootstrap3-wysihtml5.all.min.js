...
!(function (a, b) {
  ...
  function l() {
    if (!C.initialized) {
      ...
      a(document, "createRange") &&
        ((b = document.createRange()), y(b, v) && A(b, u) && (c = !0));
      var h = f(document);
      ...
      (C.initialized = !0),
        (C.features = { implementsDomRange: c, implementsTextRange: d });
      var j, l;
      for (var m in B) (j = B[m]) instanceof n && j.init(j, C);
      for (var o = 0, p = E.length; p > o; ++o)
        try {
          E[o](C);
        } catch (q) {
          (l =
  ...
  var r = "object",
    ...
    C = {
      ...
      config: {
        ...
        preferTextRange: !1,
        autoInitialize:
          typeof rangyAutoInitialize == t ? !0 : rangyAutoInitialize,
      },
    };
  (C.fail = i),
    (C.warn = j),
    {}.hasOwnProperty
      ? (C.util.extend = function (a, b, c) {
          var d, e;
          for (var f in b)
            b.hasOwnProperty(f) &&
              ((d = a[f]),
  ...
  a(document, "addEventListener")
    ...
    (C.util.addListener = D);
  var E = [];
  (C.init = l),
    (C.addInitListener = function (a) {
  ...
  (C.addShimListener = function (a) {
    ...
    (C.shim = C.createMissingNativeApi = m),
    (n.prototype = {
      init: function () {
        for (
          ...
          if (((b = c[d]), (a = B[b]), !(a && a instanceof n)))
    ...
    (C.RangePrototype = p),
    (C.rangePrototype = new p()),
    (C.selectionPrototype = new q());
  var G = !1,
    H = function () {
      G || ((G = !0), !C.initialized && C.config.autoInitialize && l());
    };
  return typeof window == t
    ? void i("No window found")
    : typeof document == t
    ? void i("No document found")
    : (a(document, "addEventListener") &&
        document.addEventListener("DOMContentLoaded", H, !1),
      D(window, "load", H),
      C.createCoreModule("DomUtil", [], function (a, b) {
        function c(a) {
          var b;
          return (
        ...
        function s(a) {
          return (
            a &&
            E.isHostMethod(a, "setTimeout") &&
            E.isHostObject(a, "document")
          );
        }
        function t(a, b, c) {
          var d;
      ...
      C.createCoreModule("DomRange", ["DomUtil"], function (a) {
        function b(a, b) {
          return (
            3 != a.nodeType && (O(a, b.startContainer) || O(a, b.endContainer))
          );
        }
        function c(a) {
        ...
        function f(a, b, c) {
          ...
          return (
            M(b)
              ? c == b.length
                ? I.insertAfter(a, b)
                : b.parentNode.insertBefore(a, 0 == c ? b : R(b, c))
        ...
        function h(a) {
          for (
            ...
            if (
              ...
              (d = d.cloneNode(!b)),
              b &&
                ((e = a.getSubtreeIterator()), d.appendChild(h(e)), e.detach()),
              10 == d.nodeType)
            )
        ...
        function i(a, b, c) {
          ...
          for (var f, g; (f = a.next()); )
            if (a.isPartiallySelectedSubtree()) {
              ...
              if (
                ((g = a.getSubtreeIterator()), i(g, b, c), g.detach(), c.stop)
              )
                return;
            } else
        ...
        function z(a, b) {
          ...
          M(e) && f > 0 && f < e.length && R(e, f, b),
            M(c) &&
              ...
              d < c.length &&
              ((c = R(c, d, b)),
              g ? ((f -= d), (e = c)) : e == c.parentNode && f >= N(c) && f++,
              (d = 0)),
        ...
        function D(a, b) {
          return function () {
            ...
            var c,
              ...
              j = new n(this, !0);
            f !== h &&
              ((c = S(f, h, !0)), (d = e(c)), (f = d.node), (g = d.offset)),
              i(j, t),
              j.reset();
            var k = a(j);
          ...
          getSubtreeIterator: function () {
            ...
            if (this.isSingleCharacterDataNode)
              ...
              var b = this._current,
                ...
                f = b,
                g = T(b);
              O(b, this.sc) && ((d = this.sc), (e = this.so)),
                O(b, this.ec) && ((f = this.ec), (g = this.eo)),
                G(a, d, e, f, g);
            }
        ...
        var gb = eb
            ? function (a) {
                ...
                var d = null;
                return (
                  1 == b.nodeType ? (d = b) : M(b) && (d = I.parentElement(b)),
                  (d =
                    null === d ||
                    ("HTML" == d.nodeName &&
                      I.isHtmlNamespace(P(d).documentElement) &&
                      I.isHtmlNamespace(d))
        ...
        J.extend(a.rangePrototype, {
          ...
          surroundContents: function (a) {
            if ((q(a, _), !this.canSurroundContents()))
          ...
          cloneRange: function () {
            y(this);
            for (var a, b = new H(c(this)), d = hb.length; d--; )
              (a = hb[d]), (b[a] = this[a]);
            return b;
          },
          toString: function () {
          ...
          comparePoint: function (a, b) {
            return (
              ...
              Q(a, b, this.startContainer, this.startOffset) < 0
                ? -1
                : Q(a, b, this.endContainer, this.endOffset) > 0
                ? 1
                : 0
            );
          },
          ...
          containsNodeContents: function (a) {
            return (
              this.comparePoint(a, 0) >= 0 && this.comparePoint(a, T(a)) <= 0
            );
          },
        ...
        if (
            ...
            n = function (a, b, c, d, f) {
              ...
              for (
                ...
                if (
                  (v == t
                    ? i.appendChild(l)
                    : i.insertBefore(l, i.childNodes[v]),
          ...
          if (
            ...
            "undefined" == typeof q.Range && (q.Range = d),
              (a.createNativeRange = function (a) {
                return (
                  (a = j(a, b, "createNativeRange")), i(a).createTextRange()
                );
              }),
              (a.WrappedRange = d);
          }
        ...
        function (a, b) {
          ...
          D.areHostMethods(R, ["addRange", "getRangeAt", "removeAllRanges"]) &&
            ...
            !(function () {
              ...
              if (b) {
                ...
                for (i.removeChild(j), b.removeAllRanges(), h = 0; c > h; ++h)
                  0 == h && f
                    ? Z
                      ? Z(b, e[h])
                      : (a.warn(
          ...
          if (!Q && U && D.areHostMethods(R, ["removeAllRanges", "addRange"])) {
            ...
            if (!(E(R, "empty") && E(S, "select") && _ && Q))
              return (
                b.fail("No means of selecting a Range or TextRange was found"),
                !1
              );
            (db.removeAllRanges = function () {
              try {
  ...
  (wysihtml5.dom.parse = (function () {
    function a(a, c) {
      ...
      var d,
        ...
        j = !1;
      for (
        c.clearInternals === !0 && (j = !0),
          c.uneditableClass && (q = c.uneditableClass),
    ...
    function b(a, c, d) {
      ...
      if (((f = k && k(a, d)), !f)) {
        if (f === !1) {
          for (e = a.ownerDocument.createDocumentFragment(), n = j; n--; )
            i[n] &&
              ((g = b(i[n], c, d)),
              g && (i[n] === g && n--, e.insertBefore(g, e.firstChild)));
          return (
            wysihtml5.lang
              .array([
                "div",
              ...
              ((a.nextSibling &&
                ...
                e.appendChild(a.ownerDocument.createTextNode(" "))),
      ...
      for (n = 0; j > n; n++)
        i[n] &&
          ((g = b(i[n], c, d)), g && (i[n] === g && n--, f.appendChild(g)));
      if (
        c &&
        f.nodeName.toLowerCase() === m &&
        (!f.childNodes.length ||
          (/^\s*$/gi.test(f.innerHTML) &&
            (d ||
              ("_wysihtml5-temp-placeholder" !== a.className &&
                "rangySelectionBoundary" !== a.className))) ||
          !f.attributes.length)
      ) {
        for (e = f.ownerDocument.createDocumentFragment(); f.firstChild; )
    ...
    function c(a, b) {
      ...
      return (
        (e = a.ownerDocument.createElement(c.rename_tag || i)),
        g(a, e, c, b),
        f(a, e, c),
        c.one_of_type && !d(a, p, c.one_of_type, b)
          ? c.remove_action && "unwrap" == c.remove_action
            ? !1
            : null
          : ((a = null), e.normalize && e.normalize(), e)
      );
    }
    function d(a, b, c, d) {
      var f, g;
      ...
      for (g in c)
        if (
          c.hasOwnProperty(g) &&
          b.type_definitions &&
          b.type_definitions[g] &&
          ((f = b.type_definitions[g]), e(a, f))
        )
          return !0;
      return !1;
    }
    function e(a, b) {
      ...
      if (i && b.classes) {
        (i = i.replace(/^\s+/g, "").replace(/\s+$/g, "").split(n)),
          (c = i.length);
    ...
    function g(a, b, c, d) {
      ...
      if ((s && (m = wysihtml5.lang.object(s).clone()), w))
        for (i in w)
          (k = t[w[i]]),
            k &&
              ((l = h(a, i)),
              (l || ("alt" === i && "IMG" == a.nodeName)) &&
                ((j = k(l)), "string" == typeof j && (m[i] = j)));
      if ((o && z.push(o), q))
        for (i in q)
          (k = v[q[i]]),
            k && ((g = k(h(a, i))), "string" == typeof g && z.push(g));
      if (r)
        for (i in r)
          (k = u[r[i]]),
            k &&
              ((newStyle = k(h(a, i))),
              "string" == typeof newStyle && A.push(newStyle));
      if ("string" == typeof x && "any" === x && a.getAttribute("class"))
        m["class"] = a.getAttribute("class");
      else {
        for (
          d ||
            ((x["_wysihtml5-temp-placeholder"] = 1),
            (x._rangySelectionBoundary = 1),
            (x["wysiwyg-tmp-selected-cell"] = 1)),
            C = a.getAttribute("class"),
            C && (z = z.concat(C.split(n))),
            e = z.length;
          e > y;
          y++
        )
      ...
      m["class"] &&
        d &&
        ((m["class"] = m["class"].replace("wysiwyg-tmp-selected-cell", "")),
        /^\s*$/g.test(m["class"]) && delete m["class"]),
        A.length && (m.style = wysihtml5.lang.array(A).unique().join(" "));
      for (i in m)
        try {
          b.setAttribute(i, m[i]);
        } catch (D) {}
      m.src &&
        ("undefined" != typeof m.width && b.setAttribute("width", m.width),
        "undefined" != typeof m.height && b.setAttribute("height", m.height));
    }
    function h(a, b) {
      b = b.toLowerCase();
      var c = a.nodeName;
    ...
    (i.prototype = {
      ...
      injectRowAt: function (a, b, c, d, f) {
        ...
        if (h) {
          ...
          k.appendChild(i),
            e(g.getParentElement(f.el, { nodeName: ["TR"] }), k);
        }
      },
      canMerge: function (a) {
        if (
      ...
      (s.prototype = {
          ...
          if (!b.containsNode(f)) {
            ...
            i.selectNode(f),
              i.isPointInRange(b.endContainer, b.endOffset) &&
                ...
                (q(f, b.endContainer, b.endOffset, this.container),
                b.setEndAfter(f)),
              i.isPointInRange(b.startContainer, b.startOffset) &&
                p(b.startContainer, b.startOffset) &&
                (f = q(f, b.startContainer, b.startOffset, this.container));
          }
          !e && this.similarClassRegExp && g(f, this.similarClassRegExp),
            e &&
              this.similarStyleRegExp &&
              (h = "change" === l(f, this.cssStyle, this.similarStyleRegExp)),
            this.isRemovable(f) && !h && n(f);
        },
          ...
          for (var c, d = b.length; d--; ) {
            ...
            if (
              ...
              for (var g, h = 0, i = c.length; i > h; ++h)
                (g = c[h]),
                  this.getMatchingAncestor(g).element ||
                    this.applyToTextNode(g);
              b[d].setStart(c[0], 0),
                (g = c[c.length - 1]),
        ...
        undoToRange: function (b) {
          for (var c, d, e, f = b.length; f--; ) {
            if (((c = b[f].getNodes([a.TEXT_NODE])), c.length))
        ...
        isAppliedToRange: function (b) {
          for (var c, d, e = [], f = "full", g = b.length; g--; ) {
            if (((d = b[g].getNodes([a.TEXT_NODE])), !d.length))
              return (
                (c = this.getMatchingAncestor(b[g].startContainer).element),
                c ? { elements: [c], coverage: f } : !1
              );
            for (var h, i = 0, j = d.length; j > i; ++i)
              (h = this.getTextSelectedByRange(d[i], b[g])),
                (c = this.getMatchingAncestor(d[i]).element),
                c && "" != h
                  ? (e.push(c),
  ...
  (wysihtml5.commands.insertList = (function (a) {
    var b = function (a, b) {
      ...
      c = function (c, d, e) {
        ...
        if (c) {
          var g = a.dom.getParentElement(c, { nodeName: "LI" }),
            h = "UL" === d ? "OL" : "UL";
          b(c, d)
            ? (f.el = c)
            : b(c, h)
        ...
        d.selection.executeAndRestore(function () {
          ...
          if (h.length)
            for (var i = h.length; i--; )
              a.dom.renameElement(h[i], c.toLowerCase());
          else {
            e = f(["OL", "UL"], d);
            for (var j = e.length; j--; )
              a.dom.resolveList(e[j], d.config.useLineBreaks);
  ...
  (function (a) {
        ...
        if (b.isCollapsed())
          if (b.caretIsInTheBeginnig("LI"))
            ...
            if (
              ...
              if (
                (a.preventDefault(), /^\s*$/.test(f.textContent || f.innerText))
              )
                f.parentNode.removeChild(f);
              else {
    ...
    a.views.Composer.prototype.observe = function () {
      ...
      b.observe(k, m, function () {
        ...
        b.observe(k, "focus", function (a) {
          e.parent.fire("focus", a).fire("focus:composer", a),
            setTimeout(function () {
              h = e.getValue(!1, !1);
            }, 0);
        }),
      ...
      d.prototype = {
        ...
        createToolbar: function (b, d) {
          ...
          for (var k in d.toolbar)
            d.toolbar[k] &&
              (h.append(c(k, j, d)), "html" === k && this.initHtml(h));
          return (
            h
