  ...
  return (function e(t, n, r) {
  ...
  })(
    {
        ...
        function (require, module, exports) {
          ...
          var Node = require("./node"),
            ...
            endsWithBlankLine = function (block) {
              for (; block; ) {
                if (block._lastLineBlank) return !0;
                var t = block.type;
            ...
            breakOutOfLists = function (block) {
              var b = block,
                last_list = null;
              do "list" === b.type && (last_list = b), (b = b._parent);
              while (b);
              if (last_list) {
                for (; block !== last_list; )
            ...
            parseListMarker = function (parser) {
              ...
              if ((match = rest.match(reBulletListMarker)))
                ...
                if (!(match = rest.match(reOrderedListMarker))) return null;
                (data.type = "ordered"),
              ...
              if (
                ...
                -1 !== nextc && nextc !== C_TAB && nextc !== C_SPACE)
              )
                return null;
              ...
              while (5 > parser.column - spacesStartCol && isSpaceOrTab(nextc));
              ...
              return (
                ...
                blank_item
                  ? ((data.padding = match[0].length + 1),
                    ...
                    isSpaceOrTab(peek(parser.currentLine, parser.offset)) &&
                      parser.advanceOffset(1, !0))
            ...
            blocks = {
              ...
              block_quote: {
                continue: function (parser) {
                  ...
                  return parser.indented ||
                    peek(ln, parser.nextNonspace) !== C_GREATERTHAN
                    ? 1
                    : (parser.advanceNextNonspace(),
                      parser.advanceOffset(1, !1),
                      isSpaceOrTab(peek(ln, parser.offset)) &&
                        parser.advanceOffset(1, !0),
                      0);
                },
                finalize: function () {},
              ...
              item: {
                continue: function (parser, container) {
                  if (parser.blank) {
                    if (null == container._firstChild) return 1;
                    parser.advanceNextNonspace();
                  } else {
                    if (
                      !(
                ...
                continue: function (parser, container) {
                  ...
                  if (container._isFenced) {
                    ...
                    for (
                      ...
                      i > 0 && isSpaceOrTab(peek(ln, parser.offset));

                    )
                      parser.advanceOffset(1, !0), i--;
              ...
              html_block: {
                continue: function (parser, container) {
                  return !parser.blank ||
                    (6 !== container._htmlBlockType &&
                      7 !== container._htmlBlockType)
                    ? 0
                    : 1;
                },
                finalize: function (parser, block) {
            ...
            blockStarts = [
              function (parser) {
                return parser.indented ||
                  peek(parser.currentLine, parser.nextNonspace) !==
                    C_GREATERTHAN
                  ? 0
                  : (parser.advanceNextNonspace(),
                    parser.advanceOffset(1, !1),
                ...
                if (
                  ...
                  for (blockType = 1; 7 >= blockType; blockType++)
                    if (
                      ...
                      (7 > blockType || "paragraph" !== container.type)
                    ) {
                      parser.closeUnmatchedBlocks();
              ...
              function (parser, container) {
                var data;
                return (parser.indented && "list" !== container.type) ||
                  !(data = parseListMarker(parser))
                  ? 0
                  : (parser.closeUnmatchedBlocks(),
                    ("list" === parser.tip.type &&
                      listsMatch(container._listData, data)) ||
                      ((container = parser.addChild(
                        "list",
                        parser.nextNonspace
                      )),
            ...
            advanceOffset = function (count, columns) {
              for (
                ...
                count > 0 && (c = currentLine[this.offset]);
                  ...
                  ? ((charsToTab = 4 - (this.column % 4)),
                    columns
                      ? ((this.partiallyConsumedTab = charsToTab > count),
                        (charsToAdvance =
                          charsToTab > count ? count : charsToTab),
            ...
            incorporateLine = function (ln) {
              ...
              (this.oldtip = this.tip),
                ...
                (this.partiallyConsumedTab = !1),
                (this.lineNumber += 1),
                -1 !== ln.indexOf("\x00") && (ln = ln.replace(/\0/g, "�")),
                (this.currentLine = ln);
              for (
                var lastChild;
                (lastChild = container._lastChild) && lastChild._open;

              ) {
                switch (
                  ((container = lastChild),
                  this.findNextNonspace(),
                  this.blocks[container.type]["continue"](this, container))
                ) {
                  case 0:
                    break;
                  case 1:
              ...
              (this.allClosed = container === this.oldtip),
                ...
                this.blank &&
                  ...
                  (this.breakOutOfLists(container), (container = this.tip));
              for (
                var matchedLeaf =
                    "paragraph" !== container.type &&
              ...
              if (
                ...
                this.closeUnmatchedBlocks(),
                  this.blank &&
                    container.lastChild &&
                    (container.lastChild._lastLineBlank = !0),
                  (t = container.type);
                for (
                  var lastLineBlank =
                      this.blank &&
                      !(
                        "block_quote" === t ||
                        ("code_block" === t && container._isFenced) ||
                        ("item" === t &&
            ...
            parse = function (input) {
              ...
              var lines = input.split(reLineEnding),
                len = lines.length;
              input.charCodeAt(input.length - 1) === C_NEWLINE && (len -= 1),
                this.options.time && console.timeEnd("preparing input"),
                this.options.time && console.time("block parsing");
              for (var i = 0; len > i; i++) this.incorporateLine(lines[i]);
              for (; this.tip; ) this.finalize(this.tip, len);
              return (
      ...
      2: [
        function (require, module, exports) {
          ...
          var encode = require("mdurl/encode"),
            ...
            reBackslashOrAmp = /[\\&]/,
            ESCAPABLE = "[!\"#$%&'()*+,./:;<=>?@[\\\\\\]^_`{|}~-]",
            reEntityOrEscapedChar = new RegExp(
              "\\\\" + ESCAPABLE + "|" + ENTITY,
              "gi"
            ),
            XMLSPECIAL = '[&<>"]',
            ...
            escapeXml = function (s, preserve_entities) {
              return reXmlSpecial.test(s)
                ? preserve_entities
                  ? s.replace(reXmlSpecialOrEntity, replaceUnsafeChar)
        ...
        { entities: 11, "mdurl/decode": 19, "mdurl/encode": 20 },
      ],
      3: [
        function (require, module, exports) {
          "use strict";
              ...
              fromCodePoint = function () {
                ...
                for (var result = ""; ++index < length; ) {
                  ...
                  65535 >= codePoint
                    ...
                    (index + 1 === length || codeUnits.length > MAX_SIZE) &&
      ...
      4: [
        ...
        { "./blocks": 1, "./node": 6, "./render/html": 8, "./xml": 10 },
      ],
      5: [
        function (require, module, exports) {
          "use strict";
          ...
          var Node = require("./node"),
            ...
            fromCodePoint = require("./from-code-point.js"),
            decodeHTML = require("entities").decodeHTML;
          ...
          var C_NEWLINE = 10,
            ...
            rePunctuation = new RegExp(
              /^[\u2000-\u206F\u2E00-\u2E7F\\'!"#\$%&\(\)\*\+,\-\.\/:;<=>\?@\[\]\^_`\{\|\}~]/
            ),
            reLinkTitle = new RegExp(
              '^(?:"(' +
                ESCAPED_CHAR +
                '|[^"\\x00])*"|\'(' +
                ESCAPED_CHAR +
            ...
            match = function (re) {
              ...
              return null === m
                ? null
                : ((this.pos += m.index + m[0].length), m[0]);
            },
            peek = function () {
              return this.subject.length > this.pos
            ...
            parseBackticks = function (block) {
              ...
              if (null === ticks) return !1;
              for (
                var matched, node, afterOpenTicks = this.pos;
                null !== (matched = this.match(reTicks));

              )
                if (matched === ticks)
                  return (
                    (node = new Node("code")),
                    (node._literal = this.subject
              ...
              return (
                (this.pos = afterOpenTicks), block.appendChild(text(ticks)), !0
              );
            },
              ...
              return (
                ...
                this.peek() === C_NEWLINE
                  ? ((this.pos += 1),
                    ...
                    block.appendChild(node))
                  : reEscapable.test(subj.charAt(this.pos))
            ...
            parseAutolink = function (block) {
              var m, dest, node;
              return (m = this.match(reEmailAutolink))
            ...
            scanDelims = function (cc) {
              ...
              if (cc === C_SINGLEQUOTE || cc === C_DOUBLEQUOTE)
                numdelims++, this.pos++;
              else for (; this.peek() === cc; ) numdelims++, this.pos++;
              return 0 === numdelims
                ? null
                : ((char_before =
              ...
              (this.pos += numdelims),
                (contents =
                  cc === C_SINGLEQUOTE
                    ...
                    : cc === C_DOUBLEQUOTE
                    ? "“"
                    : this.subject.slice(startpos, this.pos));
            ...
            removeDelimiter = function (delim) {
              null !== delim.previous && (delim.previous.next = delim.next),
                null === delim.next
            ...
            removeDelimitersBetween = function (bottom, top) {
              bottom.next !== top &&
                ((bottom.next = top), (top.previous = bottom));
            },
            processEmphasis = function (stack_bottom) {
              ...
              for (
                ...
                null !== closer && closer.previous !== stack_bottom;
              ...
              for (; null !== closer; ) {
                ...
                if (
                  ...
                  for (
                    opener = closer.previous, opener_found = !1;
                    null !== opener &&
                    opener !== stack_bottom &&
                  ...
                  if (
                    ((old_closer = closer),
                    closercc === C_ASTERISK || closercc === C_UNDERSCORE)
                  )
                    if (opener_found) {
                      (use_delims =
                        3 > closer.numdelims || 3 > opener.numdelims
                          ? opener.numdelims >= closer.numdelims
                            ? closer.numdelims
                            : opener.numdelims
                          : closer.numdelims % 2 === 0
                          ? 2
                          : 1),
                      ...
                      opener_inl.insertAfter(emph),
                        ...
                        0 === opener.numdelims &&
                          (opener_inl.unlink(), this.removeDelimiter(opener)),
                        0 === closer.numdelims &&
                          (closer_inl.unlink(),
                    ...
                    closercc === C_SINGLEQUOTE
                      ? ((closer.node._literal = "’"),
                        opener_found && (opener.node._literal = "‘"),
                        (closer = closer.next))
                      : closercc === C_DOUBLEQUOTE &&
                        ((closer.node._literal = "”"),
                  ...
                  opener_found ||
                    ...
                    old_closer.can_open || this.removeDelimiter(old_closer));
                }
              }
              for (
                ;
                null !== this.delimiters && this.delimiters !== stack_bottom;
            ...
            parseLinkTitle = function () {
              ...
              return null === title
                ? null
                : unescapeString(title.substr(1, title.length - 2));
            },
            parseLinkDestination = function () {
              var res = this.match(reLinkDestinationBraces);
              return null === res
                ? ((res = this.match(reLinkDestination)),
                  null === res ? null : normalizeURI(unescapeString(res)))
                : normalizeURI(unescapeString(res.substr(1, res.length - 2)));
            },
            ...
            parseCloseBracket = function (block) {
              var startpos,
                ...
                matched = !1;
              for (
                this.pos += 1, startpos = this.pos, opener = this.delimiters;
                null !== opener &&
                opener.cc !== C_OPEN_BRACKET &&
                opener.cc !== C_BANG;

              )
                opener = opener.previous;
              if (null === opener) return block.appendChild(text("]")), !0;
              if (!opener.active)
                return (
                  block.appendChild(text("]")), this.removeDelimiter(opener), !0
                );
              if (
                ((is_image = opener.cc === C_BANG),
                this.peek() === C_OPEN_PAREN)
              )
                this.pos++,
                  this.spnl() &&
                    null !== (dest = this.parseLinkDestination()) &&
                    this.spnl() &&
                ...
                (reflabel =
                  0 === n || 2 === n
                    ? this.subject.slice(opener.index, startpos)
                    : this.subject.slice(beforelabel, beforelabel + n)),
                  0 === n && (this.pos = savepos);
              ...
              if (matched) {
                ...
                if (
                  ...
                  for (opener = this.delimiters; null !== opener; )
                    opener.cc === C_OPEN_BRACKET && (opener.active = !1),
                      (opener = opener.previous);
                return !0;
              }
              return (
            ...
            parseEntity = function (block) {
              var m;
              return (m = this.match(reEntityHere))
                ? (block.appendChild(text(decodeHTML(m))), !0)
                : !1;
            },
            parseString = function (block) {
              var m;
              return (m = this.match(reMain))
                ? (block.appendChild(
                    text(
                      this.options.smart
                        ? m
            ...
            parseNewline = function (block) {
              ...
              if (
                ...
                var hardbreak =
                  " " === lastc._literal[lastc._literal.length - 2];
                (lastc._literal = lastc._literal.replace(reFinalSpace, "")),
                  block.appendChild(
                    new Node(hardbreak ? "linebreak" : "softbreak")
                  );
              } else block.appendChild(new Node("softbreak"));
            ...
            parseReference = function (s, refmap) {
              ...
              if (
                ...
                null === dest || 0 === dest.length)
              )
                return (this.pos = startpos), 0;
              var beforetitle = this.pos;
              this.spnl(),
                (title = this.parseLinkTitle()),
                null === title && ((title = ""), (this.pos = beforetitle));
              var atLineEnd = !0;
              if (
                (null === this.match(reSpaceAtEndOfLine) &&
                  ("" === title
                    ? (atLineEnd = !1)
                    : ((title = ""),
            ...
            parseInline = function (block) {
              ...
              return (
                res ||
                  ((this.pos += 1), block.appendChild(text(fromCodePoint(c)))),
                !0
              );
            },
        ...
        },
        {
          ...
          "./node": 6,
          "./normalize-reference": 7,
          entities: 11,
          "string.prototype.repeat": 21,
        },
      ],
      6: [
        function (require, module, exports) {
          ...
          var resumeAt = function (node, entering) {
            ...
            next = function () {
              ...
              return (
                entering && container
                  ? cur._firstChild
                    ? ((this.current = cur._firstChild), (this.entering = !0))
                    : (this.entering = !1)
                  : cur === this.root
                  ? (this.current = null)
                  : null === cur._next
                  ? ((this.current = cur._parent), (this.entering = !1))
                  : ((this.current = cur._next), (this.entering = !0)),
                { entering: entering, node: cur }
              );
            },
          ...
          Object.defineProperty(proto, "isContainer", {
            ...
            (Node.prototype.appendChild = function (child) {
              child.unlink(),
                ...
                this._lastChild
                  ...
                  : ((this._firstChild = child), (this._lastChild = child));
            }),
            ...
            (Node.prototype.insertAfter = function (sibling) {
              sibling.unlink(),
                ...
                sibling._next && (sibling._next._prev = sibling),
                (sibling._prev = this),
                (this._next = sibling),
                (sibling._parent = this._parent),
                sibling._next || (sibling._parent._lastChild = sibling);
            }),
            (Node.prototype.insertBefore = function (sibling) {
              sibling.unlink(),
                (sibling._prev = this._prev),
                sibling._prev && (sibling._prev._next = sibling),
                (sibling._next = this),
                (this._prev = sibling),
                (sibling._parent = this._parent),
                sibling._prev || (sibling._parent._firstChild = sibling);
            }),
        ...
        function (require, module, exports) {
          ...
          function tag(name, attrs, selfclosing) {
            if (!(this.disableTags > 0)) {
              if (((this.buffer += "<" + name), attrs && attrs.length > 0))
                for (var attrib, i = 0; void 0 !== (attrib = attrs[i]); )
                  (this.buffer += " " + attrib[0] + '="' + attrib[1] + '"'),
                    i++;
              selfclosing && (this.buffer += " /"),
                (this.buffer += ">"),
                (this.lastOut = ">");
            }
          }
          ...
          function link(node, entering) {
            ...
            entering
              ? ((this.options.safe && potentiallyUnsafe(node.destination)) ||
                  attrs.push(["href", esc(node.destination, !0)]),
                node.title && attrs.push(["title", esc(node.title, !0)]),
                this.tag("a", attrs))
              : this.tag("/a");
          }
            ...
            entering
              ? (0 === this.disableTags &&
                  this.lit(
                    this.options.safe && potentiallyUnsafe(node.destination)
                      ? '<img src="" alt="'
                      : '<img src="' + esc(node.destination, !0) + '" alt="'
                  ),
                (this.disableTags += 1))
              : ((this.disableTags -= 1),
                0 === this.disableTags &&
                  (node.title && this.lit('" title="' + esc(node.title, !0)),
                  this.lit('" />')));
          }
          ...
          function heading(node, entering) {
            var tagname = "h" + node.level,
              attrs = this.attrs(node);
            entering
              ? (this.cr(), this.tag(tagname, attrs))
              : (this.tag("/" + tagname), this.cr());
          }
          function code(node) {
            this.tag("code"), this.out(node.literal), this.tag("/code");
          }
          function code_block(node) {
            ...
            info_words.length > 0 &&
              ...
              attrs.push(["class", "language-" + esc(info_words[0], !0)]),
              this.cr(),
              this.tag("pre"),
              this.tag("code", attrs),
              this.out(node.literal),
          ...
          function thematic_break(node) {
            var attrs = this.attrs(node);
            this.cr(), this.tag("hr", attrs, !0), this.cr();
          }
          function block_quote(node, entering) {
            var attrs = this.attrs(node);
            entering
              ? (this.cr(), this.tag("blockquote", attrs), this.cr())
              : (this.cr(), this.tag("/blockquote"), this.cr());
          }
          function list(node, entering) {
            var tagname = "bullet" === node.listType ? "ul" : "ol",
              attrs = this.attrs(node);
            if (entering) {
              ...
              null !== start &&
                ...
                this.cr();
            } else this.cr(), this.tag("/" + tagname), this.cr();
          }
          function item(node, entering) {
            var attrs = this.attrs(node);
            entering ? this.tag("li", attrs) : (this.tag("/li"), this.cr());
          }
          function html_inline(node) {
            this.lit(
              this.options.safe ? "<!-- raw HTML omitted -->" : node.literal
            );
          }
          ...
          function custom_inline(node, entering) {
            entering && node.onEnter
              ? this.lit(node.onEnter)
              : !entering && node.onExit && this.lit(node.onExit);
          }
          ...
          var Renderer = require("./renderer"),
            ...
            potentiallyUnsafe = function (url) {
              return (
                reUnsafeProtocol.test(url) && !reSafeDataProtocol.test(url)
              );
            };
          ...
          function render(ast) {
            ...
            for (
              ...
              (type = event.node.type),
                this[type] && this[type](event.node, event.entering);
            return this.buffer;
          }
          function lit(str) {
            (this.buffer += str), (this.lastOut = str);
          }
          function cr() {
          ...
          var escapeXml = require("./common").escapeXml,
            ...
            renderNodes = function (block) {
              var attrs,
                ...
                indent = "  ",
                out = function (s) {
                  (buffer += disableTags > 0 ? s.replace(reXMLTag, "") : s),
                    (lastOut = s);
                },
                esc = this.escape,
                cr = function () {
                  if ("\n" !== lastOut) {
                    (buffer += "\n"), (lastOut = "\n");
                    for (var i = indentLevel; i > 0; i--) buffer += indent;
                  }
                },
                options = this.options;
              for (
                options.time && console.time("rendering"),
                ...
                } else (indentLevel -= 1), cr(), out(tag("/" + tagname));
              return (
                options.time && console.timeEnd("rendering"), (buffer += "\n")
              );
            };
      ...
      11: [
        function (require, module, exports) {
          ...
          (exports.decode = function (data, level) {
            ...
            (exports.decodeStrict = function (data, level) {
              return (!level || 0 >= level ? decode.XML : decode.HTMLStrict)(
                data
              );
            }),
        ...
        { "./lib/decode.js": 12, "./lib/encode.js": 14 },
      ],
      12: [
        function (require, module, exports) {
        ...
        {
          "../maps/entities.json": 16,
          "../maps/legacy.json": 17,
          "../maps/xml.json": 18,
          "./decode_codepoint.js": 13,
        },
      ],
      13: [
        function (require, module, exports) {
          function decodeCodePoint(codePoint) {
            if (
              (codePoint >= 55296 && 57343 >= codePoint) ||
              codePoint > 1114111
            )
              return "�";
      ...
      14: [
        ...
        { "../maps/entities.json": 16, "../maps/xml.json": 18 },
      ],
      15: [
        function (require, module, exports) {
          module.exports = {
                  ...
                  (b1 = parseInt(seq.slice(i + 1, i + 3), 16)),
                    128 > b1
                      ...
                      : 192 === (224 & b1) &&
                        ...
                        128 === (192 & b2))
                      ? ((chr = ((b1 << 6) & 1984) | (63 & b2)),
                        (result += 128 > chr ? "��" : String.fromCharCode(chr)),
                        (i += 3))
                      : 224 === (240 & b1) &&
                        l > i + 6 &&
                        ((b2 = parseInt(seq.slice(i + 4, i + 6), 16)),
          ...
          function encode(string, exclude, keepEscaped) {
            ...
            for (
              "string" != typeof exclude &&
                ...
                "undefined" == typeof keepEscaped && (keepEscaped = !0),
              ...
              else if (128 > code) result += cache[code];
