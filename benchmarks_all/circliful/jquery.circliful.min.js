    ...
    return this.each(function () {
      ...
      if (a(this).data("text") != undefined) {
        ...
        if (a(this).data("type") != undefined) {
          ...
          if (i == "half") {
            a(this).append(
              '<span class="circle-text-half">' + D + s + "</span>"
            );
            a(this)
              .find(".circle-text-half")
              .css({ "line-height": F / 1.45 + "px", "font-size": t + "px" });
          } else {
            a(this).append('<span class="circle-text">' + D + s + "</span>");
            a(this)
              .find(".circle-text")
              .css({ "line-height": F + "px", "font-size": t + "px" });
          }
        } else {
          a(this).append('<span class="circle-text">' + D + s + "</span>");
          a(this)
        ...
        if (a(this).data("type") != undefined) {
          ...
          if (i == "half") {
            ...
            a(this)
              ...
              .css({ "line-height": F * 0.9 + "px" });
          } else {
            a(this).append('<span class="circle-info">' + E + "</span>");
            a(this)
              .find(".circle-info")
              .css({ "line-height": F * 1.25 + "px" });
          }
        } else {
          a(this).append('<span class="circle-info">' + E + "</span>");
          a(this)
      ...
      a(this).width(F + "px");
      var h = a("<canvas></canvas>")
        .attr({ width: F, height: F })
        .appendTo(a(this))
        .get(0);
