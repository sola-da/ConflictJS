  ...
  return (function (t) {
    ...
    function (t, e) {
      ...
      var a = (function () {
        ...
        c = (function () {
          function t(e, n) {
            if ((r(this, t), arguments.length < 2))
        ...
        f = (function () {
          function t(e, n, o, i) {
            ...
            if (e instanceof Node && "CANVAS" === e.tagName) this.canvas = e;
              ...
              if ("string" != typeof e)
                throw new Error("can't look for canvas based on '" + e + "'");
              this.canvas = document.querySelector(e);
            }
            if (!this.canvas) throw new Error("canvas not found");
            (this.canvas.width = n ? n : 500),
              (this.canvas.height = o ? o : 500),
            ...
            var a = function (t) {
                ...
                var e = void 0,
                  n = void 0;
                t.changedTouches
                  ? ((e = t.changedTouches[0].pageX - t.target.offsetLeft),
                    (n = t.changedTouches[0].pageY - t.target.offsetTop))
                  : t.layerX || 0 == t.layerX
                  ? ((e = t.layerX), (n = t.layerY))
                  : (t.offsetX || 0 == t.offsetX) &&
                    ((e = t.offsetX), (n = t.offsetY)),
                  s.mouse.down
                    ? s.draw(e, n)
                    : ((s.mouse.x = e), (s.mouse.y = n));
              },
              h = function (t) {
                return (
                  t.preventDefault(),
                  ...
                  "fill" == s._mode
                    ...
                    : ((s.mouse.px = s.mouse.x),
                      ...
                      (s.mouse.down = !0),
                      s.context.beginPath(),
                      void s.context.moveTo(s.mouse.px, s.mouse.py))
                );
              },
              c = function (t) {
            ...
            this.canvas.addEventListener("mousemove", a),
              ...
              this.canvas.addEventListener("mouseup", c),
              this.canvas.addEventListener("touchstart", h),
              this.canvas.addEventListener("touchend", c),
              this.canvas.addEventListener("touchmove", a),
              (this.context = this.canvas.getContext("2d")),
              (this.context.globalCompositeOperation = "source-over"),
              (this.context.globalAlpha = 1),
              (this.context.strokeStyle = i ? i : "black"),
              ...
              [
                {
                  ...
                  value: function (e, n) {
                    var o = this.mouse,
                      ...
                      s = Math.min(0.87, this._smoothing + (r - 60) / 3e3);
                    (o.x = e - (e - o.px) * s), (o.y = n - (n - o.py) * s);
                    var a = t.lineDistance(o.x, o.y, o.px, o.py);
                    (this._targetThickness =
                      ((a - 1) / 49) * (this._maxWeight - this._weight) +
                      this._weight),
                      this._thickness > this._targetThickness
                        ? (this._thickness -= 0.5)
                        : this._thickness < this._targetThickness &&
                          (this._thickness += 0.5),
                      (i.lineWidth = this._thickness),
                      i.quadraticCurveTo(o.px, o.py, o.x, o.y),
                      i.stroke(),
                      (o.px = o.x),
                      (o.py = o.y);
                  },
                },
                {
                  key: "clear",
                  value: function () {
                    "destination-out" === this.context.globalCompositeOperation
                      ? ((this.mode = "draw"),
                  ...
                  value: function () {
                    var t = this,
                      ...
                      o = Array.prototype.slice.call(
                        n.getImageData(e.x, e.y, 1, 1).data,
                        0
                      );
                    this._filling
                      ? this._fillStack.push([e.x, e.y, o])
                  ...
                  value: function (e, o, i) {
                    for (
                      var r = this,
                        ...
                        p = Math.min(10 * s.globalAlpha * 255, 255),
                        y = t.colorPixel.apply(
                          t,
                          [l.data].concat(n(f), [i, p])
                        ),
                        g = t.matchColor.apply(t, [l.data].concat(n(i)));
                      u.length;
                    ...
                    s.putImageData(l, 0, 0),
                      this._fillStack.length
                        ? this._floodFill.apply(
                            this,
                            n(this._fillStack.shift())
                          )
                        : ((this._filling = !1),
                          setTimeout(function () {
                ...
                },
                {
                  ...
                  set: function (t) {
                    ...
                    (this._weight = t),
                      ...
                      (this._maxWeight = t + this.WEIGHT_SPREAD);
                  },
                },
                {
                  key: "mode",
                  ...
                  value: function (e, o, i, r, s, a) {
                    ...
                    return function (t) {
                      (e[t] = o),
                        ...
                        (e[t + 3] = a),
                        h(t + 4) ||
                          ((e[t + 4] = 0.01 * e[t + 4] + 0.99 * o),
                          (e[t + 4 + 1] = 0.01 * e[t + 4 + 1] + 0.99 * i),
                          (e[t + 4 + 2] = 0.01 * e[t + 4 + 2] + 0.99 * r),
                          (e[t + 4 + 3] = 0.01 * e[t + 4 + 3] + 0.99 * a)),
                        h(t - 4) ||
                          ((e[t - 4] = 0.01 * e[t - 4] + 0.99 * o),
                          (e[t - 4 + 1] = 0.01 * e[t - 4 + 1] + 0.99 * i),
                          (e[t - 4 + 2] = 0.01 * e[t - 4 + 2] + 0.99 * r),
