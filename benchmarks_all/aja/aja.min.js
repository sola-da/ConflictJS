  ...
  var a = ["html", "json", "jsonp", "script"],
      ...
      var a = {},
        ...
        c = {
          ...
          header: function (b, c) {
            return (
              ...
              d.string(b),
              "undefined" != typeof c
                ? (d.string(c), (a.headers[b] = c), this)
                : a.headers[b]
            );
          },
          auth: function (b, c) {
            return (
              d.string(b), d.string(c), (a.auth = { user: b, passwd: c }), this
            );
          },
          timeout: function (a) {
          ...
          on: function (a, c) {
            return (
              "function" == typeof c && ((b[a] = b[a] || []), b[a].push(c)),
              this
            );
          },
          off: function (a) {
          ...
          go: function () {
            var b = a.type || (a.into ? "html" : "json"),
              c = j();
            return "function" == typeof g[b] ? g[b].call(this, c) : void 0;
          },
        },
        g = {
          json: function (a) {
            var b = this;
            g._xhr.call(this, a, function (a) {
              if (a)
                try {
                  a = JSON.parse(a);
                } catch (c) {
          ...
          _xhr: function (b, c) {
            ...
            if (
              (!p &&
                ...
                (p = this.header("Content-Type"))),
              n && i())
            )
              if (("string" != typeof o && (o = ""), p.indexOf("json") > -1))
                try {
                  o = JSON.stringify(n);
                } catch (r) {
                  throw new TypeError(
                    "Unable to stringify body's content : " + r.name
                  );
                }
              else {
                g = p && p.indexOf("x-www-form-urlencoded") > 1;
                for (d in n)
                  o += g
            ...
            (h = [k, b, l]),
              a.auth && (h.push(a.auth.user), h.push(a.auth.passwd)),
              m.open.apply(m, h);
            for (e in a.headers) m.setRequestHeader(e, a.headers[e]);
        ...
        h = function (b, c, e, f) {
          if ("undefined" != typeof c) {
            ...
            return (
              "function" == typeof f ? (a[b] = f.call(this, c)) : (a[b] = c),
              this
            );
          }
    ...
    d = {
      ...
      string: function (a) {
        if ("string" != typeof a)
          throw new TypeError(
            "a string is expected, but " + a + " [" + typeof a + "] given"
          );
        return a;
      },
      positiveInteger: function (a) {
        if (parseInt(a) !== a || 0 >= a)
          throw new TypeError(
            "an integer is expected, but " + a + " [" + typeof a + "] given"
          );
        return a;
      },
      plainObject: function (a) {
        if ("object" != typeof a || a.constructor !== Object)
          throw new TypeError(
            "an object is expected, but " + a + "  [" + typeof a + "] given"
          );
        return a;
      },
      type: function (b) {
        if (((b = this.string(b)), a.indexOf(b.toLowerCase()) < 0))
          throw new TypeError(
            "a type in [" + a.join(", ") + "] is expected, but " + b + " given"
          );
    ...
    e = function (a, b) {
      var c;
      if (((a = a || ""), b))
        if ((-1 === a.indexOf("?") && (a += "?"), "string" == typeof b)) a += b;
