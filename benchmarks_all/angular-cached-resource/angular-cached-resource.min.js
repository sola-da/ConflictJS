...
})(
  {
    1: [
      function (require, module, exports) {
        ...
        module.exports = buildCachedResourceClass = function (
          $resource,
          $timeout,
          $q,
          providerParams,
          ...
          CachedResource = (function () {
            ...
            CachedResource.$clearCache = function (_arg) {
              var cacheArrayEntry,
                ...
                params,
                queue,
                translateEntriesToCacheKeys,
                translateParamsArrayToCacheKeys,
                translateParamsArrayToEntries,
                where,
                _ref,
                _ref1;
              (_ref = _arg != null ? _arg : {}),
                (where = _ref.where),
                (exceptFor = _ref.exceptFor),
                (clearPendingWrites = _ref.clearPendingWrites),
                (isArray = _ref.isArray),
                (clearChildren = _ref.clearChildren);
              if (where == null) {
                where = null;
              }
              if (exceptFor == null) {
              ...
              translateParamsArrayToCacheKeys = function (entries) {
                return translateEntriesToCacheKeys(
                  translateParamsArrayToEntries(entries)
                );
              };
              if (exceptFor || where) {
                if (isArray) {
                  cacheArrayEntry = new ResourceCacheArrayEntry(
                    $key,
                    exceptFor || where
                  ).load();
                  cacheKeys.push(cacheArrayEntry.fullCacheKey());
                  if (
                    cacheArrayEntry.value &&
                    ((exceptFor && !clearChildren) || (where && clearChildren))
                  ) {
                    entries = (function () {
                    ...
                    if (entries) {
                      cacheKeys = cacheKeys.concat(
                        translateEntriesToCacheKeys(entries)
                      );
                    }
                  }
                } else {
                  cacheKeys = translateParamsArrayToCacheKeys(
                    where || exceptFor
                  );
                }
              }
              if (!clearPendingWrites && !where) {
                (_ref1 = CachedResource.$writes),
                  (queue = _ref1.queue),
                  (key = _ref1.key);
                cacheKeys.push(key);
              ...
              if (where) {
                return Cache.clear({ key: $key, where: cacheKeys });
              } else {
                return Cache.clear({ key: $key, exceptFor: cacheKeys });
              }
            };
            CachedResource.$addToCache = function (attrs, dirty) {
              return new CachedResource(attrs).$$addToCache(dirty);
            };
            CachedResource.$addArrayToCache = function (
              attrs,
              instances,
              dirty
            ) {
              ...
              return new ResourceCacheArrayEntry($key, attrs).addInstances(
                instances,
                dirty
              );
            };
          ...
          CachedResource.$writes = new ResourceWriteQueue(
            CachedResource,
            $timeout
          );
          for (actionName in actions) {
            ...
            if (actionConfig.cache !== false) {
              handler =
                method === "GET" && actionConfig.isArray
                  ? readArrayCache(
                      $q,
                      providerParams,
                      actionName,
              ...
              CachedResource.prototype["$" + actionName] =
                Resource.prototype["$" + actionName];
            }
          }
          return CachedResource;
        };
      },
      {
        ...
        "./read_array_cache": 7,
        "./read_cache": 8,
        "./resource_cache_array_entry": 9,
        "./resource_cache_entry": 10,
        "./resource_write_queue": 11,
        "./write_cache": 12,
      },
    ],
    2: [
      function (require, module, exports) {
        ...
        Cache = (function () {
          ...
          function Cache(_arg) {
            (this.$log = _arg.$log),
              (this.localStoragePrefix = _arg.localStoragePrefix);
          }
          ...
          Cache.prototype.clear = function (_arg) {
            ...
            if (where && exceptFor) {
              return this.$log.error(
                "Using where and exceptFor arguments at once in clear() method is forbidden!"
              );
            }
            if (exceptFor) {
              if (exceptFor == null) {
              ...
              cacheKeys = [];
              for (
                i = _i = 0, _ref1 = localStorage.length;
              ...
              for (_l = 0, _len2 = where.length; _l < _len2; _l++) {
                cacheKey = where[_l];
                _results1.push(
                  localStorage.removeItem(this._buildKey(cacheKey))
                );
              }
              return _results1;
            }
        ...
        module.exports = function (providerParams) {
          ...
          return (CachedResourceManager = (function () {
            ...
            CachedResourceManager.prototype.clearUndefined = function () {
              return Cache.clear({ exceptFor: this.keys() });
            };
            return CachedResourceManager;
          })());
        };
      },
      { "./build_cached_resource_class": 1, "./cache": 2 },
    ],
    4: [
      function (require, module, exports) {
        ...
        if (typeof module !== "undefined" && module !== null) {
          module.exports = app = angular.module("ngCachedResource", [
            "ngResource",
          ]);
        }
        app.provider(
          "$cachedResource",
          ($cachedResourceProvider = (function () {
            function $cachedResourceProvider() {
              this.$get = $cachedResourceFactory;
              localStoragePrefix = "cachedResource://";
            }
            $cachedResourceProvider.prototype.setDebugMode = function (
              newSetting
            ) {
              if (newSetting == null) {
                newSetting = true;
            ...
            $cachedResourceProvider.prototype.setLocalStoragePrefix = function (
              prefix
            ) {
        ...
        $cachedResourceFactory = [
          ...
          "$q",
          "$log",
          function ($resource, $timeout, $q, $log) {
            var $cachedResource,
            ...
            resourceManager = new CachedResourceManager(
              $resource,
              $timeout,
              $q
            );
            ...
            for (_i = 0, _len = _ref.length; _i < _len; _i++) {
              fn = _ref[_i];
              $cachedResource[fn] = angular.bind(
                resourceManager,
                resourceManager[fn]
              );
            }
      ...
      { "./cached_resource_manager": 3 },
    ],
    5: [
      function (require, module, exports) {
        var modifyObjectInPlace;
        module.exports = modifyObjectInPlace = function (
          oldObject,
          newObject,
          cachedObject
        ) {
          ...
          for (_j = 0, _len1 = _ref1.length; _j < _len1; _j++) {
            ...
            if (key[0] !== "$") {
              if (
                angular.isObject(oldObject[key]) &&
                angular.isObject(newObject[key])
              ) {
                modifyObjectInPlace(
                  oldObject[key],
                  newObject[key],
                  cachedObject != null ? cachedObject[key] : void 0
                );
              } else {
                localChanges =
                  cachedObject &&
                  !angular.equals(oldObject[key], cachedObject[key]);
                if (
                  !(
                    angular.equals(oldObject[key], newObject[key]) ||
                    localChanges
                  )
                ) {
    ...
    6: [
      function (require, module, exports) {
        ...
        module.exports = processReadArgs = function ($q, args) {
          ...
          return { params: params, deferred: deferred };
        };
      },
      {},
    ],
    7: [
      function (require, module, exports) {
        ...
        module.exports = readArrayCache = function (
          $q,
          providerParams,
          name,
          CachedResource,
          ...
          return function () {
            var arrayInstance,
              ...
              _ref,
              _ref1;
            (_ref = processReadArgs($q, arguments)),
              (params = _ref.params),
              (cacheDeferred = _ref.deferred);
            ...
            readHttp = function () {
              ...
              resource.$promise.then(function (response) {
                ...
                arrayInstance.splice.apply(
                  arrayInstance,
                  [0, arrayInstance.length].concat(
                    __slice.call(newArrayInstance)
                  )
                );
            ...
            if (cacheArrayEntry.value) {
              ...
              for (_i = 0, _len = _ref1.length; _i < _len; _i++) {
                ...
                arrayInstance.push(
                  new CachedResource(cacheInstanceEntry.value)
                );
              }
              cacheDeferred.resolve(arrayInstance);
            } else if (actionConfig.cacheOnly) {
              cacheDeferred.reject(
                new Error("Cache value does not exist for params", params)
              );
            }
      ...
      function (require, module, exports) {
        ...
        module.exports = readCache = function (
          ...
          return function () {
            ...
            readHttp = function () {
              var resource;
              resource = CachedResource.$resource[name].call(
        ...
        module.exports = function (providerParams) {
          ...
          return (ResourceCacheArrayEntry = (function (_super) {
            ...
            function ResourceCacheArrayEntry() {
              return ResourceCacheArrayEntry.__super__.constructor.apply(
                this,
                arguments
              );
            }
            ...
            ResourceCacheArrayEntry.prototype.addInstances = function (
              instances,
              dirty,
              options
            ) {
              var cacheArrayReferences,
                cacheInstanceEntry,
                cacheInstanceParams,
                instance,
                _i,
              ...
              for (_i = 0, _len = instances.length; _i < _len; _i++) {
                ...
                if (Object.keys(cacheInstanceParams).length === 0) {
                  $log.error(
                    "'" +
                      this.key +
                      "' instance doesn't have any boundParams. Please, make sure you specified them in your resource's initialization, f.e. `{id: \"@id\"}`, or it won't be cached."
                  );
                } else {
        ...
        module.exports = function (providerParams) {
          ...
          return (ResourceCacheEntry = (function () {
            ...
            function ResourceCacheEntry(key, params) {
              var param, paramKeys;
              this.key = key;
              paramKeys = angular.isObject(params)
            ...
            ResourceCacheEntry.prototype.load = function () {
              var _ref;
              (_ref = Cache.getItem(this.fullCacheKey(), this.defaultValue)),
                (this.value = _ref.value),
                (this.dirty = _ref.dirty);
              return this;
            };
    ...
    11: [
      function (require, module, exports) {
        ...
        module.exports = function (providerParams, $q) {
          ...
          return (ResourceWriteQueue = (function () {
            ResourceWriteQueue.prototype.logStatusOfRequest = function (
              status,
              action,
              params,
              data
            ...
            ResourceWriteQueue.prototype.enqueue = function (
              params,
              resourceData,
              action,
              deferred
              ...
              resourceParams = angular.isArray(resourceData)
                ? resourceData.map(function (resource) {
                    return resource.$params();
                  })
                : resourceData.$params();
              write = this.findWrite({ params: params, action: action });
              if (write == null) {
                this.queue.push({
                  params: params,
              ...
              return this.logStatusOfRequest(
                "enqueued",
                action,
                params,
                resourceData
            ...
            ResourceWriteQueue.prototype.findWrite = function (_arg) {
              ...
              for (_i = 0, _len = _ref.length; _i < _len; _i++) {
                ...
                if (
                  action === write.action &&
                  angular.equals(params, write.params)
                ) {
                  return write;
                }
              }
            ...
            ResourceWriteQueue.prototype.removeWrite = function (_arg) {
              ...
              for (_i = 0, _len = _ref.length; _i < _len; _i++) {
                ...
                if (
                  !(
                    action === entry.action &&
                    angular.equals(params, entry.params)
                  )
                ) {
                  newQueue.push(entry);
                }
            ...
            ResourceWriteQueue.prototype.processResource = function (
              params,
              done
            ) {
                  ...
                  this._processWrite(
                    ...
                    (function (_this) {
                      return function () {
                        if (
                          notDone &&
                          _this._writesForResource(params).length === 0
                        ) {
                          notDone = false;
                          return done();
                        }
            ...
            ResourceWriteQueue.prototype._writesForResource = function (
              params
            ) {
              var write, _i, _len, _ref, _results;
              _ref = this.queue;
            ...
            ResourceWriteQueue.prototype._processWrite = function (
              write,
              done
            ) {
              ...
              if (angular.isArray(write.resourceParams)) {
                cacheEntries = write.resourceParams.map(
                  (function (_this) {
                    return function (resourceParams) {
                      return new ResourceCacheEntry(
                        _this.CachedResource.$key,
                        resourceParams
                      ).load();
                    };
                  })(this)
                ...
                cacheEntries = [
                  new ResourceCacheEntry(
                    this.CachedResource.$key,
                    write.resourceParams
                  ).load(),
                ];
              ...
              onFailure = (function (_this) {
                return function (error) {
                  ...
                  return (_ref = write.deferred) != null
                    ? _ref.reject(error)
                    : void 0;
                };
              })(this);
              this.CachedResource.$resource[write.action](
                write.params,
                writeData,
                onSuccess,
                onFailure
                ...
                (function (_this) {
                  return function (savedResources) {
                    var cacheEntry,
                      ...
                      _len,
                      _results;
                    savedResources = angular.isArray(savedResources)
                      ? savedResources
                      : [savedResources];
                    _results = [];
                    for (
                      _i = 0, _len = savedResources.length;
                      _i < _len;
                      _i++
                    ) {
      ...
      { "./cache": 2, "./resource_cache_entry": 10 },
    ],
    12: [
      function (require, module, exports) {
        ...
        module.exports = writeCache = function (
          ...
          return function () {
            ...
            args = Array.prototype.slice.call(arguments);
            params =
              !instanceMethod && angular.isObject(args[1])
                ? args.shift()
                : instanceMethod && angular.isObject(args[0])
                ? args.shift()
                : {};
      ...
      { "./modify_object_in_place": 5, "./resource_cache_entry": 10 },
    ],
  },
  {},
  [4]
