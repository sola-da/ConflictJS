  ...
  var c = (function (b) {
    ...
    return (
      (o._a = function () {
        var a = {
          removeAnim: function (a, b) {
            a.target &&
              a.type &&
              b.nodeHelper.removeClass(a.target, b.behavior);
          },
          holdAnimClass: function () {},
          fireOnce: function (a, b) {
            b.eventSystem.removeEventListenerHelper(
              b.eventTarget,
              b.event.type,
              b.listener
            );
        ...
        if (i)
          if (o.Util._x(i)) {
            ...
            j &&
              ...
              (g = j[0](d, { dataAniJSOwner: a }, o._z(j)));
      ...
      (o._y = function (a, b, c) {
        ...
        return (
          o.Util._x(e) &&
            ((d = o._k(a, b, e[0])), d ? (e[0] = d) : (e = e.join(" "))),
          e
        );
      }),
      (o._k = function (a, b, c) {
      ...
      (o._notifierHelper = function (a) {
        ...
        if (a)
          if (a.id && b.EventSystem.isEventTarget(a.value))
            c.push(a.value), b.registerNotifier(a);
          else if (a.split) {
        ...
        (c.init = function (a) {
          ...
          (c.doDefaultAction = function (a, b) {
            ...
            e.eventSystem.addEventListenerHelper(a, g, function (a) {
              a.stopPropagation(),
                e.eventSystem.removeEventListenerHelper(
                  a.target,
                  a.type,
                  arguments.callee
                ),
          ...
          (c.run = function () {
            ...
            (c.hasRunned = 1),
              o.Util._x(b) ? a.doFunctionAction(d, b) : a.doDefaultAction(d, b);
          }),
          c.init(a);
      }),
      (o.Parser = {
        ...
        parseDoDefinition: function (a) {
          ...
          if (null !== c) {
            (d = c[1]),
              ...
              (doDefinitionArray =
                null !== doDefinitionArray ? doDefinitionArray.split(e) : []),
              (a = []),
              (a[0] = d);
            for (var g = 0; g < doDefinitionArray.length; g++)
              "" !== doDefinitionArray[g] &&
                (a[f++] = doDefinitionArray[g].trim());
            return a;
          }
          return a;
        },
        ...
        addClass: function (a, b) {
          ...
          for (var c = 0, d = b.length; d > c; ++c)
            b[c] &&
              ...
              (a.className =
                "" === a.className ? b[c] : a.className.trim() + " " + b[c]);
        },
        removeClass: function (a, b) {
          b instanceof Array || (b = b.split(" "));
          for (var c = 0, d = b.length; d > c; ++c)
            a.className = a.className
              .replace(new RegExp(j + b[c] + k), " ")
              .trim();
        },
      ...
      (b.EventSystem = {
        ...
        purgeEventTarget: function (a) {
          ...
          if (d) {
            ...
            for (g; f > g; g++)
              (e = b[g]),
                c.removeEventListenerHelper(a, e.eventType, e.listener);
      ...
      (b.EventTarget.prototype = {
        ...
        addEventListener: function (a, b) {
          var c = this;
          "undefined" == typeof c._listeners[a] && (c._listeners[a] = []),
        ...
        dispatchEvent: function (a) {
          ...
          if (this._listeners[a.type] instanceof Array)
            for (var c = b._listeners[a.type], d = 0, e = c.length; e > d; d++)
              c[d].call(b, a);
        },
