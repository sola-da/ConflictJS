...
Backbone.EventBinder = (function (e, t) {
  "use strict";
  function r(e) {
  ...
  return (
    (i.extend = e.View.extend),
    t.extend(i.prototype, {
      bindTo: function () {
        var e = arguments[0],
          t = r(e),
          n = t.bindTo.apply(this, arguments);
        return this._eventBindings.push(n), n;
      },
      unbindFrom: function (e) {
        n[e.type].unbindFrom.apply(this, arguments),
          (this._eventBindings = t.reject(this._eventBindings, function (t) {
            return t === e;
          }));
      },
      unbindAll: function () {
