  ...
  return (function (t) {
    ...
    function (t, e, r) {
      ...
      var i = r(3),
        ...
        f = r(11),
        l = n(f);
      (o.createSpy = a.createSpy),
        (o.spyOn = a.spyOn),
        (o.isSpy = a.isSpy),
        (o.restoreSpies = a.restoreSpies),
        (o.assert = c["default"]),
        (o.extend = l["default"]),
        (t.exports = o);
    },
      ...
      var o = r(28),
        ...
        a = function (t, e) {
          for (
            ...
            n[o - 2] = arguments[o];
          if (!t) {
            var i = "string" == typeof e ? u(e, n) : e(n);
            throw new Error(i);
          }
        };
      e["default"] = a;
    ...
    function (t, e) {
      ...
      t.exports = function (t) {
        return "object" != typeof t ? !1 : u ? n(t) : o.call(t) === i;
      };
    },
    function (t, e, r) {
      "use strict";
      ...
      var i =
        ...
        b = (function () {
          function t(e) {
            o(this, t),
              (this.actual = e),
              (0, d.isFunction)(e) && ((this.context = null), (this.args = []));
          }
          return (
            u(t, [
              {
              ...
              },
              {
                ...
                value: function (t, e) {
                  try {
                    (0, y["default"])(
                      (0, d.isEqual)(this.actual, t),
                      e || "Expected %s to equal %s",
                      this.actual,
                      t
                    );
                  } catch (r) {
              ...
              },
              {
                ...
                value: function (t, e) {
                  return (
                    (0, y["default"])(
                      (0, d.isFunction)(t) || "string" == typeof t,
                      'The "value" argument in toBeA(value) must be a function or a string'
                    ),
                    (0, y["default"])(
                      (0, d.isA)(this.actual, t),
                      e || "Expected %s to be a %s",
                      this.actual,
                      t
                    ),
                    this
                  ...
                  return (
                    "string" == typeof this.actual
                      ? ((0, y["default"])(
                        ...
                        (r = t.test(this.actual)))
                      : (0, d.isObject)(this.actual)
                      ? (r = (0, f["default"])(this.actual, t))
                      : (0, y["default"])(
                          !1,
              ...
              },
              {
                ...
                value: function (t, e) {
                  return (
                    ...
                    (0, y["default"])(
                      this.actual < t,
                      e || "Expected %s to be less than %s",
                      this.actual,
                      t
                    ),
                    this
              ...
              },
              {
                ...
                value: function (t, e) {
                  return (
                    ...
                    (0, y["default"])(
                      this.actual <= t,
                      e || "Expected %s to be less than or equal to %s",
                      this.actual,
                      t
                    ),
                    this
              ...
              },
              {
                ...
                value: function (t, e) {
                  return (
                    ...
                    (0, y["default"])(
                      this.actual > t,
                      e || "Expected %s to be greater than %s",
                      this.actual,
                      t
                    ),
                    this
              ...
              },
              {
                ...
                value: function (t, e) {
                  return (
                    ...
                    (0, y["default"])(
                      this.actual >= t,
                      e || "Expected %s to be greater than or equal to %s",
                      this.actual,
                      t
                    ),
                    this
              ...
              },
              {
                ...
                value: function (t, e, r) {
                  "string" == typeof e && ((r = e), (e = null)),
                    null == e && (e = d.isEqual);
                  var n = !1;
                  return (
                    (0, d.isArray)(this.actual)
                      ? (n = (0, d.arrayContains)(this.actual, t, e))
                      : (0, d.isObject)(this.actual)
                      ? (n = (0, d.objectContains)(this.actual, t, e))
                      : "string" == typeof this.actual
                      ? (n = (0, d.stringContains)(this.actual, t))
                      : (0, y["default"])(
                          !1,
              ...
              },
              {
                ...
                value: function (t, e, r) {
                  ...
                  return (
                    (0, y["default"])(
                      o,
                      r || "Expected %s to include key(s) %s",
                      this.actual,
                      t.join(", ")
                    ),
                    this
              ...
              },
              {
                ...
                value: function (t) {
                  for (
                    ...
                    r[n - 1] = arguments[n];
                  return this.toIncludeKeys.apply(this, [[t]].concat(r));
                },
              },
              {
                key: "toExcludeKeys",
                value: function (t, e, r) {
                  ...
                  return (
                    (0, y["default"])(
                      !o,
                      r || "Expected %s to exclude key(s) %s",
                      this.actual,
                      t.join(", ")
                    ),
                    this
              ...
              },
              {
                ...
                value: function (t) {
                  for (
                    ...
                    r[n - 1] = arguments[n];
                  return this.toExcludeKeys.apply(this, [[t]].concat(r));
                },
              },
              {
              ...
              },
              {
                ...
                value: function () {
                  ...
                  return (
                    ...
                    (0, y["default"])(
                      n.calls.some(function (t) {
                        return (0, d.isEqual)(t.arguments, e);
                      }),
              ...
              },
              {
                ...
                value: function (t) {
                  ...
                  return (
                    ...
                    (0, y["default"])(
                      0 === e.calls.length,
                      t || "spy was not supposed to be called"
                    ),
                    this
                  );
                },
        ...
        v = function (t, e) {
          var r = !1;
          return function () {
            r || ((r = !0), console.warn(e));
            for (var n = arguments.length, o = Array(n), i = 0; n > i; i++)
              o[i] = arguments[i];
            return t.apply(this, o);
          };
        };
      (b.prototype.withContext = v(function (t) {
        return (
          (0, y["default"])(
            (0, d.isFunction)(this.actual),
        ...
        (b.prototype.withArgs = v(function () {
          var t;
          return (
            (0, y["default"])(
              (0, d.isFunction)(this.actual),
            ...
            arguments.length &&
              (this.args = (t = this.args).concat.apply(t, arguments)),
            this
          );
      ...
      for (var w in m)
        m.hasOwnProperty(w) && (b.prototype[w] = b.prototype[m[w]]);
      e["default"] = b;
    },
    function (t, e, r) {
      "use strict";
      ...
      Object.defineProperty(e, "__esModule", { value: !0 }),
        (e.spyOn = e.createSpy = e.restoreSpies = e.isSpy = void 0);
      var i = r(13),
        u = r(1),
        a = n(u),
        s = r(5),
        c = function () {},
        f =
          i.supportsDescriptors &&
          Object.getOwnPropertyDescriptor(function () {}, "length")
            .configurable,
        l = (e.isSpy = function (t) {
          return t && t.__isSpy === !0;
        }),
        h = [],
        p =
          ((e.restoreSpies = function () {
            for (var t = h.length - 1; t >= 0; t--) h[t].restore();
            h = [];
          }),
          (e.createSpy = function (t) {
            function e() {
              if (
                (l.calls.push({
                  context: this,
            ...
            return (
              ...
              (l.calls = []),
              (l.andCall = function (t) {
                return (n = t), l;
              }),
              (l.andCallThrough = function () {
                return l.andCall(t);
              }),
              (l.andThrow = function (t) {
                return (i = t), l;
              }),
              (l.andReturn = function (t) {
                return (u = t), l;
              }),
              (l.getLastCall = function () {
                return l.calls[l.calls.length - 1];
              }),
              (l.reset = function () {
                l.calls = [];
              }),
              (l.restore = l.destroy = r),
              (l.__isSpy = !0),
              h.push(l),
              l
            );
          }));
      e.spyOn = function (t, e) {
        var r = t[e];
        return (
          l(r) ||
            ((0, a["default"])(
    ...
    function (t, e, r) {
      ...
      var o =
        ...
        c = r(10),
        f = n(c),
        l = (e.whyNotEqual = function (t, e) {
          return t == e ? "" : (0, s["default"])(t, e);
        }),
        h =
        ...
        p = (e.isArray = function (t) {
          return Array.isArray(t);
        }),
        y = (e.isObject = function (t) {
          return (
            t &&
            !p(t) &&
        ...
        g =
          ((e.isA = function (t, e) {
            return h(e)
              ...
              : "array" === e
              ? Array.isArray(t)
              : ("undefined" == typeof t ? "undefined" : o(t)) === e;
          }),
          (e.functionThrows = function (t, e, r, n) {
            try {
              t.apply(e, r);
            } catch (o) {
              if (null == n) return !0;
              if (h(n) && o instanceof n) return !0;
              var i = o.message || o;
              if ("string" == typeof i) {
                if ((0, u["default"])(n) && n.test(o.message)) return !0;
                if ("string" == typeof n && -1 !== i.indexOf(n)) return !0;
              }
            }
            return !1;
          }),
          (e.arrayContains = function (t, e, r) {
          ...
          function (t) {
            return "object" ===
              ...
              ? Object.getOwnPropertySymbols(t)
                  ...
                  .concat((0, f["default"])(t))
              : (0, f["default"])(t);
          });
      (e.objectContains = function d(t, e, r) {
        return g(e).every(function (n) {
          return y(t[n]) && y(e[n]) ? d(t[n], e[n], r) : r(t[n], e[n]);
        });
      }),
        (e.stringContains = function (t, e) {
    ...
    function (t, e, r) {
      (function (t, n) {
        ...
        function u(e, r) {
          if (((e = g(e, 0 > r ? 0 : 0 | d(r))), !t.TYPED_ARRAY_SUPPORT))
        ...
        function h(e, r) {
          return (
            t.TYPED_ARRAY_SUPPORT
              ? (r.byteLength, (e = t._augment(new Uint8Array(r))))
              : (e = l(e, new Uint8Array(r))),
            e
          );
        }
        function p(t, e) {
        ...
        function y(t, e) {
          ...
          "Buffer" === e.type &&
            X(e.data) &&
            ((r = e.data), (n = 0 | d(r.length))),
            (t = g(t, n));
          for (var o = 0; n > o; o += 1) t[o] = 255 & r[o];
          return t;
        }
        function g(e, r) {
          t.TYPED_ARRAY_SUPPORT
            ? ((e = t._augment(new Uint8Array(r))), (e.__proto__ = t.prototype))
            : ((e.length = r), (e._isBuffer = !0));
          var n = 0 !== r && r <= t.poolSize >>> 1;
          return n && (e.parent = Z), e;
        }
        function d(t) {
          if (t >= i())
              ...
              switch (a) {
                ...
                case 3:
                  (s = t[o + 1]),
                    ...
                    128 === (192 & s) &&
                      128 === (192 & c) &&
                      ((l = ((15 & i) << 12) | ((63 & s) << 6) | (63 & c)),
                      l > 2047 && (55296 > l || l > 57343) && (u = l));
                  break;
                case 4:
                  (s = t[o + 1]),
                    (c = t[o + 2]),
        ...
        function M(e, r, n, o, i, u) {
          if (!t.isBuffer(e))
            throw new TypeError("buffer must be a Buffer instance");
          if (r > i || u > r) throw new RangeError("value is out of bounds");
        ...
        function k(t, e, r, n, o) {
          return (
            ...
            W.write(t, e, r, n, 23, 4),
            r + 4
          );
        }
        function D(t, e, r, n, o) {
          return (
            o || N(t, e, r, 8, 1.7976931348623157e308, -1.7976931348623157e308),
            W.write(t, e, r, n, 52, 8),
            r + 8
          );
        }
        function F(t) {
        ...
        function q(t, e) {
          e = e || 1 / 0;
          for (var r, n = t.length, o = null, i = [], u = 0; n > u; u++) {
        ...
        (t.TYPED_ARRAY_SUPPORT =
          ...
          t.TYPED_ARRAY_SUPPORT
            ...
            : ((t.prototype.length = void 0), (t.prototype.parent = void 0)),
          ...
          (t.compare = function (e, r) {
            ...
            if (e === r) return 0;
            for (
              var n = e.length, o = r.length, i = 0, u = Math.min(n, o);
              u > i && e[i] === r[i];

            )
              ++i;
            return (
              i !== u && ((n = e[i]), (o = r[i])), o > n ? -1 : n > o ? 1 : 0
            );
          }),
          ...
          (t.prototype.indexOf = function (e, r) {
            function n(t, e, r) {
              for (var n = -1, o = 0; r + o < t.length; o++)
                if (t[r + o] === e[-1 === n ? 0 : o - n]) {
                  if ((-1 === n && (n = o), o - n + 1 === e.length))
                    return r + n;
                } else n = -1;
              return -1;
            }
        ...
        (t.prototype.slice = function (e, r) {
          ...
          (t.prototype.readFloatLE = function (t, e) {
            return e || C(t, 4, this.length), W.read(this, t, !0, 23, 4);
          }),
          (t.prototype.readFloatBE = function (t, e) {
            return e || C(t, 4, this.length), W.read(this, t, !1, 23, 4);
          }),
          (t.prototype.readDoubleLE = function (t, e) {
            return e || C(t, 8, this.length), W.read(this, t, !0, 52, 8);
          }),
          (t.prototype.readDoubleBE = function (t, e) {
            return e || C(t, 8, this.length), W.read(this, t, !1, 52, 8);
          }),
          (t.prototype.writeUIntLE = function (t, e, r, n) {
            (t = +t),
              (e = 0 | e),
              (r = 0 | r),
              n || M(this, t, e, r, Math.pow(2, 8 * r), 0);
            var o = 1,
              i = 0;
          ...
          (t.prototype.copy = function (e, r, n, o) {
            ...
            var i,
              u = o - n;
            if (this === e && r > n && o > r)
              for (i = u - 1; i >= 0; i--) e[i + r] = this[i + n];
            else if (1e3 > u || !t.TYPED_ARRAY_SUPPORT)
              for (i = 0; u > i; i++) e[i + r] = this[i + n];
            else e._set(this.subarray(n, n + u), r);
            return u;
          }),
          ...
          (t.prototype.toArrayBuffer = function () {
            if ("undefined" != typeof Uint8Array) {
              ...
              for (
                var e = new Uint8Array(this.length), r = 0, n = e.length;
                n > r;
                r += 1
              )
                e[r] = this[r];
        ...
        t._augment = function (e) {
          return (
            ...
            (e.copy = V.copy),
            (e.slice = V.slice),
            (e.readUIntLE = V.readUIntLE),
            (e.readUIntBE = V.readUIntBE),
            ...
            (e.readIntLE = V.readIntLE),
            (e.readIntBE = V.readIntBE),
            ...
            (e.writeUIntLE = V.writeUIntLE),
            (e.writeUIntBE = V.writeUIntBE),
            ...
            (e.writeIntLE = V.writeIntLE),
            (e.writeIntBE = V.writeIntBE),
      ...
      var n = Object.prototype.hasOwnProperty,
        ...
        y = function (t) {
          ...
          if (i && t.length > 0)
            ...
            for (var d in t)
              (h && "prototype" === d) || !n.call(t, d) || l.push(String(d));
          if (a)
            for (var b = p(t), v = 0; v < c.length; ++v)
              (b && "constructor" === c[v]) || !n.call(t, c[v]) || l.push(c[v]);
          return l;
        };
      (y.shim = function () {
        if (Object.keys) {
    ...
    function (t, e, r) {
      ...
      function o(t) {
        if (-1 === a.indexOf(t)) {
          a.push(t);
          for (var e in t)
            t.hasOwnProperty(e) && (u["default"].prototype[e] = t[e]);
        }
      }
      Object.defineProperty(e, "__esModule", { value: !0 });
      var i = r(3),
    ...
    function (t, e, r) {
      ...
      !(function (t) {
        ...
        function r(t) {
          ...
          var f = t.length;
          (s = "=" === t.charAt(f - 2) ? 2 : "=" === t.charAt(f - 1) ? 1 : 0),
            (c = new i((3 * t.length) / 4 - s)),
            (u = s > 0 ? t.length - 4 : t.length);
          var l = 0;
          for (n = 0, o = 0; u > n; n += 4, o += 3)
            (a =
              (e(t.charAt(n)) << 18) |
              (e(t.charAt(n + 1)) << 12) |
              (e(t.charAt(n + 2)) << 6) |
          ...
          return (
            2 === s
              ? ((a = (e(t.charAt(n)) << 2) | (e(t.charAt(n + 1)) >> 4)),
                r(255 & a))
              : 1 === s &&
                ((a =
                  (e(t.charAt(n)) << 10) |
        ...
        function o(t) {
          ...
          var o,
            ...
            a = t.length % 3,
            s = "";
          for (o = 0, u = t.length - a; u > o; o += 3)
            (i = (t[o] << 16) + (t[o + 1] << 8) + t[o + 2]), (s += r(i));
          switch (a) {
            case 1:
              (i = t[t.length - 1]),
                (s += e(i >> 2)),
    ...
    function (t, e) {
      ...
      t.exports = function (t, e, o) {
        ...
        var i = t.length;
        if (i === +i) for (var u = 0; i > u; u++) e.call(o, t[u], u, t);
        else for (var a in t) r.call(t, a) && e.call(o, t[a], a, t);
      };
    },
    function (t, e) {
      ...
      t.exports = function (t) {
        var e = this;
        if ("function" != typeof e || o.call(e) !== i)
    ...
    function (t, e, r) {
      ...
      t.exports = function (t) {
        if (!n(t)) return !1;
        var e = o.call(t);
        return e.length > 0 && !i.test(e) && (u.test(e) || a.test(e));
      };
    },
    function (t, e) {
      "use strict";
    ...
    function (t, e) {
      ...
      t.exports = function () {
        var t = (function () {
            if ("function" != typeof Map) return null;
            try {
          ...
          e = (function () {
            if ("function" != typeof Set) return null;
            try {
    ...
    function (t, e, r) {
      ...
      t.exports = function () {
        var t =
          "function" == typeof Symbol && n(Symbol.iterator)
            ? Symbol.iterator
            : null;
        return (
          "function" == typeof Object.getOwnPropertyNames &&
            ...
            Object.getOwnPropertyNames(Map.prototype).forEach(function (e) {
              "entries" !== e &&
                "size" !== e &&
    ...
    function (t, e, r) {
      ...
      var n = Object.prototype,
        ...
        b = function () {},
        v = "foo" === b.name,
        m = "function" == typeof Symbol ? Symbol.prototype.valueOf : null,
        w = r(22)(),
        E = r(21)(),
          ...
          "object" == typeof "test".__proto__
            ...
            : function (t) {
                var e,
                  r = t.constructor;
                if (u(t, "constructor")) {
                  if (((e = r), !delete t.constructor)) return null;
                  (r = t.constructor), (t.constructor = e);
                }
                return r ? r.prototype : n;
              });
      var T =
          Array.isArray ||
          function (t) {
        ...
        x = function (t) {
          var e = [];
          try {
            E.Map.call(t, function (t, r) {
              e.push([t, r]);
            });
          } catch (r) {
            try {
              E.Set.call(t, function (t) {
                e.push([t]);
              });
            } catch (n) {
              return !1;
      ...
      t.exports = function j(t, e) {
        if (t === e) return "";
        if (null == t || null == e)
          return t === e ? "" : String(t) + " !== " + String(e);
        var r = o.call(t),
          n = o.call(t);
        if (r !== n) return "toStringTag is not the same: " + r + " !== " + n;
        var b = s(t),
          O = s(e);
        if (b || O) {
          if (!b) return "first argument is not a boolean; second argument is";
          if (!O) return "second argument is not a boolean; first argument is";
          var B = i.call(t),
            I = i.call(e);
          return B === I
            ? ""
            : "primitive value of boolean arguments do not match: " +
                B +
                " !== " +
                I;
        }
        var _ = l(t),
          P = l(t);
        if (_ || P) {
          if (!_) return "first argument is not a number; second argument is";
          if (!P) return "second argument is not a number; first argument is";
          var R = Number(t),
            C = Number(e);
          if (R === C) return "";
          var M = isNaN(t),
            U = isNaN(e);
          return M && !U
            ? "first argument is NaN; second is not"
            : !M && U
            ? "second argument is NaN; first is not"
            : M && U
            ? ""
            : "numbers are different: " + t + " !== " + e;
        }
        var L = p(t),
          N = p(e);
        if (L || N) {
          if (!L) return "second argument is string; first is not";
          if (!N) return "first argument is string; second is not";
          var k = String(t),
            D = String(e);
          return k === D
            ? ""
            : 'string values are different: "' + k + '" !== "' + D + '"';
        }
        var F = c(t),
          Y = c(e);
        if (F || Y) {
          if (!F) return "second argument is Date, first is not";
          if (!Y) return "first argument is Date, second is not";
          var H = +t,
            q = +e;
          return H === q
            ? ""
            : "Dates have different time values: " + H + " !== " + q;
        }
        var K = h(t),
          $ = h(e);
        if (K || $) {
          if (!K) return "second argument is RegExp, first is not";
          if (!$) return "first argument is RegExp, second is not";
          var G = String(t),
            z = String(e);
          return G === z
            ? ""
            : "regular expressions differ: " + G + " !== " + z;
        }
        var J = T(t),
          W = T(e);
        if (J || W) {
          if (!J) return "second argument is an Array, first is not";
          if (!W) return "first argument is an Array, second is not";
          if (t.length !== e.length)
            return (
              "arrays have different length: " + t.length + " !== " + e.length
            );
          if (String(t) !== String(e)) return "stringified Arrays differ";
          for (var X, Z, Q = t.length - 1, V = ""; "" === V && Q >= 0; ) {
            if (((X = u(t, Q)), (Z = u(e, Q)), !X && Z))
              return "second argument has index " + Q + "; first does not";
            if (X && !Z)
              return "first argument has index " + Q + "; second does not";
            (V = j(t[Q], e[Q])), (Q -= 1);
          }
          return V;
        }
        ...
        if (rt !== nt)
          return rt
            ? "first argument is a Generator; second is not"
        ...
        if (g(t) || g(e)) {
          if (v && "" !== j(t.name, e.name))
            return (
              'Function names differ: "' + t.name + '" !== "' + e.name + '"'
            );
          if ("" !== j(t.length, e.length))
            return "Function lengths differ: " + t.length + " !== " + e.length;
          var ut = S(String(t)),
            at = S(String(e));
          return "" === j(ut, at)
            ? ""
        ...
        if ("object" == typeof t || "object" == typeof e) {
          if (typeof t != typeof e)
            return (
              "arguments have a different typeof: " +
              typeof t +
              " !== " +
              typeof e
            );
          ...
          if (A(t) !== A(e)) return "arguments have a different [[Prototype]]";
          if (w) {
            var st = t[w],
              ct = g(st),
              ft = e[w],
            ...
            if (ct && lt) {
              ...
              do
                if (
                  ((ht = gt.next()),
                  (pt = dt.next()),
                  !ht.done && !pt.done && ((yt = j(ht, pt)), "" !== yt))
                )
                  return "iteration results are not equal: " + yt;
              while (!ht.done && !pt.done);
              return ht.done && !pt.done
            ...
            if (mt && wt) {
              var Et = j(bt, vt);
              return "" === Et ? "" : "Collection entries differ: " + Et;
            }
          }
          var At, Tt, St, xt;
          for (At in t)
            if (u(t, At)) {
              if (!u(e, At))
                return 'first argument has key "' + At + '"; second does not';
              if (
                ((Tt = t[At] && t[At][At] === t),
                (St = e[At] && e[At][At] === e),
                Tt !== St)
                ...
                return Tt
                  ? 'first argument has a circular reference at key "' +
                      At +
                      '"; second does not'
                  : 'second argument has a circular reference at key "' +
                      At +
                      '"; first does not';
              if (!Tt && !St && ((xt = j(t[At], e[At])), "" !== xt))
                return 'value at key "' + At + '" differs: ' + xt;
            }
          for (At in e)
            if (u(e, At) && !u(t, At))
              return 'second argument has key "' + At + '"; first does not';
          return "";
        }
        return !1;
      };
    ...
    function (t, e) {
      ...
      function i(t) {
        return "[object RegExp]" === h(t);
      }
      function u(t) {
        return "[object Error]" === h(t);
      }
      function a(t) {
        return "[object Symbol]" === h(t);
      }
      function s(t) {
        return "[object String]" === h(t);
      }
      function c(t) {
        return "[object Number]" === h(t);
      }
      function f(t) {
        return "[object Boolean]" === h(t);
      }
      function l(t, e) {
        return B.call(t, e);
      }
      ...
      function p(t) {
        ...
        var e = t.toString().match(/^function\s*([\w$]+)/);
        return e ? e[1] : void 0;
      }
      function y(t, e) {
      ...
      function v(t) {
        function e(t) {
          ...
          return r ? "\\" + r : "\\x" + (16 > e ? "0" : "") + e.toString(16);
        }
        var r = t.replace(/(['\\])/g, "\\$1").replace(/[\x00-\x1f]/g, e);
        return "'" + r + "'";
      }
      var m = "function" == typeof Map && Map.prototype,
        w =
          Object.getOwnPropertyDescriptor && m
            ...
            : null,
        E = m && w && "function" == typeof w.get ? w.get : null,
        A = m && Map.prototype.forEach,
        T = "function" == typeof Set && Set.prototype,
        S =
          Object.getOwnPropertyDescriptor && T
            ? Object.getOwnPropertyDescriptor(Set.prototype, "size")
            : null,
        x = T && S && "function" == typeof S.get ? S.get : null,
        j = T && Set.prototype.forEach,
        O = Boolean.prototype.valueOf;
      t.exports = function I(t, e, h, m) {
        function w(t, r) {
          return r && ((m = m.slice()), m.push(r)), I(t, e, h + 1, m);
        }
        e || (e = {});
        var T = void 0 === e.depth ? 5 : e.depth;
        if (
          (void 0 === h && (h = 0),
          h >= T && T > 0 && t && "object" == typeof t)
        )
          return "[Object]";
        if (void 0 === m) m = [];
        else if (y(m, t) >= 0) return "[Circular]";
        ...
        if (a(t)) {
          var B = Symbol.prototype.toString.call(t);
          return "object" == typeof t ? "Object(" + B + ")" : B;
        }
        if (b(t)) {
          for (
            var _ = "<" + String(t.nodeName).toLowerCase(),
              P = t.attributes || [],
              R = 0;
            R < P.length;
            R++
          )
            _ += " " + P[R].name + '="' + r(P[R].value) + '"';
          return (
            (_ += ">"),
        ...
        if (n(t)) {
          ...
          for (var C = Array(t.length), R = 0; R < t.length; R++)
            C[R] = l(t, R) ? w(t[R], t) : "";
          return "[ " + C.join(", ") + " ]";
        }
        if (u(t)) {
        ...
        if ("object" == typeof t && "function" == typeof t.inspect)
          return t.inspect();
        if (g(t)) {
          var M = [];
          return (
        ...
        if (c(t)) return "Object(" + Number(t) + ")";
        if (f(t)) return "Object(" + O.call(t) + ")";
        if (s(t)) return "Object(" + w(String(t)) + ")";
        if (o(t) || i(t)) return String(t);
        var C = [],
          L = [];
        for (var U in t) l(t, U) && L.push(U);
        L.sort();
    ...
    function (t, e) {
      function r() {
        c &&
          u &&
          ((c = !1), u.length ? (s = u.concat(s)) : (f = -1), s.length && n());
      }
      function n() {
        if (!c) {
          var t = setTimeout(r);
      ...
      (a.nextTick = function (t) {
        ...
        s.push(new o(t, e)), 1 !== s.length || c || setTimeout(n, 0);
      }),
    ...
    function (t, e, r) {
      (function (e, r) {
        ...
        function i(t, e, o, a) {
          if ((u("TMATCH", typeof t, e), t == e))
            return (
              u("TMATCH same object or simple value, or problem"),
              null === t || null === e
                ? !0
          ...
          if (null === t || null === e)
            return u("TMATCH null test, already failed =="), !1;
          if ("string" == typeof t && e instanceof RegExp)
            return u("TMATCH string~=regexp test"), e.test(t);
          if ("string" == typeof t && "string" == typeof e && e)
            return u("TMATCH string~=string test"), -1 !== t.indexOf(e);
          if (t instanceof Date && e instanceof Date)
            return u("TMATCH date test"), t.getTime() === e.getTime();
          if (t instanceof Date && "string" == typeof e)
            return (
              u("TMATCH date~=string test"),
              t.getTime() === new Date(e).getTime()
            );
          if (n(t) || n(e)) {
            u("TMATCH arguments test");
            var s = Array.prototype.slice;
            return i(s.call(t), s.call(e), o, a);
          }
          if (e === r) return u("TMATCH Buffer ctor"), r.isBuffer(t);
          if (e === Function)
            return u("TMATCH Function ctor"), "function" == typeof t;
          if (e === Number)
            return (
              u("TMATCH Number ctor (finite, not NaN)"),
              "number" == typeof t && t === t && isFinite(t)
            );
          if (e !== e) return u("TMATCH NaN"), t !== t;
          if (e === String)
            return u("TMATCH String ctor"), "string" == typeof t;
          if (e === Boolean)
            return u("TMATCH Boolean ctor"), "boolean" == typeof t;
          if (e === Array)
            return (
              u("TMATCH Array ctor", e, Array.isArray(t)), Array.isArray(t)
            );
          if ("function" == typeof e && "object" == typeof t)
            return u("TMATCH object~=function"), t instanceof e;
          if ("object" != typeof t || "object" != typeof e)
            return (
              u("TMATCH obj is not object, pattern is not object, false"), !1
            );
          if (t instanceof RegExp && e instanceof RegExp)
            return (
              u("TMATCH regexp~=regexp test"),
              t.source === e.source &&
                t.global === e.global &&
          ...
          if (r.isBuffer(t) && r.isBuffer(e)) {
            if ((u("TMATCH buffer test"), t.equals)) return t.equals(e);
            if (t.length !== e.length) return !1;
            for (var c = 0; c < t.length; c++) if (t[c] != e[c]) return !1;
            return !0;
          }
          u("TMATCH object~=object test");
          var f = Object.keys(t),
            l = Object.keys(e);
          if (
            (u("  TMATCH patternkeys=%j objkeys=%j", l, f),
            0 === f.length && 0 === l.length)
          )
            return !0;
          u("  TMATCH check seen objects...");
          for (var h = o.length; h--; ) if (o[h] === t && a[h] === e) return !0;
          o.push(t), a.push(e), u("  TMATCH not seen previously");
          for (var p, y = l.length - 1; y >= 0; y--)
            if (
              ((p = l[y]),
              u("  TMATCH test obj[%j]", p, t[p], e[p]),
              !i(t[p], e[p], o, a))
            )
              return !1;
          return o.pop(), a.pop(), u("  TMATCH object pass"), !0;
        }
        t.exports = o;
        var u = /\btmatch\b/.test(e.env.NODE_DEBUG || "")
          ? console.error
          : function () {};
      }.call(e, r(30), r(6).Buffer));
    },
  ]);
});
