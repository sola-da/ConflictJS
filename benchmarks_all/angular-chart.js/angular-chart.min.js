    ...
    return function (e) {
      return {
        ...
        link: function (i, u) {
          ...
          function d(e) {
            if (m(e, i) && 0 === u[0].clientHeight && 0 === k.clientHeight)
              return r(
                function () {
                  d(e);
                },
            ...
            if (i.data && i.data.length) {
              ...
              w(A, i),
                (A = new n.Chart(f)[e](h, g)),
                i.$emit("create", A),
                (o.onclick = i.click ? c(i, A, "click", !1) : t.noop),
                (o.onmousemove = i.hover ? c(i, A, "hover", !0) : t.noop),
                i.legend && "false" !== i.legend && y(u, A);
            }
          }
          function g(t) {
            if (
