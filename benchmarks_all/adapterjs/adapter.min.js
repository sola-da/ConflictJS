    ...
    if ("function" == typeof callback) {
      var beOfferer = !0,
        ...
        isLocalFirefoxInterop =
          "moz" === webrtcDetectedType && webrtcDetectedVersion > 30,
              ...
              "generateCertificate",
              {
                get: function () {
                  return arguments.length
                    ? mozRTCPeerConnection.generateCertificate.apply(
                        null,
                        arguments
                      )
                    : mozRTCPeerConnection.generateCertificate;
        ...
        webkitRTCPeerConnection.generateCertificate &&
          Object.defineProperty(
            ...
            "generateCertificate",
            {
              get: function () {
                return arguments.length
                  ? webkitRTCPeerConnection.generateCertificate.apply(
                      null,
                      arguments
                    )
                  : webkitRTCPeerConnection.generateCertificate;
          ...
          webkitRTCPeerConnection.prototype[method] = function () {
            ...
            return new Promise(function (resolve, reject) {
              nativeMethod.apply(self, [
                args[0],
                function () {
                  resolve(), args.length >= 2 && args[1].apply(null, []);
                },
                function (err) {
                  reject(err), args.length >= 3 && args[2].apply(null, [err]);
                },
              ]);
            });
          };
        ...
        (SDPUtils.splitLines = function (blob) {
          ...
          (SDPUtils.writeFtmp = function (codec) {
            ...
            if (
              (void 0 !== codec.preferredPayloadType &&
                (pt = codec.preferredPayloadType),
              codec.parameters && codec.parameters.length)
            ) {
              var params = [];
          ...
          (window.RTCPeerConnection = function (config) {
            ...
            if (
              ...
              config && config.iceTransportPolicy)
            )
          ...
          (window.RTCPeerConnection.prototype._createIceAndDtlsTransports =
            function (mid, sdpMLineIndex) {
              ...
              (iceGatherer.onlocalcandidate = function (evt) {
                ...
                cand && 0 !== Object.keys(cand).length
                  ? ((cand.component =
                      "RTCP" === iceTransport.component ? 2 : 1),
                    (event.candidate.candidate = SDPUtils.writeCandidate(cand)))
                  : (void 0 === iceGatherer.state &&
                ...
                null !== self.onicecandidate &&
                  (self.localDescription && "" === self.localDescription.type
                    ? (self._localIceCandidatesBuffer.push(event),
                      complete && self._localIceCandidatesBuffer.push({}))
                    : (self.onicecandidate(event),
                      complete && self.onicecandidate({})));
              }),
          ...
          (window.RTCPeerConnection.prototype.setLocalDescription = function (
            ...
            switch (((this.localDescription = description), description.type)) {
              case "offer":
            ...
            if (hasCallback) {
              ...
              window.setTimeout(function () {
                cb(), self._emitBufferedCandidates();
              }, 0);
            }
          ...
          (window.RTCPeerConnection.prototype.setRemoteDescription = function (
            ...
            switch (
              (sections.forEach(function (mediaSection, sdpMLineIndex) {
                ...
                var cname,
                  mid = SDPUtils.matchPrefix(mediaSection, "a=mid:")[0].substr(
                    6
                  ),
                ...
                if (
                  ...
                  if (
                    ...
                    (sendSsrc = 1001 * (2 * sdpMLineIndex + 2)),
          ...
          (window.RTCPeerConnection.prototype.close = function () {
            this.transceivers.forEach(function (transceiver) {
              transceiver.iceTransport && transceiver.iceTransport.stop(),
                transceiver.dtlsTransport && transceiver.dtlsTransport.stop(),
                transceiver.rtpSender && transceiver.rtpSender.stop(),
                transceiver.rtpReceiver && transceiver.rtpReceiver.stop();
            }),
            ...
            function () {
              ...
              this.transceivers.forEach(function (transceiver) {
                ...
                states.failed > 0
                  ...
                  : states["new"] > 0
                  ? (newState = "new")
                  : (states.connecting > 0 || states.completed > 0) &&
                    (newState = "connected"),
          ...
          (window.RTCPeerConnection.prototype.createOffer = function () {
            ...
            1 === arguments.length && "function" != typeof arguments[0]
              ...
              : 3 === arguments.length && (offerOptions = arguments[2]);
            var tracks = [],
              numAudioTracks = 0,
              numVideoTracks = 0;
            if (
              (this.localStreams.length &&
                ((numAudioTracks =
                  this.localStreams[0].getAudioTracks().length),
                (numVideoTracks =
                  this.localStreams[0].getVideoTracks().length)),
              offerOptions)
            ) {
            ...
            for (
              ...
              this.localStreams[0].getTracks().forEach(function (track) {
                tracks.push({
                  ...
                  "audio" === track.kind
                    ? numAudioTracks--
                    : "video" === track.kind && numVideoTracks--;
              });
              numAudioTracks > 0 || numVideoTracks > 0;

            )
              numAudioTracks > 0 &&
                (tracks.push({ kind: "audio", wantReceive: !0 }),
                numAudioTracks--),
                numVideoTracks > 0 &&
                  (tracks.push({ kind: "video", wantReceive: !0 }),
                  numVideoTracks--);
          ...
          (window.RTCPeerConnection.prototype.createAnswer = function () {
            ...
            1 === arguments.length && "function" != typeof arguments[0]
              ...
              : 3 === arguments.length && (answerOptions = arguments[2]);
            var sdp = SDPUtils.writeSessionBoilerplate();
            this.transceivers.forEach(function (transceiver) {
          ...
          (window.RTCPeerConnection.prototype.addIceCandidate = function (
            ...
            if (transceiver) {
              ...
              "endOfCandidates" === cand.type && (cand = {}),
            ...
            return new Promise(function (resolve) {
              ...
              Promise.all(promises).then(function (res) {
                res.forEach(function (result) {
                  ...
                  cb && window.setTimeout(cb, 0, results),
                  resolve(results);
              });
            });
          });
  ...
  ("object" == typeof console && "function" == typeof console.log) ||
    ...
    (AdapterJS.WebRTCPlugin.injectPlugin = function () {
      if (
        ...
        if (
          ...
          "IE" === webrtcDetectedBrowser && 10 >= webrtcDetectedVersion)
        ) {
    ...
    (AdapterJS.WebRTCPlugin.isPluginInstalled = function (
      ...
      if (isIE) {
        ...
        for (
          var pluginArray = navigator.plugins, i = 0;
    ...
    (AdapterJS.WebRTCPlugin.defineWebRTCInterface = function () {
      AdapterJS.WebRTCPlugin.pluginState !==
        ...
        (RTCPeerConnection = function (servers, constraints) {
          ...
          var mandatory =
              constraints && constraints.mandatory
                ...
                : null,
            optional =
              constraints && constraints.optional ? constraints.optional : null;
        ...
        (getUserMedia = function (
          ...
          (constraints.audio = constraints.audio || !1),
            (constraints.video = constraints.video || !1),
            AdapterJS.WebRTCPlugin.callWhenPluginReady(function () {
        ...
        (attachMediaStream = function (element, stream) {
          if (element && element.parentNode) {
            ...
            null === stream
              ? (streamId = "")
              : ("undefined" != typeof stream.enableSoundTracks &&
