!(function (a, b) {
  function c(b) {
    ...
    if (b.imageUrl) {
      ...
      k.setAttribute(
        "style",
        k.getAttribute("style") + "width:" + l + "px; height:" + m + "px"
      );
    }
      ...
      function () {
        function h(a) {
          ...
          if (-1 !== [9, 13, 32, 27].indexOf(b)) {
            ...
            9 === b
              ? ((c = -1 === d ? u : d === w.length - 1 ? w[0] : w[d + 1]),
                E(a),
                c.focus())
              : ((c =
                  13 === b || 32 === b
        ...
        if (void 0 === arguments[0])
          return (
            a.console.error("sweetAlert expects at least 1 attribute!"), !1
          );
        var m = d({}, o);
        switch (typeof arguments[0]) {
          ...
          case "object":
            ...
            (m.title = arguments[0].title),
              ...
              (m.allowOutsideClick =
                arguments[0].allowOutsideClick || o.allowOutsideClick),
              (m.showCancelButton =
              ...
              (m.confirmButtonText = o.showCancelButton
                ...
                : o.confirmButtonText),
              (m.confirmButtonText =
                arguments[0].confirmButtonText || o.confirmButtonText),
              (m.confirmButtonClass =
                arguments[0].confirmButtonClass ||
                (arguments[0].type ? "btn-" + arguments[0].type : null) ||
                o.confirmButtonClass),
              (m.cancelButtonText =
                arguments[0].cancelButtonText || o.cancelButtonText),
              (m.cancelButtonClass =
                arguments[0].cancelButtonClass || o.cancelButtonClass),
              (m.containerClass =
