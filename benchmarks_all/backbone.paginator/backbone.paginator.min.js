...
Backbone.Paginator = (function (a, b, c) {
    ...
    (e.clientPager = a.Collection.extend({
        ...
        if (!b.isEmpty(a)) {
          ...
          return (
            ...
            "" !== this.filterExpression &&
              (c = this._filter(c, this.filterFields, this.filterExpression)),
            c.length
          );
        }
      },
      ...
      pager: function (a) {
        ...
        void 0 === c.origModels && (c.origModels = c.models),
          ...
          "" !== this.sortColumn &&
            (c.models = c._sort(c.models, this.sortColumn, this.sortDirection)),
          b.isEmpty(this.fieldFilterRules) ||
            (c.models = c._fieldFilter(c.models, this.fieldFilterRules)),
          "" !== this.filterExpression &&
            (c.models = c._filter(
              c.models,
              this.filterFields,
          ...
          (this.lastSortColumn === this.sortColumn &&
            this.lastFilterExpression === this.filterExpression &&
            b.isEqual(this.fieldFilterRules, this.lastFieldFilterRules)) ||
            ((e = 0),
            (f = e + d),
            (c.currentPage = 1),
            (this.lastSortColumn = this.sortColumn),
              ...
              if (k) {
                ...
                if (
                  ((k =
                    b.has(a.Paginator, "removeDiacritics") &&
                    f.useDiacriticsPlugin
                      ? a.Paginator.removeDiacritics(k.toString())
                      : k.toString()),
  ...
  return (
    (e.requestPager = a.Collection.extend({
      sync: function (e, f, g) {
        var h = this;
        h.setDefaults();
        var i = {};
        ...
        b.each(j, function (a, c) {
          ...
          (g.data = g.data
            ? decodeURIComponent(c.param(b.extend(i, g.data)))
            : decodeURIComponent(c.param(i))),
          (j = b.extend(
            j,
            {
              data: decodeURIComponent(c.param(i)),
      ...
      requestNextPage: function (a) {
        return void 0 !== this.currentPage
          ? ((this.currentPage += 1), this.pager(a))
          : f();
      },
    ...
    (e.requestPager.prototype.nextPage =
      e.requestPager.prototype.requestNextPage),
    (e.requestPager.prototype.prevPage =
