              ...
              (a = function () {
                r = angular.extend(
                  angular.copy(n),
                  {
                    ...
                    appendArrows: angular.element(
                      t.appendArrows ? t.appendArrows : o
                    ),
                    prevArrow: t.prevArrow
                      ? angular.element(t.prevArrow)
                      : void 0,
                    nextArrow: t.nextArrow
                      ? angular.element(t.nextArrow)
                      : void 0,
                    centerMode: "true" === t.centerMode,
                    centerPadding: t.centerPadding || "50px",
                    cssEase: t.cssEase || "ease",
                    customPaging: s.customPaging
                      ? function (e, n) {
                    ...
                    slide: t.slide || "",
                    slidesPerRow:
                      null != t.slidesPerRow ? parseInt(t.slidesPerRow, 10) : 1,
                    slidesToShow:
              ...
              (l = function () {
                ...
                return (
                  e.hasClass("slick-initialized") &&
                    (e.remove("slick-list"), e.slick("unslick")),
                  e
                );
              }),
              (d = function () {
                ...
                if (angular.element(o).hasClass("slick-initialized")) {
                  ...
                  n.on("init", function (e, n) {
                    return (
                      "undefined" != typeof r.event.init && r.event.init(e, n),
                      "undefined" != typeof c ? n.slideHandler(c) : void 0
                    );
                  }),
                    e(function () {
                      angular.element(o).css("display", "block"), n.slick(r);
                    });
                }
                (t.internalControl = r.method || {}),
                  ...
                  n.on("afterChange", function (n, i, o, s) {
                    (c = o),
                      "undefined" != typeof r.event.afterChange &&
                        e(function () {
                          t.$apply(function () {
                            r.event.afterChange(n, i, o, s);
                          });
                        });
                  }),
                  n.on("beforeChange", function (n, i, o, s) {
                    "undefined" != typeof r.event.beforeChange &&
                      e(function () {
                        e(function () {
                          t.$apply(function () {
                            r.event.beforeChange(n, i, o, s);
                          });
                        });
                      });
                  }),
