      ...
      for (var b, c = 0; c < a.length; c++) {
        ...
        for (var d = 0, e = g.length; e > d; d++) {
          ...
          if (i) {
            ...
            return (
              j &&
                (console.log("command matched: %c" + f.originalPhrase, k),
                l.length && console.log("with parameters", l)),
              f.callback.apply(this, l),
              void t(h.resultMatch, b, f.originalPhrase, a)
            );
          }
        }
      }
  ...
  return (c = {
    init: function (k, n) {
      (n = n === b ? !0 : !!n),
              ...
              (f = !1),
                t(
                  new Date().getTime() - i < 200
                    ? h.errorPermissionBlocked
                    : h.errorPermissionDenied
                );
          }
        }),
        (e.onend = function () {
        ...
        n && (g = []),
        k.length && this.addCommands(k);
    },
    start: function (a) {
      (l = !1),
        v(),
        (a = a || {}),
        (f = a.autoRestart !== b ? !!a.autoRestart : !0),
