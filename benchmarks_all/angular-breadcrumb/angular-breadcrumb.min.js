...
!(function (a, b, c) {
      ...
      (this.$get = [
        ...
        function (b, f, g) {
          ...
          var i = function (a) {
            ...
            j = function (c, d) {
              for (
                var g, i, j = e(d), k = !1, l = !1, m = 0, n = c.length;
                n > m;
                m += 1
              )
              ...
              (g = b.get(j.state)),
                g.ncyBreadcrumb &&
                  (g.ncyBreadcrumb.force && (k = !0),
                  g.ncyBreadcrumb.skip && (l = !0)),
                (g["abstract"] && !a.includeAbstract && !k) ||
                  l ||
                  (j.paramExpr && (i = h.$eval(j.paramExpr)),
                  (g.ncyBreadcrumbLink = b.href(j.state, i || f || {})),
                  c.unshift(g));
            },
            k = function (a) {
              var c = e(a),
              ...
              (e.steps = c.getStatesChain()),
                b.forEach(e.steps, function (b) {
                  if (b.ncyBreadcrumb && b.ncyBreadcrumb.label) {
                    ...
                    (b.ncyBreadcrumbLabel = c(d)), k(f, c, d, b);
                  } else b.ncyBreadcrumbLabel = b.name;
                });
            };
          d.$on("$viewContentLoaded", function (a) {
                ...
                f = function () {
                  ...
                  if (f)
                    if (
                      ...
                      (d.ncyBreadcrumbLabel = g(c)), k(e, g, c, d);
                    } else d.ncyBreadcrumbLabel = f.name;
                };
              c.$on("$viewContentLoaded", function (a) {
                a.targetScope.ncyBreadcrumbIgnore || f();
              }),
                f();
            },
          }
  ...
  function i(a, c, d) {
    return {
      ...
      compile: function (e, f) {
        var g = e.attr(f.$attr.ncyBreadcrumbText);
        g && e.html(g);
        var h = e.attr(f.$attr.ncyBreadcrumbTextSeparator) || " / ";
        return {
          post: function (e) {
            var f = [],
              g = function (a, c, d) {
                b.forEach(j(c), function (b) {
              ...
              i = function () {
                ...
                b.forEach(i, function (b) {
                  ...
                  (e.ncyBreadcrumbChain = j.join(h));
              };
            d.$on("$viewContentLoaded", function (a) {
              a.targetScope.ncyBreadcrumbIgnore || i();
            }),
              i();
          },
        };
  ...
  (g.$inject = ["$interpolate", "$breadcrumb", "$rootScope"]),
    ...
    b
      ...
      .provider("$breadcrumb", f)
      .directive("ncyBreadcrumb", g)
      .directive("ncyBreadcrumbLast", h)
      .directive("ncyBreadcrumbText", i);
