...
(function (p, m) {
  ...
  function p(b) {
    ...
    c.destroyed &&
      ((c.destroyed = !1),
      b.options.container &&
        k(b.options.container, function (a) {
          n(a, "scroll", c.validateT);
        }),
      n(window, "resize", c.save_viewportOffsetT),
    ...
    if (
      ...
      if ((c = b.getAttribute(r) || b.getAttribute(a.src))) {
            ...
            h = function () {
              if (f) {
                ...
                c &&
                  ...
                  k(c.getElementsByTagName("source"), function (b) {
                    v(b, "srcset", a.srcset);
                  });
        ...
        "video" === b.nodeName.toLowerCase()
          ? (k(b.getElementsByTagName("source"), function (b) {
              v(b, "src", a.src);
            }),
            b.load(),
            w(b, a))
          : (a.error && a.error(b, "missing"), t(b, a.errorClass));
  }
  function w(b, c) {
    t(b, c.successClass);
  ...
  return function (b) {
    ...
    a.options.container = a.options.container
      ? document.querySelectorAll(a.options.container)
      : !1;
    ...
    a.options.save_viewportOffsetDelay =
      a.options.save_viewportOffsetDelay || 50;
    ...
    a.destroy = function () {
      ...
      this.options.container &&
        k(this.options.container, function (b) {
