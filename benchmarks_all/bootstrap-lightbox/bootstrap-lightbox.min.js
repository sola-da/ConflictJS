...
+(function (e) {
  ...
  (t.prototype = e.extend({}, e.fn.modal.Constructor.prototype)),
    ...
    (t.prototype.show = function (t) {
      var n = this,
        r = e.Event("show.bs.lightbox", { relatedTarget: t });
    ...
    (t.prototype.hide = function (t, n) {
      t && t.preventDefault(),
        (t = e.Event("hide.bs.lightbox")),
        this.$element.trigger(t);
      if (!this.isShown || t.isDefaultPrevented()) return;
      (this.isShown = !1),
        this.escape(),
        e(document).off("focusin.bs.lightbox"),
        this.$element
          .removeClass("in")
          .attr("aria-hidden", !0)
        ...
        e.support.transition && this.$element.hasClass("fade")
          ? this.$element
              .one(e.support.transition.end, e.proxy(this.hideModal(n), this))
              .emulateTransitionEnd(300)
          : this.hideModal(n);
    }),
    (t.prototype.enforceFocus = function () {
      e(document)
        .off("focusin.bs.lightbox")
        .on(
          "focusin.bs.lightbox",
          e.proxy(function (e) {
    ...
    (t.prototype.escape = function () {
      this.isShown && this.options.keyboard
        ...
        : this.isShown || this.$element.off("keyup.dismiss.bs.lightbox");
    }),
      ...
      (c = new Image()),
        (c.onload = function () {
          c.width + a + f >= s &&
            ...
            r.$element.find(".lightbox-dialog").css({
              position: "fixed",
              width: c.width + a + f,
              height: c.height + o + u,
            ...
            r.$element
              ...
              .css({ width: c.width + a + f, height: c.height + o + u }),
            l.css({ width: c.width, height: c.height }),
            n.fire();
        }),
        (c.src = l.attr("src"));
    }),
    (t.prototype.slide = function (e) {
      var t = this;
      t.hide(t.event, !0),
        e == "next" && t.$element.next(".lightbox").length
          ? t.$element.next(".lightbox").lightbox("show")
          : e == "prev" && t.$element.prev(".lightbox").length
          ? t.$element.prev(".lightbox").lightbox("show")
          : t.$element.trigger("hidden.bs.lightbox");
    });
  var n = e.fn.lightbox;
  (e.fn.lightbox = function (n, r) {
    return this.each(function () {
      var i = e(this),
        s = i.data("bs.lightbox"),
        o = e.extend({}, t.DEFAULTS, i.data(), typeof n == "object" && n);
      s || i.data("bs.lightbox", (s = new t(this, o))),
    ...
    e(document).on(
      ...
      function (t) {
        ...
        t.preventDefault(),
          i.lightbox(s, this).one("hide", function () {
