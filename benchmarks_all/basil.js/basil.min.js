!(function () {
  ...
  (e.version = "0.4.4"),
    (e.utils = {
      extend: function () {
        for (
          var e = "object" == typeof arguments[0] ? arguments[0] : {}, n = 1;
          n < arguments.length;
          n++
        )
    ...
    (e.Storage = function () {
      var n = "b45i1" + (Math.random() + 1).toString(36).substring(7),
        ...
        r = function (n, t) {
          ...
          return (
            i(t)
              ? (o += t)
              : e.utils.isArray(t) &&
                ((t = e.utils.isFunction(t.filter) ? t.filter(i) : t),
                (o = t.join("."))),
            o && i(n) ? n + "." + o : o
          );
        },
        ...
        c = {
          ...
          check: function () {
            try {
              window[this.engine].setItem(n, !0),
                window[this.engine].removeItem(n);
            } catch (e) {
              return !1;
            }
            return !0;
          ...
          reset: function (e) {
            for (var n, t = 0; t < window[this.engine].length; t++)
              (n = window[this.engine].key(t)),
                (e && 0 !== n.indexOf(e)) || (this.remove(n), t--);
          },
          keys: function (e) {
            for (var n, t = [], i = 0; i < window[this.engine].length; i++)
              (n = window[this.engine].key(i)),
                (e && 0 !== n.indexOf(e)) || t.push(s(e, n));
            return t;
          },
        };
      return (
        (t.local = e.utils.extend({}, c, { engine: "localStorage" })),
        (t.session = e.utils.extend({}, c, { engine: "sessionStorage" })),
        (t.memory = {
          _hash: {},
          check: function () {
            return !0;
        ...
        (t.cookie = {
          ...
          set: function (e, n, t) {
            ...
            if (t.expireDays) {
              var o = new Date();
              o.setTime(o.getTime() + 24 * t.expireDays * 60 * 60 * 1e3),
                (i += "; expires=" + o.toGMTString());
            }
            if (t.domain && t.domain !== document.domain) {
              var r = t.domain.replace(/^\./, "");
              if (-1 === document.domain.indexOf(r) || r.split(".").length <= 1)
          ...
          get: function (e) {
            ...
            for (
              ...
              if (((n = i[o].replace(/^\s*/, "")), 0 === n.indexOf(t + "=")))
                return decodeURIComponent(n.substring(t.length + 1, n.length));
            return null;
          },
          remove: function (e) {
            this.set(e, "", { expireDays: -1 });
            for (var n = document.domain.split("."), t = n.length; t >= 0; t--)
              this.set(e, "", {
                expireDays: -1,
          ...
          keys: function (e) {
            ...
            for (
              ...
              (n = o[r].replace(/^\s*/, "")),
                (t = decodeURIComponent(n.substr(0, n.indexOf("=")))),
                (e && 0 !== t.indexOf(e)) || i.push(s(e, t));
            return i;
          },
        }),
        {
