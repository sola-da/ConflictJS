(function (a, b) {
  ...
  var a = {
    on: function (j, m, l) {
      if (!f(this, "on", j, [m, l]) || !m) {
        return this;
      }
      this._events || (this._events = {});
      var k = this._events[j] || (this._events[j] = []);
      k.push({ callback: m, context: l, ctx: l || this });
      return this;
    },
    once: function (k, n, l) {
      if (!f(this, "once", k, [n, l]) || !n) {
        return this;
      }
      var j = this;
      var m = b(function () {
    ...
    off: function (m, v, n) {
      var t, u, w, s, r, o, q, p;
      if (!this._events || !f(this, "off", m, [v, n])) {
        return this;
      }
      if (!m && !v && !n) {
        this._events = {};
      ...
      s = m ? [m] : Object.keys(this._events);
      for (r = 0, o = s.length; r < o; r++) {
        m = s[r];
        if ((w = this._events[m])) {
          this._events[m] = t = [];
          if (v || n) {
            for (q = 0, p = w.length; q < p; q++) {
              u = w[q];
              if (
                (v && v !== u.callback && v !== u.callback._callback) ||
                (n && n !== u.context)
              ) {
                t.push(u);
              }
  ...
  function h(k, j) {
    a[k] = function (n, l, p) {
      ...
      var o = n._listenerId || (n._listenerId = new Date().getTime());
      m[o] = n;
      if (typeof l === "object") {
        p = this;
      }
