(function () {
  ...
  if (document.getElementsByClassName == null) {
    document.getElementsByClassName = function (className, parentElement) {
      ...
      while (i < length) {
        child = children[i];
        if (
          (" " + child.className + " ").indexOf(" " + className + " ") !== -1
        ) {
          elements.push(child);
        }
        i++;
  ...
  window.Authy.UI = function () {
    ...
    tooltipMessage =
      'This is a help tooltip for your users. You can set the message by doing: authyUI.setTooltip("title", "message");';
    countriesList = [
    ...
    setupCellphoneValidation = function () {
      ...
      cellPhone.onblur = function () {
        if (
          cellPhone.value !== "" &&
          cellPhone.value.match(
            /^([0-9][0-9][0-9])\W*([0-9][0-9]{2})\W*([0-9]{0,5})$/
          )
        ) {
    ...
    setupTooltip = function () {
      ...
      tooltip.innerHTML =
        '<a id="authy-tooltip-close"></a><h3 class="tooltip-title">' +
        tooltipTitle +
        '</h3><p class="tooltip-content">' +
        tooltipMessage +
        "</p>";
      ...
      document.getElementById("authy-tooltip-close").onclick = function () {
        return (document.getElementById("authy-tooltip").style.display =
          "none");
      };
    ...
    processKey38 = function (listId) {
      ...
      while (i >= 0) {
        if (
          document.getElementById(caId).getElementsByTagName("li")[i]
            .className === "active"
        ) {
          document.getElementById(caId).getElementsByTagName("li")[
            i
          ].className = "";
          activeElement = null;
          if (i === 0) {
            activeElement = document
              .getElementById(caId)
              .getElementsByTagName("li")[countriesArr.length - 1];
          } else {
            activeElement = document
              .getElementById(caId)
    ...
    processKey13 = function (listId) {
      var obj;
      obj = document
        .getElementById("countries-autocomplete-" + listId)
    ...
    setupEvents = function (countriesInput, listId) {
      ...
      countriesInput.onfocus = function () {
        ...
        countriesDropdown = document.getElementById(
          "countries-autocomplete-" + listId
        );
      ...
      document.getElementById("countries-autocomplete-" + listId).onclick =
        function (e) {
      ...
      document.getElementById("countries-input-" + listId).onclick = function (
        e
      ) {
        if (e && e.stopPropagation) {
          e.stopPropagation();
    ...
    hideAutocompleteList = function (listId) {
      ...
      autocompleteList = document.getElementById(
        "countries-autocomplete-" + listId
      );
      if (autocompleteList) {
    ...
    setupCountriesDropdown = function (countriesSelect, listId) {
      ...
      while (i < countriesList.length) {
        ...
        countriesAutocompleteList.appendChild(
          buildItem(classActive, countriesList[i], listId)
        );
        i++;
      }
    ...
    setupCountriesDropdownPosition = function (
      ...
      return countriesDropdown.setAttribute(
        "style",
        "width: " +
          (width - 5) +
          "px; top: " +
          (pos[0] + 2 + countriesInput.offsetHeight) +
          "px; left: " +
          (pos[1] - 2) +
          "px;"
      );
    ...
    this.searchItem = function (listId) {
      ...
      while (i < countriesList.length) {
        ...
        while (cw < countryWords.length) {
          if (
            (countryWords[cw].length > 2 && countryWords[cw].match(reg)) ||
            ("" + countryItem.code).match(reg)
          ) {
            countriesAutocompleteList.appendChild(
              buildItem(classActive, countryItem, listId)
            );
            classActive = "";
            matches = true;
      ...
      if (matches) {
        dropdownMenu = document.getElementById(
          "countries-autocomplete-" + listId
        );
    ...
    this.setCountryCode = function (listId, countryCode) {
      return (document.getElementById("country-code-" + listId).value =
        countryCode);
    };
