    ...
    function CSSStyleDeclaration(element) {
      ...
      for (property in currentStyle) {
        ...
        if (property == "width") style[property] = element.offsetWidth + "px";
          ...
          style[property] =
            Math.round(getComputedStylePixel(element, property, fontSize)) +
            "px";
    ...
    CSSStyleDeclaration.prototype = {
      ...
      getPropertyValue: function (property) {
        if (property === undefined) {
          throw Error(
            "TypeError: Not enough arguments to CSSStyleDeclaration.getPropertyValue"
          );
        }
        ...
        return typeof this[property] === "function" ||
          property.match(/^(?:cssText|length|\d+)$/)
          ? ""
          : this[property];
      },
      item: function (index) {
        if (property === undefined) {
          throw Error(
            "TypeError: Not enough arguments to CSSStyleDeclaration.item"
          );
        }
