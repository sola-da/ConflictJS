    ...
    return (
      ...
      (n.prototype.insert = function (t, e) {
        ...
        return (
          ...
          (n = this._getRange()) &&
            (n.setEndAfter(this.query.el[0]),
            n.collapse(!1),
            n.insertNode((o = this.app.document.createTextNode("‍" + r))),
            this._setRange("after", o, n)),
          this.$inputor.is(":focus") || this.$inputor.focus(),
          this.$inputor.change()
        );
      }),
      ...
      (e.prototype.choose = function (t) {
        ...
        return (
          (e = this.$el.find(".cur")).length &&
            ...
            this.context.insert(
              this.context.callbacks("beforeInsert").call(this.context, i, e),
              e
            ),
