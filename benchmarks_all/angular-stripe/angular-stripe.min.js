  ...
  return (function e(t, n, r) {
  ...
  })(
    {
        ...
        function (_dereq_, module, exports) {
          ...
          module.exports = function promisifyStripe(Stripe, Promise) {
            if (typeof Stripe !== "function")
              throw new Error("Stripe.js must be provided");
            if (typeof Promise !== "function")
              throw new Error("Promise constructor must be provided");
            var stripe = {};
            ...
            return function promisified() {
              ...
              return new Promise(function (resolve, reject) {
                receiver[method].apply(
                  receiver,
                  args.concat(function promisifiedResolve() {
                    resolver.apply(
      ...
      5: [
        function (_dereq_, module, exports) {
          ...
          function stripeProvider(Stripe) {
            if (!Stripe)
              throw new Error("Stripe must be available as window.Stripe");
      ...
      7: [
        ...
        { "./provider": 5, "angular-assert-q-constructor": 1 },
      ],
    },
    {},
    [7]
