...
!(function (t, i) {
    ...
    function d(t, i, n) {
      ...
      return (
        t.each(function (t, d) {
          ...
          if (!h)
            return void s(
              e + " not initialized. Cannot call methods, i.e. " + r
            );
          var u = h[i];
          if (!u || "_" == i.charAt(0))
  ...
  (function (t, i) {
    ...
    function r(i) {
      if (
        ...
        for (
          var u = (a.isBorderBox = "border-box" == r.boxSizing), c = 0;
          h > c;
          c++
        ) {
          var p = d[c],
        ...
        var x = t(r.height);
        return (
          x !== !1 && (a.height = x + (E ? 0 : v + P)),
          (a.innerWidth = a.width - (l + b)),
          (a.innerHeight = a.height - (v + P)),
  ...
  (function (t, i) {
    ...
    (o.bindStartEvent = function (t) {
      ...
      (o._bindStartEvent = function (i, e) {
        ...
        t.navigator.pointerEnabled
          ? i[n]("pointerdown", this)
          : t.navigator.msPointerEnabled
          ? i[n]("MSPointerDown", this)
          : (i[n]("mousedown", this), i[n]("touchstart", this));
      }),
    ...
    return (
      (o._bindPostStartEvents = function (i) {
        if (i) {
          var e = r[i.type];
      ...
      (o._unbindPostStartEvents = function () {
        this._boundPointerEvents &&
          (this._boundPointerEvents.forEach(function (i) {
    ...
    return (
      (o._bindHandles = function (t) {
        ...
        i = r.pointerEnabled
          ...
          : e;
        for (
          var n = t ? "addEventListener" : "removeEventListener", o = 0;
      ...
      (o._staticClick = function (t, i) {
        if (!this.isIgnoringMouseUp || "mouseup" != t.type) {
          ...
          ("INPUT" == e || "TEXTAREA" == e) && t.target.focus(),
  ...
  (function (t, i) {
    ...
    var c = d.documentElement,
      p =
        "string" == typeof c.style.transform ? "transform" : "WebkitTransform",
      f = t.jQuery,
    ...
    return (
      ...
      (g.dragEnd = function (t, i) {
        this.isEnabled &&
          (p && ((this.element.style[p] = ""), this.setLeftTop()),
      ...
      (g._init = n),
      f && f.bridget && f.bridget("draggabilly", s),
      s
    );
  });
