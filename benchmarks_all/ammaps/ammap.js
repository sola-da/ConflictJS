...
AmCharts.wrappedText = function (a, b, c, d, f, e, g, h, k) {
  ...
  if (l) {
    ...
    if (n.width > h) {
      ...
      l.remove();
      for (var l = [], t = 0; -1 < (index = b.indexOf(" ", t)); )
        l.push(index), (t = index + 1);
      Math.round(b.length / 2);
      for (var p, t = 0; t < l.length; t += Math.ceil(l.length / n))
        (p = l[t]), (b = b.substr(0, p) + m + b.substr(p + 1));
      if (isNaN(p)) {
        if (0 == k)
          for (t = 1; t < n; t++)
            (p = Math.round((b.length / n) * t)),
              (b = b.substr(0, p) + m + b.substr(p));
...
AmCharts.formatDataContextValue = function (a, b) {
  if (a) {
    ...
    for (d = 0; d < c.length; d++) {
      ...
      void 0 !== b[f] &&
        (a = a.replace(new RegExp("\\[\\[" + f + "\\]\\]", "g"), b[f]));
    }
  }
  return a;
};
...
AmCharts.easeOutElastic = function (a, b, c, d, f) {
  ...
  g < Math.abs(d)
    ? ((g = d), (a = e / 4))
    : (a = (e / (2 * Math.PI)) * Math.asin(d / g));
  return (
    g * Math.pow(2, -10 * b) * Math.sin((2 * (b * f - a) * Math.PI) / e) + d + c
  );
};
...
AmCharts.parseDefs = function (a, b) {
  for (var c in a) {
    ...
    if (0 < a[c].length && "object" == d)
      ...
      "object" == d
        ? ((f = document.createElementNS(AmCharts.SVG_NS, c)),
          b.appendChild(f),
          AmCharts.parseDefs(a[c], f))
...
AmCharts.SVGRenderer = AmCharts.Class({
  ...
  animate: function (a, b, c, d, f) {
    ...
    "translate" == b
      ? ((e = (e = e.getAttribute("transform"))
          ? String(e).substring(10, e.length - 1)
          : "0,0"),
        (e = e.split(", ").join(" ")),
        (e = e.split(" ").join(",")),
        0 === e && (e = "0,0"))
          ...
          "translate" == g
            ? ((h = c.from.split(",")),
              ...
              (l =
                0 === l - g
                  ? l
                  : Math.round(AmCharts[c.effect](0, f, g, l - g, d))),
              (c =
                0 === k - h
                  ? k
                  : Math.round(AmCharts[c.effect](0, f, h, k - h, d))),
              (g = "transform"),
              (c = "translate(" + l + "," + c + ")"))
            : ((k = Number(c.from)),
              (h = Number(c.to)),
...
AmCharts.AmChart = AmCharts.Class({
  ...
  showBalloonReal: function (a, b, c, d, f) {
    ...
    e.enabled &&
      ...
      e.changeColor(b),
      !c || e.fixedPosition
        ? (e.setPosition(d, f), e.followCursor(!1))
        : e.followCursor(!0),
      a && e.showBalloon(a));
  },
  ...
  updateAnimations: function () {
    ...
    for (a = this.animations.length - 1; 0 <= a; a--) {
      ...
      if (d <= c) {
        ...
        0 === h
          ? (this.animations.splice(a, 1),
            (f.node.style[e] = Number(b.to) + b.suffix))
  ...
  brr: function () {
    ...
    if ("amcharts.com" != b || !0 === this.inIframe()) {
      ...
      "ammap" == this.product &&
        ((e = "http://www.ammap.com/javascript-maps/"),
  ...
  draw: function () {
    ...
    if (!isNaN(a)) {
      ...
      if (this.show) {
        ...
        this.className &&
          (m.className =
            m.className + " " + u + "-balloon-div-" + this.className);
        u = m.style;
        ...
        "H" != B
          ? ((q = a - x / 2),
            b < h + w + 10 && "down" != B
              ? ((C = !0), d && (b += r), (r = b + v), (this.deltaSignY = -1))
              : (d && (b -= r), (r = b - w - v), (this.deltaSignY = 1)))
          : (2 * v > w && (v = w / 2),
            (r = b - w / 2),
            a < g + (k - g) / 2
              ? ((q = a + v), (this.deltaSignX = -1))
              : ((q = a - x - v), (this.deltaSignX = 1)));
        r + w >= l && (r = l - w);
        r < h && (r = h);
        q < g && (q = g);
        q + x > k && (q = k - x);
        ...
        0 < A || 0 === v
          ? (0 < y &&
            ...
            this.showBullet &&
              ((E = AmCharts.circle(f, D, p, this.fillAlpha)), e.push(E)))
          : ((p = []),
            (A = []),
            "H" != B
              ? ((g = a - q),
              ...
              : ((p = b - r),
                p > w - v && (p = w - v),
                p < v && (p = v),
                (A = [0, p - v, b - r, p + v, w, w, 0, 0]),
                (p =
                  a < g + (k - g) / 2
                    ? [0, 0, q < a ? 0 : a - q, 0, 0, x, x, 0]
                    : [x, x, q + x > a ? x : a - q, x, x, 0, 0, x])),
            0 < y &&
              ((a = AmCharts.polygon(f, p, A, n, 0, z, F, y)),
              a.translate(1, 1),
              e.push(a)),
            (n = AmCharts.polygon(
              f,
        ...
        0 < this.animationDuration &&
          ...
          e.animate({ translate: q - f + "," + r }, b, "easeOutSine"),
          m &&
...
AmCharts.line = function (a, b, c, d, f, e, g, h, k, l, m) {
  if (a.handDrawn && !m)
    return AmCharts.handDrawnLine(a, b, c, d, f, e, g, h, k, l, m);
...
AmCharts.handDrawnLine = function (a, b, c, d, f, e, g, h, k, l, m) {
  ...
  for (m = 1; m < b.length; m++)
    for (
      var t = [b[m - 1], b[m]],
        p = [c[m - 1], c[m]],
        p = AmCharts.makeHD(t, p, a.handDrawScatter),
        t = p[0],
        p = p[1],
        z = 1;
      z < t.length;
...
AmCharts.wedge = function (a, b, c, d, f, e, g, h, k, l, m, n) {
  ...
  n &&
    ((x["fill-opacity"] = 0),
    (x["stroke-opacity"] = l["stroke-opacity"] / 2),
    (x.stroke = l.stroke));
  0 < k &&
    ((D = " M" + y + "," + (B + k) + " L" + A + "," + (w + k)),
    z
      ...
      : ((D +=
        ...
        0 < h &&
          (D += " A" + h + "," + p + ",0," + C + ",0," + y + "," + (B + k))),
    (D = a.path(D + " Z", void 0, void 0, "1000,1000").attr(x)),
    d.push(D),
    (D = a
      .path(
        " M" +
...
AmCharts.AmLegend = AmCharts.Class({
  ...
  drawLegend: function () {
    ...
    "outside" == b
      ? ((c = e.offsetWidth),
        (f = e.offsetHeight),
        e.clientHeight && ((c = e.clientWidth), (f = e.clientHeight)))
      : (isNaN(c) || (e.style.width = c + "px"),
    ...
    if ((f = this.title))
      (f = AmCharts.text(
        ...
        AmCharts.setCN(a, f, "legend-title"),
        f.translate(
          this.marginLeft,
  ...
  arrangeEntries: function () {
    ...
    k = A.height + 2 * l - 1;
    "left" == a || "right" == a
      ? ((h = A.width + 2 * e), (g.style.width = h + b + c + "px"))
      : (h = h - b - c - 1);
    c = AmCharts.polygon(
      this.container,
      [0, h, h, 0],
    ...
    if ("top" == a || "bottom" == a || "absolute" == a || "outside" == a)
      "center" == this.align
        ? (b = e + (h - A.width) / 2)
        : "right" == this.align && (b = e + h - A.width);
    v.translate(b, l + 1);
  ...
  createEntry: function (a) {
    if (!1 !== a.visibleInLegend) {
      ...
      g &&
        (l <= c &&
          g.translate(t, l / 2 + this.ly - c / 2 + (c + 2 - l) / 2 - n),
      ...
      d &&
        ...
        (z = this.labelWidth),
        (z = isNaN(z)
          ? AmCharts.text(this.container, d, e, b.fontFamily, c, "start")
        ...
        AmCharts.setCN(b, z, "legend-label"),
        z.translate(this.lx + m, this.ly),
        k.push(z),
        (b = z.getBBox().width),
  ...
  createValue: function (a) {
    ...
    if (!1 !== a.visibleInLegend) {
      ...
      c = b.container
        .rect(a.legendEntryWidth, 0, e, d, 0, 0)
...
AmCharts.AmMap = AmCharts.Class({
  ...
  drawChart: function () {
    ...
    this.areasSettings = AmCharts.processObject(
      this.areasSettings,
      AmCharts.AreasSettings,
      this.theme
    );
    this.imagesSettings = AmCharts.processObject(
      this.imagesSettings,
      AmCharts.ImagesSettings,
      this.theme
    );
    this.linesSettings = AmCharts.processObject(
      this.linesSettings,
      AmCharts.LinesSettings,
      this.theme
    );
  ...
  buildEverything: function () {
    ...
    if (0 < a.realWidth && 0 < a.realHeight) {
      var b = a.container;
      a.zoomControl = AmCharts.processObject(
        a.zoomControl,
        AmCharts.ZoomControl,
        a.theme
      );
      ...
      var c = a.smallMap;
      c &&
        ((a.smallMap = AmCharts.processObject(
          a.smallMap,
          AmCharts.SmallMap,
          a.theme
        )),
      ...
      a.processAreas();
      if ((c = a.valueLegend))
        (c = AmCharts.processObject(c, AmCharts.ValueLegend, a.theme)),
          (a.valueLegend = c),
          c.init(a, b);
      a.objectList &&
        ((a.objectList = AmCharts.processObject(
          a.objectList,
          AmCharts.ObjectList
        )),
        (b = a.objectList)) &&
  ...
  rescaleMapAndObjects: function () {
    ...
    this.updateSmallMap();
    1 == d &&
      ((d = { type: "zoomCompleted", chart: this }), this.fire(d.type, d));
  },
  ...
  handleReleaseOutside: function () {
    if (AmCharts.isModern && !this.preventHover) {
      ...
      this.zoomOnDoubleClick &&
        this.mouseIsOver &&
        ((a = new Date().getTime()),
        200 > a - this.previousClickTime &&
          20 < a - this.previousClickTime &&
          this.doDoubleClickZoom(),
  ...
  handleMouseMove: function (a) {
    ...
    a &&
      a.touches &&
      (a = a.touches.item(1)) &&
      ((b.mouse2X = a.pageX - AmCharts.findPosX(b.div)),
    ...
    if ((a = b.mapContainer)) {
      ...
      b.isDragging &&
        ...
        b.preventDragOut &&
          ((t = -t * h + l / 2),
          (l /= 2),
          (c = AmCharts.fitToBounds(c, -n * h + m / 2, m / 2)),
          (d = AmCharts.fitToBounds(d, t, l))),
        a.translate(c, d, h),
        b.updateSmallMap());
      b.previuosMouseX = f;
      b.previuosMouseY = e;
  ...
  selectObject: function (a) {
    ...
    "MapArea" == a.objectType &&
      (a.autoZoomReal && (f = !0), (e = b.areasSettings.selectedOutlineColor));
    if (
      c &&
      !f &&
      ("string" == typeof c && (c = b.getObjectById(c)),
    ...
    if ((f = a.displayObject)) {
      ...
      if (!a.preserveOriginalAttributes) {
        ...
        var l = a.imageLabel;
        l &&
          ((c = a.selectedLabelColorReal),
          void 0 !== c && l.setAttr("fill", c));
      }
      a.selectable ||
        (f.setAttr("cursor", "default"), l && l.setAttr("cursor", "default"));
      ...
      for (l = b.getGroupById(f), c = 0; c < l.length; c++)
        if (((k = l[c]), (k.isOver = !1), (f = k.displayObject)))
          if (
            ...
            "MapLine" == k.objectType &&
              ((h = k.lineSvg) && h.setAttr("stroke", g), (k = k.arrowSvg)))
          )
            k.setAttr("fill", g), k.setAttr("stroke", g);
    b.zoomToSelectedObject();
    d != a &&
      ((a = { type: "selectedObjectChanged", chart: b }), b.fire(a.type, a));
  },
  ...
  zoomToLatLongRectangle: function (a, b, c, d) {
    var f = this.dataProvider,
      ...
      e = AmCharts.fitToBounds(
        g / k > h / f ? (0.8 * k) / g : (0.8 * f) / h,
        e.minZoomLevel,
        e.maxZoomLevel
      );
  ...
  zoomToObject: function (a) {
    ...
    "MapArea" == a.objectType &&
      ...
      isNaN(a.zoomX) &&
        ...
        isNaN(a.zoomLongitude) &&
        ((a = this.mapSet.getBBox()),
        this.zoomToMapXY(h, -a.x * b + c + f / 2, -a.y * b + d + e / 2)));
  },
  ...
  buildSVGMap: function () {
    ...
    for (d = 0; d < a.length; d++) {
      ...
      if (this.areasSettings.preserveOriginalAttributes) {
        e.customAttr = {};
        for (var h in f)
          "d" != h && "id" != h && "title" != h && (e.customAttr[h] = f[h]);
      }
  ...
  showAsRolledOver: function (a) {
    ...
    if (!a.showAsSelected && b && !a.isOver) {
      ...
      "MapImage" == a.objectType &&
        ...
        isNaN(c) ||
          1 == c ||
          ((a.tempScale = b.scale), b.translate(b.x, b.y, b.scale * c, !0)));
      this.useHandCursorOnClickableOjects &&
  ...
  longitudeToX: function (a) {
    return (
      this.longitudeToCoordinate(a) * this.zoomLevel() + this.mapContainer.x
    );
  },
  latitudeToY: function (a) {
    return (
      this.latitudeToCoordinate(a) * this.zoomLevel() + this.mapContainer.y
    );
  },
  ...
  showDescription: function (a) {
    ...
    if (a.description) {
      ...
      isNaN(k) || (e = k);
      isNaN(f) &&
        ((f = this.mouseX), (f = f > this.realWidth / 2 ? f - c - 20 : f + 20));
      ...
      "mercator" == c.projection
        ? ((c = this.mercatorLatitudeToCoordinate(d)),
          ...
          (a =
            2 *
              Math.atan(
                Math.exp((2 * ((a * (c - f)) / b + f) * Math.PI) / 180)
              ) -
            0.5 * Math.PI),
  ...
  coordinateToLongitude: function (a) {
    ...
    this.mapSet &&
      (b =
        (a / this.mapWidth) * (c.rightLongitude - c.leftLongitude) +
        c.leftLongitude);
    return Math.round(1e6 * b) / 1e6;
  },
            ...
            void 0 !== a[b][k]
              ? void 0 === a[b][k].length
                ? ((n = a[b][k]),
                  ...
                  (n = a[b][k][1]))
                : "object" == typeof a[b][k] &&
                  (a[b][k].push({}), (n = a[b][k][a[b][k].length - 1]))
              : ((a[b][k] = {}), (n = a[b][k]));
            if (e.attributes && e.attributes.length)
              for (l = 0; l < e.attributes.length; l++)
                n[e.attributes[l].name] = e.attributes[l].value;
            void 0 !== a[b][k].length
  ...
  getDevInfo: function () {
    var a = this.zoomLevel(),
      a = {
        ...
        latitude: this.coordinateToLatitude(
          (this.mouseY - this.mapContainer.y) / a
        ),
        longitude: this.coordinateToLongitude(
  ...
  processObject: function (a, b, c) {
    if (a) {
      ...
      for (d = 0; d < a.length; d++) {
        ...
        "image" == c &&
          (f = AmCharts.extend(f, new AmCharts.MapImage(this.theme), !0));
        "line" == c &&
          (f = AmCharts.extend(f, new AmCharts.MapLine(this.theme), !0));
        a[d] = f;
...
AmCharts.ZoomControl = AmCharts.Class({
  construct: function (a) {
    ...
    this.buttonIconAlpha =
      this.buttonBorderThickness =
      this.buttonBorderAlpha =
        1;
  ...
  init: function (a, b) {
    ...
    g &&
      ...
      AmCharts.setCN(a, u.set, "pan-right"),
      g.push(u.set),
      (u = new AmCharts.SimpleButton()),
  ...
  update: function () {
    ...
    this.isDragging
      ...
      : ((a = Math.log(g.zoomLevel() / 100) / Math.log(b)),
        (a = (d - a) * c + e));
...
AmCharts.SmallMap = AmCharts.Class({
  ...
  init: function (a, b) {
    ...
    if (c.enabled) {
      ...
      isNaN(c.bottom) ||
        ((k = a.getY(c.bottom, !0) - c.height - e), (p = c.height - h + e / 2));
      isNaN(c.left) || ((l = a.getX(c.left) + e), (t = -e / 2));
      isNaN(c.right) ||
        ((l = a.getX(c.right, !0) - c.width - e), (t = c.width - h + e / 2));
      e = b.set();
      ...
      AmCharts.remove(c.allSet),
        AmCharts.remove(c.downButtonSet),
        AmCharts.remove(c.upButtonSet);
  },
  minimize: function () {
  ...
  update: function () {
    ...
    0 < c &&
      0 < b &&
      (f.setAttr("width", Math.ceil(c + 1)),
      f.setAttr("height", Math.ceil(b + 1)));
    this.rWidth = c;
    this.rHeight = b;
  },
  ...
  handleMouseUp: function () {
    ...
    a.zoomTo(
      b,
      -((a.mouseX - this.set.x - this.dx - this.rWidth / 2) / this.mapWidth) *
        b,
      -((a.mouseY - this.set.y - this.dy - this.rHeight / 2) / this.mapHeight) *
        b
    );
  },
});
AmCharts.AreasProcessor = AmCharts.Class({
  ...
  process: function (a) {
    ...
    for (f = 0; f < d; f++) {
      ...
      n &&
        n.className &&
        (g = b.areasClasses[n.className]) &&
        ((c = g),
        (c = AmCharts.processObject(c, AmCharts.AreasSettings, b.theme)));
      var t = c.color,
        p = c.alpha,
      ...
      void 0 == c.colorSolid ||
        isNaN(e.value) ||
        ((r = Math.floor((e.value - l) / ((k - l) / b.colorSteps))),
        r == b.colorSteps && r--,
        (colorPercent = (1 / (b.colorSteps - 1)) * r),
        k == l && (colorPercent = 1),
      ...
      void 0 == e.preserveOriginalAttributes &&
        (e.preserveOriginalAttributes = F);
      e.alphaReal = m;
      ...
      if (
        ...
        void 0 != e.colorReal &&
          (D =
            e.showAsSelected || b.selectedObject == e
              ? e.selectedColorReal
              : e.colorReal);
        ...
        e.preserveOriginalAttributes ||
          (c.setAttr("fill", D),
          c.setAttr("stroke", t),
          c.setAttr("stroke-opacity", A),
          c.setAttr("stroke-width", w),
          c.setAttr("fill-opacity", m));
...
AmCharts.ImagesProcessor = AmCharts.Class({
  ...
  createImage: function (a, b) {
    ...
    if (u) {
      ...
      "kilometers" == a.widthAndHeightUnits &&
        ((p = c.kilometersToPixels(a.width)),
        (v = c.kilometersToPixels(a.height)));
      "miles" == a.widthAndHeightUnits &&
        ((p = c.milesToPixels(a.width)), (v = c.milesToPixels(a.height)));
      if ("circle" == u || "bubble" == u) v = p;
      C = this.createPredefinedImage(x, n, t, u, p, v);
      l = y = 0;
      a.centeredReal
        ? (isNaN(a.right) || (y = p * g), isNaN(a.bottom) || (l = v * g))
        : ((y = (p * g) / 2), (l = (v * g) / 2));
      C.translate(y, l, g);
    } else
      r
        ? (isNaN(p) && (p = 10),
          isNaN(v) && (v = 10),
          (C = d.image(r, 0, 0, p, v)),
          C.node.setAttribute("preserveAspectRatio", "none"),
          C.setAttr("opacity", h),
          a.centeredReal &&
            ((y = isNaN(a.right) ? -p / 2 : p / 2),
            (l = isNaN(a.bottom) ? -v / 2 : v / 2),
            C.translate(y, l)))
        : B &&
          ((C = d.path(B)),
          (n = C.getBBox()),
    ...
    C &&
      (q.push(C),
      (a.image = C),
      C.setAttr("stroke-opacity", k),
      C.setAttr("fill-opacity", h),
      C.setAttr("fill", x),
      AmCharts.setCN(c, C, "map-image"),
      void 0 != a.id && AmCharts.setCN(c, C, "map-image-" + a.id));
    ...
    void 0 !== a.label &&
      ...
      AmCharts.setCN(c, x, "map-image-label"),
      void 0 !== a.id && AmCharts.setCN(c, x, "map-image-label-" + a.id),
      (C = a.labelBackgroundAlpha),
      (h = a.labelBackgroundColor) &&
        0 < C &&
        ((k = x.getBBox()),
        (d = AmCharts.rect(d, k.width + 16, k.height + 10, h, C)),
        AmCharts.setCN(c, d, "map-image-label-background"),
        void 0 != a.id &&
          AmCharts.setCN(c, d, "map-image-label-background-" + a.id),
        q.push(d),
        (a.labelBG = d)),
      (a.imageLabel = x),
      q.push(x),
      AmCharts.setCN(c, q, "map-image-container"),
      void 0 != a.id && AmCharts.setCN(c, q, "map-image-container-" + a.id));
  ...
  updateSizeAndPosition: function (a) {
    ...
    if (!isNaN(d) && !isNaN(f)) c.translate(d, f);
      ...
      !isNaN(h) &&
      !isNaN(g) &&
      ((d = b.longitudeToCoordinate(g)),
      (f = b.latitudeToCoordinate(h)),
    ...
    for (u = 0; u < b.length; u++) {
      ...
      if (q.remainVisible || c.selectedObject == q.parentObject) {
        ...
        if (0 < G.length) {
          ...
          F = AmCharts.line(r, G, I, D, 0.001, 3, F, !1, !1, !0);
          AmCharts.dx = 0.5;
          AmCharts.dy = 0.5;
          x.push(K);
          x.push(F);
          ...
          if ("none" != L) {
            ...
            if ("end" == L || "both" == L)
              (E = G[G.length - 1]),
                (D = I[I.length - 1]),
                1 < G.length
                  ? ((J = G[G.length - 2]), (H = I[I.length - 2]))
                  : ((J = E), (H = D)),
                (H = (180 * Math.atan((D - H) / (E - J))) / Math.PI),
                (Q = E),
                (S = D),
                (H = 0 > E - J ? H - 90 : H + 90);
            "both" == L &&
            ...
            if ("start" == L || "both" == L)
              (E = G[0]),
                (S = I[0]),
                1 < G.length ? ((D = G[1]), (Q = I[1])) : ((D = E), (Q = S)),
                (H = (180 * Math.atan((S - Q) / (E - D))) / Math.PI),
                (Q = E),
                (H = 0 > E - D ? H - 90 : H + 90);
            "middle" == L &&
              ((E = G[G.length - 1]),
          ...
          q.fixedSize &&
            K &&
            (this.linesToResize.push({ line: K, thickness: C }),
            this.linesToResize.push({ line: F, thickness: 3 }));
          q.lineSvg = K;
...
AmCharts.ValueLegend = AmCharts.Class({
  ...
  init: function (a, b) {
    if (this.enabled) {
      ...
      void 0 !== h &&
        ((g = AmCharts.text(b, h, m, l, k, "left")),
        g.translate(0, k / 2 - 1),
        AmCharts.setCN(a, g, "value-legend-min-label"),
        e.push(g),
        (g = g.getBBox().height));
      h = this.maxValue;
      ...
      void 0 !== h &&
        ...
        AmCharts.setCN(a, g, "value-legend-max-label"),
        e.push(g),
        (g = g.getBBox().height));
      if (this.showAsGradient)
        (c = AmCharts.rect(
          ...
          AmCharts.setCN(a, c, "value-legend-gradient"),
          c.translate(0, g),
          e.push(c);
      else
        for (k = this.width / f, l = 0; l < f; l++)
          (m = AmCharts.getColorFade(c, d, (1 * l) / (f - 1))),
            ...
            AmCharts.setCN(a, m, "value-legend-color"),
            AmCharts.setCN(a, m, "value-legend-color-" + l),
            m.translate(k * l, g),
            e.push(m);
      d = c = 0;
      f = e.getBBox();
