  ...
  var LayoutManager = Backbone.View.extend(
    {
      ...
      setView: function (name, view, insert) {
        ...
        if (!manager) {
          throw new Error(
            "The argument associated with selector '" +
              name +
      ...
      render: function () {
        ...
        function resolve() {
          ...
          if (
            rentManager &&
            (rentManager.renderInProgress || rentManager.queue)
          ) {
    ...
    },
    {
      ...
      _removeView: function (view, force) {
        ...
        var rentManager = manager.parent && manager.parent.__manager__;
        var keep =
          typeof view.keep === "boolean" ? view.keep : view.options.keep;
  ...
  var defaultOptions = {
    ...
    htmlBatch: function (rootView, subViews, selector) {
      ...
      var els = _.reduce(
        ...
        function (memo, sub) {
          var keep =
            typeof sub.keep === "boolean" ? sub.keep : sub.options.keep;
