!(function (a, b) {
  ...
  (function (a) {
    ...
    var f = function (a, b) {
        var e,
          c = /\s(?![^<]*>)/g;
        if (!d) for (d = []; null !== (e = c.exec(a)); ) d.push(e.index);
      ...
      h = function (a) {
        return (
          (b =
            a.get(0).currentStyle || window.getComputedStyle(a.get(0), null)),
          "justify" === b.textAlign
        );
      },
      i = function (b, c, d) {
    ...
    (a.fn.balanceTextUpdate = n),
      (a.fn.balanceText = function (b) {
        var f = this.selector;
        return (
          b || -1 !== m.indexOf(f) || m.push(f),
          c
            ? this
            : this.each(function () {
                var b = a(this),
                  ...
                  for (
                    ...
                    (E =
                      0 === C.index
                        ...
                        ? C.index
                        : Math.abs(A - C.width) < Math.abs(D.width - A)
                        ? C.index
                        : D.index),
                      (w = u.substr(0, E)),
                      x
