...
!(function (a, b) {
  ...
  function f(a, b) {
    (this.dateDelta = null),
      ...
      (this.container = a),
      (this.settings = c(this._defaults, b)),
  ...
  (f.prototype = {
    ...
    getTimeDiff: function () {
      ...
      return (
        !(0 > a) || (this.startDateInput && this.endDateInput) || (a += g), a
      );
    },
    refresh: function () {
      if (
      ...
      if (
        ...
        c &&
          d &&
          ((this.timeDelta = d.getTime() - c.getTime()),
          this._updateEndMintime());
      }
    },
    remove: function () {
    ...
    _bindChangeHandler: function () {
      h
        ? h(this.container).on(
            "change.datepair",
            h.proxy(this.handleEvent, this)
          )
        : this.container.addEventListener("change", this, !1);
    },
    _unbindChangeHandler: function () {
      h
        ? h(this.container).off("change.datepair")
        : this.container.removeEventListener("change", this, !1);
    },
    handleEvent: function (a) {
      this._unbindChangeHandler(),
        e(a.target, this.settings.dateClass)
          ? "" != a.target.value
            ? (this._dateChanged(a.target), this._timeChanged(a.target))
            : (this.dateDelta = null)
          : e(a.target, this.settings.timeClass) &&
            ("" != a.target.value
              ? this._timeChanged(a.target)
              : (this.timeDelta = null)),
      ...
      if (this.startTimeInput && this.endTimeInput) {
        ...
        if (b && c)
          if (
            ...
            this.settings.updateTime(this.endTimeInput, d),
              (c = this.settings.parseTime(this.endTimeInput)),
            ...
            this.settings.updateTime(this.startTimeInput, d),
              (b = this.settings.parseTime(this.startTimeInput)),
              this._doMidnightRollover(b, c);
          } else {
            this._doMidnightRollover(b, c);
            var f, g;
            if (
              (this.startDateInput &&
                this.endDateInput &&
                ((f = this.settings.parseDate(this.startDateInput)),
                (g = this.settings.parseDate(this.endDateInput))),
              +f == +g && b > c)
            ) {
              var h = e(a, this.settings.endClass)
                  ? this.endTimeInput
                  : this.startTimeInput,
                i = e(a, this.settings.startClass)
                  ? this.endTimeInput
                  : this.startTimeInput,
    ...
    _doMidnightRollover: function (a, b) {
      if (this.startDateInput && this.endDateInput) {
        var c = this.settings.parseDate(this.endDateInput),
          ...
          f = a > b ? g : -1 * g;
        null !== this.dateDelta &&
          this.dateDelta + this.timeDelta <= g &&
          this.dateDelta + e != 0 &&
          (f > 0 || 0 != this.dateDelta) &&
          ((e >= 0 && this.timeDelta < 0) || (0 > e && this.timeDelta >= 0)) &&
          ("start" == this.settings.anchor
            ? (this.settings.updateDate(
                this.endDateInput,
                new Date(c.getTime() + f)
              ),
              this._dateChanged(this.endDateInput))
            : "end" == this.settings.anchor &&
              (this.settings.updateDate(
                this.startDateInput,
                new Date(d.getTime() - f)
              ),
    ...
    _updateEndMintime: function () {
      if ("function" == typeof this.settings.setMinTime) {
        ...
        "start" == this.settings.anchor &&
          (!this.dateDelta ||
            this.dateDelta < g ||
            (this.timeDelta && this.dateDelta + this.timeDelta < g)) &&
          (a = this.settings.parseTime(this.startTimeInput)),
          this.settings.setMinTime(this.endTimeInput, a);
      }
    },
    _validateRanges: function () {
      return this.startTimeInput && this.endTimeInput && null === this.timeDelta
        ? void d(this.container, "rangeIncomplete")
        : this.startDateInput && this.endDateInput && null === this.dateDelta
        ? void d(this.container, "rangeIncomplete")
        : void (!this.startDateInput ||
          !this.endDateInput ||
          this.dateDelta + this.timeDelta >= 0
            ? d(this.container, "rangeSelected")
            : d(this.container, "rangeError"));
    },
  }),
    (a.Datepair = f);
})(window, document);
