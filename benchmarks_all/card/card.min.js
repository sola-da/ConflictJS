      ...
      2: [
        function (r, e, t) {
          function a() {
            ...
            for (
              "boolean" == typeof p &&
                ((s = p), (p = arguments[1] || {}), (c = 2)),
                "object" == typeof p || n.fn(p) || (p = {});
              l > c;
              c++
            )
              if (((r = arguments[c]), null != r)) {
                "string" == typeof r && (r = r.split(""));
                for (e in r)
                  (t = p[e]),
                    (i = r[e]),
                    p !== i &&
                      (s && i && (n.hash(i) || (o = n.array(i)))
                        ? (o
                            ? ((o = !1), (d = t && n.array(t) ? t : []))
                            : (d = t && n.hash(t) ? t : {}),
                          (p[e] = a(s, d, i)))
                        : "undefined" != typeof i && (p[e] = i));
              }
            return p;
          }
          var n = r("is");
        ...
        function (r, e, t) {
          ...
          (s.a = s.type =
            ...
            (s.equal = function (r, e) {
              ...
              if ("[object Array]" === a) {
                if (((t = r.length), t !== e.length)) return !1;
            ...
            (s["false"] = function (r) {
              return s.bool(r) && Boolean(Number(r)) === !1;
            }),
            (s["true"] = function (r) {
              return s.bool(r) && Boolean(Number(r)) === !0;
            }),
            (s.date = function (r) {
            ...
            (s.fn = s["function"] =
              function (r) {
                var e = "undefined" != typeof window && r === window.alert;
                return e || "[object Function]" === o.call(r);
              }),
            (s.number = function (r) {
            ...
            (s.divisibleBy = function (r, e) {
              var t = s.infinite(r),
                a = s.infinite(e),
                n = s.number(r) && !d(r) && s.number(e) && !d(e) && 0 !== e;
              return t || a || (n && r % e === 0);
            }),
            (s.integer = s["int"] =
              function (r) {
            ...
            (s.le = function (r, e) {
              if (d(r) || d(e)) throw new TypeError("NaN is not a valid value");
              return !s.infinite(r) && !s.infinite(e) && e >= r;
            }),
            (s.lt = function (r, e) {
              if (d(r) || d(e)) throw new TypeError("NaN is not a valid value");
              return !s.infinite(r) && !s.infinite(e) && e > r;
            ...
            (s.within = function (r, e, t) {
              ...
              if (!s.number(r) || !s.number(e) || !s.number(t))
                throw new TypeError("all arguments must be numbers");
              var a = s.infinite(r) || s.infinite(e) || s.infinite(t);
              return a || (r >= e && t >= r);
            }),
            (s.object = function (r) {
          ...
          (function (t) {
            ...
            (n = r("qj/src/qj.coffee")),
              ...
              (i = function (r) {
                var e, t, a;
                for (
                  r = (r + "").replace(/\D/g, ""), t = 0, a = d.length;
                  a > t;
                  t++
                )
                  if (((e = d[t]), e.pattern.test(r))) return e;
              }),
              (o = function (r) {
                var e, t, a;
                for (t = 0, a = d.length; a > t; t++)
                  if (((e = d[t]), e.type === r)) return e;
              }),
              (h = function (r) {
                var e, t, a, n, i, o;
                for (
              ...
              (s = function (r) {
                ...
                return (
                  ...
                  (c = n.val(d)),
                  (e = i(c + t)),
                  (a = (c.replace(/\D/g, "") + t).length),
                  (p = 16),
                  e && (p = e.length[e.length.length - 1]),
                  a >= p || j(d))
                    ? void 0
                    : ((o =
                        e && "amex" === e.type
              ...
              (c = function (r) {
                ...
                return (
                  ...
                  r.meta || 8 !== r.which || j(e)
                    ? void 0
                    : /\d\s$/.test(t)
                    ? (r.preventDefault(), n.val(e, t.replace(/\d\s$/, "")))
                    : /\s\d?$/.test(t)
                    ? (r.preventDefault(), n.val(e, t.replace(/\s\d?$/, "")))
                    : void 0
                );
              }),
              (f = function (r) {
                ...
                return (
                  ...
                  /^\d+$/.test(e)
                    ? ((t = r.target),
                      (a = n.val(t) + e),
                      /^\d$/.test(a) && "0" !== a && "1" !== a
                        ? (r.preventDefault(), n.val(t, "0" + a + " / "))
                        : /^\d\d$/.test(a)
                        ? (r.preventDefault(), n.val(t, a + " / "))
                        : void 0)
                    : void 0
                );
              }),
              ...
              (x = function (r) {
                ...
                if (
                  ...
                  if (((o = (n.val(a) + t).replace(/\D/g, "")), (e = i(o)))) {
                    if (!(o.length <= e.length[e.length.length - 1]))
              ...
              (k = function (r, e) {
                ...
                return (
                  ...
                  /^\d+$/.test(t) && !j(a)
                    ? ((i = n.val(a) + t),
                      (i = i.replace(/\D/g, "")),
                      i.length > e ? r.preventDefault() : void 0)
                    : void 0
                );
              }),
              (y = function (r) {
              ...
              (v = function (r) {
                ...
                return (
                  ...
                  /^\d+$/.test(e) && !j(t)
                    ? ((a = n.val(t) + e),
                      a.length <= 4 ? void 0 : r.preventDefault())
                    : void 0
                );
              }),
              (F = function (r) {
                ...
                return (
                  (o = r.target),
                  (p = n.val(o)),
                  (i = a.fns.cardType(p) || "unknown"),
                  n.hasClass(o, i)
                    ? void 0
                    : ((e = (function () {
                        var r, e, a;
                        for (a = [], r = 0, e = d.length; e > r; r++)
                          (t = d[r]), a.push(t.type);
                        return a;
                      })()),
                      n.removeClass(o, "unknown"),
                      n.removeClass(o, e.join(" ")),
                      n.addClass(o, i),
                      n.toggleClass(o, "identified", "unknown" !== i),
                      n.trigger(o, "payment.cardType", i))
                );
              }),
              (a = (function () {
                function r() {}
                  ...
                  (r.fns = {
                    cardExpiryVal: function (r) {
                      ...
                      return (
                        ...
                        (e = a[0]),
                        (n = a[1]),
                        2 === (null != n ? n.length : void 0) &&
                          /^\d+$/.test(n) &&
                          ((t = new Date().getFullYear()),
                          (t = t.toString().slice(0, 2)),
                          (n = t + n)),
                        (e = parseInt(e, 10)),
                        (n = parseInt(n, 10)),
                        { month: e, year: n }
        ...
        function (r, e, t) {
          ...
          (a = function (r) {
            ...
            (a.preventDefault = function (r) {
              return "function" == typeof r.preventDefault
            ...
            (a.normalizeEvent = function (r) {
              ...
              return (
                (e = r),
                (r = {
                  which: null != e.which ? e.which : void 0,
                ...
                null == r.which &&
                  (r.which = null != e.charCode ? e.charCode : e.keyCode),
                r
              );
            }),
            (a.on = function (r, e, t) {
              var n, i, o, d, p, c, l, s;
              if (r.length)
                for (i = 0, d = r.length; d > i; i++) (n = r[i]), a.on(n, e, t);
              else {
                if (!e.match(" "))
                  return (
                    (l = t),
                    ...
                    r.addEventListener
                      ...
                      : r.attachEvent
                      ? ((e = "on" + e), r.attachEvent(e, t))
                      : void (r["on" + e] = t)
                  );
                for (s = e.split(" "), o = 0, p = s.length; p > o; o++)
                  (c = s[o]), a.on(r, c, t);
              }
            }),
            (a.addClass = function (r, e) {
              ...
              return r.length
                ? (function () {
                    var n, i, o;
                    for (o = [], n = 0, i = r.length; i > n; n++)
                      (t = r[n]), o.push(a.addClass(t, e));
                    return o;
                  })()
                : r.classList
                ? r.classList.add(e)
            ...
            (a.hasClass = function (r, e) {
              var t, n, i, o;
              if (r.length) {
                for (n = !0, i = 0, o = r.length; o > i; i++)
                  (t = r[i]), (n = n && a.hasClass(t, e));
                return n;
              }
              return r.classList
                ? r.classList.contains(e)
                : new RegExp("(^| )" + e + "( |$)", "gi").test(r.className);
            }),
            (a.removeClass = function (r, e) {
              ...
              if (r.length)
                return (function () {
                  var t, i, o;
                  for (o = [], t = 0, i = r.length; i > t; t++)
                    (n = r[t]), o.push(a.removeClass(n, e));
                  return o;
                })();
              if (r.classList) {
                for (d = e.split(" "), p = [], i = 0, o = d.length; o > i; i++)
                  (t = d[i]), p.push(r.classList.remove(t));
                return p;
              }
            ...
            (a.toggleClass = function (r, e, t) {
              ...
              return r.length
                ? (function () {
                    var i, o, d;
                    for (d = [], i = 0, o = r.length; o > i; i++)
                      (n = r[i]), d.push(a.toggleClass(n, e, t));
                    return d;
                  })()
                : t
                ? a.hasClass(r, e)
          ...
          (e.exports = function (r, e) {
            ...
            (e.exports.byUrl = function (r) {
              if (document.createStyleSheet)
                return document.createStyleSheet(r).ownerNode;
            ...
            r("../scss/card.scss"),
              ...
              (a = (function () {
                        ...
                        this.options.container
                          ? ((this.$container = n(this.options.container)),
                            (e = n.isDOMElement(this.$container)
                              ...
                              : this.$container[0]),
                            void (
                              e.getAttribute(this.initializedDataAttr) ||
                ...
                return (
                  ...
                  (r.prototype.template = function (r, e) {
                    return r.replace(/\{\{(.*?)\}\}/g, function (r, t, a) {
                      return e[t];
                    });
                  }),
                  (r.prototype.cardTypes = [
                    "jp-card-amex",
                    "jp-card-dankort",
                    "jp-card-dinersclub",
                    "jp-card-discover",
                  ...
                  (r.prototype.render = function () {
                    ...
                    n.append(
                      ...
                      this.template(
                        this.cardTemplate,
                        i({}, this.options.messages, this.options.placeholders)
                      )
                    ),
                      (o = this.options.cardSelectors);
                    for (t in o)
                      (p = o[t]), (this["$" + t] = n.find(this.$container, p));
                    d = this.options.formSelectors;
                    for (t in d)
                      (p = d[t]),
                        (p = this.options[t] ? this.options[t] : p),
                        (a = n.find(this.$el, p)),
                        !a.length &&
                          this.options.debug &&
                          console.error(
                            "Card can't find a " + t + " in your form."
                          ),
                        (this["$" + t] = a);
                    return (
                      ...
                      /rv:11.0/i.test(navigator.userAgent)
                        ? n.addClass(this.$card, "jp-card-ie-11")
                        : void 0
                    );
                  }),
                  (r.prototype.attachHandlers = function () {
                    ...
                    return (
                      ...
                      r.push(this.validToggler("cardExpiry")),
                      ...
                      e(this.$nameInput, this.$nameDisplay, {
                        fill: !1,
                  ...
                  (e = function (r, e, t) {
                    ...
                    return (
                      ...
                      (o = (function () {
                        var r, t, a;
                        for (a = [], r = 0, t = e.length; t > r; r++)
                          (i = e[r]), a.push(i.textContent);
                        return a;
                      })()),
                      ...
                      n.on(r, "keyup change paste", function (a) {
                        ...
                        for (
                          m = (function () {
                            var e, t, a;
                            for (a = [], e = 0, t = r.length; t > e; e++)
                              (i = r[e]), a.push(n.val(i));
                            return a;
                          })(),
                            l = t.join(m),
                            m = m.join(l),
                          ...
                          (d = j[c]), (m = d(m, r, e));
                        for (h = [], p = s = 0, g = e.length; g > s; p = ++s)
                          (u = e[p]),
                            (b = t.fill
                              ? m + o[p].substring(m.length)
                              : m || o[p]),
                            h.push((u.textContent = b));
                        return h;
                      }),
                      r
                    );
