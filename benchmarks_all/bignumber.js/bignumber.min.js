...
!(function (e) {
  ...
  function n(e) {
    function E(e, n) {
      ...
      if (null != n && H(n, 2, 64, M, "base")) {
        ...
        o
          ? ((f.s = 0 > 1 / e ? ((s = s.slice(1)), -1) : 1),
            j && s.replace(/^0\.0*|\./, "").length > 15 && L(M, v, e),
            (o = !1))
      ...
      if ((s = s.slice(i, u + 1)))
        if (
          ((u = s.length),
          o && j && u > 15 && (e > y || e !== d(e)) && L(M, v, f.s * e),
          (r = r - i - 1),
          r > z)
        )
          f.c = f.e = null;
    ...
    function D(e, n, t, i) {
      ...
      if (
        ...
        if (((h.length = o), c))
          for (--n; ++h[--o] > n; ) (h[o] = 0), o || (++u, h.unshift(1));
        for (f = h.length; !h[--f]; );
    ...
    return (
      ...
      (E.config = function () {
        ...
        return (
          f((n = "DECIMAL_PLACES")) && H(e, 0, A, 2, n) && (P = 0 | e),
          (r[n] = P),
          f((n = "ROUNDING_MODE")) && H(e, 0, 8, 2, n) && (k = 0 | e),
          (r[n] = k),
          f((n = "EXPONENTIAL_AT")) &&
            (u(e)
              ? H(e[0], -A, 0, 2, n) &&
          ...
          f((n = "CRYPTO")) &&
            (e === !!e || 1 === e || 0 === e
              ? ((V = !(!e || !a)),
                e && !V && j && L(2, "crypto unavailable", a))
              : j && L(2, n + m, e)),
          (r[n] = V),
          f((n = "MODULO_MODE")) && H(e, 0, 9, 2, n) && (W = 0 | e),
          (r[n] = W),
          f((n = "POW_PRECISION")) && H(e, 0, A, 2, n) && (J = 0 | e),
          (r[n] = J),
          f((n = "FORMAT")) &&
            ("object" == typeof e
              ? (X = e)
      ...
      (E.random = (function () {
        ...
        return function (e) {
          var t,
            ...
            l = new E(q);
          if (
            ((e = null != e && H(e, 0, A, 14) ? 0 | e : P), (o = p(e / O)), V)
          )
        ...
        return function (i, o, u, s, f) {
          ...
          for (
            w = new E(x),
              ...
              c = i.e - o.e,
              x = u + c + 1,
              f || ((f = b), (c = t(i.e / O) - t(o.e / O)), (x = (x / O) | 0)),
              a = 0;
            L[a] == (I[a] || 0);
            a++
          );
          if ((L[a] > (I[a] || 0) && c--, 0 > x)) v.push(1), (h = !0);
          else {
            for (
              A = I.length,
                F = L.length,
            ...
            do {
              if (((g = 0), (l = n(L, N, F, y)), 0 > l)) {
                ...
                else 0 == g && (l = g = 1), (p = L.slice()), (m = p.length);
                if (
                  (y > m && p.unshift(0),
                  r(N, p, y, f),
                  (y = N.length),
      ...
      (T.minus = T.sub =
        function (e, n) {
          ...
          if (((l = t(l)), (c = t(c)), (a = a.slice()), (f = l - c))) {
            ...
            for (
              i = (u = (f = a.length) < (n = h.length)) ? f : n, f = n = 0;
              i > n;
              n++
            )
              if (a[n] != h[n]) {
        ...
        function (e) {
          ...
          if (
            (null != e &&
              ...
              1 !== e &&
              0 !== e &&
              (j && L(13, "argument" + m, e), e != !!e && (e = null)),
            !i)
          )
            return null;
      ...
      (T.round = function (e, n) {
        ...
        return (
          (null == e || H(e, 0, A, 15)) &&
            U(t, ~~e + this.e + 1, null != n && H(n, 0, 8, 15, w) ? 0 | n : k),
          t
        );
      }),
      (T.shift = function (e) {
        var n = this;
        return H(e, -y, y, 16, "argument")
          ? n.times("1e" + c(e))
          : new E(
      ...
      (T.times = T.mul =
        function (e, n) {
          ...
          if (!(N && y && N[0] && y[0]))
            return (
              !v.s || !e.s || (N && !N[0] && !y) || (y && !y[0] && !N)
                ? (e.c = e.e = e.s = null)
                : ((e.s *= v.s),
                  N && y ? ((e.c = [0]), (e.e = 0)) : (e.c = e.e = null)),
              e
            );
          for (
            i = t(v.e / O) + t(e.e / O),
          ...
          for (m = b, w = R, o = h; --o >= 0; ) {
            for (
              r = 0, g = y[o] % w, p = (y[o] / w) | 0, s = l, u = o + s;
              u > o;
      ...
      (T.toDigits = function (e, n) {
        var t = new E(this);
        return (
          (e = null != e && H(e, 1, A, 18, "precision") ? 0 | e : null),
          (n = null != n && H(n, 0, 8, 18, w) ? 0 | n : k),
          e ? U(t, e, n) : t
        );
      }),
      ...
      (T.toFixed = function (e, n) {
        return F(
          this,
          null != e && H(e, 0, A, 20) ? ~~e + this.e + 1 : null,
          n,
          20
        );
      }),
      (T.toFormat = function (e, n) {
        var t = F(
          this,
          null != e && H(e, 0, A, 21) ? ~~e + this.e + 1 : null,
          n,
          21
        );
        if (this.c) {
          ...
          (null != e &&
            ...
            (!(a = s.isInt()) || s.lt(q)) &&
              (j &&
                L(
                  22,
                  "max denominator " + (a ? "out of range" : "not an integer"),
                  e
                ),
              (e = !a && s.c && U(s, s.e + 1, 1).gte(q) ? s : null))),
          !g)
        )
          return h.toString();
        for (
          c = r(g),
            o = p.e = c.length - h.e - 1,
            p.c[0] = S[(u = o % O) < 0 ? O + u : u],
            e = !e || s.cmp(p) > 0 ? (o > 0 ? p : d) : s,
            u = z,
            z = 1 / 0,
            s = new E(c),
            f.c[0] = 0;
          (l = C(s, p, 0, 1)), (i = t.plus(l.times(m))), 1 != i.cmp(e);

        )
          (t = m),
            (m = i),
            (d = f.plus(l.times((i = d)))),
            (f = i),
            (p = s.minus(l.times((i = p)))),
            (s = i);
        return (
          (i = C(e.minus(t), m, 0, 1)),
          (f = f.plus(i.times(d))),
          ...
          (o *= 2),
          (n =
            C(d, m, o, k).minus(h).abs().cmp(C(f, t, o, k).minus(h).abs()) < 1
      ...
      (T.toPower = T.pow =
        function (e, n) {
          ...
          return n
            ? r
            : (0 > e && (r = q.div(r)), i ? r.mod(i) : t ? U(r, J, k) : r);
        }),
      (T.toPrecision = function (e, n) {
        return F(
          this,
          null != e && H(e, 1, A, 24, "precision") ? 0 | e : null,
          n,
          24
        );
      }),
  ...
  var a,
    ...
    A = 1e9;
  if (
    ("undefined" != typeof crypto && (a = crypto),
