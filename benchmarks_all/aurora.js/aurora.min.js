          ...
          Bitstream = (function () {
            ...
            Bitstream.prototype.read = function (bits, signed) {
              ...
              if (mBits <= 8) {
                ...
                a =
                  ((this.stream.peekUInt16() << this.bitPosition) & 65535) >>>
                  (16 - bits);
              } else if (mBits <= 24) {
                a =
                ...
                a0 = this.stream.peekUInt8(0) * 4294967296;
        ...
        function (_dereq_, module, exports) {
          ...
          Stream = (function () {
            ...
            float64Fallback = function () {
              ...
              exp -= 1023;
              out = (frac | 1048576) * Math.pow(2, exp - 20);
                ...
                case "utf-8":
                  while (
                    ...
                    if ((b1 & 128) === 0) {
                      ...
                      b2 = this.peekUInt8(offset++) & 63;
                      result += String.fromCharCode(((b1 & 31) << 6) | b2);
                    } else if ((b1 & 240) === 224) {
                      b2 = this.peekUInt8(offset++) & 63;
                      b3 = this.peekUInt8(offset++) & 63;
                      ...
                      b2 = this.peekUInt8(offset++) & 63;
                      b3 = this.peekUInt8(offset++) & 63;
                      b4 = this.peekUInt8(offset++) & 63;
                      pt =
                        (((b1 & 15) << 18) | (b2 << 12) | (b3 << 6) | b4) -
                        65536;
                      result += String.fromCharCode(
                        55296 + (pt >> 10),
                        56320 + (pt & 1023)
                ...
                switch (this.headerCache.type) {
                  ...
                  case "pakt":
                    if (this.stream.available(this.headerCache.size)) {
                      ...
                      this.emit(
                        "duration",
                        ((this.numFrames / this.format.sampleRate) * 1e3) | 0
                      );
          ...
          M4ADemuxer = (function (_super) {
            ...
            M4ADemuxer.prototype.parseChapters = function () {
              ...
              while (this.chapters.length < track.seekPoints.length) {
                ...
                this.chapters.push({
                  title: title,
                  timestamp: ((point.timestamp / track.timeScale) * 1e3) | 0,
                  duration:
      ...
      20: [
        function (_dereq_, module, exports) {
          ...
          WAVEDemuxer = (function (_super) {
            ...
            formats = { 1: "lpcm", 3: "lpcm", 6: "alaw", 7: "ulaw" };
        ...
        function (_dereq_, module, exports) {
          ...
          AudioDevice = (function (_super) {
            ...
            AudioDevice.prototype.updateTime = function () {
              ...
              this.currentTime +=
                (((time - this._lastTime) / this.device.sampleRate) * 1e3) | 0;
              this._lastTime = time;
              return this.emit("timeUpdate", this.currentTime);
            };
            devices = [];
        ...
        function (_dereq_, module, exports) {
          ...
          Player = (function (_super) {
            ...
            Player.prototype.seek = function (timestamp) {
              ...
              timestamp = (timestamp / 1e3) * this.format.sampleRate;
              timestamp = this.asset.decoder.seek(timestamp);
              this.currentTime =
                ((timestamp / this.format.sampleRate) * 1e3) | 0;
              this.queue.reset();
