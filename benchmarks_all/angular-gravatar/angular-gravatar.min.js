angular.module("md5", []).constant(
  ...
  (function () {
    ...
    function c(a) {
      ...
      for (
        var c, d = o ? "0123456789ABCDEF" : "0123456789abcdef", e = "", f = 0;
        f < a.length;
        f++
      )
        (c = a.charCodeAt(f)),
      ...
      for (var b, c, d = "", e = -1; ++e < a.length; )
        (b = a.charCodeAt(e)),
          ...
          127 >= b
            ...
            : 2047 >= b
            ? (d += String.fromCharCode(192 | ((b >>> 6) & 31), 128 | (63 & b)))
            : 65535 >= b
  ...
  function () {
    ...
    (a = function (a) {
          ...
          return (
            (c = function (a, b) {
              ...
              for (c in b)
                (e = b[c]),
                  0 === c.indexOf(a) &&
                    ((c = c.substr(a.length).toLowerCase()),
                    c.length > 0 && (d[c] = e));
              return d;
            }),
            {
      ...
      angular
          ...
          function (a) {
            ...
            return (
              ...
              (d = function (a) {
                ...
                c = [];
                for (b in a)
                  (d = a[b]), c.push("" + b + "=" + encodeURIComponent(d));
                return c.join("&");
              }),
              (this.defaults = {}),
              (this.secure = !1),
              (this.protocol = null),
              (this.urlFunc = function (c) {
                var e, f, g, h, i;
                return (
                  (g = c.protocol ? c.protocol + ":" : ""),
                  (i = c.secure ? "https://secure" : g + "//www"),
                  (h = b.test(c.src) ? c.src : a(c.src)),
                  (f = [i, ".gravatar.com/avatar/", h]),
                  (e = d(c.params)),
                  e.length > 0 && f.push("?" + e),
                  f.join("")
                );
                  ...
                  return {
                    url: function (a, b) {
                      return (
                        ...
                        null == b && (b = {}),
                        c.urlFunc({
                          params: angular.extend(angular.copy(c.defaults), b),
                          protocol: c.protocol,
                          secure: c.secure,
                          src: a,
                        })
        ...
        .directive("gravatarSrc", a())
        .directive("gravatarSrcOnce", a(!0));
  }.call(this);
