  ...
  angular.module("bootstrapLightbox").service("ImageLoader", [
    ...
    function (a) {
      this.load = function (b) {
        ...
        return (
          (d.onload = function () {
            (("boolean" == typeof this.complete && this.complete === !1) ||
              ("number" == typeof this.naturalWidth &&
                0 === this.naturalWidth)) &&
              c.reject(),
              c.resolve(d);
          }),
    ...
    (this.templateUrl = "lightbox.html"),
      ...
      (this.calculateImageDimensionLimits = function (a) {
        return a.windowWidth >= 768
          ? { maxWidth: a.windowWidth - 92, maxHeight: a.windowHeight - 126 }
      ...
      (this.calculateModalDimensions = function (a) {
        ...
        return (
          (b >= a.windowWidth - 20 || a.windowWidth < 768) && (b = "auto"),
      ...
      (this.isSharedVideo = function (a) {
        return (
          this.isVideo(a) && !this.getImageUrl(a).match(/\.(mp4|ogg|webm)$/)
        );
      }),
      (this.$get = [
        "$document",
        ...
        function (a, b, c, d, e) {
          ...
          return (
            ...
            (g.calculateImageDimensionLimits =
    ...
    function (a, b, c) {
      var d = function (a, b) {
          ...
          if (b) {
            ...
            e > c && f > d
              ? c / d > g / h
                ? ((j = f), (i = Math.round((c * f) / d)))
                : ((i = e), (j = Math.round((d * e) / c)))
              : e > c
              ? ((i = e), (j = Math.round((d * e) / c)))
              : f > d && ((j = f), (i = Math.round((c * f) / d))),
              c > g && d > h
                ? c / d > g / h
                  ? ((i = g), (j = Math.round((d * g) / c)))
                  : ((j = h), (i = Math.round((c * h) / d)))
                : c > g
                ? ((i = g), (j = Math.round((d * g) / c)))
                : d > h && ((j = h), (i = Math.round((c * h) / d)));
      ...
      return {
        link: function (h, i, j) {
          var k = function () {
            ...
            i.css({ width: k.width + "px", height: k.height + "px" }),
              angular
                .element(
