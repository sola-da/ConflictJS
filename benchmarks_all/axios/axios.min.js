        ...
        return new Promise(function (t, n) {
          try {
            ...
            "function" == typeof e.adapter
              ...
              ? (o = r(6))
              : "undefined" != typeof process && (o = r(6)),
      ...
      e.exports = function (e, t, f) {
        ...
        if (
          (l.open(
            ...
            o(f.url, f.params, f.paramsSerializer),
            !0
          ),
          (l.timeout = f.timeout),
          (l[h] = function () {
          ...
          var g = r(13),
            v =
              f.withCredentials || u(f.url) ? g.read(f.xsrfCookieName) : void 0;
        ...
        f.progress &&
          ("post" === f.method || "put" === f.method
            ? l.upload.addEventListener("progress", f.progress)
            : "get" === f.method && l.addEventListener("progress", f.progress)),
          void 0 === p && (p = null),
          l.send(p);
      };
    },
