...
(function (t, e) {
  ...
  function i(e, n, o, r) {
    for (var s in n)
      if (n.hasOwnProperty(s)) {
        var u = n[s];
        if (e.hasComputed(s)) {
          if (r.length && t.contains(r, s))
            throw "Recursive setter: " + r.join(" > ");
  ...
  function o(e, n, i, o) {
    (i = i || {}),
      i.get && w(i.get) && (i._get = i.get),
      i.set && w(i.set) && (i._set = i.set),
      delete i.get,
      delete i.set,
      t.extend(this, i),
      (this.model = e),
  ...
  function u(e) {
    return function () {
      ...
      return function (e) {
        return y(e)
          ? i.apply(this, t.map(n, r))
          : n[0]((o ? o : i).call(this, e));
      };
    };
  }
  function c(e, n, i, o, r) {
    return (e = t.result(e, o))
      ? (C(e)
          ? ((r = r ? r + "_" : ""),
            (n["$" + o] = function () {
              return F && F.push([e, "change"]), e;
            }),
            t.each(e.toJSON({ computed: !0 }), function (t, o) {
              n[r + o] = function (t) {
                return a(e, o, t, i);
              };
            }))
  ...
  function l(e, n, i, o, r, s) {
    ...
    var h = t
      .map(t.union(c.events || [], ["change"]), function (t) {
        return t + ".epoxy";
      })
      .join(" ");
    t.each(c, function (t, i) {
      if (r.hasOwnProperty(i)) e.b().push(new p(e, n, r[i], t, h, o, c));
      else if (!q.hasOwnProperty(i))
        throw 'binding handler "' + i + '" is not defined.';
    });
  }
  function f(t, e, n) {
  ...
  function p(e, n, i, o, s, u, c) {
    var a = this,
      ...
      l =
        ...
        "select" == h ||
        "textarea" == h ||
        "true" == n.prop("contenteditable"),
      f = [],
      d = function (t) {
        a.$el && a.set(a.$el, r(o), t);
      };
    if (
      ((a.view = e),
      (a.$el = n),
      ...
      l &&
        i.get &&
        w(o) &&
        a.$el.on(s, function (t) {
          o(a.get(a.$el, r(o), t));
        }),
      f.length)
    )
      for (var p = 0, g = f.length; g > p; p++) a.listenTo(f[p][0], f[p][1], d);
  }
  var g,
    v = (e.Epoxy = {}),
    m = Array.prototype,
    ...
    O = {
      mixin: function (t) {
        ...
        for (var e in this.prototype)
          ("bindings" === e && t.bindings) ||
            (this.prototype.hasOwnProperty(e) &&
              "constructor" !== e &&
              (t[e] = this.prototype[e]));
        return t;
      },
    },
    V = ["computeds"];
  (v.Model = e.Model.extend(
    {
      ...
      constructor: function (e, i) {
        t.extend(this, t.pick(i || {}, V)),
          n(this, "constructor", arguments),
          this.initComputeds(e, i);
      },
      getCopy: function (e) {
      ...
      get: function (t) {
        return (
          g && g.push(["change:" + t, this]),
          this.hasComputed(t) ? this.c()[t].get() : n(this, "get", arguments)
        );
      },
      set: function (e, o, r) {
        var s = e;
        ...
        return (
          r.silent ||
            (!this.hasChanged() && u.length && this.trigger("change", this),
            t.each(
              u,
              function (t) {
      ...
      initComputeds: function (e) {
        ...
        (n = t.extend(n, t.pick(e || {}, t.keys(n)))),
          t.each(
            n,
            function (t, e) {
      ...
      addComputed: function (t, e, n) {
        ...
        if (w(e)) {
          ...
          (i = {}),
            (i._get = e),
            w(n) && ((i._set = n), s++),
            (i.deps = m.slice.call(arguments, s));
        }
      ...
      removeComputed: function (t) {
        return (
          this.hasComputed(t) && (this.c()[t].dispose(), delete this.c()[t]),
          this
        );
      },
      ...
      modifyArray: function (t, e, n) {
        ...
        if (_(i) && w(m[e])) {
          ...
          return (
            (n = n || {}),
            n.silent || this.trigger("change:" + t + " change", this, m, n),
            r
          );
        }
        return null;
      ...
      modifyObject: function (t, e, n, i) {
        ...
        return b(o)
          ? ((i = i || {}),
            y(n) && o.hasOwnProperty(e)
              ? (delete o[e], (r = !0))
              : o[e] !== n && ((o[e] = n), (r = !0)),
            r &&
              !i.silent &&
              this.trigger("change:" + t + " change", this, o, i),
            o)
          : null;
      },
    },
    ...
    t.extend(o.prototype, e.Events, {
        ...
        this.get(!0),
          ...
          n.length &&
            ...
            t.each(
              ...
              function (e, n) {
                for (var i = 0, o = e.length; o > i; i++)
                  this.listenTo(e[i], n, t.bind(this.get, this, !0));
              },
              this
            ));
      },
      ...
      change: function (e) {
        if (!t.isEqual(e, this.value)) {
          ...
          this.model._setting
            ? this.model._setting.push(n)
            : ((n[0] += " change"), this.model.trigger.apply(this.model, n));
        }
      },
      dispose: function () {
  ...
  var k = { optionText: "label", optionValue: "value" },
    P = {},
    B = {
      attr: s(function (t, e) {
        t.attr(e);
      ...
      collection: s({
        init: function (t, e, n, i) {
          if (
            ((this.i = i.itemView ? this.view[i.itemView] : this.view.itemView),
            !x(e))
          )
            throw 'Binding "collection" requires a Collection.';
          if (!w(this.i)) throw 'Binding "collection" requires an itemView.';
          this.v = {};
        },
        set: function (e, n, i) {
          var o,
            ...
            c = F;
          if (((F = null), (i = i || n), C(i)))
            if (r.hasOwnProperty(i.cid)) r[i.cid].remove(), delete r[i.cid];
            else {
              r[i.cid] = o = new s({ model: i, collectionView: this.view });
              var a = t.indexOf(u, i),
                h = e.children();
            ...
            l
              ...
              : (this.clean(),
                n.each(function (t) {
                  (r[t.cid] = o =
                    new s({ model: t, collectionView: this.view })),
                    f.appendChild(o.el);
                }, this)),
              e.append(f);
          }
        ...
        clean: function () {
          for (var t in this.v)
            this.v.hasOwnProperty(t) && (this.v[t].remove(), delete this.v[t]);
        },
      }),
      css: s(function (t, e) {
        t.css(e);
      ...
      options: s({
        init: function (t, e, n, i) {
          (this.e = i.optionsEmpty),
            (this.d = i.optionsDefault),
            (this.v = i.value);
        },
        set: function (e, n) {
          var i = this,
          ...
          a || s || !o
            ...
            : ((l += i.opt(o, a)), (h = !1)),
            e.html(l).prop("disabled", !h).val(u);
          var f = e.val();
        ...
        opt: function (t) {
          ...
          return (
            b(t) &&
              ((e = C(t) ? t.get(i) : t[i]), (n = C(t) ? t.get(o) : t[o])),
            ['<option value="', n, '">', e, "</option>"].join("")
          );
        },
        clean: function () {
      ...
      template: s({
        init: function (e, n, i) {
          ...
          return (
            (this.t = t.template(o.length ? o.html() : e.html())),
            _(n) ? t.pick(i, n) : void 0
          );
        },
        set: function (t, e) {
          (e = C(e) ? e.toJSON({ computed: !0 }) : e), t.html(this.t(e));
        },
        clean: function () {
          this.t = null;
        },
    ...
    E = {
      all: u(function () {
        for (var t = arguments, e = 0, n = t.length; n > e; e++)
          if (!t[e]) return !1;
        return !0;
      }),
      any: u(function () {
      ...
      format: u(function (t) {
        for (var e = arguments, n = 1, i = e.length; i > n; n++)
          t = t.replace(RegExp("\\$" + n, "g"), e[n]);
        return t;
      }),
    ...
    q = { events: 1, itemView: 1, optionsDefault: 1, optionsEmpty: 1 };
  v.binding = {
    allowedParams: q,
  ...
  return (
    (v.View = e.View.extend(
      {
        _super: e.View,
        constructor: function (e) {
          t.extend(this, t.pick(e || {}, M)),
            n(this, "constructor", arguments),
            this.applyBindings();
        },
        b: function () {
        ...
        applyBindings: function () {
          ...
          t.each(t.result(n, "bindingHandlers") || {}, function (t, e) {
            ...
            (n.model = c(n, p, r, "model")),
            (n.viewModel = c(n, p, r, "viewModel")),
            (n.collection = c(n, p, r, "collection")),
            n.collection &&
              n.collection.view &&
              (n.itemView = n.collection.view),
            i &&
              (t.each(i, function (t, e) {
                i[e] = c(i, p, r, e, e);
              }),
              (n.bindingSources = i)),
            t.each(t.result(n, "computeds") || {}, function (t, e) {
              var i = w(t) ? t : t.get,
                o = t.set,
                r = t.deps;
              p[e] = function (t) {
        ...
        removeBindings: function () {
          if (((this._c = null), this._b))
            for (; this._b.length; ) this._b.pop().dispose();
        },
        remove: function () {
