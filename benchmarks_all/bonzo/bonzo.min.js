...
(function (e, t, n) {
  ...
  function O(e, t, n) {
    var r, i, s;
    if (typeof e == "string") return Q.create(e);
    A(e) && (e = [e]);
    if (n) {
      s = [];
      for (r = 0, i = e.length; r < i; r++) s[r] = V(t, e[r]);
      return s;
    }
    return e;
  }
  ...
  function D(e, t, n) {
    for (var r = 0, i = e.length; r < i; r++)
      A(e[r]) && (D(e[r].childNodes, t, n), t.call(n || e[r], e[r], r, e));
    return e;
  }
  function P(e) {
  ...
  function B(e) {
    e[S]("data-node-uid") || e[E]("data-node-uid", ++g);
    var t = e[S]("data-node-uid");
    return m[t] || (m[t] = {});
  }
  function j(e) {
    var t = e[S]("data-node-uid");
  ...
  function q(e) {
    return (
      (e == "transform" && (e = x.transform)) ||
        (/^transform-?[Oo]rigin$/.test(e) && (e = x.transform + "Origin")),
      e ? P(e) : null
    );
  }
  function R(e, t, n, r) {
    var i = 0,
      s = t || this,
      o = [],
      u = k && typeof e == "string" && e.charAt(0) != "<" ? k(e) : e;
    return (
      _(
        O(u),
        function (e, t) {
  ...
  function U(e, t, n) {
    ...
    i == "static" && (r.css("position", o), (i = o)),
      isNaN(a[0]) && (a[0] = u ? 0 : e.offsetLeft),
      isNaN(a[1]) && (a[1] = u ? 0 : e.offsetTop),
      t != null && (e.style.left = t - s.left + a[0] + w),
      n != null && (e.style.top = n - s.top + a[1] + w);
  }
  function z(e, t) {
    return typeof t == "function" ? t.call(e, e) : t;
  }
  function W(t, n, r) {
    var i = this[0];
    return i
      ? t == null && n == null
        ? ($(i) ? J() : { x: i.scrollLeft, y: i.scrollTop })[r]
        : ($(i)
            ? e.scrollTo(t, n)
            : (t != null && (i.scrollLeft = t), n != null && (i.scrollTop = n)),
          this)
      : this;
  }
  function X(e) {
  ...
  return (
    x.classList
      ...
      : ((p = function (e, t) {
          return M(t).test(e.className);
        }),
        (d = function (e, t) {
          e.className = (e.className + " " + t).trim();
        }),
        (v = function (e, t) {
          e.className = e.className.replace(M(t), " ").trim();
        })),
    (X.prototype = {
      get: function (e) {
        return this[e] || null;
      ...
      html: function (e, t) {
        var n = t ? "textContent" : "innerHTML",
          r = this,
          i = function (t, n) {
            _(O(e, r, n), function (e) {
              t.appendChild(e);
            });
          },
          o = function (r, o) {
            try {
              if (t || (typeof e == "string" && !s.test(r.tagName)))
                return (r[n] = e);
            } catch (u) {}
            i(r, o);
          };
      ...
      clone: function (e) {
        var t = [],
          n,
          r;
        for (r = 0, n = this.length; r < n; r++) t[r] = V(e || this, this[r]);
        return Q(t);
      },
      addClass: function (e) {
        return (
      ...
      css: function (n, r) {
        function o(e, t, n) {
          for (var r in s)
            if (s.hasOwnProperty(r)) {
              (n = s[r]), (t = q(r)) && y.test(n) && !(t in C) && (n += w);
              try {
                e.style[t] = z(e, n);
              } catch (i) {}
            }
        ...
        var i,
          s = n;
        return r === undefined && typeof n == "string"
          ? ((r = this[0]),
            r
              ? r === t || r === e
                ? ((i = r === t ? Q.doc() : Q.viewport()),
                  n == "width" ? i.width : n == "height" ? i.height : "")
                : (n = q(n))
                ? L(r, n)
                : null
              : null)
          : (typeof n == "string" && ((s = {}), (s[n] = r)), this.each(o));
      },
      offset: function (e, n) {
        if (
          !e ||
          ...
          var r = this[0],
            ...
            l =
              s.left + o.x - Math.max(0, i && i.clientLeft, t.body.clientLeft);
      ...
      dim: function () {
        ...
        var e = this[0],
          ...
          i = t
            ...
            : e.offsetHeight;
        return n && this.first().css(n), { height: i, width: r };
      },
      attr: function (e, t) {
        var n = this[0],
          r;
        if (typeof e == "string" || e instanceof String)
          return typeof t == "undefined"
            ? n
              ...
              : null
            : this.each(function (n) {
                i.test(e) ? (n[e] = z(n, t)) : n[E](e, z(n, t));
              });
      ...
      data: function (e, t) {
        ...
        return typeof t == "undefined"
          ? n
            ? ((r = B(n)),
              typeof e == "undefined"
                ? (_(n.attributes, function (e) {
                    (i = ("" + e.name).match(b)) && (r[P(i[1])] = F(e.value));
                  }),
                  r)
                : (typeof r[e] == "undefined" &&
                    (r[e] = F(this.attr("data-" + H(e)))),
                  r[e]))
            : null
          : this.each(function (n) {
              B(n)[e] = t;
      ...
      remove: function () {
        return this.deepEach(j), this.detach();
      },
      empty: function () {
        return this.each(function (e) {
          D(e.childNodes, j);
      ...
      scrollTop: function (e) {
        return W.call(this, null, e, "y");
      },
      scrollLeft: function (e) {
        return W.call(this, e, null, "x");
      },
    }),
    (Q.setQueryEngine = function (e) {
      (k = e), delete Q.setQueryEngine;
    }),
    (Q.aug = function (e, t) {
      for (var n in e) e.hasOwnProperty(n) && ((t || X.prototype)[n] = e[n]);
    }),
    (Q.create = function (e) {
      return typeof e == "string" && e !== ""
        ? (function () {
            if (o.test(e)) return [K(e)];
            var n = e.match(/^\s*<([^\s>]+)/),
