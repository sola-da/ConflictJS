...
!(function (a, b) {
  ...
  function a() {
    ...
    function d(a) {
      if (!c(a))
        throw new TypeError(
          "Invalid type of a first argument, a non-empty string expected."
        );
    ...
    (a.prototype.parseUrl = function (a, b) {
      return angular.isFunction(a)
        ? a(this.name, b)
        : a.replace(/\{part\}/g, this.name).replace(/\{lang\}/g, b);
    }),
      (a.prototype.getTable = function (a, b, c, d, e, f) {
        if (this.tables[a]) return b.when(this.tables[a]);
        var g = this;
        return c(
          angular.extend({ method: "GET", url: this.parseUrl(e, a) }, d)
        ).then(
          function (b) {
    ...
    (this.addPart = function (d, e) {
       ...
       */ (this.setPart = function (d, e, f) {
        if (!c(d))
          throw new TypeError(
            "Couldn't set part.`lang` parameter has to be a string!"
          );
        if (!c(e))
          throw new TypeError(
            "Couldn't set part.`part` parameter has to be a string!"
          );
        ...
        return (
          b(e) || ((g[e] = new a(e)), (g[e].isActive = !1)),
          (g[e].tables[d] = f),
          this
        );
      }),
       ...
       */ (this.$get = [
        ...
        function (h, i, j, k) {
          ...
          var l = function (a) {
            if (!c(a.key))
              throw new TypeError(
                "Unable to load data, a key is not a non-empty string."
              );
            if (!c(a.urlTemplate) && !angular.isFunction(a.urlTemplate))
              throw new TypeError(
            ...
            return (
              angular.forEach(g, function (c) {
                d.push(c.getTable(a.key, j, k, a.$http, a.urlTemplate, b)),
                  (c.urlTemplate = a.urlTemplate);
              }),
              j.all(d).then(
                function () {
                  var b = {};
           ...
           */
          return (
            (l.addPart = function (d, e) {
              if (!c(d))
                throw new TypeError(
                  "Couldn't add part, first arg has to be a string"
                );
              return (
                b(d)
                  ? g[d].isActive ||
                    ((g[d].isActive = !0),
                    h.$emit("$translatePartialLoaderStructureChanged", d))
                  : ((g[d] = new a(d, e)),
                    h.$emit("$translatePartialLoaderStructureChanged", d)),
                l
              );
              ...
              if (b(a)) {
                ...
                if (d) {
                  ...
                  "string" == typeof j &&
                    ...
                    "object" == typeof j &&
                      angular.forEach(g[a].tables, function (b, c) {
            ...
            (l.isPartLoaded = function (a, b) {
              return (
                angular.isDefined(g[a]) && angular.isDefined(g[a].tables[b])
              );
            }),
  ...
  return (
    angular
      ...
      .provider("$translatePartialLoader", a),
    (a.displayName = "$translatePartialLoader"),
