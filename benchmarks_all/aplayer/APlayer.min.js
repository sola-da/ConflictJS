...
!(function (e) {
  var t = (function () {
    function t(e) {
      ...
      (this.playIndex =
        "[object Array]" === Object.prototype.toString.call(e.music) ? 0 : -1),
        (this.option = e),
        (this.audios = []),
        (this.loop = e.loop),
                ...
                for (var d = o.length, u = 0; d > u; u++) {
                  var p = /\[(\d{2}):(\d{2})\.(\d{2,3})]/.exec(o[u]),
                    c =
                      60 * p[1] +
                      parseInt(p[2]) +
                      parseInt(p[3]) / (2 === (p[3] + "").length ? 100 : 1e3);
                  s.push([c, r]);
                }
            }
            s.sort(function (e, t) {
        ...
        (this.updateLrc = function () {
          var e =
            arguments.length <= 0 || void 0 === arguments[0]
              ...
              : arguments[0];
          if (
            a.lrcIndex > a.lrc.length - 1 ||
            e < a.lrc[a.lrcIndex][0] ||
            !a.lrc[a.lrcIndex + 1] ||
            e >= a.lrc[a.lrcIndex + 1][0]
          )
            for (var t = 0; t < a.lrc.length; t++)
              e >= a.lrc[t][0] &&
                (!a.lrc[t + 1] || e < a.lrc[t + 1][0]) &&
                ((a.lrcIndex = t),
                (a.lrcContents.style.transform =
                  "translateY(" + 20 * -a.lrcIndex + "px)"),
                (a.lrcContents.style.webkitTransform =
                  "translateY(" + 20 * -a.lrcIndex + "px)"),
                a.lrcContents
        ...
        (this.event = {});
      for (var n = 0; n < this.eventTypes.length; n++)
      ...
      _createClass(t, [
        {
          ...
          value: function () {
            function t(e) {
              for (
                var t = e.offsetLeft, a = e.offsetParent, i = void 0;
                null !== a;
            ...
            function a(e) {
              for (
                var t = e.offsetTop, a = e.offsetParent, i = void 0;
                null !== a;
            ...
            if (this.option.showlrc) {
              ...
              if (1 === this.option.showlrc)
                if (this.multiple)
                  for (s = 0; s < this.option.music.length; s++)
                    n.push(this.option.music[s].lrc);
            ...
            (this.element.innerHTML = l),
              ...
              (this.element.getElementsByClassName(
                ...
                this.element.getElementsByClassName("aplayer-time")[0]
                  .offsetWidth +
                5 +
                "px"),
              this.option.narrow &&
                    ...
                    var e = i.element
                      ...
                      t = function (t) {
                        e[t].addEventListener("click", function () {
                          ...
                          a !== i.playIndex && i.setMusic(a),
                            i.isMobile ? i.pause() : i.play();
                        });
                      },
                      a = 0;
                    a < i.option.music.length;
                    a++
                  )
                    t(a);
                })(),
              ...
              (this.thumb =
                this.element.getElementsByClassName("aplayer-thumb")[0]),
              (this.bar =
                this.element.getElementsByClassName("aplayer-bar")[0]);
            var o = void 0;
            this.bar.addEventListener("click", function (e) {
              var a = e || window.event;
              o = i.bar.clientWidth;
              var s = (a.clientX - t(i.bar)) / o;
              i.updateBar("played", s, "width"),
                (i.element.getElementsByClassName(
                  "aplayer-ptime"
                )[0].innerHTML = i.secondToTime(s * i.audio.duration)),
                (i.audio.currentTime =
            ...
            this.element
              ...
              .addEventListener("click", function (e) {
                ...
                (s = s > 0 ? s : 0),
                  (s = 1 > s ? s : 1),
                  i.updateBar("volume", s, "height"),
                  (i.audio.volume = s),
                  i.audio.muted && (i.audio.muted = !1),
                  1 === s
            ...
            m.addEventListener("click", function () {
              i.loop
                ? (m.classList.add("aplayer-noloop"),
                  (i.loop = !1),
                  (i.audio.loop = i.multiple ? !1 : i.loop))
                : (m.classList.remove("aplayer-noloop"),
                  (i.loop = !0),
                  (i.audio.loop = i.multiple ? !1 : i.loop));
            }),
              this.multiple &&
                this.element
                  ...
                  .addEventListener("click", function () {
                    ...
                    e.classList.contains("aplayer-list-hide")
                      ? e.classList.remove("aplayer-list-hide")
                      : e.classList.add("aplayer-list-hide");
                  }),
              this.setMusic(0),
              e.push(this);
          },
        },
        {
          ...
          value: function (e) {
            ...
            if (
              ...
              (this.multiple && !this.audios[a]) || -1 === this.playIndex
                ? ((this.audio = document.createElement("audio")),
                  ...
                  this.multiple && (this.audios[a] = this.audio))
