...
!(function (a) {
  a.emojioneList = {
    ...
    ":ve:": { unicode: ["1f1fb-1f1ea"], isCanonical: !1 },
  ...
  (a.shortnames = c.join("|")),
    ...
    (a.shortnameToUnicode = function (b) {
      ...
      return (
        (b = b.replace(a.regShortNames, function (b) {
          return "undefined" != typeof b && "" !== b && b in a.emojioneList
            ? ((c = a.emojioneList[b].unicode[0].toUpperCase()), a.convert(c))
            : b;
        })),
        a.ascii &&
    ...
    (a.shortnameToImage = function (b) {
      ...
      return (
        ...
        a.ascii &&
          (b = b.replace(a.regAscii, function (b, f, g, h) {
            return "undefined" != typeof h &&
              "" !== h &&
              a.unescapeHTML(h) in a.asciiList
              ? ((h = a.unescapeHTML(h)),
                (d = a.asciiList[h]),
                (e = a.unicodeAlt
    ...
    (a.unicodeToImage = function (b) {
      var c, d, e;
      if (!a.unicodeAlt || a.sprites) var f = a.mapUnicodeToShort();
      return (b = b.replace(a.regUnicode, function (b) {
        return "undefined" != typeof b && "" !== b && b in a.jsEscapeMap
          ? ((d = a.jsEscapeMap[b]),
            (e = a.unicodeAlt ? a.convert(d.toUpperCase()) : f[d]),
            (c =
              "png" === a.imageType
                ? a.sprites
                  ? '<span class="emojione emojione-' +
