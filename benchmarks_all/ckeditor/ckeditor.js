...
(function () {
  (window.CKEDITOR && window.CKEDITOR.dom) ||
          ...
          on: function (b, d, e, l, f) {
            ...
            if (0 > g.getListenerIndex(d)) {
              ...
              for (var t = g.length - 1; 0 <= t; t--)
                if (g[t].priority <= f)
                  return g.splice(t + 1, 0, h), { removeListener: k };
              g.unshift(h);
            }
          ...
          fire: (function () {
            ...
            return function (f, h, k) {
              ...
              if (g) {
                var t = g.listeners;
                if (t.length)
                  for (var t = t.slice(0), r, q = 0; q < t.length; q++) {
                    if (g.errorProof)
                      try {
      ...
      CKEDITOR.tools = {
        ...
        parseCssText: function (a, g, f) {
          ...
          f &&
            ...
            (a = CKEDITOR.tools.convertRgbToHex(
      ...
      getIndex: function (a) {
        ...
        do
          (a &&
            ...
            (m || b(c))) ||
            (d++, (m = c.nodeType == CKEDITOR.NODE_TEXT));
      ...
      CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {
        ...
        getDocumentPosition: function (a) {
          ...
          if (document.documentElement.getBoundingClientRect) {
            var m = this.$.getBoundingClientRect(),
              ...
              p = l.clientLeft || d.$.clientLeft || 0,
              w = !0;
            CKEDITOR.env.ie &&
              ((w = g.getDocumentElement().contains(this)),
        ...
        scrollIntoParent: function (a, b, c) {
          ...
          function v(a, b) {
            ...
            c = a.getWindow();
            c.equals(b) ||
              ((c = v(CKEDITOR.dom.element.get(c.$.frameElement), b)),
              (g.x += c.x),
              (g.y += c.y));
            return g;
          }
          ...
          a instanceof CKEDITOR.dom.window &&
            (a = w ? e.getBody() : e.getDocumentElement());
          e = a.getWindow();
          d = v(this, e);
          var z = v(a, e),
            B = this.$.offsetHeight;
        ...
        copyAttributes: function (a, b) {
          ...
          for (var g = 0; g < c.length; g++) {
            var d = c[g],
              ...
              m;
            if (!(e in b))
              if ("checked" == e && (m = this.getAttribute(e)))
                a.setAttribute(e, m);
              else if (!CKEDITOR.env.ie || this.hasAttribute(e))
                (m = this.getAttribute(e)),
                  null === m && (m = d.nodeValue),
                  a.setAttribute(e, m);
          }
          "" !== this.$.style.cssText &&
      ...
      function e(a, b, c, d, f) {
        ...
        function h() {
          var a,
            b,
            g,
            c = Math.min(E.length, N.length);
          for (a = 0; a < c; a++)
            if (((b = E[a]), (g = N[a]), !b.equals(g))) return a;
          return a - 1;
        }
        function e() {
          var b = R - 1,
        ...
        var y = a.startContainer,
          ...
          H,
          K;
        if (u && D.type == CKEDITOR.NODE_TEXT && y.equals(D))
          ...
          for (
            ...
            W = M.getNext();
            for (
              J != P || (M.equals(N[J]) && P < T)
                ? b && (Y = O.append(M.clone(0, f)))
                : C
                ? k(M, O, !1, F)
                : H && O.append(a.document.createText(M.substring(x)));
              W;
          ...
          O = c;
          for (J = R; J <= T; J++)
            if (((c = N[J]), (W = c.getPrevious()), c.equals(E[J])))
              b && (O = O.getChild(0));
            else {
              J != T || (c.equals(E[J]) && T < P)
                ? b && (Y = O.append(c.clone(0, f)))
                : G
                ? k(c, O, !1, I)
                : K && O.append(a.document.createText(c.substring(0, A)));
        ...
        return function (f) {
          return c(f) || b(f)
            ...
            : (f.type == CKEDITOR.NODE_TEXT &&
              ...
              (f.type == CKEDITOR.NODE_ELEMENT && !f.is(m))
            ? !1
            : !0;
        };
      }
        ...
        createBookmark2: (function () {
          function a(b) {
            ...
            f =
              ...
              k == f.getChildCount()
                ? 0
                : f.getChild(k - 1).type == CKEDITOR.NODE_TEXT &&
                  f.getChild(k).type == CKEDITOR.NODE_TEXT;
        ...
        enlarge: function (a, b) {
          ...
          switch (a) {
            ...
            case CKEDITOR.ENLARGE_ELEMENT:
              ...
              A.type == CKEDITOR.NODE_TEXT
                ? (G &&
                    ...
                    (x = !!A)),
                  A && ((y = A.getPrevious()) || (u = A.getParent())))
                : (G && (y = A.getChild(G - 1) || A.getLast()), y || (u = A));
              for (u = c(u); u || y; ) {
                if (u && !y) {
                  !D && u.equals(h) && (D = !0);
                  if (f ? u.isBlockBoundary() : !e.contains(u)) break;
                  (x && "inline" == u.getComputedStyle("display")) ||
                    ((x = !1), D ? (m = u) : this.setStartBefore(u));
                  y = u.getPrevious();
                }
                for (; y; )
                    ...
                    if (y.type == CKEDITOR.NODE_TEXT)
                      ...
                      if (x && CKEDITOR.dtd.$removeEmpty[y.getName()]) {
                        ...
                        if (d.test(C)) y = null;
                          ...
                          for (
                            var G = y.$.getElementsByTagName("*"), F = 0, I;
                            (I = G[F++]);
              ...
              for (; u || y; ) {
                if (u && !y) {
                  ...
                  if (f ? u.isBlockBoundary() : !e.contains(u)) break;
                  (x && "inline" == u.getComputedStyle("display")) ||
                    ((x = !1), D ? (l = u) : u && this.setEndAfter(u));
                  y = u.getNext();
                }
                for (; y; ) {
                  A = !1;
            ...
            case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:
              ...
              var H,
                K,
                E = CKEDITOR.dom.walker.blockBoundary(
      ...
      a.prototype = {
        getNextParagraph: function (a) {
          ...
          if (!this._.started) {
            ...
            e = v.startPath();
            var p = v.endPath(),
              w = !v.collapsed && c(v, e.block),
              z = !v.collapsed && c(v, p.block, 1);
            ...
            v.collapsed ||
              ((e = new CKEDITOR.dom.walker(v.clone())),
              ...
              (e.evaluator = p),
              (e = e.previous()),
              (this._.lastNode = e.getNextSourceNode(!0, null, v.root)),
              this._.lastNode &&
          ...
          for (this._.nextNode = null; p; ) {
            var w = 0,
              ...
              B = p.type != CKEDITOR.NODE_ELEMENT,
              u = 0;
            if (B)
              p.type == CKEDITOR.NODE_TEXT && d.test(p.getText()) && (B = 0);
            else {
              var y = p.getName();
              if (
                ...
                p.isBlockBoundary(this.forceBrBreak && !z && { br: 1 })
              ) {
                if ("br" == y) B = 1;
                else if (!e && !p.getChildCount() && "hr" != y) {
                  g = p;
                  l = p.equals(v);
                  break;
                }
          ...
          r &&
            ...
            ("br" == r.getName()
              ? r.remove()
              : r.getLast() &&
                "br" == r.getLast().$.nodeName.toLowerCase() &&
                r.getLast().remove());
          q &&
            (r = g.getLast()) &&
            r.type == CKEDITOR.NODE_ELEMENT &&
            "br" == r.getName() &&
            (!CKEDITOR.env.needsBrFiller || r.getPrevious(m) || r.getNext(m)) &&
            r.remove();
          this._.nextNode ||
            (this._.nextNode =
              l || g.equals(v) || !v ? null : this._getNextSourceNode(g, 1, v));
          return g;
        },
    ...
    (function () {
      function a(a, b, c, d, f) {
        ...
        for (g in b) {
          ...
          for (m in K) {
            ...
            for (n in B)
              "!" == n.charAt(0) &&
                ((n = n.slice(1)), p.push(n), (v[n] = !0), (D = !1));
        ...
        for (d = a.length; c < d; ++c) {
          ...
          if (!0 === g.elements || null === g.elements)
            ...
            for (q in ((k = g.elements), delete g.elements, k))
              if (b[q]) b[q][e ? "unshift" : "push"](g);
              else b[q] = [g];
        }
      }
      function e(a, c, d, g) {
      ...
      function r(a, b, d, f) {
        ...
        if (f.doCallbacks && a.elementCallbacks) {
          a: {
            ...
            for (var h = 0, m = k.length, u; h < m; ++h)
              if ((u = k[h](b))) {
                k = u;
                break a;
              }
        ...
        if (f.doFilter) {
          a: {
            ...
            if (a || k) {
              ...
              if (m) for (E = 0, B = m.length; E < B; ++E) c(m[E], b, l);
              if (a) for (E = 0, B = a.length; E < B; ++E) e(a[E], b, l, u);
              if (k) for (E = 0, B = k.length; E < B; ++E) e(k[E], b, l, u);
              a = l;
            } else a = null;
          }
      ...
      function u(a, b, c) {
        ...
        if (G.$empty[d] || !a.children.length)
          ...
          if ("br" == b)
            ...
            b: {
              f = G[b];
              for (var g = 0, k = d.length, e; g < k; ++g)
                if (
              ...
              for (
                ...
                (e = d[--k]),
                  ...
                  (e.type == CKEDITOR.NODE_TEXT ||
                    (e.type == CKEDITOR.NODE_ELEMENT && G.$inline[e.name]))
                    ? (h ||
      ...
      function D(a, b) {
        ...
        for (g in d)
          if ("class" == g)
            for (
              c = d[g].split(/\s+/), k = a.classes.join("|");
              (h = c.pop());
      ...
      CKEDITOR.filter.prototype = {
        ...
        applyTo: function (a, b, c, d) {
                ...
                a: {
                  ...
                  if (e)
                    for (l = 0; l < e.length; ++l)
                      if ((E = d.match(e[l])) && E[0].length == d.length) {
                        c = !0;
                        break a;
                      }
          ...
          for (; (l = a.pop()); )
            if (((c = l.el), c.parent))
              switch (((E = G[c.parent.name] || G.span), l.check)) {
                case "it":
            ...
            for (f = 0; f < a.length; ++f) {
              ...
              for (e = 0; e < b.length; ++e)
                (k = b[e]),
                  ...
                  m instanceof CKEDITOR.style && (m = A(m)),
                  c.push({
                    check: h == g ? null : h,
                    left: m,
          ...
          if ("string" == typeof a) {
            ...
            (d = a.getDefinition()),
              ...
              f && !CKEDITOR.tools.isEmpty(f)
                ? ((f = F(f)), (h.style = CKEDITOR.tools.writeCssText(f, !0)))
                : (f = {}),
              (f = {
                name: d.element,
                attributes: h,
        ...
        transform: function (a, b) {
          if ("string" == typeof b) a.name = b;
            ...
            for (g in f)
              if ("class" == g)
                for (
                  c = a.classes.join("|"), k = f[g].split(/\s+/);
                  (h = k.pop());
                      ...
                      (CKEDITOR.env.ie && 11 > CKEDITOR.env.version
                        ? (f.$.onreadystatechange = function () {
                            if (
                              ...
                              (f.$.onreadystatechange = null), t(b, !0);
                          })
                        : ((f.$.onload = function () {
                            setTimeout(function () {
                              t(b, !0);
              ...
              a.call(
                ...
                function (a) {
                  ...
                  for (f in a) {
                    ...
                    if (!e[f]) {
                      if (n.icons)
                        for (var r = n.icons.split(","), q = r.length; q--; )
    ...
    (function () {
        ...
        CKEDITOR.plugins.load(c.split(","), function (c) {
          ...
          for (var k in c) {
            ...
            m &&
              !a.lang[k] &&
              (m.split && (m = m.split(",")),
              0 <= CKEDITOR.tools.indexOf(m, a.langCode)
                ? (u = a.langCode)
                : ((u = a.langCode.replace(/-.*/, "")),
                  (u =
                    u != a.langCode && 0 <= CKEDITOR.tools.indexOf(m, u)
                      ? u
                      : 0 <= CKEDITOR.tools.indexOf(m, "en")
                      ? "en"
                      : m[0])),
              h.langEntries && h.langEntries[u]
                ? ((a.lang[k] = h.langEntries[u]), (u = null))
                : g.push(CKEDITOR.getUrl(h.path + "lang/" + u + ".js")));
            f.push(u);
            d.push(h);
          }
            ...
            for (
              ...
              for (var e = 0; e < d.length; e++) {
                ...
                0 === g &&
                  ...
                  k.lang &&
                  k.langEntries &&
                  (a.lang[k.name] = k.langEntries[f[e]]);
                if (k[c[g]]) k[c[g]](a);
              }
      ...
      CKEDITOR.tools.extend(CKEDITOR.editor.prototype, {
        ...
        getSelectedHtml: function (a) {
          ...
          for (
            var d = new CKEDITOR.dom.documentFragment(), f, g, e, k = 0;
            k < c.length;
            k++
          ) {
            var h = c[k],
            ...
            m.getName && "tr" == m.getName()
              ? (f ||
                  ((f = m.getAscendant("table").clone()),
                  f.append(m.getAscendant("tbody").clone()),
                  d.append(f),
                  (f = f.findOne("tbody"))),
                (g && g.equals(m)) || ((g = m), (e = m.clone()), f.append(e)),
      ...
      CKEDITOR.htmlParser.prototype = {
        ...
        parse: function (b) {
          for (var c, d, m = 0, l; (c = this._.htmlPartsRegex.exec(b)); ) {
            d = c.index;
            if (d > m)
              if (((m = b.substring(m, d)), l)) l.push(m);
              else this.onText(m);
    ...
    (function () {
      ...
      CKEDITOR.htmlParser.fragment.fromHtml = function (m, l, f) {
          ...
          if (0 < p.length)
            for (var c = 0; c < p.length; c++) {
              var d = p[c],
                f = d.name,
                g = CKEDITOR.dtd[f],
                e = z.name && CKEDITOR.dtd[z.name];
              (e && !e[f]) || (a && g && !g[a] && CKEDITOR.dtd[a])
                ? f == z.name && (n(z, z.parent, 1), c--)
                : (b || (k(), (b = 1)),
                  (d = d.clone()),
                  (d.parent = z),
                  (z = d),
        ...
        function n(b, c, d) {
          ...
          var e = z;
          void 0 === b.previous &&
            (t(c, b) && ((z = c), q.onTagOpen(f, {}), (b.returnPoint = c = z)),
            g(b),
            ...
            if ("br" == d) w.push(f);
              ...
              for (
                ...
                !((m = (g = z.name)
                  ...
                  : c),
                f.isUnknown || z.isUnknown || m[d]);

              )
                if (z.isOptionalClose) q.onTagClose(g);
                ...
                else if (g in e && !r(d, g))
                  !f.returnPoint && (f.returnPoint = z), (z = z.parent);
                else if ((g in CKEDITOR.dtd.$inline && p.unshift(z), z.parent))
                  n(z, z.parent, 1);
                else {
                  f.isOrphan = 1;
                  break;
        ...
        q.onText = function (a) {
          if (
            !((z._.hasInlineStarted && !w.length) || u || B) &&
          ...
          var b = z.name,
            g = b
              ? CKEDITOR.dtd[b] ||
                (z._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span)
              : c;
          if (!B && !g["#"] && b in e) q.onTagOpen(d[b] || ""), q.onText(a);
          else {
            k();
            h();
            u || B || (a = a.replace(/[\t\r\n ]{2,}|[\t\r\n]/g, " "));
    ...
    (function () {
      ...
      a.prototype = {
        ...
        addMany: function (a, c, d) {
          for (var e = [this.findIndex(c), 0], l = 0, f = a.length; l < f; l++)
        ...
        execOnName: function (a, c) {
          for (var d = 0, e = this.rules, l = e.length, f; c && d < l; d++)
            (f = e[d]),
          ...
          return function (f) {
            if (f.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
              var e = [],
                ...
                l;
              if (h)
                for (k(h, 1) && e.push(h); h; )
                  m(h) &&
                    (u = c(h)) &&
                    k(u) &&
                    ((l = c(u)) && !m(l)
                      ? e.push(u)
                      : (g(E).insertAfter(u), u.remove())),
                    (h = h.previous);
        ...
        function k(a, b) {
          ...
          return a.type == CKEDITOR.NODE_TEXT &&
            ...
            (c.index &&
              ...
              (a.value = c[0])),
            (!CKEDITOR.env.needsBrFiller && E && (!b || a.parent.name in B)) ||
              (!E && (((c = a.previous) && "br" == c.name) || !c || m(c))))
            ? !0
            : !1;
        }
        var h = { elements: {} },
          E = "html" == f,
          B = CKEDITOR.tools.extend({}, u),
          n;
        for (n in B) "#" in z[n] || delete B[n];
        for (n in B) h.elements[n] = e(E, a.config.fillEmptyBlocks);
        h.root = e(E, !1);
    ...
    (function () {
      ...
      CKEDITOR.inlineAll = function () {
        ...
        for (b in CKEDITOR.dtd.$editable)
          for (
            var c = CKEDITOR.document.getElementsByTag(b), d = 0, m = c.count();
            d < m;
            d++
          )
            (a = c.getItem(d)),
      ...
      CKEDITOR.editor.prototype.setMode = function (a, b) {
        ...
        if (a != e.mode && l && l[a]) {
          ...
          if (e.mode) {
            ...
            "source" == e.mode &&
              l == h &&
              (e.fire("lockSnapshot", { forceUpdate: !0 }), (k = 1));
    ...
    (function () {
                  ...
                  (f = m(b))
                    ...
                    : e.collapsed &&
                      ...
                      e[c ? "checkStartOfBlock" : "checkEndOfBlock"]()
                        ...
                        : k.blockLimit &&
                          k.blockLimit.is("td") &&
                          (u = k.blockLimit.getAscendant("table")) &&
                          e.checkBoundaryOfElement(
                            u,
                            c ? CKEDITOR.START : CKEDITOR.END
                          ) &&
                          (n = u[c ? "getPrevious" : "getNext"](g))
                        ? (a.fire("saveSnapshot"),
                          e["moveToElementEdit" + (c ? "End" : "Start")](n),
                          e.checkStartOfBlock() && e.checkEndOfBlock()
                            ? n.remove()
      ...
      v = (function () {
        ...
        function d(b, c) {
          ...
          for (u && f.push(" "); h < e; h++)
            (k = g.getItem(h)),
              a(k) && !k.is(l) ? (f = f.concat(d(k, c))) : f.push(k);
          u && f.push(" ");
          return f;
        }
        function g(b) {
        ...
        function k(b, c, d, f) {
          ...
          (e = new CKEDITOR.dom.walker(g).next()) &&
            ...
            f.contains(e) &&
            e.isIdentical(h) &&
            (e.moveChildren(h), e.remove(), k(b, c, d, f));
        }
        function h(b, c) {
          function d(b, c) {
            if (
        ...
        delete p.br;
        return function (n, E, q, v) {
          var r = n.editor,
            z = !1;
          "unfiltered_html" == E && ((E = "html"), (z = !0));
          if (!v.checkReadOnly()) {
            var t =
              new CKEDITOR.dom.elementPath(v.startContainer, v.root)
                .blockLimit || v.root;
            n = {
              type: E,
              dontFilter: z,
            ...
            n.endPath = t = new CKEDITOR.dom.elementPath(E.endContainer);
            if (!E.collapsed) {
            ...
            for (; (M = g(E)) && a(M) && M.isBlockBoundary() && z.contains(M); )
              E.moveToPosition(M, CKEDITOR.POSITION_BEFORE_END);
            k(E, n.blockLimit, z, t);
            F && (E.setEndBefore(F), E.collapse(), F.remove());
            F = E.startPath();
            if ((r = F.contains(e, !1, 1)))
              E.splitElement(r),
                (n.inlineStylesRoot = r),
                (n.inlineStylesPeak = F.lastElement);
            F = E.createBookmark();
            ...
            if ((F = q)) {
              ...
              if ("text" == n.type && n.inlineStylesRoot) {
                ...
                E = M.getDocument().createText("{cke-peak}");
                for (v = n.inlineStylesRoot.getParent(); !M.equals(v); )
                  (E = E.appendTo(M.clone())), (M = M.getParent());
                q = E.getOuterHtml().split("{cke-peak}").join(q);
              }
              ...
              if (
                ...
                a: {
                  ...
                  if (
                    ...
                    F = 0;
                    for (v = U.count(); F < v; F++)
                      if (((E = U.getItem(F)), !E.is(p))) break a;
            ...
            if (F) {
                ...
                if ((L = t.isLineBreak)) {
                  ...
                  t.hasBlockSibling
                    ...
                    : (X = L.startContainer.getAscendant(m.$block, 1)) &&
                      X.is({ div: 1, p: 1 })
                    ? ((ea = X.getPosition(V)),
                      ea == CKEDITOR.POSITION_IDENTICAL ||
                      ea == CKEDITOR.POSITION_CONTAINS
                        ? (L = 0)
                        : ((V = L.splitElement(X)),
                          L.moveToPosition(V, CKEDITOR.POSITION_AFTER_START),
                          (L = 1)))
                    : (L = 0);
                }
                if (L) q = 0 < v;
                  ...
                  !t.isBlock &&
                    ...
                    (aa = f(n.editor)) &&
                    ((aa = F.createElement(aa)),
                    aa.appendBogus(),
                    J.insertNode(aa),
                    CKEDITOR.env.needsBrFiller &&
                      (S = aa.getBogus()) &&
                      S.remove(),
                    J.moveToPosition(aa, CKEDITOR.POSITION_BEFORE_END));
                  ...
                  t.lastNotAllowed &&
                    v < E.length - 1 &&
                    ((da = W ? z : da) &&
                      J.setEndAt(da, CKEDITOR.POSITION_AFTER_START),
                    (r = 0));
                  J.collapse();
                }
              }
              ...
              S &&
                ((q = !0),
                (L = E[0].node),
                J.setStartAt(L, CKEDITOR.POSITION_BEFORE_START),
                J.setEndAt(L, CKEDITOR.POSITION_AFTER_END));
              n.dontMoveCaret = q;
            ...
            for (ba = S.createBookmark(); (Q = n.zombies.pop()); )
              Q.getParent() &&
                ((aa = S.clone()),
                aa.moveToElementEditStart(Q),
                aa.removeEmptyBlocksAtEnd());
            if (da)
              for (; (Q = da.pop()); )
                CKEDITOR.env.needsBrFiller
                  ? Q.appendBogus()
        ...
        return {
          list: {
            detectMerge: function (a, b) {
              ...
              a.mergeList =
                e && k && e.getParent().equals(k.getParent()) && !e.equals(k);
              a.mergeListItems =
                f.block &&
                g.block &&
                f.block.is(CKEDITOR.dtd.$listItem) &&
                ...
                if (e && k && a.equals(k))
                  ...
                  if ((l = !e))
                    l =
                      ...
                      (!k || b(a, k)) &&
                      (!h || b(a, h));
                  l && ((g = c.clone()), g.selectNodeContents(a), f.push(g));
                }
              };
              e.lastForward();
                ...
                if (l || m)
                  l && m && b(l, m)
                    ...
                    ? m ||
                      ((f.tableSurroundingRange = k),
                      k.setStartAt(l, CKEDITOR.POSITION_AFTER_END),
                      e.setEndAt(l, CKEDITOR.POSITION_AFTER_END))
                    : ((f.tableSurroundingRange = k),
                      k.setEndAt(m, CKEDITOR.POSITION_BEFORE_START),
                      e.setStartAt(m, CKEDITOR.POSITION_AFTER_START)),
                    (f.tableContentsRanges = h ? h : a(e));
              },
      ...
      function g(a) {
        for (var b = 0; b < a.length; b++) {
          ...
          if (!c.collapsed) {
            ...
            f &&
              f.type == CKEDITOR.NODE_TEXT &&
              (e ? k.setEndAfter(f) : k.setEndBefore(f));
          ...
          var a = v
            ? (function () {
                ...
                var b = function (b, c) {
                  ...
                  return {
                    container: w,
                    offset: 0 < n ? -h : w.nodeValue.length + h,
                  };
                };
                return function () {
    ...
    (function () {
      ...
      function b(c) {
        ...
        if (c.collapsed)
          ...
          for (
            z.getPosition(r) == CKEDITOR.POSITION_FOLLOWING && (z = 0);
            z;

          ) {
            m = !1;
            if (z.equals(r)) (z = null), (m = !0);
            else {
              ...
              if (t && l && CKEDITOR.dtd.$block[B])
                for (
                  ...
                  var A = x[G],
                    ga = CKEDITOR.filter.instances[A.data("cke-filter")];
                  if (ga ? ga.check(this) : 1)
              ...
              if (x)
                if (
                  ...
                  (G = k),
                  !A ||
                    (!(A.getDtd() || CKEDITOR.dtd.span)[C] && !G) ||
                  ...
                  if (
                    ...
                    B == CKEDITOR.NODE_TEXT ||
                      t ||
                      (B == CKEDITOR.NODE_ELEMENT && !z.getChildCount()))
                  ) {
                    for (
                      var B = z, fa;
                      (m = !B.getNext(F)) &&
                      ((fa = B.getParent()), n[fa.getName()]) &&
                      e(fa, v, h, K);
              ...
              for (
                ...
                if (y.getName() == g) {
                  for (I in h.attributes)
                    !C[I] &&
                      (ha = y.getAttribute(Z)) &&
                      (m.getAttribute(I) == ha ? (x[I] = 1) : (C[I] = 1));
                  for (Z in h.styles)
                    !A[Z] &&
                      (ha = y.getStyle(Z)) &&
                      (m.getStyle(Z) == ha ? (B[Z] = 1) : (A[Z] = 1));
                }
                y = y.getParent();
              }
        ...
        for (var g in b)
          if (g != this.element)
            for (c = a.getElementsByTag(g), f = c.count() - 1; 0 <= f; f--)
              (d = c.getItem(f)), d.isReadOnly() || v(d, b[g]);
      }
      function v(a, b, c) {
        if ((b = b && b.attributes))
      ...
      CKEDITOR.style.prototype = {
        apply: function (a) {
          if (a instanceof CKEDITOR.dom.document)
            return D.call(this, a.getSelection());
          if (this.checkApplicable(a.elementPath(), a)) {
            var b = this._.enterMode;
            b || (this._.enterMode = a.activeEnterMode);
            D.call(this, a.getSelection(), 0, a);
            this._.enterMode = b;
          }
        },
        remove: function (a) {
          if (a instanceof CKEDITOR.dom.document)
            return D.call(this, a.getSelection(), 1);
          if (this.checkApplicable(a.elementPath(), a)) {
            var b = this._.enterMode;
            b || (this._.enterMode = a.activeEnterMode);
            D.call(this, a.getSelection(), 1, a);
            this._.enterMode = b;
          }
        },
                ...
                if ("_length" != h) {
                  ...
                  if ("style" == h)
                    a: {
                      ...
                      "string" == typeof f &&
                        (f = CKEDITOR.tools.parseCssText(f, !0));
                      e = void 0;
                      for (e in d)
                        if (
                          !(e in f) ||
    ...
    CKEDITOR.tools.extend(CKEDITOR.dom.text.prototype, {
      ...
      split: function (a) {
        ...
        e.childNodes.length == b &&
          (a >= c
            ? ((m = d.createText("")), m.insertAfter(this))
            : ((a = d.createText("")), a.insertAfter(m), a.remove()));
        return m;
      },
        ...
        setUiColor: function (a) {
          ...
          return (this.setUiColor = function (a) {
            ...
            var c = CKEDITOR.skin.chameleon,
              ...
              k = "";
            "function" == typeof c &&
              ((e = c(this, "editor")), (k = c(this, "panel")));
            a = [[h, a]];
            d([b], e, a);
            d(f, k, a);
          }).call(this, a);
    ...
    (CKEDITOR.skin.chameleon = (function () {
      ...
      return function (c, d) {
        var m = c.uiColor,
          m = {
            id: "." + c.id,
            defaultBorder: a(m, -0.1),
            defaultGradient: e(a(m, 0.9), m),
            lightGradient: e(a(m, 1), a(m, 0.7)),
            mediumGradient: e(a(m, 0.8), a(m, 0.5)),
            ckeButtonOn: e(a(m, 0.6), a(m, 0.7)),
            ckeResizer: a(m, -0.4),
            ckeToolbarSeparator: a(m, 0.5),
            ckeColorauto: a(m, 0.8),
            dialogBody: a(m, 0.7),
            dialogTabSelected: e("#FFFFFF", "#FFFFFF"),
            dialogTabSelectedBorder: "#FFF",
            elementsPathColor: a(m, -0.6),
            elementsPathBg: m,
            menubuttonIcon: a(m, 0.5),
            menubuttonIconHover: a(m, 0.3),
          };
              ...
              if (!(3 > arguments.length)) {
                ...
                CKEDITOR.ui.dialog.labeledElement.call(
                  ...
                  function () {
                    ...
                    for (b in l)
                      a.push(
                        b + '\x3d"' + CKEDITOR.tools.htmlEncode(l[b]) + '" '
                      );
                    a.push(
                      "\x3e",
                  ...
                  function () {
                    for (
                      ...
                      var w = c.items[m],
                        ...
                        x = [];
                      e._["default"] == B && (D.checked = "checked");
                      l(u);
                      l(z);
    ...
    (function () {
      ...
      function m(a) {
        var b = CKEDITOR.dom.element.createFromHtml(
            CKEDITOR.addTemplate("dialog", v).output({
      ...
      function k(a) {
        function b(c) {
          ...
          a.move(
            f.x + h[3] < g
              ? -h[3]
              : f.x - h[1] > m.width - k.width - g
              ? m.width - k.width + ("rtl" == e.lang.dir ? 0 : h[1])
              : f.x,
            f.y + h[0] < g
              ? -h[0]
              : f.y - h[2] > m.height - k.height - g
      ...
      function g(a) {
        function b(c) {
          var n = "rtl" == e.lang.dir,
            ...
            w = l.height,
            q =
              p + (c.data.$.screenX - m.x) * (n ? -1 : 1) * (a._.moved ? 1 : 2),
            z = w + (c.data.$.screenY - m.y) * (a._.moved ? 1 : 2),
      ...
      CKEDITOR.dialog = function (b, f) {
        ...
        if (b._.removeDialogTabs && (B = b._.removeDialogTabs[f]))
          for (r = 0; r < B.length; r++) q.removeContents(B[r]);
          ...
          function () {
            ...
            b.config.dialog_startupFocusTab && a
              ...
              : this._.hasFocus ||
                ...
                q.onFocus ? (a = q.onFocus.call(this)) && a.focus() : l(1));
          },
          this,
          null,
          4294967295
        ...
        CKEDITOR.ui.dialog = {
          uiElement: function (a, b, c, d, f, e, g) {
            if (!(4 > arguments.length)) {
              ...
              b.align &&
                ((q = b.align),
                (m["margin-left"] = "left" == q ? 0 : "auto"),
                (m["margin-right"] = "right" == q ? 0 : "auto"));
              for (p in m) w.push(p + ":" + m[p]);
              b.hidden && w.push("display:none");
              for (p = w.length - 1; 0 <= p; p--) "" === w[p] && w.splice(p, 1);
              0 < w.length &&
                (l.style = (l.style ? l.style + "; " : "") + w.join("; "));
              for (p in l)
                k.push(p + '\x3d"' + CKEDITOR.tools.htmlEncode(l[p]) + '" ');
          ...
          if (d) {
            ...
            if (b == CKEDITOR.TRISTATE_OFF) {
              ...
              for (f = 0; f < l.length; f++)
                (b = l[f]), (h = h.getCommonAncestor(b.getParent()));
              for (
              ...
              for (; 0 < d.length; )
                if (((b = d.shift()), "blockquote" == b.getName())) {
                  for (
                    ...
                    f.append(b.getFirst().remove()), l.push(f.getLast());
                  f.replace(b);
                } else l.push(b);
              d = a.document.createElement("blockquote");
              for (d.insertBefore(l[0]); 0 < l.length; )
                (b = l.shift()), d.append(b);
                ...
                (k = f.shift()),
                  ...
                  k.getPrevious()
                    ? k.getNext()
                      ...
                      : k.remove().insertAfter(d)
                    : k.remove().insertBefore(d),
    ...
    (function () {
      ...
      function e(b) {
        ...
        function y(c) {
          ...
          f && A.canClipboardApiBeTrusted(d.dataTransfer, b)
            ? (c.data.preventDefault(),
              setTimeout(function () {
                a(b, d);
              }, 0))
    ...
    (function () {
      function a(a, c, d, m, l) {
        ...
        var f = e[l];
        f ||
          ((f = e[l] = new CKEDITOR.ui.panel(c, m)),
          (f.element = d.append(
        ...
        proto: {
          ...
          showBlock: function (a, c, d, e, l, f) {
            ...
            var n = this.element,
              ...
              q = c.getDocumentPosition(t),
              t = r ? r.getDocumentPosition(t) : { x: 0, y: 0 },
              v = "rtl" == this._.dir,
              p = q.x + (e || 0) - t.x,
              w = q.y + (l || 0) - t.y;
            !v || (1 != d && 4 != d)
              ? v || (2 != d && 3 != d) || (p += c.$.offsetWidth - 1)
              : (p += c.$.offsetWidth);
        ...
        proto: {
          ...
          show: function (b, c, e, f) {
            ...
            if (!g) {
              ...
              t["rtl" == k.lang.dir ? 37 : 39] = CKEDITOR.env.ie
                ? "mouseup"
                : "click";
    ...
    (function () {
      function a(a, b) {
        ...
        g.onClick = l;
        var t = CKEDITOR.tools.addFunction(l),
        ...
        a.on("selectionChange", function () {
          for (
            ...
            var D = B[y],
              x = 0;
            u = D.data("cke-display-name")
              ? D.data("cke-display-name")
              : D.data("cke-real-element-type")
              ? D.data("cke-real-element-type")
              : D.getName();
            (l = D.hasAttribute("contenteditable")
            ...
            x || (f.unshift(D), e.unshift(u));
          }
          f = f.length;
          for (m = 0; m < f; m++)
            (u = e[m]),
              (l = a.lang.elementspath.eleTitle.replace(/%1/, u)),
              (u = c.output({
                id: n + m,
                label: l,
                text: u,
      ...
      CKEDITOR.plugins.add("indent", {
        init: function (b) {
          ...
          b.on("dirChanged", function (a) {
            ...
            d.setStartBefore(f);
            d.setEndAfter(f);
            for (var e = new CKEDITOR.dom.walker(d), k; (k = e.next()); )
              if (k.type == CKEDITOR.NODE_ELEMENT)
                if (!k.equals(f) && k.getDirection())
                  d.setStartAfter(k), (e = new CKEDITOR.dom.walker(d));
                else {
                  ...
                  if (g)
                    for (
                      ...
                      k.hasClass(g[t] + n[0]) &&
                        (k.removeClass(g[t] + n[0]), k.addClass(g[t] + n[1]));
    ...
    (function () {
      function a(a) {
        function c(e) {
          for (
            var h = r.startContainer, l = r.endContainer;
          ...
          if (!h || !l) return !1;
          for (var q = h, h = [], v = !1; !v; )
            q.equals(l) && (v = !0), h.push(q), (q = q.getNext());
          ...
          for (
            var q = d.isIndent ? 1 : -1,
              l = h[0],
              h = h[h.length - 1],
              v = CKEDITOR.plugins.list.listToArray(e, g),
              y = v[h.getCustomData("listarray_index")].indent,
              l = l.getCustomData("listarray_index");
            l <= h.getCustomData("listarray_index");
            l++
          )
            if (((v[l].indent += q), 0 < q)) {
              var t = v[l].parent;
              v[l].parent = new CKEDITOR.dom.element(
                t.getName(),
                t.getDocument()
              );
            }
          for (
            l = h.getCustomData("listarray_index") + 1;
            l < v.length && v[l].indent > y;
            l++
          )
            v[l].indent += q;
          ...
          if (!d.isIndent) {
            ...
            if ((x = e.getParent()) && x.is("li"))
              for (
                var q = h.listNode.getChildren(), A = [], C, l = q.count() - 1;
                0 <= l;
                l--
              )
                (C = q.getItem(l)) && C.is && C.is("li") && A.push(C);
          }
          ...
          if (A && A.length)
            for (l = 0; l < A.length; l++) {
              for (
                C = e = A[l];
                (C = C.getNext()) && C.is && C.getName() in m;
        ...
        for (
          ...
          for (
            ...
            q && (q.type != CKEDITOR.NODE_ELEMENT || !m[q.getName()]);
          ...
          q ||
            ((q = r.startPath().contains(m)) &&
              r.setEndAt(q, CKEDITOR.POSITION_BEFORE_END));
          if (!q) {
            var v = r.getEnclosedNode();
            v &&
              v.type == CKEDITOR.NODE_ELEMENT &&
              v.getName() in m &&
              (r.setStartAt(v, CKEDITOR.POSITION_AFTER_START),
              r.setEndAt(v, CKEDITOR.POSITION_BEFORE_END),
              (q = v));
          }
          q &&
            r.startContainer.type == CKEDITOR.NODE_ELEMENT &&
            r.startContainer.getName() in m &&
            ((v = new CKEDITOR.dom.walker(r)),
            (v.evaluator = e),
            (r.startContainer = v.next()));
          q &&
            r.endContainer.type == CKEDITOR.NODE_ELEMENT &&
            r.endContainer.getName() in m &&
            ((v = new CKEDITOR.dom.walker(r)),
            (v.evaluator = e),
            (r.endContainer = v.previous()));
          if (q) return c(q);
        }
        return 0;
      }
    ...
    (function () {
      ...
      function m(a, d, f) {
        ...
        var h = d.createBookmark(),
          ...
          t = r.contains(CKEDITOR.dtd.$listItem),
          r = r.contains(CKEDITOR.dtd.$list);
        m
          ? (m = m.getBogus()) && m.remove()
          : r && (m = r.getPrevious(g)) && n(m) && m.remove();
        (m = e.getLast()) &&
        ...
        t &&
          (e = l(t)) &&
          (k.contains(t) ? (b(e, t.getParent(), t), e.remove()) : k.append(e));
      ...
      CKEDITOR.plugins.list = {
        listToArray: function (a, b, c, d, e) {
          ...
          for (var g = 0, h = a.getChildCount(); g < h; g++) {
            ...
            if ("li" == k.$.nodeName.toLowerCase()) {
              ...
              c.push(l);
              for (var m = 0, n = k.getChildCount(), r; m < n; m++)
                (r = k.getChild(m)),
                  r.type == CKEDITOR.NODE_ELEMENT && f[r.getName()]
        ...
        arrayToList: function (a, b, c, d, e) {
          ...
          for (
            ...
            if (H.indent == t) {
              (n && a[r].parent.getName() == n.getName()) ||
                ((n = a[r].parent.clone(!1, 1)),
              ...
              r++;
            } else if (H.indent == Math.max(t, 0) + 1)
              (H = a[r - 1].element.getDirection(1)),
                (r = CKEDITOR.plugins.list.arrayToList(
                  a,
                  null,
                  r,
                  d,
              ...
              f[h.getName()]
                ? ((C = H.element.clone(!1, !0)),
                  G != h.getDirection(1) && C.setAttribute("dir", G))
                : (C = new CKEDITOR.dom.documentFragment(l));
              var n = h.getDirection(1) != G,
                K = H.element,
                E = K.getAttribute("class"),
                N = K.getAttribute("style"),
                R =
                  C.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT &&
                  (d != CKEDITOR.ENTER_BR || n || N || E),
                P,
                T = H.contents.length,
                O;
              for (h = 0; h < T; h++)
                if (((P = H.contents[h]), k(P) && 1 < T))
                  R ? (O = P.clone(1, 1)) : C.append(P.clone(1, 1));
                else if (
                  ...
                  R
                    ? (F ||
                        ((F = l.createElement(I)),
                        C.append(F),
                        n && F.setAttribute("dir", G)),
                      N && F.setAttribute("style", N),
                      E && F.setAttribute("class", E),
                      O && (F.append(O), (O = null)),
                      F.append(P.clone(1, 1)))
                    : C.append(P.clone(1, 1));
          ...
          if (b)
            for (a = m.getFirst(); a; ) {
              if (
                ...
                a.getName() in CKEDITOR.dtd.$listItem &&
                  ((c = a), (l = e = d = void 0), (d = c.getDirection())))
              ) {
        ...
        exec: function (b) {
          ...
          for (
            ...
            x.type == CKEDITOR.NODE_ELEMENT &&
              "td" == x.getName() &&
              l.setStartAt(r.startNode, CKEDITOR.POSITION_AFTER_START);
            A.type == CKEDITOR.NODE_ELEMENT &&
              "td" == A.getName() &&
              l.setEndAt(r.endNode, CKEDITOR.POSITION_BEFORE_END);
            l = l.createIterator();
            for (
              l.forceBrBreak = this.state == CKEDITOR.TRISTATE_OFF;
              (r = l.getNextParagraph());

            )
              if (!r.getCustomData("list_block")) {
                CKEDITOR.dom.element.setMarker(m, r, "list_block", 1);
                for (
                  var C = b.elementPath(r),
                    x = C.elements,
                    A = 0,
                    C = C.blockLimit,
                    G,
                  ...
                  if (f[G.getName()] && C.contains(G)) {
                    C.removeCustomData("list_group_object_" + n);
                    (x = G.getCustomData("list_group_object"))
                      ? x.contents.push(r)
                      : ((x = { root: G, contents: [r] }),
                        k.push(x),
                        CKEDITOR.dom.element.setMarker(
                ...
                A ||
                  ...
                  A.getCustomData("list_group_object_" + n)
                    ? A.getCustomData("list_group_object_" + n).contents.push(r)
                    : ((x = { root: A, contents: [r] }),
                      CKEDITOR.dom.element.setMarker(
                        m,
                        A,
          ...
          for (G = []; 0 < k.length; )
            if (((x = k.shift()), this.state == CKEDITOR.TRISTATE_OFF))
              if (f[x.root.getName()]) {
                ...
                for (
                  var F = n.root.getDocument(), I = void 0, H = void 0, r = 0;
                  r < C.length;
                  r++
                ) {
                  var K = C[r].getCustomData("listarray_index"),
                    I = A[K].parent;
                  I.is(this.type) ||
                    ((H = F.createElement(this.type)),
                ...
                for (r = 0; r < C && (A = x.listNode.getChild(r)); r++)
                ...
                for (F = 0; F < C.length; F++)
                  l = l.getCommonAncestor(C[F].getParent());
                I = A.config.useComputedState;
                A = x = void 0;
                I = void 0 === I || I;
                for (F = 0; F < C.length; F++)
                  for (H = C[F]; (K = H.getParent()); ) {
                    if (K.equals(l)) {
                      n.push(H);
                ...
                if (h && h.collapsed) {
                  ...
                  if (r) {
                    ...
                    (x = l(x))
                      ...
                      : (D.range.setStartAt(t, CKEDITOR.POSITION_AFTER_START),
                    ...
                    if (
                      (D.range.setEndAt(t, CKEDITOR.POSITION_BEFORE_END),
                      (r = (t = e.getLast(g)) && d(t) ? t : e),
                      (k = 0),
                      (x = D.next()) &&
                      x.type == CKEDITOR.NODE_ELEMENT &&
                      x.getName() in f &&
                      x.equals(t)
                        ? ((k = 1), (x = D.next()))
                        : h.checkBoundaryOfElement(r, CKEDITOR.END) && (k = 2),
                      k && x)
                    ) {
                      h = h.clone();
    ...
    (function () {
      function a(a, b, c) {
        ...
        "wysiwyg" == a.mode &&
          ...
          a.fire("saveSnapshot"),
          b == CKEDITOR.ENTER_BR ? l(a, b, null, c) : f(a, b, null, c),
          a.fire("saveSnapshot"));
      }
      function e(a) {
      ...
      CKEDITOR.plugins.enterkey = {
        enterBlock: function (a, f, m, t) {
          if ((m = m || e(a))) {
            m = b(m);
            var r = m.document,
              q = m.checkStartOfBlock(),
              v = m.checkEndOfBlock(),
              p = a.elementPath(m.startContainer),
              w = p.block,
            ...
            if (q && v) {
              if (w && (w.is("li") || w.getParent().is("li"))) {
                ...
                var u = !w.hasNext(),
                  ...
                  y = z.createBookmarks(),
                  q = w.getDirection(1),
                  v = w.getAttribute("class"),
                  D = w.getAttribute("style"),
                  x = B.getDirection(1) != q;
                a = a.enterMode != CKEDITOR.ENTER_BR || x || D || v;
                if (B.is("li"))
                  t || u
                    ? (t && u && m.remove(),
                      w[u ? "insertAfter" : "insertBefore"](B))
                    : w.breakParent(B);
                else {
                  if (a)
                    if (
                      (p.block.is("li")
                        ? ((B = r.createElement(
                          ...
                          x && B.setAttribute("dir", q),
                          D && B.setAttribute("style", D),
                          v && B.setAttribute("class", v),
                          w.moveChildren(B))
                        : (B = p.block),
                      t || u)
                    )
                      B[t ? "insertBefore" : "insertAfter"](m);
                    else w.breakParent(m), B.insertAfter(m);
                  else if ((w.appendBogus(!0), t || u))
                    for (; (r = w[t ? "getFirst" : "getLast"]()); )
                      r[t ? "insertBefore" : "insertAfter"](m);
                  else
                    for (w.breakParent(m); (r = w.getLast()); )
                      r.insertAfter(m);
                  w.remove();
                }
                z.selectBookmarks(y);
              ...
              if (w && w.getParent().is("blockquote")) {
                ...
                w.getPrevious().getFirst(CKEDITOR.dom.walker.invisible(1)) ||
                  w.getPrevious().remove();
                w.getNext().getFirst(CKEDITOR.dom.walker.invisible(1)) ||
                  w.getNext().remove();
            ...
            if ((q = m.splitBlock(z))) {
              ...
              w
                ? ((y = w.getParent()),
                  y.is("li") && (w.breakParent(y), w.move(w.getNext(), 1)))
                : f &&
                  (y = f.getParent()) &&
                  y.is("li") &&
                  (f.breakParent(y),
              ...
              if (p || a) {
                ...
                B
                  ? t && !B.is("li") && B.renameNode(z)
                  : y && y.is("li")
                  ? (B = y)
                  : ((B = r.createElement(z)),
                    f && (u = f.getDirection()) && B.setAttribute("dir", u));
                if ((r = q.elementPath))
                  for (t = 0, z = r.elements.length; t < z; t++) {
                    y = r.elements[t];
                ...
                !CKEDITOR.env.ie ||
                  !p ||
                  (a && f.getChildCount()) ||
                  (m.moveToElementEditStart(a ? f : B), m.select());
                m.moveToElementEditStart(p && !a ? w : B);
              } else
                w.is("li") &&
                  ((B = m.clone()),
                  B.selectNodeContents(w),
                  (B = new CKEDITOR.dom.walker(B)),
                  (B.evaluator = function (a) {
                    return !(
                      d(a) ||
        ...
        enterBr: function (a, b, c, d) {
          if ((c = c || e(a))) {
            var l = c.document,
              m = c.checkEndOfBlock(),
              v = new CKEDITOR.dom.elementPath(
              ...
              ? (!d && m && h.test(w)
                  ? (m = p.getDirection())
                    ? ((l = l.createElement("div")),
                      ...
                      l.insertAfter(p),
                      c.setStart(l, 0))
                    : (l.createElement("br").insertAfter(p),
                      CKEDITOR.env.gecko && l.createText("").insertAfter(p),
                      c.setStartAt(
                        p.getNext(),
                        CKEDITOR.env.ie
                          ? CKEDITOR.POSITION_BEFORE_START
    ...
    (function () {
      ...
      CKEDITOR.plugins.add("entities", {
        afterInit: function (e) {
          ...
          function c(a) {
            return "force" != d.entities_processNumerical && l[a]
              ? l[a]
              : "\x26#" + a.charCodeAt(0) + ";";
          }
          var d = e.config;
    ...
    CKEDITOR.tools.extend(CKEDITOR.editor.prototype, {
      popup: function (a, e, b, c) {
        ...
        var d = parseInt((window.screen.height - b) / 2, 10),
          m = parseInt((window.screen.width - e) / 2, 10);
        c =
          (c ||
    ...
    (function () {
      ...
      function m(a, f, g, l) {
        if (l && l.length)
          for (var t, r = l.length; r--; )
            if (
              ((t = l[r]),
              ("hbox" != t.type && "vbox" != t.type && "fieldset" != t.type) ||
                m(a, f, g, t.children),
              t.filebrowser)
            )
              if (
                ("string" == typeof t.filebrowser &&
                  (t.filebrowser = {
                ...
                q &&
                  ((t.onClick = b), (t.filebrowser.url = q), (t.hidden = !1));
              } else if (
                "QuickUpload" == t.filebrowser.action &&
                t["for"] &&
                ((q = t.filebrowser.url),
                void 0 === q &&
                ...
                d(
                  a,
                  g.getContents(t["for"][0]).get(t["for"][1]),
                  t.filebrowser
                );
              }
      }
            ...
            return function (f) {
              if ((m = a.editable())) {
                ...
                k
                  ? (z + y <= p.top
                      ? g("top")
                      : z + y > w.height - p.bottom
                      ? g("pin")
                      : g("bottom"),
                    (f = w.width / 2),
                    (f = d.floatSpacePreferRight
                      ? "right"
                      : 0 < p.left && p.right < w.width && p.width > v.width
      ...
      init: function (a) {
        if (!a.blockless) {
          for (
            ...
            var h = c[f],
              k = new CKEDITOR.style(e["format_" + h]);
    ...
    (function () {
      ...
      CKEDITOR.plugins.link = {
        ...
        getLinkAttributes: function (c, d) {
          ...
          if (d.advanced) {
            for (var q in v) (f = d.advanced[v[q]]) && (h[q] = f);
    ...
    (function () {
      ...
      function d(a, b, c) {
        return (b = b[c ? "getPrevious" : "getNext"](function (b) {
          return (
            (b && b.type == CKEDITOR.NODE_TEXT && !ba(b)) ||
            (n(b) && !t(b) && !g(a, b))
          );
        }));
      }
        ...
        A(c, {
          ...
          place: function () {
            ...
            f && e
              ...
              : f
              ? e || (k.top = f.size.bottom + f.size.margin.bottom)
              : (k.top = e.size.top - e.size.margin.top);
            d.is(T) || m(k.top, b.scroll.y - 15, b.scroll.y + 5)
              ? ((k.top = a.inInlineMode ? 0 : b.scroll.y), this.look(T))
              : d.is(O) || m(k.top, b.pane.bottom - 5, b.pane.bottom + 15)
        ...
        c.lineChildren[0].on("mouseup", function (b) {
          ...
          h(
            ...
            function (b) {
              ...
              b[c.is(E) ? "insertBefore" : "insertAfter"](
                c.is(E) ? c.lower : c.upper
              );
            },
            !0
          );
      ...
      function h(a, b, c) {
        var d = new CKEDITOR.dom.range(a.doc),
          f = a.editor,
          e;
        F.ie && a.enterMode == CKEDITOR.ENTER_BR
          ? (e = a.doc.createText(M))
          : ((e =
              ((e = l(a.element, !0)) && e.data("cke-enter-mode")) ||
              a.enterMode),
            (e = new C(K[e], a.doc)),
            e.is("br") || a.doc.createText(M).appendTo(e));
      ...
      function w(a) {
        ...
        u(a, b);
        return !h && 0 <= b.size.top && m(c.y, 0, b.size.top + f)
          ? ((a = a.inInlineMode || 0 === d.scroll.y ? T : Y),
            new e([null, b, E, P, a]))
          : h &&
            b.size.bottom <= d.pane.height &&
            m(c.y, b.size.bottom - f, d.pane.height)
          ? ((a =
              a.inInlineMode ||
              m(b.size.bottom, d.pane.height - f, d.pane.height)
                ? O
                : Y),
            new e([b, null, N, P, a]))
          : null;
      ...
      function z(a) {
        ...
        var h = Math.min(h, 0 | (g.size.outerHeight / 2)),
          ...
          l,
          r;
        if (m(c.y, g.size.top - 1, g.size.top + h)) r = !1;
        else if (m(c.y, g.size.bottom - h, g.size.bottom + 1)) r = !0;
        else return null;
        if (t(g) || p(a, g, r) || g.getParent().is(W)) return null;
        var v = d(a, g, !r);
        if (v) {
          if (v && v.type == CKEDITOR.NODE_TEXT) return null;
          if (n(v)) {
            if (t(v) || !q(a, v) || v.getParent().is(W)) return null;
            k = [v, g][r ? "reverse" : "concat"]().concat([R, P]);
          }
        } else
          g.equals(a.editable[r ? "getLast" : "getFirst"](a.isRelevant))
            ? (y(a),
              r &&
              m(c.y, g.size.bottom - h, f.pane.height) &&
              m(g.size.bottom, f.pane.height - h, f.pane.height)
                ? (l = O)
                : m(c.y, 0, g.size.top + h) && (l = T))
            : (l = Y),
            (k = [null, g]
              [r ? "reverse" : "concat"]()
              .concat([
      ...
      function B(a, b, c, d) {
        for (
          ...
          (e[ca[l]] =
            parseInt(
              b.getComputedStyle.call(b, "border-" + ca[l] + "-width"),
              10
            ) || 0),
            (g[ca[l]] =
              parseInt(b.getComputedStyle.call(b, "padding-" + ca[l]), 10) ||
              0),
            (h[ca[l]] =
              parseInt(b.getComputedStyle.call(b, "margin-" + ca[l]), 10) || 0);
        (c && !d) || D(a, d);
        ...
        return A({ border: e, padding: g, margin: h, ignoreScroll: c }, k, !0);
      }
      function u(a, b, c) {
                    ...
                    if ("wysiwyg" == a.mode && !a.readOnly && !u) {
                      ...
                      u = setTimeout(function () {
                        ...
                        p &&
                          ...
                          !m.line.mouseNear() &&
                          (m.element = da(m, !0)) &&
                          ((m.trigger = w(m) || z(m) || ea(m)) &&
                          !v(m, m.trigger.upper || m.trigger.lower)
                            ? m.line.attach().place()
      ...
      var da = (function () {
        ...
        ba = CKEDITOR.dom.walker.whitespaces(),
        ...
        ea = (function () {
          function b(f) {
            ...
            for (
              var e = Number.MAX_VALUE, l, q, r, p;
              g && !g.equals(h) && (q = h.getNext(f.isRelevant));

            )
              (l = Math.abs(c(f, h, q) - f.mouse.y)),
                l < e && ((e = l), (r = h), (p = q)),
                (h = q),
                u(f, h);
            if (!r || !p || !m(f.mouse.y, r.size.top, p.size.bottom))
              return null;
            k.upper = r;
            k.lower = p;
            return k.set(R, 8);
            ...
            a.addCommand("maximize", {
              ...
              exec: function () {
                ...
                if (this.state == CKEDITOR.TRISTATE_OFF) {
                  ...
                  for (var p = [v, q], z = 0; z < p.length; z++)
                    c(p[z], p[z].getCustomData("maximize_saved_styles")),
                      p[z].removeCustomData("maximize_saved_styles");
                  for (p = a.container; (p = p.getParent()); )
                ...
                if ((p = this.uiItems[0]))
                  (v =
                    ...
                    p.getChild(1).setHtml(v),
                    p.setAttribute("title", v),
                    p.setAttribute("href", 'javascript:void("' + v + '");');
                "wysiwyg" == a.mode
                  ? g
                    ? (CKEDITOR.env.gecko && d(a),
                      ...
                      (w = a.getSelection().getStartElement()) &&
                        w.scrollIntoView(!0))
                    : k.$.scrollTo(n.x, n.y)
                  : (g && ((w.selectionStart = g[0]), (w.selectionEnd = g[1])),
                    (w.scrollLeft = n[0]),
                    (w.scrollTop = n[1]));
                g = n = null;
                r = this.state;
              ...
              if (
                ...
                var h = a(b, d, function () {
                  if (h) b.fire("paste", l);
                    ...
                    l.dataValue = CKEDITOR.cleanWord(f, b);
                  c = 0;
                });
                h && e.cancel();
              }
    ...
    CKEDITOR.plugins.add("resize", {
      init: function (a) {
        function e(b) {
          var d = h.width,
            e = h.height,
            l = d + (b.data.$.screenX - f.x) * ("rtl" == m ? -1 : 1);
          b = e + (b.data.$.screenY - f.y);
          k &&
            (d = Math.max(c.resize_minWidth, Math.min(l, c.resize_maxWidth)));
          g &&
    ...
    CKEDITOR.plugins.add("scayt", {
      ...
      menuGenerator: function (a, e) {
        var b = a.scayt,
          ...
          l = e.getAttribute(b.getLangAttribute()) || b.getLang(),
          f,
          h;
        f = b.isScaytNode(e);
        h = b.isGraytNode(e);
        f
          ? ((c = c.scayt),
            ...
            b.fire("getSuggestionsList", { lang: l, word: d }),
          ...
          : h &&
            ...
            (h = b.getProblemDescriptionText(d, l)),
            c.grayt_problemdescription &&
              h &&
              (c.grayt_problemdescription.label = h),
            b.fire("getGrammarSuggestionsList", { lang: l, phrase: d }),
            (d = this.buildSuggestionMenuItems(
              a,
              CKEDITOR.plugins.scayt.suggestions,
              f
        ...
        a[e] = CKEDITOR.tools.override(a[e], function (a) {
          return function (c) {
            ...
            CKEDITOR.plugins.scayt &&
              ...
              (c.contents = d.removeMarkupFromString(l) || ""));
            ...
            init: function () {
              ...
              for (m = d.length; g < m; g++)
                (a = d[g]),
                  ...
                  (k = a._.type),
                  k != e &&
                    (this.startGroup(b["panelTitle" + String(k)]), (e = k)),
                  this.add(
                    c,
    ...
    (function () {
      ...
      CKEDITOR.plugins.add("tab", {
        init: function (d) {
          for (
            var m = !1 !== d.config.enableTabKeyTools,
              l = d.config.tabSpaces || 0,
              f = "";
            l--;
    ...
    (function () {
      ...
      function e(b, c) {
        for (
          var d = a(b),
            ...
            d = new CKEDITOR.dom.element(e.$.rows[k]),
            h = c ? h : k,
            g = c ? g : d,
          ...
          var l;
          1 < e[k].rowSpan && h && e[k] == h[k]
            ? ((l = e[k]), (l.rowSpan += 1))
            : ((l = new CKEDITOR.dom.element(e[k]).clone()),
      ...
      function b(c) {
        if (c instanceof CKEDITOR.dom.selection) {
          ...
          for (
            ...
            for (
              var k = e[h], l = new CKEDITOR.dom.element(f.$.rows[h]), m = 0;
              m < k.length;
              m++
            ) {
              var n = new CKEDITOR.dom.element(k[m]),
                t = n.getParent().$.rowIndex;
              1 == n.$.rowSpan
                ? n.remove()
                : (--n.$.rowSpan,
                  t == h &&
                    ((t = e[h + 1]),
                    t[m - 1]
                      ? n.insertAfter(new CKEDITOR.dom.element(t[m - 1]))
      ...
      function c(a, b) {
        for (var c = b ? Infinity : 0, d = 0; d < a.length; d++) {
          ...
          f = a[d];
          for (
            var e = b, g = f.getParent().$.cells, h = 0, k = 0;
            k < g.length;
            k++
          ) {
            var l = g[k],
      ...
      function d(b, d) {
        for (
          ...
          e.push(h[l][g]), f.push(d ? h[l][g - 1] : h[l][g + 1]);
        for (l = 0; l < k; l++)
          e[l] &&
            (1 < e[l].colSpan && f[l] == e[l]
              ? ((g = e[l]), (g.colSpan += 1))
              : ((g = new CKEDITOR.dom.element(e[l]).clone()),
                g.removeAttribute("colSpan"),
                g.appendBogus(),
                g[d ? "insertBefore" : "insertAfter"].call(
                  g,
                  new CKEDITOR.dom.element(e[l])
                ),
                (g = g.$)),
            (l += g.rowSpan - 1));
      }
      ...
      function k(b, c, d) {
        ...
        for (c = 0; c < f.length; c++) {
          ...
          d ||
            ((N = g),
            (R = N.getBogus()) && R.remove(),
            N.trim(),
            g.getChildren().count() &&
              (K == F ||
                !E ||
                (E.isBlockBoundary && E.isBlockBoundary({ br: 1 })) ||
                ((F = I.getLast(CKEDITOR.dom.walker.whitespaces(!0))),
                !F || (F.is && F.is("br")) || I.append("br")),
              g.moveChildren(I)),
      ...
      function g(b, c) {
        ...
        if (1 < m) {
          ...
          for (
            ...
            if (((t = g[k]), t.parentNode == e.$ && k > l)) {
              f.insertBefore(new CKEDITOR.dom.element(t));
              break;
            } else t = null;
          t || e.append(f);
        } else
            ...
            h({
              ...
              exec: function (b) {
                ...
                for (
                  ...
                  for (var n = 0, q = e[l].length; n < q; n++)
                    e[l][n] == c.$ && (g = n), e[l][n] == d.$ && (h = n);
                for (l = g; l <= h; l++)
    ...
    (CKEDITOR.tools.buildTableMap = function (a) {
      ...
      for (var e = -1, b = [], c = 0; c < a.length; c++) {
        ...
        for (var d = -1, m = 0; m < a[c].cells.length; m++) {
          ...
          for (d++; b[e][d]; ) d++;
          for (
            var f = isNaN(l.colSpan) ? 1 : l.colSpan,
          ...
          if (c.length) {
            ...
            for (var f; (f = c.shift()); )
              (f = "string" == typeof f ? f : f.name),
                (k && -1 != CKEDITOR.tools.indexOf(k, f)) ||
        ...
        init: function (d) {
          ...
          d.on("uiSpace", function (c) {
            if (c.data.space == d.config.toolbarLocation) {
              ...
              for (
                var t = d.toolbox.toolbars, r = a(d), q = 0;
                q < r.length;
                q++
              ) {
                var v,
                  ...
                  B;
                if (z)
                  if ((g && (k.push("\x3c/span\x3e"), (m = g = 0)), "/" === z))
                    k.push(
                    ...
                    for (var u = 0; u < B.length; u++) {
                      ...
                      if (y) {
                        ...
                        if (y.type == CKEDITOR.UI_SEPARATOR) m = g && y;
                        else {
                          D = !1 !== y.canGroup;
                          if (!p) {
                            ...
                            w =
                              z.name &&
                              (d.lang.toolbar.toolbarGroups[z.name] || z.name);
                            k.push(
                              '\x3cspan id\x3d"',
                              v,
                              '" class\x3d"cke_toolbar"',
                              w ? ' aria-labelledby\x3d"' + v + '_label"' : "",
                            ...
                            var A = t.push(p) - 1;
                            0 < A &&
                              ((p.previous = t[A - 1]), (p.previous.next = p));
                          }
                          D
                            ? g ||
                              (k.push(
          ...
          a.addMode("wysiwyg", function (b) {
            ...
            if (n) {
              var g = CKEDITOR.tools.getNextId(),
                t = CKEDITOR.dom.element.createFromHtml(
                  '\x3cspan id\x3d"' +
                    g +
                    '" class\x3d"cke_voice_label"\x3e' +
                    n +
