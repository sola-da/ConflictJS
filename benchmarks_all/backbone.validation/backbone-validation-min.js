      ...
      var e = function (b, c) {
        ...
        g = function (b, c) {
          ...
          return (
            a.isFunction(d)
              ? (d = d(c))
              : a.isString(d) && a.isFunction(j[d]) && (d = j[d](c)),
        ...
        h = function (b, c) {
          ...
          return (
            ...
            a.reduce(
              ...
              function (b, c) {
                return (
                  a.each(a.without(a.keys(c), "msg"), function (a) {
        ...
        m = function (b, c) {
          return {
            ...
            isValid: function (e) {
              ...
              return (
                (e = e || g(c, b)),
                a.isString(e) ? (h = [e]) : a.isArray(e) && (h = e),
                h &&
                  ((f = d(this.attributes)),
                  a.each(
                    ...
                    function (b) {
                      a.each(
                        h,
                        function (d) {
                          (j = i(this, d, f[d], a.extend({}, this.attributes))),
                            j
                              ? (c.invalid(b, d, j, c.selector),
                                (k = k || {}),
                                (k[d] = j))
                              : c.valid(b, d, c.selector);
                        },
                        this
                      );
                    },
                ...
                e === !0 && (k = this.validate()),
                k && this.trigger("invalid", this, k, { validationError: k }),
                ...
                a.each(i.associatedViews, function (b) {
                  a.each(m, function (a, c) {
                    ...
                    d || k.valid(b, c, k.selector),
                      d &&
                        (e || j) &&
                        k.invalid(b, c, q.invalidAttrs[c], k.selector);
                  });
                }),
                a.defer(function () {
                  i.trigger("validated", i._isValid, i, q.invalidAttrs),
                    i.trigger(
                      "validated:" + (i._isValid ? "valid" : "invalid"),
                      i,
                      q.invalidAttrs
                    );
                }),
                !k.forceUpdate &&
                a.intersection(a.keys(q.invalidAttrs), a.keys(p)).length > 0
                  ? q.invalidAttrs
                  : void 0
              );
            },
        ...
        o = function (b, c) {
          c && b.associatedViews && b.associatedViews.length > 1
      ...
      return {
        ...
        range: function (a, b, d, e) {
          return !c(a) || a < d[0] || a > d[1]
            ? this.format(h.range, this.formatLabel(b, e), d[0], d[1])
            : void 0;
        },
        ...
        rangeLength: function (b, c, d, e) {
          return !a.isString(b) || b.length < d[0] || b.length > d[1]
            ? this.format(h.rangeLength, this.formatLabel(c, e), d[0], d[1])
            : void 0;
        },
        oneOf: function (b, c, d, e) {
          return a.include(d, b)
            ? void 0
            : this.format(h.oneOf, this.formatLabel(c, e), d.join(", "));
        },
        ...
        pattern: function (a, b, c, e) {
          return d(a) && a.toString().match(g[c] || c)
            ? void 0
            : this.format(h[c] || h.inlinePattern, this.formatLabel(b, e), c);
        },
      };
    })());
  return (
