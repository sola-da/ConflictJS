        ...
        return (
          ...
          }),
          {
            ...
            link: function (a, l, o, d) {
              ...
              return (
                (a.disabledValuesHistory = a.disabledValuesHistory
                  ? a.disabledValuesHistory
                  : []),
                (l = $(l)),
                l.addClass("localytics-chosen"),
                (p = a.$eval(o.chosen) || {}),
                angular.forEach(o, function (t, r) {
                  return e.call(n, r) >= 0
                    ? o.$observe(r, function (e) {
                        return (
                          (p[s(r)] =
                            "{{" === String(l.attr(o.$attr[r])).slice(0, 2)
                              ? e
                              : a.$eval(e)),
                          S()
                        );
                ...
                (v = function () {
                  return (
                    ...
                    angular.isDefined(o.disabled)
                      ? l.attr("disabled", o.disabled)
                      : l.attr("disabled", !1),
                ...
                (S = function () {
                  return (
                    c
                      ? l
                          .attr("data-placeholder", u.results_none_found)
                          .attr("disabled", !0)
                      : l.removeAttr("data-placeholder"),
                    l.trigger("chosen:updated")
                  );
                }),
                d
                  ? ((g = d.$render),
                    ...
                    o.multiple &&
                      ...
                      a.$watch(w, d.$render, !0)))
                  : f(),
                o.$observe("disabled", function () {
                  return l.trigger("chosen:updated");
                }),
                o.ngOptions && d
                  ? ((h = o.ngOptions.match(r)),
                    (y = h[7]),
                    a.$watchCollection(y, function (e, n) {
                      var r;
                      return (r = t(function () {
                    ...
                    a.$on("$destroy", function (e) {
                      return "undefined" != typeof timer && null !== timer
                        ? t.cancel(timer)
                        : void 0;
                    }))
                  : void 0
