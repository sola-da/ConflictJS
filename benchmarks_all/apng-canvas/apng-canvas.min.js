        ...
        (function (n, r) {
          (function () {
              ...
              (n._instanceConstructor = t),
                ...
                n._validateInput(e)
                  ? ((n._input = e),
                    ...
                    n._init(),
                    0 === n.length
                      ? N(n.promise, n._result)
                      : ((n.length = n.length || 0),
                        n._enumerate(),
                        0 === n._remaining && N(n.promise, n._result)))
            ...
            function j(t) {
              ...
              if (!Q(t))
                return (
                  C(i, new TypeError("You must pass an array to race.")), i
                );
              for (var o = t.length, a = 0; i._state === nt && o > a; a++)
                T(r.resolve(t[a]), void 0, e, n);
              return i;
            }
            function k(t) {
              var e = this;
            ...
            function M(t) {
              (this._id = ht++),
                ...
                (this._result = void 0),
                (this._subscribers = []),
                v !== t && (o(t) || S(), this instanceof M || G(), U(this, t));
            }
            function q() {
              var t;
            ...
            (L.prototype._enumerate = function () {
              for (
                var t = this, e = t.length, n = t.promise, r = t._input, i = 0;
                n._state === nt && e > i;
                i++
              )
                t._eachEntry(r[i], i);
              ...
              (L.prototype._settledAt = function (t, e, n) {
                var r = this,
                  i = r.promise;
                i._state === nt &&
                  (r._remaining--, t === it ? C(i, n) : (r._result[e] = n)),
                  0 === r._remaining && N(i, r._result);
              }),
            ...
            "function" == typeof define && define.amd
              ...
              ? (e.exports = At)
              : "undefined" != typeof this && (this.ES6Promise = At),
              pt();
          }.call(this));
        }.call(
          this,
    ...
    4: [
      function (t, e, n) {
        ...
        for (var r = new Uint32Array(256), i = 0; 256 > i; i++) {
          for (var o = i, a = 0; 8 > a; a++)
            o = 1 & o ? 3988292384 ^ (o >>> 1) : o >>> 1;
          r[i] = o;
        }
        e.exports = function (t, e, n) {
          (e = e || 0), (n = n || t.length - e);
          for (var i = -1, o = e, a = e + n; a > o; o++)
            i = (i >>> 8) ^ r[255 & (i ^ t[o])];
          return -1 ^ i;
        };
      },
      ...
      function (t, e, n) {
        (function (e) {
          ...
          var n = t("./support-test"),
            ...
            i = t("./loader"),
            o = (e.APNG = {});
          (o.checkNativeFeatures = n.checkNativeFeatures),
            (o.ifNeeded = n.ifNeeded),
            (o.parseBuffer = function (t) {
              return r(t);
            });
          var a = {};
          (o.parseURL = function (t) {
            ...
            (o.animateImage = function (t) {
              return (
                t.setAttribute("data-is-apng", "progress"),
                o.parseURL(t.src).then(
                  function (e) {
                      ...
                      Array.prototype.slice
                        ...
                        .forEach(function (t) {
                          -1 ==
                            ...
                            n.setAttributeNode(t.cloneNode(!1));
                        }),
                      n.setAttribute("data-apng-src", t.src),
                      "" != t.alt &&
                        n.appendChild(document.createTextNode(t.alt));
                    var r = "",
                      i = "",
                      o = 0,
                      a = "";
                    "" != t.style.width && "auto" != t.style.width
                      ...
                      : t.hasAttribute("width") &&
                        (r = t.getAttribute("width") + "px"),
                      "" != t.style.height && "auto" != t.style.height
                        ? (i = t.style.height)
                        : t.hasAttribute("height") &&
                          (i = t.getAttribute("height") + "px"),
                      "" != r &&
                        "" == i &&
                        ((o = parseFloat(r)),
                        (a = r.match(/\D+$/)[0]),
                        (i = Math.round((n.height * o) / n.width) + a)),
                      "" != i &&
                        "" == r &&
                        ((o = parseFloat(i)),
                        (a = i.match(/\D+$/)[0]),
                        (r = Math.round((n.width * o) / n.height) + a)),
                      (n.style.width = r),
                      (n.style.height = i);
                    var s = t.parentNode;
                    s.insertBefore(n, t),
                      s.removeChild(t),
                      e.addContext(n.getContext("2d")),
                      e.play();
                  },
                  function () {
        ...
        e.exports = function (t) {
          ...
          return new r(function (t, n) {
            for (var r = 0; r < a.length; r++)
              if (a[r] != e[r])
                return void n("Not a PNG file (invalid file signature)");
            var o = !1;
            if (
              (s(e, function (t) {
              ...
              return void n("Not an animated PNG");
            var h = [],
              p = [],
              v = null,
              m = null,
              g = new i();
            if (
              (s(e, function (t, e, n, r) {
                switch (t) {
                  case "IHDR":
                    (v = e.subarray(n + 8, n + 8 + r)),
                      (g.width = u(e, n + 8)),
                      (g.height = u(e, n + 12));
                    break;
                  case "acTL":
                  ...
                  case "fcTL":
                    ...
                    0 == o && (o = 100),
                      ...
                      (g.playTime += m.delay),
                      (m.disposeOp = f(e, n + 8 + 24)),
                      (m.blendOp = f(e, n + 8 + 25)),
                      (m.dataParts = []);
                    break;
                  case "fdAT":
              ...
              return void n("Not an animated PNG");
            for (
              var w = 0, y = new Blob(h), _ = new Blob(p), b = 0;
              b < g.frames.length;
              b++
            ) {
              m = g.frames[b];
              ...
              E.push(a),
                ...
                E.push(A("IHDR", v)),
                E.push(y);
              for (var P = 0; P < m.dataParts.length; P++)
                E.push(A("IDAT", m.dataParts[P]));
              E.push(_);
              var x = URL.createObjectURL(new Blob(E, { type: "image/png" }));
              delete m.dataParts,
                (E = null),
            ...
            o = i(function (t) {
              ...
              if (r.canvas) {
                ...
                (i.onload = function () {
                  ...
                  n.drawImage(i, 0, 0),
                    (r.APNG = 0 === n.getImageData(0, 0, 1, 1).data[3]),
                    t(r);
                }),
                  (i.src =
              ...
              return (
                ...
                o().then(function (e) {
                  if (e.APNG && !t) reject();
                    ...
                    var n = !0;
                    for (var r in e)
                      e.hasOwnProperty(r) && "APNG" != r && (n = n && e[r]);
                  }
                })
              );
            };
          e.exports = { checkNativeFeatures: o, ifNeeded: a };
        }.call(
          this,
          "undefined" != typeof self
            ? self
