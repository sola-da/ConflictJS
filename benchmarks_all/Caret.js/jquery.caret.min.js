    ...
    (b = (function () {
      ...
      return (
          ...
          return (
            (e = j.getSelection()) &&
              ...
              (b = function (a, f) {
                var g, i, j, k, l, m;
                for (
                  l = f.childNodes, m = [], j = 0, k = l.length;
                  k > j && ((g = l[j]), !c);
                  j++
                )
                  if (3 === g.nodeType) {
            ...
            j.getSelection && (d = this.range())
              ? (d.endOffset - 1 > 0 &&
                ...
                (c && 0 !== (null != c ? c.height : void 0)) ||
                  ...
                  b.selectNode(f[0]),
                  (e = b.getBoundingClientRect()),
                  (c = { height: e.height, left: e.left, top: e.top }),
                  f.remove(),
                  b.detach()))
              : h.selection && (c = this.getOldIEOffset()),
            c && ((c.top += a(j).scrollTop()), (c.left += a(j).scrollLeft())),
            c
          );
        }),
        (b.prototype.range = function () {
          ...
          if (j.getSelection)
            return (
              (a = j.getSelection()), a.rangeCount > 0 ? a.getRangeAt(0) : null
            );
        }),
        b
      );
      ...
      return (
        ...
        (b.prototype.setPos = function (a) {
          ...
          return (
            (b = this.domInputor),
            h.selection
              ? ((c = b.createTextRange()), c.move("character", a), c.select())
      ...
      return (
        ...
        (b.prototype.mirrorCss = function () {
          var b,
            c = this;
          return (
            (b = { position: "absolute", left: -9999, top: 0, zIndex: -2e4 }),
