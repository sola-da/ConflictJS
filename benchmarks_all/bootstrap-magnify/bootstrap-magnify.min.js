!(function (e) {
  ...
  t.prototype = {
    ...
    init: function (t, n, r) {
      ...
      this.$element
        .parent(".magnify")
        .on(i + "." + this.type, e.proxy(this.check, this));
      this.$element
        .parent(".magnify")
        .on(s + "." + this.type, e.proxy(this.check, this));
    },
    ...
    check: function (t) {
      ...
      if (!this.nativeWidth && !this.nativeHeight) {
        ...
        var o = n.offset(),
          u = t.pageX - o.left,
          a = t.pageY - o.top;
        u < n.width() && a < n.height() && u > 0 && a > 0
          ? i.fadeIn(100)
          : i.fadeOut(100);
        if (i.is(":visible")) {
          var f =
              Math.round((u / n.width()) * this.nativeWidth - i.width() / 2) *
              -1,
            l =
              Math.round(
                (a / n.height()) * this.nativeHeight - i.height() / 2
              ) * -1,
            c = f + "px " + l + "px",
            h = u - i.width() / 2,
            p = a - i.height() / 2;
