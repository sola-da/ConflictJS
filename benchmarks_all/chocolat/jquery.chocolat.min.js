!(function (t) {
  ...
  t.extend(n.prototype, {
    ...
    close: function () {
      ...
      return (
        (this.settings.currentImage = !1), (this.settings.initialized = !1), s
      );
    },
    destroy: function () {
    ...
    events: function () {
      ...
      t(i)
        ...
        this.elems.wrapper
          ...
          .off("click.chocolat")
          .on("click.chocolat", function (t) {
            return null === s.settings.initialZoomState &&
        ...
        this.elems.wrapper.mousemove(function (e) {
          if (
            ...
            var g = { "margin-left": -h + "px", "margin-top": -m + "px" };
            "undefined" != typeof e.duration
              ? t(s.elems.img).stop(!1, !0).animate(g, e.duration)
              : t(s.elems.img).stop(!1, !0).css(g);
          }
        }),
        t(e).on("resize", function () {
          s.settings.initialized &&
            s.debounce(50, function () {
              (fitting = s.fit(s.settings.currentImage, s.elems.wrapper)),
                s.center(
                  fitting.width,
                  fitting.height,
                  fitting.left,
    ...
    zoomOut: function (t, e) {
      return null !== this.settings.initialZoomState
