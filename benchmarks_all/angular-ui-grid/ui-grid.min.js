      ...
      .service("uiGridColumnMenuService", [
        ...
        function (a, b, c) {
          var d = {
            ...
            sortable: function (a) {
              return a.grid.options.enableSorting &&
                ...
                post: function (a, c, e, g) {
                  ...
                  var r = function (d) {
                    ...
                    n && (e.removeClass(n), (n = null)),
                      (n = angular.isFunction(a.col.headerCellClass)
                      ...
                      k.grid.options.enableSorting && a.col.enableSorting
                        ? (a.sortable = !0)
                        : (a.sortable = !1);
                    var g = a.filterable;
                  ...
                  r();
                  var s = a.grid.registerDataChangeCallback(r, [
                    f.dataChange.COLUMN,
                  ]);
                  a.$on("$destroy", s),
            ...
            return {
              pre: function (a, c, e, i) {
                function j() {
                  ...
                  a.length > 0
                    ? (m.headerCanvas = m.colContainer.headerCanvas = a[0])
                    : (m.headerCanvas = null);
                }
                function k(a) {
              ...
              post: function (a, b, c, e) {
                ...
                i && (h.headerViewport = i),
                  g &&
                    g.grid.registerStyleComputation({ priority: 15, func: f });
              },
            };
          },
        };
              ...
              angular.isArray(c)
                ? b.gridMenuScope
                  ? ((b.gridMenuScope.registeredMenuItems = b.gridMenuScope
                      ...
                      : []),
                    (b.gridMenuScope.registeredMenuItems =
                      b.gridMenuScope.registeredMenuItems.concat(c)))
                  : a.logError(
        ...
        function (a, b, c, d, e, f, g) {
          var h = {
            ...
            link: function (a, d, h, i) {
              ...
              (a.dynamicStyles = ""),
                i &&
                  ((j = i.grid.gridHeight - 30),
                  (a.dynamicStyles = [
                    ".grid" + i.grid.id + " .ui-grid-menu-mid {",
                    "max-height: " + j + "px;",
                    "}",
                  ].join(" "))),
                (a.i18n = { close: g.getSafeText("columnMenu.close") }),
                (a.showMenu = function (c, f) {
                  a.shown
                    ? a.shownMid || ((a.shownMid = !0), a.$emit("menu-shown"))
                    : ((a.shown = !0),
                      b(function () {
                  ...
                  f &&
                    f.originalEvent &&
                    f.originalEvent.type &&
                    "touchstart" === f.originalEvent.type &&
                    (g = f.originalEvent.type),
                ...
                m = function (a) {
                  ...
                  if (9 === a.keyCode) {
                    ...
                    f.length > 0 &&
                      ((c = f[0]),
                      (e = f[f.length - 1]),
                      a.target !== e || a.shiftKey
                        ? a.target === c && a.shiftKey && b(e)
                        : b(c));
                  }
                };
              ("undefined" == typeof a.autoHide || void 0 === a.autoHide) &&
                (a.autoHide = !0),
          ...
          compile: function () {
            return {
              pre: function (a, b, c, d) {
                ...
                var h = (a.rowContainer =
                    g.renderContainers[a.rowContainerName]),
        ...
        return {
          ...
          link: function (c, d, e, f) {
            function g(e) {
              ...
              (j.newScrollLeft = g),
                (j.newScrollTop = f),
                i > -1 && (j.x = { percentage: i }),
                h > -1 && (j.y = { percentage: h }),
            ...
            function j(b) {
              var c = b.getNewScrollLeft(o, m.viewport);
              m.headerViewport &&
                (m.headerViewport.scrollLeft = a.denormalizeScrollLeft(
                  m.viewport,
                  c,
                  p
                ));
            ...
            function k(b) {
              var c = b.getNewScrollLeft(o, m.viewport);
              m.footerViewport &&
                (m.footerViewport.scrollLeft = a.denormalizeScrollLeft(
                  m.viewport,
                  c,
                  p
                ));
            ...
            c.$parent.bindScrollVertical &&
              p.addVerticalScrollSync(c.$parent.containerId, h),
              c.$parent.bindScrollHorizontal &&
                (p.addHorizontalScrollSync(c.$parent.containerId, i),
            ...
            post: function (a, b, g, h) {
              ...
              function k() {
                (n.gridWidth = a.gridWidth = e.elementWidth(b)),
                  ...
                  n.gridHeight <= n.options.rowHeight &&
                    n.options.enableMinHeightCheck &&
                    l(),
                  n.refreshCanvas(!0);
              }
              function l() {
                var c = n.options.minRowsToShow * n.options.rowHeight,
                  ...
                  h = 0;
                n.options.enableHorizontalScrollbar === f.scrollbars.ALWAYS &&
                ...
                if (
                  ...
                  var j =
                    n.options.columnDefs.length &&
                    n.options.columnDefs.every(function (a) {
    ...
    angular.module("ui.grid").controller("uiGridController", [
      ...
      function (a, b, c, d, e, f, g, h, i, j, k) {
        function l(b, c) {
          b &&
            b !== c &&
            ((n.grid.options.columnDefs = a.uiGrid.columnDefs),
            n.grid.buildColumns({ orderByColumnDefs: !0 }).then(function () {
        ...
        function m(b) {
          var d = [];
          if (
            (n.grid.options.fastWatch &&
              (b = angular.isString(a.uiGrid.data)
                ? n.grid.appScope[a.uiGrid.data]
                : a.uiGrid.data),
            (p = b),
            b)
          ) {
            var g =
              n.grid.columns.length >
              (n.grid.rowHeaderColumns ? n.grid.rowHeaderColumns.length : 0);
            !g &&
              !c.uiGridColumns &&
              0 === n.grid.options.columnDefs.length &&
              b.length > 0 &&
              n.grid.buildColumnDefsFromData(b),
              !g &&
                (n.grid.options.columnDefs.length > 0 || b.length > 0) &&
                d.push(
        ...
        n.grid.options.fastWatch
          ? ((n.uiGrid = a.uiGrid),
            angular.isString(a.uiGrid.data)
              ? (o.push(a.$parent.$watch(a.uiGrid.data, m)),
                o.push(
                  a.$parent.$watch(function () {
                    return n.grid.appScope[a.uiGrid.data]
                      ? n.grid.appScope[a.uiGrid.data].length
                      : void 0;
                  }, m)
                ))
              : (o.push(
          ...
          : (angular.isString(a.uiGrid.data)
              ? o.push(a.$parent.$watchCollection(a.uiGrid.data, m))
              : o.push(
              ...
              post: function (a, b, c, d) {
                ...
                function f() {
                  if ("left" === a.side || "right" === a.side) {
                    for (
                      var b = h.renderContainers[a.side].visibleColumnCache,
                        c = 0,
                        d = 0;
                      d < b.length;
                      d++
                ...
                b.addClass("ui-grid-pinned-container-" + a.side),
                  ("left" === a.side || "right" === a.side) &&
                    (h.renderContainers[a.side].getViewportWidth = e),
                  h.renderContainers.body.registerViewportAdjuster(function (
                    b
                  ) {
      ...
      function (a, b, c, d, e, f, g, h, i, j, k, l, m, n) {
        ...
        var p = function (a) {
          ...
          (g.flagScrollingVertically = function (a) {
            g.isScrollingVertically ||
              g.isScrollingHorizontally ||
              g.api.core.raise.scrollBegin(a),
            ...
            (g.scrollbarHeight = 0),
            (g.scrollbarWidth = 0),
            g.options.enableHorizontalScrollbar === e.scrollbars.ALWAYS &&
              (g.scrollbarHeight = d.getScrollbarWidth()),
            g.options.enableVerticalScrollbar === e.scrollbars.ALWAYS &&
              (g.scrollbarWidth = d.getScrollbarWidth()),
            (g.api = new i(g)),
            ...
            g.registerDataChangeCallback(g.columnRefreshCallback, [
              e.dataChange.COLUMN,
            ]),
            g.registerDataChangeCallback(g.processRowsCallback, [
              e.dataChange.EDIT,
            ]),
            g.registerDataChangeCallback(g.updateFooterHeightCallback, [
        ...
        return (
          (p.prototype.calcFooterHeight = function () {
            ...
            var a = 0;
            return (
              this.options.showGridFooter &&
                (a += this.options.gridFooterHeight),
          ...
          (p.prototype.callDataChangeCallbacks = function (a, b) {
            angular.forEach(
              ...
              function (b, c) {
                (-1 !== b.types.indexOf(e.dataChange.ALL) ||
                  -1 !== b.types.indexOf(a) ||
                  a === e.dataChange.ALL) &&
                  (b._this
                    ? b.callback.apply(b._this, this)
                    : b.callback(this));
              },
              this
            );
          ...
          (p.prototype.notifyDataChange = function (a) {
            ...
            a === b.ROW ||
            a === b.OPTIONS
              ? this.callDataChangeCallbacks(a)
              : d.logError(
          ...
          (p.prototype.addRowHeaderColumn = function (a) {
            ...
            (c.isRowHeader = !0),
              b.isRTL()
                ? (b.createRightContainer(), (c.renderContainer = "right"))
                : (b.createLeftContainer(), (c.renderContainer = "left")),
          ...
          (p.prototype.buildColumns = function (b) {
            ...
            if (
              (f.rowHeaderColumns.forEach(function (a) {
                f.columns.unshift(a);
              }),
              ...
              for (e = 0; k > e; e++)
                f.columns[e + i].name !== f.options.columnDefs[e].name
                  ? (j[e + i] = f.getColumn(f.options.columnDefs[e].name))
                  : (j[e + i] = f.columns[e + i]);
              (f.columns.length = 0),
          ...
          (p.prototype.preCompileCellTemplates = function () {
            var a = this,
              c = function (c) {
                var d = c.cellTemplate.replace(
                  e.MODEL_COL_FIELD,
                  a.getQualifiedColField(c)
                );
                d = d.replace(e.COL_FIELD, "grid.getCellValue(row, col)");
                var f = b(d);
                (c.compiledElementFn = f),
                  c.compiledElementFnDefer &&
                    c.compiledElementFnDefer.resolve(c.compiledElementFn);
              };
            this.columns.forEach(function (a) {
              a.cellTemplate
                ? c(a)
                : a.cellTemplatePromise &&
                  a.cellTemplatePromise.then(function () {
                    c(a);
                  });
            });
          }),
          ...
          (p.prototype.modifyRows = function (b) {
            ...
            var f = a.when(c.processRowsProcessors(c.rows)).then(function (a) {
              ...
              g = a
                .when(c.processColumnsProcessors(c.columns))
                .then(function (a) {
          ...
          (p.prototype.processRowBuilders = function (a) {
            var b = this;
            return (
              b.rowBuilders.forEach(function (c) {
          ...
          (p.prototype.registerRowsProcessor = function (a, b) {
            ...
            this.rowsProcessors.push({ processor: a, priority: b }),
          ...
          (p.prototype.setVisibleRows = function (a) {
            ...
            for (var c in b.renderContainers) {
              ...
              (d.canvasHeightShouldUpdate = !0),
                "undefined" == typeof d.visibleRowCache
                  ? (d.visibleRowCache = [])
            ...
            for (var e = 0; e < a.length; e++) {
              var f = a[e],
                g =
                  "undefined" != typeof f.renderContainer && f.renderContainer
                    ? f.renderContainer
                    : "body";
          ...
          (p.prototype.registerColumnsProcessor = function (a, b) {
            if (!angular.isFunction(a))
              throw "Attempt to register non-function rows processor: " + a;
            this.columnsProcessors.push({ processor: a, priority: b }),
          ...
          (p.prototype.removeColumnsProcessor = function (a) {
            ...
            "undefined" != typeof b &&
              void 0 !== b &&
              this.columnsProcessors.splice(b, 1);
          }),
            ...
            for (var e = 0; e < a.length; e++) {
              ...
              f.visible &&
                ("undefined" != typeof f.renderContainer && f.renderContainer
                  ? b.renderContainers[
                      f.renderContainer
                    ].visibleColumnCache.push(f)
                  : b.renderContainers.body.visibleColumnCache.push(f));
            }
          }),
          (p.prototype.handleWindowResize = function (a) {
            var b = this;
            return (
              (b.gridWidth = d.elementWidth(b.element)),
          ...
          (p.prototype.queueRefresh = function () {
            var a = this;
            return (
              a.refreshCanceller && m.cancel(a.refreshCanceller),
          ...
          (p.prototype.queueGridRefresh = function () {
            var a = this;
            return (
              a.gridRefreshCanceller && m.cancel(a.gridRefreshCanceller),
          ...
          (p.prototype.minColumnsToRender = function () {
            var a = this,
              ...
              d = 0;
            return (
              a.columns.forEach(function (e, f) {
          ...
          (p.prototype.removeViewportAdjuster = function (a) {
            ...
            "undefined" != typeof b &&
              void 0 !== b &&
              this.viewportAdjusters.splice(b, 1);
          }),
          (p.prototype.getViewportAdjustment = function () {
            var a = this,
              b = { height: 0, width: 0 };
            return (
              a.viewportAdjusters.forEach(function (a) {
                b = a.call(this, b);
              }),
              b
            );
          ...
          (p.prototype.getCellValue = function (a, b) {
            return "undefined" != typeof a.entity["$$" + b.uid]
              ? a.entity["$$" + b.uid].rendered
              : this.options.flatEntityAccess && "undefined" != typeof b.field
              ? a.entity[b.field]
              : (b.cellValueGetterCache ||
                  (b.cellValueGetterCache = c(a.getEntityQualifiedColField(b))),
          ...
          (p.prototype.getCellDisplayValue = function (a, b) {
            if (!b.cellDisplayGetterCache) {
              ...
              "undefined" != typeof a.entity["$$" + b.uid]
                ? (b.cellDisplayGetterCache = c(
                    a.entity["$$" + b.uid].rendered + d
                  ))
                : this.options.flatEntityAccess && "undefined" != typeof b.field
                ? (b.cellDisplayGetterCache = c(a.entity[b.field] + d))
                : (b.cellDisplayGetterCache = c(
                    a.getEntityQualifiedColField(b) + d
                  ));
            }
          ...
          (p.prototype.sortColumn = function (b, c, d) {
            ...
            if (
              ("boolean" == typeof c ? (d = c) : (f = c),
              d
                ? b.sort.priority ||
                  (b.sort.priority = e.getNextColumnSortPriority())
                : (e.resetColumnSorting(b),
              ...
              var g = b.sortDirectionCycle.indexOf(
                b.sort.direction ? b.sort.direction : null
              );
              (g = (g + 1) % b.sortDirectionCycle.length),
                b.colDef &&
                  b.suppressRemoveSort &&
                  !b.sortDirectionCycle[g] &&
                  (g = (g + 1) % b.sortDirectionCycle.length),
                b.sortDirectionCycle[g]
                  ? (b.sort.direction = b.sortDirectionCycle[g])
                  : (b.sort = {});
            }
            return (
              e.api.core.raise.sortChanged(e, e.getColumnSorting()), a.when(b)
            );
          }),
                  ...
                  m(function () {
                    ...
                    for (a = 0; a < f.length; a++)
                      if (
                        ...
                        if (g.header) {
                          var l = (g.headerHeight = k(
                              g.headerHeight,
                              parseInt(d.outerElementHeight(g.header), 10)
                            )),
                        ...
                        if (g.headerCanvas) {
                          var p = (g.headerCanvasHeight = k(
                            g.headerCanvasHeight,
                            parseInt(d.outerElementHeight(g.headerCanvas), 10)
                          ));
                    ...
                    for (a = 0; a < f.length; a++)
                      (g = f[a]),
                        i > 0 &&
                          "undefined" != typeof g.headerHeight &&
                          null !== g.headerHeight &&
                          (g.explicitHeaderHeight || g.headerHeight < i) &&
                          (g.explicitHeaderHeight = k(
                            g.explicitHeaderHeight,
                            i
                          )),
                        j > 0 &&
                          "undefined" != typeof g.headerCanvasHeight &&
                          null !== g.headerCanvasHeight &&
                          (g.explicitHeaderCanvasHeight ||
                            g.headerCanvasHeight < j) &&
                          (g.explicitHeaderCanvasHeight = k(
                            g.explicitHeaderCanvasHeight,
                            j
                          ));
          ...
          (p.prototype.redrawInPlace = function (a) {
            ...
            for (var c in b.renderContainers) {
              var d = b.renderContainers[c];
              a
                ? (d.adjustRows(d.prevScrollTop, null),
                  d.adjustColumns(d.prevScrollLeft, null))
                : (d.adjustRows(null, d.prevScrolltopPercentage),
  ...
  (function () {
    angular.module("ui.grid").factory("GridApi", [
      ...
      function (a, b, c, d, e, f) {
        ...
        return (
          (h.prototype.suppressEvents = function (a, b) {
            var c = this,
        ...
        return (
          ...
          (d.prototype.updateColumnDef = function (c, d) {
            ...
            ["minWidth", "maxWidth"].forEach(function (a) {
              ...
              (e.enableSorting =
                "undefined" != typeof c.enableSorting ? c.enableSorting : !0),
              ...
              "undefined" == typeof e.suppressRemoveSort &&
                (e.suppressRemoveSort =
                  "undefined" != typeof c.suppressRemoveSort
                    ...
                    : !1),
              (e.enableFiltering =
                "undefined" != typeof c.enableFiltering
                  ? c.enableFiltering
                  : !0),
        ...
        return {
          initialize: function (c) {
            return (
              ...
              (c.showHeader =
                "undefined" != typeof c.showHeader ? c.showHeader : !0),
              c.showHeader
                ? (c.headerRowHeight =
      ...
      function (a, b) {
        ...
        return (
          ...
          (c.prototype.minColumnsToRender = function () {
            for (
              var a = this, b = this.getViewportWidth(), c = 0, d = 0, e = 0;
              e < a.visibleColumnCache.length;
              e++
            ) {
              ...
              if (b > d) (d += f.drawnWidth ? f.drawnWidth : 0), c++;
                ...
                for (var g = 0, h = e; h >= e - c; h--)
                  g += a.visibleColumnCache[h].drawnWidth
                    ? a.visibleColumnCache[h].drawnWidth
                    : 0;
                b > g && c++;
              }
            }
          ...
          (c.prototype.getMargin = function (a) {
            var b = this,
              c = 0;
            return (
              b.viewportAdjusters.forEach(function (b) {
          ...
          (c.prototype.adjustScrollVertical = function (a, b, c) {
            (this.prevScrollTop !== a || c) &&
              (("undefined" == typeof a || void 0 === a || null === a) &&
                (a = (this.getCanvasHeight() - this.getViewportHeight()) * b),
          ...
          (c.prototype.adjustScrollHorizontal = function (a, b, c) {
            (this.prevScrollLeft !== a || c) &&
              (("undefined" == typeof a || void 0 === a || null === a) &&
                (a = (this.getCanvasWidth() - this.getViewportWidth()) * b),
          ...
          (c.prototype.adjustRows = function (a, b, c) {
            ...
            if (f.length > d.grid.options.virtualizationThreshold) {
              if ("undefined" != typeof a && null !== a) {
                if (
                  !d.grid.suppressParentScrollDown &&
                  d.prevScrollTop < a &&
                  h < d.prevRowScrollIndex + d.grid.options.scrollThreshold &&
                  g > h
                )
                  return;
                if (
                  !d.grid.suppressParentScrollUp &&
                  d.prevScrollTop > a &&
                  h > d.prevRowScrollIndex - d.grid.options.scrollThreshold &&
                  g > h
                )
          ...
          (c.prototype.adjustColumns = function (a, b) {
            ...
            var i = [];
            if (
              e.length > c.grid.options.columnVirtualizationThreshold &&
              c.getCanvasWidth() > c.getViewportWidth()
            ) {
  ...
  (function () {
    ...
    angular.module("ui.grid").factory("GridRowColumn", [
      ...
      function (a, b) {
        ...
        return (
          (c.prototype.getIntersectionValueRaw = function () {
          ...
          (c.prototype.getIntersectionValueFiltered = function () {
            ...
            if (this.col.cellFilter && "" !== this.col.cellFilter) {
              ...
              if (d) a = d(a);
                ...
                var e,
                  f = /([^:]*):([^:]*):?([\s\S]+)?/;
                null !== (e = f.exec(this.col.cellFilter)) &&
                  (a = b(e[1])(a, e[2], e[3]));
              }
            }
            return a;
          ...
          rowTemplateAssigner: function (d) {
            ...
            if (d.rowTemplate) {
              ...
              (d.getRowTemplateFn = f.promise),
                a.getTemplate(d.rowTemplate).then(
                  function (a) {
                    var b = c(a);
                    f.resolve(b);
                  },
                  function (a) {
                    throw new Error(
                      "Couldn't fetch/use row template '" + d.rowTemplate + "'"
                    );
                  }
                );
            } else
        ...
        return (
            ...
            for (var d = [], f = a.length, g = 0; f > g; g++) {
              ...
              if (h.noTerm || !b.isNullOrUndefined(h.term)) {
                ...
                (h.flags && h.flags.caseSensitive) || (j += "i"),
                  ...
                  h.condition
                    ? (i.condition = h.condition)
                    : (i.condition = e.guessCondition(h)),
                  (i.flags = angular.extend(
                    { caseSensitive: !1, date: !1 },
                    h.flags
                  )),
                  i.condition === c.filter.STARTS_WITH &&
                    (i.startswithRE = new RegExp("^" + i.term, j)),
                  i.condition === c.filter.ENDS_WITH &&
                    (i.endswithRE = new RegExp(i.term + "$", j)),
                  i.condition === c.filter.CONTAINS &&
                    (i.containsRE = new RegExp(i.term, j)),
                  i.condition === c.filter.EXACT &&
                    (i.exactRE = new RegExp("^" + i.term + "$", j)),
                  d.push(i);
              }
            }
            return d;
          ...
          (e.runColumnFilter = function (a, b, d, e) {
            var f,
              ...
              h = e.term;
            if (
              ((f = d.filterCellFiltered
                ? a.getCellDisplayValue(b, d)
                : a.getCellValue(b, d)),
            ...
            return (
              e.flags.date === !0 &&
                ((f = new Date(f)), (h = new Date(h.replace(/\\/g, "")))),
              e.condition === c.filter.GREATER_THAN
                ? f > h
                : e.condition === c.filter.GREATER_THAN_OR_EQUAL
                ? f >= h
                : e.condition === c.filter.LESS_THAN
                ? h > f
                : e.condition === c.filter.LESS_THAN_OR_EQUAL
                ? h >= f
                : !0
            );
          }),
              ...
              for (
                var f = [],
                  ...
                  h = function (a) {
                    ...
                    return (
                      a.forEach(function (a) {
                        ((!b.isNullOrUndefined(a.term) && "" !== a.term) ||
                          a.noTerm) &&
                          (c = !0);
                      }),
                      c
                ...
                var j = d[i];
                "undefined" != typeof j.filters &&
                  h(j.filters) &&
                  f.push({ col: j, filters: e.setupFilters(j.filters) });
              }
              if (f.length > 0) {
                for (
      ...
      function (a, b) {
        ...
        return (
          ...
          (d.getSortFn = function (a, b, c) {
            var e;
            return (
              d.colSortFnCache[b.colDef.name]
                ? (e = d.colSortFnCache[b.colDef.name])
                : void 0 !== b.sortingAlgorithm
                ? ((e = b.sortingAlgorithm),
                  (d.colSortFnCache[b.colDef.name] = b.sortingAlgorithm))
                : b.sortCellFiltered && b.cellFilter
                ? ((e = d.sortAlpha), (d.colSortFnCache[b.colDef.name] = e))
                : ((e = d.guessSortFn(b.colDef.type)),
                  e
                    ? (d.colSortFnCache[b.colDef.name] = e)
                    : (e = d.sortAlpha)),
              e
            );
          }),
          (d.prioritySort = function (a, b) {
            return void 0 !== a.sort.priority && void 0 !== b.sort.priority
              ? a.sort.priority < b.sort.priority
                ...
                ? 0
                : 1
              : a.sort.priority || void 0 === a.sort.priority
              ? -1
              : b.sort.priority || void 0 === b.sort.priority
              ? 1
              : 0;
          }),
              ...
              var j = c.slice(0),
                k = function (c, e) {
                  for (var i, k = 0, l = 0; 0 === k && l < f.length; ) {
                    ...
                    var m, n;
                    g.sortCellFiltered
                      ? ((m = a.getCellDisplayValue(c, g)),
                        (n = a.getCellDisplayValue(e, g)))
                      : ((m = a.getCellValue(c, g)),
                        (n = a.getCellValue(e, g))),
                      (k = i(m, n, c, e, h)),
                      l++;
                  }
                  return 0 === k
                    ? c.entity.$$uiGridIndex - e.entity.$$uiGridIndex
                    : h === b.ASC
                    ? k
                    : 0 - k;
                },
      ...
      function (f, g, l, m, n, o, p, q, r, s, t) {
        function u(a, b) {
          ...
          if (
            ...
            "axis" in b &&
              ...
              ((e = -1 * f), (f = 0)),
            (d = 0 === f ? e : f),
            "deltaY" in b && ((f = -1 * b.deltaY), (d = f)),
            "deltaX" in b && ((e = b.deltaX), 0 === f && (d = -1 * e)),
            0 !== f || 0 !== e)
          ) {
            if (1 === b.deltaMode) {
        ...
        var x = {
                ...
                a
                  ...
                  .replace(/^[A-Z]+$/, function (a) {
                    return angular.lowercase(
                      angular.uppercase(a.charAt(0)) + a.slice(1)
                    );
                  })
          ...
          isTouchEnabled: function () {
            ...
            return (
              ("ontouchstart" in g ||
                (g.DocumentTouch && l instanceof DocumentTouch)) &&
                (a = !0),
              a
            );
          },
          ...
          endsWith: function (a, b) {
            return a && b && "string" == typeof a
              ? -1 !== a.indexOf(b, a.length - b.length)
              : !1;
          },
          ...
          hashKey: function (a) {
            ...
            return (
              "object" === c && null !== a
                ? "function" == typeof (b = a.$$hashKey)
                  ? (b = a.$$hashKey())
                  : "undefined" != typeof a.$$hashKey && a.$$hashKey
                  ? (b = a.$$hashKey)
                  : void 0 === b && (b = a.$$hashKey = x.nextUid())
                : (b = a),
              c + ":" + b
            );
          },
        ...
        (x.focus = {
          ...
          byId: function (a, b) {
            ...
            var c = o(function () {
              ...
              d
                ? d.focus()
                : x.logWarn("[focus.byId] Element id " + c + " was not found.");
            });
          ...
          ["width", "height"].forEach(function (b) {
            ...
            (x["element" + d] = function (d, e) {
              var f = d;
              if (
                (f && "undefined" != typeof f.length && f.length && (f = d[0]),
                f)
              ) {
                var g = a(f);
                return 0 === f.offsetWidth && h.test(g.display)
                  ? x.swap(f, i, function () {
                      return c(f, b, e);
                    })
                  : c(f, b, e);
              ...
              (x["outerElement" + d] = function (a, b) {
                return a
                  ? x["element" + d].call(this, a, b ? "margin" : "border")
                  : null;
              });
          }),
          ...
          (x.getBorderSize = function (b, c) {
            ...
            var d = a(b);
            (c = c
              ? "border" + c.charAt(0).toUpperCase() + c.slice(1)
              : "border"),
              (c += "Width");
          ...
          (x.rtlScrollType = function B() {
            ...
            return (
              ...
              a.scrollLeft > 0
                ? (b = "default")
                : ((a.scrollLeft = 1), 0 === a.scrollLeft && (b = "negative")),
          ...
          (x.preEval = function (a) {
            ...
            if (b)
              return (
                (b[1] ? x.preEval(b[1]) : b[1]) +
                b[2] +
                (b[3] ? x.preEval(b[3]) : b[3])
              );
          ...
          (x.debounce = function (a, b, c) {
            function d() {
              ...
              var d = function () {
                ...
                i = c && !e;
              return (
                e && o.cancel(e), (e = o(d, b, !1)), i && (h = a.apply(g, f)), h
              );
            }
            var e, f, g, h;
            return (
        ...
        function (a, b, c, d, e, f, g) {
          var h = {
            ...
            cellNavColumnBuilder: function (a, b, c) {
              ...
              return (
                (a.allowCellFocus =
                  void 0 === a.allowCellFocus ? !0 : a.allowCellFocus),
                d.all(e)
              );
            },
              ...
              return {
                pre: function (a, f, g, h) {
                  ...
                  b.initializeGrid(j),
                    ...
                    (h.cellNav.broadcastCellNav = j.cellNav.broadcastCellNav =
                      function (a, b, d) {
                        (b = !(void 0 === b || !b)),
                    ...
                    (h.cellNav.clearFocus = j.cellNav.clearFocus =
                      function () {
          ...
          return {
            ...
            link: function (a, b, c, d) {
              ...
              if (j.grid.api.cellNav && a.col.colDef.allowCellFocus) {
                ...
                (a.focused = !1),
                  b.attr("tabindex", -1),
                  b.find("div").on("click", function (b) {
                    j.cellNav.broadcastCellNav(
                      new g(a.row, a.col),
                      b.ctrlKey || b.metaKey,
                      b
                    ),
                  ...
                  b.on("mousedown", f),
                  j.grid.api.edit &&
                    (j.grid.api.edit.on.beginCellEdit(a, function () {
                      b.off("mousedown", f);
                    }),
          ...
          var d = {
            ...
            defaultGridOptions: function (a) {
              (a.cellEditableCondition =
                void 0 === a.cellEditableCondition
                  ? !0
                  : a.cellEditableCondition),
            ...
            link: function (b, l, m, n) {
              function o() {
                l.on("dblclick", u),
                  ...
                  n &&
                    n.grid.api.cellNav &&
                    ((G = n.grid.api.cellNav.on.viewPortKeyDown(
                      b,
                      function (a, c) {
                        null !== c &&
                          (c.row !== b.row ||
              ...
              function v(h) {
                if (!E && t(b.col, b.row)) {
                  (B = g(b.row.getQualifiedColField(b.col))),
                    ...
                    (z = b.col.colDef.editModelField
                      ? z.replace(
                          d.MODEL_COL_FIELD,
                          f.preEval("row.entity." + b.col.colDef.editModelField)
                        )
                      : z.replace(
                          d.MODEL_COL_FIELD,
                          b.row.getQualifiedColField(b.col)
                        )),
                    (z = z.replace(d.COL_FIELD, "grid.getCellValue(row, col)"));
                  var k = b.col.colDef.editDropdownFilter
                  ...
                  if (n)
                    ...
                    o
                      ? (b.editDropdownOptionsArray = y(b.row.entity, o))
                ...
                var F = function () {},
                  ...
                  H = function () {
                    b.col.colDef.enableCellEdit && b.row.enableCellEdit !== !1
                      ? b.beginEditEventsWired || o()
                      : b.beginEditEventsWired && r();
                  };
                H();
              ...
              return {
                ...
                post: function (c, d, e, f) {
                  ...
                  c.$on(b.events.BEGIN_CELL_EDIT, function () {
                    d[0].focus(),
                      (d[0].style.width =
                        d[0].parentElement.offsetWidth - 1 + "px"),
                    ...
                    d.on("keydown", function (d) {
                      ...
                      if (g && g.grid.api.cellNav)
                        (d.uiGridTargetRenderContainerId = h.containerId),
          ...
          var g = {
              ...
              (a.exporterSuppressMenu = a.exporterSuppressMenu === !0),
                ...
                (a.exporterMenuSelectedData =
                  void 0 !== a.exporterMenuSelectedData
                    ...
                    : !0),
                (a.exporterMenuCsv =
                  void 0 !== a.exporterMenuCsv ? a.exporterMenuCsv : !0),
                (a.exporterMenuPdf =
                  void 0 !== a.exporterMenuPdf ? a.exporterMenuPdf : !0),
              ...
              return (
                d.forEach(function (b, c) {
                  b.colDef.exporterSuppressExport !== !0 &&
                    -1 === a.options.exporterSuppressColumns.indexOf(b.name) &&
                    e.push({
                      name: b.field,
            ...
            getData: function (a, d, e, f) {
              ...
              switch (d) {
                ...
                case b.SELECTED:
                  a.api.selection
                    ? (g = a.api.selection.getSelectedGridRows())
                    : c.logError(
                  ...
                  if (c.exporterEnableExporting !== !1) {
                    ...
                    h.forEach(function (d, h) {
                      if (
                        ...
                        -1 === a.options.exporterSuppressColumns.indexOf(d.name)
                      ) {
                        var i = f
            ...
            pdfExport: function (a, b, c) {
              ...
              this.loadAllDataIfNeeded(a, b, c).then(function () {
                ...
                d.isIE() || -1 !== navigator.appVersion.indexOf("Edge")
          ...
          var j = {
            ...
            insertGroupHeader: function (a, b, c, d, g) {
              ...
              for (
                ...
                m &&
                  m[l(d[n].currentValue)] &&
                  (m = m[l(d[n].currentValue)].children);
              var o;
              for (
                m && m[l(i)]
                  ? ((o = m[l(i)].row), (o.entity = {}))
                  : ((o = new e({}, null, a)),
                    f.rowTemplateAssigner.call(a, o)),
                  o.entity["$$" + d[g].col.uid] = { groupVal: k },
                  o.treeLevel = g,
                  o.groupHeader = !0,
                  o.internalRow = !0,
                  o.enableCellEdit = !1,
          ...
          handleScroll: function (a) {
            if (
              ...
              a.grid.scrollDirection === d.scrollDirection.UP
                ? ((b = a.y.percentage), c >= b && g.loadData(a.grid))
                : a.grid.scrollDirection === d.scrollDirection.DOWN &&
                  ((b = 1 - a.y.percentage), c >= b && g.loadData(a.grid));
            }
          },
          loadData: function (a) {
            (a.infiniteScroll.previousVisibleRows =
              ...
              c(function () {
                ...
                a.infiniteScroll.scrollDown &&
                  ...
                  a.infiniteScroll.direction === d.scrollDirection.UP &&
                    ((i = a.infiniteScroll.prevScrollTop || 0),
                  ...
                  a.infiniteScroll.direction === d.scrollDirection.DOWN &&
                    ((j =
                      a.infiniteScroll.prevScrollTop ||
                      a.infiniteScroll.previousVisibleRows * f - e),
                    g.adjustInfiniteScrollPosition(a, j),
                    c(function () {
                      b.resolve();
                    }));
                ...
                post: function (a, b, e, f) {
                  if (a.col.colDef.enableColumnMoving) {
                      ...
                      q = function (b) {
                        (h = a.grid.element[0].getBoundingClientRect().left),
                          a.grid.hasLeftContainer() &&
                            (h +=
                              a.grid.renderContainers.left.header[0].getBoundingClientRect()
                                .width),
                          (i = b.pageX),
                          (j = 0),
                          (k = h + a.grid.getViewportWidth()),
                          "mousedown" === b.type
                            ? (d.on("mousemove", r), d.on("mouseup", s))
                            : "touchstart" === b.type &&
                              (d.on("touchmove", r), d.on("touchend", s));
                      },
                      r = function (a) {
                        var b = a.pageX - i;
                        0 !== b &&
                          ...
                          if (0 > j) {
                            ...
                            if (a.grid.isRTL()) {
                              for (h = e + 1; h < d.length; h++)
                                if (
                                  (angular.isUndefined(d[h].colDef.visible) ||
                                    d[h].colDef.visible === !0) &&
                                  ((i +=
                                    d[h].drawnWidth ||
                                    d[h].width ||
                                    d[h].colDef.width),
                            ...
                            if (a.grid.isRTL()) {
                              for (k = e - 1; k > 0; k--)
                                if (
                                  (angular.isUndefined(d[k].colDef.visible) ||
                                    d[k].colDef.visible === !0) &&
                                  ((m +=
                                    d[k].drawnWidth ||
                                    d[k].width ||
                                    d[k].colDef.width),
                    ...
                    var v = function () {
                        ...
                        e > d &&
                          ((m = a.col.drawnWidth + (d - e)),
                          (c.width = m + "px")),
                          l.css(c);
                      },
                      w = function (b) {
                        for (
                          var c = a.grid.columns, d = 0, e = 0;
                          e < c.length;
                          e++
                        )
                          (angular.isUndefined(c[e].colDef.visible) ||
                            c[e].colDef.visible === !0) &&
                            (d +=
                              c[e].drawnWidth ||
                              c[e].width ||
                              c[e].colDef.width);
                        ...
                        for (var q = 0, r = 0; r < c.length; r++)
                          if (
                            angular.isUndefined(c[r].colDef.visible) ||
                            c[r].colDef.visible === !0
                          ) {
                        ...
                        void 0 === a.newScrollLeft
                          ? (j += b)
                          : (j = a.newScrollLeft + i - q),
                          m < a.col.drawnWidth &&
                            ((m += Math.abs(b)), l.css({ width: m + "px" }));
                      };
                  }
                },
              };
        ...
        var b = {
          initializeGrid: function (a) {
            ...
            var d = function (b) {
              ...
              return (
                f > e.length &&
                  ((d = a.options.paginationCurrentPage = 1),
                  (f = (d - 1) * c)),
                e.slice(f, f + c)
              );
            };
        ...
        function (a, b, c, d) {
          return {
            ...
            link: function (e, f, g, h) {
              ...
              var l = function () {
                  (e.showingLow =
                    (j.paginationCurrentPage - 1) * j.paginationPageSize + 1),
                    (e.showingHigh = Math.min(
                      j.paginationCurrentPage * j.paginationPageSize,
                      j.totalItems
                    ));
                },
                m = e.$watch(
                ...
                n = e.$watch(
                  ...
                  function (b, c) {
                    if (b !== c && void 0 !== c) {
                      if (
                        !angular.isNumber(j.paginationCurrentPage) ||
                      ...
                      if (
                        ...
                        return void (j.paginationCurrentPage =
                          e.paginationApi.getTotalPages());
                      l(),
                        a.onPaginationChanged(
                          e.grid,
                          j.paginationCurrentPage,
              ...
              e.$on("$destroy", function () {
                ...
                (e.cantPageForward = function () {
                  return j.totalItems > 0
                    ? j.paginationCurrentPage >= e.paginationApi.getTotalPages()
                    : j.data.length < 1;
                }),
              ...
              link: function (f, g, h, i) {
                ...
                function l(a, b) {
                  a.originalEvent && (a = a.originalEvent),
                    a.preventDefault(),
                    (o =
                      (a.targetTouches ? a.targetTouches[0] : a).clientX - p),
                    0 > o
                      ? (o = 0)
                      : o > i.grid.gridWidth && (o = i.grid.gridWidth);
                ...
                function m(a, b) {
                  a.originalEvent && (a = a.originalEvent),
                    ...
                    e.remove(),
                    (o =
                      (a.changedTouches ? a.changedTouches[0] : a).clientX - p);
                  var c = o - n;
                ...
                var r = function (b, c) {
                    b.originalEvent && (b = b.originalEvent),
                      ...
                      (n =
                        (b.targetTouches ? b.targetTouches[0] : b).clientX - p),
          ...
          var f = {
            ...
            considerSetTimer: function (b, c) {
              if (
                ...
                c.isDirty &&
                  !c.isSaving &&
                  -1 !== b.options.rowEditWaitInterval)
              ) {
            ...
            getRowVal: function (a, b) {
              ...
              return (
                a.options.saveRowIdentity
                  ...
                  : ((c.identity = !1),
                    (c.row =
                      a.renderContainers.body.visibleRowCache.indexOf(b))),
                c
              );
            },
          ...
          return {
            ...
            link: function (a, d, e, f) {
              function g(a, c) {
                c.stopPropagation(),
                  c.shiftKey
                    ? b.shiftSelect(i, a, c, i.options.multiSelect)
                    : c.ctrlKey || c.metaKey
                    ...
                    : b.toggleRowSelection(
                        ...
                        c,
                        i.options.multiSelect &&
                          !i.options.modifierKeysToMultiSelect,
                        i.options.noUnselect
                      );
              }
              function h(a) {
                ...
                "undefined" != typeof a.treeAggregationType &&
                  ...
                  typeof c.treeCustomAggregations[a.treeAggregationType]
                    ...
                    : "undefined" !=
                      ...
                      (b.treeAggregation.label =
                        i.nativeAggregations()[a.treeAggregationType].label))),
                ...
                h = function (c) {
                  ...
                  ("undefined" == typeof c.treeLevel ||
                    ...
                    "undefined" != typeof c.treeLevel &&
                      null !== c.treeLevel &&
                      c.treeLevel >= 0 &&
                      (f.push(c), e++, (d = i.setCurrentState(f))),
