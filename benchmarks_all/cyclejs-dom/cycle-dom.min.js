  ...
  return (function e(t, n, r) {
  ...
  })(
    {
      ...
      13: [
        ...
        {
          "./vendor/camel-case-regexp": 14,
          "./vendor/non-word-regexp": 15,
          "./vendor/trailing-digit-regexp": 16,
          "lower-case": 10,
        },
      ],
      14: [
      ...
      17: [
        function (require, module, exports) {
          ...
          function createVirtualDomNode(el, attr) {
            var ns =
              el.namespaceURI !== HTML_NAMESPACE ? el.namespaceURI : null;
            var key =
              attr && el.getAttribute(attr) ? el.getAttribute(attr) : null;
            return new VNode(
              el.tagName,
              createProperties(el),
          ...
          function createProperty(attr) {
            ...
            return { name: name, value: value, isAttr: isAttr || false };
          }
        ...
        },
        {
          "./namespace-map": 18,
          "./property-map": 19,
          "virtual-dom/vnode/vnode": 44,
          "virtual-dom/vnode/vtext": 46,
        },
      ],
      18: [
        function (require, module, exports) {
      ...
      20: [
        ...
        { "./property-config": 22, "escape-html": 3 },
      ],
      21: [
        function (require, module, exports) {
          var escape = require("escape-html");
        ...
        },
        {
          ...
          "escape-html": 3,
          "param-case": 12,
          "virtual-dom/virtual-hyperscript/hooks/attribute-hook": 32,
          "virtual-dom/virtual-hyperscript/hooks/soft-set-hook": 34,
          "virtual-dom/vnode/is-thunk": 38,
          "virtual-dom/vnode/is-vnode": 40,
          "virtual-dom/vnode/is-vtext": 41,
          "virtual-dom/vnode/is-widget": 42,
          xtend: 50,
        },
      ],
      22: [
        function (require, module, exports) {
          var types = { BOOLEAN: 1, OVERLOADED_BOOLEAN: 2 };
          var properties = {
            accept: true,
            acceptCharset: true,
            accessKey: true,
      ...
      26: [
        ...
        { "../vnode/is-vhook.js": 39, "is-object": 9 },
      ],
      27: [
        function (require, module, exports) {
      ...
      51: [
        ...
        },
        {
          ...
          "./render-dom": 54,
          "./render-html": 55,
          "./virtual-hyperscript": 58,
          "./virtual-hyperscript-svg": 57,
          "hyperscript-helpers": 6,
        },
      ],
      52: [
        function (require, module, exports) {
            ...
            function getEventsStreamForSelector(mockedEventTypes) {
              return function getEventsStream(eventType) {
                for (var key in mockedEventTypes) {
                  if (
                    mockedEventTypes.hasOwnProperty(key) &&
                    key === eventType
                  ) {
        ...
        function (require, module, exports) {
          (function (global) {
            ...
            function wrapTopLevelVTree(vtree, rootElem) {
              ...
              var vtreeId =
                _vtree$properties$id === undefined ? "" : _vtree$properties$id;
              var _vtree$properties$className = vtree.properties.className;
              var vtreeClass =
                _vtree$properties$className === undefined
                  ? ""
                  : _vtree$properties$className;
              var sameId = vtreeId === rootElem.id;
              var sameClass = vtreeClass === rootElem.className;
              var sameTagName =
                vtree.tagName.toUpperCase() === rootElem.tagName;
            ...
            function makeDiffAndPatchToElement$(rootElem) {
              return function diffAndPatchToElement$(_ref) {
                ...
                rootElem = VDOM.patch(
                  rootElem,
                  VDOM.diff(prevVTree, nextVTree)
                );
                return Rx.Observable.just(rootElem);
              };
            }
            function renderRawRootElem$(vtree$, domContainer) {
              var diffAndPatchToElement$ =
                makeDiffAndPatchToElement$(domContainer);
              return vtree$
            ...
            function isolateSink(sink, scope) {
              return sink.map(function (vtree) {
                ...
                var vtreeClass =
                  _vtree$properties$className2 === undefined
                    ? ""
                    : _vtree$properties$className2;
                ...
                if (vtree.properties.attributes) {
                  var vtreeAttrClass =
                    vtree.properties.attributes["class"] || "";
            ...
            function makeSimulateBubbling(namespace, rootEl) {
              ...
              return function simulateBubbling(ev) {
                ...
                for (
                  ...
                  if (
                    matchesSelector(el, descendantSel) ||
                    matchesSelector(el, topSel)
                  ) {
            ...
            function makeEventsSelector(rootEl$, namespace) {
              return function events(eventName) {
                ...
                return rootEl$
                  .first()
                  .flatMapLatest(function (rootEl) {
                    if (!namespace || namespace.length === 0) {
                      return fromEvent(rootEl, eventName, useCapture);
                    }
                    var simulateBubbling = makeSimulateBubbling(
                      namespace,
                      rootEl
                    );
                    return fromEvent(rootEl, eventName, useCapture).filter(
                      simulateBubbling
                    );
                  })
                  .share();
            ...
            function makeElementSelector(rootEl$) {
              return function select(selector) {
                ...
                var element$ = rootEl$.map(function (rootEl) {
                  ...
                  var nodeList = rootEl.querySelectorAll(
                    childNamespace.join(" ")
                  );
                  ...
                  return array.filter(
                    makeIsStrictlyInRootScope(childNamespace)
                  );
                });
                return {
                  observable: element$,
            ...
            function validateDOMSink(vtree$) {
              if (!vtree$ || typeof vtree$.subscribe !== "function") {
                throw new Error(
                  "The DOM driver function expects as input an " +
            ...
            function makeDOMDriver(container, options) {
              ...
              if (typeof container === "string" && domContainer === null) {
                throw new Error(
                  "Cannot render into unknown element `" + container + "`"
                );
              } else if (!isElement(domContainer)) {
                throw new Error(
                  "Given container is not a DOM element neither a selector " +
                    "string."
                );
              }
              var _ref3 = options || {};
              ...
              var onError =
                _ref3$onError === undefined ? defaultOnErrorFn : _ref3$onError;
              if (typeof onError !== "function") {
                throw new Error(
                  "You provided an `onError` to makeDOMDriver but it was " +
                    "not a function. It should be a callback function to handle errors."
                );
              }
              return function domDriver(vtree$) {
                validateDOMSink(vtree$);
                var rootElem$ = renderRawRootElem$(vtree$, domContainer)
      ...
      55: [
        ...
        { "./transposition": 56, "vdom-to-html": 21 },
      ],
      56: [
        function (require, module, exports) {
          (function (global) {
      ...
      57: [
        function (require, module, exports) {
          ...
          module.exports = { svg: svg, SupportedSvgTags: SupportedSvgTags };
        ...
        },
        {
          "./virtual-hyperscript": 58,
          "virtual-dom/virtual-hyperscript/hooks/attribute-hook": 32,
          "virtual-dom/virtual-hyperscript/svg-attribute-namespace": 36,
          "x-is-array": 49,
        },
      ],
      58: [
        ...
        {
          "virtual-dom/virtual-hyperscript/hooks/ev-hook.js": 33,
          "virtual-dom/virtual-hyperscript/hooks/soft-set-hook.js": 34,
          "virtual-dom/virtual-hyperscript/parse-tag.js": 35,
          "virtual-dom/vnode/is-thunk": 38,
          "virtual-dom/vnode/is-vhook": 39,
          "virtual-dom/vnode/is-vnode": 40,
          "virtual-dom/vnode/is-vtext": 41,
          "virtual-dom/vnode/is-widget": 42,
          "virtual-dom/vnode/vnode.js": 44,
          "virtual-dom/vnode/vtext.js": 46,
          "x-is-array": 49,
        },
      ],
    },
