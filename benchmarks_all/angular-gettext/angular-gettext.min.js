angular.module("gettext", []),
  angular.module("gettext").constant("gettext", function (a) {
    return a;
  }),
  angular.module("gettext").factory("gettextCatalog", [
    ...
    function (a, b, c, d, e, f) {
      ...
      var h,
        ...
        l = function (a) {
          return h.debug && h.currentLanguage !== h.baseLanguage
            ? h.debugPrefix + a
            : a;
        },
        m = function (a) {
          return h.showTranslatedMarkers
            ? h.translatedMarkerPrefix + a + h.translatedMarkerSuffix
            : a;
        };
      return (h = {
        debug: !1,
        ...
        setStrings: function (a, b) {
          ...
          for (var c in b) {
            var d = b[c];
            if (
              (k && (c = angular.element("<span>" + c + "</span>").html()),
              angular.isString(d) || angular.isArray(d))
            ) {
              var e = {};
              (e[i] = d), (d = e);
            }
        ...
        getString: function (a, c, d) {
          ...
          return (
            (a =
              this.getStringFormFor(this.currentLanguage, a, 1, d) ||
              this.getStringFormFor(f, a, 1, d) ||
              l(a)),
            (a = c ? e(a)(c) : a),
            m(a)
          );
        ...
        getPlural: function (a, c, d, f, g) {
          ...
          return (
            (c =
              this.getStringFormFor(this.currentLanguage, c, a, g) ||
              this.getStringFormFor(h, c, a, g) ||
              l(1 === a ? c : d)),
            f && ((f.$count = a), (c = e(c)(f))),
            m(c)
          );
        ...
        loadRemote: function (a) {
          return c({ method: "GET", url: a, cache: h.cache }).then(function (
            a
          ) {
            var b = a.data;
  ...
  angular.module("gettext").directive("translate", [
    ...
    function (a, b, c, d, e, f) {
      ...
      var i = parseInt(
          (/msie (\d+)/.exec(angular.lowercase(e.navigator.userAgent)) ||
            [])[1],
          10
        ),
        j = "translateParams";
      return {
        ...
        compile: function (e, g) {
          f.assert(
            !g.translatePlural || g.translateN,
            "translate-n",
            "translate-plural"
          ),
            f.assert(
              !g.translateN || g.translatePlural,
              "translate-plural",
              "translate-n"
            );
          var j = f.trim(e.html()),
          ...
          return (
            i <= 8 && "<!--IE fix-->" === j.slice(-13) && (j = j.slice(0, -13)),
            {
              post: function (e, g, i) {
                function m(b) {
                  b = b || null;
  ...
  angular.module("gettext").factory("gettextUtil", function () {
    ...
    return { trim: d, assert: a, startsWith: b, lcFirst: c };
  });
