...
!(function (e, t, n) {
  ...
  function a(e, n, a, o, i, r) {
    ...
    function l(e) {
      return u[e]
        ? u[e]
        : (u[e] = n.get(e, { cache: r }).then(function (e) {
            return e.data;
          }));
    }
    this.compile = function (t) {
      t.template &&
        /\.html$/.test(t.template) &&
        (console.warn(
      ...
      return (
        t.titleTemplate &&
          (d.$template = e
            .all([d.$template, l(t.titleTemplate)])
            .then(function (e) {
              var t = angular.element(e[0]);
              return (
                s('[ng-bind="title"]', t[0]).removeAttr("ng-bind").html(e[1]),
                t[0].outerHTML
              );
            })),
        t.contentTemplate &&
          (d.$template = e
            .all([d.$template, l(t.contentTemplate)])
            .then(function (e) {
              var n = angular.element(e[0]),
                a = s('[ng-bind="content"]', n[0])
                  .removeAttr("ng-bind")
                  .html(e[1]);
            ...
            function r(t, n, r) {
              ...
              (d.$resetMatches = function () {
                ...
                (l.select = function (e) {
                  if (-1 !== e) {
                    ...
                    n.$setViewValue(t),
                      ...
                      angular.isDefined(u.onSelect) &&
                        angular.isFunction(u.onSelect) &&
                        u.onSelect(t, e, l);
                  }
                }),
                (l.$isVisible = function () {
                  return u.minLength && n
                    ? d.$matches.length &&
                        angular.isString(n.$viewValue) &&
                        n.$viewValue.length >= u.minLength
                    : !!d.$matches.length;
                }),
                (l.$getIndex = function (e) {
                  ...
                  for (
                    t = d.$matches.length;
                    t-- && !angular.equals(d.$matches[t].value, e);
                ...
                (l.$onKeyDown = function (e) {
                  /(38|40|13)/.test(e.keyCode) &&
                    (!l.$isVisible() ||
                      (13 === e.keyCode && -1 === d.$activeIndex) ||
                      (e.preventDefault(), e.stopPropagation()),
                    13 === e.keyCode && d.$matches.length
                      ? l.select(d.$activeIndex)
                      : 38 === e.keyCode && d.$activeIndex > 0
                      ? d.$activeIndex--
                      : 40 === e.keyCode &&
                        d.$activeIndex < d.$matches.length - 1
                      ? d.$activeIndex++
                      : angular.isUndefined(d.$activeIndex) &&
                        (d.$activeIndex = 0),
                    d.$digest());
                });
              var f = l.show;
              l.show = function () {
                f(),
                  i(
                    function () {
                      l.$element &&
                        (l.$element.on("mousedown", l.$onMouseDown),
      ...
      .filter("bsAsyncFilter", [
        ...
        function (e) {
          return function (t, n, a) {
            return t && angular.isFunction(t.then)
              ? t.then(function (t) {
        ...
        function (e, t, n, a, o) {
          ...
          return {
            ...
            link: function (e, t, n, r) {
              ...
              var u = angular.isDefined(s.filter) ? s.filter : i.filter,
                c = s.limit || i.limit,
                d = s.comparator || i.comparator,
                f = n.bsOptions;
              u && ((f += " | " + u + ":$viewValue"), d && (f += ":" + d)),
                c && (f += " | limitTo:" + c);
              var p = o(f),
                g = a(t, r, s);
              if (s.watchOptions) {
              ...
              e.$watch(n.ngModel, function (t, n) {
                (e.$modelValue = t),
                  p.valuesFn(e, r).then(function (e) {
                    return s.selectMode && !e.length && t.length > 0
                      ? void r.$setViewValue(
                ...
                r.$formatters.push(function (e) {
                  ...
                  return t
                    ? t
                    : angular.isDefined(e) && "object" != typeof e
                    ? e
                    : "";
                }),
                (r.$render = function () {
      ...
      .provider("$tooltip", function () {
        ...
        this.$get = [
          ...
          function (n, a, o, i, r, s, l, u, c, d, f) {
            function p(i, r) {
              function s() {
                O.$emit(V.prefixEvent + ".show", F),
                  angular.isDefined(V.onShow) &&
                    angular.isFunction(V.onShow) &&
                    V.onShow(F);
              }
              function p() {
                if (
                  (O.$emit(V.prefixEvent + ".hide", F),
                  angular.isDefined(V.onHide) &&
                    angular.isFunction(V.onHide) &&
                    V.onHide(F),
                  B === z)
                ) {
                  if (q && "focus" === V.trigger) return i[0].blur();
                  A();
                }
              }
              function $() {
                ...
                angular.forEach(e, function (e) {
                  "click" === e || "contextmenu" === e
                    ? i.on(e, F.toggle)
                    : "manual" !== e &&
                      (i.on("hover" === e ? "mouseenter" : "focus", F.enter),
              ...
              function w() {
                for (var e = V.trigger.split(" "), t = e.length; t--; ) {
                  ...
                  "click" === n || "contextmenu" === n
                    ? i.off(n, F.toggle)
                    : "manual" !== n &&
                      (i.off("hover" === n ? "mouseenter" : "focus", F.enter),
              ...
              function y() {
                "focus" !== V.trigger
                  ? B.on("keyup", F.$onKeyUp)
                  : i.on("keyup", F.$onFocusKeyUp);
              }
              function b() {
                "focus" !== V.trigger
                  ? B.off("keyup", F.$onKeyUp)
                  : i.off("keyup", F.$onFocusKeyUp);
              }
              function D() {
                f(
                  function () {
              ...
              H.then(function (e) {
                ...
                (F.init = function () {
                  V.delay &&
                    angular.isNumber(V.delay) &&
                    (V.delay = { show: V.delay, hide: V.delay }),
                    "self" === V.container
                      ? (R = i)
                      : angular.isElement(V.container)
                      ? (R = V.container)
                      : V.container && (R = m(V.container)),
                    $(),
                    V.target &&
                      (V.target = angular.isElement(V.target)
                        ? V.target
                        : m(V.target)),
                    V.show &&
                      O.$$postDigest(function () {
                ...
                (F.show = function () {
                  if (V.bsEnabled && !F.$isShown) {
                    O.$emit(V.prefixEvent + ".show.before", F),
                      angular.isDefined(V.onBeforeShow) &&
                        angular.isFunction(V.onBeforeShow) &&
                        V.onBeforeShow(F);
                    var e, t;
                    V.container
                      ? ((e = R),
                        (t = R[0].lastChild
                          ? angular.element(R[0].lastChild)
                          : null))
                      : ((e = null), (t = i)),
                      B && A(),
                      (Y = F.$scope.$new()),
                      (B = F.$element = L.link(Y, function (e, t) {})),
                      B.css({
                        top: "-9999px",
                        left: "-9999px",
                        right: "auto",
                      ...
                      V.animation && B.addClass(V.animation),
                      V.type && B.addClass(V.prefixClass + "-" + V.type),
                      V.customClass && B.addClass(V.customClass),
                      t ? t.after(B) : e.prepend(B),
                      (F.$isShown = O.$isShown = !0),
                      g(O),
                      F.$applyPlacement(),
                      angular.version.minor <= 2
                        ? l.enter(B, e, t, s)
                        : l.enter(B, e, t).then(s),
                      g(O),
                      d(function () {
                        B && B.css({ visibility: "visible" }),
                          V.keyboard &&
                            ("focus" !== V.trigger && F.focus(), y());
                      }),
                      V.autoClose && D();
                  }
                }),
              ...
              (F.hide = function (e) {
                F.$isShown &&
                  (O.$emit(V.prefixEvent + ".hide.before", F),
                  angular.isDefined(V.onBeforeHide) &&
                    angular.isFunction(V.onBeforeHide) &&
                    V.onBeforeHide(F),
                  (q = e),
                  (z = B),
                  angular.version.minor <= 2
                ...
                (F.$applyPlacement = function () {
                  if (B) {
                    ...
                    a && (t = t.replace(n, "") || e.placement),
                      B.addClass(V.placement);
                    var o = x(),
                      i = B.prop("offsetWidth"),
                      r = B.prop("offsetHeight");
                    if (
                      ((F.$viewport =
                        V.viewport && m(V.viewport.selector || V.viewport)),
                      a)
                    ) {
                      var s = t,
                        l = x(F.$viewport);
                      /bottom/.test(s) && o.bottom + r > l.bottom
                        ? (t = s.replace("bottom", "top"))
                        : /top/.test(s) &&
                          o.top - r < l.top &&
                          (t = s.replace("top", "bottom")),
                        /left/.test(s) && o.left - i < l.left
                          ? (t = t.replace("left", "right"))
                          : /right/.test(s) &&
                            o.right + i > l.width &&
                            (t = t.replace("right", "left")),
                        B.removeClass(s).addClass(t);
                    }
                    var u = C(t, o, i, r);
                    T(u, t);
                  }
                ...
                (F.$onKeyUp = function (e) {
                  27 === e.which &&
                    F.$isShown &&
                    (F.hide(), e.stopPropagation());
                }),
                (F.$onFocusKeyUp = function (e) {
                  27 === e.which && (i[0].blur(), e.stopPropagation());
                }),
                (F.$onFocusElementMouseDown = function (e) {
                  V.mouseDownPreventDefault && e.preventDefault(),
                    V.mouseDownStopPropagation && e.stopPropagation(),
        ...
        function (e, t, n, a, o, i) {
          return {
            ...
            link: function (e, t, a, r) {
              ...
              angular.isDefined(c) &&
                (u.test(c) ? (l.target = !1) : (l.target = c)),
                e.hasOwnProperty("title") || (e.title = ""),
                a.$observe("title", function (t) {
                ...
                a.bsEnabled &&
                  e.$watch(a.bsEnabled, function (e, t) {
                    s &&
                      angular.isDefined(e) &&
                      (angular.isString(e) &&
                        (e = !!e.match(/true|1|,?(tooltip),?/i)),
                      e === !1 ? s.setEnabled(!1) : s.setEnabled(!0));
                  }),
                a.viewport &&
                  e.$watch(a.viewport, function (e) {
    ...
    angular
      ...
      .directive("bsTimepicker", [
        ...
        function (e, t, a, o, i, r) {
          var s = r.defaults,
            l = /(ip[ao]d|iphone|android)/gi.test(e.navigator.userAgent);
          return {
            restrict: "EAC",
            require: "ngModel",
            link: function (e, t, a, u) {
              ...
              function d() {
                return !u.$dateValue || isNaN(u.$dateValue.getTime())
                  ? ""
                  : $(u.$dateValue, f.timeFormat);
              }
              var f = { scope: e };
              angular.forEach(
                [
              ...
              angular.forEach(["minTime", "maxTime"], function (e) {
                ...
                u.$parsers.unshift(function (e) {
                  ...
                  return !a || isNaN(a.getTime())
                    ? (u.$setValidity("date", !1), n)
                    : (c(a),
                      "string" === f.timeType
                        ? ((t = h.timezoneOffsetAdjust(a, f.timezone, !0)),
                          $(t, f.modelTimeFormat || f.timeFormat))
                        : ((t = h.timezoneOffsetAdjust(
                            u.$dateValue,
                            f.timezone,
                            !0
                          )),
                  ...
                  return (
                    (t =
                      angular.isUndefined(e) || null === e
                        ...
                        ? e
                        : "string" === f.timeType
                        ? h.parse(e, null, f.modelTimeFormat)
                        : "unix" === f.timeType
                        ? new Date(1e3 * e)
                        : new Date(e)),
            ...
            function c(o) {
              ...
              return (
                ...
                (x.checkPosition = function () {
                  if (T.length) {
                    if (
                      ((k = (g ? a.pageYOffset : m.prop("scrollTop")) || 0),
                      (S = Math.max(a.innerHeight, f.prop("clientHeight"))),
                      k < T[0].offsetTop && w !== T[0].target)
                    )
                      return x.$activateElement(T[0]);
                    for (var e = T.length; e--; )
                      if (
                        !angular.isUndefined(T[e].offsetTop) &&
                        null !== T[e].offsetTop &&
                        w !== T[e].target &&
                        !(
                          k < T[e].offsetTop ||
                          (T[e + 1] && k > T[e + 1].offsetTop)
                        )
                      )
                        return x.$activateElement(T[e]);
                  }
                }),
      ...
      .provider("$select", function () {
        ...
        this.$get = [
          ...
          function (t, a, o, i, r) {
            function s(o, s, l) {
              var c = {},
                d = angular.extend({}, e, l);
              c = i(o, d);
              var f = c.$scope;
              (f.$matches = []),
                d.multiple ? (f.$activeIndex = []) : (f.$activeIndex = -1),
                (f.$isMultiple = d.multiple),
                (f.$showAllNoneButtons = d.allNoneButtons && d.multiple),
                (f.$iconCheckmark = d.iconCheckmark),
                (f.$allText = d.allText),
                (f.$noneText = d.noneText),
                ...
                (c.activate = function (e) {
                  return (
                    d.multiple
                      ? (c.$isActive(e)
                          ? f.$activeIndex.splice(f.$activeIndex.indexOf(e), 1)
                          : f.$activeIndex.push(e),
                        d.sort &&
                          f.$activeIndex.sort(function (e, t) {
                            return e - t;
                          }))
                      : (f.$activeIndex = e),
                    f.$activeIndex
                ...
                (c.select = function (e) {
                  if (
                    !(angular.isUndefined(e) || 0 > e || e >= f.$matches.length)
                  ) {
                    ...
                    f.$apply(function () {
                      c.activate(e),
                        d.multiple
                          ? s.$setViewValue(
                              f.$activeIndex.map(function (e) {
                                return angular.isUndefined(f.$matches[e])
                                  ? null
                                  : f.$matches[e].value;
                              })
                            )
                          : (d.toggle
                              ? s.$setViewValue(t === s.$modelValue ? n : t)
                              : s.$setViewValue(t),
                            c.hide());
                    }),
                      f.$emit(d.prefixEvent + ".select", t, e, c),
                      angular.isDefined(d.onSelect) &&
                        angular.isFunction(d.onSelect) &&
                        d.onSelect(t, e, c);
                  }
                }),
                (c.$updateActiveIndex = function () {
                  d.multiple
                    ? angular.isArray(s.$modelValue)
                      ? (f.$activeIndex = s.$modelValue.map(function (e) {
                          return c.$getIndex(e);
                        }))
                      : (f.$activeIndex = [])
                    : angular.isDefined(s.$modelValue) && f.$matches.length
                    ? (f.$activeIndex = c.$getIndex(s.$modelValue))
                    : (f.$activeIndex = -1);
                }),
                (c.$isVisible = function () {
                  return d.minLength && s
                    ? f.$matches.length && s.$viewValue.length >= d.minLength
                    : f.$matches.length;
                }),
                (c.$isActive = function (e) {
                  return d.multiple
                    ? -1 !== f.$activeIndex.indexOf(e)
                    : f.$activeIndex === e;
                }),
                (c.$getIndex = function (e) {
                  ...
                  for (
                    t = f.$matches.length;
                    t-- && !angular.equals(f.$matches[t].value, e);
                ...
                (c.$onKeyDown = function (e) {
                  return /(9|13|38|40)/.test(e.keyCode)
                    ? (9 !== e.keyCode &&
                        (e.preventDefault(), e.stopPropagation()),
                      d.multiple && 9 === e.keyCode
                        ? c.hide()
                        : d.multiple || (13 !== e.keyCode && 9 !== e.keyCode)
                        ? void (
                            d.multiple ||
                            (38 === e.keyCode && f.$activeIndex > 0
                              ? f.$activeIndex--
                              : 38 === e.keyCode && f.$activeIndex < 0
              ...
              c.show = function () {
                p(),
                  d.multiple && c.$element.addClass("select-multiple"),
                  r(
                    function () {
                      c.$element.on(
                        ...
                        d.keyboard && o.on("keydown", c.$onKeyDown);
                    },
                    0,
                    !1
                  );
              ...
              return (
                (c.hide = function () {
                  !d.multiple &&
                    ...
                    d.keyboard && o.off("keydown", c.$onKeyDown),
                    g(!0);
                }),
                c
              );
        ...
        function (e, t, n, a, o) {
          ...
          return {
            ...
            link: function (e, t, n, r) {
              ...
              if (
                (angular.isDefined(u) &&
                  (l.test(u) ? (s.multiple = !1) : (s.multiple = u)),
                ...
                (r.$render = function () {
                  ...
                  s.multiple && angular.isArray(r.$modelValue)
                    ...
                    : ((n = f.$getIndex(r.$modelValue)),
                      (e = -1 !== n ? f.$scope.$matches[n].label : !1)),
                    t.html((e || s.placeholder) + (s.caretHtml || i.caretHtml));
                }),
                s.multiple &&
        ...
        function (e, t, n) {
          ...
          return {
            ...
            link: function (e, o, i) {
              ...
              angular.isDefined(u) &&
                (l.test(u) ? (s.target = !1) : (s.target = u)),
    ...
    angular
      ...
      .provider("$modal", function () {
        ...
        this.$get = [
          ...
          "$sce",
          "dimensions",
          function (n, a, o, i, r, s, l) {
            function u(t) {
              function n() {
                T.$emit(x.prefixEvent + ".show", k),
                  angular.isDefined(x.onShow) &&
                    angular.isFunction(x.onShow) &&
                    x.onShow(k);
              }
              function r() {
                T.$emit(x.prefixEvent + ".hide", k),
                  angular.isDefined(x.onHide) &&
                    angular.isFunction(x.onHide) &&
                    x.onHide(k),
                  g.removeClass(x.prefixClass + "-open"),
                  x.animation &&
                    g.removeClass(x.prefixClass + "-with-" + x.animation);
              }
              function l() {
                x.backdrop &&
                  (M.on("click", b), F.on("click", b), F.on("wheel", D));
              }
              function u() {
                x.backdrop &&
                  (M.off("click", b), F.off("click", b), F.off("wheel", D));
              }
              function w() {
              ...
              function b(e) {
                e.target === e.currentTarget &&
                  ("static" === x.backdrop ? k.focus() : k.hide());
              }
              function D(e) {
                e.preventDefault();
              }
              function S() {
                k.$isShown && null !== M && (u(), y()),
                  A && (A.$destroy(), (A = null)),
                  M && (M.remove(), (M = k.$element = null));
              }
              var k = {},
                x = (k.$options = angular.extend({}, e, t)),
                C = (k.$promise = o.compile(x)),
                T = (k.$scope = (x.scope && x.scope.$new()) || a.$new());
              x.element || x.container || (x.container = "body"),
                (k.$id = x.id || (x.element && x.element.attr("id")) || ""),
              ...
              var E,
                ...
                A,
                F = angular.element(
                  '<div class="' + x.prefixClass + '-backdrop"/>'
                );
              return (
                F.css({
                  position: "fixed",
                ...
                (k.show = function () {
                  if (!k.$isShown) {
                    var e, t;
                    if (
                      (angular.isElement(x.container)
                        ? ((e = x.container),
                          (t = x.container[0].lastChild
                            ? angular.element(x.container[0].lastChild)
                            : null))
                        : x.container
                        ? ((e = d(x.container)),
                          (t =
                      ...
                      M && S(),
                      (A = k.$scope.$new()),
                      (M = k.$element = E.link(A, function (e, t) {})),
                      x.backdrop &&
                        (M.css({ "z-index": $ + 20 * m }),
                        F.css({ "z-index": h + 20 * m }),
                        m++),
                      !T.$emit(x.prefixEvent + ".show.before", k)
                        .defaultPrevented)
                    ) {
                      angular.isDefined(x.onBeforeShow) &&
                        angular.isFunction(x.onBeforeShow) &&
                        x.onBeforeShow(k),
                        M.css({ display: "block" }).addClass(x.placement),
                        x.customClass && M.addClass(x.customClass),
                        x.size &&
                          v[x.size] &&
                          angular
                            .element(d(".modal-dialog", M[0]))
                            .addClass(v[x.size]),
                        x.animation &&
                          (x.backdrop && F.addClass(x.backdropAnimation),
                          M.addClass(x.animation)),
                        x.backdrop && i.enter(F, g, null),
                        angular.version.minor <= 2
                          ? i.enter(M, e, t, n)
                          : i.enter(M, e, t).then(n),
                      ...
                      p(function () {
                        ...
                        g.addClass(x.prefixClass + "-open"),
                        x.animation &&
                          g.addClass(x.prefixClass + "-with-" + x.animation),
                        l(),
                        w();
                    }
                  }
                ...
                (k.hide = function () {
                  k.$isShown &&
                    (T.$emit(x.prefixEvent + ".hide.before", k)
                      .defaultPrevented ||
                      (angular.isDefined(x.onBeforeHide) &&
                        angular.isFunction(x.onBeforeHide) &&
                        x.onBeforeHide(k),
                      angular.version.minor <= 2
                        ? i.leave(M, r)
                        : i.leave(M).then(r),
                      x.backdrop && (m--, i.leave(F)),
                      (k.$isShown = T.$isShown = !1),
                      c(T),
                      u(),
                      y()));
            ...
            compile: function (e, t) {
              if (!t.bsDropdown) {
                for (var o = e[0].nextSibling; o && 1 !== o.nodeType; )
                  o = o.nextSibling;
                o &&
                  o.className.split(" ").indexOf("dropdown-menu") >= 0 &&
                  ((t.template = o.outerHTML),
                  (t.templateUrl = n),
    ...
    angular
      ...
      .factory("dimensions", function () {
        function t(e) {
          ...
          for (; o && !a(o, "html") && "static" === n.css(o, "position"); )
            o = o.offsetParent;
        ...
        return (
          ...
          (n.setOffset = function (e, t, a) {
            ...
            "static" === d && (e.style.position = "relative"),
              ...
              (c =
                ...
                (r + u).indexOf("auto") > -1),
              c
                ? ((o = n.position(e)), (s = o.top), (i = o.left))
                : ((s = parseFloat(r) || 0), (i = parseFloat(u) || 0)),
              angular.isFunction(t) && (t = t.call(e, a, l)),
          ...
          (n.position = function (e) {
            var o,
              ...
              r = { top: 0, left: 0 };
            return (
              "fixed" === n.css(e, "position")
                ? (i = e.getBoundingClientRect())
                : ((o = t(e)),
                  (i = n.offset(e)),
                  a(o, "html") || (r = n.offset(o)),
                  (r.top += n.css(o, "borderTopWidth", !0)),
                  (r.left += n.css(o, "borderLeftWidth", !0))),
              {
                width: e.offsetWidth,
          ...
          (n.height = function (e, t) {
            ...
            return (
              t
                ? (a +=
                    n.css(e, "marginTop", !0) + n.css(e, "marginBottom", !0))
                : (a -=
                    n.css(e, "paddingTop", !0) +
                    n.css(e, "paddingBottom", !0) +
                    n.css(e, "borderTopWidth", !0) +
                    n.css(e, "borderBottomWidth", !0)),
              a
            );
          }),
          (n.width = function (e, t) {
            ...
            return (
              t
                ? (a +=
                    n.css(e, "marginLeft", !0) + n.css(e, "marginRight", !0))
                : (a -=
                    n.css(e, "paddingLeft", !0) +
                    n.css(e, "paddingRight", !0) +
                    n.css(e, "borderLeftWidth", !0) +
                    n.css(e, "borderRightWidth", !0)),
              a
            );
          }),
          n
              ...
              var l = function (l) {
                ...
                var h,
                  ...
                  D = {
                    ...
                    y: function (e) {
                      return 50 >= 1 * e && 2 === e.length
                        ? this.setFullYear(2e3 + 1 * e)
                        : this.setFullYear(1 * e);
                    },
                  };
                return (
                  (y.init = function () {
          ...
          function (t, n, a, o, i, r, s, l) {
            function u(t, n, a) {
              ...
              (g.$mode = p.startView),
                ...
                (g.$hasToday = p.hasToday),
                (g.$hasClear = p.hasClear);
            ...
            link: function (e, t, n, s) {
              ...
              n.bsShow &&
                ...
                angular.isDefined(n.dateFormat) &&
                  n.$observe("dateFormat", function (e) {
                ...
                $ = [
                  {
                    ...
                    build: function () {
                      ...
                      (r.title = u(n, s.monthTitleFormat)),
                        ...
                        (r.isTodayDisabled = this.isDisabled(new Date())),
                        (this.built = !0);
                    },
          ...
          return {
            ...
            link: function (e, o, i, r) {
              ...
              i.$observe("value", function (t) {
                (s = "boolean" != typeof t && a.test(t) ? e.$eval(t) : t),
                  r.$render();
              }),
                (r.$render = function () {
            ...
            function o(o, s) {
              ...
              if (f.offsetParent)
                if (f.offsetParent.match(/^\d+$/))
                  for (var S = 0; S < 1 * f.offsetParent - 1; S++)
                    D = D.parent();
                  ...
                  y !== r &&
                    ...
                    "top" === r
                      ...
                      : ((b = null),
                        ...
                        f.inlineStyles &&
                          (o.css("position", "fixed"), o.css("top", $ + "px"))),
                    o
                      .removeClass(g)
