...
!(function (a) {
    ...
    (g = e.fn.autocomplete),
      ...
      (i = {
        ...
        val: function (a) {
          ...
          return arguments.length ? this.each(b) : c(this.first());
        },
        destroy: function () {
          function a() {
            var a,
      ...
      every: function (a, b) {
        ...
        return a
          ? (this.each(a, function (d, e) {
              return (c = b.call(null, d, e, a)), c ? void 0 : !1;
            }),
            !!c)
          : c;
      },
  ...
  function (a, b, c) {
    ...
    function d(a) {
      ...
      (a = a || {}),
        ...
        (this.$node = e(a)),
        (b = this.$node.find(
          i.className(this.cssClasses.prefix, this.cssClasses.dropdownMenu)
        )),
        (c = this.$node.find(
          i.className(this.cssClasses.prefix, this.cssClasses.input)
        )),
        (f = this.$node.find(
          i.className(this.cssClasses.prefix, this.cssClasses.hint)
        )),
        a.dropdownMenuContainer &&
          j
            ...
            .append(b.css("top", "0")),
        c.on("blur.aa", function (a) {
          var d = document.activeElement;
          i.isMsie() &&
            (b.is(d) || b.has(d).length > 0) &&
            (a.preventDefault(),
        ...
        (this.eventBus = a.eventBus || new k({ el: c })),
        ...
        (this.input = new d.Input({ input: c, hint: f })
    ...
    function e(a) {
      ...
      (d = j.element(g).css(o.dropdown)),
        ...
        b
          ...
          .css(a.hint ? o.input : o.inputWithNoHint);
      try {
    ...
    i.mixin(d.prototype, {
      ...
      _select: function (a) {
        "undefined" != typeof a.value && this.input.setQuery(a.value),
          this.input.setInputValue(a.value, !0),
          this._setLanguageDirection();
        var b = this.eventBus.trigger("selected", a.raw, a.datasetName);
        b.isDefaultPrevented() === !1 &&
          (this.dropdown.close(),
  ...
  function (a, b, c) {
    "use strict";
    function d(a) {
      (a && a.el) || f.error("EventBus initialized without el"),
        (this.$el = g.element(a.el));
    }
    var e = "autocomplete:",
      f = c(4),
      g = c(2);
      ...
      i.mixin(d.prototype, k, {
        ...
        _checkInputValue: function () {
          ...
          (a = this.getInputValue()),
            (b = f(a, this.query)),
            (c = b && this.query ? this.query.length !== a.length : !1),
            (this.query = a),
            b
        ...
        setInputValue: function (a, b) {
          "undefined" == typeof a && (a = this.query),
            this.$input.val(a),
  ...
  function (a, b, c) {
    (function (b) {
      ...
      function f(a) {
        ...
        for (a = a.split(k); (b = a.shift()); ) delete this._callbacks[b];
        return this;
      }
      function g(a) {
        var b, c, d, e, f;
        if (!this._callbacks) return this;
        for (
          a = a.split(k), d = [].slice.call(arguments, 1);
          (b = a.shift()) && (c = this._callbacks[b]);

        )
          (e = h(c.sync, this, [b].concat(d))),
            (f = h(c.async, this, [b].concat(d))),
            e() && l(f);
        return this;
      }
      function h(a, b, c) {
      ...
      var k = /\s+/,
        l = i();
      a.exports = { onSync: e, onAsync: d, off: f, trigger: g };
    }.call(b, c(9).setImmediate));
  },
  function (a, b, c) {
    (function (a, d) {
      function e(a, b) {
      ...
      (b.setTimeout = function () {
        ...
        (b.setImmediate =
          "function" == typeof a
            ...
            : function (a) {
                var c = j++,
                  d = arguments.length < 2 ? !1 : h.call(arguments, 1);
                return (
                  (i[c] = !0),
                  f(function () {
                    i[c] &&
    ...
    }.call(b, c(9).setImmediate, c(9).clearImmediate));
  },
  function (a, b) {
    function c() {
  ...
  function (a, b, c) {
    ...
    function d(a) {
      ...
      (a = a || {}),
        ...
        (this.isOpen = !1),
        (this.isEmpty = !0),
        (this.cssClasses = f.mixin({}, j.defaultClasses, a.cssClasses || {})),
        (this.templates = {}),
    ...
    f.mixin(d.prototype, h, {
      ...
      _onSuggestionMouseEnter: function (a) {
        ...
        ) || (this._removeCursor(), this._setCursor(b, !1));
      },
      _onSuggestionMouseLeave: function (a) {
        if (a.relatedTarget) {
          var b = g.element(a.relatedTarget);
          if (
            b.closest(
              "." +
                f.className(this.cssClasses.prefix, this.cssClasses.cursor, !0)
      ...
      _onRendered: function (a, b) {
        ...
        if (((this.isEmpty = f.every(this.datasets, c)), this.isEmpty))
          if (this.$empty)
            if (b) {
              var d = this.templates.empty({
                query: this.datasets[0] && this.datasets[0].query,
              });
              this.$empty.html(d);
            } else this._hide();
          else this._hide();
        else this.isOpen && (this.$empty && this.$empty.empty(), this._show());
      ...
      _show: function () {
        this.$menu.css("display", "block"), this.trigger("shown");
      },
  ...
  function (a, b, c) {
    ...
    function d(a) {
      (a = a || {}),
        ...
        (this.name =
          "undefined" == typeof a.name || null === a.name
            ? k.getUniqueId()
            : a.name),
        (this.source = a.source),
        (this.displayFn = e(a.display || a.displayKey)),
        (this.templates = f(a.templates, this.displayFn)),
        (this.cssClasses = k.mixin({}, n.defaultClasses, a.cssClasses || {}));
        ...
        _render: function (a, b) {
          function c() {
            ...
            return (
              ...
              o.templates.empty.apply(this, b)
            );
          }
          function d() {
            function a(a) {
              ...
              return (
                (b = l
                  .element(c)
                  .append(o.templates.suggestion.apply(this, [a].concat(e)))),
                b.data(h, o.name),
                b.data(i, o.displayFn(a) || void 0),
                b.data(j, JSON.stringify(a)),
                b.children().each(function () {
                  l.element(this).css(n.suggestionChild);
                }),
                b
              );
            }
            ...
            return (
              (c = l.element(g).css(n.suggestions)),
              (d = k.map(b, a)),
              c.append.apply(c, d),
              c
            );
          ...
          function e() {
            ...
            return (
              ...
              o.templates.header.apply(this, b)
            );
          }
          function f() {
            var b = [].slice.call(arguments, 0);
            return (
              (b = [{ query: a, isEmpty: !g }].concat(b)),
              o.templates.footer.apply(this, b)
            );
          }
          if (this.$el) {
            var g,
              o = this,
              p = [].slice.call(arguments, 2);
            this.$el.empty(),
              (g = b && b.length),
              !g && this.templates.empty
                ? this.$el
                    .html(c.apply(this, p))
                    .prepend(o.templates.header ? e.apply(this, p) : null)
  ...
  function (a, b, c) {
    "use strict";
    a.exports = { hits: c(16), popularIn: c(17) };
  },
  function (a, b, c) {
    "use strict";
    var d = c(4);
    a.exports = function (a, b) {
      function c(c, e) {
        a.search(c, b, function (a, b) {
          return a ? void d.error(a.message) : void e(b.hits, b);
        });
      }
      return c;
    };
  ...
  function (a, b, c) {
    ...
    a.exports = function (a, b, c, e) {
      function f(f, i) {
        a.search(f, b, function (a, b) {
          if (a) return void d.error(a.message);
          if (b.hits.length > 0) {
            var f = b.hits[0],
              j = d.mixin({ hitsPerPage: 0 }, c);
            return (
              delete j.source,
              delete j.index,
              void h.search(g(f), j, function (a, c) {
                if (a) return void d.error(a.message);
                var g = [];
                if (e.includeAll) {
                  var h = e.allTitle || "All departments";
                  g.push(
                    d.mixin(
                      { facet: { value: h, count: c.nbHits } },
                      d.cloneDeep(f)
                    )
                  );
                }
                d.each(c.facets, function (a, b) {
                  d.each(a, function (a, c) {
                    g.push(
                      d.mixin(
                        { facet: { facet: b, value: c, count: a } },
                        d.cloneDeep(f)
                      )
                    );
                  });
                });
                for (var j = 1; j < b.hits.length; ++j) g.push(b.hits[j]);
                i(g, b);
              })
            );
          }
      ...
      if (!c.source) return d.error("Missing 'source' key");
      var g = d.isFunction(c.source)
        ? c.source
        : function (a) {
            return a[c.source];
          };
