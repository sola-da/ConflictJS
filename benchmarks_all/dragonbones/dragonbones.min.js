...
!(function (a) {
  ...
  !(function (a) {
    ...
    var d = (function (a) {
      ...
      return __extends(b, a), (b.Z_ORDER_UPDATED = "zOrderUpdated"), b;
    })(b);
    a.ArmatureEvent = d;
    var e = (function (a) {
      function b(b) {
      ...
      return (
        ...
        (a.prototype.dispatchEvent = function (a) {
          if (a) {
            ...
            if (b) {
              a.target = this;
              for (var c = b.concat(), d = b.length, e = 0; d > e; e++) c[e](a);
            }
          }
        }),
        a
  ...
  !(function (a) {
    var d = (function () {
      ...
      return (
        (a.prototype.contains = function (a) {
          return this._animatableList.indexOf(a) >= 0;
        }),
        ...
        (a.prototype.remove = function (a) {
          ...
          b >= 0 && (this._animatableList[b] = null);
        }),
        ...
        (a.prototype.advanceTime = function (a) {
          ...
          if (0 != c) {
            for (var d = 0, e = 0; c > e; e++) {
              ...
              f &&
                (d != e &&
                  ((this._animatableList[d] = f),
                  (this._animatableList[e] = null)),
                f.advanceTime(a),
                d++);
            }
            if (d != e) {
              for (c = this._animatableList.length; c > e; )
                this._animatableList[d++] = this._animatableList[e++];
    ...
    var f = (function () {
      function a() {
        (this.transform = new e.DBTransform()),
          (this.pivot = new b.Point()),
          (this._durationTransform = new e.DBTransform()),
          (this._durationPivot = new b.Point()),
          (this._durationColor = new b.ColorTransform());
      }
      return (
        ...
        (a._returnObject = function (b) {
          a._pool.indexOf(b) < 0 && (a._pool[a._pool.length] = b), b.clear();
        }),
        (a._clear = function () {
        ...
        (a.prototype.fadeOut = function () {
          (this.transform.skewX = g.TransformUtil.formatRadian(
            this.transform.skewX
          )),
            (this.transform.skewY = g.TransformUtil.formatRadian(
        ...
        (a.prototype.update = function (b) {
          if (this._updateState)
            if (this._updateState > 0) {
              0 == this._timeline.scale ? (b = 1) : (b /= this._timeline.scale),
                1 == b && (b = 0.99999999),
                (b += this._timeline.offset);
              var c = Math.floor(b);
              b -= c;
              for (
                var f, d = this._totalTime * b, e = !1;
                !this._currentFrame ||
              ...
              if (e) {
                (this.tweenActive = this._currentFrame.displayIndex >= 0),
                  f++,
                  f >= this._timeline.getFrameList().length && (f = 0);
                var h = this._timeline.getFrameList()[f];
                0 == f &&
                ...
                ((this._currentFramePosition + this._currentFrameDuration) /
                  ...
                  0.99999999
                  ? ((this._updateState = 0), (this._tweenEasing = 0 / 0))
                  : (this._tweenEasing =
                      this._currentFrame.displayIndex < 0 ||
                      h.displayIndex < 0 ||
                      !this._animationState.tweenEnabled
                        ? 0 / 0
                        : isNaN(this._animationState.clip.tweenEasing)
                        ? this._currentFrame.tweenEasing
                        : this._animationState.clip.tweenEasing),
                  isNaN(this._tweenEasing)
                    ? ((this._tweenTransform = !1), (this._tweenColor = !1))
                    : ((this._durationTransform.x =
                        h.transform.x - this._currentFrame.transform.x),
                      (this._durationTransform.y =
                        h.transform.y - this._currentFrame.transform.y),
                      (this._durationTransform.skewX =
                        h.transform.skewX - this._currentFrame.transform.skewX),
                      (this._durationTransform.skewY =
                        h.transform.skewY - this._currentFrame.transform.skewY),
                      ...
                      (this._durationPivot.x =
                        h.pivot.x - this._currentFrame.pivot.x),
                      (this._durationPivot.y =
                        h.pivot.y - this._currentFrame.pivot.y),
                      (this._tweenTransform =
                        ...
                        0 != this._durationPivot.y
                          ? !0
                          : !1),
                      this._currentFrame.color && h.color
                        ...
                        ? ((this._tweenColor = !0),
                          (this._durationColor.alphaOffset =
                            h.color.alphaOffset),
                          (this._durationColor.redOffset = h.color.redOffset),
                          (this._durationColor.greenOffset =
                            h.color.greenOffset),
                          (this._durationColor.blueOffset = h.color.blueOffset),
                          (this._durationColor.alphaMultiplier =
                            h.color.alphaMultiplier - 1),
                          (this._durationColor.redMultiplier =
                            h.color.redMultiplier - 1),
                          (this._durationColor.greenMultiplier =
                            h.color.greenMultiplier - 1),
                          (this._durationColor.blueMultiplier =
                            h.color.blueMultiplier - 1))
                        : (this._tweenColor = !1)),
                  this._tweenTransform ||
                    (this._animationState.blend
                      ? ((this.transform.x =
                          this._originTransform.x +
                          this._currentFrame.transform.x),
                        (this.transform.y =
                          this._originTransform.y +
                          this._currentFrame.transform.y),
                        (this.transform.skewX =
              ...
              if (
                ((this._tweenTransform || this._tweenColor) &&
                  ((b =
                    (d - this._currentFramePosition) /
                ...
                var i = this._currentFrame.transform,
                  j = this._currentFrame.pivot;
                this._animationState.blend
                  ? ((this.transform.x =
                      this._originTransform.x +
                      i.x +
                    ...
                    (this.pivot.x =
                      this._originPivot.x + j.x + this._durationPivot.x * b),
                    (this.pivot.y =
                      this._originPivot.y + j.y + this._durationPivot.y * b))
                  : ((this.transform.x = i.x + this._durationTransform.x * b),
                    (this.transform.y = i.y + this._durationTransform.y * b),
                    (this.transform.skewX =
                      i.skewX + this._durationTransform.skewX * b),
                    (this.transform.skewY =
                      i.skewY + this._durationTransform.skewY * b),
                    (this.transform.scaleX =
                      i.scaleX + this._durationTransform.scaleX * b),
                    (this.transform.scaleY =
                      i.scaleY + this._durationTransform.scaleY * b),
                    (this.pivot.x = j.x + this._durationPivot.x * b),
                    (this.pivot.y = j.y + this._durationPivot.y * b));
              }
              this._tweenColor &&
                (this._currentFrame.color
                  ? this._bone._updateColor(
    ...
    var h = (function () {
      function a() {
        (this.loop = 0), (this.layer = 0), (this._timelineStates = {});
      }
      return (
        (a._borrowObject = function () {
          return 0 == a._pool.length ? new a() : a._pool.pop();
        ...
        (a.prototype.fadeIn = function (a, b, c, d, e, f, g, h) {
          (this.layer = f),
            ...
            (this._armature = a),
            Math.round(this.clip.duration * this.clip.frameRate) < 2 ||
            1 / 0 == d
              ? ((this.timeScale = 1),
        ...
        (a.prototype.fadeOut = function (a, b) {
          if (
            ...
            this._armature && !(this._fadeOutWeight >= 0))
          ) {
            (this._fadeState = -1),
        ...
        (a.prototype.getMixingTransform = function (a) {
          return this._mixingTransforms
            ? Number(this._mixingTransforms[a])
            : -1;
        }),
        (a.prototype.addMixingTransform = function (a, b, c) {
          if (
            ...
            "undefined" == typeof c && (c = !0),
            !this.clip || !this.clip.getTimeline(a))
          )
            throw new Error();
          if ((this._mixingTransforms || (this._mixingTransforms = {}), c))
            for (var e, f, d = this._armature._boneList.length; d--; )
              (e = this._armature._boneList[d]),
                e.name == a && (f = e),
                f &&
                  (f == e || f.contains(e)) &&
                  (this._mixingTransforms[e.name] = b);
        ...
        (a.prototype.removeMixingTransform = function (a, b) {
          if (
            ...
            if (b)
              for (var d, e, c = this._armature._boneList.length; c--; )
        ...
        (a.prototype.advanceTime = function (a) {
          ...
          if (
            (this._fadeIn &&
              ((this._fadeIn = !1),
              this._armature.hasEventListener(c.AnimationEvent.FADE_IN) &&
                ((b = new c.AnimationEvent(c.AnimationEvent.FADE_IN)),
                (b.animationState = this),
                this._armature._eventList.push(b))),
            this._fadeOut &&
              ((this._fadeOut = !1),
              this._armature.hasEventListener(c.AnimationEvent.FADE_OUT) &&
                ((b = new c.AnimationEvent(c.AnimationEvent.FADE_OUT)),
                (b.animationState = this),
                this._armature._eventList.push(b))),
            ...
            var e, f;
            this._pauseBeforeFadeInComplete
              ? ((this._pauseBeforeFadeInComplete = !1),
                (this.isPlaying = !1),
                (e = 0),
                (f = Math.floor(e)))
              : ((e = this.currentTime / this.totalTime),
                (f = Math.floor(e)),
                f != this.loopCount &&
                  (-1 == this.loopCount &&
                    this._armature.hasEventListener(c.AnimationEvent.START) &&
                    ((b = new c.AnimationEvent(c.AnimationEvent.START)),
                    (b.animationState = this),
                    this._armature._eventList.push(b)),
                  (this.loopCount = f),
                  this.loopCount &&
                    ...
                    this.loopCount * this.loopCount >= this.loop * this.loop - 1
                      ? ((d = !0),
                        ...
                        this._armature.hasEventListener(
                          c.AnimationEvent.COMPLETE
                        ) &&
                          ((b = new c.AnimationEvent(
                            c.AnimationEvent.COMPLETE
                          )),
                          (b.animationState = this),
                          this._armature._eventList.push(b)))
                      : this._armature.hasEventListener(
                          c.AnimationEvent.LOOP_COMPLETE
                        ) &&
                        ((b = new c.AnimationEvent(
                          c.AnimationEvent.LOOP_COMPLETE
                        )),
            ...
            for (var g in this._timelineStates)
              this._timelineStates[g].update(e);
            var h = this.clip.getFrameList();
            if (h.length > 0) {
              for (
                var k, i = this.totalTime * (e - f), j = !1;
                !this._currentFrame ||
                i > this._currentFrame.position + this._currentFrame.duration ||
                i < this._currentFrame.position;
                ...
                j &&
                  ...
                  (j = !0),
                  this._currentFrame
                    ? ((k = h.indexOf(this._currentFrame)),
                      k++,
                      k >= h.length && (k = 0),
                      (this._currentFrame = h[k]))
                    : (this._currentFrame = h[0]);
              j &&
                this._armature._arriveAtFrame(
                  this._currentFrame,
                  null,
          ...
          if (this._fadeState > 0)
            0 == this._fadeInTime
              ? ((this._fadeWeight = 1),
                ...
                (this.isPlaying = !0),
                this._armature.hasEventListener(
                  c.AnimationEvent.FADE_IN_COMPLETE
                ) &&
                  ((b = new c.AnimationEvent(
                    c.AnimationEvent.FADE_IN_COMPLETE
                  )),
            ...
            if (0 == this._fadeOutTime)
              return (
                ...
                (this._fadeState = 0),
                this._armature.hasEventListener(
                  c.AnimationEvent.FADE_OUT_COMPLETE
                ) &&
                  ((b = new c.AnimationEvent(
                    c.AnimationEvent.FADE_OUT_COMPLETE
                  )),
            ...
            if (
              ((this._fadeWeight =
                (1 -
                  (this.currentTime - this._fadeOutBeginTime) /
                    this._fadeOutTime) *
                this._fadeOutWeight),
              this._fadeWeight <= 0)
            )
        ...
        (a.prototype.addTimelineState = function (a) {
          ...
          if (b) {
            ...
            c.fadeIn(b, this, d), (this._timelineStates[a] = c);
          }
        }),
    ...
    var i = (function () {
      ...
      return (
        ...
        (a.prototype.gotoAndPlay = function (b, c, d, e, f, g, i, j, k, l) {
          if (
            ...
            "undefined" == typeof i && (i = a.SAME_LAYER_AND_GROUP),
            ...
            return null;
          for (var n, m = this._animationDataList.length; m--; )
            if (this._animationDataList[m].name == b) {
              n = this._animationDataList[m];
              break;
            }
          if (!n) return null;
          (this._isPlaying = !0),
            (c = 0 > c ? (n.fadeInTime < 0 ? 0.3 : n.fadeInTime) : c);
          var o;
          (o = 0 > d ? (n.scale < 0 ? 1 : n.scale) : d / n.duration),
            (e = isNaN(e) ? n.loop : e),
            (f = this.addLayer(f));
          var p, q;
          switch (i) {
            case a.NONE:
              break;
            case a.SAME_LAYER:
              for (q = this._animationLayer[f], m = q.length; m--; )
                (p = q[m]), p.fadeOut(c, k);
              break;
            case a.SAME_GROUP:
              for (r = this._animationLayer.length; r--; )
                for (q = this._animationLayer[r], m = q.length; m--; )
                  (p = q[m]), p.group == g && p.fadeOut(c, k);
              break;
            case a.ALL:
              for (var r = this._animationLayer.length; r--; )
                for (q = this._animationLayer[r], m = q.length; m--; )
                  (p = q[m]), p.fadeOut(c, k);
              break;
          ...
          var t,
            u,
            s = this._armature._slotList;
          for (m = s.length; m--; )
            (t = s[m]),
              (u = t.getChildArmature()),
              u && u.animation.gotoAndPlay(b, c);
          return this._lastAnimationState;
        }),
        (a.prototype.play = function () {
          this._animationDataList &&
        ...
        (a.prototype.getState = function (a, b) {
          ...
          if (!d) return null;
          for (var e = d.length; e--; ) if (d[e].name == a) return d[e];
          return null;
        }),
        ...
        (a.prototype.advanceTime = function (a) {
          if (this._isPlaying) {
            ...
            var c,
              ...
              w,
              x,
              b = this._armature._boneList.length,
              e = b;
            for (b--; e--; ) {
              for (
                g = this._armature._boneList[e],
                  ...
                  p = 0,
                  q = 0,
                  c = this._animationLayer.length;
                c--;

              ) {
                for (
                  r = 0, s = this._animationLayer[c], f = s.length, d = 0;
                  f > d;
                  d++
                )
                  (t = s[d]),
                    e == b && t.advanceTime(a)
                      ? (this.removeState(t), d--, f--)
                      : ((u = t._timelineStates[h]),
                        u &&
                          u.tweenActive &&
                          ((v = t._fadeWeight * t.weight * i),
                          (w = u.transform),
                          (x = u.pivot),
                          (j += w.x * v),
                          (k += w.y * v),
  ...
  !(function (a) {
    ...
    var f = (function () {
      ...
      return (
        ...
        (a.prototype.addFrame = function (a) {
          ...
          if (!(this._frameList.indexOf(a) < 0)) throw new Error();
    ...
    var k = (function () {
      ...
      return (
        ...
        (a.prototype.addDisplayData = function (a) {
          if (!a) throw new Error();
          if (!(this._displayDataList.indexOf(a) < 0)) throw new Error();
    ...
    var l = (function () {
      function a() {
        (this.length = 0), (this.global = new c()), (this.transform = new c());
      }
      return (
        (a.prototype.dispose = function () {
    ...
    var m = (function () {
      ...
      return (
        ...
        (a.prototype.addSlotData = function (a) {
          if (!a) throw new Error();
          if (!(this._slotDataList.indexOf(a) < 0)) throw new Error();
      ...
      return (
        ...
        (a.prototype.sortBoneDataList = function () {
          ...
          if (0 != a) {
            ...
            for (b.sort(this.sortBoneData), a = b.length; a--; )
    ...
    var o = (function () {
      ...
      return (
        (a.prototype.getArmatureNames = function () {
          var a = [];
          for (var b in this._armatureDataList)
        ...
        (a.prototype.addArmatureData = function (a) {
          if (!a) throw new Error();
          if (!(this._armatureDataList.indexOf(a) < 0)) throw new Error();
        ...
        (a.prototype.removeArmatureData = function (a) {
          ...
          b >= 0 && this._armatureDataList.splice(b, 1);
        }),
        ...
        (a.prototype.addSubTexturePivot = function (a, c, d) {
          var e = this._subTexturePivots[d];
          return (
            e
              ? ((e.x = a), (e.y = c))
              : (this._subTexturePivots[d] = e = new b.Point(a, c)),
            e
          );
        }),
    ...
    var p = (function () {
      ...
      return (
        (a.parseTextureAtlasData = function (a, c) {
          if (("undefined" == typeof c && (c = 1), !a)) throw new Error();
          var d = {};
          d.__name = a[g.ConstValues.A_NAME];
          var e = a[g.ConstValues.SUB_TEXTURE];
          for (var f in e) {
            var h = e[f],
              i = h[g.ConstValues.A_NAME],
              j = new b.Rectangle(
                Number(h[g.ConstValues.A_X]) / c,
                Number(h[g.ConstValues.A_Y]) / c,
                Number(h[g.ConstValues.A_WIDTH]) / c,
                Number(h[g.ConstValues.A_HEIGHT]) / c
              );
            d[i] = j;
          }
          return d;
        ...
        (a.parseSkeletonData = function (b) {
          ...
          var e = b[g.ConstValues.ARMATURE];
          for (var f in e) {
            var h = e[f];
            d.addArmatureData(a.parseArmatureData(h, d, c));
          }
          return d;
        }),
        (a.parseArmatureData = function (b, c, d) {
          ...
          for (var h in f) {
            var i = f[h];
            e.addBoneData(a.parseBoneData(i));
          }
          var j = b[g.ConstValues.SKIN];
          for (var h in j) {
            var k = j[h];
            e.addSkinData(a.parseSkinData(k, c));
          }
          g.DBDataUtil.transformArmatureData(e), e.sortBoneDataList();
          var l = b[g.ConstValues.ANIMATION];
          for (var h in l) {
            var m = l[h];
            e.addAnimationData(a.parseAnimationData(m, e, d));
          }
          return e;
        }),
        ...
        (a.parseSkinData = function (b, c) {
          ...
          for (var f in e) {
            var h = e[f];
            d.addSlotData(a.parseSlotData(h, c));
          }
          return d;
        }),
        (a.parseSlotData = function (b, c) {
          ...
          for (var f in e) {
            var h = e[f];
            d.addDisplayData(a.parseDisplayData(h, c));
          }
          return d;
        }),
        ...
        (a.parseAnimationData = function (b, c, d) {
          ...
          if (
            ...
            b.hasOwnProperty(g.ConstValues.A_TWEEN_EASING))
          ) {
            var f = b[g.ConstValues.A_TWEEN_EASING];
            e.tweenEasing = void 0 == f || null == f ? 0 / 0 : Number(f);
          } else e.tweenEasing = 0 / 0;
          a.parseTimeline(b, e, a.parseMainFrame, d);
          var h,
            j,
            k = b[g.ConstValues.TIMELINE];
          for (var l in k) {
            var m = k[l];
            (h = a.parseTransformTimeline(m, e.duration, d)),
              (j = m[g.ConstValues.A_NAME]),
              e.addTimeline(h, j);
          }
          return (
        ...
        (a.parseTimeline = function (a, b, c, d) {
          var f,
            e = 0,
            h = a[g.ConstValues.FRAME];
          for (var i in h) {
            var j = h[i];
            (f = c(j, d)), (f.position = e), b.addFrame(f), (e += f.duration);
          }
        ...
        (a.parseTransformFrame = function (c, d) {
          ...
          if (
            (a.parseFrame(c, f, d),
            (f.visible = 1 != Number(c[g.ConstValues.A_HIDE])),
            c.hasOwnProperty(g.ConstValues.A_TWEEN_EASING))
          ) {
            var h = c[g.ConstValues.A_TWEEN_EASING];
            f.tweenEasing = void 0 == h || null == h ? 0 / 0 : Number(h);
          } else f.tweenEasing = 0;
          (f.tweenRotate = Number(c[g.ConstValues.A_TWEEN_ROTATE]) || 0),
            (f.displayIndex = Number(c[g.ConstValues.A_DISPLAY_INDEX]) || 0),
            (f.zOrder = Number(c[g.ConstValues.A_Z_ORDER]) || 0),
            a.parseTransform(c[g.ConstValues.TRANSFORM], f.global, f.pivot),
            f.transform.copy(f.global);
          var i = c[g.ConstValues.COLOR_TRANSFORM];
          return (
            i &&
              ((f.color = new b.ColorTransform()),
              (f.color.alphaOffset = Number(i[g.ConstValues.A_ALPHA_OFFSET])),
              (f.color.redOffset = Number(i[g.ConstValues.A_RED_OFFSET])),
              (f.color.greenOffset = Number(i[g.ConstValues.A_GREEN_OFFSET])),
              (f.color.blueOffset = Number(i[g.ConstValues.A_BLUE_OFFSET])),
              (f.color.alphaMultiplier =
                0.01 * Number(i[g.ConstValues.A_ALPHA_MULTIPLIER])),
              (f.color.redMultiplier =
                0.01 * Number(i[g.ConstValues.A_RED_MULTIPLIER])),
              (f.color.greenMultiplier =
                0.01 * Number(i[g.ConstValues.A_GREEN_MULTIPLIER])),
              (f.color.blueMultiplier =
                0.01 * Number(i[g.ConstValues.A_BLUE_MULTIPLIER]))),
            f
          );
        }),
        (a.parseTransform = function (a, b, c) {
          "undefined" == typeof c && (c = null),
            a &&
              (b &&
                ((b.x = Number(a[g.ConstValues.A_X])),
                (b.y = Number(a[g.ConstValues.A_Y])),
                (b.skewX =
                  Number(a[g.ConstValues.A_SKEW_X]) *
                  g.ConstValues.ANGLE_TO_RADIAN),
                (b.skewY =
                  Number(a[g.ConstValues.A_SKEW_Y]) *
                  g.ConstValues.ANGLE_TO_RADIAN),
                (b.scaleX = Number(a[g.ConstValues.A_SCALE_X])),
                (b.scaleY = Number(a[g.ConstValues.A_SCALE_Y]))),
              c &&
                ((c.x = Number(a[g.ConstValues.A_PIVOT_X])),
                (c.y = Number(a[g.ConstValues.A_PIVOT_Y]))));
        }),
        a
      );
    })();
  ...
  !(function (b) {
    var d = (function (b) {
      ...
      return (
        ...
        (c.prototype.addSkeletonData = function (a, b) {
          ...
          this._dataDic[b], (this._dataDic[b] = a);
        }),
        ...
        (c.prototype.addTextureAtlas = function (a, b) {
          if (!a) throw new Error();
          if (((b = b || a.name), !b)) throw new Error("Unnamed data!");
          this._textureAtlasDic[b], (this._textureAtlasDic[b] = a);
        }),
        ...
        (c.prototype.dispose = function (a) {
          if (("undefined" == typeof a && (a = !0), a)) {
            ...
            for (var b in this._textureAtlasDic)
        ...
        (c.prototype.buildArmature = function (b, c, d, f, g) {
          if (d) {
            var h = this._dataDic[d];
            if (h) var i = h.getArmatureData(b);
          } else
            for (d in this._dataDic)
              if (((h = this._dataDic[d]), (i = h.getArmatureData(b)))) break;
          if (!i) return null;
          (this._currentDataName = d), (this._currentTextureAtlasName = f || d);
          var j = this._generateArmature();
          j.name = b;
          var k,
            l,
            m = i.getBoneDataList();
          for (var n in m)
            (l = m[n]),
              ...
              i.getBoneData(l.parent)
                ? j.addChild(k, l.parent)
                : j.addChild(k, null);
          if (c && c != b) {
            var o = h.getArmatureData(c);
            if (!o)
              for (d in this._dataDic)
                if (((h = this._dataDic[d]), (o = h.getArmatureData(c)))) break;
          }
          o
            ? j.animation.setAnimationDataList(o.getAnimationDataList())
            : j.animation.setAnimationDataList(i.getAnimationDataList());
          var p = i.getSkinData(g);
          ...
          var q,
            ...
            w = p.getSlotDataList();
          for (var n in w)
            if (((v = w[n]), (k = j.getBone(v.parent)))) {
              for (
                x = v.getDisplayDataList(),
                  q = this._generateSlot(),
                  q.name = v.name,
                  q._originZOrder = v.zOrder,
                  q._dislayDataList = x,
                  u.length = 0,
                  t = x.length;
                t--;
              ...
              q.setDisplayList(u), q._changeDisplay(0), k.addChild(q);
            }
          return (j._slotsZOrderChanged = !0), j.advanceTime(0), j;
        }),
        (c.prototype.getTextureDisplay = function (a, b, c, d) {
          ...
          if (e) {
            if (isNaN(c) || isNaN(d)) {
              var f = this._dataDic[b];
              if (f) {
                var g = f.getSubTexturePivot(a);
                g && ((c = g.x), (d = g.y));
              }
            }
        ...
        (c.prototype._generateDisplay = function () {
          return null;
        }),
        c
      );
    ...
    (function (a) {
      ...
      var f = (function () {
        ...
        return (
          (a.transformPointWithParent = function (b, c) {
            var d = a._helpMatrix;
            a.transformToMatrix(c, d), d.invert();
            var e = b.x,
              f = b.y;
      ...
      var g = (function () {
        function a() {}
        return (
          (a.transformArmatureData = function (a) {
            for (var d, e, b = a.getBoneDataList(), c = b.length; c--; )
              (d = b[c]),
                d.parent &&
                  ((e = a.getBoneData(d.parent)),
                  e &&
                    (d.transform.copy(d.global),
                    f.transformPointWithParent(d.transform, e.global)));
          }),
          (a.transformArmatureDataAnimations = function (b) {
            for (var c = b.getAnimationDataList(), d = c.length; d--; )
              a.transformAnimationData(c[d], b);
          }),
          (a.transformAnimationData = function (b, c) {
            for (
              ...
              if (((i = e[h]), (j = b.getTimeline(i.name)))) {
                k = null;
                for (var t in g) if (((k = g[t]), k.parent == i.name)) break;
                (m = i.parent ? b.getTimeline(i.parent) : null),
                  (n = j.getFrameList()),
                  (o = null),
                  (p = null),
                  (q = null),
                ...
                for (var u = 0; s > u; u++) {
                  if (
                    ((r = n[u]),
                    m
                      ? (a._helpTransform1.copy(r.global),
                        a.getTimelineTransform(
                          m,
                          r.position,
                          a._helpTransform2
                        ),
                        f.transformPointWithParent(
                          a._helpTransform1,
                          a._helpTransform2
                        ),
                        r.transform.copy(a._helpTransform1))
                      : r.transform.copy(r.global),
                    (r.transform.x -= i.transform.x),
                    (r.transform.y -= i.transform.y),
                    (r.transform.skewX -= i.transform.skewX),
                    (r.transform.skewY -= i.transform.skewY),
                    (r.transform.scaleX -= i.transform.scaleX),
                    (r.transform.scaleY -= i.transform.scaleY),
                    j.transformed || (k && (r.zOrder -= k.zOrder)),
                    o ||
                      ((o = j.originTransform),
                      o.copy(r.transform),
                      (o.skewX = f.formatRadian(o.skewX)),
                      (o.skewY = f.formatRadian(o.skewY)),
                      (p = j.originPivot),
                      (p.x = r.pivot.x),
                      (p.y = r.pivot.y)),
                    (r.transform.x -= o.x),
                    (r.transform.y -= o.y),
                    (r.transform.skewX = f.formatRadian(
                      r.transform.skewX - o.skewX
                    )),
                    (r.transform.skewY = f.formatRadian(
                      r.transform.skewY - o.skewY
                    )),
                    (r.transform.scaleX -= o.scaleX),
                    (r.transform.scaleY -= o.scaleY),
                    j.transformed || ((r.pivot.x -= p.x), (r.pivot.y -= p.y)),
                    q)
                  ) {
                    var v = r.transform.skewX - q.transform.skewX;
                    q.tweenRotate
                      ? q.tweenRotate > 0
                        ? (0 > v &&
                            ((r.transform.skewX += 2 * Math.PI),
                            (r.transform.skewY += 2 * Math.PI)),
                          q.tweenRotate > 1 &&
                            ((r.transform.skewX +=
                              2 * Math.PI * (q.tweenRotate - 1)),
                            (r.transform.skewY +=
                              2 * Math.PI * (q.tweenRotate - 1))))
                        : (v > 0 &&
                            ((r.transform.skewX -= 2 * Math.PI),
                      ...
                      : ((r.transform.skewX =
                          q.transform.skewX +
                          f.formatRadian(
                            r.transform.skewX - q.transform.skewX
                          )),
                        (r.transform.skewY =
                          q.transform.skewY +
                          f.formatRadian(
                            r.transform.skewY - q.transform.skewY
                          )));
                  }
                  q = r;
                }
          ...
          (a.getTimelineTransform = function (a, b, c) {
            for (var h, i, j, k, e = a.getFrameList(), g = e.length; g--; )
              if (
                ((h = e[g]), h.position <= b && h.position + h.duration > b)
              ) {
                (i = h.tweenEasing),
                  g == e.length - 1 || isNaN(i) || b == h.position
                    ? c.copy(h.global)
                    : ((j = (b - h.position) / h.duration),
                      i && (j = d.TimelineState.getEaseValue(j, i)),
                      (k = e[g + 1]),
                      (c.x = h.global.x + (k.global.x - h.global.x) * j),
                      (c.y = h.global.y + (k.global.y - h.global.y) * j),
                      (c.skewX = f.formatRadian(
                        h.global.skewX + (k.global.skewX - h.global.skewX) * j
                      )),
                      (c.skewY = f.formatRadian(
                        h.global.skewY + (k.global.skewY - h.global.skewY) * j
                      )),
                      (c.scaleX =
                        h.global.scaleX +
                        (k.global.scaleX - h.global.scaleX) * j),
                      (c.scaleY =
                        h.global.scaleY +
                        (k.global.scaleY - h.global.scaleY) * j));
                break;
              }
          }),
          (a.addHideTimeline = function (a, b) {
            for (var f, g, c = b.getBoneDataList(), d = c.length; d--; )
              (f = c[d]),
                (g = f.name),
                a.getTimeline(g) ||
                  a.addTimeline(e.TransformTimeline.HIDE_TIMELINE, g);
          }),
    ...
    h = (function () {
      function a() {
        (this.global = new e.DBTransform()),
          ...
          (this._globalTransformMatrix = new b.Matrix()),
          (this._visible = !0),
  ...
  var i = (function (a) {
    ...
    return (
      ...
      (b.prototype.getDisplay = function () {
        ...
        return a instanceof k ? a.getDisplay() : a;
      }),
      ...
      (b.prototype.setDisplayList = function (a) {
        ...
        if (this._displayIndex >= 0) {
          ...
          (this._displayIndex = -1), this._changeDisplay(c);
        }
      }),
      (b.prototype._setDisplay = function (a) {
        this._displayBridge.getDisplay()
          ...
          (this._isDisplayOnStage =
            !this._isHideDisplay && this._displayBridge.getDisplay() ? !0 : !1);
      }),
      (b.prototype._changeDisplay = function (a) {
        if (0 > a)
          ...
          if ((a >= c && c > 0 && (a = c - 1), this._displayIndex != a)) {
            this._displayIndex = a;
            var d = this._displayList[this._displayIndex];
            d instanceof k
              ? this._setDisplay(d.getDisplay())
              : this._setDisplay(d),
  ...
  var j = (function (a) {
    ...
    return (
      ...
      (d.prototype.setVisible = function (a) {
        if (this._visible != a) {
          ...
          for (var b = this._children.length; b--; ) {
            ...
            c instanceof i && c._updateVisible(this._visible);
          }
        }
      }),
      (d.prototype._setArmature = function (b) {
        a.prototype._setArmature.call(this, b);
        for (var c = this._children.length; c--; )
          this._children[c]._setArmature(this.armature);
      }),
      (d.prototype.dispose = function () {
        if (this._children) {
          a.prototype.dispose.call(this);
      ...
      (d.prototype.contains = function (a) {
        if (!a) throw new Error();
        if (a == this) return !1;
        for (var b = a; b != this && null != b; ) b = b.parent;
        return b == this;
      }),
      (d.prototype.addChild = function (a) {
        if (!a) throw new Error();
        if (a == this || (a instanceof d && a.contains(this)))
          throw new Error(
        ...
        a.parent && a.parent.removeChild(a),
          ...
          !this.slot && a instanceof i && (this.slot = a);
      }),
      ...
      (d.prototype.getSlots = function () {
        for (var a = [], b = this._children.length; b--; )
          this._children[b] instanceof i && a.unshift(this._children[b]);
        return a;
      }),
      (d.prototype._arriveAtFrame = function (a, b, e) {
        if (a) {
          var g = e.getMixingTransform(name);
          if (
            !(
              !e.displayControl ||
              (2 != g && -1 != g) ||
            ...
            var h = a;
            if (this.slot) {
              var j = h.displayIndex;
              j >= 0 &&
                (isNaN(h.zOrder) ||
                  h.zOrder == this.slot._tweenZorder ||
                  ((this.slot._tweenZorder = h.zOrder),
                  (this.armature._slotsZOrderChanged = !0))),
                this.slot._changeDisplay(j),
                this.slot._updateVisible(h.visible);
            }
          }
          if (
            a.event &&
            this.armature.hasEventListener(c.FrameEvent.BONE_FRAME_EVENT)
          ) {
            var k = new c.FrameEvent(c.FrameEvent.BONE_FRAME_EVENT);
            (k.bone = this),
              (k.animationState = e),
              (k.frameLabel = a.event),
              this.armature._eventList.push(k);
          }
          if (a.sound && d._soundManager.hasEventListener(c.SoundEvent.SOUND)) {
            var l = new c.SoundEvent(c.SoundEvent.SOUND);
            (l.armature = this.armature),
              (l.animationState = e),
              (l.sound = a.sound),
              d._soundManager.dispatchEvent(l);
          }
          if (a.action)
            for (var m in this._children)
              if (this._children[m] instanceof i) {
                var n = this._children[m].getChildArmature();
                n && n.animation.gotoAndPlay(a.action);
              }
        } else this.slot && this.slot._changeDisplay(-1);
      }),
      (d.prototype._updateColor = function (a, b, c, d, e, f, g, h, i) {
        (i || this._isColorChanged) &&
          this.slot._displayBridge.updateColor(a, b, c, d, e, f, g, h),
  ...
  var k = (function (a) {
    function b(b) {
      a.call(this),
        (this.animation = new d.Animation(this)),
        (this._display = b),
    ...
    return (
      ...
      (b.prototype.advanceTime = function (a) {
        this.animation.advanceTime(a), (a *= this.animation.timeScale);
        for (var b = this._boneList.length; b--; ) this._boneList[b]._update();
        b = this._slotList.length;
        for (var d; b--; )
          if (((d = this._slotList[b]), d._update(), d._isDisplayOnStage)) {
            var e = d.getChildArmature();
            e && e.advanceTime(a);
          }
        if (
          (this._slotsZOrderChanged &&
            (this.updateSlotsZOrder(),
            this.hasEventListener(c.ArmatureEvent.Z_ORDER_UPDATED) &&
              this.dispatchEvent(
                new c.ArmatureEvent(c.ArmatureEvent.Z_ORDER_UPDATED)
              )),
          this._eventList.length)
        ) {
          var f = this._eventList.length;
          for (b = 0; f > b; b++) this.dispatchEvent(this._eventList[b]);
          this._eventList.length = 0;
        }
      }),
      ...
      (b.prototype.removeSlot = function (a) {
        if (!a) throw new Error();
        if (!(this._slotList.indexOf(a) >= 0)) throw new Error();
      ...
      (b.prototype.removeBone = function (a) {
        if (!a) throw new Error();
        if (!(this._boneList.indexOf(a) >= 0)) throw new Error();
      ...
      (b.prototype.updateSlotsZOrder = function () {
        ...
        for (var b, a = this._slotList.length; a--; )
          (b = this._slotList[a]),
            b._isDisplayOnStage &&
      ...
      (b.prototype._addDBObject = function (a) {
        if (a instanceof i) {
          var b = a;
          this._slotList.indexOf(b) < 0 &&
            (this._slotList[this._slotList.length] = b);
        } else if (a instanceof j) {
          var c = a;
          this._boneList.indexOf(c) < 0 &&
            ((this._boneList[this._boneList.length] = c), this._sortBoneList());
        }
      }),
      (b.prototype._removeDBObject = function (a) {
        if (a instanceof i) {
          ...
          c >= 0 && this._slotList.splice(c, 1);
        } else if (a instanceof j) {
          var d = a;
          (c = this._boneList.indexOf(d)),
            c >= 0 && this._boneList.splice(c, 1);
        }
      }),
      (b.prototype._sortBoneList = function () {
        ...
        if (0 != a) {
          for (var c, d, e, b = []; a--; ) {
            for (c = 0, d = this._boneList[a], e = d; e; ) c++, (e = e.parent);
            b[a] = { level: c, bone: d };
          }
          for (b.sort(this.sortBone), a = b.length; a--; )
            this._boneList[a] = b[a].bone;
        }
      }),
      (b.prototype._arriveAtFrame = function (a, d, e) {
        if (
          a.event &&
          this.hasEventListener(c.FrameEvent.ANIMATION_FRAME_EVENT)
        ) {
          var g = new c.FrameEvent(c.FrameEvent.ANIMATION_FRAME_EVENT);
          (g.animationState = e),
            (g.frameLabel = a.event),
            this._eventList.push(g);
        }
        if (a.sound && b._soundManager.hasEventListener(c.SoundEvent.SOUND)) {
          var h = new c.SoundEvent(c.SoundEvent.SOUND);
          (h.armature = this),
            (h.animationState = e),
            (h.sound = a.sound),
