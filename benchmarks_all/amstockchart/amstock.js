AmCharts.AmStockChart = AmCharts.Class({
  ...
  measurePanels: function () {
    ...
    for (e = 0; e < a.length; e++)
      (k = a[e]),
        (k.percentHeight = (k.percentHeight / d) * 100),
        k.panelBox &&
          (k.panelBox.style.height =
            Math.round((k.percentHeight * this.panelsHeight) / 100) + "px");
  },
  ...
  addChartScrollbar: function () {
    ...
    if (a.enabled) {
      ...
      var h;
      d &&
        ((h = new AmCharts.AmGraph(this.theme)),
        (h.valueField = d.valueField),
        (h.periodValue = d.periodValue),
        (h.type = d.type),
        (h.connect = d.connect),
        (h.minDistance = a.minDistance),
        b.addGraph(h));
      ...
      switch (a.position) {
        ...
        case "bottom":
          (e.style.marginTop = c + "px"),
            "bottom" == d ? f.insertBefore(e, b) : f.appendChild(e);
      }
  ...
  zoomChart: function (a, b) {
    ...
    if (e && k) {
      ...
      if (h) {
        ...
        a.getTime() == b.getTime() &&
          m != g &&
          ((b = AmCharts.changeDate(b, m.period, m.count)),
      ...
      d.currentPeriod = h;
      var m = AmCharts.extractPeriod(h),
        z = AmCharts.getPeriodDuration(m.period, m.count);
      AmCharts.getPeriodDuration(g);
      1 > b.getTime() - a.getTime() && (a = new Date(b.getTime() - 1));
      g = AmCharts.newDate(a);
      d.extendToFullPeriod &&
        (g.getTime() - e.getTime() < 0.1 * z &&
          (g = AmCharts.resetDateToMin(a, m.period, m.count, x)),
        k.getTime() - b.getTime() < 0.1 * z &&
          ((b = AmCharts.resetDateToMin(k, m.period, m.count, x)),
          (b = AmCharts.changeDate(b, m.period, m.count, !0))));
      ...
      for (e = 0; e < p.length; e++) {
        ...
        if (h != f) {
          for (c = 0; c < r.length; c++)
            (z = r[c].graph),
              (z.dataProvider = z.dataSet.agregatedDataProviders[h]);
          c = k.categoryAxis;
          c.firstDayOfWeek = x;
          c.minPeriod = h;
          ...
          if ((c = k.chartCursor))
            (c.categoryBalloonDateFormat =
              d.chartCursorSettings.categoryBalloonDateFormat(m.period)),
        ...
        c ||
          ((k.startTime = void 0), (k.endTime = void 0), k.zoomToDates(g, b));
        0 < l.startDuration && d.animationPlayed && !c
          ? ((k.startDuration = 0), k.animateAgain())
          : 0 < l.startDuration && !c && k.animateAgain();
      }
      d.animationPlayed = !0;
    ...
    if (0 < this.dataSets.length) {
      ...
      for (b = 0; b < a.length; b++) {
        ...
        for (h = 0; h < k.length; h++) {
          var f = k[h],
            f = AmCharts.processObject(f, AmCharts.StockGraph, this.theme);
          k[h] = f;
          ...
          var w = c.stockLegend,
            ...
            A;
          w &&
            ((w = AmCharts.processObject(w, AmCharts.StockLegend, this.theme)),
            (c.stockLegend = w),
            (x = w.valueTextComparing),
            (m = w.valueTextRegular),
            (z = w.periodValueTextComparing),
            (A = w.periodValueTextRegular));
          if (f.comparable) {
            var y = e.length;
            if (f.valueAxis) {
              0 < y &&
              ...
              for (C = 0; C < y; C++) {
                var B = e[C],
                  t = f.comparedGraphs[B.id];
                t ||
                  ((t = new AmCharts.AmGraph(this.theme)),
                  (t.id = "comparedGraph" + C + "_" + h + B.id));
                ...
                if (g) {
                  ...
                  f.compareGraphLineColor &&
                    (t.lineColor = f.compareGraphLineColor);
                  ...
                  if ((g = f.compareGraphFillColors)) t.fillColors = g;
                  if ((g = f.compareGraphNegativeFillColors))
                    t.negativeFillColors = g;
                  if ((g = f.compareGraphFillAlphas)) t.fillAlphas = g;
                  if ((g = f.compareGraphNegativeFillAlphas))
                    t.negativeFillAlphas = g;
                  if ((g = f.compareGraphBullet)) t.bullet = g;
                  if ((g = f.compareGraphNumberFormatter))
                    t.numberFormatter = g;
                  g = f.compareGraphPrecision;
                  isNaN(g) || (t.precision = g);
                  if ((g = f.compareGraphBalloonText)) t.balloonText = g;
                  ...
                  w &&
                    (r && x
                      ? ((t.legendValueText = x), (t.legendPeriodValueText = z))
                      : (m && (t.legendValueText = m),
                        (t.legendPeriodValueText = A)));
          ...
          w &&
            (r && x
              ? ((f.legendValueText = x), (f.legendPeriodValueText = z))
              : (m && (f.legendValueText = m), (f.legendPeriodValueText = A)));
        }
      }
    }
  },
  ...
  handleCursorChange: function (a) {
    ...
    for (k = 0; k < e.length; k++) {
      ...
      h != b &&
        ...
        (h.forceShow = !0),
        (h.initialMouse = b.initialMouse),
        (h.selectionPosX = b.selectionPosX),
        h.setPosition(c, !1, a));
    }
  },
  ...
  validateSizeReal: function () {
    ...
    if (
      ...
      0 < this.divRealWidth &&
        ...
        this.fire("resized", { type: "resized", chart: this }),
...
AmCharts.PeriodSelector = AmCharts.Class({
  ...
  zoom: function (a, b) {
    ...
    this.inputFieldsEnabled &&
      ((this.startDateField.value = AmCharts.formatDate(a, this.dateFormat, c)),
      (this.endDateField.value = AmCharts.formatDate(b, this.dateFormat, c)));
  ...
  write: function (a) {
    ...
    if (b.inputFieldsEnabled) {
      ...
      AmCharts.isIE &&
        l.attachEvent("onkeypress", function (a) {
          b.handleCalendarChange.call(b, a);
        });
      f.appendChild(l);
      b.startDateField = l;
      if (e) (g = b.width - 6 + "px"), AmCharts.addBr(f);
      else {
    ...
    if (AmCharts.ifArray(f)) {
      ...
      for (a = 0; a < f.length; a++)
        (l = f[a]),
          ...
          (p.count = l.count),
          (p.periodObj = l),
          (p.className = "amChartsButton " + c + "-period-input"),
          d && AmCharts.applyStyles(p.style, d.PeriodButton),
          e && (p.style.width = b.width - 1 + "px"),
          (p.style.boxSizing = "border-box"),
          g.appendChild(p),
          b.addEventListeners(p),
          (l.button = p);
    ...
    l &&
      ...
      ("MAX" == k
        ...
        ? this.selectFromStart
          ? ((f = l), (g = new Date(l)), g.setMonth(g.getMonth() + e))
          : ((f = new Date(n)),
            AmCharts.changeDate(f, k, e, !1),
            f.setDate(f.getDate() - 1),
            (g = n))
        : ((p = AmCharts.getPeriodDuration(k, e)),
          this.selectFromStart
            ? ((f = l), (g = new Date(l.getTime() + p - 1)))
            : ((f = new Date(n.getTime() - p + 1)), (g = n))),
      (a.startTime = f.getTime()),
      this.hideOutOfScopePeriods &&
        (b && a.startTime < l.getTime()
          ? (d.style.display = "none")
          : (d.style.display = "inline")),
      f.getTime() > n.getTime() &&
        ((p = AmCharts.getPeriodDuration("DD", 1)),
        (f = new Date(n.getTime() - p))),
      f.getTime() < l.getTime() && (f = l),
      "YTD" == k && (a.startTime = f.getTime()),
      (a.endTime = g.getTime()),
      b ||
        ((this.skipMark = !0),
        ...
        r && AmCharts.applyStyles(d.style, r.PeriodButtonSelected),
        (a = { type: "changed" }),
        (a.startDate = f),
        (a.endDate = g),
        (a.predefinedPeriod = k),
        (a.chart = this.chart),
        (a.count = e),
        (a.event = c),
        this.fire(a.type, a)));
      ...
      for (k = b.length - 1; 0 <= k; k--) {
        ...
        h.startTime &&
          ...
          (f.className =
            ...
            a.classNamePrefix +
            "-period-input-selected"),
          e && AmCharts.applyStyles(f.style, e.PeriodButtonSelected));
      }
    }
    this.skipMark = !1;
  },
...
AmCharts.StockPanel = AmCharts.Class({
  ...
  createDrawIcons: function () {
    var a = this,
      ...
      k = AmCharts.rect(c, b, b, "#000", 0.005),
  ...
  if (f) {
    ...
    for (n = 0; n < p; n++) {
      var A = h[n],
        ...
        y =
          y instanceof Date
            ? AmCharts.newDate(y, b)
            : e
            ? AmCharts.stringToDate(y, e)
            : new Date(y),
        C = y.getTime(),
        B = {};
      for (r = 0; r < z; r++) B[m[r].toField] = A[m[r].fromField];
      var t;
      for (t = g; t < l; t++) {
        r = c[t];
        var u = AmCharts.extractPeriod(r),
          D = u.period,
          F = u.count,
          v,
          q;
        if (t == g || C >= w[r] || !w[r]) {
          x[r] = {};
          x[r].amCategoryIdField = String(
            AmCharts.resetDateToMin(y, D, F, d).getTime()
          );
          var E;
          for (E = 0; E < z; E++)
            (u = m[E].toField),
          ...
          k[r].push(x[r]);
          t > g &&
            ((u = AmCharts.newDate(y, b)),
            (u = AmCharts.changeDate(u, D, F, !0)),
            (u = AmCharts.resetDateToMin(u, D, F, d)),
            (w[r] = u.getTime()));
          if (t == g) for (var G in A) A.hasOwnProperty(G) && (x[r][G] = A[G]);
          x[r][f] = AmCharts.newDate(y, b);
        } else
          for (D = 0; D < z; D++)
            (u = m[D].toField),
              (v = x[r]),
              n == p - 1 && (v[f] = AmCharts.newDate(y, b)),
              (q = Number(B[u])),
              isNaN(q) ||
                (isNaN(v[u + "Low"]) && (v[u + "Low"] = q),
                q < v[u + "Low"] && (v[u + "Low"] = q),
                isNaN(v[u + "High"]) && (v[u + "High"] = q),
                q > v[u + "High"] && (v[u + "High"] = q),
                (v[u + "Close"] = q),
                (F = AmCharts.getDecimals(v[u + "Sum"])),
                (E = AmCharts.getDecimals(q)),
                (v[u + "Sum"] += q),
                (v[u + "Sum"] = AmCharts.roundTo(v[u + "Sum"], Math.max(F, E))),
                v[u + "Count"]++,
...
AmCharts.parseEvents = function (a, b, c, d, e, k) {
  ...
  for (l = 0; l < g; l++) {
    ...
    for (n = 0; n < p; n++)
      (r = w[n]),
        (r.customBulletField = "amCustomBullet" + r.id + "_" + x.id),
        (r.bulletConfigField = "amCustomBulletConfig" + r.id + "_" + x.id);
    for (var y = 0; y < h.length; y++)
      if (
        ((m = h[y]),
        (A = m.graph),
        AmCharts.isString(A) && (A = AmCharts.getObjById(w, A)))
      )
        m.graph = A;
  }
  for (var C in f)
    if (f.hasOwnProperty(C)) {
      A = f[C];
      var B = AmCharts.extractPeriod(C),
        t = A.length,
        u;
      for (u = 0; u < t; u++) {
        var D = A[u];
        ...
        v =
          "fff" == w
            ? l.getTime() + 1
            : AmCharts.resetDateToMin(
                AmCharts.changeDate(new Date(l), B.period, B.count),
                w,
                y,
                d
              ).getTime();
        for (l = 0; l < g; l++)
          for (x = b[l], w = x.graphs, p = w.length, n = 0; n < p; n++) {
            ...
            for (y = 0; y < h.length; y++) {
              ...
              var E = !1;
              m.graph &&
                (m.graph.showEventsOnComparedGraphs &&
                  m.graph.comparedGraphs[a.id] &&
                  (E = !0),
                (r == m.graph || E) &&
                  z >= F &&
                  z < v &&
                  (q.eventObjects.push(m),
                  q.letters.push(m.text),
                  q.descriptions.push(m.description),
                  m.type ? q.shapes.push(m.type) : q.shapes.push(c.type),
                  void 0 !== m.backgroundColor
                    ? q.backgroundColors.push(m.backgroundColor)
                    : q.backgroundColors.push(c.backgroundColor),
                  isNaN(m.backgroundAlpha)
                    ? q.backgroundAlphas.push(c.backgroundAlpha)
                    : q.backgroundAlphas.push(m.backgroundAlpha),
                  isNaN(m.borderAlpha)
                    ? q.borderAlphas.push(c.borderAlpha)
                    : q.borderAlphas.push(m.borderAlpha),
                  void 0 !== m.borderColor
                    ? q.borderColors.push(m.borderColor)
                    : q.borderColors.push(c.borderColor),
                  void 0 !== m.rollOverColor
                    ? q.rollOverColors.push(m.rollOverColor)
                    : q.rollOverColors.push(c.rollOverColor),
                  void 0 !== m.showAt
                    ? q.showAts.push(m.showAt)
                    : q.showAts.push(c.showAt),
                  q.colors.push(m.color),
                  q.values.push(m.value),
                  !m.panel && m.graph && (m.panel = m.graph.chart),
                  q.showOnAxis.push(m.showOnAxis),
                  (q.date = new Date(m.date))));
              0 < q.shapes.length &&
                ((m = "amCustomBullet" + r.id + "_" + x.id),
                (z = "amCustomBulletConfig" + r.id + "_" + x.id),
                (D[m] = AmCharts.StackedBullet),
                (D[z] = q));
            }
          }
      }
...
AmCharts.DataSetSelector = AmCharts.Class({
  ...
  write: function (a) {
    var b = this,
      ...
      e = b.chart;
    a.className =
      "amChartsDataSetSelector " + e.classNamePrefix + "-data-set-selector-div";
    var k = b.width;
    c = b.position;
    b.width = void 0;
    b.position = void 0;
    ...
    if (1 < b.countDataSets("showInSelect")) {
      ...
      AmCharts.isIE &&
        n.attachEvent("onchange", function (a) {
          b.handleDataSetChange.call(b, a);
        });
    ...
    if (0 < b.countDataSets("showInCompare") && 1 < k.length)
      if (
        ...
        a.appendChild(f);
        f.className =
          "amChartsCompareList " + e.classNamePrefix + "-compare-div";
        ...
        for (c = 0; c < k.length; c++)
          (g = k[c]),
            !0 === g.showInCompare &&
              ...
              (d.className = e.classNamePrefix + "-compare-item-div"),
              (d.dataSet = g),
              (d.style.height = l + "px"),
              g.compared &&
        ...
        AmCharts.isIE &&
          e.attachEvent("onchange", function (a) {
            b.handleCBSelect.call(b, a);
          });
        l = document.createElement("option");
        ...
        for (c = 0; c < k.length; c++)
          if (
            ((g = k[c]), !0 === g.showInCompare && g != b.chart.mainDataSet)
          ) {
            l = document.createElement("option");
            l.text = g.title;
            l.value = c;
            g.compared && (l.selected = !0);
            try {
              e.add(l, null);
            } catch (w) {
              e.add(l);
...
AmCharts.StackedBullet = AmCharts.Class({
  ...
  addLetter: function (a, b, c) {
    ...
    this.showOnAxis
      ...
      : this.value
      ? ((n = this.value),
        h.recalculateToPercents && (n = (n / h.recBaseValue) * 100 - 100),
        (n = h.getCoordinate(n) - this.bulletY),
        (l = f * e))
      : this.showAt
      ? ((m = this.graphDataItem.values),
        h.recalculateToPercents && (m = this.graphDataItem.percents),
        m &&
          ((n = h.getCoordinate(m[this.showAt]) - this.bulletY), (l = f * e)))
      : ((n = this.nextY), (l = f * e));
    a.translate(g, l);
    b.push(a);
    b.translate(0, n);
