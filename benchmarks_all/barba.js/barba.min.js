  ...
  return (function (t) {
    ...
    function (t, e) {
      function n() {
        u &&
          s &&
          ((u = !1), s.length ? (c = s.concat(c)) : (f = -1), c.length && i());
      }
      function i() {
        if (!u) {
          var t = setTimeout(n);
        ...
        u = {
          ...
          init: function () {
            ...
            this.History.add(this.getCurrentUrl(), this.Dom.getNamespace(t)),
              ...
              o.trigger("newPageReady", this.History.currentStatus(), {}, t),
          ...
          onLinkClick: function (t) {
            ...
            this.preventCheck(t, e) &&
              (t.stopPropagation(),
              t.preventDefault(),
              o.trigger("linkClicked", e),
              this.goTo(e.href));
          },
          preventCheck: function (t, e) {
            return history.pushState && e && e.href
      ...
      var n = {
        ...
        putContainer: function (t) {
          (t.style.visibility = "hidden"),
            document.getElementById(this.wrapperId).appendChild(t);
        },
