...
!(function (a) {
        ...
        function e(d) {
          function e(a) {
            if (!r.isDestroyed) {
              ...
              b.off("child_added", j),
                b.off("child_moved", l),
                b.off("child_changed", k),
                b.off("child_removed", m),
                (d = null),
                q(a || "destroyed");
            }
          }
          function f(b) {
            var c = d.$ref();
            c.on("child_added", j, p),
              c.on("child_moved", l, p),
              c.on("child_changed", k, p),
              c.on("child_removed", m, p),
              c.once(
                "value",
                function (c) {
                  angular.isArray(c.val()) &&
                    a.warn(
                      "Storing data using array indices in Firebase can result in unexpected behavior. See https://firebase.google.com/docs/database/web/structure-data for more information."
                    ),
                    q(null, b);
                },
                q
          ...
          (d.prototype = {
            ...
            $save: function (a) {
              ...
              if (null !== f) {
                ...
                g.reject("Invalid record; could not determine key for " + a);
              return g.promise;
            },
            $remove: function (a) {
              ...
              return c.reject(
                "Invalid record; could not determine key for " + a
              );
            },
            $keyAt: function (a) {
            ...
            $$added: function (a) {
              ...
              if (-1 === c) {
                var d = a.val();
                return (
                  angular.isObject(d) || (d = { $value: d }),
                  (d.$id = a.key),
                  (d.$priority = a.getPriority()),
                  b.applyDefaults(d, this.$$defaults),
                  d
                );
              }
              return !1;
            ...
            $$process: function (a, b, c) {
              ...
              return (
                angular.isDefined(d) && (f = this._addAfter(b, c) !== d),
                f && this.$$notify(a, e, c),
                f
              );
            },
            $$notify: function (a, b, c) {
              var d = { event: a, key: b };
              angular.isDefined(c) && (d.prevChild = c),
                angular.forEach(this._observers, function (a) {
                  a[0].call(a[1], d);
                });
            },
            _addAfter: function (a, b) {
              ...
              return (
                null === b
                  ? (c = 0)
                  : ((c = this.$indexFor(b) + 1),
                    0 === c && (c = this.$list.length)),
                this.$list.splice(c, 0, a),
                (this._indexCache[this.$$getKey(a)] = c),
                c
              );
            },
            _spliceOut: function (a) {
              var b = this.$indexFor(a);
              return b > -1
                ? (delete this._indexCache[a], this.$list.splice(b, 1)[0])
                : null;
            },
            ...
            _assertNotDestroyed: function (a) {
              if (this._isDestroyed)
                throw new Error(
                  "Cannot call " +
                    a +
                    " method on a destroyed $firebaseArray object"
                );
            },
          }),
              ...
              1 === arguments.length &&
                ...
                (a = function (b) {
                  return this instanceof a
                    ? (d.apply(this, arguments), this.$list)
                    : new a(b);
                })),
              b.inherit(a, d, c)
            );
  ...
  (function () {
    ...
    angular.module("firebase").factory("$firebaseAuth", [
      ...
      (a = function (a, b, c) {
        if (((this._q = a), (this._utils = b), "string" == typeof c))
          throw new Error(
            "The $firebaseAuth service accepts a Firebase auth instance (or nothing) instead of a URL."
          );
        if ("undefined" != typeof c.ref)
          throw new Error(
            "The $firebaseAuth service accepts a Firebase auth instance (or nothing) instead of a Database reference."
          );
        (this._auth = c),
      ...
      (a.prototype = {
        ...
        signInWithRedirect: function (a) {
          return this._q.when(
            this._auth.signInWithRedirect(this._getProvider(a))
          );
        },
        ...
        signOut: function () {
          null !== this.getAuth() && this._auth.signOut();
        },
        ...
        _routerMethodOnAuthPromise: function (a) {
          ...
          return this._initialAuthResolver.then(function () {
            var c = b.getAuth(),
              d = null;
            return (d =
              a && null === c ? b._q.reject("AUTH_REQUIRED") : b._q.when(c));
          });
        },
        ...
        updatePassword: function (a) {
          var b = this.getAuth();
          return b
            ? this._q.when(b.updatePassword(a))
            : this._q.reject(
                "Cannot update password since there is no logged in user."
              );
        },
        updateEmail: function (a) {
          var b = this.getAuth();
          return b
            ? this._q.when(b.updateEmail(a))
            : this._q.reject(
                "Cannot update email since there is no logged in user."
              );
        },
        deleteUser: function () {
          var a = this.getAuth();
          return a
            ? this._q.when(a["delete"]())
            : this._q.reject(
                "Cannot delete user since there is no logged in user."
              );
        },
        ...
        function e(a) {
          return this instanceof e
            ? ((this.$$conf = {
              ...
              (this.$id = a.ref.key),
              (this.$priority = null),
              b.applyDefaults(this, this.$$defaults),
              void this.$$conf.sync.init())
            : new e(a);
        }
        function f(a) {
          (this.subs = []),
          ...
          function g() {
            e.on("value", k, l),
              e.once(
                "value",
                function (a) {
                  angular.isArray(a.val()) &&
                    c.warn(
                      "Storing data using array indices in Firebase can result in unexpected behavior. See https://firebase.google.com/docs/database/web/structure-data for more information. Also note that you probably wanted $firebaseArray and not $firebaseObject."
                    ),
                    m(null);
                },
                m
          ...
          (e.prototype = {
            ...
            $remove: function () {
              ...
              return (
                b.trimKeys(a, {}),
                (a.$value = null),
                b.doRemove(a.$ref()).then(function () {
            ...
            $destroy: function (a) {
              ...
              c.$isDestroyed ||
                ((c.$isDestroyed = !0),
                c.$$conf.sync.destroy(a),
                c.$$conf.binding.destroy(),
            ...
            $$scopeUpdated: function (a) {
              var c = d.defer();
              return (
                this.$ref().set(b.toJSON(a), b.makeNodeResolver(c)), c.promise
              );
            },
            $$notify: function () {
              var a = this,
          ...
          (f.prototype = {
            assertNotBound: function (a) {
              if (this.scope) {
                var b =
                  "Cannot bind to " +
                  a +
                  " because this instance is already bound to " +
                  this.key +
                  "; one binding per instance (call unbind method or create another FirebaseObject instance)";
            ...
            bindTo: function (c, d) {
              function e(e) {
                      ...
                      k.$$scopeUpdated(d)["finally"](function () {
                        (i = !1),
                          d.hasOwnProperty("$value") ||
                            (delete k.$value, delete j(c).$value),
                          g(k);
                      });
                    },
                    50,
                ...
                return (
                  g(k),
                  e.subs.push(c.$on("$destroy", e.unbind.bind(e))),
                  e.subs.push(c.$watch(h, m, !0)),
                  e.subs.push(k.$watch(n)),
                  e.unbind.bind(e)
                );
              }
            ...
            unbind: function () {
              this.scope &&
                (angular.forEach(this.subs, function (a) {
                  a();
                }),
                (this.subs = []),
                (this.scope = null),
      ...
      angular.module("firebase").factory("$FirebaseObject", [
        ...
        function (a, b) {
          return function () {
            return (
              a.warn(
                "$FirebaseObject has been renamed. Use $firebaseObject instead."
              ),
              b.apply(null, arguments)
            );
          };
  ...
  (function () {
    ...
    angular.module("firebase").factory("$firebase", function () {
      return function () {
        throw new Error(
          "$firebase has been removed. You may instantiate $firebaseArray and $firebaseObject directly now. For simple write operations, just use the Firebase ref directly. See the AngularFire 1.0.0 changelog for details: https://github.com/firebase/angularfire/releases/tag/v1.0.0"
        );
      };
    });
  })(),
  (function () {
    ...
    (a.$inject = ["$firebaseAuth", "$firebaseRef"]),
      angular.module("firebase").factory("$firebaseAuthService", a);
  })(),
  (function () {
    "use strict";
    function a() {
      (this.urls = null),
        (this.registerUrl = function (a) {
          "string" == typeof a &&
            ((this.urls = {}), (this.urls["default"] = a)),
            angular.isObject(a) && (this.urls = a);
        }),
        (this.$$checkUrls = function (a) {
          return a
            ? a["default"]
              ? void 0
              : new Error(
                  'No default Firebase URL registered. Use firebaseRefProvider.registerUrl({ default: "https://<my-firebase-app>.firebaseio.com/"}).'
                )
            : new Error(
                "No Firebase URL registered. Use firebaseRefProvider.registerUrl() in the config phase. This is required if you are using $firebaseAuthService."
              );
        }),
    ...
    angular.module("firebase").provider("$firebaseRef", a);
  })(),
  ...
  Array.prototype.findIndex ||
    Object.defineProperty(Array.prototype, "findIndex", {
      ...
      value: function (a) {
        ...
        for (
          var b, c = Object(this), d = c.length >>> 0, e = arguments[1], f = 0;
          d > f;
          f++
        )
      ...
      .factory("$firebaseConfig", [
        ...
        function (a, b, c) {
          return function (d) {
            ...
            return (
              "string" == typeof e.objectFactory &&
                (e.objectFactory = c.get(e.objectFactory)),
              "string" == typeof e.arrayFactory &&
                (e.arrayFactory = c.get(e.arrayFactory)),
              angular.extend({ arrayFactory: a, objectFactory: b }, e)
            );
          };
        },
      ])
        ...
        function (b, c, d) {
          var e = {
            ...
            debounce: function (a, b, c, d) {
              ...
              var i, j, k, l;
              if (
                ("number" == typeof b && ((d = c), (c = b), (b = null)),
                "number" != typeof c)
              )
                throw new Error(
            ...
            assertValidRef: function (a, b) {
              if (
                !angular.isObject(a) ||
                "object" != typeof a.ref ||
                "function" != typeof a.ref.transaction
              )
                throw new Error(b || "Invalid Firebase reference");
            },
            inherit: function (a, b, c) {
              ...
              return (
                ...
                angular.forEach(Object.keys(d), function (b) {
                  a.prototype[b] = d[b];
                }),
                angular.isObject(c) && angular.extend(a.prototype, c),
                a
              );
            },
            getPrototypeMethods: function (a, b, c) {
              for (
                var d = {},
                  ...
                  f =
                    angular.isFunction(a) && angular.isObject(a.prototype)
                      ? a.prototype
            ...
            scopeData: function (a) {
              ...
              return (
                ...
                !c && a.hasOwnProperty("$value") && (b.$value = a.$value),
                b
              );
            },
            ...
            toJSON: function (b) {
              var c;
              return (
                angular.isObject(b) || (b = { $value: b }),
                angular.isFunction(b.toJSON)
                  ? (c = b.toJSON())
                  : ((c = {}),
                    e.each(b, function (b, d) {
                      c[d] = a(b);
                    })),
                angular.isDefined(b.$value) &&
                  0 === Object.keys(c).length &&
                  null !== b.$value &&
                  (c[".value"] = b.$value),
                angular.isDefined(b.$priority) &&
                ...
                angular.forEach(c, function (a, b) {
                  if (
                    ...
                    throw new Error(
                      "Invalid key " + b + " (cannot contain .$[]#/)"
                    );
                  if (angular.isUndefined(a))
                    throw new Error(
                      "Key " +
                        b +
                        " was undefined. Cannot pass undefined in JSON. Use null instead."
                    );
                }),
                c
              );
            ...
            doSet: function (a, c) {
              var d = b.defer();
              if (angular.isFunction(a.set) || !angular.isObject(c))
                try {
                ...
                var g = angular.extend({}, c);
                a.once(
                  "value",
                  function (b) {
                    b.forEach(function (a) {
                      g.hasOwnProperty(a.key) || (g[a.key] = null);
                    }),
                      a.ref.update(g, e.makeNodeResolver(d));
                  },
                  function (a) {
                    d.reject(a);
                  }
            ...
            doRemove: function (a) {
              var c = b.defer();
              return (
                angular.isFunction(a.remove)
                  ? a.remove(e.makeNodeResolver(c))
                  : a.once(
                      "value",
                      function (b) {
                        var d = [];
