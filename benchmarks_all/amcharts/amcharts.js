...
AmCharts.callInitHandler = function (a) {
  ...
  if (AmCharts.initHandlers)
    for (var c = 0; c < b.length; c++) {
      var d = b[c];
      d.types
        ? AmCharts.isInArray(d.types, a.type) && d.method(a)
        : d.method(a);
    }
};
...
AmCharts.isNN &&
  ...
  window.addEventListener("orientationchange", AmCharts.handleResize, !0),
...
AmCharts.parseDefs = function (a, b) {
  for (var c in a) {
    ...
    if (0 < a[c].length && "object" == d)
      ...
      "object" == d
        ? ((e = document.createElementNS(AmCharts.SVG_NS, c)),
          b.appendChild(e),
          AmCharts.parseDefs(a[c], e))
...
AmCharts.ValueAxis = AmCharts.Class({
  ...
  draw: function () {
    ...
    AmCharts.setCN(a, this.labelsSet, "value-axis value-axis-" + this.id);
    AmCharts.setCN(
      a,
      ...
      if (0 < e) {
        ...
        for (f = this.fillAlpha = 0; f < e; f++) {
          var y = u[f],
            ...
            C = y.above;
          isNaN(y.toValue) ||
            ((A = this.getCoordinate(y.toValue)),
            (x = new this.axisItemRenderer(this, A, "", !0, NaN, NaN, y)),
            this.pushAxisItem(x, C));
          var B = NaN;
          isNaN(y.value) ||
            ((B = this.getCoordinate(y.value)),
            (x = new this.axisItemRenderer(
              this,
              B,
              y.label,
              !0,
            ...
            this.pushAxisItem(x, C));
          isNaN(A - B) ||
            ((x = new this.guideFillRenderer(this, B, A, y)),
            this.pushAxisItem(x, C),
            (x = x.graphics()),
            (y.graphics = x),
            y.balloonText && this.addEventListeners(x, y));
        }
        this.fillAlpha = w;
      }
      this.exponential = !1;
      for (f = p; f < r; f += n)
        (u = AmCharts.roundTo(this.step * f + this.min, t)),
          -1 != String(u).indexOf("e") &&
            ((this.exponential = !0), String(u).split("e"));
      this.duration &&
        (this.maxInterval = AmCharts.getMaxInterval(this.max, this.duration));
      var t = this.step,
        H,
        u = this.minorGridAlpha;
      this.minorGridEnabled &&
        (H = this.getMinorGridStep(t, this.stepWidth * t));
      for (f = p; f < r; f += n)
        if (
          ((p = t * f + this.min),
          d && this.max - this.min > 5 * this.min && (p -= this.min),
          ...
          if (isNaN(z) || Number(AmCharts.toFixed(p, z)) == p) {
            !0 === d &&
              (0 === p && (p = this.minReal),
              q > this.logGridLimit && (p = Math.pow(10, f)));
            ...
            if (p == this.baseValue && "radar" != a.type) {
              ...
              w = this.viY;
              "H" == this.orientation
                ? 0 <= e && e <= y + 1 && ((D = [e, e, e + g]), (I = [C, 0, h]))
                : 0 <= e &&
                  e <= C + 1 &&
                  ((D = [0, y, y + g]), (I = [e, e, e + h]));
              D &&
                ((e = AmCharts.fitToBounds(2 * this.gridAlpha, 0, 1)),
                (e = AmCharts.line(
                  a.container,
                  D,
                  I,
                ...
                a.axesSet.push(e),
                e.toBack(),
                AmCharts.setCN(a, e, this.bcn + "zero-grid-" + this.id),
                AmCharts.setCN(a, e, this.bcn + "zero-grid"));
            }
            if (!isNaN(H) && 0 < u && f < r - 1) {
              x = this.gridAlpha;
              this.gridAlpha = this.minorGridAlpha;
              for (e = 1; e < t / H; e++)
                (w = this.getCoordinate(p + H * e)),
                  (w = new this.axisItemRenderer(
                    this,
                    w,
                    "",
                    !1,
    ...
    this.positionTitle();
    "radar" != a.type
      ? ((a = this.viX), (H = this.viY), b.translate(a, H), q.translate(a, H))
      : d.toFront();
    !this.visible || c
      ? (b.hide(), d.hide(), q.hide())
      : (b.show(), d.show(), q.show());
  ...
  formatValue: function (a, b, c) {
    ...
    d
      ? ((b = -1 == String(a).indexOf("e") ? a.toExponential(15) : String(a)),
        (c = b.split("e")),
        (b = Number(c[0])),
        (c = Number(c[1])),
        (b = AmCharts.roundTo(b, 14)),
        10 == b && ((b = 1), (c += 1)),
        (b = b + "e" + c),
        0 === a && (b = "0"),
        1 == a && (b = "1"))
    ...
    this.recalculateToPercents
      ? (b += "%")
      : (f = this.unit) && (b = "left" == this.unitPosition ? f + b : b + f);
      ...
      for (n = 0; n < h.length; n++)
        if (((m = h[n]), m.hidden)) m.newStack && ((e[k] = NaN), (d[k] = NaN));
          ...
          if (
            ...
            r &&
              t &&
              (t = this.data[k].axes[this.id].graphs[t.id]) &&
...
AmCharts.RecItem = AmCharts.Class({
  construct: function (a, b, c, d, e, f, g, h, k, l, m, n) {
    ...
    var oa = a.counter,
      ...
      sa;
    g
      ? (void 0 != g.id && (n = p.classNamePrefix + "-guide-" + g.id),
        (ca = !0),
        isNaN(g.tickLength) || (A = g.tickLength),
        void 0 != g.lineColor && (H = g.lineColor),
        void 0 != g.color && (t = g.color),
        isNaN(g.lineAlpha) || (C = g.lineAlpha),
        isNaN(g.dashLength) || (D = g.dashLength),
        isNaN(g.lineThickness) || (B = g.lineThickness),
        !0 === g.inside && (S = !0),
        isNaN(g.labelRotation) || (m = g.labelRotation),
        isNaN(g.fontSize) || (q = g.fontSize),
        g.position && (Z = g.position),
        void 0 !== g.boldLabel && (h = g.boldLabel),
        isNaN(g.labelOffset) || (ma = g.labelOffset))
      : "" === c && (A = 0);
    var ha = "start";
    e && (ha = "middle");
    var O = (m * Math.PI) / 180,
    ...
    ca &&
      ((W =
        a.autoWrap && 0 === m
          ? AmCharts.wrappedText(z, c, t, r, q, ha, h, e, 0)
          : AmCharts.text(z, c, t, r, q, ha, h)),
      (ha = W.getBBox()),
      (da = ha.width),
      (Pa = ha.height));
    if ("H" == Oa) {
      if (
        (0 <= b &&
          ...
          (0 < A &&
            0 < y &&
            b + k <= ra + 1 &&
            ((ba = AmCharts.line(z, [b + k, b + k], [0, A], w, y, B)),
            x.push(ba)),
          0 < C &&
            ((sa = AmCharts.line(
              z,
        ...
        !1 === d
          ? ((ha = "start"),
            (v = "bottom" == Z ? (S ? v + A : v - A) : S ? v - A : v + A),
            (G += 3),
            e && ((G += e / 2 - 3), (ha = "middle")),
            0 < m && (ha = "middle"))
          : (ha = "middle"),
        1 == oa &&
          ...
          !l &&
          Y < ra &&
          ((d = AmCharts.fitToBounds(b, 0, ra)),
          (Y = AmCharts.fitToBounds(Y, 0, ra)),
          (U = d - Y),
          0 < U &&
            ((va = AmCharts.rect(z, U, a.height, I, X)),
            va.translate(d - U + pa, ia),
            x.push(va))),
        "bottom" == Z
          ? ((v += T + q / 2 + aa),
            S
              ? (0 < m
                  ? ((v = T - (da / 2) * Math.sin(O) - A - 3),
                    (G += (da / 2) * Math.cos(O) - 4 + 2))
                  : 0 > m
                  ? ((v = T + da * Math.sin(O) - A - 3 + 2),
                    (G += -da * Math.cos(O) - Pa * Math.sin(O) - 4))
                  : (v -= A + q + 3 + 3),
                (v -= ma))
              : (0 < m
                  ? ((v = T + (da / 2) * Math.sin(O) + A + 3),
          ...
          : ((v += ia + q / 2 - aa),
            ...
            S
              ? (0 < m
                  ? ((v = (da / 2) * Math.sin(O) + A + 3),
                    (G -= (da / 2) * Math.cos(O)))
                  : (v += A + 3),
                (v += ma))
              : (0 < m
                  ? ((v = -(da / 2) * Math.sin(O) - A - 6),
                    (G += (da / 2) * Math.cos(O)))
                  : (v -= A + q + 3 + u + 3),
                (v -= ma))),
        "bottom" == Z
          ? (U = (S ? T - A - 1 : T + u - 1) + aa)
          : ((ja = pa), (U = (S ? ia : ia - A - u + 1) - aa)),
        f && (G += f),
        (f = G),
        0 < m && (f += (da / 2) * Math.cos(O)),
        W &&
          ((q = 0), S && (q = (da / 2) * Math.cos(O)), f + q > ra + 2 || 0 > f))
      )
        W.remove(), (W = null);
    } else {
      0 <= b &&
        ...
        (0 < A &&
          0 < y &&
          b + k <= T + 1 &&
          ((ba = AmCharts.line(z, [0, A], [b + k, b + k], w, y, B)),
          x.push(ba)),
        0 < C &&
          ((sa = AmCharts.line(
            z,
      ...
      1 == oa &&
        ...
        !g &&
        !l &&
        ((d = AmCharts.fitToBounds(b, 0, T)),
        (Y = AmCharts.fitToBounds(Y, 0, T)),
        (O = d - Y),
        (va = AmCharts.polygon(
          z,
          [0, a.width, a.width, 0],
      ...
      "right" == Z
        ...
        ? ((G += A + 4 - aa),
          ...
          g && ((G += pa), (v += ia)),
          (G += ma))
        : ((G += -A - u - 4 - 2 - aa), (v -= 2), (G -= ma));
      ba &&
        ("right" == Z
          ? ((ja += pa + aa + ra), (U += ia), (ja = S ? ja - u : ja + u))
          : ((ja -= aa), S || (ja -= A + u)));
      f && (v += f);
      S = -3;
      "right" == Z && (S += ia);
    ...
    ba &&
      (ba.translate(ja, U),
      AmCharts.setCN(p, ba, a.bcn + "tick"),
      AmCharts.setCN(p, ba, n, !0),
      g && AmCharts.setCN(p, ba, "guide"));
    !1 === a.visible && (ba && ba.remove(), W && (W.remove(), (W = null)));
    W &&
      (W.attr({ "text-anchor": ha }),
      W.translate(G, v),
      0 !== m && W.rotate(-m, a.chart.backgroundColor),
      a.allLabels.push(W),
      (this.label = W),
      AmCharts.setCN(p, W, a.bcn + "label"),
      AmCharts.setCN(p, W, n, !0),
      g && AmCharts.setCN(p, W, "guide"));
    sa &&
      (AmCharts.setCN(p, sa, a.bcn + "grid"),
      AmCharts.setCN(p, sa, n, !0),
      g && AmCharts.setCN(p, sa, "guide"));
    va && (AmCharts.setCN(p, va, a.bcn + "fill"), AmCharts.setCN(p, va, n, !0));
    l
      ? sa && AmCharts.setCN(p, sa, a.bcn + "grid-minor")
      : ((a.counter = 0 === oa ? 1 : 0), (a.previousCoord = b));
...
AmCharts.RecFill = AmCharts.Class({
  construct: function (a, b, c, d) {
    ...
    "V" == g
      ? ((g = AmCharts.rect(k, a.viW, c, m, l)), g.translate(e, b - h + f))
      : ((g = AmCharts.rect(k, c, a.viH, m, l)), g.translate(b - h + e, f));
...
AmCharts.AmChart = AmCharts.Class({
  ...
  drawBackground: function () {
    ...
    if ((b = this.backgroundImage))
      this.path && (b = this.path + b),
        (a = a.image(b, 0, 0, e, f)),
        AmCharts.setCN(this, b, "bg-image"),
        (this.bgImg = a),
        d.push(a);
  },
  drawTitles: function () {
  ...
  updateWidth: function () {
    ...
    if (c) {
      ...
      if ("right" == c || "left" == c) {
        ...
        g.width = a + "px";
        "left" == c
          ? ((g.left = e + "px"), (d.left = "0px"))
          : ((g.left = "0px"), (d.left = a + "px"));
        b > f && (d.top = (b - f) / 2 + "px");
      }
    }
    return a;
  ...
  dispDUpd: function () {
    if (!this.skipEvents) {
      ...
      this.chartCreated ||
        ((a = "init"), this.fire(a, { type: a, chart: this }));
      this.chartRendered ||
        ((a = "rendered"),
        this.fire(a, { type: a, chart: this }),
  ...
  validateSize: function () {
    ...
    if (a.realWidth != a.previousWidth || a.realHeight != a.previousHeight) {
      if (0 < a.realWidth && 0 < a.realHeight) {
        ...
        "xy" != a.type
          ? (a.marginsUpdated = !1)
          : ((a.marginsUpdated = !0), (a.selfZoom = !0));
...
AmCharts.AmGraph = AmCharts.Class({
  ...
  draw: function () {
    ...
    var d = c.set(),
      e = c.set();
    this.behindColumns
      ? (a.graphsBehindSet.push(d), a.bulletBehindSet.push(e))
      : (a.graphsSet.push(d), a.bulletSet.push(e));
    ...
    d ||
      ((e = this.valueAxis.stackType),
      (d = "top"),
      "column" == this.type &&
        (a.rotate && (d = "right"), "100%" == e || "regular" == e) &&
        (d = "middle"),
  ...
  createXYGraph: function () {
    ...
    for (e = this.start; e <= this.end; e++) {
      ...
      !isNaN(h) &&
        ...
        (a.push(g),
        b.push(l),
        (h = this.createBullet(f, g, l, e)),
        (k = this.labelText)) &&
        ((f = this.createLabel(f, g, l, k)),
        this.positionLabel(g, l, f, h),
  ...
  positionLabel: function (a, b, c, d, e, f) {
    ...
    n &&
      f &&
      (h.height > k.columnHeight || h.width > k.columnWidth) &&
      (c.remove(), (c = !1));
    ...
    if (
      ...
      r
        ? ((da = n),
          ...
          (rb = Math.abs(fb - Fa) + 1),
          (eb = pb = 0),
          f.reversed ? ((W = 0), (db = Fa)) : ((W = Fa), (db = 0)))
        : ((Pa = m),
          (da = Math.abs(Hb - Fa) + 1),
          (rb = m),
          (qb = Math.abs(fb - Fa) + 1),
          (db = W = 0),
          f.reversed ? ((eb = p), (pb = Fa)) : (eb = Fa + 1));
    }
    var Ga = Math.round;
    this.pmx = Ga(W);
    this.pmy = Ga(pb);
    ...
    if ("line" == g || "step" == g || "smoothedLine" == g) {
      if (0 < ca) {
        ...
        if (this.dashLengthField)
          for (J = ca; -1 < J; J--)
            if (
              ((G = d[J]), (v = G.axes[f.id].graphs[b]), !isNaN(v.dashLength))
            ) {
    ...
    for (J = ca; J <= oa; J++) {
      ...
      if (l && void 0 == this.openField)
        for (
          ...
          tb < d.length &&
          (!d[tb] ||
            !(Ya = d[J + 1].axes[f.id].graphs[b]) ||
            !Ya.values ||
            ((La = Ya.values.value), isNaN(La)));
          tb++
        );
      var R,
        N,
      ...
      if (Aa) {
        ...
        if ("candlestick" == g || "ohlc" == g)
          (V = Aa.close),
            (vb = Aa.low),
            (Ca = f.getCoordinate(vb)),
            (ub = Aa.high),
            (Da = f.getCoordinate(ub));
        la = Aa.open;
        E = f.getCoordinate(V);
        isNaN(la) ||
          ((K = f.getCoordinate(la)), l && ((La = la), (la = K = NaN)));
        l &&
          (void 0 == this.openField
            ? Ya &&
              ((Ya.isNegative = La < V ? !0 : !1),
              isNaN(La) && (v.isNegative = !Ka))
            : (v.isNegative = La > V ? !0 : !1));
        if (!S)
        ...
        "start" == this.pointPosition &&
          ((ka -= U / 2 + Math.floor((Sa * U) / 2)),
          (qa = 0),
          (Ea = Math.floor(U) + Math.floor(Sa * U)));
        "end" == this.pointPosition &&
          ((ka += U / 2 + Math.floor((Sa * U) / 2)),
          (qa = Math.floor(U) + Math.floor(Sa * U)),
          (Ea = 0));
        if (Jb) {
        ...
        r
          ? ((F = E),
            (M = K),
            (K = E = ka),
            isNaN(la) && !this.fillToGraph && (M = ia),
            (Ma = Ca),
            (Na = Da))
          : ((M = F = ka), isNaN(la) && !this.fillToGraph && (K = ia));
        if ((!wb && V < la) || (wb && V < sa))
          (v.isNegative = !0),
            Ia && (Ha = Ia),
            Wa && (Ra = Wa),
        ...
        switch (g) {
            ...
            if (isNaN(V))
              ...
              if (
                ...
                this.drawLineGraph(x, u, P, Q),
                  ...
                  l
                    ? Ka
                      ? ((this.lineColorSwitched = ra),
                        (this.fillColorsSwitched = sb))
                      : ((this.lineColorSwitched = Ba),
                        (this.fillColorsSwitched = Ia))
          ...
          case "smoothedLine":
            if (isNaN(V))
              z ||
                (this.drawSmoothedGraph(x, u, P, Q),
                (x = []),
                (u = []),
                (P = []),
                (Q = []));
              ...
              r
                ? (isNaN(w) || (x.push(w), u.push(E - qa)),
                  ...
                  !Ja ||
                    isNaN(K) ||
                    isNaN(M) ||
                    (isNaN(A) || (P.push(A), Q.push(K - qa)),
                    P.push(M),
                    Q.push(K - qa),
                    P.push(M),
                    Q.push(K + Ea)))
                : (isNaN(y) ||
                    (u.push(y), x.push(w), u.push(y), x.push(F - qa)),
                  x.push(F - qa),
                  u.push(E),
                  x.push(F + Ea),
                  u.push(E),
              ...
              if (!((V < Kb && la < Kb) || (V > Lb && la > Lb))) {
                ...
                if (r) {
                  "3d" == X
                    ? ((N =
                        E -
                        (q / 2 - this.depthCount + 1) * (h + O) +
                        O / 2 +
                        I * Z),
                      (R = M + D * Z),
                      (ua = Z))
                    : ((N = Math.floor(E - (q / 2 - Z) * (h + O) + O / 2)),
                      (R = M),
                      (ua = 0));
                  L = h;
                  xa = F;
                  ...
                  N < n &&
                    ...
                    (v.columnWidth = Math.abs(ea)),
                    (v.columnHeight = Math.abs(L)));
                } else {
                  "3d" == X
                    ? ((R =
                        F -
                  ...
                  R < m + Z * D &&
                    ...
                    (v.columnHeight = Math.abs(ea)),
                    (v.columnWidth = Math.abs(L)));
                }
              }
              if (
                na &&
                ((wa = na.set),
                AmCharts.setCN(a, na.set, "graph-" + this.type),
                AmCharts.setCN(a, na.set, "graph-" + this.id),
                v.className && AmCharts.setCN(a, na.set, v.className, !0),
                (v.columnGraphics = wa),
                wa.translate(R, N),
                this.columnsSet.push(wa),
                (v.url || this.showHandOnHover) &&
                  wa.setAttr("cursor", "pointer"),
                !S)
              ) {
                "none" == X && (H = r ? (this.end + 1 - J) * B - c : B * J + c);
                "3d" == X &&
                  (r
                    ? ((H = (this.end + 1 - J) * B - c - 1e3 * this.depthCount),
                      (xa += D * this.columnIndex),
                      (fa += D * this.columnIndex),
                      (v.y += D * this.columnIndex))
                    : ((H = (B - c) * (J + 1) + 1e3 * this.depthCount),
                      (ya += I * this.columnIndex),
                      (ga += I * this.columnIndex),
                      (v.y += I * this.columnIndex)));
                if ("regular" == X || "100%" == X)
                  H = r
                    ? 0 < Aa.value
                      ? (this.end + 1 - J) * B + c
              ...
              if (r) {
                if (
                  ...
                  !isNaN(Na) &&
                    ...
                    E < n &&
                    0 < E &&
                    ((Ta = AmCharts.line(e, yb, [E, E], ta, T, Y)),
                    ($a = AmCharts.line(e, zb, [E, E], ta, T, Y)));
                  ea = F - M;
                  na = new AmCharts.Cuboid(
                    e,
                    ea,
                ...
                !isNaN(Da) &&
                  ...
                  F < m &&
                  0 < F &&
                  ((Ta = AmCharts.line(e, [F, F], Ab, ta, T, Y)),
                  ($a = AmCharts.line(e, [F, F], Bb, ta, T, Y)),
                  AmCharts.setCN(a, Ta, this.bcn + "line-high"),
                  v.className && AmCharts.setCN(a, Ta, v.className, !0),
                  AmCharts.setCN(a, $a, this.bcn + "line-low"),
                  v.className && AmCharts.setCN(a, $a, v.className, !0));
              }
              na &&
                ((wa = na.set),
                (v.columnGraphics = wa),
                ba.push(wa),
                wa.translate(R, N - Y / 2),
                (v.url || this.showHandOnHover) &&
                  wa.setAttr("cursor", "pointer"),
                Ta && (ba.push(Ta), ba.push($a)),
                (xa = F),
                (ya = E),
                r
                  ? ((ga = E),
          ...
          case "ohlc":
            if (!(isNaN(la) || isNaN(ub) || isNaN(vb) || isNaN(V))) {
              ...
              if (r) {
                ...
                0 < E &&
                  E < n &&
                  (lb = AmCharts.line(e, [Ma, Na], [E, E], za, T, Y, aa));
                ...
                0 < F &&
                  F < m &&
                  (lb = AmCharts.line(e, [F, F], [Ca, Da], za, T, Y, aa));
        ...
        if (!S && !isNaN(V)) {
          ...
          if (this.end - this.start <= Pb || 0 === Pb) {
            ...
            if (Qb) {
              ...
              (Gb = this.positionLabel(xa, ya, Gb, $b, L, ea)) &&
                this.allBullets.push(Gb);
            }
            if ("regular" == X || "100%" == X) {
              var Rb = f.totalText;
              if (Rb) {
                ...
                r
                  ...
                  : ((ab = F),
                    (bb =
                      0 > V ? E + Ub / 2 + cb + ob : E - Ub / 2 - 3 - cb - ob));
                Ua.translate(ab, bb);
                f.totals[J] = Ua;
                r
                  ? (0 > bb || bb > n) && Ua.remove()
  ...
  drawLineGraph: function (a, b, c, d) {
    ...
    if (1 < a.length) {
      ...
      void 0 === t ||
        ...
        ((n = AmCharts.line(h, a, b, t, r, n, z, !1, !0)),
        AmCharts.setCN(g, n, e.bcn + "stroke"),
        AmCharts.setCN(g, n, e.bcn + "stroke-negative"),
        l.push(n));
      if (0 < f || 0 < u)
        if (
          ((n = a.join(";").split(";")),
          ...
          "serial" == m
            ? 0 < c.length
              ? (c.reverse(), d.reverse(), (n = a.concat(c)), (r = b.concat(d)))
              : e.rotate
              ? (r.push(r[r.length - 1]),
                n.push(w),
                r.push(r[0]),
          ...
          0 < f &&
            ((b = AmCharts.polygon(h, n, r, q, f, 1, "#000", 0, a)),
            b.pattern(e.pattern),
            AmCharts.setCN(g, b, e.bcn + "fill"),
            k.push(b)),
          x || void 0 !== t)
        )
          isNaN(u) && (u = f),
            x || (x = t),
            (h = AmCharts.polygon(h, n, r, x, u, 1, "#000", 0, a)),
            AmCharts.setCN(g, h, e.bcn + "fill"),
            AmCharts.setCN(g, h, e.bcn + "fill-negative"),
            h.pattern(e.pattern),
            l.push(h),
            l
              .click(function (a) {
  ...
  drawSmoothedGraph: function (a, b, c, d) {
    if (1 < a.length) {
      ...
      h.push(l.path);
      void 0 !== q &&
        ((m = new AmCharts.Bezier(g, a, b, q, u, m, r, 0, e)),
        AmCharts.setCN(f, m, this.bcn + "stroke"),
        AmCharts.setCN(f, m, this.bcn + "stroke-negative"),
        k.push(m.path));
      0 < n &&
        ((l = a.join(";").split(";")),
        (p = b.join(";").split(";")),
        ...
        0 < c.length
          ...
          : (this.rotate
              ...
              : ((m += " L" + a[a.length - 1] + "," + x),
                (m += " L" + a[0] + "," + x)),
            (m += " L" + a[0] + "," + b[0])),
        (c = new AmCharts.Bezier(g, l, p, NaN, 0, 0, r, n, e, m)),
        AmCharts.setCN(f, c, this.bcn + "fill"),
        c.path.pattern(this.pattern),
        h.push(c.path),
        t || void 0 !== q) &&
        (z || (z = n),
        t || (t = q),
        (a = new AmCharts.Bezier(g, a, b, NaN, 0, 0, t, z, e, m)),
        a.path.pattern(this.pattern),
        AmCharts.setCN(f, a, this.bcn + "fill"),
        AmCharts.setCN(f, a, this.bcn + "fill-negative"),
        k.push(a.path));
      this.applyMask(k, h);
    }
  },
  ...
  createBullet: function (a, b, c, d) {
    if (!isNaN(b) && !isNaN(c)) {
      ...
      isNaN(k) ||
        (isNaN(h) || (g = ((h - l) / (k - l)) * (m - n) + n),
        l == k && (g = m));
      k = g;
      this.bulletAxis &&
        ((g = a.values.error),
        isNaN(g) || (h = g),
        (g = this.bulletAxis.stepWidth * h));
      ...
      a.isNegative &&
        ...
        (n = this.bulletColorNegative);
      void 0 !== a.color && (n = a.color);
      var r;
      "xy" == d.type &&
        this.valueField &&
        ((r = this.pattern), a.pattern && (r = a.pattern));
      f = this.bullet;
      a.bullet && (f = a.bullet);
      ...
      if (this.customBullet || a.customBullet)
        (r = this.customBullet),
          a.customBullet && (r = a.customBullet),
          r &&
            (p && p.remove(),
            "function" == typeof r
              ? ((p = new r()),
              ...
              : (d.path && (r = d.path + r),
                ...
                (e = e.image(r, 0, 0, g, g)),
                p.push(e),
                this.centerCustomBullets && e.translate(-g / 2, -g / 2)));
      p &&
...
AmCharts.ChartCursor = AmCharts.Class({
  ...
  draw: function () {
    ...
    a.valueLineBalloonEnabled &&
      ...
      (a.vaBalloon = d),
      AmCharts.copyProperties(c, d),
      (d.animationDuration = 0),
  ...
  createCursor: function () {
    ...
    m
      ? ((e = [0, k, k + g]), (f = [0, 0, h]), (g = [g, 0, 0]), (h = [h, 0, l]))
      : ((e = [g, 0, 0]),
        (f = [h, 0, l]),
        (g = [0, k, k + g]),
        (h = [0, 0, h]));
    ...
    this.valueLineEnabled &&
      ...
      isNaN(e) || (b = e),
      (b = AmCharts.line(this.container, g, h, this.cursorColor, b, 1)),
      AmCharts.setCN(a, b, "cursor-value-line"),
      (this.vLine = b),
      this.set.push(b));
    ...
    if (a.mouseIsOver) {
      ...
      -0.5 < b && b < this.width + 1 && 0 < c && c < this.height
        ? (this.drawing
          ...
          (this.rolledOver = !0),
          (this.valueLineEnabled || this.valueLineBalloonEnabled) &&
            this.updateVLine(b, c),
          this.setPosition())
  ...
  updateVLine: function (a, b) {
    ...
    if ((c || d) && !this.panning && !this.drawing) {
      ...
      var e = this.valueLineAxis,
        ...
        g = this.rotate;
      g
        ? (c && c.translate(a, 0), e && (f = e.coordinateToValue(a)), (c = a))
        : (c && c.translate(0, b),
          e && (f = e.coordinateToValue(b)),
          (c = b - 1));
  ...
  updateSelectionSize: function (a, b) {
    ...
    0 < g &&
      ...
      AmCharts.setCN(this.chart, c, "cursor-selection"),
  ...
  zoom: function (a, b, c, d) {
    ...
    if (this.fullWidth) {
      ...
      f
        ? (this.extraWidth = c = a * g)
        : ((this.extraWidth = b = a * g), (this.categoryBalloon.minWidth = b));
          ...
          if (((this.forceShow = !1), C)) {
            ...
            "start" == y
              ...
              : "mouse" == y &&
                (c.mouseIsOver
                  ? (q = t ? f - 2 : e - 2)
                  : isNaN(this.tempPosition) || (q = this.tempPosition - 2));
            if (t) {
              if (0 > q)
                if (A) q = 0;
                else {
            ...
            if (0 < this.cursorAlpha) {
              var D = this.line;
              t
                ? ((u = 0), (w = q + k), d && (w -= g.cellWidth / 2))
                : ((u = q), (w = 0), d && (u -= g.cellWidth / 2));
              z = this.animationDuration;
              0 < z && !this.zooming
                ? isNaN(this.previousX)
                  ? D.translate(u, w)
                  : (D.translate(this.previousX, this.previousY),
                    D.animate({ translate: u + "," + w }, z, "easeOutSine"))
                : D.translate(u, w);
              this.previousX = u;
              this.previousY = w;
              D.show();
            ...
            A &&
              (d && D.hide(),
              t
                ? this.updateSelectionSize(NaN, q)
                : this.updateSelectionSize(q, NaN));
            z = !0;
            A && (z = !1);
            this.categoryBalloonEnabled && z
              ? (this.setBalloonPosition(x, g, q, t),
                (u = this.categoryBalloonFunction)
                  ? x.showBalloon(u(r.category))
                  : g.parseDates
                  ? ((g = AmCharts.formatDate(
                    ...
                    -1 != g.indexOf("fff") &&
                      (g = AmCharts.formatMilliseconds(g, r.category)),
                    x.showBalloon(g))
                  : x.showBalloon(AmCharts.fixNewLines(r.category)))
              : x.hide();
              ...
              for (g = 0; g < B.length; g++)
                (u = B[g]),
                  u.showBalloon &&
                    !u.hidden &&
                    u.balloonText &&
                    ((w = r.axes[u.valueAxis.id].graphs[u.id]),
                    (x = w.y),
                    isNaN(x) ||
                      (t
                        ? Math.abs(e - x) < q &&
            ...
            if (a != this.previousIndex || H != this.previousMostCloseGraph)
              if (
                ...
                this.destroyValueBalloons(),
                (this.resizedBullets = []),
                B && this.valueBalloonsEnabled && z && c.balloon.enabled)
              ) {
                  ...
                  if (
                    ...
                    if (
                      ...
                      for (q = a + 1; q < this.data.length; q++)
                        if ((d = this.data[q]))
                          if (
                            ((w = d.axes[u.valueAxis.id].graphs[u.id]),
                            (x = w.y),
                            !isNaN(x))
                          )
                            break;
                    if (!isNaN(x)) {
                      ...
                      if (t) {
                        ...
                        k = !1;
                      k &&
                        ((k = this.graphBulletSize),
                        (D = this.graphBulletAlpha),
                        (1 == k && isNaN(D)) ||
                          !AmCharts.isModern ||
                          !(y = w.bulletGraphics) ||
                          (y.getBBox(),
                          y.translate(w.bx, w.by, k),
                          this.resizedBullets.push(w),
                          isNaN(D) ||
                            (y.setAttr("fill-opacity", D),
                            y.setAttr("stroke-opacity", D))),
                        (k = u.valueBalloon),
                        (D = c.getBalloonColor(u, w)),
                        k.setBounds(l, m, l + n, m + p),
                        (k.pointerOrientation = "H"),
                        (y = this.balloonPointerOrientation),
                        "vertical" == y && (k.pointerOrientation = "V"),
                        "horizontal" == y && (k.pointerOrientation = "H"),
                        k.changeColor(D),
                        void 0 !== u.balloonAlpha &&
                          (k.fillAlpha = u.balloonAlpha),
                        void 0 !== u.balloonTextColor &&
                          (k.color = u.balloonTextColor),
                        k.setPosition(q + l, d + m),
                        (q = c.formatString(u.balloonText, w, !0)),
                        (d = u.balloonFunction) && (q = d(w, u).toString()),
                        "" !== q &&
                          (t ? k.showBalloon(q) : ((k.text = q), (k.show = !0)),
                          z.push({ yy: x, balloon: k })),
                        !t &&
                          k.set &&
                          (k.set.hide(), (u = k.textDiv)) &&
  ...
  setBalloonPosition: function (a, b, c, d) {
    ...
    d
      ? (f &&
          ("right" == e
            ? a.setBounds(k, l + g, k + m + h, l + c + g)
            : a.setBounds(k, l + g, k + m + h, l + c)),
        "right" == e
          ? f
            ? a.setPosition(k + m + h, l + c + g)
            : a.setPosition(k + m + h + b, l + c + g)
          : f
          ? a.setPosition(k, l + c)
          : a.setPosition(k - b, l + c))
      : "top" == e
      ? f
        ? a.setPosition(k + c + h, l + g)
        : a.setPosition(k + c + h, l + g - b + 1)
      : f
      ? a.setPosition(k + c, l + n)
  ...
  setBalloonBounds: function (a, b, c) {
    ...
    c
      ? (e && (a.pointerWidth = 0),
        "right" == d
          ? e
            ? a.setBounds(l, m + h, l + n + k, m + p + h)
            : a.setBounds(l + n + k + f, m + h, l + n + 1e3, m + p + h)
          : e
          ? a.setBounds(l, m, n + l, p + m)
          : a.setBounds(-1e3, -1e3, l - g - f, m + p + 15))
      : ((a.maxWidth = n),
        b.parseDates && ((g = 0), (a.pointerWidth = 0)),
        "top" == d
          ? e
            ? a.setBounds(l + k, m + h, n + k + l, p + m)
            : a.setBounds(l + k, -1e3, n + k + l, m + h - g - f)
          : e
          ? a.setBounds(l, m, n + l, p + m - g)
          : a.setBounds(l, m + p + g + f - 1, l + n, m + p + g + f));
  },
        ...
        if (this.pan) this.rolledOver = !1;
          ...
          if ("cursor" == this.type)
            this.rotate
              ...
              (4 > Math.abs(e - this.initialMouse) &&
                ...
                e.parseDates &&
                  !e.equalSpacing &&
                  (b[c.start] && (c.start = b[c.start].time),
                  b[c.end] && (c.end = a.getEndTime(b[c.end].time))),
  ...
  updateDragIconPositions: function () {
    ...
    this.rotate
      ? ((f = this.dragIconWidth),
        ...
        e.translate((h - g) / 2, c + a.height - f / 2))
  ...
  handleBgClick: function () {
    ...
    if (!a.resizingRight && !a.resizingLeft) {
      ...
      l
        ? ((b = "y"),
          (c = c.mouseY - f / 2 - h),
          (c = AmCharts.fitToBounds(c, 0, a.height - f)))
        : ((b = "x"),
          (c = c.mouseX - g / 2 - k),
          (c = AmCharts.fitToBounds(c, 0, a.width - g)));
      a.updateOnReleaseOnly
        ? ((a.skipEvent = !1),
          ...
          a.clipDragger())
        : ((c = Math.round(c)),
          l ? e.animate({ y: c }, d, ">") : e.animate({ x: c }, d, ">"),
          (a.forceClip = !0),
    ...
    if (this.skipEvent) this.skipEvent = !1;
      ...
      if (h.parseDates && !h.equalSpacing) {
        if (
          ...
          (h = Math.round(b / k) + g),
          (b = this.dragging
            ? h + this.timeDifference
            : Math.round((b + c) / k) + g),
          h > b && (h = b),
          0 < e &&
            b - h < e &&
            ((b = Math.round(h + (b - h) / 2)),
            (d = Math.round(e / 2)),
            (h = b - d),
            (b += d),
            (d = !0)),
          ...
          h < g && (h = g),
          h + e > b && (b = h + e),
          h != this.startTime || b != this.endTime)
        )
          (this.startTime = h),
            (this.endTime = b),
            (f.start = h),
  ...
  draw: function () {
    ...
    if (!isNaN(a)) {
      ...
      if (this.show) {
        ...
        this.className &&
          (m.className =
            m.className + " " + A + "-balloon-div-" + this.className);
        A = m.style;
        ...
        "H" != x
          ? ((C = a - B / 2),
            b < h + w + 10 && "down" != x
              ? ((H = !0), d && (b += y), (y = b + z), (this.deltaSignY = -1))
              : (d && (b -= y), (y = b - w - z), (this.deltaSignY = 1)))
          : (2 * z > w && (z = w / 2),
            (y = b - w / 2),
            a < g + (k - g) / 2
              ? ((C = a + z), (this.deltaSignX = -1))
              : ((C = a - B - z), (this.deltaSignX = 1)));
        y + w >= l && (y = l - w);
        y < h && (y = h);
        C < g && (C = g);
        C + B > k && (C = k - B);
        ...
        0 < u || 0 === z
          ? (0 < t &&
            ...
            this.showBullet &&
              ((X = AmCharts.circle(e, I, r, this.fillAlpha)), f.push(X)))
          : ((r = []),
            (u = []),
            "H" != x
              ? ((g = a - C),
              ...
              : ((r = b - y),
                r > w - z && (r = w - z),
                r < z && (r = z),
                (u = [0, r - z, b - y, r + z, w, w, 0, 0]),
                (r =
                  a < g + (k - g) / 2
                    ? [0, 0, C < a ? 0 : a - C, 0, 0, B, B, 0]
                    : [B, B, C + B > a ? B : a - C, B, B, 0, 0, B])),
            0 < t &&
              ((a = AmCharts.polygon(e, r, u, n, 0, q, D, t)),
              a.translate(1, 1),
              f.push(a)),
            (n = AmCharts.polygon(
              e,
        ...
        0 < this.animationDuration &&
          ...
          f.animate({ translate: C - e + "," + y }, b, "easeOutSine"),
          m &&
            ((A.left = this.prevTX + "px"),
  ...
  parseSerialData: function () {
    ...
    if (e) {
      ...
      f &&
        ...
        (n = b.period),
        (p = b.count),
        (q = AmCharts.getPeriodDuration(n, p)));
      var t = {};
      this.lookupTable = t;
      var z,
      ...
      for (z = 0; z < e.length; z++) {
        ...
        if (
          ...
          ((b = h.categoryFunction
            ? h.categoryFunction(b, y, h)
            : b instanceof Date
            ? AmCharts.newDate(b, h.minPeriod)
            : x
            ? AmCharts.stringToDate(b, x)
            : new Date(b)),
          (b = AmCharts.resetDateToMin(b, n, p, h.firstDayOfWeek)),
          (w.category = b),
          (w.time = b.getTime()),
          isNaN(w.time))
        )
...
AmCharts.AmSlicedChart = AmCharts.Class({
  ...
  clickSlice: function (a, b, c) {
    ...
    AmCharts.getURL(a.url, this.urlTarget);
    c ||
      ((a = { type: "clickSlice", dataItem: a, chart: this, event: b }),
      this.fire(a.type, a));
  },
  handleRightClick: function (a, b) {
    isNaN(a) || (a = this.chartData[a]);
...
AmCharts.AmRectangularChart = AmCharts.Class({
  ...
  drawZoomOutButton: function () {
    ...
    void 0 !== a.pathToImages &&
      ...
      AmCharts.setCN(a, n, "zoom-out-image"),
      b.push(n),
      (n = n.getBBox()),
      (l = n.width + 5));
    void 0 !== g &&
      ((c = AmCharts.text(a.container, g, c, a.fontFamily, d, "start")),
      AmCharts.setCN(a, c, "zoom-out-label"),
      (d = c.getBBox()),
  ...
  drawPlotArea: function () {
    ...
    0 !== a &&
      ...
      AmCharts.setCN(this, e, "plot-area-bottom"),
      e.translate(c, d + f),
      this.set.push(e),
      (a = AmCharts.polygon(
        this.container,
      ...
      AmCharts.setCN(this, a, "plot-area-left"),
      a.translate(c, d),
      this.set.push(a));
...
AmCharts.TrendLine = AmCharts.Class({
  ...
  draw: function () {
    ...
    r &&
      !u &&
      (isNaN(q) || (d = r.getCoordinate(q)),
      isNaN(t) || (e = r.getCoordinate(t)));
    p &&
      !u &&
    ...
    isNaN(d) ||
      ...
      AmCharts.setCN(b, d, "trend-line"),
      AmCharts.setCN(b, d, "trend-line-" + a.id),
      (a.line = d),
      (a.set = c),
      h
        .mouseup(function () {
...
AmCharts.wedge = function (a, b, c, d, e, f, g, h, k, l, m, n) {
  ...
  n &&
    ((B["fill-opacity"] = 0),
    (B["stroke-opacity"] = l["stroke-opacity"] / 2),
    (B.stroke = l.stroke));
  0 < k &&
    ((I = " M" + t + "," + (x + k) + " L" + u + "," + (w + k)),
    q
      ...
      : ((I +=
        ...
        0 < h &&
          (I += " A" + h + "," + r + ",0," + H + ",0," + t + "," + (x + k))),
    (I = a.path(I + " Z", void 0, void 0, "1000,1000").attr(B)),
    d.push(I),
    (I = a
      .path(
        " M" +
...
AmCharts.AmDraw = AmCharts.Class({
  ...
  rect: function (a, b, c, d, e, f, g) {
    ...
    AmCharts.VML &&
      ((e = Math.round((100 * e) / Math.min(c, d))),
      (c += 2 * f),
      (d += 2 * f),
      (h.bw = f),
...
AmCharts.AmLegend = AmCharts.Class({
  ...
  invalidateSize: function () {
    ...
    this.enabled &&
      (AmCharts.ifArray(a) || AmCharts.ifArray(this.data)) &&
      this.drawLegend();
  },
  drawLegend: function () {
    var a = this.chart,
    ...
    if ((e = this.title))
      (e = AmCharts.text(
        ...
        AmCharts.setCN(a, e, "legend-title"),
        e.translate(
          this.marginLeft,
  ...
  arrangeEntries: function () {
    ...
    k = u.height + 2 * l - 1;
    "left" == a || "right" == a
      ? ((h = u.width + 2 * f), (g.style.width = h + b + c + "px"))
      : (h = h - b - c - 1);
    c = AmCharts.polygon(
      this.container,
      [0, h, h, 0],
    ...
    if ("top" == a || "bottom" == a || "absolute" == a || "outside" == a)
      "center" == this.align
        ? (b = f + (h - u.width) / 2)
        : "right" == this.align && (b = f + h - u.width);
    z.translate(b, l + 1);
  ...
  createEntry: function (a) {
    if (!1 !== a.visibleInLegend) {
      ...
      if (this.useGraphSettings) {
        ...
        if ("line" == c || "step" == c || "smoothedLine" == c || "ohlc" == c)
          (g = k.set()),
            ...
            AmCharts.setCN(b, m, "graph-stroke"),
            g.push(m),
            a.bullet &&
              ...
              (AmCharts.setCN(b, m, "graph-bullet"),
              m.translate(l + 1, l / 2),
              g.push(m)),
            (p = 0),
            (m = l),
      ...
      (f = this.switchType) &&
        "none" != f &&
        ("x" == f
          ? ((c = this.createX()), c.translate(l / 2, l / 2))
          : (c = this.createV()),
        (c.dItem = a),
        !0 !== a.hidden
          ? "x" == f
            ...
            : c.show()
          : "x" != f && c.hide(),
        this.switchable || c.hide(),
        this.addListeners(c, a),
        (a.legendSwitch = c),
        k.push(c),
        AmCharts.setCN(b, c, "legend-switch"));
      f = this.color;
      a.showBalloon &&
        this.textClickEnabled &&
      ...
      g &&
        (l <= c &&
          g.translate(p, l / 2 + this.ly - c / 2 + (c + 2 - l) / 2 - n),
      ...
      d &&
        ...
        (q = this.labelWidth),
        (q = isNaN(q)
          ? AmCharts.text(this.container, d, f, b.fontFamily, c, "start")
        ...
        AmCharts.setCN(b, q, "legend-label"),
        q.translate(this.lx + m, this.ly),
        k.push(q),
        (b = q.getBBox().width),
  ...
  createValue: function (a) {
    ...
    if (!1 !== a.visibleInLegend) {
      ...
      c = b.container
        .rect(a.legendEntryWidth, 0, f, d, 0, 0)
...
AmCharts.stringToDate = function (a, b) {
  ...
  AmCharts.useUTC
    ? ((d = new Date()),
      d.setUTCFullYear(c.year, c.month, c.date),
      d.setUTCHours(c.hours, c.minutes, c.seconds, c.milliseconds))
    : (d = new Date(
        c.year,
        c.month,
        c.date,
