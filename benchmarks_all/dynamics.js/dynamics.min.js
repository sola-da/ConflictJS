  ...
  (q = function () {
    ...
    (X = function (t) {
      ...
      return "undefined" != typeof SVGElement &&
        ...
        : null !=
          (e =
            null != (n = C.tests) && "function" == typeof n.isSVG
              ? n.isSVG(t)
              : void 0)
        ? e
        : !1;
            ...
            te.contains(r)
              ? null == i.transform &&
                ((o = n
                  ...
                  : u.fromTransform(s[A("transform")])),
                (i.transform = o.decompose()))
              : ((a = s[r]),
                null == a && B.contains(r) && (a = t.getAttribute(r)),
                ("" === a || null == a) && (a = k(r)),
                (i[r] = S(a)));
      else for (h = 0, c = e.length; c > h; h++) (r = e[h]), (i[r] = S(t[r]));
      return i;
    }),
    (S = function (t) {
      var e, n, o, u, l;
    ...
    (a = (function () {
      function t(t) {
        (this.parts = t),
          (this.format = re(this.format, this)),
          (this.interpolate = re(this.interpolate, this));
      }
      return (
    ...
    (t = (function () {
      function t(t, e) {
        (this.rgb = null != t ? t : {}),
          (this.format = e),
          (this.toRgba = re(this.toRgba, this)),
          (this.toRgb = re(this.toRgb, this)),
          (this.toHex = re(this.toHex, this));
      }
      return (
    ...
    (o = (function () {
      ...
      return (
        (e.prototype.interpolate = function (n, r) {
          ...
          return (
            (i = "a"),
            (u = Z((o.rgb[i] - a.rgb[i]) * r + a.rgb[i], 5)),
    ...
    (n = (function () {
      function t(t) {
        (this.props = t),
          (this.applyRotateCenter = re(this.applyRotateCenter, this)),
          (this.format = re(this.format, this)),
          (this.interpolate = re(this.interpolate, this));
      }
      return (
    ...
    (l = (function () {
      function t(t) {
        (this.m = t),
          (this.applyProperties = re(this.applyProperties, this)),
          (this.decompose = re(this.decompose, this)),
    ...
    (h = (function () {
      function t(t) {
        (this.els = t),
          (this.combine = re(this.combine, this)),
          (this.normalize = re(this.normalize, this)),
          (this.length = re(this.length, this)),
          (this.cross = re(this.cross, this)),
          (this.dot = re(this.dot, this)),
          (this.e = re(this.e, this));
      }
      return (
    ...
    (e = (function () {
      function t() {
        (this.toMatrix = re(this.toMatrix, this)),
          (this.format = re(this.format, this)),
          (this.interpolate = re(this.interpolate, this));
      }
      return (
    ...
    (u = (function () {
      function t(t) {
        (this.els = t),
          (this.toString = re(this.toString, this)),
          (this.decompose = re(this.decompose, this)),
          (this.inverse = re(this.inverse, this)),
          (this.augment = re(this.augment, this)),
          (this.toRightTriangular = re(this.toRightTriangular, this)),
          (this.transpose = re(this.transpose, this)),
          (this.multiply = re(this.multiply, this)),
          (this.dup = re(this.dup, this)),
          (this.e = re(this.e, this));
      }
      return (
        ...
        (t.matrixForTransform = w(function (t) {
          ...
          return (
            ...
            (n =
              null != (o = null != (i = r.transform) ? i : r[A("transform")])
                ? o
                : null != (s = C.tests)
    ...
    (D = function (t) {
      ...
      for (n = [], r = 0, o = m.length; o > r; r++)
        (e = m[r]), c(t, e) || n.push(e);
      return (
    ...
    (U = function (t, e, n, r) {
      ...
      for (h in e)
        (y = e[h]),
          null != t.style && te.contains(h)
            ? g.push([h, y])
            : ((s = S(y)),
              s instanceof i && null != t.style && (s = new a([s, ne(h, 0)])),
              (o[h] = s));
      return (
        g.length > 0 &&
          ((f = X(t)),
          f
            ? ((p = new l()), p.applyProperties(g))
            : ((y = g
                .map(function (t) {
                  return ee(t[0], t[1]);
                })
                .join(" ")),
              (p = u.fromTransform(u.matrixForTransform(y)))),
          (o.transform = p.decompose()),
          f &&
            c.transform.applyRotateCenter([
    ...
    (p = function (t, e) {
      ...
      return (
        (J += 1),
        (n = { id: J, tStart: Date.now(), fn: t, delay: e, originalDelay: e }),
        P(n),
        Q.push(n),
        J
      );
    ...
    z(function (t) {
      ...
      if (((E = !t), t)) {
        if (L)
          for (n = Date.now() - K, i = 0, u = m.length; u > i; i++)
            (e = m[i]), null != e.tStart && (e.tStart += n);
        for (s = 0, l = Q.length; l > s; s++)
          (r = Q[s]), (r.delay = Y(K, r)), P(r);
        return (K = null);
      }
      for (K = Date.now(), f = [], o = 0, a = Q.length; a > o; o++)
        (r = Q[o]), f.push(clearTimeout(r.realTimeoutId));
      return f;
    }),
    (C = {}),
    (C.linear = function () {
    ...
    (C.forceWithGravity = function (t) {
      return (
        null == t && (t = {}),
        g(t, C.forceWithGravity.defaults),
        (t.returnsToSelf = !0),
        C.gravity(t)
      );
    }),
    ...
    (C.easeInOut = function (t) {
      ...
      return (
        null == t && (t = {}),
        (e = null != (n = t.friction) ? n : C.easeInOut.defaults.friction),
        C.bezier({
          points: [
    ...
    (C.easeIn = function (t) {
      ...
      return (
        null == t && (t = {}),
        (e = null != (n = t.friction) ? n : C.easeIn.defaults.friction),
        C.bezier({
          points: [
            { x: 0, y: 0, cp: [{ x: 0.92 - e / 1e3, y: 0 }] },
            { x: 1, y: 1, cp: [{ x: 1, y: 1 }] },
    ...
    (C.easeOut = function (t) {
      ...
      return (
        null == t && (t = {}),
        (e = null != (n = t.friction) ? n : C.easeOut.defaults.friction),
        C.bezier({
          points: [
            { x: 0, y: 0, cp: [{ x: 0, y: 0 }] },
            { x: 1, y: 1, cp: [{ x: 0.08 + e / 1e3, y: 1 }] },
    ...
    (C.animate = j(function (t, e, n) {
      ...
      return (
        null == n && (n = {}),
        (n = M(n)),
        g(n, { type: C.easeInOut, duration: 1e3, delay: 0, animated: !0 }),
        (n.duration = Math.max(0, n.duration * N)),
    ...
    (C.toggleSlow = function () {
      return (
        ...
        "function" == typeof console.log
          ? console.log(
              "dynamics.js: slow animations " + (W ? "enabled" : "disabled")
            )
          : void 0
      );
    }),
