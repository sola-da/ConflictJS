...
!(function (t, e) {
  ...
  var t = function (e) {
    (e = e || {}),
      ...
      (this.email = "boolean" == typeof e.email ? e.email : !0),
      (this.twitter = "boolean" == typeof e.twitter ? e.twitter : !0),
      (this.phone = "boolean" == typeof e.phone ? e.phone : !0),
      (this.hashtag = e.hashtag || !1),
      (this.newWindow = "boolean" == typeof e.newWindow ? e.newWindow : !0),
      (this.stripPrefix =
        "boolean" == typeof e.stripPrefix ? e.stripPrefix : !0);
    var r = this.hashtag;
    if (r !== !1 && "twitter" !== r && "facebook" !== r && "instagram" !== r)
  ...
  return (
    ...
    (t.prototype = {
      ...
      normalizeUrlsCfg: function (t) {
        return (
          ...
          "boolean" == typeof t
            ...
            : {
                schemeMatches:
                  "boolean" == typeof t.schemeMatches ? t.schemeMatches : !0,
                wwwMatches:
                  "boolean" == typeof t.wwwMatches ? t.wwwMatches : !0,
                tldMatches:
                  "boolean" == typeof t.tldMatches ? t.tldMatches : !0,
              }
        );
      },
      ...
      parse: function (t) {
        for (
          ...
          if ("element" === c && "a" === o.getTagName())
            o.isClosing() ? (a = Math.max(a - 1, 0)) : a++;
          else if ("text" === c && 0 === a) {
        ...
        return (
          (n = this.compactMatches(n)), (n = this.removeUnwantedMatches(n))
        );
      },
      compactMatches: function (t) {
        ...
        for (var e = 0; e < t.length - 1; e++)
          for (
            var r = t[e], a = r.getOffset() + r.getMatchedText().length;
            e + 1 < t.length && t[e + 1].getOffset() <= a;
      ...
      parseText: function (t, e) {
        e = e || 0;
        for (
          var r = this.getMatchers(), a = [], n = 0, i = r.length;
          i > n;
          n++
        ) {
          for (var s = r[n].parseMatches(t), o = 0, c = s.length; c > o; o++)
            s[o].setOffset(e + s[o].getOffset());
          a.push.apply(a, s);
        }
        return a;
      },
      link: function (t) {
        if (!t) return "";
        for (
          var e = this.parse(t), r = [], a = 0, n = 0, i = e.length;
          i > n;
          n++
        ) {
          var s = e[n];
          r.push(t.substring(a, s.getOffset())),
            r.push(this.createMatchReturnVal(s)),
            (a = s.getOffset() + s.getMatchedText().length);
        }
      ...
      createMatchReturnVal: function (e) {
        var r;
        if (
          (this.replaceFn && (r = this.replaceFn.call(this, this, e)),
          "string" == typeof r)
        )
          return r;
      ...
      getMatchers: function () {
        ...
        var e = t.matcher,
          ...
          a = [
            new e.Hashtag({ tagBuilder: r, serviceName: this.hashtag }),
            new e.Email({ tagBuilder: r }),
            new e.Phone({ tagBuilder: r }),
            new e.Twitter({ tagBuilder: r }),
            new e.Url({ tagBuilder: r, stripPrefix: this.stripPrefix }),
          ];
    ...
    (t.Util = {
      ...
      defaults: function (t, e) {
        for (var r in e)
          e.hasOwnProperty(r) && void 0 === t[r] && (t[r] = e[r]);
        return t;
      },
      extend: function (e, r) {
        var a = e.prototype,
      ...
      splitAndCapture: function (t, e) {
        for (var r, a = [], n = 0; (r = e.exec(t)); )
          a.push(t.substring(n, r.index)),
            a.push(r[0]),
            (n = r.index + r[0].length);
        return a.push(t.substring(n)), a;
      },
      trim: function (t) {
    ...
    (t.RegexLib = (function () {
      ...
      return { alphaNumericCharsStr: r, domainNameRegex: a, tldRegex: n };
    })()),
    (t.AnchorTagBuilder = t.Util.extend(Object, {
      ...
      doTruncate: function (e) {
        ...
        var a = r.length,
          n = r.location;
        return "smart" === n
          ? t.truncate.TruncateSmart(e, a, "..")
          : "middle" === n
          ? t.truncate.TruncateMiddle(e, a, "..")
          : t.truncate.TruncateEnd(e, a, "..");
      },
    })),
    (t.htmlParser.HtmlParser = t.Util.extend(Object, {
      ...
      parse: function (t) {
        for (
          var e, r, a = this.htmlRegex, n = 0, i = [];
          null !== (e = a.exec(t));
          ...
          var s = e[0],
            ...
            l = e.index,
            u = t.substring(n, l);
          u && ((r = this.parseTextAndEntityNodes(n, u)), i.push.apply(i, r)),
            o
        ...
        if (n < t.length) {
          var g = t.substring(n);
          g && ((r = this.parseTextAndEntityNodes(n, g)), i.push.apply(i, r));
        }
        return i;
      },
      parseTextAndEntityNodes: function (e, r) {
        for (
          var a = [],
            n = t.Util.splitAndCapture(r, this.htmlCharacterEntitiesRegex),
            i = 0,
            s = n.length;
          s > i;
          i += 2
          ...
          var o = n[i],
            c = n[i + 1];
          o && (a.push(this.createTextNode(e, o)), (e += o.length)),
            c && (a.push(this.createEntityNode(e, c)), (e += c.length));
        }
        return a;
      },
      createCommentNode: function (e, r, a) {
        return new t.htmlParser.CommentNode({
          offset: e,
          text: r,
          comment: t.Util.trim(a),
        });
      },
      createElementNode: function (e, r, a, n) {
    ...
    (t.matcher.Email = t.Util.extend(t.matcher.Matcher, {
      matcherRegex: (function () {
        var e = t.RegexLib.alphaNumericCharsStr,
          r = new RegExp("[" + e + "\\-;:&=+$.,]+@"),
          a = t.RegexLib.domainNameRegex,
          n = t.RegexLib.tldRegex;
        return new RegExp([r.source, a.source, "\\.", n.source].join(""), "gi");
      })(),
      parseMatches: function (e) {
        for (
          var r, a = this.matcherRegex, n = this.tagBuilder, i = [];
          null !== (r = a.exec(e));
    ...
    (t.matcher.Url = t.Util.extend(t.matcher.Matcher, {
      matcherRegex: (function () {
        var e =
          ...
          a = t.RegexLib.domainNameRegex,
          n = t.RegexLib.tldRegex,
          i = t.RegexLib.alphaNumericCharsStr,
          s = new RegExp(
            "[" +
              i +
              "\\-+&@#/%=~_()|'$*\\[\\]?!:,.;]*[" +
      ...
      parseMatches: function (e) {
        for (
          ...
          var o = r[0],
            ...
            f = e.charAt(g - 1);
          if (
            t.matcher.UrlMatchValidator.isValid(o, c) &&
            !(
              (g > 0 && "@" === f) ||
              (g > 0 && m && this.wordCharRegExp.test(f))
            )
          ) {
            if (this.matchHasUnbalancedClosingParen(o))
              o = o.substr(0, o.length - 1);
            else {
              var p = this.matchHasInvalidCharAfterTld(o, c);
              p > -1 && (o = o.substr(0, p));
            }
            var d = c ? "scheme" : h ? "www" : "tld",
              b = !!c;
            s.push(
              new t.match.Url({
                tagBuilder: i,
      ...
      matchHasUnbalancedClosingParen: function (t) {
        ...
        if (")" === e) {
          var r = t.match(this.openParensRe),
            a = t.match(this.closeParensRe),
            n = (r && r.length) || 0,
            i = (a && a.length) || 0;
          if (i > n) return !0;
        }
      ...
      matchHasInvalidCharAfterTld: function (t, e) {
        ...
        var a =
            /^((.?\/\/)?[A-Za-z0-9\u00C0-\u017F\.\-]*[A-Za-z0-9\u00C0-\u017F\-]\.[A-Za-z]+)/,
          n = a.exec(t);
        return null === n
          ? -1
          : ((r += n[1].length),
            (t = t.slice(n[1].length)),
            /^[^.A-Za-z:\/?#]/.test(t) ? r : -1);
      },
    })),
    ...
    (t.truncate.TruncateEnd = function (e, r, a) {
      return t.Util.ellipsis(e, r, a);
    }),
    (t.truncate.TruncateMiddle = function (t, e, r) {
      ...
      var a = e - r.length,
        n = "";
      return (
        a > 0 && (n = t.substr(-1 * Math.floor(a / 2))),
        (t.substr(0, Math.ceil(a / 2)) + r + n).substr(0, e)
      );
    }),
    (t.truncate.TruncateSmart = function (t, e, r) {
      var a = function (t) {
          var e = {},
            ...
            a = r.match(/^([a-z]+):\/\//i);
          return (
            a && ((e.scheme = a[1]), (r = r.substr(a[0].length))),
            (a = r.match(/^(.*?)(?=(\?|#|\/|$))/i)),
            a && ((e.host = a[1]), (r = r.substr(a[0].length))),
            (a = r.match(/^\/(.*?)(?=(\?|#|$))/i)),
            a && ((e.path = a[1]), (r = r.substr(a[0].length))),
            (a = r.match(/^\?(.*?)(?=(#|$))/i)),
            a && ((e.query = a[1]), (r = r.substr(a[0].length))),
            (a = r.match(/^#(.*?)$/i)),
            a && (e.fragment = a[1]),
            e
          );
        ...
        i = function (t, e) {
          var a = e / 2,
            ...
            i = -1 * Math.floor(a),
            s = "";
          return 0 > i && (s = t.substr(i)), t.substr(0, n) + r + s;
        };
      if (t.length <= e) return t;
      var s = e - r.length,
        o = a(t);
      if (o.query) {
        ...
        c && ((o.query = o.query.substr(0, c[1].length)), (t = n(o)));
      }
      if (t.length <= e) return t;
      if (
        (o.host && ((o.host = o.host.replace(/^www\./, "")), (t = n(o))),
        t.length <= e)
      )
        return t;
      var h = "";
      if ((o.host && (h += o.host), h.length >= s))
        return o.host.length == e
          ? (o.host.substr(0, e - r.length) + r).substr(0, e)
          : i(h, s).substr(0, e);
      var l = "";
      if ((o.path && (l += "/" + o.path), o.query && (l += "?" + o.query), l)) {
        if ((h + l).length >= s) {
          if ((h + l).length == e) return (h + l).substr(0, e);
          var u = s - h.length;
          return (h + i(l, u)).substr(0, e);
        }
        h += l;
      }
      if (o.fragment) {
        var g = "#" + o.fragment;
        if ((h + g).length >= s) {
          if ((h + g).length == e) return (h + g).substr(0, e);
          var m = s - h.length;
          return (h + i(g, m)).substr(0, e);
        }
        h += g;
      }
      if (o.scheme && o.host) {
        var f = o.scheme + "://";
        if ((h + f).length < s) return (f + h).substr(0, e);
      }
      if (h.length <= e) return h;
      var p = "";
      return (
        s > 0 && (p = h.substr(-1 * Math.floor(s / 2))),
        (h.substr(0, Math.ceil(s / 2)) + r + p).substr(0, e)
      );
    }),
    t
  );
