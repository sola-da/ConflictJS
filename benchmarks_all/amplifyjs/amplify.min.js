...
(function (e, t) {
  ...
  (function (e, t) {
      ...
      n.addType(e, function (s, o, u) {
        ...
        if (!s) {
          ...
          try {
            ...
            while ((s = i.key(l++)))
              r.test(s) &&
                ((f = JSON.parse(i.getItem(s))),
                f.expires && f.expires <= p
                  ? c.push(s)
                  : (h[s.replace(r, "")] = f.data));
    ...
    var n = (e.store = function (e, t, r) {
      var i = n.type;
      return (
        r && r.type && r.type in n.types && (i = r.type),
        n.types[i](e, t, r || {})
      );
    });
    (n.types = {}),
    ...
    var r = /^__amplify__/;
    for (var s in { localStorage: 1, sessionStorage: 1 })
      try {
        window[s].setItem("__amplify__", "x"),
          window[s].removeItem("__amplify__"),
          i(s, window[s]);
      } catch (o) {}
    if (!n.types.localStorage && window.globalStorage)
      try {
        i("globalStorage", window.globalStorage[window.location.hostname]),
          n.type === "sessionStorage" && (n.type = "globalStorage");
      } catch (o) {}
    (function () {
      ...
      n.addType("userData", function (i, s, o) {
        ...
        if (!i) {
          (h = {}), (c = []), (l = 0);
          while ((u = e.XMLDocument.documentElement.attributes[l++]))
            (a = JSON.parse(u.value)),
              a.expires && a.expires <= p
                ? c.push(u.name)
                : (h[u.name] = a.data);
        ...
        try {
          ...
          f === null ? e.removeAttribute(i) : e.setAttribute(i, f),
            n.userData();
          try {
      ...
      (function () {
        ...
        n.addType("memory", function (n, s, o) {
          return n
            ? s === t
              ? i(e[n])
              : (r[n] && (clearTimeout(r[n]), delete r[n]),
                s === null
                  ? (delete e[n], null)
                  : ((e[n] = s),
                    o.expires &&
  ...
  (function (e, t) {
    ...
    (e.request = function (t, s, o) {
      ...
      typeof u == "string" &&
        (r(s) && ((o = s), (s = {})),
        (u = { resourceId: t, data: s || {}, success: o }));
      var a = { abort: n },
      ...
      (u.success = i(function (t, n) {
        (n = n || "success"),
          e.publish("request.success", u, t, n),
          e.publish("request.complete", u, t, n),
          l(t, n);
      })),
        (u.error = i(function (t, n) {
          (n = n || "error"),
            e.publish("request.error", u, t, n),
            e.publish("request.complete", u, t, n),
            c(t, n);
        }));
      if (!f)
        throw u.resourceId
          ? "amplify.request: unknown resourceId: " + u.resourceId
          : "amplify.request: no resourceId provided";
      ...
      (e.request.types = {}),
      (e.request.resources = {}),
      (e.request.define = function (t, n, r) {
        if (typeof n == "string") {
          if (!(n in e.request.types))
            throw "amplify.request.define: unknown type: " + n;
  ...
  (function (e, t, n) {
    ...
    (e.request.types.ajax = function (i) {
        ...
        function (s, o) {
          ...
          (a = function (e, i) {
            t.each(r, function (e, t) {
              ...
              e === n && (e = null),
              h && (i = "abort"),
              /timeout|error|abort/.test(i) ? p.error(e, i) : p.success(e, i),
              (a = t.noop);
          }),
            e.publish("request.ajax.preprocess", i, s, c, p),
            t.extend(c, {
              isJSONP: function () {
              ...
              cacheURL: function () {
                ...
                var e = "callback";
                this.hasOwnProperty("jsonp") &&
                  (this.jsonp !== !1
                    ? (e = this.jsonp)
                    : this.hasOwnProperty("jsonpCallback") &&
                      (e = this.jsonpCallback));
            ...
            c.cache && c.isJSONP() && t.extend(c, { cache: !0 }),
            t.ajax(c),
            (o.abort = function () {
              p.abort(), l.call(this);
            });
      ...
      e.subscribe("request.ajax.preprocess", function (e, n, r) {
        ...
        (o = t.extend(!0, {}, e.data, o)),
          (r.url = r.url.replace(i, function (e, t) {
    ...
    e.store &&
      (t.each(e.store.types, function (t) {
        s[t] = function (n, r, i, o) {
          ...
          o.success = function (r) {
            e.store[t](u, r, { expires: n.cache.expires }),
              f.apply(this, arguments);
          };
        };
      }),
      (s.persist = s[e.store.type])),
      e.subscribe("request.before.ajax", function (e) {
        var t = e.cache;
        if (t)
          return (
            (t = t.type || t), s[t in s ? t : "_default"].apply(this, arguments)
          );
      }),
      (e.request.decoders = {
      ...
      e.subscribe("request.before.ajax", function (n, r, i, s) {
        ...
        var o = s.success,
          u = s.error,
          a = t.isFunction(n.decoder)
            ? n.decoder
            : n.decoder in e.request.decoders
            ? e.request.decoders[n.decoder]
            : e.request.decoders._default;
        if (!a) return;
