(function (a) {
  ...
  function r(a, b) {
    function c(b, c) {
      ...
      } else c = new p(b.context, c);
      l.call(this, b.context),
        (this.left = b),
        (this.right = c),
        (this.toString = function () {
          return b + " " + a + " " + c;
    ...
    var d = (c.prototype = Object.create(l.prototype));
    return (
      (d.valueAt = function (a) {
      ...
      (d.on = function (a, b) {
        return arguments.length < 2
          ? this.left.on(a)
          : (this.left.on(a, b), this.right.on(a, b), this);
      }),
      function (a) {
        return new c(this, a);
      }
  ...
  (b.option = function (a, c) {
    ...
    (b.options = function (a, b) {
      var c = location.search.substring(1).split("&"),
        ...
        g;
      while (++e < f)
        (g = c[e].split("="))[0] == a && d.push(decodeURIComponent(g[1]));
    ...
    (b.context = function () {
      function p() {
        var c = Date.now();
        return (
          (g = new Date(Math.floor((c - j - k) / b) * b)),
          (f = new Date(g - d * b)),
          (i = new Date(Math.floor((c - j) / b) * b)),
          (h = new Date(i - d * b)),
          m.domain([f, g]),
          a
        );
      ...
      return (
        (a.start = function () {
          ...
          return (
            ...
            (n = setTimeout(function e() {
              (i = new Date(Math.floor((Date.now() - j) / b) * b)),
                (h = new Date(i - d * b)),
                l.prepare.call(a, h, i),
                setTimeout(function () {
                  m.domain([(f = h), (g = i)]),
                    l.beforechange.call(a, h, i),
                    l.change.call(a, h, i),
                    l.focus.call(a, o);
                }, k),
                (n = setTimeout(e, b));
        ...
        (a.on = function (b, c) {
          return arguments.length < 2
            ...
            : (l.on(b, c),
              c != null &&
                (/^prepare(\.|$)/.test(b) && c.call(a, h, i),
                /^beforechange(\.|$)/.test(b) && c.call(a, f, g),
                /^change(\.|$)/.test(b) && c.call(a, f, g),
                /^focus(\.|$)/.test(b) && c.call(a, o)),
              a);
        }),
  ...
  f.librato = function (a, c) {
    function f(a) {
      var b = avail_rsts[0],
        c = avail_rsts[avail_rsts.length];
      if (a >= c) return c;
      if (a <= b) return b;
      var d, e, f;
      for (f = a; f <= c; f++) {
        d = avail_rsts.indexOf(f);
        if (d > -1) {
          e = avail_rsts[d];
          break;
        }
    ...
    function g(a, b, c) {
      ...
      return d > e
        ? 3600
        : ((i = f(c)), d > g && i < 900 ? 900 : d > h && i < 60 ? 60 : i);
    }
    var d = {},
      e = this;
    (auth_string = "Basic " + btoa(a + ":" + c)),
    ...
    var j = function (a) {
      ...
      function e(a, b, c, d) {
        ...
        for (i = a; i <= b; i += c) {
          var f = [];
          while (d.length && d[0].measure_time <= i) f.push(d.shift().value);
          var g;
          f.length
            ? (g =
      ...
      var c = "https://metrics-api.librato.com/v1/metrics";
      return (
        (request = {}),
        (request.fire = function (a, c, f, g) {
          function i(j) {
            d3.json(j)
              .header("X-Requested-With", "XMLHttpRequest")
              .header("Authorization", auth_string)
              .header("Librato-User-Agent", "cubism/" + b.version)
              .get(function (b, j) {
                if (!b) {
                  if (j.measurements.length === 0) return;
                  j.measurements[0].series.forEach(function (a) {
                    h.push(a);
                  });
                  var k = "query" in j && "next_time" in j.query;
                  if (k) i(d(j.query.next_time, c, f));
                  else {
                    var l = e(a, c, f, h);
                    g(l);
                  }
    ...
    return (
      (d.metric = function (a) {
        return e.metric(function (b, c, d, e) {
          j(a).fire(h(b), h(c), h(d), function (a) {
            e(null, a);
          });
        }, (a += ""));
      }),
  ...
  (b.metric = l),
    ...
    (f.metric = function (a, b) {
      function r(b, c) {
        var d = Math.min(j, Math.round((b - g) / i));
        if (!d || q) return;
        (q = !0), (d = Math.min(j, d + n));
        var f = new Date(c - d * i);
        a(f, c, i, function (a, b) {
          q = !1;
          if (a) return console.warn(a);
          var d = isFinite(g) ? Math.round((f - g) / i) : 0;
          for (var h = 0, j = b.length; h < j; ++h) k[h + d] = b[h];
          m.change.call(e, g, c);
        });
      }
      function s(a, b) {
        isFinite(g) || (g = a),
          k.splice(0, Math.max(0, Math.min(j, Math.round((a - g) / i)))),
          (g = a),
          (h = b);
      }
      var d = this,
        ...
        j = d.size(),
        k = [],
        m = d3.dispatch("change"),
        p = 0,
        q;
      return (
        (e.valueAt = function (a) {
          return k[a];
        }),
        (e.shift = function (b) {
          return d.metric(o(a, +b));
        }),
        (e.on = function (a, b) {
          return arguments.length
            ? (b == null
                ? m.on(a) != null &&
                  --p == 0 &&
                  d.on("prepare" + f, null).on("beforechange" + f, null)
                : m.on(a) == null &&
                  ++p == 1 &&
                  d.on("prepare" + f, r).on("beforechange" + f, s),
              m.on(a, b),
              b != null && /^change(\.|$)/.test(a) && b.call(d, g, h),
              e)
            : m.on(a);
        }),
        arguments.length > 1 &&
  ...
  var n = 6,
    q = (p.prototype = Object.create(l.prototype));
  (q.valueAt = function () {
    return +this;
  }),
    (q.extent = function () {
    ...
    (m.add = r("+", function (a, b) {
      return a + b;
    })),
    (m.subtract = r("-", function (a, b) {
      return a - b;
    })),
    (m.multiply = r("*", function (a, b) {
      return a * b;
    })),
    (m.divide = r("/", function (a, b) {
      return a / b;
    })),
    (f.horizon = function () {
      function o(o) {
        o
          ...
          o.append("canvas").attr("width", f).attr("height", g),
          o.append("span").attr("class", "title").text(k),
          o.append("span").attr("class", "value"),
          o.each(function (k, o) {
            function B(c, d) {
              w.save();
              var i = r.extent();
              ...
              if (this === a) {
                if (k == y) {
                  ...
                  if (l < f) {
                    ...
                    m.clearRect(0, 0, f, g),
                      m.drawImage(w.canvas, l, 0, f - l, g, 0, 0, f - l, g),
                      w.clearRect(0, 0, f, g),
                      w.drawImage(m.canvas, 0, 0);
                  }
                }
                u = c;
              }
            ...
            function C(a) {
              a == null && (a = f - 1);
              var b = r.valueAt(a);
              x.datum(b).text(isNaN(b) ? null : l);
            }
            var p = this,
              q = ++c,
              r = typeof i == "function" ? i.call(p, k, o) : i,
              s = typeof m == "function" ? m.call(p, k, o) : m,
              ...
              z = s.length >> 1,
              A;
            w.datum({ id: q, metric: r }),
              (w = w.node().getContext("2d")),
              a.on("change.horizon-" + q, B),
              a.on("focus.horizon-" + q, C),
              r.on("change.horizon-" + q, function (a, b) {
      ...
      return (
        (o.remove = function (b) {
          function c(b) {
            b.metric.on("change.horizon-" + b.id, null),
              a.on("change.horizon-" + b.id, null),
              a.on("focus.horizon-" + b.id, null);
          }
          b.on("mousemove.horizon", null).on("mouseout.horizon", null),
            b.selectAll("canvas").each(c).remove(),
            b.selectAll(".title,.value").remove();
        }),
        (o.mode = function (a) {
    ...
    (f.comparison = function () {
      function o(o) {
        o
          ...
          o.append("canvas").attr("width", b).attr("height", e),
          o.append("span").attr("class", "title").text(j),
          o.append("span").attr("class", "value primary"),
          o.append("span").attr("class", "value change"),
          o.each(function (j, o) {
            function B(c, d) {
            ...
            function D(a, b) {
              B(a, b),
                C(),
                A &&
                  (r.on("change.comparison-" + q, d),
                  s.on("change.comparison-" + q, d));
            }
            var p = this,
              q = ++c,
              r = typeof g == "function" ? g.call(p, j, o) : g,
              s = typeof h == "function" ? h.call(p, j, o) : h,
              t = typeof i == "function" ? i.call(p, j, o) : i,
              w = d3.select(p),
              x = w.select("canvas"),
              y = w.select(".value.primary"),
              z = w.select(".value.change"),
              A;
            x.datum({ id: q, primary: r, secondary: s }),
              (x = x.node().getContext("2d")),
              r.on("change.comparison-" + q, D),
              s.on("change.comparison-" + q, D),
              a.on("change.comparison-" + q, B),
              a.on("focus.comparison-" + q, C);
          });
      }
      var a = this,
        b = a.size(),
      ...
      return (
        (o.remove = function (b) {
          function c(b) {
            b.primary.on("change.comparison-" + b.id, null),
              b.secondary.on("change.comparison-" + b.id, null),
              a.on("change.comparison-" + b.id, null),
              a.on("focus.comparison-" + b.id, null);
          }
          b.on("mousemove.comparison", null).on("mouseout.comparison", null),
            b.selectAll("canvas").each(c).remove(),
            b.selectAll(".title,.value").remove();
        }),
        (o.height = function (a) {
  ...
  f.axis = function () {
    function g(e) {
      var h = ++c,
        ...
        j = e
          ...
          .datum({ id: h })
          .attr("width", a.size())
          .attr("height", Math.max(28, -g.tickSize()))
          .append("g")
          .attr(
            "transform",
            "translate(0," + (d.orient() === "top" ? 27 : 4) + ")"
          )
          .call(d);
      a.on("change.axis-" + h, function () {
        j.call(d),
          i ||
            (i = d3
              .select(
                j.node().appendChild(j.selectAll("text").node().cloneNode(!0))
              )
              .style("display", "none")
              .text(null));
      }),
          ...
          if (i)
            if (a == null)
              i.style("display", "none"),
                j.selectAll("text").style("fill-opacity", null);
            else {
    ...
    var a = this,
      ...
      e = a.step() < 6e4 ? w : a.step() < 864e5 ? x : y,
      f = e;
    return (
      (g.remove = function (b) {
        function c(b) {
  ...
  var w = d3.time.format("%I:%M:%S %p"),
    x = d3.time.format("%I:%M %p"),
    y = d3.time.format("%B %d");
  f.rule = function () {
    function e(d) {
      var e = ++c,
        f = d.append("div").datum({ id: e }).attr("class", "line").call(z);
      d.each(function (e, f) {
        function j(b, c) {
          var e = [];
          ...
          h.exit().remove(),
            h.enter().append("div").attr("class", "metric line").call(z),
            h.style("left", A);
        }
        var g = this,
          h = ++c,
        ...
        a.on("focus.rule-" + e, function (a) {
          f.datum(a)
            .style("display", a == null ? "none" : null)
            .style("left", a == null ? null : A);
        });
    }
    var a = this,
      b = d;
