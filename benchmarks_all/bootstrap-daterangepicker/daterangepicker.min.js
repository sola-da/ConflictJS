  ...
  return (
    (a.prototype = {
      ...
      renderCalendar: function (a) {
        ...
        for (
          var k, y, v = t([f, m, g, 12, h, o]), D = 0, k = 0, y = 0;
          42 > D;
          D++, k++, v = t(v).add(24, "hour")
        )
          D > 0 && k % 7 === 0 && ((k = 0), y++),
        ...
        if (this.showDropdowns) {
          for (
            ...
            B +=
              (!S || _ >= C.month()) && (!A || _ <= b.month())
                ? "<option value='" +
                  _ +
                  "'" +
                  (_ === M ? " selected='selected'" : "") +
                  ">" +
                  this.locale.monthNames[_] +
                  "</option>"
                : "<option value='" +
                  _ +
                  "'" +
        ...
        for (var y = 0; 6 > y; y++) {
          ...
          for (var k = 0; 7 > k; k++) {
            ...
            for (var H = "", T = !1, D = 0; D < N.length; D++)
              (H += N[D] + " "), "disabled" == N[D] && (T = !0);
            T || (H += "available"),
              (w +=
                '<td class="' +
                H.replace(/^\s+|\s+$/g, "") +
