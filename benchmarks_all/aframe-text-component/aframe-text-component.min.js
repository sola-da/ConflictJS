!(function (l) {
  function q(x) {
    if (m[x]) return m[x].exports;
    var a = (m[x] = { exports: {}, id: x, loaded: !1 });
    return l[x].call(a.exports, a, a.exports, q), (a.loaded = !0), a.exports;
  }
  var m = {};
  return (q.m = l), (q.c = m), (q.p = ""), q(0);
})([
  function (l, q, m) {
    function x(l) {
      return new THREE.TextGeometry(l.text, l);
    }
    m(1),
      m(2),
      m(3),
      AFRAME.registerComponent("text", {
        ...
        update: function (l) {
          this.el.getOrCreateObject3D("mesh", THREE.Mesh).geometry = x(
            this.data
          );
        },
      });
  ...
  function (l, q) {
    (THREE.FontUtils = {
      ...
      loadFace: function (l) {
        var q = l.familyName.toLowerCase(),
          m = this;
        return (
          (m.faces[q] = m.faces[q] || {}),
          (m.faces[q][l.cssFontWeight] = m.faces[q][l.cssFontWeight] || {}),
          (m.faces[q][l.cssFontWeight][l.cssFontStyle] = l),
          (m.faces[q][l.cssFontWeight][l.cssFontStyle] = l),
          l
        );
      },
      drawText: function (l) {
        var q,
          m = this.getFace(),
          x = this.size / m.resolution,
          a = 0,
          n = String(l).split(""),
          o = n.length,
          i = [];
        for (q = 0; o > q; q++) {
          var _ = new THREE.Path(),
            e = this.extractGlyphPoints(n[q], m, x, a, _);
          (a += e.offset), i.push(e.path);
        }
        var t = a / 2;
        return { paths: i, offset: t };
      },
      extractGlyphPoints: function (l, q, m, x, a) {
        var n,
          o,
          i,
          _,
          ...
          y,
          F = [],
          O = THREE.ShapeUtils.b2,
          A = THREE.ShapeUtils.b3,
          N = q.glyphs[l] || q.glyphs["?"];
        if (N) {
          if (N.o)
            for (
              _ = N._cachedOutline || (N._cachedOutline = N.o.split(" ")),
                t = _.length,
                h = m,
                s = m,
                n = 0;
              ...
              switch ((e = _[n++])) {
                case "m":
                  (r = _[n++] * h + x), (c = _[n++] * s), a.moveTo(r, c);
                  break;
                case "l":
                  (r = _[n++] * h + x), (c = _[n++] * s), a.lineTo(r, c);
                  break;
                case "q":
                  if (
                    ((f = _[n++] * h + x),
                    ...
                    (u = _[n++] * h + x),
                    (p = _[n++] * s),
                    a.quadraticCurveTo(u, p, f, d),
                    (y = F[F.length - 1]))
                  )
                    for (
                      E = y.x, T = y.y, o = 1, i = this.divisions;
                      i >= o;
                      o++
                    ) {
                      var v = o / i;
                ...
                case "b":
                  if (
                    ...
                    for (
                      ...
                      var v = o / i;
                      A(v, E, u, R, f), A(v, T, p, g, d);
                    }
              }
          return { offset: N.ha * m, path: a };
        }
      },
    }),
      (THREE.FontUtils.generateShapes = function (l, q) {
        q = q || {};
        var m = void 0 !== q.size ? q.size : 100,
          x = void 0 !== q.curveSegments ? q.curveSegments : 4,
          a = void 0 !== q.font ? q.font : "helvetiker",
          n = void 0 !== q.weight ? q.weight : "normal",
          o = void 0 !== q.style ? q.style : "normal";
        (THREE.FontUtils.size = m),
          (THREE.FontUtils.divisions = x),
          (THREE.FontUtils.face = a),
          (THREE.FontUtils.weight = n),
          (THREE.FontUtils.style = o);
        for (
          var i = THREE.FontUtils.drawText(l),
            _ = i.paths,
            e = [],
            t = 0,
            h = _.length;
          ...
          Array.prototype.push.apply(e, _[t].toShapes());
        return e;
      }),
      (THREE.typeface_js = {
  ...
  function (l, q) {
    (THREE.TextGeometry = function (l, q) {
      q = q || {};
      var m = THREE.FontUtils.generateShapes(l, q);
      (q.amount = void 0 !== q.height ? q.height : 50),
        void 0 === q.bevelThickness && (q.bevelThickness = 10),
        void 0 === q.bevelSize && (q.bevelSize = 8),
        void 0 === q.bevelEnabled && (q.bevelEnabled = !1),
        THREE.ExtrudeGeometry.call(this, m, q),
