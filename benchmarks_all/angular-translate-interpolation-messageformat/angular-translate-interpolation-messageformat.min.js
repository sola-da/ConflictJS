...
!(function (a, b) {
  "function" == typeof define && define.amd
    ? // AMD. Register as an anonymous module unless amdModuleId is set
      define(["messageformat"], function (a) {
        return b(a);
      })
  ...
  function b(b, c, d) {
    ...
    return (
      ...
      (e.setLocale = function (b) {
        (g = f.get(b)), g || ((g = new a(b)), f.put(b, g));
      }),
      (e.getInterpolationIdentifier = function () {
        return h;
      }),
      (e.useSanitizeValueStrategy = function (a) {
        return b.useStrategy(a), this;
      }),
      (e.interpolate = function (a, c) {
        (c = c || {}), (c = b.sanitize(c, "params"));
        var d = f.get("mf:" + a);
        ...
        if (!d) {
          ...
          for (var e in c)
            if (c.hasOwnProperty(e)) {
              // ensure number
              var h = parseInt(c[e], 10);
              angular.isNumber(h) && "" + h === c[e] && (c[e] = h);
            }
          (d = g.compile(a)), f.put("mf:" + a, d);
        }
        var i = d(c);
        return b.sanitize(i, "text");
      }),
      e
    );
  }
  return (
    ...
    angular
      ...
      .factory("$translateMessageFormatInterpolation", b),
    (b.displayName = "$translateMessageFormatInterpolation"),
