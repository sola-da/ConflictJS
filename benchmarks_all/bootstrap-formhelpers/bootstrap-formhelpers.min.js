        ...
        b.hasClass("open")
          ? (b.trigger((c = a.Event("hide.bfhcolorpicker"))),
            c.isDefaultPrevented()
              ? !0
              : (b.removeClass("open").trigger("hidden.bfhcolorpicker"),
                void 0))
          : !0
      );
    });
  ...
  g.prototype = {
    ...
    initPopover: function () {
      ...
      (a = ""),
        ...
        this.$element
          .on(
            "click.bfhcolorpicker.data-api touchstart.bfhcolorpicker.data-api",
            f,
            g.prototype.toggle
          )
          .on(
        ...
        return (
          ...
          b.hasClass("open")
            ? (b.trigger((c = a.Event("hide.bfhdatepicker"))),
              c.isDefaultPrevented()
                ? !0
                : (b.removeClass("open").trigger("hidden.bfhdatepicker"),
                  void 0))
            : !0
        );
      });
          ...
          b.hasClass("open")
            ? (b.trigger((d = a.Event("hide.bfhselectbox"))),
              d.isDefaultPrevented()
                ? !0
                : (b.removeClass("open").trigger("hidden.bfhselectbox"),
                  void 0))
            : !0
        );
      });
        ...
        return (
          ...
          b.hasClass("open")
            ? (b.trigger((c = a.Event("hide.bfhtimepicker"))),
              c.isDefaultPrevented()
                ? !0
                : (b.removeClass("open").trigger("hidden.bfhtimepicker"),
                  void 0))
            : !0
        );
      });
        ...
        (b = ""),
          ...
          this.$element.html(
            '<div class="' +
              ...
              h +
              '" data-zeros="true" data-wrap="true">' +
              "</td>" +
              '<td class="separator">' +
              BFHTimePickerDelimiter +
              "</td>" +
              ...
              '<input type="text" class="' +
              this.options.input +
              ' bfh-number"  data-min="0" data-max="59" data-zeros="true" data-wrap="true">' +
              "</td>" +
              g +
              "</tr>" +
              "</tbody>" +
