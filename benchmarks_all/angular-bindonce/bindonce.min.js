  ...
  e.directive("bindonce", function () {
    ...
    var r = {
            ...
            l = {
              ...
              removeWatcher: function () {
                void 0 !== this.watcherRemover &&
                  (this.watcherRemover(), (this.watcherRemover = void 0));
              },
              runBinders: function () {
                  ...
                  if (!this.group || this.group == r.group) {
                    ...
                    switch (r.attr) {
                      ...
                      case "boSwitchWhen":
                        ...
                        (u.cases["!" + r.attrs.boSwitchWhen] =
                          u.cases["!" + r.attrs.boSwitchWhen] || []),
                          u.cases["!" + r.attrs.boSwitchWhen].push({
      ...
      link: function (e, t, r, a) {
        ...
        void 0 !== i
          ? a.checkBindonce(i)
          : (a.setupWatcher(r.bindonce), t.bind("$destroy", a.removeWatcher));
      },
    };
    return r;
  }),
