          ...
          (function (global) {
              ...
              return Rx.Observable.create(function (observer) {
                ...
                setTimeout(function () {
                  ...
                  for (var i = 0; i < keys.length; i++) {
                    var _name2 = keys[i];
                    if (
                      subjects.hasOwnProperty(_name2) &&
                      !subjects[_name2].isDisposed
                    ) {
                      subscription.add(
                        observables[_name2]
                          .doOnError(logToConsoleError)
                          .subscribe(subjects[_name2].asObserver())
                      );
                    }
                  }
            ...
            function run(main, drivers) {
              if (typeof main !== "function") {
                throw new Error(
                  "First argument given to Cycle.run() must be the 'main' " +
                    "function."
                );
              }
              if (typeof drivers !== "object" || drivers === null) {
                throw new Error(
                  "Second argument given to Cycle.run() must be an object " +
