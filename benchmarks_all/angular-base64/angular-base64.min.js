!(function () {
  "use strict";
  angular.module("base64", []).constant(
    "$base64",
    (function () {
      function a(a, b) {
      ...
      function b(b) {
        ...
        switch (c) {
          case 1:
            (f = (a(b, d) << 18) | (a(b, d + 1) << 12) | (a(b, d + 2) << 6)),
              h.push(String.fromCharCode(f >> 16, 255 & (f >> 8)));
            break;
          case 2:
            (f = (a(b, d) << 18) | (a(b, d + 1) << 12)),
      ...
      function d(a) {
        ...
        for (b = 0; h > b; b += 3)
          (d = (c(a, b) << 16) | (c(a, b + 1) << 8) | c(a, b + 2)),
            g.push(f.charAt(d >> 18)),
            g.push(f.charAt(63 & (d >> 12))),
            g.push(f.charAt(63 & (d >> 6))),
            g.push(f.charAt(63 & d));
        switch (a.length - h) {
          case 1:
            (d = c(a, b) << 16),
              g.push(f.charAt(d >> 18) + f.charAt(63 & (d >> 12)) + e + e);
            break;
          case 2:
            (d = (c(a, b) << 16) | (c(a, b + 1) << 8)),
              g.push(
                f.charAt(d >> 18) +
                  f.charAt(63 & (d >> 12)) +
                  f.charAt(63 & (d >> 6)) +
