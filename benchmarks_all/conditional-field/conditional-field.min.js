    ...
    return (
      _createClass(t, [
        ...
        },
        {
          key: "setVisible",
          value: function (t) {
            for (var i in this.args.visibility)
              t == i
                ? $(this.args.visibility[i]).show()
                : $(this.args.visibility[i]).hide();
          },
        },
        {
          key: "getInputType",
          value: function () {
            return this.$control.is("select")
              ? "select"
              : this.$control.is(":radio")
              ? "radio"
              : this.$control.is(":checkbox")
              ? "checkbox"
              : void 0;
          },
        },
