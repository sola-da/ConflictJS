...
angular.module("mm.foundation", [
  ...
  angular
    .module("mm.foundation.accordion", [])
  ...
  angular
    .module("mm.foundation.alert", [])
    .controller("AlertController", [
      "$scope",
      "$attrs",
      function (a, b) {
        a.closeable = "close" in b && "undefined" != typeof b.close;
      },
    ])
  ...
  angular.module("mm.foundation.position", []).factory("$position", [
    "$document",
    "$window",
    function (a, b) {
      function c(a, c) {
  ...
  angular
    .module("mm.foundation.mediaQueries", [])
    .factory("matchMedia", [
      "$document",
      "$window",
      function (a, b) {
    ...
    .factory("mediaQueries", [
      ...
      function (a, b) {
        ...
        c.append('<meta class="foundation-mq-topbar" />'),
          c.append('<meta class="foundation-mq-small" />'),
          c.append('<meta class="foundation-mq-medium" />'),
          c.append('<meta class="foundation-mq-large" />');
        var d = /^[\/\\'"]+|(;\s?})+|[\/\\'"]+$/g,
          e = {
            topbar: getComputedStyle(
              c[0].querySelector("meta.foundation-mq-topbar")
            ).fontFamily.replace(d, ""),
            small: getComputedStyle(
              c[0].querySelector("meta.foundation-mq-small")
            ).fontFamily.replace(d, ""),
            medium: getComputedStyle(
              c[0].querySelector("meta.foundation-mq-medium")
            ).fontFamily.replace(d, ""),
            large: getComputedStyle(
              c[0].querySelector("meta.foundation-mq-large")
            ).fontFamily.replace(d, ""),
          };
        return {
  ...
  angular
    .module("mm.foundation.dropdownToggle", [
      "mm.foundation.position",
      "mm.foundation.mediaQueries",
    ])
      ...
      function (a, b, c, d) {
        ...
        return {
          ...
          link: function (c, g, h, i) {
            var j = g.parent(),
              k = angular.element(a[0].querySelector(h.dropdownToggle)),
              l = function () {
              ...
              m = function (c) {
                ...
                if (
                  ...
                  c.stopPropagation(),
                  e && f(),
                  !m && !g.hasClass("disabled") && !g.prop("disabled"))
                ) {
                  k.css("display", "block"), k.addClass("f-open-dropdown");
                  var n = d.offset(g),
                    o = d.offset(angular.element(k[0].offsetParent)),
                    p = k.prop("offsetWidth"),
                    q = { top: n.top - o.top + n.height + "px" };
                  if (i.small())
                    (q.left = Math.max((o.width - p) / 2, 8) + "px"),
                      (q.position = "absolute"),
                      (q.width = "95%"),
                      (q["max-width"] = "none");
                  else {
                    var r = Math.round(n.left - o.left),
                      s = b.innerWidth - p - 8;
                    r > s && ((r = s), k.removeClass("left").addClass("right")),
                      (q.left = r + "px"),
                      (q.position = null),
                      (q["max-width"] = null);
                  }
                  k.css(q),
                    ...
                    (f = function () {
                      a.off("click", f),
                        k.css("display", "none"),
                        k.removeClass("f-open-dropdown"),
                        g.removeClass("expanded"),
                        (f = angular.noop),
                        (e = null),
                        j.hasClass("hover") && j.removeClass("hover");
                    }),
                    a.on("click", f);
                }
              };
            k && k.css("display", "none"),
              c.$watch("$location.path", function () {
                f();
              }),
              g.on("click", m),
  ...
  angular
    .module("mm.foundation.interchange", ["mm.foundation.mediaQueries"])
    .factory("interchangeQueries", [
      "$document",
      function (a) {
        for (
          var b,
            ...
            e = "foundation-mq-",
            f = ["small", "medium", "large", "xlarge", "xxlarge"],
            g = angular.element(a[0].querySelector("head")),
            h = 0;
          h < f.length;
          h++
        )
          g.append('<meta class="' + e + f[h] + '" />'),
            (b = getComputedStyle(g[0].querySelector("meta." + e + f[h]))),
            (c = b.fontFamily.replace(/^[\/\\'"]+|(;\s?})+|[\/\\'"]+$/g, "")),
            (d[f[h]] = c);
        return d;
      },
    ])
    .factory("interchangeQueriesManager", [
      "interchangeQueries",
      function (a) {
        return {
          add: function (b, c) {
            return b && c && angular.isString(b) && angular.isString(c) && !a[b]
              ? ((a[b] = c), !0)
              : !1;
          },
        };
      ...
      function (a, b, c) {
        var d = function (a) {
            for (
              ...
              c[d].replace(/[\W\d]+/, "").length > 4 &&
                ((b = e.exec(c[d])), b && 3 === b.length && (f[b[2]] = b[1]));
            return f;
          },
          e = function (a) {
            var d, e, f;
            for (d in a)
              if (((e = c[d] || d), (f = b(e)), f.matches)) return a[d];
          };
        return { parseAttribute: d, findCurrentMediaFile: e };
      },
    ])
    .directive("interchange", [
      "$window",
      "$rootScope",
      "interchangeTools",
      function (a, b, c) {
        ...
        return {
          ...
          compile: function (e, f) {
            return (
              "DIV" !== e[0].nodeName ||
                d.test(f.interchange) ||
                e.html('<ng-include src="currentFile"></ng-include>'),
              {
                pre: function () {},
                post: function (d, e, f) {
                  var g, h;
                  switch (
                    ((h = e && e[0] && e[0].nodeName),
                    (d.fileMap = c.parseAttribute(f.interchange)),
                    h)
                  ) {
                    case "DIV":
                      (g = c.findCurrentMediaFile(d.fileMap)),
                        (d.type =
                          /[A-Za-z0-9-_]+\.(jpg|jpeg|png|gif|bmp|tiff)$/i.test(
                            g
                          )
                            ? "background"
                            : "include");
  ...
  angular.module("mm.foundation.transition", []).factory("$transition", [
    "$q",
    "$timeout",
    "$rootScope",
    function (a, b, c) {
  ...
  angular
    .module("mm.foundation.modal", ["mm.foundation.transition"])
    ...
    .directive("modalWindow", [
      ...
      function (a, b) {
        return {
          ...
          link: function (a, c, d) {
            (a.windowClass = d.windowClass || ""),
              b(function () {
                (a.animate = !0),
                  c[0].querySelectorAll("[autofocus]").length > 0
                    ? c[0].querySelectorAll("[autofocus]")[0].focus()
                    : c[0].focus();
              });
          },
        };
    ...
    .factory("$modalStack", [
      ...
      function (a, b, c, d, e, f, g) {
        function h() {
          for (var a = -1, b = q.keys(), c = 0; c < b.length; c++)
            q.get(b[c]).value.backdrop && (a = c);
          return a;
        }
        function i(a) {
          var b = d.find(a.options.parent).eq(0),
            c = q.get(a).value;
          q.remove(a),
            k(c.modalDomEl, c.modalScope, 300, function () {
              c.modalScope.$destroy(), b.toggleClass(p, q.length() > 0), j();
            });
        }
        function j() {
          if (m && -1 == h()) {
        ...
        function l(b, c) {
          angular.isUndefined(c) && (c = 0);
          var d = a.pageYOffset || 0;
          return c + d;
        }
        var m,
          n,
        ...
        return (
          ...
          (r.open = function (b, c) {
            (b.options = {
              ...
              q.add(b, b.options);
            var g = d.find(c.parent).eq(0),
              i = h();
            i >= 0 &&
              !m &&
              ((n = f.$new(!0)),
              (n.index = i),
              (m = e("<div modal-backdrop></div>")(n)),
              g.append(m));
            var j = angular.element(
              '<div class="reveal-modal" style="z-index:-1""></div>'
            );
            g.append(j[0]), (o = parseInt(a.getComputedStyle(j[0]).top) || 0);
            var k = l(j, o);
            j.remove();
            var r = angular
              .element(
                '<div modal-window style="visibility: visible; top:' +
                  k +
                  'px;"></div>'
              )
              .attr({
            ...
            r.html(c.content);
            var s = e(r)(c.scope);
            (q.top().value.modalDomEl = s), g.append(s), g.addClass(p);
          }),
          (r.reposition = function (a) {
            var b = q.get(a).value;
            if (b) {
              var c = b.modalDomEl,
                d = l(c, o);
          ...
          (r.close = function (a, b) {
            var c = q.get(a);
            c && (c.value.deferred.resolve(b), i(a));
          }),
          (r.dismiss = function (a, b) {
            var c = q.get(a);
            c && (c.value.deferred.reject(b), i(a));
          }),
  ...
  angular
    .module("mm.foundation.offcanvas", [])
    .directive("offCanvasWrap", [
      "$window",
      function (a) {
        return {
          scope: {},
    ...
    .directive("rightOffCanvasToggle", [
      function () {
        return {
          require: "^offCanvasWrap",
          restrict: "C",
  ...
  angular
    .module("mm.foundation.pagination", [])
        ...
        (this.init = function (d) {
          ...
          (this.render = function () {
            (this.page = parseInt(a.page, 10) || 1),
              this.page > 0 &&
                this.page <= a.totalPages &&
                (a.pages = this.getPages(this.page, a.totalPages));
          }),
          (a.selectPage = function (b) {
            !e.isActive(b) &&
              b > 0 &&
              b <= a.totalPages &&
              ((a.page = b), a.onSelectPage({ page: b }));
          }),
          ...
          link: function (c, d, e, f) {
            ...
            f.init(b.itemsPerPage),
              ...
              (f.getPages = function (a, b) {
                ...
                p &&
                  (o
                    ? ((d = Math.max(a - Math.floor(h / 2), 1)),
                      (e = d + h - 1),
                      e > b && ((e = b), (d = e - h + 1)))
                    : ((d = (Math.ceil(a / h) - 1) * h + 1),
                      (e = Math.min(d + h - 1, b))));
                for (var q = d; e >= q; q++) {
                ...
                compile: function () {
                  ...
                  return function (b, c, d) {
                    ...
                    (b.tt_isOpen = !1),
                      ...
                      (d[l + "Placement"] = d[l + "Placement"] || null),
                      d.$observe(l + "Placement", function (a) {
                        b.tt_placement =
                          angular.isDefined(a) && a ? a : o.placement;
                      }),
                      (d[l + "PopupDelay"] = d[l + "PopupDelay"] || null),
                    ...
                    var B = function () {
                        y &&
                          (angular.isFunction(x.show)
                            ? C()
                            : (c.unbind(x.show, k), c.unbind(x.hide, m)));
                      },
                      C = function () {};
                    (d[l + "Trigger"] = d[l + "Trigger"] || null),
                    ...
                    (b.tt_animation = angular.isDefined(D) ? !!D : o.animation),
  ...
  angular
    .module("mm.foundation.popover", ["mm.foundation.tooltip"])
  ...
  angular
    .module("mm.foundation.progressbar", ["mm.foundation.transition"])
      ...
      function (a, b, c, d) {
        ...
        (this.addBar = function (a, b) {
          ...
          (this.update = function (a, b, c) {
            ...
            h
              ? (a.css("width", this.getPercentage(c) + "%"),
                d(a, { width: e + "%" }))
              : a.css({ transition: "none", width: e + "%" });
          }),
  ...
  angular
    ...
    .controller("RatingController", [
      ...
      "ratingConfig",
      function (a, b, c, d) {
        (this.maxRange = angular.isDefined(b.max)
          ? a.$parent.$eval(b.max)
          : d.max),
          ...
          (this.createRateObjects = function (a) {
            for (
              var b = { stateOn: this.stateOn, stateOff: this.stateOff },
                c = 0,
                d = a.length;
              d > c;
              c++
          ...
          (a.range = this.createRateObjects(
            angular.isDefined(b.ratingStates)
              ? angular.copy(a.$parent.$eval(b.ratingStates))
          ...
          (a.readonly = !1),
          b.readonly &&
            a.$parent.$watch(c(b.readonly), function (b) {
              a.readonly = !!b;
            });
      },
    ])
  ...
  angular
    .module("mm.foundation.tabs", [])
    .controller("TabsetController", [
      "$scope",
      function (a) {
        var b = this,
          c = (b.tabs = a.tabs = []);
        angular.isUndefined(a.openOnLoad) && (a.openOnLoad = !0),
          (b.select = function (a) {
          ...
          (b.addTab = function (d) {
            c.push(d),
              a.openOnLoad && (1 === c.length || d.active) && b.select(d);
          }),
        ...
        link: function (a, b, c) {
          (a.vertical = angular.isDefined(c.vertical)
            ...
            (a.justified = angular.isDefined(c.justified)
              ...
              : !1),
            (a.type = angular.isDefined(c.type)
              ? a.$parent.$eval(c.type)
              : "tabs");
        },
      };
    })
  ...
  angular
    .module("mm.foundation.topbar", ["mm.foundation.mediaQueries"])
    .factory("closest", [
      function () {
        return function (a, b) {
          for (
            var c = function (a, b) {
                for (
                  var c = (a.parentNode || a.document).querySelectorAll(b),
                    d = -1;
                  c[++d] && c[d] != a;
      ...
      function (a, b, c, d, e) {
        return {
          ...
          controller: [
            ...
            function (b, c, f) {
              (c.settings = {}),
                (c.settings.stickyClass = c.stickyClass || "sticky"),
                (c.settings.backText = c.backText || "Back"),
                (c.settings.stickyOn = c.stickyOn || "all"),
                (c.settings.customBackText =
                  void 0 === c.customBackText ? !0 : c.customBackText),
                (c.settings.isHover = void 0 === c.isHover ? !0 : c.isHover),
                (c.settings.mobileShowParentLink =
                  void 0 === c.mobileShowParentLink
                    ? !0
                    : c.mobileShowParentLink),
                (c.settings.scrolltop =
                  void 0 === c.scrolltop ? !0 : c.scrolltop),
                (this.settings = c.settings),
                (c.index = 0);
              var g = function (a) {
                  var b = a.offsetHeight,
                    c = a.currentStyle || getComputedStyle(a);
                  return (b +=
                    parseInt(c.marginTop, 10) + parseInt(c.marginBottom, 10));
                },
                h = [];
              ...
              var i = /rtl/i.test(d.find("html").attr("dir"))
                ? "right"
                : "left";
              c.$watch("index", function (a) {
                ...
                (this.back = function (b) {
                  if (!(c.index < 1) && e.topbarBreakpoint()) {
                    ...
                    (c.index = c.index - 1),
                      (c.height =
                        0 === c.index ? "" : c.originalHeight + g(i[0])),
                      a(function () {
                        h.removeClass("moved");
                      }, 300);
                  }
                ...
                (this.forward = function (a) {
                  ...
                  d.addClass("moved"),
                    (c.height =
                      c.originalHeight + g(b.parent()[0].querySelector("ul"))),
                    (c.index = c.index + 1),
                    c.$apply();
                });
            },
          ...
          link: function (a, b) {
            var f = (a.topbar = b),
              g = f.parent(),
              h = angular.element(d[0].querySelector("body")),
              i = e.topbarBreakpoint(),
              j = (a.isSticky = function () {
                var b = g.hasClass(a.settings.stickyClass);
                return b && "all" === a.settings.stickyOn
                  ? !0
                  : b && e.small() && "small" === a.settings.stickyOn
                  ? !0
                  : b && e.medium() && "medium" === a.settings.stickyOn
                  ? !0
                  : b && e.large() && "large" === a.settings.stickyOn
                  ? !0
                  : !1;
              }),
              k = function () {
                if (a.stickyTopbar && a.isSticky()) {
                  var b = n;
                  c.pageYOffset > b && !g.hasClass("fixed")
                    ? (g.addClass("fixed"),
                      h.css("padding-top", a.originalHeight + "px"))
                    : c.pageYOffset <= b &&
                      g.hasClass("fixed") &&
                      (g.removeClass("fixed"), h.css("padding-top", ""));
                }
              },
              l = function () {
                ...
                if (i !== b) {
                  ...
                  angular.forEach(c, function (a) {
                    angular
                      .element(a.querySelectorAll("li.moved"))
                      .removeClass("moved");
                  }),
                    a.$apply();
                }
            ...
            if (
              ((a.toggle = function (b) {
                ...
                d ? f.addClass("expanded") : f.removeClass("expanded"),
                  a.settings.scrolltop
                    ? !d && f.hasClass("fixed")
                      ? (f.parent().addClass("fixed"),
                        f.removeClass("fixed"),
                        h.css("padding-top", a.originalHeight + "px"))
                      : d &&
                        f.parent().hasClass("fixed") &&
                        (f.parent().removeClass("fixed"),
                        f.addClass("fixed"),
                        h.css("padding-top", ""),
                        c.scrollTo(0, 0))
                    : (j() && f.parent().addClass("fixed"),
                      f.parent().hasClass("fixed") &&
                        (d
                          ? (f.addClass("fixed"),
              ...
              var n = g[0].getBoundingClientRect().top + c.pageYOffset;
            } else a.height = f[0].offsetHeight;
            (a.originalHeight = a.height),
              a.$watch("height", function (a) {
                a ? f.css("height", a + "px") : f.css("height", "");
              }),
              angular.element(c).bind("resize", l),
              angular.element(c).bind("scroll", m),
              a.$on("$destroy", function () {
                angular.element(c).unbind("scroll", l),
                  angular.element(c).unbind("resize", m);
              }),
              g.hasClass("fixed") &&
                h.css("padding-top", a.originalHeight + "px");
          },
      ...
      function (a, b) {
        return {
          ...
          link: function (a, c, d, e) {
            ...
            (a.reset = function () {
              angular
                .element(f[0].querySelectorAll("li.moved"))
                .removeClass("moved");
            }),
              (a.move = function (a, b) {
                f.css(
          ...
          link: function (b, c, d, e) {
            ...
            f.bind("click", function (a) {
              ...
              c.bind("mouseenter", function () {
                e.settings.isHover &&
                  !a.topbarBreakpoint() &&
                  c.addClass("not-click");
              }),
              c.bind("click", function () {
                e.settings.isHover ||
                  a.topbarBreakpoint() ||
                  c.toggleClass("not-click");
              }),
        ...
        return {
          ...
          link: function (b, c, d, e) {
            var f,
              g = e[0],
              h = e[1],
              i = angular.element(h.triggerLink),
              j = i.attr("href");
            (b.linkText = i.text()),
              (b.back = function (a) {
                g.back(a);
              }),
              (b.backText = g.settings.customBackText
                ? g.settings.backText
                : "&laquo; " + i.html()),
              (f = angular.element(
                g.settings.mobileShowParentLink && j && j.length > 1
                  ? '<li class="title back js-generated"><h5><a href="#" ng-click="back($event);">{{backText}}</a></h5></li><li><a class="parent-link js-generated" href="' +
                      j +
                      '">{{linkText}}</a></li>'
                  : '<li class="title back js-generated"><h5><a href="" ng-click="back($event);">{{backText}}</a></h5></li>'
              )),
              a(f)(b),
              c.prepend(f);
          },
      ...
      function (a) {
        function b() {
          try {
            ...
            if ("SecurityError" !== b.name) throw b;
          }
        }
        function c() {
          try {
            a.localStorage.setItem("mm.tour.step", e);
          } catch (b) {
            if ("SecurityError" !== b.name) throw b;
          }
        }
        ...
        return {
          ...
          link: function (b, c) {
            (b.isLastStep = function () {
              ...
              b.$on("$locationChangeSuccess", b.endTour);
          },
        };
      },
    ])
      ...
      function (a, b, c, d) {
        function e(a) {
          ...
          return (
            b.top >= 0 &&
            b.left >= 0 &&
            b.bottom <= d.innerHeight - 80 &&
            b.right <= d.innerWidth
          );
        }
        function f(b, f, g) {
  ...
  angular
    .module("mm.foundation.typeahead", [
      "mm.foundation.position",
      "mm.foundation.bindHtml",
    ])
          ...
          link: function (i, j, k, l) {
            ...
            w.attr({
              ...
              angular.isDefined(k.typeaheadTemplateUrl) &&
                w.attr("template-url", k.typeaheadTemplateUrl);
            var x = i.$new();
            ...
            l.$parsers.unshift(function (a) {
              ...
              (x.select = function (a) {
                ...
                (d[v.itemName] = c = x.matches[a].model),
                  ...
                  r(i, { $item: c, $model: b, $label: v.viewMapper(i, d) }),
                  y(),
                  j[0].focus();
              }),
              j.bind("keydown", function (a) {
                0 !== x.matches.length &&
                  ...
                  40 === a.which
                    ...
                    : 38 === a.which
                    ? ((x.activeIdx =
                        (x.activeIdx ? x.activeIdx : x.matches.length) - 1),
                      x.$digest())
