(function e(t, n, r) {
...
})(
  {
    1: [
      function (require, module, exports) {
        (function () {
          ...
          Bottleneck = (function () {
            ...
            Bottleneck.Cluster =
              Bottleneck.prototype.Cluster = require("./Cluster");
            Bottleneck.DLList =
              Bottleneck.prototype.DLList = require("./DLList");
            Bottleneck.Promise = Bottleneck.prototype.Promise = (function () {
              ...
              try {
                ...
                return typeof Promise !== "undefined" && Promise !== null
                  ...
                  : function () {
                      throw new Error(
                        "Bottleneck: install 'bluebird' or use Node 0.12 or higher for Promise support"
                      );
                    };
              }
            })();
            function Bottleneck(maxNb, minTime, highWater, strategy) {
              ...
              this.strategy =
                strategy != null
                  ? strategy
                  : Bottleneck.prototype.strategy.LEAK;
              ...
              this._timeouts = [];
              this._unblockTime = 0;
              this.penalty = 15 * this.minTime || 5e3;
            ...
            Bottleneck.prototype._trigger = function (name, args) {
              return setTimeout(
                (function (_this) {
                  return function () {
                    var ref;
                    return (ref = _this.events[name]) != null
            ...
            Bottleneck.prototype._conditionsCheck = function () {
              return (
                (this._nbRunning < this.maxNb || this.maxNb <= 0) &&
                (this.reservoir == null || this.reservoir > 0)
              );
            };
            Bottleneck.prototype.check = function () {
              return (
                this._conditionsCheck() && this._nextRequest - Date.now() <= 0
              );
            };
                      ...
                      (function (_this) {
                        return function () {
                          ...
                          if (_this.limiter != null) {
                            return _this.limiter.submit.apply(
                              _this.limiter,
                            ...
                            return next.task.apply(
                              {},
                              next.args.concat(completed)
                            );
                          }
                        };
                      })(this),
            ...
            Bottleneck.prototype.submit = function () {
              ...
              return this.submitPriority.apply(
                {},
                Array.prototype.concat(MIDDLE_PRIORITY, args)
              );
            };
              ...
              (priority = arguments[0]),
                ...
                (args =
                  4 <= arguments.length
                    ...
                    : ((j = 2), [])),
                (cb = arguments[j++]);
              job = { task: task, args: args, cb: cb };
              priority = this._sanitizePriority(priority);
              reachedHighWaterMark =
                this.highWater >= 0 &&
                this.nbQueued() === this.highWater &&
                !this.check();
              if (
                this.strategy === Bottleneck.prototype.strategy.BLOCK &&
                (reachedHighWaterMark || this.isBlocked())
              ) {
                ...
                shifted =
                  this.strategy === Bottleneck.prototype.strategy.LEAK
                    ? this._getFirst(
                        this._queues.slice(priority).reverse()
                      ).shift()
                    : this.strategy ===
                      Bottleneck.prototype.strategy.OVERFLOW_PRIORITY
                    ? this._getFirst(
                        this._queues.slice(priority + 1).reverse()
                      ).shift()
                    : this.strategy === Bottleneck.prototype.strategy.OVERFLOW
                    ? job
                    : void 0;
                if (shifted != null) {
            ...
            Bottleneck.prototype.schedule = function () {
              var args;
              args = 1 <= arguments.length ? slice.call(arguments, 0) : [];
              return this.schedulePriority.apply(
                {},
                Array.prototype.concat(MIDDLE_PRIORITY, args)
              );
            };
            Bottleneck.prototype.schedulePriority = function () {
              ...
              return new Bottleneck.prototype.Promise(
                (function (_this) {
                  return function (resolve, reject) {
                    return _this.submitPriority.apply(
                      {},
                      Array.prototype.concat(priority, wrapped, function () {
                        var args, error;
                        (error = arguments[0]),
                          (args =
                            2 <= arguments.length
                              ...
                              : []);
                        return (error != null ? reject : resolve).apply(
                          {},
                          args
                        );
                      })
            ...
            Bottleneck.prototype.changeSettings = function (
              maxNb,
              minTime,
              highWater,
              strategy
      ...
      { "./Cluster": 2, "./DLList": 3, bluebird: undefined },
    ],
    2: [
      function (require, module, exports) {
        (function () {
          ...
          Cluster = (function () {
            ...
            Cluster.prototype.key = function (key) {
              ...
              return (ref = this.limiters[key]) != null
                ? ref
                ...
                setInterval(
                  (function (_this) {
                    return function () {
                      ...
                      for (k in ref) {
                        v = ref[k];
                        if (v._nextRequest + 1e3 * 60 * 5 < time) {
        ...
        (function () {
          ...
          DLList = (function () {
            ...
            DLList.prototype.shift = function () {
              ...
              this._first =
                (ref1 = this._first.next) != null ? ref1 : (this._last = null);
              return value;
            };
