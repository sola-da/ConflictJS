!(function (t, e) {
  ...
  if ("undefined" != typeof module && module.exports) {
    ...
    o
      ...
      : (module.exports = e(require("jquery"), require("bootstrap")));
  } else
    "function" == typeof define && define.amd
      ? define("bootstrap-dialog", ["jquery", "bootstrap"], function (t) {
          return e(t);
        })
      : (t.BootstrapDialog = e(t.jQuery));
})(this, function (t) {
  ...
  (n.getModalVersion = function () {
    var e = null;
    return (e =
      "undefined" == typeof t.fn.modal.Constructor.VERSION
        ? "v3.1"
        : /3\.2\.\d+/.test(t.fn.modal.Constructor.VERSION)
        ? "v3.2"
        : /3\.3\.[1,2]/.test(t.fn.modal.Constructor.VERSION)
        ? "v3.3"
        : "v3.3.4");
  }),
    (n.ORIGINAL_BODY_PADDING = parseInt(
    ...
    (n.METHODS_TO_OVERRIDE["v3.3"] = {
      ...
      resetScrollbar: function () {
        ...
        0 === t.length &&
          this.$body.css("padding-right", n.ORIGINAL_BODY_PADDING);
      },
      hideModal: function () {
        this.$element.hide(),
          this.backdrop(
    ...
    (n.prototype = t.extend(
      n.prototype,
      e.prototype,
      n.METHODS_TO_OVERRIDE[n.getModalVersion()]
    ));
  var o = function (e) {
    (this.defaultOptions = t.extend(
      !0,
      {
        id: o.newGuid(),
        buttons: [],
      ...
      (this.draggableData = { isMouseDown: !1, mouseOffset: {} }),
      (this.realized = !1),
      (this.opened = !1),
      this.initOptions(e),
  ...
  return (
      ...
      handleModalBackdropEvent: function () {
        return (
          this.getModal().on("click", { dialog: this }, function (t) {
            t.target === this &&
              t.data.dialog.isClosable() &&
              t.data.dialog.canCloseByBackdrop() &&
              t.data.dialog.close();
          }),
          this
        );
    ...
    (o.METHODS_TO_OVERRIDE["v3.2"] = {
      handleModalBackdropEvent:
        o.METHODS_TO_OVERRIDE["v3.1"].handleModalBackdropEvent,
    ...
    (o.prototype = {
      ...
      updateSize: function () {
        if (this.isRealized()) {
          var e = this;
          this.getModal()
            .removeClass(o.SIZE_NORMAL)
            .removeClass(o.SIZE_SMALL)
            .removeClass(o.SIZE_WIDE)
            .removeClass(o.SIZE_LARGE),
            this.getModal().addClass(this.getSize()),
            this.getModalDialog().removeClass("modal-sm"),
            this.getSize() === o.SIZE_SMALL &&
              this.getModalDialog().addClass("modal-sm"),
            this.getModalDialog().removeClass("modal-lg"),
            this.getSize() === o.SIZE_WIDE &&
      ...
      getButton: function (t) {
        return "undefined" != typeof this.indexedButtons[t]
          ? this.indexedButtons[t]
          : null;
      },
      getButtonSize: function () {
        return "undefined" != typeof o.BUTTON_SIZES[this.getSize()]
          ? o.BUTTON_SIZES[this.getSize()]
          : "";
      },
      updateButtons: function () {
        return (
          this.isRealized() &&
            (0 === this.getButtons().length
      ...
      createCloseButton: function () {
        ...
        return (
          e.append(n),
          e.on("click", { dialog: this }, function (t) {
            t.data.dialog.close();
          }),
          e
        );
      ...
      createFooterButtons: function () {
        var e = this,
          n = t("<div></div>");
        return (
          n.addClass(this.getNamespace("footer-buttons")),
          (this.indexedButtons = {}),
      ...
      createButton: function (e) {
        ...
        return (
          n.prop("id", e.id),
          n.data("button", e),
          "undefined" != typeof e.icon &&
            "" !== t.trim(e.icon) &&
            n.append(this.createButtonIcon(e.icon)),
          "undefined" != typeof e.label && n.append(e.label),
          n.addClass(
            "undefined" != typeof e.cssClass && "" !== t.trim(e.cssClass)
              ? e.cssClass
              : "btn-default"
          ),
          "undefined" != typeof e.hotkey &&
            (this.registeredButtonHotkeys[e.hotkey] = n),
          n.on("click", { dialog: this, $button: n, button: e }, function (t) {
            var e = t.data.dialog,
              n = t.data.$button,
              o = n.data("button");
            return (
      ...
      enhanceButton: function (t) {
        return (
          ...
          (t.toggleEnable = function (t) {
            ...
            return (
              "undefined" != typeof t
                ? e.prop("disabled", !t).toggleClass("disabled", !t)
          ...
          (t.toggleSpin = function (e) {
            ...
            return (
              "undefined" == typeof e &&
                (e = !(t.find(".icon-spin").length > 0)),
              e
                ? (i.hide(),
                  t.prepend(
                    o.createButtonIcon(o.getSpinicon()).addClass("icon-spin")
                  ))
                : (i.show(), t.find(".icon-spin").remove()),
              n
            );
          }),
          (t.spin = function () {
      ...
      enableButtons: function (e) {
        return (
          t.each(this.indexedButtons, function (t, n) {
            n.toggleEnable(e);
          }),
          this
        );
      ...
      handleModalEvents: function () {
        return (
          this.getModal().on("show.bs.modal", { dialog: this }, function (t) {
            var e = t.data.dialog;
            if (
              (e.setOpened(!0),
          ...
          this.getModal().on("shown.bs.modal", { dialog: this }, function (t) {
            var e = t.data.dialog;
            e.isModalEvent(t) &&
              "function" == typeof e.options.onshown &&
              e.options.onshown(e);
          }),
          ...
          this.getModal().on("hidden.bs.modal", { dialog: this }, function (e) {
            var n = e.data.dialog;
            n.isModalEvent(e) &&
              "function" == typeof n.options.onhidden &&
              n.options.onhidden(n),
              n.isAutodestroy() &&
                (n.setRealized(!1),
          ...
          this.getModal().on("keyup", { dialog: this }, function (t) {
            27 === t.which &&
              t.data.dialog.isClosable() &&
              t.data.dialog.canCloseByKeyboard() &&
              t.data.dialog.close();
          }),
      ...
      handleModalBackdropEvent: function () {
        return (
          this.getModal().on("click", { dialog: this }, function (e) {
            t(e.target).hasClass("modal-backdrop") &&
        ...
        return (
          this.options.draggable &&
            (this.getModalHeader()
              ...
              .on("mousedown", { dialog: this }, function (t) {
                var e = t.data.dialog;
    ...
    (o.prototype = t.extend(
      o.prototype,
      o.METHODS_TO_OVERRIDE[n.getModalVersion()]
    )),
    (o.newGuid = function () {
    ...
    (o.alert = function () {
      ...
      e =
        ...
        arguments[0].constructor === {}.constructor
          ? t.extend(!0, n, arguments[0])
          : t.extend(!0, n, {
              message: arguments[0],
              callback:
                "undefined" != typeof arguments[1] ? arguments[1] : null,
            });
      var i = new o(e);
      return (
        ...
        i.addButton({
          label: e.buttonLabel,
          action: function (t) {
            return "function" == typeof t.getData("callback") &&
              t.getData("callback").call(this, !0) === !1
              ? !1
              : (t.setData("btnClicked", !0), t.close());
          },
        }),
        i.onHide(
          "function" == typeof i.options.onhide
            ? function (t) {
                var e = !0;
                return (
                  !t.getData("btnClicked") &&
                    t.isClosable() &&
                    "function" == typeof t.getData("callback") &&
                    (e = t.getData("callback")(!1)),
                  e === !1 ? !1 : (e = this.onhide(t))
                );
              }.bind({ onhide: i.options.onhide })
            : function (t) {
                var e = !0;
                return (
                  !t.getData("btnClicked") &&
    ...
    (o.confirm = function () {
      ...
      (e =
        ...
        null === e.btnOKClass &&
          (e.btnOKClass = ["btn", e.type.split("-")[1]].join("-"));
      var i = new o(e);
      return (
        i.setData("callback", e.callback),
        i.addButton({
          ...
          action: function (t) {
            return "function" == typeof t.getData("callback") &&
              t.getData("callback").call(this, !1) === !1
              ? !1
              : t.close();
          },
        }),
