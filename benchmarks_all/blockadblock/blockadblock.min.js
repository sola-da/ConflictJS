      ...
      i = function () {
        setTimeout(function () {
          o._options.checkOnLoad === !0 &&
            (o._options.debug === !0 &&
              o._log("onload->eventCallback", "A check loading is launched"),
  ...
  (e.prototype._options = null),
      ...
      for (var i in t)
        (this._options[i] = t[i]),
          this._options.debug === !0 &&
            this._log(
              "setOption",
              'The option "' + i + '" he was assigned to "' + t[i] + '"'
            );
      return this;
    }),
    ...
    (e.prototype._checkBait = function (e) {
      ...
      if (
        ...
        (null !== t.document.body.getAttribute("abp") ||
      ...
      this._options.debug === !0 &&
        ...
        o === !0
          ? (this._stopLoop(),
            this._destroyBait(),
            this.emitEvent(!0),
            e === !0 && (this._var.checking = !1))
          : (null === this._var.loop || e === !1) &&
            (this._destroyBait(),
            this.emitEvent(!1),
            e === !0 && (this._var.checking = !1));
    }),
    ...
    (e.prototype.emitEvent = function (t) {
      ...
      for (var o in e)
        this._options.debug === !0 &&
          this._log(
            "emitEvent",
            "Call function " + (parseInt(o) + 1) + "/" + e.length
          ),
    ...
    (t.BlockAdBlock = e),
    void 0 === t.blockAdBlock &&
      (t.blockAdBlock = new e({ checkOnLoad: !0, resetOnEnd: !0 }));
})(window);
