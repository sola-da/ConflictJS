      ...
      return (
        ...
        (o.prototype.end = function () {
          ...
          return (
            ...
            (r = this.hideStep(this._current)),
            this._callOnPromiseDone(r, o)
          );
        }),
        ...
        (o.prototype.hideStep = function (e) {
          var o, n, r;
          return (r = this.getStep(e))
            ? (this._clearTimer(),
              (n = this._makePromise(
                null != r.onHide ? r.onHide(this, e) : void 0
              )),
              (o = (function (o) {
                return function () {
                  var n;
                  return (
                    ...
                    n.removeData("bs.popover"),
                    r.reflex &&
                      t(r.reflexElement)
                        .removeClass("tour-step-element-reflex")
                        .off(
                          "" +
                            o._reflexEvent(r.reflex) +
                            ".tour-" +
                            o._options.name
                        ),
                    r.backdrop && o._hideBackdrop(),
                    null != r.onHidden ? r.onHidden(o) : void 0
                  );
                };
              })(this)),
              ...
              (r = (function (e) {
                return function () {
                  ...
                  if (
                    ...
                    !e._isRedirect(s.host, o, n.location) ||
                      (e._redirect(s, t, o),
                      e._isJustPathHashDifferent(s.host, o, n.location)))
                  ) {
                    if (e._isOrphan(s)) {
                      if (s.orphan === !1)
                        return (
                          ...
                          i ? e._showPrevStep() : e._showNextStep(),
                          void 0
                        );
                      e._debug(
                    ...
                    return (
                      s.backdrop && e._showBackdrop(s),
                      (r = function () {
                        return e.getCurrentStep() !== t || e.ended()
                          ? void 0
                          : (null != s.element &&
                              s.backdrop &&
                      ...
                      s.autoscroll ? e._scrollIntoView(s.element, r) : r(),
        ...
        (o.prototype._isRedirect = function (t, e, o) {
          var n;
          return "" !== t && this._isHostDifferent(t, o.href)
            ? !0
        ...
        (o.prototype._isHostDifferent = function (t, e) {
          return (
            this._getProtocol(t) !== this._getProtocol(e) ||
            this._getHost(t) !== this._getHost(e)
          );
        }),
        ...
        (o.prototype._redirect = function (e, o, r) {
          ...
          if (e.redirect === !0) {
            if (
              (this._debug("Redirect to " + e.host + r),
              this._getState("redirect_to") !== "" + o)
            )
              return (
                this._setState("redirect_to", "" + o),
        ...
        (o.prototype._showPopover = function (e, o) {
          ...
          return (
            ...
            (a = e.smartPlacement === !0 && -1 === e.placement.search(/auto/i)),
            n
              .popover({
        ...
        (o.prototype._template = function (e, o) {
          ...
          return (
            ...
            e.prev < 0 && (i.addClass("disabled"), i.prop("disabled", !0)),
            e.next < 0 && (r.addClass("disabled"), r.prop("disabled", !0)),
            e.duration || s.remove(),
        ...
        (o.prototype._reposition = function (e, o) {
          ...
          if (
            ...
            (p = h.left),
            (u = h.top),
            (r = t(n).outerHeight() - h.top - e.outerHeight()),
            0 > r && (h.top = h.top + r),
            ...
            return this._replaceArrow(e, 2 * (h.top - u), i, "top");
        }),
        ...
        (o.prototype._showOverlayElement = function (e, o) {
          ...
          return (
            (n = t(e.element)),
            !n || 0 === n.length || (this.backdrop.overlayElementShown && !o)
              ? void 0
              : (this.backdrop.overlayElementShown ||
                ...
                e.backdropPadding &&
                  (r = this._applyBackdropPadding(e.backdropPadding, r)),
        ...
        (o.prototype._getParams = function (t, e) {
          ...
          for (n = n[1].split("&"), r = {}, i = 0, s = n.length; s > i; i++)
