...
!(function (a, b) {
  ...
  function b() {
    ...
    var a,
      b,
      c = null, // TODO change to either 'sanitize', 'escape' or ['sanitize', 'escapeParameters'] in 3.0.
      d = !1,
      e = !1;
    (b = {
      ...
      (this.$get = [
        ...
        function (f, g) {
          ...
          return (
            f.has("$sanitize") && (a = f.get("$sanitize")),
            {
    ...
    var f = function (a) {
        var b = angular.element("<div></div>"); // not chainable, see #1044
  ...
  function c(a, b, c, d) {
      ...
      G = {
        ...
        java: function (a) {
          var b = (a || "").split("-").join("_"),
            c = b.split("_");
          return c.length > 1
            ? c[0].toLowerCase() + "_" + c[1].toUpperCase()
            : b;
        },
        bcp47: function (a) {
    ...
    var K = function (a, b) {
      ...
      M = function (a) {
        if (a) {
          for (
            var b = [], c = angular.lowercase(a), d = 0, e = v.length;
            e > d;
            d++
          )
              ...
              if (f.hasOwnProperty(h)) {
                var i = !1,
                  j =
                    ...
                    angular.lowercase(h) === angular.lowercase(a);
                if (
                  ("*" === h.slice(-1) &&
                    (i = h.slice(0, -1) === a.slice(0, h.length - 1)),
                  (j || i) && ((g = f[h]), K(b, angular.lowercase(g)) > -1))
                )
                  return g;
              }
          }
          ...
          var k = a.split("_");
          return k.length > 1 && K(b, angular.lowercase(k[0])) > -1
            ? k[0]
            : void 0;
        }
      },
      N = function (a, b) {
        ...
        if (a && !b) {
          ...
          angular.isObject(u[a]) || (u[a] = {}), angular.extend(u[a], O(b));
        return this;
      };
    (this.translations = N),
      /**
    ...
    var O = function (a, b, c, d) {
      ...
      for (e in a)
        Object.prototype.hasOwnProperty.call(a, e) &&
          ...
          angular.isObject(h)
            ? O(h, b.concat(e), c, e)
            : ((f = b.length ? "" + b.join(B) + B + e : e),
              b.length && e === d && ((g = "" + b.join(B)), (c[g] = "@:" + f)),
              (c[f] = h)));
      return c;
    };
    (O.displayName = "flatObject"),
      /**
       * @ngdoc function
    ...
    (this.translationNotFoundIndicator = function (a) {
      return (
        this.translationNotFoundIndicatorLeft(a),
    ...
    var Q = function (a) {
      return a
        ? (angular.isString(a)
            ? ((h = !0), (g = [a]))
            : angular.isArray(a) && ((h = !1), (g = a)),
          angular.isString(e) && K(g, e) < 0 && g.push(e),
          this)
        : h
        ? g[0]
        : g;
    ...
    (this.storageKey = R),
       ...
       */ (this.uniformLanguageTag = function (a) {
        return (
          a ? angular.isString(a) && (a = { standard: a }) : (a = {}),
          (F = a.standard),
          this
        );
      }),
       ...
       */ (this.$get = [
        ...
        function (a, b, c, d) {
          var f,
            l,
            F,
            G = b.get(n || "$translateDefaultInterpolation"),
            I = !1,
            S = {},
            T = {},
            U = function (a, b, c, h, j) {
              !i && e && (i = e);
              var m =
                j && j !== i // we don't want to re-negotiate $uses
                  ? M(j) || j
                  : i;
            ...
            V = function (a) {
              ...
              return (
                q && (a = [q, a].join(" ")), r && (a = [a, r].join(" ")), a
              );
            },
            W = function (a) {
              (i = a),
                k && f.put(U.storageKey(), i),
                c.$emit("$translateChangeSuccess", { language: a }),
                G.setLocale(i);
              var b = function (a, b) {
                S[b].setLocale(i);
              };
              (b.displayName = "eachInterpolatorLocaleSetter"),
                ...
                angular.forEach(S, b),
                c.$emit("$translateChangeEnd", { language: a });
            },
            X = function (a) {
              ...
              var g = angular.extend({}, p, {
                ...
                h = function (b) {
                  var d = {};
                  c.$emit("$translateLoadingSuccess", { language: a }),
                    angular.isArray(b)
                      ? angular.forEach(b, function (a) {
                          angular.extend(d, O(a));
                        })
                      : angular.extend(d, O(b)),
                    (I = !1),
                    e.resolve({ key: a, table: d }),
                    c.$emit("$translateLoadingEnd", { language: a });
                };
              h.displayName = "onLoaderSuccess";
              var i = function (a) {
                c.$emit("$translateLoadingError", { language: a }),
                  e.reject(a),
                  c.$emit("$translateLoadingEnd", { language: a });
              };
              return (
          ...
          if (k && ((f = b.get(k)), !f.get || !f.put))
            throw new Error(
              "Couldn't use storage '" + k + "', missing get() or put() method!"
            );
          ...
          if (x.length) {
            var Y = function (a) {
              ...
              c.setLocale(e || i),
                ...
                (S[c.getInterpolationIdentifier()] = c);
            };
          ...
          var Z = function (a) {
            ...
            $ = function (a, b, c, e) {
              var f = d.defer(),
                g = function (d) {
                  if (Object.prototype.hasOwnProperty.call(d, b)) {
                    ...
                    var g = d[b];
                    if ("@:" === g.substr(0, 2))
                      $(a, g.substr(2), c, e).then(f.resolve, f.reject);
                    else {
              ...
              return (
                (g.displayName = "fallbackTranslationResolver"),
                Z(a).then(g, f.reject),
                f.promise
              );
            },
            ...
            fa = function (a, b, c, e, f) {
              ...
              if (i && Object.prototype.hasOwnProperty.call(i, a)) {
                ...
                if ("@:" === k.substr(0, 2))
                  U(k.substr(2), b, c, e, f).then(h.resolve, h.reject);
                else {
                  //
            ...
            ga = function (a, b, c, d) {
              ...
              if (
                ...
                (S && Object.prototype.hasOwnProperty.call(S, c) && (h = S[c]),
            ...
            ia = function (a, c, d, e, f) {
              ...
              return g && ("string" == typeof g && (g = b.get(g)), g)
                ? g(a, c, d, e, f)
                : d;
            },
            ja = function (a) {
          ...
          (U.preferredLanguage = function (a) {
                  ...
                  (!A && u[a]) || !o || T[a]
                    ? T[a]
                      ? T[a].then(
                          ...
                          function (a) {
                            return !i && g && g.length > 0
                              ? U.use(g[0]).then(b.resolve, b.reject)
                              : b.reject(a);
                          }
                        )
                      : (b.resolve(a), W(a))
                    : ((T[a] = X(a).then(
                        ...
                        function (a) {
                          return (
                            c.$emit("$translateChangeError", { language: a }),
                            b.reject(a),
                            c.$emit("$translateChangeEnd", { language: a }),
                            d.reject(a)
                          );
             ...
             */ (U.instant = function (a, b, c, d) {
              ...
              var f =
                d && d !== i // we don't want to re-negotiate $uses
                  ? M(d) || d
                  : i;
              ...
              if (
                // Check forceLanguage is present
                (d && ja(d), angular.isArray(a))
              ) {
                for (var h = {}, j = 0, k = a.length; k > j; j++)
                  h[a[j]] = U.instant(a[j], b, c, d);
                return h;
              }
              ...
              return (
                l ||
                  ...
                  (q || r
                    ? (l = V(a))
                    : ((l = G.interpolate(a, b)), m && !I && (l = aa(a, b)))),
                l
              );
            }),
            /**
          ...
          ka.promise.then(function () {
             ...
             */ (U.onReady = function (a) {
              var b = d.defer();
              return (
                angular.isFunction(a) && b.promise.then(a),
                C ? b.resolve() : ka.promise.then(b.resolve),
                b.promise
              );
            }),
            /**
          ...
          if (o) {
            ...
            if (
              ...
              (angular.equals(u, {}) && U.use() && U.use(U.use()),
              g && g.length)
            )
              for (
                var na = function (a) {
                    return (
                      N(a.key, a.table),
                      c.$emit("$translateChangeEnd", { language: a.key }),
                      a
                    );
                  },
                  oa = 0,
    ...
    return {
      ...
      compile: function (b, i) {
        ...
        return function (b, o, p) {
          ...
          var q = {},
            r = function (a, c, d) {
              ...
              if (
                // initial setup
                (c.translateValues &&
                  angular.extend(a, e(c.translateValues)(b.$parent)),
                l)
              )
                for (var f in d)
                  if (
                    Object.prototype.hasOwnProperty.call(c, f) &&
                    "translateValue" === f.substr(0, 14) &&
                    "translateValues" !== f
                  ) {
            ...
            s = function (a) {
              if (
                ...
                (angular.isFunction(s._unwatchOld) &&
                  (s._unwatchOld(), (s._unwatchOld = void 0)),
                ...
                if (angular.isArray(e)) {
                  ...
                  angular.isArray(f) &&
                    f[2] &&
                    f[2].length &&
                    (s._unwatchOld = b.$watch(f[2], function (a) {
                      (q.translate = a), y();
                    }));
                }
          ...
          if (
            (p.$observe("translateDefault", function (a) {
              (b.defaultText = a), y();
            }),
            j &&
              p.$observe("translateValues", function (a) {
                a &&
          ...
          var y = function () {
            ...
            z = function (b, c, d, e, f, g) {
              c
                ? // if translation id starts with '.' and translateNamespace given, prepend namespace
                  (g && "." === c.charAt(0) && (c = g + c),
                  a(c, e, k, f, d.translateLanguage).then(
                    function (a) {
                      A(a, d, !0, b);
                    },
                    function (a) {
            ...
            A = function (b, c, e, f) {
              if (
                (e ||
                  ("undefined" != typeof c.defaultText && (b = c.defaultText)),
                "translate" === f)
              ) {
                // default translate into innerHTML
                (e || (!e && "undefined" == typeof p.translateKeepContent)) &&
          ...
          (j || l || p.translateDefault) &&
            b.$watch("interpolateParams", y, !0);
          // Replaced watcher on translateLanguage with event listener
          var B = b.$on("translateLanguageChanged", y),
            C = g.$on("$translateChangeSuccess", y);
          // ensure translation will be looked up at least one
          o.text().length
            ? s(p.translate ? p.translate : "")
            : p.translate &&
    ...
    return {
      compile: function (c) {
        ...
        return (
          ...
          function (c, f, g) {
            g.translateCloak &&
              g.translateCloak.length &&
              // Register a watcher for the defined translation allowing a fine tuned cloak
              (g.$observe("translateCloak", function (b) {
                a(b).then(e, d);
              }),
        ...
        return {
          pre: function (a, b, c) {
            (a.translateNamespace = f(a)),
              a.translateNamespace && "." === c.translateNamespace.charAt(0)
                ? (a.translateNamespace += c.translateNamespace)
                : (a.translateNamespace = c.translateNamespace);
          },
        };
      },
  ...
  return (
    ...
    angular.module("pascalprecht.translate", ["ng"]).run(a),
    (a.displayName = "runTranslate"),
    angular
      .module("pascalprecht.translate")
      .provider("$translateSanitization", b),
    angular
      .module("pascalprecht.translate")
      .constant("pascalprechtTranslateOverrider", {})
      .provider("$translate", c),
    (c.displayName = "displayName"),
    angular
      .module("pascalprecht.translate")
      .factory("$translateDefaultInterpolation", d),
