!(function (a) {
  ...
  (a.expr[":"].appeared = function (t) {
    ...
    return (
      s + e.height() >= d &&
      s - (e.data("appear-top-offset") || 0) <= d + r.height() &&
      o + e.width() >= i &&
      o - (e.data("appear-left-offset") || 0) <= i + r.width()
    );
  }),
    a.fn.extend({
      appear: function (e) {
  ...
  $(".animatedClick").click(function () {
    ...
    if (void 0 != $(this).attr("data-sequence")) {
      var t = $("." + a + ":first").attr("data-id"),
        ...
        i = t;
      $("." + a + "[data-id=" + i + "]").hasClass("go")
        ? ($("." + a + "[data-id=" + i + "]").addClass("goAway"),
          $("." + a + "[data-id=" + i + "]").removeClass("go"))
        : ($("." + a + "[data-id=" + i + "]").addClass("go"),
          $("." + a + "[data-id=" + i + "]").removeClass("goAway")),
        i++,
