...
net.brehaut || (net.brehaut = {}),
  function () {
    ...
    function e(e, t) {
      e = e.toString();
      for (var r = [], n = 0, a = Math.max(t - e.length, 0); a > n; n++)
        r.push("0");
    ...
    function a(e, r) {
      ...
      for (var o in r)
        if (r.hasOwnProperty(o)) {
          h[o] = r[o];
          var m = h[o];
          if ("_" == o.slice(0, 1)) continue;
          if (o in l || "function" != typeof m) {
      ...
      return (
        ...
        (p[e] = i),
        (h.clone = function () {
          for (var e = i(), t = 0, r = s.length; r > t; t++) {
            var n = s[t];
            e[n] = this[n];
          }
          return e;
    ...
    var l,
      ...
      F = "\\s*?",
      c = new RegExp(
        ["^hsl(a?)\\(", o, ",", m, ",", m, "(,(", o, "))?\\)$"].join(F)
      ),
      g = new RegExp(
        ["^rgb(a?)\\(", s, ",", s, ",", s, "(,(", o, "))?\\)$"].join(F)
      ),
      f = new RegExp(
        ["^rgb(a?)\\(", m, ",", m, ",", m, "(,(", o, "))?\\)$"].join(F)
      ),
      d = [],
      p = {};
    this.object ||
    ...
    l = {
      fromObject: function (e) {
        if (!e) return v(l);
        for (var t = 0, r = d.length; r > t; t++) {
          var n = d[t].fromObject(e);
          if (n) return n;
        }
        return v(l);
      },
    ...
    a("RGB", {
      ...
      blend: function (e, t) {
        (e = e.toRGB()), (t = Math.min(Math.max(t, 0), 1));
        var r = this.clone();
        return (
          (r.red = r.red * (1 - t) + e.red * t),
      ...
      fromObject: function (e) {
        return e instanceof Array
          ? this._fromRGBArray(e)
          : "string" == typeof e
          ? this._fromCSS(r(e))
          : e.hasOwnProperty("red") &&
            e.hasOwnProperty("green") &&
            e.hasOwnProperty("blue")
          ? this._fromRGB(e)
          : void 0;
      },
      _stringParsers: [
        function (e) {
          function t(t, r) {
            var n = e.match(t);
            if (!n || !!n[1] + !!n[5] === 1) return null;
            var a = p.RGB();
            return (
              (a.red = Math.min(1, Math.max(0, n[2] / r))),
        ...
        function (e) {
          ...
          if (
            (t in h && (e = h[t]),
            e.match(/^#([0-9a-fA-F]{3}|[0-9a-fA-F]{6})$/))
          ) {
            e = e.replace(/^#/, "");
            var r = e.length / 3,
              n = Math.pow(16, r) - 1,
              a = p.RGB();
            return (
              (a.red = parseInt(e.slice(0, r), 16) / n),
              (a.green = parseInt(e.slice(1 * r, 2 * r), 16) / n),
              (a.blue = parseInt(e.slice(2 * r), 16) / n),
              (a.alpha = 1),
              a
            );
          }
        ...
        function (e) {
          return "transparent" === e.toLowerCase() ? b : void 0;
        },
      ],
      _fromCSS: function (e) {
        for (var t = null, r = 0, n = this._stringParsers.length; n > r; r++)
          if ((t = this._stringParsers[r](e))) return t;
      },
      _fromRGB: function (e) {
        var t = p.RGB();
        return (
      ...
      toCSSHex: function (t) {
        t = t || 2;
        var r = Math.pow(16, t) - 1,
          n = [
            "#",
            e(
              Math.round(this.red * r)
                .toString(16)
                .toUpperCase(),
              t
            ),
            e(
              Math.round(this.green * r)
                .toString(16)
                .toUpperCase(),
              t
            ),
            e(
              Math.round(this.blue * r)
                .toString(16)
                .toUpperCase(),
              t
            ),
      ...
      toCSS: function (e) {
        if (1 === this.alpha) return this.toCSSHex(e);
        var t = 255,
          r = [
            "rgba(",
            Math.max(0, Math.min(t, Math.round(this.red * t))),
            ",",
            Math.max(0, Math.min(t, Math.round(this.green * t))),
            ",",
            Math.max(0, Math.min(t, Math.round(this.blue * t))),
            ",",
      ...
      toHSV: function () {
        var e,
          ...
          n = p.HSV();
        return (
          (e = Math.min(this.red, this.green, this.blue)),
          (t = Math.max(this.red, this.green, this.blue)),
          (n.value = t),
          (r = t - e),
          0 == r
            ? (n.hue = n.saturation = 0)
            : ((n.saturation = r / t),
              this.red == t
                ? (n.hue = (this.green - this.blue) / r)
                : this.green == t
                ? (n.hue = 2 + (this.blue - this.red) / r)
                : (n.hue = 4 + (this.red - this.green) / r),
      ...
      (b = l.fromObject({ red: 0, blue: 0, green: 0, alpha: 0 })),
      a("HSV", {
        hue: 0,
        saturation: 0,
        value: 1,
        alpha: 1,
        shiftHue: n(function (e) {
          var t = (this.hue + e) % 360;
          0 > t && (t = (360 + t) % 360), (this.hue = t);
        }),
        devalueByAmount: n(function (e) {
          this.value = Math.min(1, Math.max(this.value - e, 0));
        }),
        devalueByRatio: n(function (e) {
          this.value = Math.min(1, Math.max(this.value * (1 - e), 0));
        }),
        valueByAmount: n(function (e) {
          this.value = Math.min(1, Math.max(this.value + e, 0));
        }),
        valueByRatio: n(function (e) {
          this.value = Math.min(1, Math.max(this.value * (1 + e), 0));
        }),
        desaturateByAmount: n(function (e) {
          this.saturation = Math.min(1, Math.max(this.saturation - e, 0));
        }),
        desaturateByRatio: n(function (e) {
          this.saturation = Math.min(1, Math.max(this.saturation * (1 - e), 0));
        }),
        saturateByAmount: n(function (e) {
          this.saturation = Math.min(1, Math.max(this.saturation + e, 0));
        }),
        saturateByRatio: n(function (e) {
          this.saturation = Math.min(1, Math.max(this.saturation * (1 + e), 0));
        }),
        schemeFromDegrees: function (e) {
          for (var t = [], r = 0, n = e.length; n > r; r++) {
            var a = this.clone();
            (a.hue = (this.hue + e[r]) % 360), t.push(a);
          }
          return t;
        },
        ...
        fromObject: function (e) {
          if (
            e.hasOwnProperty("hue") &&
            e.hasOwnProperty("saturation") &&
        ...
        toRGB: function () {
          ...
          switch (
            ...
            case 0:
              (i.red = this.value), (i.green = a), (i.blue = r);
              break;
            case 1:
              (i.red = n), (i.green = this.value), (i.blue = r);
              break;
            case 2:
              (i.red = r), (i.green = this.value), (i.blue = a);
              break;
            case 3:
              (i.red = r), (i.green = n), (i.blue = this.value);
              break;
            case 4:
              (i.red = a), (i.green = r), (i.blue = this.value);
              break;
            default:
              (i.red = this.value), (i.green = r), (i.blue = n);
          }
          return (i.alpha = this.alpha), i;
        },
        toHSL: function () {
          this._normalise();
          var e = p.HSL();
      ...
      a("HSL", {
        ...
        lightness: 0,
        alpha: 1,
        darkenByAmount: n(function (e) {
          this.lightness = Math.min(1, Math.max(this.lightness - e, 0));
        }),
        darkenByRatio: n(function (e) {
          this.lightness = Math.min(1, Math.max(this.lightness * (1 - e), 0));
        }),
        lightenByAmount: n(function (e) {
          this.lightness = Math.min(1, Math.max(this.lightness + e, 0));
        }),
        lightenByRatio: n(function (e) {
          this.lightness = Math.min(1, Math.max(this.lightness * (1 + e), 0));
        }),
        fromObject: function (e) {
          return "string" == typeof e
            ...
            : e.hasOwnProperty("hue") &&
              e.hasOwnProperty("saturation") &&
              e.hasOwnProperty("lightness")
            ? this._fromHSL(e)
            : void 0;
        },
        _fromCSS: function (e) {
          var t = r(e).match(c);
          if (!t || !!t[1] + !!t[5] === 1) return null;
          var n = p.HSL();
          return (
      ...
      (i.isValid = function (e) {
        var t,
          r = i(e),
          n = 0;
        for (t in r) r.hasOwnProperty(t) && n++;
        return n > 0;
      }),
      (net.brehaut.Color = i);
  }.call(net.brehaut);
var module;
module && (module.exports.Color = net.brehaut.Color);
