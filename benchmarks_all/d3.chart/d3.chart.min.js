        ...
        (h.prototype.initialize = function () {}),
          ...
          (h.prototype.layer = function (t, e, r) {
            ...
            if (2 === arguments.length) {
              if ("function" == typeof e.draw)
                return (
                  (e._chart = this), (this._layers[t] = e), this._layers[t]
                );
              o(
                !1,
            ...
            return (
              (n = e.layer(r)), (this._layers[t] = n), (e._chart = this), n
            );
          }),
          ...
          (h.prototype.draw = function (t) {
            ...
            for (r in this._attached)
              (n = this.demux ? this.demux(r, t) : t),
                this._attached[r].draw(n);
          }),
