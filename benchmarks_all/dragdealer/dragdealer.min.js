!(function (a, b) {
  ...
  function k(a) {
    i.backfaceVisibility &&
      i.perspective &&
      ((a.style[i.perspective] = "1000px"),
      (a.style[i.backfaceVisibility] = "hidden"));
  }
  var a = function (a, b) {
    (this.options = this.applyDefaults(b || {})),
      ...
      this.wrapper &&
        ((this.handle = this.getHandleElement(
          this.wrapper,
  ...
  a.prototype = {
    ...
    bindMethods: function () {
      (this.requestAnimationFrame =
        "function" == typeof this.options.customRequestAnimationFrame
          ? b(this.options.customRequestAnimationFrame, window)
          : b(m, window)),
        (this.cancelAnimationFrame =
          "function" == typeof this.options.customCancelAnimationFrame
            ? b(this.options.customCancelAnimationFrame, window)
            : b(n, window)),
        (this.animateWithRequestAnimationFrame = b(
          this.animateWithRequestAnimationFrame,
          this
        )),
        (this.animate = b(this.animate, this)),
        (this.onHandleMouseDown = b(this.onHandleMouseDown, this)),
        (this.onHandleTouchStart = b(this.onHandleTouchStart, this)),
        (this.onDocumentMouseMove = b(this.onDocumentMouseMove, this)),
        (this.onWrapperTouchMove = b(this.onWrapperTouchMove, this)),
        (this.onWrapperMouseDown = b(this.onWrapperMouseDown, this)),
        (this.onWrapperTouchStart = b(this.onWrapperTouchStart, this)),
        (this.onDocumentMouseUp = b(this.onDocumentMouseUp, this)),
        (this.onDocumentTouchEnd = b(this.onDocumentTouchEnd, this)),
        (this.onHandleClick = b(this.onHandleClick, this)),
        (this.onWindowResize = b(this.onWindowResize, this));
    },
    ...
    onWrapperTouchMove: function (a) {
      return (
        ...
        !this.activity && this.draggingOnDisabledAxis()
          ? (this.dragging && this.stopDrag(), void 0)
          : (e(a), (this.activity = !0), void 0)
      );
    },
    ...
    setStep: function (a, b, c) {
      this.setValue(
        this.options.steps && a > 1 ? (a - 1) / (this.options.steps - 1) : 0,
        this.options.steps && b > 1 ? (b - 1) / (this.options.steps - 1) : 0,
        c
      );
    },
    ...
    startTap: function () {
      !this.disabled &&
        ...
        this.setTargetValueByOffset([
          g.x - this.offset.wrapper[0] - this.handle.offsetWidth / 2,
          g.y - this.offset.wrapper[1] - this.handle.offsetHeight / 2,
        ]));
    },
    stopTap: function () {
      !this.disabled &&
    ...
    startDrag: function () {
      this.disabled ||
        ...
        this.setWrapperOffset(),
        (this.offset.mouse = [
          g.x - h.get(this.handle)[0],
          g.y - h.get(this.handle)[1],
        ]),
      ...
      if (!a || this.dragging) {
        if (this.dragging) {
          var c = this.groupClone(this.value.target),
            d = [
              g.x - this.offset.wrapper[0] - this.offset.mouse[0],
              g.y - this.offset.wrapper[1] - this.offset.mouse[1],
            ];
    ...
    renderHandlePosition: function () {
      var a = "";
      return this.options.css3 && i.transform
        ? (this.options.horizontal &&
            (a += "translateX(" + this.offset.current[0] + "px)"),
          this.options.vertical &&
            (a += " translateY(" + this.offset.current[1] + "px)"),
          (this.handle.style[i.transform] = a),
          void 0)
        : (this.options.horizontal &&
    ...
    draggingOnDisabledAxis: function () {
      return (
        (!this.options.horizontal && g.xDiff > g.yDiff) ||
        (!this.options.vertical && g.yDiff > g.xDiff)
      );
    },
  };
  for (
    ...
    (m = window[l[o] + "RequestAnimationFrame"]),
      (n =
        window[l[o] + "CancelAnimationFrame"] ||
        window[l[o] + "CancelRequestAnimationFrame"]);
  return (
    m ||
      ((m = function (a) {
