...
(function (e, t, n) {
  ...
  var n = window,
    ...
    w = (function () {
      var e =
          "compareDocumentPosition" in f
            ? function (e, t) {
                return (
                  t.compareDocumentPosition &&
                  (t.compareDocumentPosition(e) & 16) === 16
                );
              }
            : "contains" in f
            ? function (e, t) {
                return (
                  (t = t.nodeType === 9 || t === window ? f : t),
                  t !== e && t.contains(e)
                );
              }
            : function (e, t) {
    ...
    E = (function () {
      var e = d(
        ...
        r = t.concat(d("wheelDelta wheelDeltaX wheelDeltaY wheelDeltaZ axis")),
        i = e.concat(
          d("char charCode key keyCode keyIdentifier keyLocation location")
        ),
        s = e.concat(d("data")),
        o = e.concat(d("touches targetTouches changedTouches scale rotation")),
        u = e.concat(d("data origin source")),
        l = e.concat(d("state")),
        c = /over|out/,
        h = [
          {
          ...
          },
          {
            ...
            fix: function (e, n, r) {
              (n.rightClick = e.which === 3 || e.button === 2),
                (n.pos = { x: 0, y: 0 });
              if (e.pageX || e.pageY)
                (n.clientX = e.pageX), (n.clientY = e.pageY);
              else if (e.clientX || e.clientY)
                (n.clientX = e.clientX + a.body.scrollLeft + f.scrollLeft),
                  (n.clientY = e.clientY + a.body.scrollTop + f.scrollTop);
              return (
                c.test(r) &&
                  (n.relatedTarget =
                    e.relatedTarget ||
                    e[(r == "mouseover" ? "from" : "to") + "Element"]),
                t
              );
            },
          },
        ...
        v = function (e, t, r) {
          ...
          (e =
            e ||
            ((t.ownerDocument || t.document || t).parentWindow || n).event),
    ...
    x = (function () {
      var e = function (e, t, n, r) {
        ...
        t = function (t, n, r, i, s, o, u) {
          var a = w[n],
            f;
          n == "unload" && (r = A(O, t, n, r, i)),
            a &&
              (a.condition && (r = e(t, r, a.condition, o)), (n = a.base || n)),
            (this.isNative = f = b[n] && !!t[c]),
            (this.customType = !l && !f && n),
            (this.element = t),
            (this.type = n),
            (this.original = i),
            (this.namespaces = s),
            (this.eventType = l || f ? n : "propertychange"),
            (this.target = S(t, f)),
            (this[c] = !!this.target[c]),
            (this.root = u),
            (this.handler = e(t, r, null, o));
        };
      return (
    ...
    T = (function () {
      var e = {},
        t = function (n, r, i, s, o, u) {
          var a = o ? "r" : "$";
          if (!r || r == "*")
            for (var f in e) f.charAt(0) == a && t(n, f.substr(1), i, s, o, u);
          else {
            var l = 0,
              c,
              h = e[a + r],
            ...
            for (c = h.length; l < c; l++)
              if ((p || h[l].matches(n, i, s)) && !u(h[l], h, l, r)) return;
          }
        },
        n = function (t, n, r, i) {
          var s,
          ...
          if (o)
            for (s = o.length; s--; )
              if (!o[s].root && o[s].matches(t, r, null)) return !0;
          return !1;
        },
        r = function (e, n, r, i) {
          var s = [];
        ...
        s = function (n) {
          t(n.element, n.type, null, n.handler, n.root, function (t, n, r) {
            return (
              n.splice(r, 1),
              (t.removed = !0),
              n.length === 0 && delete e[(t.root ? "r" : "$") + t.type],
              !1
            );
          });
        },
    ...
    k = function (e, t) {
      ...
      var n = T.get(this, t || e.type, null, !1),
        r = n.length,
        i = 0;
      ...
      : function (e, t, n, r) {
          ...
          n
            ? (T.put(
              ...
              r && e["_on" + r] == null && (e["_on" + r] = 0),
              i.target.attachEvent("on" + i.eventType, i.handler))
            : ((i = T.get(e, r || t, k, !0)[0]),
              i &&
                (i.target.detachEvent("on" + i.eventType, i.handler),
                T.del(i)));
        },
    ...
    O = function (e, t, n, r) {
      ...
      for (a = 0, f = o.length; a < f; a++)
        (!n || o[a].original === n) &&
          ...
          !u[o[a].eventType] &&
            o[a][c] &&
            (u[o[a].eventType] = { t: o[a].eventType, c: o[a].type }));
    ...
    M = function (e, t) {
      var n = function (t, n) {
          ...
          for (; t && t !== n; t = t.parentNode)
            for (r = i.length; r--; ) if (i[r] === t) return t;
        },
        r = function (e) {
    ...
    _ = l
      ...
      : function (e, t, n) {
          (n = S(n, e)),
            e ? n.fireEvent("on" + t, a.createEventObject()) : n["_on" + t]++;
        },
    D = function (e, t, n) {
      var r = v(t),
        o,
      ...
      if (!t || r) {
        ...
        O(e, u, n, a);
      } else if (m(t)) O(e, null, t);
      else for (o in t) t.hasOwnProperty(o) && D(e, o, t[o]);
      return e;
    },
    P = function (e, t, n, r) {
      var o, u, a, f, l, v, g;
      ...
      m(n)
        ? ((l = p.call(arguments, 3)), (r = o = n))
        : ((o = r), (l = p.call(arguments, 4)), (r = M(n, o, N))),
        (a = d(t)),
        this === h && (r = A(D, e, t, r, o));
      for (f = a.length; f--; )
        (g = T.put(
          (v = new x(
            e,
          ...
          v[c] && g && L(e, v.eventType, !0, v.customType);
      return e;
    },
    H = function (e, t, n, r) {
      return P.apply(
        ...
        v(n)
          ? [e, n, t, r].concat(
              arguments.length > 3 ? p.call(arguments, 5) : []
            )
          : p.call(arguments)
      );
    },
    ...
    F = function (e, t, n) {
      ...
      for (; s < i; s++)
        r[s].original &&
          ((o = [e, r[s].type]),
          (u = r[s].handler.__beanDel) && o.push(u.selector),
          o.push(r[s].original),
          P.apply(null, o));
      return e;
    },
