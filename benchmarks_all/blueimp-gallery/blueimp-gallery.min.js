!(function () {
  ...
  (e.extend = t),
    (e.contains = function (t, e) {
      do if (((e = e.parentNode), e === t)) return !0;
      while (e);
      return !1;
    }),
      ...
      t.extend(e.prototype, {
          ...
          var s = this,
            ...
            o = window.setInterval(function () {
              ...
              return r > i
                ...
                : void (s.slidesContainer[0].style.left =
                    (e - t) * (Math.floor((r / i) * 100) / 100) + t + "px");
            }, 4);
        },
        ...
        ontouchend: function (t) {
          ...
          var e,
            ...
            c =
              (!r && this.touchDelta.x > 0) ||
              (r === this.num - 1 && this.touchDelta.x < 0),
            u =
              !d &&
              this.options.closeOnSwipeUpOrDown &&
              ...
              ? ((i = r + e),
                ...
                this.options.continuous
                  ? (this.move(this.circle(i), n, 0),
                    this.move(this.circle(r - 2 * e), o, 0))
                  : i >= 0 && i < this.num && this.move(i, n, 0),
                this.move(r, this.positions[r] + n, l),
                this.move(
                  this.circle(s),
                ...
                this.onslide(r))
              : this.options.continuous
              ? (this.move(this.circle(r - 1), -a, l),
                this.move(r, 0, l),
                this.move(this.circle(r + 1), a, l))
              : (r && this.move(r - 1, -a, l),
                this.move(r, 0, l),
                r < this.num - 1 && this.move(r + 1, a, l));
        },
        ...
        initOptions: function (e) {
          (this.options = t.extend({}, this.options)),
            ((e && e.carousel) ||
              (this.options.carousel && (!e || e.carousel !== !1))) &&
              ...
              (s || t(m))
                ...
                .on("pause", function () {
                  (l = !1),
                    ...
                    a && h.container.addClass(h.options.controlsClass),
    ...
    return (
      t.extend(s.prototype, {
        ...
        loadAPI: function () {
          ...
          i || ((i = document.createElement("script")), (i.src = o)),
            t(i).on("load", e),
            r[0].parentNode.insertBefore(i, r[0]),
