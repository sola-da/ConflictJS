...
!(function () {
  ...
  void 0 === angular.element.prototype.querySelectorAll &&
    ...
    void 0 === angular.element.prototype.closest &&
      (angular.element.prototype.closest = function (e) {
        for (
          var t = this[0],
            i =
              t.matches ||
  ...
  i.directive("uiSelectChoices", [
    ...
    function (e, t, i, c, s) {
      return {
        ...
        compile: function (c, l) {
          ...
          u.attr("ng-repeat", o.repeatExpression(n)).attr(
            "ng-if",
            "$select.open"
          );
          ...
          return (
            p.attr(
              "ng-click",
              "$select.select(" + o.itemName + ",$select.skipFocusser,$event)"
            ),
            function (t, i, c, s) {
              s.parseRepeatAttr(c.repeat, n, a),
                (s.disableChoiceExpression = c.uiDisableChoice),
                (s.onHighlightCallback = c.onHighlight),
                (s.dropdownPosition = c.position
                ...
                t.$watch("$select.search", function (e) {
                  e && !s.open && s.multiple && s.activate(!1, !0),
                    ...
                    s.search.length >= c.minimumInputLength
                      ? s.refresh(c.refresh)
                      : (s.items = []);
                }),
    ...
    i.controller("uiSelectCtrl", [
      ...
      "$injector",
      "$window",
      function (t, i, c, s, l, n, a, r, o, u, d) {
        function p(e, t, i) {
          if (e.findIndex) return e.findIndex(t, i);
          for (var c, s = Object(e), l = s.length >>> 0, n = 0; l > n; n++)
            if (((c = s[n]), t.call(i, c, n, s))) return n;
          return -1;
        }
        function h() {
          (m.resetSearchInput ||
            (void 0 === m.resetSearchInput && r.resetSearchInput)) &&
            ((m.search = $),
            m.selected &&
              m.items.length &&
              !m.multiple &&
        ...
        function g(e, t) {
          ...
          for (i = 0; i < t.length; i++)
            for (c = 0; c < e.length; c++) e[c].name == [t[i]] && s.push(e[c]);
          return s;
        }
        function f(t) {
          var i = !0;
          switch (t) {
            case e.DOWN:
              !m.open && m.multiple
                ? m.activate(!1, !0)
                : m.activeIndex < m.items.length - 1 && m.activeIndex++;
              break;
            case e.UP:
              !m.open && m.multiple
                ? m.activate(!1, !0)
            ...
            case e.TAB:
              ...
              break;
            case e.ENTER:
              m.open && (m.tagging.isActivated || m.activeIndex >= 0)
                ? m.select(m.items[m.activeIndex], m.skipFocusser)
                : m.activate(!1, !0);
              break;
            case e.ESC:
              m.close();
        ...
        function v() {
          ...
          if (!(m.activeIndex < 0)) {
            ...
            s > l
              ? (e[0].scrollTop += s - l)
              : s < c.clientHeight &&
                (m.isGrouped && 0 === m.activeIndex
                  ? (e[0].scrollTop = 0)
                  : (e[0].scrollTop -= c.clientHeight - s));
          }
        }
        var m = this,
          $ = "";
        if (
          ...
          (m.searchEnabled = r.searchEnabled),
          (m.sortable = r.sortable),
          (m.refreshDelay = r.refreshDelay),
          (m.paste = r.paste),
          (m.removeSelected = r.removeSelected),
          (m.closeOnSelect = !0),
          (m.skipFocusser = !1),
          (m.search = $),
          (m.activeIndex = 0),
          ...
          (m.disabled = !1),
          (m.selected = void 0),
          (m.dropdownPosition = "auto"),
          (m.focusser = void 0),
          (m.resetSearchInput = !0),
          (m.multiple = void 0),
          (m.disableChoiceExpression = void 0),
          (m.tagging = { isActivated: !1, fct: void 0 }),
          (m.taggingTokens = { isActivated: !1, tokens: void 0 }),
          (m.lockChoiceExpression = void 0),
          ...
          (m.searchInput = i.querySelectorAll("input.ui-select-search")),
          1 !== m.searchInput.length)
        )
          throw a(
            "searchInput",
            "Expected 1 input.ui-select-search but got '{0}'.",
            m.searchInput.length
          );
        (m.isEmpty = function () {
          return (
            angular.isUndefined(m.selected) ||
            null === m.selected ||
            "" === m.selected ||
            (m.multiple && 0 === m.selected.length)
          );
        }),
          (m.activate = function (e, s) {
            if (!m.disabled && !m.open) {
              s || h(),
                ...
                (m.open = !0),
                (m.activeIndex =
                  m.activeIndex >= m.items.length ? 0 : m.activeIndex),
                -1 === m.activeIndex &&
                  m.taggingLabel !== !1 &&
                  (m.activeIndex = 0);
              var l = i.querySelectorAll(".ui-select-choices-content"),
                n = i.querySelectorAll(".ui-select-search");
              if (m.$animate && m.$animate.on && m.$animate.enabled(l[0])) {
                var a = function (t, i) {
                  "start" === i && 0 === m.items.length
                    ? (m.$animate.off("removeClass", n[0], a),
                      c(function () {
                        m.focusSearchInput(e);
                      }))
                    : "close" === i &&
                      (m.$animate.off("enter", l[0], a),
                      c(function () {
                        m.focusSearchInput(e);
                      }));
                };
                m.items.length > 0
                  ? m.$animate.on("enter", l[0], a)
                  : m.$animate.on("removeClass", n[0], a);
              } else
                c(function () {
                  m.focusSearchInput(e),
                    !m.tagging.isActivated && m.items.length > 1 && v();
                });
            }
          }),
          ...
          (m.parseRepeatAttr = function (e, i, c) {
              ...
              if (
                ...
                angular.forEach(e, function (e) {
                  var t = angular.isFunction(s) ? s(e) : e[s],
                    i = m.findGroupByName(t);
                  i ? i.items.push(e) : m.groups.push({ name: t, items: [e] });
                }),
                c)
              ) {
                var l = t.$eval(c);
                angular.isFunction(l)
                  ? (m.groups = l(m.groups))
                  : angular.isArray(l) && (m.groups = g(m.groups, l));
              }
              (m.items = []),
            ...
            (m.setItemsFn = i ? s : l),
              (m.parserResult = n.parse(e)),
              (m.isGrouped = !!i),
              (m.itemProperty = m.parserResult.itemName);
            var r = m.parserResult.source,
              u = function () {
                var e = r(t);
            ...
            m.parserResult.keyName &&
              (u(),
              (m.parserResult.source = o(
                "$uisSource" + m.parserResult.filters
              )),
              t.$watch(
                r,
                function (e, t) {
              ...
              (m.refreshItems = function (e) {
                e = e || m.parserResult.source(t);
                var i = m.selected;
                if (
                  m.isEmpty() ||
                  (angular.isArray(i) && !i.length) ||
                  !m.removeSelected
                )
                  m.setItemsFn(e);
                else if (void 0 !== e && null !== e) {
                  var c = e.filter(function (e) {
                    return angular.isArray(i)
                      ? i.every(function (t) {
                ...
                ("auto" !== m.dropdownPosition &&
                  "up" !== m.dropdownPosition) ||
                  t.calculateDropdownPos(),
                  t.$broadcast("uis:refresh");
              }),
              t.$watchCollection(m.parserResult.source, function (e) {
                if (void 0 === e || null === e) m.items = [];
                else {
                  if (!angular.isArray(e))
                    throw a("items", "Expected an array but got '{0}'.", e);
                  m.refreshItems(e),
                    angular.isDefined(m.ngModel.$modelValue) &&
                      (m.ngModel.$modelValue = null);
                }
              });
          });
        var b;
        (m.refresh = function (e) {
          ...
          (m.isActive = function (e) {
            if (!m.open) return !1;
            var t = m.items.indexOf(e[m.itemProperty]),
              i = t == m.activeIndex;
            return !i || 0 > t
              ? !1
              : (i &&
                  !angular.isUndefined(m.onHighlightCallback) &&
                  e.$eval(m.onHighlightCallback),
                i);
          });
        var w = function (e) {
          return (
            m.selected &&
            angular.isArray(m.selected) &&
            m.selected.filter(function (t) {
        ...
        (m.isDisabled = function (e) {
          if (m.open) {
            ...
            return (
              i >= 0 &&
                (!angular.isUndefined(m.disableChoiceExpression) ||
                  m.multiple) &&
                ((t = m.items[i]),
                (c = !!e.$eval(m.disableChoiceExpression) || w(t)),
                ...
                if (m.tagging.isActivated) {
                  if (m.taggingLabel === !1)
                    if (m.activeIndex < 0) {
                      if (
                        ((e =
                          void 0 !== m.tagging.fct
                            ? m.tagging.fct(m.search)
                            : m.search),
                        !e || angular.equals(m.items[0], e))
                      )
                        return;
                    ...
                    if (void 0 !== m.tagging.fct && "string" == typeof e) {
                      ...
                      "string" == typeof e &&
                        (e = e.replace(m.taggingLabel, "").trim());
                  }
                  if (w(e)) return void m.close(i);
                }
                t.$broadcast("uis:select", e);
                var l = {};
                (l[m.parserResult.itemName] = e),
                  c(function () {
                    m.onSelectCallback(t, {
                      $item: e,
                      $model: m.parserResult.modelMapper(t, l),
                    });
                  }),
                  m.closeOnSelect && m.close(i),
                  s && "click" === s.type && (m.clickTriggeredSelect = !0);
              }
            }
          }),
          (m.close = function (e) {
            m.open &&
              (m.ngModel && m.ngModel.$setTouched && m.ngModel.$setTouched(),
              h(),
              (m.open = !1),
          ...
          (m.toggle = function (e) {
            m.open
              ? (m.close(), e.preventDefault(), e.stopPropagation())
              : m.activate();
          }),
          (m.isLocked = function (e, t) {
            ...
            return (
              c &&
                !angular.isUndefined(m.lockChoiceExpression) &&
                ((i = !!e.$eval(m.lockChoiceExpression)),
                (c._uiSelectChoiceLocked = i)),
              i
            );
          });
        var y = null,
        ...
        (m.sizeSearchInput = function () {
          var e = m.searchInput[0],
            ...
            l = function (t) {
              ...
              return (
                50 > i && (i = t), m.searchInput.css("width", i + "px"), !0
              );
            };
          m.searchInput.css("width", "10px"),
            c(function () {
              null !== y ||
                l(s()) ||
                (y = t.$watch(function () {
          ...
          m.searchInput.on("keydown", function (i) {
            var s = i.which;
            ~[e.ENTER, e.ESC].indexOf(s) &&
              (i.preventDefault(), i.stopPropagation()),
              t.$apply(function () {
                var t = !1;
                if (
                  (m.items.length > 0 || m.tagging.isActivated) &&
                  (f(s), m.taggingTokens.isActivated)
                ) {
                  for (var l = 0; l < m.taggingTokens.tokens.length; l++)
                    m.taggingTokens.tokens[l] === e.MAP[i.keyCode] &&
                      m.search.length > 0 &&
                      (t = !0);
                  t &&
                    c(function () {
                      ...
                      m.tagging.fct && (t = m.tagging.fct(t)),
                        t && m.select(t, !0);
                    });
                }
              }),
              e.isVerticalMovement(s) && m.items.length > 0 && v(),
              (s !== e.ENTER && s !== e.ESC) ||
                (i.preventDefault(), i.stopPropagation());
          }),
            ...
            if (
              ((i =
                window.clipboardData && window.clipboardData.getData
                  ...
                  : (t.originalEvent || t).clipboardData.getData("text/plain")),
              (i = m.search + i),
              i && i.length > 0)
            )
              if (m.taggingTokens.isActivated) {
                for (
                  var c = [], s = 0;
                  s < m.taggingTokens.tokens.length;
                  s++
                ) {
                  var l =
                    e.toSeparator(m.taggingTokens.tokens[s]) ||
                    m.taggingTokens.tokens[s];
                  if (i.indexOf(l) > -1) {
                    c = i.split(l);
                    break;
                  }
        ...
        angular.element(d).bind("resize", E),
          t.$on("$destroy", function () {
            m.searchInput.off("keyup keydown tagged blur paste"),
              angular.element(d).off("resize", E);
          });
      },
    ]),
    i.directive("uiSelect", [
      "$document",
      "uiSelectConfig",
      "uiSelectMinErr",
      "uisOffset",
      ...
      function (e, t, i, c, s, l, n) {
        return {
          ...
          compile: function (s, a) {
            ...
            return (
              angular.isDefined(a.multiple)
                ? s.append("<ui-select-multiple/>").removeAttr("multiple")
                : s.append("<ui-select-single/>"),
              a.inputId &&
              ...
              function (s, a, r, o, u) {
                function d(e) {
                  if (g.open) {
                    ...
                    if (
                      ((t = window.jQuery
                        ? window.jQuery.contains(a[0], e.target)
                        : a[0].contains(e.target)),
                      !t && !g.clickTriggeredSelect)
                    ) {
                      var i;
                      if (g.skipFocusser) i = !0;
                      else {
                ...
                (g.generatedId = t.generateId()),
                  ...
                  (g.closeOnSelect = (function () {
                    return angular.isDefined(r.closeOnSelect)
                      ? l(r.closeOnSelect)()
                      : t.closeOnSelect;
                  })()),
                  ...
                  (g.onSelectCallback = l(r.onSelect)),
                  ...
                  r.$observe("limit", function () {
                    g.limit = angular.isDefined(r.limit)
                      ? parseInt(r.limit, 10)
                      : void 0;
                  }),
                  ...
                  r.$observe("taggingLabel", function () {
                    void 0 !== r.tagging &&
                      ("false" === r.taggingLabel
                        ? (g.taggingLabel = !1)
                        : (g.taggingLabel =
                            void 0 !== r.taggingLabel
                              ? r.taggingLabel
                              : "(new)"));
                  }),
                  r.$observe("taggingTokens", function () {
                    if (void 0 !== r.tagging) {
                      var e =
                        void 0 !== r.taggingTokens
                          ? r.taggingTokens.split("|")
                          : [",", "ENTER"];
                      g.taggingTokens = { isActivated: !0, tokens: e };
                    }
                  }),
                  angular.isDefined(r.autofocus) &&
                    n(function () {
                      g.setFocus();
                    }),
                  angular.isDefined(r.focusOn) &&
                    s.$on(r.focusOn, function () {
                      n(function () {
                        g.setFocus();
                      });
                    }),
                  ...
                  u(s, function (e) {
                    ...
                    if (
                      (s.removeAttr("ui-select-choices"),
                    ...
                    l.removeAttr("ui-select-no-choice"),
                      l.removeAttr("data-ui-select-no-choice"),
                      1 == l.length &&
                        a
                ...
                s.$watch("$select.open", function () {
                  ("auto" !== g.dropdownPosition &&
                    "up" !== g.dropdownPosition) ||
                    s.calculateDropdownPos();
                });
                var y = function (e, t) {
                    (e = e || c(a)),
                      (t = t || c(b)),
                  ...
                  E = function () {
                    n(function () {
                      if ("up" === g.dropdownPosition) y();
                      else {
                        a.removeClass(w);
                        var t = c(a),
                          i = c(b),
                          s =
                            e[0].documentElement.scrollTop ||
                            e[0].body.scrollTop;
    ...
    i.directive("uiSelectMatch", [
      "uiSelectConfig",
      function (e) {
        function t(e, t) {
          return e[0].hasAttribute(t)
            ? e.attr(t)
            : e[0].hasAttribute("data-" + t)
            ? e.attr("data-" + t)
            : e[0].hasAttribute("x-" + t)
            ? e.attr("x-" + t)
            : void 0;
        }
        return {
          ...
          link: function (c, s, l, n) {
            ...
            function r(t) {
                ...
                switch (t) {
                  ...
                  case e.DELETE:
                    return ~h.activeMatchIndex
                      ? (h.removeChoice(h.activeMatchIndex), r)
                      : !1;
                }
              }
              var c = a(d.searchInput[0]),
                ...
                p = r;
              return c > 0 || (d.search.length && t == e.RIGHT)
                ? !1
                : (d.close(),
                  (p = i()),
                  d.selected.length && p !== !1
                    ? (h.activeMatchIndex = Math.min(n, Math.max(l, p)))
            ...
            function o(e) {
              ...
              var t =
                e.filter(function (e) {
                  return void 0 === d.search.toUpperCase() || void 0 === e
                    ? !1
                    : e.toUpperCase() === d.search.toUpperCase();
                }).length > 0;
              return t;
            }
            function u(e, t) {
              ...
              if (angular.isArray(e))
                for (var c = angular.copy(e), s = 0; s < c.length; s++)
                  if (void 0 === d.tagging.fct)
                    ...
                    var l = c[s];
                    angular.isObject(l) && (l.isTag = !0),
                      angular.equals(l, t) && (i = s);
                  }
              return i;
            }
            var d = n[0],
            ...
            (d.multiple = !0),
              ...
              p.$parsers.unshift(function () {
                for (
                  var e, t = {}, i = [], s = d.selected.length - 1;
                  s >= 0;
                  s--
                )
                  (t = {}),
              ...
              p.$formatters.unshift(function (e) {
                var t,
                  i =
                    d.parserResult &&
                    d.parserResult.source(c, { $select: { search: "" } }),
                  s = {};
                if (!i) return e;
                var l = [],
                  n = function (e, i) {
                      ...
                      for (var n = e.length - 1; n >= 0; n--) {
                        if (
                          ...
                          if (
                            a &&
                            a.length > 0 &&
                            a[1] == d.parserResult.itemName &&
                            r &&
                            r.length > 0 &&
                            t[r[1]] == i[r[1]]
                          )
                            return l.unshift(e[n]), !0;
                        }
              ...
              c.$watchCollection(
                ...
                function (e, t) {
                  t != e &&
                    (angular.isDefined(p.$modelValue) && (p.$modelValue = null),
                    h.refreshComponent());
                }
              ),
              (p.$render = function () {
                if (!angular.isArray(p.$viewValue)) {
                  if (
                    !angular.isUndefined(p.$viewValue) &&
                    null !== p.$viewValue
                  )
                    throw t(
                      "multiarr",
              ...
              d.searchInput.on("keyup", function (t) {
                if (
                  ...
                  if (void 0 !== d.tagging.fct) {
                    ...
                    if (
                      ((l = d.$filter("filter")(a, function (e) {
                  ...
                  p && (h = u(d.selected, i)),
                    h > -1
                      ? (a = a.slice(h + 1, a.length - 1))
                      : ((a = []), i && a.push(i), (a = a.concat(r))),
                    c.$evalAsync(function () {
            ...
            r.$parsers.unshift(function (e) {
              ...
              r.$formatters.unshift(function (e) {
                var t,
                  i =
                    a.parserResult &&
                    a.parserResult.source(c, { $select: { search: "" } }),
                  s = {};
                if (i) {
                  var l = function (i) {
                    return (
                      (s[a.parserResult.itemName] = i),
            ...
            i(o)(c),
                ...
                return t.which === e.BACKSPACE
                  ...
                  : void (
                      ...
                      ((t.which != e.DOWN &&
                        ...
                        t.which != e.ENTER &&
                        t.which != e.SPACE) ||
                        (t.preventDefault(), t.stopPropagation(), a.activate()),
                      c.$digest())
                    );
              }),
              o.bind("keyup input", function (t) {
                t.which === e.TAB ||
                  ...
                  t.which == e.ENTER ||
                  t.which === e.BACKSPACE ||
                  (a.activate(o.val()), o.val(""), c.$digest());
              });
          },
        };
      },
    ]),
    i.directive("uiSelectSort", [
      "$timeout",
      "uiSelectConfig",
      "uiSelectMinErr",
      function (e, t, i) {
          ...
          link: function (t, c, s, l) {
            ...
            var g,
              ...
              m = function (e) {
                ...
                t < this["vertical" === o ? "offsetHeight" : "offsetWidth"] / 2
                  ? (v(h), c.addClass(p))
                  : (v(p), c.addClass(h));
              },
              $ = function (t) {
                t.preventDefault();
                var i = parseInt(
                  (t.dataTransfer || t.originalEvent.dataTransfer).getData(
                    "text"
                  ),
                  10
                );
            ...
            c.on("dragenter", function () {
              c.hasClass(u) ||
                (c.addClass(d), c.on("dragover", m), c.on("drop", $));
            }),
              c.on("dragleave", function (e) {
                e.target == c &&
                  (v(d), v(p), v(h), c.off("dragover", m), c.off("drop", $));
              });
          },
        };
      },
    ]),
    i.factory("$$uisDebounce", [
      "$timeout",
      function (e) {
        return function (t, i) {
          var c;
        ...
        (i.parse = function (i) {
          ...
          return {
            ...
            repeatExpression: function (e) {
              var t =
                this.itemName + " in " + (e ? "$group.items" : "$select.items");
              return (
                this.trackByExp && (t += " track by " + this.trackByExp), t
              );
            },
          };
        }),
