...
!(function (a, b) {
  "object" == typeof exports || ("object" == typeof module && module.exports)
    ? (module.exports = b(require("angular"), require("highlight.js")))
    : "function" == typeof define && define.amd
    ? define(["angular", "hljs"], b)
    : (a.returnExports = b(a.angular, a.hljs));
})(this, function (a, b) {
  function c(b) {
    return function (c) {
      switch (c) {
        ...
        case "onhighlight":
          return a.isDefined(b.hljsOnhighlight)
            ? b.hljsOnhighlight
            : b.onhighlight;
      }
    };
  ...
  function d(b) {
    var c = !0;
    return (
      a.forEach(["source", "include"], function (a) {
        b[a] && (c = !1);
      }),
      c
    );
  ...
  e.provider("hljsService", function () {
    ...
    e.controller("HljsCtrl", [
      ...
      function (b, c, d, e, f) {
        ...
        function i(a) {
          for (
            var b, c = [], d = new RegExp(r, "g"), e = "", f = 0;
            null !== (b = d.exec(a));

          )
            (e += a.substring(f, b.index) + s),
        ...
        function j(a, b) {
          for (
            var c, d = new RegExp(s, "g"), e = "", f = 0;
            null !== (c = d.exec(a));

          )
            (e += a.substring(f, c.index) + b.shift()),
              ...
              if (
                ...
                m
                  ? ((g = k._cacheKey(m, !!o, e)),
                    (f = b.get(g)),
                    f ||
                      ((f = c.highlight(m, c.fixMarkup(e), !0)), b.put(g, f)))
                  : ((g = k._cacheKey(!!o, e)),
                    (f = b.get(g)),
                    f || ((f = c.highlightAuto(c.fixMarkup(e))), b.put(g, f))),
                (e = f.value),
                o)
              ) {
  ...
  return (
      ...
      function (b) {
        return {
          ...
          compile: function (e, f, g) {
            ...
            return (
              e.html('<pre><code class="hljs"></code></pre>'),
              function (e, f, g, j) {
                var k,
                  l = c(g);
                if (
                  (a.isDefined(l("escape"))
                    ? (k = b(l("escape")))
                    : a.isDefined(l("no-escape")) && (k = b("false")),
                  j.init(f.find("code")),
                  l("onhighlight") &&
                    j.highlightCallback(function () {
                    ...
                    if (b && a.isString(b)) {
                      ...
                      (g = d.get(b)),
                        g ||
                          ...
                          (g = i.promise)),
                        e.when(g).then(function (b) {
                          b &&
                            (a.isArray(b)
                              ? (b = b[1])
                              : a.isObject(b) && (b = b.data),
                            (b = b.replace(/^(\r\n|\r|\n)/m, "")),
                            h.highlight(b));
                        });
                    } else h.clear();
    ...
    (function (b) {
      b.directive("hljs", f),
        a.forEach(
          ["interpolate", "hljsInterpolate", "compile", "hljsCompile"],
          function (a) {
            b.directive(a, g(a));
          }
        ),
