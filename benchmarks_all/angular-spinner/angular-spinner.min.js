...
!(function (a) {
          ...
          return {
            ...
            link: function (d, e, f) {
              ...
              (d.spinner = null),
                ...
                (d.startActive = a.isDefined(f.spinnerStartActive)
                  ? d.$eval(f.spinnerStartActive)
                  : d.key
                  ? !1
                  : !0),
                (d.spin = function () {
                ...
                d.$watch(
                  ...
                  function (h) {
                    g(),
                      (h = a.extend({}, c.config, c.themes[f.spinnerTheme], h)),
                      (d.spinner = new b(h)),
                      (d.key && !d.startActive) ||
                        f.spinnerOn ||
                        d.spinner.spin(e[0]);
                ...
                f.spinnerOn &&
                  d.$watch(f.spinnerOn, function (a) {
                    a ? d.spin() : d.stop();
                  }),
  ...
  "object" == typeof module && module.exports
    ? (module.exports = b(require("angular"), require("spin.js")))
    : "function" == typeof define && define.amd
    ? define(["angular", "spin"], b)
    : b(a.angular, a.Spinner);
})(this);
