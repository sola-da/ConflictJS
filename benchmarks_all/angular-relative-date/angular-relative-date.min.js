      ...
      1: [
        function (e, o, r) {
            ...
            return function (e) {
              ...
              switch (!1) {
                ...
                case !(2 * u > a):
                  return l("a_minute");
                case !(f > a):
                  return l("minutes", Math.floor(a / u));
                case 1 !== Math.floor(a / f):
                  return l("an_hour");
                case !(s > a):
                  return l("hours", Math.floor(a / f));
                case !(2 * s > a):
                  return l("a_day");
                case !(i > a):
                  return l("days", Math.floor(a / s));
                case 1 !== Math.floor(a / i):
                  return l("a_week");
                case !(_ > a):
                  return l("weeks", Math.floor(a / i));
                case 1 !== Math.floor(a / _):
                  return l("a_month");
                case !(m > a):
                  return l("months", Math.floor(a / _));
                case 1 !== Math.floor(a / m):
                  return l("a_year");
                default:
                  return l("over_a_year");
              }
            };
          }
          Object.defineProperty(r, "__esModule", { value: !0 }),
            (r["default"] = t);
          var a = function (e, o) {
              return e.has("$translate")
                ? e.get("$translate")
                : {
                    instant: function (e, r) {
                      return o[e].replace("{{time}}", r.time);
                    },
                  };
            },
            n = function (e, o) {
              return Math.round(Math.abs(e - o) / 1e3);
            };
        },
        {},
      ],
      2: [
        function (e, o, r) {
          ...
          var a = e("./translations"),
            ...
            u = e("./filter"),
            f = t(u),
            s = angular.module("relativeDate", []);
          s.value("now", null),
            s.value("relativeDateTranslations", n["default"]),
            s.filter("relativeDate", [
              "$injector",
              "now",
              "relativeDateTranslations",
              f["default"],
            ]),
            (r["default"] = s);
        },
