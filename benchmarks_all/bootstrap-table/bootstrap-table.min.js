  ...
  (o.DEFAULTS = {
      ...
      (this.header = {
        ...
        this.$container
          ...
          .on("click", ".th-inner", function (c) {
            var d = a(this);
            return d.closest(".bootstrap-table")[0] !== b.$container[0]
              ? !1
              : void (
                  b.options.sortable &&
      ...
      this.$toolbar.find(".bars").children().length &&
        ...
        this.options.showColumns &&
          ...
          a.each(this.columns, function (a, b) {
            if (
              !(b.radio || b.checkbox || (f.options.cardView && !b.cardVisible))
            ) {
        ...
        this.options.showColumns &&
          ...
          j <= this.options.minimumCountColumns &&
        ...
        this.options.search &&
          ...
          d.off("keyup drop").on("keyup drop", function (a) {
            (f.options.searchOnEnterKey && 13 !== a.keyCode) ||
              (clearTimeout(i),
          ...
          (this.data = c
            ? a.grep(this.data, function (d, f) {
                for (var g in d) {
                  ...
                  j &&
                    j.searchFormatter &&
                    (i = h(j, b.header.formatters[k], [i, d, f], i));
      ...
      this.$pagination.html(m.join("")),
        this.options.onlyInfoPagination ||
          ...
          this.options.smartDisplay &&
            ...
            (r.length < 2 || this.options.totalRows <= r[0]) &&
      ...
      for (var k = this.pageFrom - 1; k < this.pageTo; k++) {
        ...
        n._data &&
          ...
          this.options.cardView &&
            g.push(c('<td colspan="%s">', this.header.fields.length)),
          !this.options.cardView &&
          ...
          a.each(this.header.fields, function (b, i) {
            ...
            if (x.visible) {
              if (
                ...
                n["_" + i + "_class"] &&
                  (t = c(' class="%s"', n["_" + i + "_class"])),
                n["_" + i + "_rowspan"] &&
                  (v = c(' rowspan="%s"', n["_" + i + "_rowspan"])),
                n["_" + i + "_title"] &&
                  (w = c(' title="%s"', n["_" + i + "_title"])),
              ...
              n["_" + i + "_data"] &&
                ...
                a.each(n["_" + i + "_data"], function (a, b) {
                  "index" !== a && (u += c(' data-%s="%s"', a, b));
                }),
                x.checkbox || x.radio
                  ? ((q = x.checkbox ? "checkbox" : q),
                    (q = x.radio ? "radio" : q),
                    (j = [
                      c(
                        f.options.cardView
                      ...
                      "<input" +
                        ...
                        c(
                          ' checked="%s"',
                          l === !0 || (l && l.checked) ? "checked" : void 0
                        ) +
                        c(
                          ' disabled="%s"',
                          !x.checkboxEnabled || (l && l.disabled)
                            ? "disabled"
                            : void 0
                        ) +
                        " />",
                      f.header.formatters[b] && "string" == typeof l ? l : "",
                      f.options.cardView ? "</div>" : "</td>",
                    ].join("")),
                    (n[f.header.stateField] = l === !0 || (l && l.checked)))
                  : ((l =
                      "undefined" == typeof l || null === l
                        ? f.options.undefinedText
                        : l),
                    (j = f.options.cardView
                      ? [
                          '<div class="card-view">',
                          f.options.showHeader
                            ? c(
                                ...
                                o,
                                d(f.columns, "field", "title", i)
                              )
                            : "",
                          c('<span class="value">%s</span>', l),
                          "</div>",
                        ].join("")
                      : [
                          c("<td%s %s %s %s %s %s>", s, t, o, u, v, w),
                          l,
                          "</td>",
                        ].join("")),
                    f.options.cardView &&
        ...
        this.$body
          ...
          .on("click dblclick", function (b) {
            var d = a(this),
              ...
              j =
                f.header.fields[
                  f.options.detailView && !f.options.cardView ? i - 1 : i
                ],
      ...
      this.options.pagination &&
        ...
        (this.options.url || this.options.ajax) &&
          ...
          a.isEmptyObject(this.filterColumnsPartial) ||
            (g.filter = JSON.stringify(this.filterColumnsPartial, null)),
          ...
          f !== !1 &&
            ...
            this.options.ajax
              ? h(this, this.options.ajax, [d], null)
              : a.ajax(d)));
    }),
      ...
      this.options.showFooter &&
        ...
        a.each(this.columns, function (a, f) {
          ...
          f.visible &&
            ...
            ((g = c("text-align: %s; ", f.falign ? f.falign : f.align)),
    ...
    (o.prototype.resetView = function (a) {
      ...
      return this.options.cardView
        ? (this.$el.css("margin-top", "0"),
          void this.$tableContainer.css("padding-bottom", "0"))
    ...
    (o.prototype.updateByUniqueId = function (b) {
      ...
      b.hasOwnProperty("id") &&
        ...
        ((c = a.inArray(this.getRowByUniqueId(b.id), this.options.data)),
        -1 !== c &&
          (a.extend(this.data[c], b.row), this.initSort(), this.initBody(!0)));
    }),
    ...
    (o.prototype.updateRow = function (b) {
      b.hasOwnProperty("index") &&
        b.hasOwnProperty("row") &&
        (a.extend(this.data[b.index], b.row),
        this.initSort(),
        this.initBody(!0));
    }),
