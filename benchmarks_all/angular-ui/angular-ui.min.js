...
angular.module("ui.config", []).value("ui.config", {}),
  ...
  angular.module("ui.directives").directive("uiAnimate", [
    ...
    function (e, t) {
      var n = {};
      return (
        angular.isString(e.animate)
          ? (n["class"] = e.animate)
          : e.animate && (n = e.animate),
        {
          restrict: "A",
          link: function (e, r, i) {
            var s = {};
            i.uiAnimate &&
              ((s = e.$eval(i.uiAnimate)),
              angular.isString(s) && (s = { class: s })),
              (s = angular.extend({ class: "ui-animate" }, n, s)),
              r.addClass(s["class"]),
              t(
                function () {
        ...
        (e.uiCalendar = e.uiCalendar || {}),
        {
          ...
          link: function (t, n, r, i) {
            function a() {
              ...
              i && (i = i.name);
              var o,
                u = { defaultView: i, eventSources: s };
              r.uiCalendar ? (o = t.$eval(r.uiCalendar)) : (o = {}),
                angular.extend(u, e.uiCalendar, o),
                t.calendar.fullCalendar(u);
            }
      ...
      return {
        ...
        link: function (r, i, s, o) {
          ...
          if (i[0].type !== "textarea")
            throw new Error(
              "uiCodemirror3 can only be applied to a textarea element"
            );
          (u = e.codemirror || {}),
            (a = angular.extend({}, u, r.$eval(s.uiCodemirror))),
            (f = function (e) {
              return function (t, n) {
                var i = t.getValue();
                i !== o.$viewValue && (o.$setViewValue(i), r.$apply()),
                  typeof e == "function" && e(t, n);
              };
            }),
            (l = function () {
              (c = CodeMirror.fromTextArea(i[0], a)),
                c.on("change", f(a.onChange));
              ...
              o.$formatters.push(function (e) {
                ...
                s.uiRefresh &&
                  r.$watch(s.uiRefresh, function (e, n) {
                    e !== n && t(c.refresh);
                  });
            }),
            t(l);
  ...
  angular.module("ui.directives").directive("uiCurrency", [
    ...
    function (e, t) {
      ...
      return (
        e.currency && angular.extend(n, e.currency),
        {
          restrict: "EAC",
          require: "ngModel",
          link: function (e, r, i, s) {
            var o, u, a;
            (o = angular.extend({}, n, e.$eval(i.uiCurrency))),
              (u = function (e) {
                var n;
                return (
                  (n = e * 1),
                  r.toggleClass(o.pos, n > 0),
                  r.toggleClass(o.neg, n < 0),
                  r.toggleClass(o.zero, n === 0),
                  e === "" ? r.text("") : r.text(t(n, o.symbol)),
                  !0
                );
              }),
              (s.$render = function () {
  ...
  angular
    ...
    .directive("uiDate", [
      ...
      function (e) {
        ...
        return (
          (t = {}),
          angular.isObject(e.date) && angular.extend(t, e.date),
          {
            require: "?ngModel",
            link: function (t, n, r, i) {
              var s = function () {
        ...
        compile: function (e, t, n) {
          return function (e, t, r) {
            ...
            e.$watch(r.uiIf, function (r) {
              i && (i.remove(), (i = undefined)),
                s && (s.$destroy(), (s = undefined)),
                r &&
                  ((s = e.$new()),
                  n(s, function (e) {
                    (i = e), t.after(e);
    ...
    function (t, n) {
      return {
        ...
        compile: function (r, i) {
          if (!angular.isFunction(r[i.uiJq]))
            throw new Error(
              'ui-jq: The "' + i.uiJq + '" function does not exist'
            );
          ...
          return function (t, r, i) {
            ...
            var o = [];
            i.uiOptions
              ? ((o = t.$eval("[" + i.uiOptions + "]")),
                angular.isObject(s) &&
                  angular.isObject(o[0]) &&
                  (o[0] = angular.extend({}, s, o[0])))
              : s && (o = [s]),
              i.ngModel &&
                r.is("select,input,textarea") &&
                r.on("change", function () {
                  r.trigger("input");
                }),
              i.uiRefresh &&
                t.$watch(i.uiRefresh, function (e) {
                  u();
                }),
              u();
          };
      ...
      return function (e, i, s, o) {
        ...
        (u = i.$eval(o["ui" + r(e)])),
          angular.forEach(u, function (e, n) {
            var r, i;
            (i = t(e)),
              angular.forEach(n.split(" "), function (e) {
                (r = { expression: i, keys: {} }),
          ...
          s.bind(e, function (t) {
            var r = t.metaKey || t.altKey,
              ...
              o = t.shiftKey,
              u = t.keyCode;
            e === "keypress" && !o && u >= 97 && u <= 122 && (u -= 32),
              angular.forEach(a, function (e) {
                var u =
                    e.keys[n[t.keyCode]] || e.keys[t.keyCode.toString()] || !1,
                  a = e.keys.alt || !1,
                  f = e.keys.ctrl || !1,
                  l = e.keys.shift || !1;
                u &&
  ...
  (function () {
    ...
    e.directive("uiMap", [
      ...
      e.directive("uiMapInfoWindow", [
        "ui.config",
        "$parse",
        "$compile",
        function (e, n, r) {
          var i =
              "closeclick content_change domready position_changed zindex_changed",
            s = e.mapInfoWindow || {};
          return {
            link: function (e, o, u) {
              ...
              var f = n(u.uiMapInfoWindow),
                l = f(e);
              l || ((l = new google.maps.InfoWindow(a)), f.assign(e, l)),
                t(e, i, l, o),
                o.replaceWith("<div></div>");
              var c = l.open;
      ...
      n(
        "uiMapMarker",
        "animation_changed click clickable_changed cursor_changed dblclick drag dragend draggable_changed dragstart flat_changed icon_changed mousedown mouseout mouseover mouseup position_changed rightclick shadow_changed shape_changed title_changed visible_changed zindex_changed"
      ),
      n(
        "uiMapPolyline",
      ...
      n("uiMapGroundOverlay", "click dblclick");
  })(),
        ...
        link: function (e, t, n, r) {
          (r.$render = function () {
            ...
            r.$parsers.push(function (e) {
              var n =
                t.isMaskValid() ||
                (angular.isUndefined(t.isMaskValid()) && t.val().length > 0);
  ...
  angular.module("ui.directives").directive("uiReset", [
    ...
    function (e) {
      var t = null;
      return (
        e.reset !== undefined && (t = e.reset),
        {
          require: "ngModel",
          link: function (e, n, r, i) {
            var s;
            (s = angular.element('<a class="ui-reset" />')),
              n.wrap('<span class="ui-resetwrap" />').after(s),
              s.bind("click", function (n) {
                n.preventDefault(),
                  e.$apply(function () {
                    r.uiReset
                      ? i.$setViewValue(e.$eval(r.uiReset))
                      : i.$setViewValue(t),
                      i.$render();
                  });
              });
      ...
      return {
        ...
        compile: function (n, r) {
          ...
          if (r.uiRoute) i = "uiRoute";
            ...
            if (!r.href)
              throw new Error(
                "uiRoute missing a route or href property on " + n[0]
              );
            i = "href";
          }
          return function (n, r, s) {
            function a(t) {
              (hash = t.indexOf("#")) > -1 && (t = t.substr(hash + 1)),
                (u = function () {
    ...
    function (e) {
      ...
      return {
        link: function (t, n, r) {
          var i = n.offset().top;
          r.uiScrollfix
            ? r.uiScrollfix.charAt(0) === "-"
              ? (r.uiScrollfix = i - r.uiScrollfix.substr(1))
              : r.uiScrollfix.charAt(0) === "+" &&
                (r.uiScrollfix = i + parseFloat(r.uiScrollfix.substr(1)))
            : (r.uiScrollfix = i),
            angular.element(e).on("scroll.ui-scrollfix", function () {
              var t;
              ...
              !n.hasClass("ui-scrollfix") && t > r.uiScrollfix
                ? n.addClass("ui-scrollfix")
                : n.hasClass("ui-scrollfix") &&
                  t < r.uiScrollfix &&
                  n.removeClass("ui-scrollfix");
            });
        },
      };
    },
  ...
  angular.module("ui.directives").directive("uiSelect2", [
    ...
    function (e, t) {
      var n = {};
      return (
        e.select2 && angular.extend(n, e.select2),
        {
          require: "?ngModel",
          compile: function (e, r) {
            ...
            return (
              e.is("select") &&
                ((s = e.find("option[ng-repeat], option[data-ng-repeat]")),
                s.length &&
                  ((o = s.attr("ng-repeat") || s.attr("data-ng-repeat")),
                  (i = jQuery.trim(o.split("|")[0]).split(" ").pop()))),
              function (e, r, s, o) {
                var f = angular.extend({}, n, e.$eval(s.uiSelect2));
                u
                  ? (delete f.multiple, delete f.initSelection)
                  : a && (f.multiple = !0);
                if (o) {
                  (o.$render = function () {
                    u
                      ? r.select2("val", o.$modelValue)
                      : a
                      ? o.$modelValue
                        ? angular.isArray(o.$modelValue)
                          ? r.select2("data", o.$modelValue)
                          : r.select2("val", o.$modelValue)
                        : r.select2("data", [])
                      : angular.isObject(o.$modelValue)
                      ? r.select2("data", o.$modelValue)
                      : r.select2("val", o.$modelValue);
                  }),
                    i &&
                      e.$watch(i, function (e, n, i) {
                        if (!e) return;
                        t(function () {
                ...
                s.$observe("disabled", function (e) {
                  ...
                  s.ngMultiple &&
                    e.$watch(s.ngMultiple, function (e) {
                      r.select2(f);
                    }),
                  r.val(e.$eval(s.ngModel)),
                  t(function () {
                    r.select2(f),
                      !f.initSelection &&
                        !u &&
      ...
      function () {
        return function (e, t, n) {
          e.$watch(n.uiToggle, function (e, n) {
            e
              ? t.removeClass("ui-hide").addClass("ui-show")
              : t.removeClass("ui-show").addClass("ui-hide");
          });
        };
      },
    ]),
    ...
    function (e) {
      return {
        ...
        link: function (t, n, r, i) {
          ...
          (f = angular.extend({}, e.sortable, t.$eval(r.uiSortable))),
            i &&
              ((i.$render = function () {
                n.sortable("refresh");
              }),
              ...
              (s = function (e, t) {
                (t.item.sortable.relocate = !0),
                  i.$modelValue.splice(
                    t.item.index(),
                    0,
                    t.item.sortable.moved
                  );
              }),
              (o = function (e, t) {
                i.$modelValue.length === 1
                  ? (t.item.sortable.moved = i.$modelValue.splice(0, 1)[0])
                  : (t.item.sortable.moved = i.$modelValue.splice(
                      t.item.sortable.index,
                      1
                    )[0]);
              }),
              (onStop = function (e, n) {
                if (n.item.sortable.resort && !n.item.sortable.relocate) {
                  var r, i;
                  (i = n.item.sortable.index),
                    (r = n.item.index()),
                    i < r && r--,
                    n.item.sortable.resort.$modelValue.splice(
                      r,
                      0,
                      n.item.sortable.resort.$modelValue.splice(i, 1)[0]
                    );
                }
                (n.item.sortable.resort || n.item.sortable.relocate) &&
                  t.$apply();
              }),
              (h = f.start),
      ...
      return (
        (e.tinymce = e.tinymce || {}),
        {
          ...
          link: function (t, n, r, i) {
            ...
            r.uiTinymce ? (s = t.$eval(r.uiTinymce)) : (s = {}),
              angular.extend(o, e.tinymce, s),
              setTimeout(function () {
                n.tinymce(o);
              });
          },
  ...
  angular.module("ui.directives").directive("uiValidate", function () {
    return {
      ...
      link: function (e, t, n, r) {
        ...
        if (!u) return;
        angular.isString(u) && (u = { validator: u }),
          angular.forEach(u, function (t, n) {
            (i = function (i) {
              return e.$eval(t, { $value: i })
                ? (r.$setValidity(n, !0), i)
                : (r.$setValidity(n, !1), undefined);
            }),
              (o[n] = i),
              r.$formatters.push(i),
              r.$parsers.push(i);
  ...
  angular.module("ui.filters").filter("format", function () {
    return function (e, t) {
      ...
      return t === undefined
        ? n
        : !angular.isArray(t) && !angular.isObject(t)
        ? n.split("$0").join(t)
        : ((r = (angular.isArray(t) && "$") || ":"),
  ...
  angular.module("ui.filters").filter("highlight", function () {
    return function (e, t, n) {
      return t || angular.isNumber(t)
        ? ((e = e.toString()),
          (t = t.toString()),
          n
            ? e.split(t).join('<span class="ui-match">' + t + "</span>")
            : e.replace(
                new RegExp(t, "gi"),
  ...
  angular.module("ui.filters").filter("inflector", function () {
    ...
    var n = {
      ...
      underscore: function (e) {
        return (
          e.substr(0, 1).toLowerCase() +
          t(e.substr(1), "_").toLowerCase().split(" ").join("_")
        );
      },
      variable: function (t) {
        return (
          (t =
            ...
            e(t.split("_").join(" ")).substr(1).split(" ").join("")),
          t
        );
      },
    };
    return function (e, t, r) {
      return t !== !1 && angular.isString(e)
        ? ((t = t || "humanize"), n[t](e))
        : e;
    };
  }),
