    ...
    return (
      ...
      (addClass = function (element, name) {
        return element.className.match(new RegExp("\\b" + name + "\\b"))
          ? void 0
          : (element.className = _.trim(element.className + " " + name));
      }),
      ...
      (domStyle = function (elem, name) {
        return elem && 3 !== elem.nodeType && 8 !== elem.nodeType && elem.style
          ? elem.style[name]
          : void 0;
      }),
      ...
      (utf8_encode = function (argString) {
        ...
        for (
          ...
          (c1 = string.charCodeAt(n)),
            ...
            n++;
        return (
          end > start && (utftext += string.slice(start, stringl)), utftext
        );
      }),
      (crc32 = function (str) {
      ...
      (TransformationBase = (function () {
        ...
        return (
            ...
            switch (
              ...
              (transformationList = function () {
                ...
                for (results = [], j = 0, len = paramList.length; len > j; j++)
                  (t = paramList[j]),
                    results.push(
                      null != (ref1 = this.get(t)) ? ref1.serialize() : void 0
                    );
                return results;
              }.call(this)),
              !1)
          ...
          (TransformationBase.prototype.toHtmlAttributes = function () {
            ...
            for (key in ref)
              (value = ref[key]),
                Util.contains(this.PARAM_NAMES, key) || (options[key] = value);
            for (
              ...
              (key = ref1[j]), (options[key] = this.get(key).value);
            for (ref2 = this.keys(), l = 0, len1 = ref2.length; len1 > l; l++)
              (k = ref2[l]),
                /^html_/.exec(k) && (options[k.substr(5)] = this.getValue(k));
            return (
              this.hasLayer() ||
                this.getValue("angle") ||
                Util.contains(
                ...
                ((width =
                  null != (ref3 = this.get("width")) ? ref3.origValue : void 0),
                (height =
                  null != (ref4 = this.get("height"))
                    ? ref4.origValue
                    : void 0),
                parseFloat(width) >= 1 &&
                  null == options.width &&
            ...
            if (
              ...
              null != cloudinary_url &&
                ...
                (this.configuration = {
                  ...
                  secure_distribution:
                    uri.pathname && uri.pathname.substring(1),
                }),
                null != uri.query))
            ) {
              ref2 = uri.query;
        ...
        return (
          ...
          (ImageTag.prototype.attributes = function () {
            ...
            return (
              ...
              null == attr.src &&
                (attr.src = new Cloudinary(this.getOptions()).url(
                  this.publicId
                )),
              attr
            );
          ...
          (VideoTag.prototype.attributes = function () {
            ...
            return (
              Util.isArray(sourceTypes) ||
                (attr.src = new Cloudinary(this.getOptions()).url(
                  this.publicId,
                  { resource_type: "video", format: sourceTypes }
                )),
      ...
      (Cloudinary = (function () {
        ...
        return (
          ...
          (Cloudinary.prototype.fetch_image = function (publicId, options) {
            return this.image(
              publicId,
              Util.assign({ type: "fetch" }, options)
            );
          }),
          ...
          (Cloudinary.prototype.responsive = function (options) {
            ...
            return (
              ...
              this.cloudinary_update(
                "img.cld-responsive, img.cld-hidpi",
                this.responsiveConfig
              ),
              (responsiveResize =
                null !=
                (ref =
                  null != (ref1 = this.responsiveConfig.responsive_resize)
                    ? ref1
                        ...
                        return (
                          (debounce =
                            ...
                            (ref2 =
                              null !=
                              (ref3 =
                                _this.responsiveConfig.responsive_debounce)
                                ? ref3
                          ...
                          (wait = function () {
                            return reset(), setTimeout(waitFunc, debounce);
                          }),
                          debounce ? wait() : run()
                        );
                      };
          ...
          (Cloudinary.prototype.supported_dpr_values = [
            0.75, 1, 1.3, 1.5, 2, 3,
          ]),
              ...
              (responsive_use_breakpoints =
                ...
                (ref =
                  ...
                  (ref1 =
                    null !=
                    (ref2 =
                      null != (ref3 = options.responsive_use_breakpoints)
                        ? ref3
          ...
          (parentWidth = function (element) {
            ...
            for (
              containerWidth = 0;
              (element =
                null != element ? element.parentNode : void 0) instanceof
          ...
          (Cloudinary.prototype.cloudinary_update = function (
            elements,
            options
          ) {
            var containerWidth,
            ...
            for (
              ...
              (tag = elements[j]),
                (null != (ref = tag.tagName) ? ref.match(/img/i) : void 0) &&
                  ((setUrl = !0),
                  options.responsive && Util.addClass(tag, "cld-responsive"),
                  (src =
                    Util.getData(tag, "src-cache") || Util.getData(tag, "src")),
                  Util.isEmpty(src) ||
                    ((src = src.replace(
                      /\bdpr_(1\.0|auto)\b/g,
                      "dpr_" + this.device_pixel_ratio()
                    )),
                    Util.hasClass(tag, "cld-responsive") &&
                      /\bw_auto\b/.exec(src) &&
