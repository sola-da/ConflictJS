          ...
          (h.prototype = {
            ...
            applyOptions: function () {
              ...
              (b = this.scope.rzSliderOptions
                ...
                (this.options.showTicks =
                  this.options.showTicks || this.options.showTicksValues),
            ...
            translateFn: function (a, b, c, d) {
              ...
              var e = "",
                f = !1;
              d
                ? (this.options.stepsArray && (a = this.getStepValue(a)),
                ...
                for (var c = 0; b > c; c++) {
                  ...
                  if (
                    ...
                    this.options.ticksTooltip &&
                      ((e.tooltip = this.options.ticksTooltip(d)),
                      (e.tooltipPlacement = this.options.vertical
                        ? "right"
                        : "top")),
                    this.options.showTicksValues &&
                      ((e.value = this.getDisplayValue(d, "tick-value")),
                      this.options.ticksValuesTooltip &&
                        ((e.valueTooltip = this.options.ticksValuesTooltip(d)),
                        (e.valueTooltipPlacement = this.options.vertical
                          ? "right"
                          : "top"))),
                    this.getLegend)
                  ) {
                  ...
                  this.options.rightToLeft
                    ? this.scope.ticks.unshift(e)
                    : this.scope.ticks.push(e);
                }
              }
            },
            ...
            shFloorCeil: function () {
              ...
              l
                ...
                this.range &&
                  ...
                  n ? this.hideEl(this.flrLab) : a || this.showEl(this.flrLab));
            },
              ...
              if (this.range)
                ...
                c
                  ? ((b =
                    ...
                    (a = this.minH.rzsp + this.handleHalfDim))
                  : ((b =
                      Math.abs(this.maxH.rzsp - this.minH.rzsp) +
                      this.handleHalfDim),
                    (a = 0));
              if (
            ...
            valueToOffset: function (a) {
              return this.options.rightToLeft
                ? ((this.maxValue - this.sanitizeValue(a)) * this.maxPos) /
                    this.valueRange || 0
                : ((this.sanitizeValue(a) - this.minValue) * this.maxPos) /
                    this.valueRange || 0;
            },
            ...
            offsetToValue: function (a) {
              return this.options.rightToLeft
                ? (1 - a / this.maxPos) * this.valueRange + this.minValue
                : (a / this.maxPos) * this.valueRange + this.minValue;
            },
            ...
            getEventPosition: function (a) {
              ...
              return (
                (c = this.options.vertical
                  ? -this.getEventXY(a) + b
                  : this.getEventXY(a) - b),
                (c - this.handleHalfDim) * this.options.scale
              );
            },
            getEventNames: function (a) {
              ...
              return (
                a.touches ||
                (void 0 !== a.originalEvent && a.originalEvent.touches)
              ...
              if (null != h && "" !== this.tracking) {
                ...
                b(function () {
                  ...
                  if (i.options.draggableRangeOnly) {
                    var b,
                      c,
                      d = i.highValue - i.lowValue;
                    "lowValue" === i.tracking
                      ? ((b = a),
                        (c = a + d),
                        c > i.maxValue && ((c = i.maxValue), (b = c - d)))
                      : ((c = a),
                        (b = a - d),
                        b < i.minValue && ((b = i.minValue), (c = b + d))),
                  ...
                  "min" === a
                    ? c
                      ? d
                        ...
                        : this.minValue
                      : e
                      ? this.offsetToValue(b + this.dragging.lowLimit)
                      : this.offsetToValue(b - this.dragging.lowLimit)
                    : c
                    ? d
                      ? e
            ...
            positionTrackingBar: function (a, b) {
              (this.lowValue = a),
                ...
                this.range && this.applyHighValue(),
                this.applyModel(),
                this.updateHandles("lowValue", this.valueToOffset(a)),
                this.updateHandles("highValue", this.valueToOffset(b));
            },
              ...
              (a = this.applyMinMaxLimit(a)),
                ...
                this[this.tracking] !== a &&
                  ...
                  "lowValue" === this.tracking
                    ? this.applyLowValue()
                    : this.applyHighValue(),
                  this.updateHandles(this.tracking, this.valueToOffset(a)),
                  this.updateAriaAttributes(),
                  (b = !0)),
                b && this.applyModel();
            },
