...
!(function (e, r) {
  ...
  return (function (e) {
        ...
        return (
          ...
          function (n, i) {
            ...
            return (
              "object" == typeof i &&
                i &&
                (-1 !== t.indexOf(i) ? (a = r(n, i)) : (t.push(i), o.push(n))),
              e && (a = e(n, a)),
              a
            );
          }
    ...
    function (e, r, t) {
      ...
      function a(e, r) {
        ...
        return (t =
          n && e.shortType
            ? e.shortType
            : (!n && "object" == typeof e.type) || "function" === e.type
            ? u(e, r)
            : u(e, r) || e.displayName || e.name);
      }
      function u(e, r) {
        var t = e.type;
      ...
      function c(e, r, t) {
        ...
        for (var i in e)
          if (o.call(e, i) && ((n = r.call(t, e[i], i, e)), n === !1)) return n;
        return !0;
      }
      function s(e, r, t) {
        for (var n = void 0, o = e.length, i = 0; o > i; i++)
          if (((n = r.call(t, e[i], i, e)), n === !1)) return n;
        return !0;
      }
      function l(e) {
    ...
    function (e, r, t) {
      ...
      function n() {
        function r(n, i, a) {
          if (r.config.disabled || e.exports.globalConfig.disabled)
            return {
              apiTypes: {},
              argTypes: {},
              passed: !0,
          ...
          return (
            (f.args = i),
            u.length
              ? ((f.message = r.getErrorMessage(n, i, u, a)),
                (f.failed = !0),
                (f.passed = !1))
              : ((f.message = ""), (f.failed = !1), (f.passed = !0)),
            f
          );
        }
        function t(e) {
        ...
        function a(e, t) {
          function n() {
            var e = p.onlyPrefix;
            return (
              e || (e = ((f.prefix || "") + " " + (p.prefix || "")).trim()), e
            );
          }
          function o() {
            var e = p.onlySuffix;
            return (
              e || (e = ((p.suffix || "") + " " + (f.suffix || "")).trim()), e
            );
          }
          function i() {
            var e = p.url;
            return (
              e ||
                (e =
                  f.docsBaseUrl &&
                  p.urlSuffix &&
                  ("" + f.docsBaseUrl + p.urlSuffix).trim()),
              e
            );
          }
          var a =
            ...
            h(e, function (r, n) {
              -1 === f.indexOf(r) &&
                ...
                "object" == typeof r
                  ? t(e)
                  : "function" == typeof r &&
                    (e[n] = r.displayName || r.name || "anonymous function"));
            });
          }
          function n(e) {
            return e && e.length
              ? (e && 1 === e.length && (e = e[0]), l(e, null, 2))
              : "nothing";
          }
          function o() {
            var e = "\n",
        ...
        j &&
          arguments.length &&
          j["throw"](C.getApiCheckInstanceCheckers, arguments, {
        ...
        return (
          h(k.getCheckers(m), function (e, t) {
            return (r[t] = e);
          }),
          h(d, function (e, t) {
            return (r[t] = e);
      ...
      function i(e, r, t) {
        var n = k.shape({ type: k.string, optional: k.bool }),
          o = k.func.withProperties({ __apiCheckData: n }),
          a = k.shape({ __apiCheckData: n }),
          u = k.oneOfType([o, a])(e, r, t);
        return d(u)
          ? u
          : "function" == typeof e || e.hasOwnProperty(e.__apiCheckData.type)
          ? void 0
          : O(r, t, i.type);
      }
      function a(e, r, t) {
      ...
      function p(e, r) {
        ...
        return r.length < t.length
          ? [
              "Not enough arguments specified. Requires `" +
                t.length +
                "`, you passed `" +
                r.length +
                "`",
      ...
      (e.exports = n),
        ...
        (e.exports.utils = y),
        (e.exports.globalConfig = { verbose: !1, disabled: !1 });
    ...
    function (e, r, t) {
      ...
      function n(e) {
        ...
        function t() {
          ...
          return (
            (t.withProperties = function (r) {
              var t = m.objectOf(m.func)(
                r,
                "properties",
              ...
              var n = m.shape(r, !0);
              return (
                (n.type.__apiCheckData.type = "func.withProperties"),
                b(
                  function (e, r, t) {
                    var o = m.func(e, r, t);
                    return c(o) ? o : n(e, r, t);
                  },
                  { type: n.type, shortType: "func.withProperties" },
                  e
                )
              );
            }),
        ...
        function v(r) {
          var t = { __apiCheckData: { optional: !1, type: "enum" }, enum: r },
            n =
              "oneOf[" +
              r
                .map(function (e) {
        ...
        function O(r) {
          ...
          var n = r.map(function (e) {
            ...
            o = "oneOfType[" + n.join(", ") + "]";
          return (
            (t.__apiCheckData = { optional: !1, type: "oneOfType" }),
            b(
              function (e, t, n) {
                return r.some(function (r) {
                  return !c(r(e, t, n));
        ...
        function k(r) {
          ...
          var n = f(r, { short: !0 }),
            o = "arrayOf[" + n + "]";
          return (
            (t.__apiCheckData = { optional: !1, type: "arrayOf" }),
            b(
              function (e, t, n) {
                return c(m.array(e)) ||
                  !e.every(function (e) {
        ...
        function C(r) {
          ...
          var n = f(r, { short: !0 }),
            o = "objectOf[" + n + "]";
          return (
            (t.__apiCheckData = { optional: !1, type: "objectOf" }),
            b(
              function (e, t, n) {
        ...
        function j(r) {
          ...
          var n = f(r, { short: !0 }),
            o = "typeOrArrayOf[" + n + "]";
          return (
            (t.__apiCheckData = { optional: !1, type: "typeOrArrayOf" }),
            b(
              function (e, t, n, i) {
                return c(m.oneOfType([r, m.arrayOf(r)])(e, t, n, i))
                  ? y(t, n, o)
                  : void 0;
              },
              { type: t, shortType: o },
        ...
        function x() {
            ...
            function n() {
              function e(e, r, t, n, o) {
                ...
                if (t || !o || n.isOptional) {
                  ...
                  var p = "ITEM";
                  n.type &&
                    n.type.__apiCheckData &&
                    (p = n.type.__apiCheckData.type.toUpperCase()),
                    a(
                      "missing",
                      "MISSING THIS " + p,
            ...
            var a = b(
              function (e, n, o) {
                ...
                return (
                  ...
                  (n = n || ""),
                  u(r, function (r, t) {
                    return e.hasOwnProperty(t) || !r.isOptional
                      ? ((a = r(e[t], t, "" + o + n, e)), !c(a))
                      : void 0;
                  }),
                  c(a) ? a : void 0
              ...
              { type: n, shortType: "shape" },
              e
            );
            return (
              (o.__apiCheckData = p(a.type.__apiCheckData)),
          ...
          return (
            (r.ifNot = function (r, t) {
              Array.isArray(r) || (r = [r]);
              var o = void 0;
              o =
                1 === r.length
                  ? "specified only if " + r[0] + " is not specified"
                  : "specified only if none of the following are specified: [" +
                    l(r, ", ", "and ") +
                    "]";
              var i = "ifNot[" + r.join(", ") + "]",
                a = n(t, o, i);
              return b(
                ...
                { notRequired: !0, type: a, shortType: i },
                e
              );
            }),
            (r.onlyIf = function (r, t) {
              ...
              o =
                1 === r.length
                  ? "specified only if " + r[0] + " is also specified"
                  : "specified only if all of the following are specified: [" +
                    l(r, ", ", "and ") +
                    "]";
              var i = "onlyIf[" + r.join(", ") + "]",
                a = n(t, o, i);
        ...
        function _() {
          ...
          return b(
            function (e, t, n) {
              return Array.isArray(e) || c(m.object(e)) || c(m.number(e.length))
                ? y(t, n, r)
                : void 0;
            },
            { type: r },
        ...
        function w(r, t) {
          ...
          return b(
            function (e, o, i) {
              return "number" != typeof e || r > e || e > t
                ? y(o, i, n)
                : void 0;
            },
            { type: n },
        ...
        function N() {
          ...
          return b(
            function (e, t, n) {
              return "object" !== a(e) || null === e || Object.keys(e).length
                ? y(t, n, r)
                : void 0;
            },
            { type: r },
