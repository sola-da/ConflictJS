!(function (e) {
  ...
  function e(r, n) {
    ...
    (this.options = n = n ? zi(n) : {}), zi(el, n, !1), d(n);
    var i = n.value;
    "string" == typeof i && (i = new Ll(i, n.mode, null, n.lineSeparator)),
      (this.doc = i);
    ...
    bo &&
      ...
      $n(this, i),
      (n.autofocus && !Wo) || a.hasFocus()
        ? setTimeout(Fi(vr, this), 20)
        : mr(this);
    for (var c in tl) tl.hasOwnProperty(c) && tl[c](this, n[c], rl);
    C(this), n.finishInit && n.finishInit(this);
    for (var h = 0; h < ll.length; ++h) ll[h](this);
    Ct(this),
      xo &&
        n.lineWrapping &&
  ...
  function t(e, t, r) {
    var n = this;
    (this.input = r),
      (n.scrollbarFiller = Ui("div", null, "CodeMirror-scrollbar-filler")),
      n.scrollbarFiller.setAttribute("cm-not-content", "true"),
      (n.gutterFiller = Ui("div", null, "CodeMirror-gutter-filler")),
      n.gutterFiller.setAttribute("cm-not-content", "true"),
      (n.lineDiv = Ui("div", null, "CodeMirror-code")),
      (n.selectionDiv = Ui(
        "div",
        null,
        null,
      ...
      (n.cursorDiv = Ui("div", null, "CodeMirror-cursors")),
      (n.measure = Ui("div", null, "CodeMirror-measure")),
      (n.lineMeasure = Ui("div", null, "CodeMirror-measure")),
      (n.lineSpace = Ui(
        "div",
      ...
      (n.mover = Ui(
        "div",
        [Ui("div", [n.lineSpace], "CodeMirror-lines")],
        null,
        "position: relative"
      )),
      (n.sizer = Ui("div", [n.mover], "CodeMirror-sizer")),
      (n.sizerWidth = null),
      (n.heightForcer = Ui(
        "div",
        null,
        null,
        "position: absolute; height: " + El + "px; width: 1px;"
      )),
      (n.gutters = Ui("div", null, "CodeMirror-gutters")),
      (n.lineGutter = null),
      (n.scroller = Ui(
        "div",
      ...
      xo || (vo && Wo) || (n.scroller.draggable = !0),
  ...
  function i(e) {
    e.options.lineWrapping
      ? (Ql(e.display.wrapper, "CodeMirror-wrap"),
        (e.display.sizer.style.minWidth = ""),
        (e.display.sizerWidth = null))
      : (Zl(e.display.wrapper, "CodeMirror-wrap"), f(e)),
      l(e),
      Et(e),
      st(e),
      setTimeout(function () {
  ...
  function g(e, t, r) {
    ...
    var n = (this.vert = Ui(
        "div",
        [Ui("div", null, null, "min-width: 1px")],
        "CodeMirror-vscrollbar"
      )),
      i = (this.horiz = Ui(
        "div",
        [Ui("div", null, null, "height: 100%; min-height: 1px")],
        "CodeMirror-hscrollbar"
      ));
    e(n),
      e(i),
      Al(n, "scroll", function () {
  ...
  function m(t) {
    t.display.scrollbars &&
      ...
      t.display.scrollbars.addClass &&
        Zl(t.display.wrapper, t.display.scrollbars.addClass)),
      ...
      t.display.scrollbars.addClass &&
        Ql(t.display.wrapper, t.display.scrollbars.addClass);
  }
  function y(e, t) {
    t || (t = p(e));
  ...
  function w(e, t, r) {
    ...
    if (r && r.ensure) {
      var s = r.ensure.from.line,
        a = r.ensure.to.line;
      o > s
        ? ((o = s), (l = ri(t, ni(Zn(t, s)) + e.wrapper.clientHeight)))
        : Math.min(a, t.lastLine()) >= l &&
          ((o = ri(t, ni(Zn(t, a)) - e.wrapper.clientHeight)), (l = a));
    }
  ...
  function M(e, t) {
    ...
    Bt(e, o, l),
      (r.viewOffset = ni(Zn(e.doc, r.viewFrom))),
  ...
  function N(e, t) {
    for (
      ...
      ((n && e.options.lineWrapping && t.oldDisplayWidth != Ye(e)) ||
        (r &&
          null != r.top &&
          (r = { top: Math.min(e.doc.height + Ke(e.display) - _e(e), r.top) }),
  ...
  function A(e, t) {
    (e.display.sizer.style.minHeight = t.docHeight + "px"),
      ...
      (e.display.gutters.style.height =
        t.docHeight + e.display.barHeight + Xe(e) + "px");
  }
  function O(e) {
    for (
      ...
      if (!o.hidden) {
        ...
        if (
          (2 > i && (i = yt(t)),
          (a > 0.001 || -0.001 > a) && (ei(o.line, i), D(o.line), o.rest))
        )
  ...
  function P(e, t, r) {
    function n(t) {
      var r = t.nextSibling;
      return (
        xo && Ao && e.display.currentWheelTarget == t
    ...
    for (
      ...
      if (h.hidden);
        ...
        h.changes && (Hi(h.changes, "gutter") > -1 && (f = !1), E(e, h, u, r)),
          f &&
            (Vi(h.lineNumber),
  ...
  function I(e) {
    return (
      e.node == e.text &&
        ((e.node = Ui("div", null, null, "position: relative")),
  ...
  function B(e) {
    z(e),
      e.line.wrapClass
        ? (I(e).className = e.line.wrapClass)
  ...
  function Z(e, t, r, n, i) {
    ...
    if (l && n.ranges.length > 1)
      if (Bo && Bo.text.join("\n") == t) {
        if (n.ranges.length % Bo.text.length == 0) {
          a = [];
          for (var u = 0; u < Bo.text.length; u++)
            a.push(o.splitLines(Bo.text[u]));
        }
      } else
    ...
    for (var u = n.ranges.length - 1; u >= 0; u--) {
      ...
      c.empty() &&
        (r && r > 0
          ...
          ? (f = Fo(
              f.line,
              Math.min(Zn(o, f.line).text.length, f.ch + Di(s).length)
            ))
          : Bo &&
            Bo.lineWise &&
            Bo.text.join("\n") == t &&
          ...
          if (o.electricChars) {
            ...
            o.electricInput &&
              o.electricInput.test(
                Zn(e.doc, i.head.line).text.slice(0, i.head.ch)
              ) &&
              (l = Rr(e, i.head.line, "smart"));
  ...
  function ne() {
    ...
    return (
      xo ? (e.style.width = "1000px") : e.setAttribute("wrap", "off"),
  ...
  function ae(e, t, r) {
        ...
        for (var o = 0 > i ? u.map : c[i], l = 0; l < o.length; l += 3) {
          ...
          if (s == t || s == r) {
            var a = ti(0 > i ? e.line : e.rest[i]),
              h = o[l] + n;
            return (0 > n || s != t) && (h = o[l + (n ? 1 : 0)]), Fo(a, h);
          }
        }
    }
    var i = e.text.firstChild,
      o = !1;
    if (!t || !_l(i, t)) return le(Fo(ti(e.line), 0), !0);
    ...
    if (h) return le(h, o);
    for (
      var f = a.nextSibling, d = s ? s.nodeValue.length - r : 0;
      f;
      f = f.nextSibling
    ) {
      if ((h = n(f, f.firstChild, 0))) return le(Fo(h.line, h.ch - d), o);
      d += f.textContent.length;
    }
    for (var p = a.previousSibling, d = r; p; p = p.previousSibling) {
      if ((h = n(p, p.firstChild, -1))) return le(Fo(h.line, h.ch + d), o);
      d += f.textContent.length;
    }
  }
  function ue(e, t, r, n, i) {
    ...
    function l(t) {
      if (1 == t.nodeType) {
        ...
        if (h) {
          var f = e.findMarks(Fo(n, 0), Fo(i + 1, 0), o(+h));
          return void (
            f.length &&
            (c = f[0].find()) &&
            (s += Qn(e.doc, c.from, c.to).join(u))
          );
        }
    ...
    for (var s = "", a = !1, u = e.doc.lineSeparator(); l(t), t != r; )
      t = t.nextSibling;
    return s;
  }
  function ce(e, t) {
  ...
  function ge(e, t) {
    ...
    return t.line > r
      ? Fo(r, Zn(e, r).text.length)
      : ve(t, Zn(e, t.line).text.length);
  }
  function ve(e, t) {
    var r = e.ch;
  ...
  function be(e, t, r, n) {
    if ((e.cm && e.cm.display.shift) || e.extend) {
      ...
      if (n) {
        var o = Ro(r, i) < 0;
        o != Ro(n, i) < 0 ? ((i = r), (r = n)) : o != Ro(r, n) < 0 && (r = n);
      }
      return new he(i, r);
    }
    return new he(n || r, r);
  ...
  function Le(e, t, r) {
    ...
    return (
      Hl(e, "beforeSelectionChange", e, n),
      e.cm && Hl(e.cm, "beforeSelectionChange", e.cm, n),
  ...
  function Me(e, t, r) {
    ...
    var n =
      (r && r.bias) ||
      (Ro(t.primary().head, e.sel.primary().head) < 0 ? -1 : 1);
  ...
  function Ne(e, t) {
    t.equals(e.sel) ||
      ((e.sel = t),
      e.cm &&
        ((e.cm.curOp.updateInput = e.cm.curOp.selectionChanged = !0), Mi(e.cm)),
      Li(e, "cursorActivity", e));
  }
  function We(e) {
    Ne(e, Ae(e, e.sel, null, !1), zl);
  }
  function Ae(e, t, r, n) {
    for (var i, o = 0; o < t.ranges.length; o++) {
      ...
      (i || a != l.anchor || u != l.head) &&
        (i || (i = t.ranges.slice(0, o)), (i[o] = new he(a, u)));
    }
    ...
    if (o.markedSpans)
      for (var l = 0; l < o.markedSpans.length; ++l) {
        ...
        if (
          ...
          if (i && (Hl(a, "beforeCursorEnter"), a.explicitlyCleared)) {
            if (o.markedSpans) {
              --l;
              continue;
            }
          ...
          if (r) {
            var u,
              c = a.find(0 > n ? 1 : -1);
            if (
              ((0 > n ? a.inclusiveRight : a.inclusiveLeft) &&
                (c = He(e, c, -n, c && c.line == t.line ? o : null)),
              c &&
                c.line == t.line &&
                (u = Ro(c, r)) &&
                (0 > n ? 0 > u : u > 0))
          ...
          return (
            (0 > n ? a.inclusiveLeft : a.inclusiveRight) &&
              (h = He(e, h, n, h.line == t.line ? o : null)),
            h ? Oe(e, h, t, n, i) : null
          );
        }
      }
  ...
  function He(e, t, r, n) {
    return 0 > r && 0 == t.ch
      ? t.line > e.first
        ? ge(e, Fo(t.line - 1))
        : null
      : r > 0 && t.ch == (n || Zn(e, t.line)).text.length
      ? t.line < e.first + e.size - 1
        ? Fo(t.line + 1, 0)
        : null
      : new Fo(t.line, t.ch + r);
  }
  function Pe(e) {
  ...
  function Ie(e, t, r) {
    ...
    if (
      ...
      var o = r.appendChild(
        Ui("div", " ", "CodeMirror-cursor CodeMirror-secondarycursor")
      );
      (o.style.display = ""),
  ...
  function ze(e, t, r) {
    ...
    function i(t, r, i) {
      ...
      var s,
        ...
        f = h.text.length;
      return (
        eo(ii(h), r || 0, null == i ? f : i, function (e, t, l) {
          var h,
            d,
            p,
            g = o(e, "left");
          ...
          null == r && 0 == e && (d = u),
            ...
            (!a ||
              h.bottom > a.bottom ||
              (h.bottom == a.bottom && h.right > a.right)) &&
              (a = h),
            u + 1 > d && (d = u),
  ...
  function Re(e, t) {
    e.doc.mode.startState &&
      ...
      e.state.highlight.set(t, Fi(Be, e));
  }
  function Be(e) {
    var t = e.doc;
    if (
        ...
        function (o) {
          if (t.frontier >= e.display.viewFrom) {
            ...
            for (
              ...
              h = l[f] != o.styles[f];
            h && i.push(t.frontier), (o.stateAfter = s ? n : al(t.mode, n));
          } else
            o.text.length <= e.options.maxHighlightLength && In(e, o.text, n),
              (o.stateAfter = t.frontier % 5 == 0 ? al(t.mode, n) : null);
          return (
            ++t.frontier,
            +new Date() > r ? (Re(e, e.options.workDelay), !0) : void 0
          );
        }
      ),
        i.length &&
  ...
  function Ge(e, t, r) {
    for (
      ...
      var u = Bl(a.text, null, e.options.tabSize);
  ...
  function et(e, t) {
    ...
    n && !n.text
      ? (n = null)
      : n && n.changes && (E(e, n, r, H(e)), (e.curOp.forceUpdate = !0)),
      n || (n = Ze(e, t));
    var i = $e(n, t, r);
    return {
      line: t,
    ...
    return (
      t.cache.hasOwnProperty(l)
        ...
        : (t.rect || (t.rect = t.view.text.getBoundingClientRect()),
          t.hasHeights || (qe(e, t.view, t.rect), (t.hasHeights = !0)),
          (o = nt(e, t, r, n)),
          o.bogus || (t.cache[l] = o)),
      {
        left: o.left,
    ...
    if (3 == l.nodeType) {
      for (var c = 0; 4 > c; c++) {
        ...
        for (
          ...
          Gi(t.line.text.charAt(o.coverStart + a));

        )
          ++a;
        if (bo && 9 > wo && 0 == s && a == o.coverEnd - o.coverStart)
          i = l.parentNode.getBoundingClientRect();
        else if (bo && e.options.lineWrapping) {
          var h = Kl(l, s, a).getClientRects();
          i = h.length ? h["right" == n ? h.length - 1 : 0] : Ko;
        } else i = Kl(l, s, a).getBoundingClientRect() || Ko;
  ...
  function ct(e, t, r, n) {
    ...
    var l = ni(t);
    if (
      ("local" == n ? (l += Ve(e.display)) : (l -= e.display.viewOffset),
      "page" == n || "window" == n)
    ) {
  ...
  function dt(e, t, r, n, i, o) {
    ...
    function s(e, t) {
      var r = a[t],
        n = r.level % 2;
      return (
        e == to(r) && t && r.level < a[t - 1].level
          ? ((r = a[--t]), (e = ro(r) - (r.level % 2 ? 0 : 1)), (n = !0))
          : e == ro(r) &&
            t < a.length - 1 &&
            r.level < a[t + 1].level &&
            ((r = a[++t]), (e = to(r) - (r.level % 2)), (n = !1)),
    ...
    var c = uo(a, u),
      h = s(u, c);
    return null != ls && (h.other = s(u, ls)), h;
  }
  function pt(e, t) {
    var r = 0,
      t = ge(e.doc, t);
  ...
  function mt(e, t, r, n, i) {
    ...
    for (;;) {
      if (c ? d == f || d == ho(t, f, 1) : 1 >= d - f) {
        for (
          var y = p > n || v - n >= n - p ? f : d, b = n - (y == f ? p : v);
          Gi(t.text.charAt(y));
  ...
  function yt(e) {
    ...
    if (null == Go) {
      Go = Ui("pre");
      for (var t = 0; 49 > t; ++t)
        Go.appendChild(document.createTextNode("x")), Go.appendChild(Ui("br"));
      Go.appendChild(document.createTextNode("x"));
    }
    Ki(e.measure, Go);
    var r = Go.offsetHeight / 50;
  ...
  function wt(e) {
    (e.curOp = {
      ...
      jo
        ? jo.ops.push(e.curOp)
        : (e.curOp.ownsGroup = jo = { ops: [e.curOp], delayedCallbacks: [] });
  }
  function xt(e) {
  ...
  function kt(e) {
    ...
    e.updatedDisplay && O(t),
      ...
      r.maxLineChanged &&
        ...
        ((e.adjustWidthTo = Qe(t, r.maxLine, r.maxLine.text.length).left + 3),
        (t.display.sizerWidth = e.adjustWidthTo),
        (e.barMeasure.scrollWidth = Math.max(
          r.scroller.clientWidth,
          r.sizer.offsetLeft + e.adjustWidthTo + Xe(t) + t.display.barWidth
        )),
        (e.maxScrollLeft = Math.max(
          0,
          r.sizer.offsetLeft + e.adjustWidthTo - Ye(t)
        ))),
  ...
  function Mt(e) {
    ...
    var r =
      e.focus && e.focus == ji() && (!document.hasFocus || document.hasFocus());
    e.preparedSelection &&
  ...
  function Nt(e) {
    ...
    if (
      ...
      var i = Hr(
        t,
        ge(n, e.scrollToPos.from),
        ge(n, e.scrollToPos.to),
    ...
    if (o)
      for (var s = 0; s < o.length; ++s) o[s].lines.length || Hl(o[s], "hide");
    if (l)
      for (var s = 0; s < l.length; ++s)
        l[s].lines.length && Hl(l[s], "unhide");
    r.wrapper.offsetHeight && (n.scrollTop = t.display.scroller.scrollTop),
      e.changeObjs && Hl(t, "changes", t, e.changeObjs),
  ...
  function Ht(e, t, r) {
    (this.line = t),
      (this.rest = bn(t)),
      (this.size = this.rest ? ti(Di(this.rest)) - r + 1 : 1),
  ...
  function Et(e, t, r, n) {
    ...
    if (
      ...
      zo && wn(e.doc, t) < i.viewTo && zt(e);
    else if (r <= i.viewFrom)
      zo && xn(e.doc, r + n) > i.viewFrom
        ? zt(e)
  ...
  function Bt(e, t, r) {
    ...
    0 == i.length || t >= n.viewTo || r <= n.viewFrom
      ? ((n.view = Pt(e, t, r)), (n.viewFrom = t))
      : (n.viewFrom > t
          ? (n.view = Pt(e, t, n.viewFrom).concat(n.view))
          : n.viewFrom < t && (n.view = n.view.slice(Ft(e, t))),
        (n.viewFrom = t),
        n.viewTo < r
          ? (n.view = n.view.concat(Pt(e, n.viewTo, r)))
          : n.viewTo > r && (n.view = n.view.slice(0, Ft(e, r)))),
      (n.viewTo = r);
  }
  function Gt(e) {
  ...
  function Ut(e) {
    ...
    var i = e.display;
    Al(i.scroller, "mousedown", At(e, Yt)),
      bo && 11 > wo
        ? Al(
            i.scroller,
            "dblclick",
    ...
    Al(i.scroller, "touchstart", function (t) {
      ...
      Al(i.scroller, "touchend", function (r) {
        var o = i.activeTouch;
        if (
          o &&
          !jt(i, r) &&
          ...
          (l =
            !o.prev || n(o, o.prev)
              ...
              ? e.findWordAt(s)
              : new he(Fo(s.line, 0), ge(e.doc, Fo(s.line + 1, 0)))),
    ...
    Al(s, "keyup", function (t) {
      dr.call(e, t);
    }),
      Al(s, "keydown", At(e, hr)),
      Al(s, "keypress", At(e, pr)),
      Al(s, "focus", Fi(vr, e)),
      Al(s, "blur", Fi(mr, e));
  }
  function Vt(t, r, n) {
  ...
  function Xt(e, t, r, n) {
    ...
    if (n && 1 == u.xRel && (a = Zn(e.doc, u.line).text).length == u.ch) {
      var c = Bl(a, a.length, e.options.tabSize) - a.length;
      u = Fo(
        u.line,
        Math.max(0, Math.round((o - je(e.display).left) / bt(e.display)) - c)
      );
    }
    return u;
  }
        ...
        switch ((window.focus(), Ci(e))) {
          case 1:
            t.state.selectingText
              ...
              : n
              ? _t(t, e, n)
              : xi(e) == r.scroller && Ml(e);
            break;
          case 2:
            xo && (t.state.lastMiddleDown = +new Date()),
              n && we(t.doc, n),
              setTimeout(function () {
                r.input.focus();
              }, 20),
  ...
  function _t(e, t, r) {
    bo ? setTimeout(Fi($, e), 0) : (e.curOp.focus = ji());
    var n,
      i = +new Date();
    Vo && Vo.time > i - 400 && 0 == Ro(Vo.pos, r)
      ? (n = "triple")
      : Uo && Uo.time > i - 400 && 0 == Ro(Uo.pos, r)
      ? ((n = "double"), (Vo = { time: i, pos: r }))
      : ((n = "single"), (Uo = { time: i, pos: r }));
    var o,
      l = e.doc.sel,
    ...
    "single" == n &&
    (o = l.contains(r)) > -1 &&
    (Ro((o = l.ranges[o]).from(), r) < 0 || r.xRel > 0) &&
    (Ro(o.to(), r) > 0 || r.xRel < 0)
      ? qt(e, t, r, s)
      : $t(e, t, r, n, s);
  }
  function qt(e, t, r, n) {
  ...
  function $t(e, t, r, n, i) {
      ...
      if (0 != Ro(v, t))
        if (((v = t), "rect" == n)) {
          for (
            var i = [],
              o = e.options.tabSize,
              l = Bl(Zn(u, r.line).text, r.ch, o),
              s = Bl(Zn(u, t.line).text, t.ch, o),
              a = Math.min(l, s),
              d = Math.max(l, s),
            ...
            var m = Zn(u, p).text,
              y = Gl(m, a, o);
            a == d
              ? i.push(new he(Fo(p, y), Fo(p, y)))
              : m.length > y && i.push(new he(Fo(p, y), Fo(p, Gl(m, d, o))));
          }
          ...
          if ("single" != n) {
            ...
            else var C = new he(Fo(t.line, 0), ge(u, Fo(t.line + 1, 0)));
            Ro(C.anchor, w) > 0
              ? ((x = C.head), (w = q(b.from(), C.anchor)))
              : ((x = C.anchor), (w = _(b.to(), C.head)));
          }
          var i = f.ranges.slice(0);
          (i[h] = new he(ge(u, w), x)), ke(u, fe(i, h), Fl);
        }
    }
    function l(t) {
      var r = ++y,
    ...
    if (
      (i && !t.shiftKey
        ? ((h = u.sel.contains(r)), (c = h > -1 ? d[h] : new he(r, r)))
        : ((c = u.sel.primary()), (h = u.sel.primIndex)),
      Oo ? t.shiftKey && t.metaKey : t.altKey)
    )
      (n = "rect"), i || (c = new he(r, r)), (r = Xt(e, t, !0, !0)), (h = -1);
    else if ("double" == n) {
      var p = e.findWordAt(r);
      c = e.display.shift || u.extend ? be(u, c, p.anchor, p.head) : p;
    } else if ("triple" == n) {
      var g = new he(Fo(r.line, 0), ge(u, Fo(r.line + 1, 0)));
      c = e.display.shift || u.extend ? be(u, c, g.anchor, g.head) : g;
    } else c = be(u, c, r);
    i
      ? -1 == h
        ? ((h = d.length),
          ke(u, fe(d.concat([c]), h), { scroll: !1, origin: "*mouse" }))
        : d.length > 1 && d[h].empty() && "single" == n && !t.shiftKey
        ? (ke(u, fe(d.slice(0, h).concat(d.slice(h + 1)), 0), {
            scroll: !1,
            origin: "*mouse",
          }),
          (f = u.sel))
        : Ce(u, h, c, Fl)
      : ((h = 0), ke(u, new ce([c], 0), Fl), (f = u.sel));
    var v = r,
    ...
    (e.state.selectingText = x),
      Al(document, "mousemove", b),
      Al(document, "mouseup", x);
  }
  function Zt(e, t, r, n) {
    try {
      var i = t.clientX,
      ...
      if (r && !t.isReadOnly())
        if (n && n.length && window.FileReader && window.File)
            ...
            var i = n.length,
              ...
              s = function (e, n) {
                if (
                  ...
                  -1 != Hi(t.options.allowDropFileTypes, e.type)
                ) {
          ...
          try {
            ...
            if (o) {
              if (t.state.draggingText && !(Ao ? e.altKey : e.ctrlKey))
                var u = t.listSelections();
              if ((Me(t.doc, de(r, r)), u))
                for (var a = 0; a < u.length; ++a)
                  Or(t.doc, "", u[a].anchor, u[a].head, "drag");
  ...
  function er(e, t) {
    if (bo && (!e.state.draggingText || +new Date() - Yo < 100))
      return void Wl(t);
    if (
      !ki(e, t) &&
      !jt(e.display, t) &&
      ...
      t.dataTransfer.setDragImage && !To)
    ) {
        ...
        return (
          i &&
            ...
            nr(
              ...
              Math.max(
                0,
                Math.min(l.scrollTop + i * qo, l.scrollHeight - l.clientHeight)
              )
            ),
          ir(
            e,
            Math.max(
              0,
              Math.min(l.scrollLeft + n * qo, l.scrollWidth - l.clientWidth)
            )
          ),
          (!i || (i && a)) && Ml(t),
  ...
  function sr(e, t, r) {
    for (var n = 0; n < e.state.keyMaps.length; n++) {
      var i = fl(t, e.state.keyMaps[n], r, e);
      if (i) return i;
    }
    return (
      (e.options.extraKeys && fl(t, e.options.extraKeys, r, e)) ||
      fl(t, e.options.keyMap, r, e)
    );
  }
  function ar(e, t, r, n) {
    ...
    return (
      ...
      "handled" == o && Li(e, "keyHandled", e, t, r),
      ("handled" != o && "multi" != o) || (Ml(r), Fe(e)),
      i && !o && /\'$/.test(t) ? (Ml(r), !0) : !!o
    );
  }
  function ur(e, t) {
  ...
  function fr(e) {
    function t(e) {
      (18 != e.keyCode && e.altKey) ||
        (Zl(r, "CodeMirror-crosshair"),
        Dl(document, "keyup", t),
        Dl(document, "mouseover", t));
    }
    var r = e.display.lineDiv;
    Ql(r, "CodeMirror-crosshair"),
      Al(document, "keyup", t),
  ...
  function pr(e) {
    ...
    if (
      ...
      var r = e.keyCode,
        n = e.charCode;
      if (Lo && r == Qo) return (Qo = null), void Ml(e);
    ...
    e.state.delayingBlurEvent && (e.state.delayingBlurEvent = !1),
      "nocursor" != e.options.readOnly &&
        (e.state.focused ||
          (Hl(e, "focus", e),
          (e.state.focused = !0),
          Ql(e.display.wrapper, "CodeMirror-focused"),
          e.curOp ||
  ...
  function wr(e, t) {
    if (Ro(e, t.from) < 0) return e;
    if (Ro(e, t.to) <= 0) return Jo(t);
  ...
  function Cr(e, t, r) {
    return e.line == t.line
      ? Fo(r.line, e.ch - t.ch + r.ch)
      : Fo(r.line + (e.line - t.line), e.ch);
  }
  function Sr(e, t, r) {
    for (var n = [], i = Fo(e.first, 0), o = i, l = 0; l < t.length; l++) {
      var s = t[l],
        a = Cr(s.from, i, o),
        u = Cr(Jo(s), i, o);
      if (((i = s.to), (o = u), "around" == r)) {
        var c = e.sel.ranges[l],
          h = Ro(c.head, c.anchor) < 0;
  ...
  function Lr(e, t, r) {
    ...
    return (
      ...
      Hl(e, "beforeChange", e, n),
      e.cm && Hl(e.cm, "beforeChange", e.cm, n),
      n.canceled
        ? null
  ...
  function Tr(e, t, r) {
    ...
    if (
      ...
      var n = Io && !r && an(e, t.from, t.to);
      if (n)
        for (var i = n.length - 1; i >= 0; --i)
          kr(e, { from: n[i].from, to: n[i].to, text: i ? [""] : t.text });
      else kr(e, t);
    }
  }
  function kr(e, t) {
    if (1 != t.text.length || "" != t.text[0] || 0 != Ro(t.from, t.to)) {
      var r = xr(e, t);
      ui(e, t, r, e.cm ? e.cm.curOp.id : NaN), Wr(e, t, r, on(e, t));
      var n = [];
      qn(e, function (e, r) {
        r || -1 != Hi(n, e.history) || (bi(e.history, t), n.push(e.history)),
          Wr(e, t, null, on(e, t));
      });
    }
  }
    ...
    if (!e.cm || !e.cm.state.suppressEdits) {
      ...
      if (a != l.length) {
        for (i.lastOrigin = i.lastSelOrigin = null; (n = l.pop()), n.ranges; ) {
          if ((fi(n, s), r && !n.equals(e.sel)))
            return void ke(e, n, { clearRedo: !1 });
          o = n;
        }
        var u = [];
        fi(o, s),
        ...
        for (
          var c = Ni(e, "beforeChange") || (e.cm && Ni(e.cm, "beforeChange")),
          ...
          var f = a ? xr(e, h) : Di(l);
          Wr(e, h, f, sn(e, h)),
            !a && e.cm && e.cm.scrollIntoView({ from: h.from, to: Jo(h) });
          var d = [];
          qn(e, function (e, t) {
            t ||
              -1 != Hi(d, e.history) ||
              (bi(e.history, h), d.push(e.history)),
              Wr(e, h, null, sn(e, h));
          });
        }
      }
  ...
  function Nr(e, t) {
    if (
      ...
      ((e.first += t),
      (e.sel = new ce(
        Pi(e.sel.ranges, function (e) {
          return new he(
            Fo(e.anchor.line + t, e.anchor.ch),
            Fo(e.head.line + t, e.head.ch)
          );
        }),
        e.sel.primIndex
      )),
  ...
  function Wr(e, t, r, n) {
    ...
    if (t.to.line < e.first)
      return void Nr(e, t.text.length - 1 - (t.to.line - t.from.line));
    if (!(t.from.line > e.lastLine())) {
      ...
      t.to.line > o &&
        ...
        (t.removed = Qn(e, t.from, t.to)),
        r || (r = xr(e, t)),
        e.cm ? Ar(e.cm, t, n) : Xn(e, t, n),
        Me(e, r, zl);
    }
  }
  function Ar(e, t, r) {
    ...
    e.options.lineWrapping ||
      ...
      n.sel.contains(t.from, t.to) > -1 && Mi(e),
      Xn(n, t, r, o(e)),
      e.options.lineWrapping ||
    ...
    t.full
      ? Et(e)
      : l.line != s.line || 1 != t.text.length || jn(e.doc, t)
      ? Et(e, l.line, s.line + 1, c)
      : It(e, l.line, "text");
    var f = Ni(e, "changes"),
      d = Ni(e, "change");
    if (d || f) {
  ...
  function Or(e, t, r, n, i) {
    ...
    "string" == typeof t && (t = e.splitLines(t)),
      Tr(e, { from: r, to: n, text: t, origin: i });
  }
  function Dr(e, t) {
      ...
      if (
        ...
        var o = Ui(
          ...
          "position: absolute; top: " +
            (t.top - r.viewOffset - Ve(e.display)) +
            "px; height: " +
            (t.bottom - t.top + Xe(e) + r.barHeight) +
            "px; left: " +
            t.left +
            "px; width: 2px;"
        );
  ...
  function Hr(e, t, r, n) {
    ...
    for (var i = 0; 5 > i; i++) {
      ...
      if (
        (null != a.scrollTop &&
          (nr(e, a.scrollTop), Math.abs(e.doc.scrollTop - u) > 1 && (o = !0)),
        null != a.scrollLeft &&
          (ir(e, a.scrollLeft), Math.abs(e.doc.scrollLeft - c) > 1 && (o = !0)),
        !o)
      )
        break;
    }
  ...
  function Pr(e, t, r, n, i) {
    var o = Er(e, t, r, n, i);
    null != o.scrollTop && nr(e, o.scrollTop),
      null != o.scrollLeft && ir(e, o.scrollLeft);
  }
  ...
  function Rr(e, t, r, n) {
    ...
    "prev" == r
      ? (u = t > o.first ? Bl(Zn(o, t - 1).text, null, l) : 0)
      : "add" == r
    ...
    if ((u > f && (h += Oi(u - f)), h != c))
      return (
        Or(o, h, Fo(t, 0), Fo(t, c.length), "+input"), (s.stateAfter = null), !0
      );
  ...
  function Br(e, t, r, n) {
    var i = t,
      o = t;
    return (
      "number" == typeof t ? (o = Zn(e, pe(e, t))) : (i = ti(t)),
      null == i ? null : (n(o, i) && e.cm && It(e.cm, i, r), o)
    );
  }
  function Gr(e, t) {
    for (var r = e.doc.sel.ranges, n = [], i = 0; i < r.length; i++) {
      for (var o = t(r[i]); n.length && Ro(o.from, Di(n).to) <= 0; ) {
        var l = n.pop();
        if (Ro(l.from, o.from) < 0) {
          o.from = l.from;
          break;
        }
      }
    ...
    Wt(e, function () {
      for (var t = n.length - 1; t >= 0; t--)
        Or(e.doc, "", n[t].from, n[t].to, "+delete");
      zr(e);
    });
  }
  function Ur(e, t, r, n, i) {
    ...
    var m = De(e, Fo(s, a), t, u, !0);
    return Ro(t, m) || (m.hitSide = !0), m;
  }
  function Vr(e, t, r, n) {
    var i,
      o = e.doc,
    ...
    if ("page" == n) {
      ...
      i = t.top + r * (s - (0 > r ? 1.5 : 0.5) * yt(e.display));
  ...
  function Yr(e, t, r, n, i) {
    ...
    var o = new ml(e, i),
      l = Ro(t, r);
    if ((n && zi(n, o, !1), l > 0 || (0 == l && o.clearWhenEmpty !== !1)))
      return o;
    if (
      (o.replacedWith &&
        ((o.collapsed = !0),
        (o.widgetNode = Ui("span", [o.replacedWith], "CodeMirror-widget")),
        n.handleMouseEvents ||
      ...
      if (
        mn(e, t.line, t, r, o) ||
        (t.line != r.line && mn(e, r.line, t, r, o))
      )
        throw new Error(
    ...
    if (
      (e.iter(a, r.line + 1, function (e) {
        u &&
          ...
          yn(e) == u.display.maxLine &&
          (s = !0),
          o.collapsed && a != t.line && ei(e, 0),
          tn(
            e,
            new Qr(o, a == t.line ? t.ch : null, a == r.line ? r.ch : null)
          ),
          ++a;
      }),
      o.collapsed &&
    ...
    if (e)
      for (var n, i = 0; i < e.length; ++i) {
        ...
        if (
          ...
          (n || (n = [])).push(
            new Qr(l, a ? null : o.from - t, null == o.to ? null : o.to - t)
          );
        }
      }
    return n;
  ...
  function on(e, t) {
    ...
    if (!u) {
      ...
      if (v > 0 && s)
        for (var h = 0; h < s.length; ++h)
          null == s[h].to &&
            (g || (g = [])).push(new Qr(s[h].marker, null, null));
  ...
  function an(e, t, r) {
    ...
    for (var i = [{ from: t, to: r }], o = 0; o < n.length; ++o)
      for (var l = n[o], s = l.find(0), a = 0; a < i.length; ++a) {
        var u = i[a];
        if (!(Ro(u.to, s.from) < 0 || Ro(u.from, s.to) > 0)) {
          var c = [a, 1],
            h = Ro(u.from, s.from),
            f = Ro(u.to, s.to);
          (0 > h || (!l.inclusiveLeft && !h)) &&
  ...
  function dn(e, t) {
    ...
    var n = e.find(),
      i = t.find(),
      o = Ro(n.from, i.from) || hn(e) - hn(t);
    if (o) return -o;
    var l = Ro(n.to, i.to) || fn(e) - fn(t);
      ...
      for (var s = 0; s < l.length; ++s) {
        ...
        if (a.marker.collapsed) {
          var u = a.marker.find(0),
            c = Ro(u.from, r) || hn(a.marker) - hn(i),
            h = Ro(u.to, n) || fn(a.marker) - fn(i);
          if (
            !((c >= 0 && 0 >= h) || (0 >= c && h >= 0)) &&
            ((0 >= c &&
  ...
  function Ln(e, t, r) {
    ni(t) < ((e.curOp && e.curOp.scrollTop) || e.doc.scrollTop) &&
      Ir(e, null, r);
  }
  function Tn(e) {
    ...
    if (!_l(document.body, e.node)) {
      ...
      e.coverGutter &&
        ...
        Ki(t.display.measure, Ui("div", [e.node], null, r));
    }
  ...
  function Dn(e, t, r, n) {
    ...
    var a,
      u = Zn(l, t.line),
      c = Ue(e, t.line, r),
      h = new gl(u.text, e.options.tabSize);
    for (n && (a = []); (n || h.pos < t.ch) && !h.eol(); )
      (h.start = h.pos), (o = On(s, h, c)), n && a.push(i(!0));
    return n ? a : i();
  }
    ...
    if (!t.styles || t.styles[0] != e.state.modeGen) {
      var n = Ue(e, ti(t)),
        i = Pn(
          e,
          t,
          t.text.length > e.options.maxHighlightLength ? al(e.doc.mode, n) : n
        );
      (t.stateAfter = n),
        (t.styles = i.styles),
        i.classes
  ...
  function In(e, t, r, n) {
    var i = e.doc.mode,
      o = new gl(t, e.options.tabSize);
    for (o.start = o.pos = n || 0, "" == t && An(i, r); !o.eol(); )
      On(i, o, r), (o.start = o.pos);
  }
  function zn(e, t) {
    if (!e || /^\s*$/.test(e)) return null;
    var r = t.addModeClass ? Cl : xl;
  ...
  function Fn(e, t) {
    ...
    for (var i = 0; i <= (t.rest ? t.rest.length : 0); i++) {
      ...
      (n.pos = 0),
        (n.addToken = Bn),
        Qi(e.display.measure) &&
          (o = ii(l)) &&
          (n.addToken = Un(n.addToken, o)),
        (n.map = []);
      var s = t != e.display.externalMeasured && ti(l);
      Kn(l, n, En(e, l, s)),
        l.styleClasses &&
          (l.styleClasses.bgClass &&
            (n.bgClass = Yi(l.styleClasses.bgClass, n.bgClass || "")),
          l.styleClasses.textClass &&
            (n.textClass = Yi(l.styleClasses.textClass, n.textClass || ""))),
        0 == n.map.length &&
          n.map.push(0, 0, n.content.appendChild(Zi(e.display.measure))),
        0 == i
    ...
    return (
      Hl(e, "renderLine", e, t.line, n.pre),
      n.pre.className && (n.textClass = Yi(n.pre.className, n.textClass || "")),
      n
    );
  }
  function Rn(e) {
      ...
      if (a.test(t))
        for (var c = document.createDocumentFragment(), h = 0; ; ) {
          ...
          if (d) {
            ...
            bo && 9 > wo ? c.appendChild(Ui("span", [p])) : c.appendChild(p),
  ...
  function Kn(e, t, r) {
    ...
    if (n)
          ...
          for (var y, b = [], w = 0; w < n.length; ++w) {
            ...
            "bookmark" == C.type && x.from == p && C.widgetNode
              ...
              ? (null != x.to &&
                ...
                C.endStyle &&
                  x.to == m &&
                  (y || (y = [])).push(C.endStyle, x.to),
                C.title && !h && (h = C.title),
                C.collapsed && (!f || dn(f.marker, C) < 0) && (f = x))
      ...
      for (var g = 1; g < r.length; g += 2)
        t.addToken(t, i.slice(o, (o = r[g])), zn(r[g + 1], t.cm.options));
  }
  function jn(e, t) {
    return (
      0 == t.from.ch &&
  ...
  function Xn(e, t, r, n) {
    ...
    function l(e, t) {
      for (var r = e, o = []; t > r; ++r) o.push(new wl(u[r], i(r), n));
      return o;
    }
    var s = t.from,
      a = t.to,
    ...
    if (t.full)
      ...
      if (1 == u.length)
        ...
        g.push(new wl(f + c.text.slice(a.ch), d, n)),
  ...
  function ti(e) {
    ...
    for (
      var t = e.parent, r = Hi(t.lines, e), n = t.parent;
      n;
      t = n, n = n.parent
    )
  ...
  function li(e, t) {
    var r = { from: Y(t.from), to: Jo(t), text: Qn(e, t.from, t.to) };
    return (
  ...
  function ai(e, t) {
    return t
      ? (si(e.done), Di(e.done))
      : e.done.length && !Di(e.done).ranges
      ? Di(e.done)
      : e.done.length > 1 && !e.done[e.done.length - 2].ranges
      ? (e.done.pop(), Di(e.done))
      : void 0;
  }
  function ui(e, t, r, n) {
    var i = e.history;
    ...
    if (
      ...
      var s = Di(o.changes);
      0 == Ro(t.from, t.to) && 0 == Ro(t.from, s.to)
        ? (s.to = Jo(t))
        : o.changes.push(li(e, t));
    } else {
      var a = Di(i.done);
      for (
        (a && a.ranges) || fi(e.sel, i.done),
          o = { changes: [li(e, t)], generation: i.generation },
          i.done.push(o);
    ...
    for (var i = 0; i < e.length; ++i) {
      ...
      if (o.ranges) {
        ...
        for (var s = 0; s < o.ranges.length; s++)
          mi(o.ranges[s].anchor, t, r, n), mi(o.ranges[s].head, t, r, n);
      } else {
        for (var s = 0; s < o.changes.length; ++s) {
          var a = o.changes[s];
          if (r < a.from.line)
            (a.from = Fo(a.from.line + n, a.from.ch)),
              (a.to = Fo(a.to.line + n, a.to.ch));
          else if (t <= a.to.line) {
            l = !1;
            break;
          }
    ...
    return (
      null == t &&
        (1 & e.button
          ...
          ? (t = 3)
          : 4 & e.button && (t = 2)),
      Ao && e.ctrlKey && 1 == t && (t = 3),
      t
    );
  }
  function Si(e, t, r) {
    var n = e._handlers && e._handlers[t];
    return r ? (n && n.length > 0 ? n.slice() : Ol) : n || Ol;
  }
  function Li(e, t) {
    function r(e) {
      return function () {
    ...
    if (n.length) {
      ...
      jo
        ? (i = jo.delayedCallbacks)
        : Pl
        ? (i = Pl)
        : ((i = Pl = []), setTimeout(Ti, 0));
  ...
  function Ri(e, t) {
    return t ? (t.source.indexOf("\\w") > -1 && Xl(e) ? !0 : t.test(e)) : Xl(e);
  }
  function Bi(e) {
  ...
  function Zi(e) {
    if (null == ql) {
      var t = Ui("span", "​");
      Ki(e, Ui("span", [t, document.createTextNode("x")])),
        0 != e.firstChild.offsetHeight &&
          (ql = t.offsetWidth <= 1 && t.offsetHeight > 2 && !(bo && 8 > wo));
    }
    var r = ql
      ? Ui("span", "​")
      : Ui(
  ...
  function Qi(e) {
    ...
    var t = Ki(e, document.createTextNode("AخA")),
      r = Kl(t, 0, 1).getBoundingClientRect();
    if (!r || r.left == r.right) return !1;
    var n = Kl(t, 1, 2).getBoundingClientRect();
  ...
  function Ji(e) {
    ...
    var t = Ki(e, Ui("span", "x")),
      ...
      n = Kl(t, 0, 1).getBoundingClientRect();
    return (is = Math.abs(r.left - n.left) > 1);
  }
  function eo(e, t, r, n) {
  ...
  function ho(e, t, r, n) {
    ...
    for (
      var o = uo(i, t), l = i[o], s = co(e, t, l.level % 2 ? -r : r, n);
      ;
  ...
  var po = navigator.userAgent,
    ...
    Wo =
      No || /Android|webOS|BlackBerry|Opera Mini|Opera Mobi|IEMobile/i.test(po),
    Ao = No || /Mac/.test(go),
    Oo = /\bCrOS\b/.test(po),
    Do = /win/i.test(go),
    Ho = Lo && po.match(/Version\/(\d*\.\d*)/);
  Ho && (Ho = Number(Ho[1])), Ho && Ho >= 15 && ((Lo = !1), (xo = !0));
  var Po = Ao && (Co || (Lo && (null == Ho || 12.11 > Ho))),
    Eo = vo || (bo && wo >= 9),
    Io = !1,
    zo = !1;
  (g.prototype = zi(
      ...
      zeroWidthHack: function () {
        ...
        (this.horiz.style.height = this.vert.style.width = e),
          (this.horiz.style.pointerEvents = this.vert.style.pointerEvents =
            "none"),
          (this.disableHoriz = new Ai()),
          (this.disableVert = new Ai());
      },
  ...
  (re.prototype = zi(
    {
      init: function (e) {
        function t(e) {
          if (!ki(n, e)) {
            if (n.somethingSelected())
              (Bo = { lineWise: !1, text: n.getSelections() }),
                r.inaccurateSelection &&
                  ((r.prevInput = ""),
                  (r.inaccurateSelection = !1),
                  (o.value = Bo.text.join("\n")),
                  Vl(o));
            else {
              if (!n.options.lineWiseCopyCut) return;
              var t = ee(n);
              (Bo = { lineWise: !0, text: t.text }),
                "cut" == e.type
                  ? n.setSelections(t.ranges, null, zl)
        ...
        e.wrapper.insertBefore(i, e.wrapper.firstChild),
          ...
          Al(o, "input", function () {
            bo && wo >= 9 && r.hasSelection && (r.hasSelection = null),
              r.poll();
          }),
      ...
      showSelection: function (e) {
        var t = this.cm,
          r = t.display;
        Ki(r.cursorDiv, e.cursors),
          Ki(r.selectionDiv, e.selection),
          null != e.teTop &&
        ...
        if (!this.contextMenuPending) {
          ...
          if (n.somethingSelected()) {
            ...
            (this.textarea.value = l),
              n.state.focused && Vl(this.textarea),
              bo && wo >= 9 && (this.hasSelection = l);
          } else
            e ||
              ((this.prevInput = this.textarea.value = ""),
              bo && wo >= 9 && (this.hasSelection = null));
      ...
      onContextMenu: function (e) {
        ...
        if (s && !Lo) {
          ...
          u && -1 == i.doc.sel.contains(s) && At(i, ke)(i.doc, de(s), zl);
          ...
          if (
            ((l.style.cssText =
              ...
              (bo ? "rgba(255, 255, 255, .05)" : "transparent") +
          ...
          if (
            ...
            Wl(e);
            var p = function () {
              Dl(window, "mouseup", p), setTimeout(r, 20);
            };
            Al(window, "mouseup", p);
    ...
    (ie.prototype = zi(
      {
            ...
            if (!ki(n, e)) {
              ...
              if (e.clipboardData && !No)
                e.preventDefault(),
                  ...
                  e.clipboardData.setData("text/plain", Bo.text.join("\n"));
              else {
                var r = ne(),
                  i = r.firstChild;
        ...
        showPrimarySelection: function () {
          ...
          if (
            ...
            if (i || o) {
              ...
              try {
                var c = Kl(i.node, i.offset, o.offset, o.node);
              } catch (h) {}
              c &&
                (!vo && this.cm.state.focused
                  ? (e.collapse(i.node, i.offset), c.collapsed || e.addRange(c))
                  : (e.removeAllRanges(), e.addRange(c)),
                s && null == e.anchorNode
                  ? e.addRange(s)
                  : vo && this.startGracePeriod()),
        ...
        showMultipleSelections: function (e) {
          Ki(this.cm.display.cursorDiv, e.cursors),
            Ki(this.cm.display.selectionDiv, e.selection);
        },
        ...
        pollContent: function () {
          ...
          var o;
          if (n.line == t.viewFrom || 0 == (o = Ft(e, n.line)))
          ...
          if (a == t.view.length - 1)
            ...
            var u = ti(t.view[a + 1].line) - 1,
              c = t.view[a + 1].node.previousSibling;
          for (
            var h = e.doc.splitLines(ue(e, s, c, l, u)),
              f = Qn(e.doc, Fo(l, 0), Fo(u, Zn(e.doc, u).text.length));
          ...
          var x = Fo(l, d),
            C = Fo(u, f.length ? Di(f).length - p : 0);
          return h.length > 1 || h[0] || Ro(x, C)
            ? (Or(e.doc, h, x, C, "+input"), !0)
            : void 0;
        },
        ensurePolled: function () {
        ...
        applyComposition: function (e) {
          this.cm.isReadOnly()
            ? At(this.cm, Et)(this.cm)
            : e.data &&
              e.data != e.startData &&
              At(this.cm, Z)(this.cm, e.data, 0, e.sel);
        },
    ...
    (e.inputStyles = { textarea: re, contenteditable: ie }),
    (ce.prototype = {
      primary: function () {
      ...
      equals: function (e) {
        ...
        for (var t = 0; t < this.ranges.length; t++) {
          var r = this.ranges[t],
            n = e.ranges[t];
          if (0 != Ro(r.anchor, n.anchor) || 0 != Ro(r.head, n.head)) return !1;
        }
        return !0;
      },
      deepCopy: function () {
      ...
      contains: function (e, t) {
        ...
        for (var r = 0; r < this.ranges.length; r++) {
          var n = this.ranges[r];
          if (Ro(t, n.from()) >= 0 && Ro(e, n.to()) <= 0) return r;
        }
        return -1;
      },
    }),
  ...
  var Go,
    ...
    _o = 0,
    qo = null;
  bo ? (qo = -0.53) : vo ? (qo = 15) : So ? (qo = -0.7) : To && (qo = -1 / 3);
  var $o = function (e) {
    var t = e.wheelDeltaX,
      r = e.wheelDeltaY;
    return (
    ...
    Jo = (e.changeEnd = function (e) {
      return e.text
        ? Fo(
            ...
            Di(e.text).length + (1 == e.text.length ? e.from.ch : 0)
          )
        : e.to;
    });
  (e.prototype = {
    ...
    setOption: function (e, t) {
      var r = this.options,
        n = r[e];
      (r[e] == t && "mode" != e) ||
        ((r[e] = t), tl.hasOwnProperty(e) && At(this, tl[e])(this, t, n));
    },
    ...
    removeOverlay: Ot(function (e) {
      for (var t = this.state.overlays, r = 0; r < t.length; ++r) {
        ...
        if (n == e || ("string" == typeof e && n.name == e))
          return t.splice(r, 1), this.state.modeGen++, void Et(this);
      }
    }),
    ...
    indentSelection: Ot(function (e) {
      for (var t = this.doc.sel.ranges, r = -1, n = 0; n < t.length; n++) {
        ...
        if (i.empty())
          i.head.line > r &&
            (Rr(this, i.head.line, e, !0),
            (r = i.head.line),
            n == this.doc.sel.primIndex && zr(this));
        else {
          var o = i.from(),
            l = i.to(),
            s = Math.max(r, o.line);
          ...
          0 == o.ch &&
            t.length == u.length &&
            u[n].from().ch > 0 &&
            Ce(this.doc, n, new he(o, u[n].to()), zl);
        }
      }
    }),
    ...
    getLineTokens: function (e, t) {
      return Dn(this, Fo(e), t, !0);
    },
    getTokenTypeAt: function (e) {
      e = ge(this.doc, e);
      var t,
        r = En(this, Zn(this.doc, e.line)),
        n = 0,
        i = (r.length - 1) / 2,
        o = e.ch;
      if (0 == o) t = r[2];
    ...
    getHelpers: function (e, t) {
      var r = [];
      if (!sl.hasOwnProperty(t)) return r;
      var n = sl[t],
        i = this.getModeAt(e);
    ...
    getStateAfter: function (e, t) {
      var r = this.doc;
      return (
        (e = pe(r, null == e ? r.first + r.size - 1 : e)), Ue(this, e + 1, t)
      );
    },
    ...
    lineAtHeight: function (e, t) {
      return (
        (e = ht(this, { top: e, left: 0 }, t || "page").top),
        ri(this.doc, e + this.display.viewOffset)
      );
    },
    heightAtLine: function (e, t) {
      ...
      return (
        ct(this, r, { top: 0, left: 0 }, t || "page").top +
        (n ? this.doc.height - ni(r) : 0)
      );
    },
      ...
      (t.style.top = l + "px"),
        ...
        "right" == i
          ...
          : ("left" == i
            ...
            (t.style.left = s + "px")),
        r && Pr(this, s, l, s + t.offsetWidth, l + t.offsetHeight);
    },
    ...
    findPosH: function (e, t, r, n) {
      ...
      0 > t && ((i = -1), (t = -t));
      for (
        var o = 0, l = ge(this.doc, e);
        t > o && ((l = Ur(this.doc, l, i, r, n)), !l.hitSide);
        ++o
      );
      return l;
    },
    moveH: Ot(function (e, t) {
      ...
      r.extendSelectionsBy(function (n) {
        return r.display.shift || r.doc.extend || n.empty()
          ? Ur(r.doc, n.head, e, t, r.options.rtlMoveVisually)
          : 0 > e
          ? n.from()
          : n.to();
      }, Rl);
      ...
      if (
        (n.extendSelectionsBy(function (l) {
          ...
          return (
            "page" == t &&
              l == n.sel.primary() &&
              Ir(r, null, ft(r, a, "div").top - s.top),
            a
          );
        }, Rl),
        i.length)
    ...
    findWordAt: function (e) {
      ...
      return new he(Fo(e.line, n), Fo(e.line, i));
    },
    toggleOverwrite: function (e) {
      (null != e && e == this.state.overwrite) ||
        ((this.state.overwrite = !this.state.overwrite)
          ? Ql(this.display.cursorDiv, "CodeMirror-overwrite")
          : Zl(this.display.cursorDiv, "CodeMirror-overwrite"),
        Hl(this, "overwriteToggle", this, this.state.overwrite));
    },
    hasFocus: function () {
    ...
    scrollIntoView: Ot(function (e, t) {
      if (
        (null == e
          ...
          : "number" == typeof e
          ? (e = { from: Fo(e, 0), to: null })
          : null == e.from && (e = { from: e, to: null }),
        e.to || (e.to = e.from),
        (e.margin = t || 0),
        null != e.from.line)
      )
        Fr(this), (this.curOp.scrollToPos = e);
      else {
        var r = Er(
          this,
    ...
    setSize: Ot(function (e, t) {
      ...
      null != e && (n.display.wrapper.style.width = r(e)),
        ...
        n.options.lineWrapping && lt(this);
    ...
    refresh: Ot(function () {
      ...
      Et(this),
        ...
        c(this),
        (null == e || Math.abs(e - yt(this.display)) > 0.5) && l(this),
        Hl(this, "refresh", this);
    }),
  ...
  Kr(
    ...
    Kr("lineSeparator", null, function (e, t) {
      if (((e.doc.lineSep = t), t)) {
        ...
        for (var i = r.length - 1; i >= 0; i--)
          Or(e.doc, t, r[i], Fo(r[i].line, r[i].ch + t.length));
      }
    }),
    Kr(
      "specialChars",
    ...
    Kr("rtlMoveVisually", !Do),
    Kr("wholeLineUpdateBefore", !0),
    Kr(
      "theme",
      "default",
      function (e) {
    ...
    Kr("keyMap", "default", function (t, r, n) {
      var i = Xr(r),
        o = n != e.Init && Xr(n);
      o && o.detach && o.detach(t, i), i.attach && i.attach(t, o || null);
    }),
    Kr("extraKeys", null),
    Kr("lineWrapping", !1, i, !0),
    Kr(
      "gutters",
      [],
      function (e) {
    ...
    Kr("showCursorWhenSelecting", !1, Pe, !0),
    Kr("resetSelectionOnContextMenu", !0),
    Kr("lineWiseCopyCut", !0),
    Kr("readOnly", !1, function (e, t) {
      "nocursor" == t
        ? (mr(e), e.display.input.blur(), (e.display.disabled = !0))
    ...
    Kr("dragDrop", !0, Vt),
    Kr("allowDropFileTypes", null),
    Kr("cursorBlinkRate", 530),
    Kr("cursorScrollMargin", 0),
    Kr("cursorHeight", 1, Pe, !0),
    Kr("singleCursorHeightPerLine", !0, Pe, !0),
    Kr("workTime", 100),
    Kr("workDelay", 100),
    Kr("flattenSpans", !0, n, !0),
    Kr("addModeClass", !1, n, !0),
    Kr("pollInterval", 100),
    Kr("undoDepth", 200, function (e, t) {
      e.doc.history.undoDepth = t;
    }),
    Kr("historyEventDelay", 1250),
    Kr(
      "viewportMargin",
      10,
      function (e) {
    ...
    Kr("maxHighlightLength", 1e4, n, !0),
    Kr("moveInputWithCursor", !0, function (e, t) {
  ...
  (e.defineMode = function (t, r) {
    ...
    (e.resolveMode = function (t) {
      if ("string" == typeof t && il.hasOwnProperty(t)) t = il[t];
      else if (t && "string" == typeof t.name && il.hasOwnProperty(t.name)) {
        var r = il[t.name];
  ...
  var ol = (e.modeExtensions = {});
  (e.extendMode = function (e, t) {
    var r = ol.hasOwnProperty(e) ? ol[e] : (ol[e] = {});
    zi(t, r);
  }),
  ...
  (e.registerHelper = function (t, r, n) {
    sl.hasOwnProperty(t) || (sl[t] = e[t] = { _global: [] }), (sl[t][r] = n);
  }),
    (e.registerGlobalHelper = function (t, r, n, i) {
      e.registerHelper(t, r, i), sl[t]._global.push({ pred: n, val: i });
    });
  var al = (e.copyState = function (e, t) {
    ...
    ul = (e.startState = function (e, t, r) {
  ...
  var cl = (e.commands = {
      selectAll: function (e) {
        e.setSelection(Fo(e.firstLine(), 0), Fo(e.lastLine()), zl);
      },
        ...
        Gr(e, function (t) {
          if (t.empty()) {
            ...
            return t.head.ch == r && t.head.line < e.lastLine()
              ? { from: t.head, to: Fo(t.head.line + 1, 0) }
              : { from: t.head, to: Fo(t.head.line, r) };
          }
      ...
      delLineLeft: function (e) {
        Gr(e, function (e) {
          return { from: Fo(e.from().line, 0), to: e.from() };
        });
      },
      ...
      transposeChars: function (e) {
        Wt(e, function () {
          for (var t = e.listSelections(), r = [], n = 0; n < t.length; n++) {
            ...
            if (o)
              if (
                (i.ch == o.length && (i = new Fo(i.line, i.ch - 1)), i.ch > 0)
              )
  ...
  (hl.basic = {
    ...
    (hl["default"] = Ao ? hl.macDefault : hl.pcDefault),
  ...
  var fl = (e.lookupKey = function (e, t, r, n) {
      t = Xr(t);
      ...
      if (t.fallthrough) {
        if ("[object Array]" != Object.prototype.toString.call(t.fallthrough))
          return fl(e, t.fallthrough, r, n);
        for (var o = 0; o < t.fallthrough.length; o++) {
          var l = fl(e, t.fallthrough[o], r, n);
          if (l) return l;
        }
      }
    }),
    ...
    pl = (e.keyName = function (e, t) {
      ...
      return null == n || e.altGraphKey
        ...
        : (e.altKey && "Alt" != r && (n = "Alt-" + n),
          (Po ? e.metaKey : e.ctrlKey) && "Ctrl" != r && (n = "Ctrl-" + n),
          (Po ? e.ctrlKey : e.metaKey) && "Cmd" != r && (n = "Cmd-" + n),
  ...
  e.fromTextArea = function (t, r) {
    ...
    if (t.form && (Al(t.form, "submit", n), !r.leaveSubmitMethodAlone)) {
      var o = t.form,
        l = o.submit;
      try {
  ...
  var gl = (e.StringStream = function (e, t) {
    ...
    column: function () {
      return (
        this.lastColumnPos < this.start &&
          ...
          (this.lastColumnPos = this.start)),
        this.lastColumnValue -
          (this.lineStart ? Bl(this.string, this.lineStart, this.tabSize) : 0)
      );
    },
    indentation: function () {
      return (
        Bl(this.string, null, this.tabSize) -
        (this.lineStart ? Bl(this.string, this.lineStart, this.tabSize) : 0)
      );
    },
  ...
  var vl = 0,
    ml = (e.TextMarker = function (e, t) {
      (this.lines = []), (this.type = t), (this.doc = e), (this.id = ++vl);
    });
  Wi(ml),
    (ml.prototype.clear = function () {
      if (!this.explicitlyCleared) {
        ...
        for (var n = null, i = null, o = 0; o < this.lines.length; ++o) {
          ...
          e && !this.collapsed
            ? It(e, ti(l), "text")
            : e && (null != s.to && (i = ti(l)), null != s.from && (n = ti(l))),
        ...
        null != n && e && this.collapsed && Et(e, n, i + 1),
          (this.lines.length = 0),
          (this.explicitlyCleared = !0),
          this.atomic &&
            this.doc.cantEdit &&
            ((this.doc.cantEdit = !1), e && We(e.doc)),
          e && Li(e, "markerCleared", e, this),
          t && Ct(e),
    ...
    (ml.prototype.find = function (e, t) {
      ...
      for (var r, n, i = 0; i < this.lines.length; ++i) {
        ...
        if (null != l.from && ((r = Fo(t ? o : ti(o), l.from)), -1 == e))
          return r;
        if (null != l.to && ((n = Fo(t ? o : ti(o), l.to)), 1 == e)) return n;
      }
    ...
    (ml.prototype.changed = function () {
      ...
      e &&
        ...
        Wt(r, function () {
          ...
          if (
            (o &&
              (ot(o), (r.curOp.selectionChanged = r.curOp.forceUpdate = !0)),
            (r.curOp.updateMaxLine = !0),
            !Cn(t.doc, n) && null != t.height)
          ) {
            var l = t.height;
            t.height = null;
            var s = Tn(t) - l;
    ...
    (ml.prototype.attachLine = function (e) {
      if (!this.lines.length && this.doc.cm) {
        ...
        (t.maybeHiddenMarkers && -1 != Hi(t.maybeHiddenMarkers, this)) ||
    ...
    (ml.prototype.detachLine = function (e) {
      if (
        (this.lines.splice(Hi(this.lines, e), 1),
  ...
  var vl = 0,
    yl = (e.SharedTextMarker = function (e, t) {
  ...
  Wi(yl),
    ...
    (yl.prototype.find = function (e, t) {
      return this.primary.find(e, t);
    });
  var bl = (e.LineWidget = function (e, t, r) {
  ...
  var wl = (e.Line = function (e, t, r) {
    (this.text = e), cn(this, t), (this.height = r ? r(this) : 1);
  });
  Wi(wl),
    (wl.prototype.lineNo = function () {
      return ti(this);
    });
  var xl = {},
    Cl = {};
  (Yn.prototype = {
    ...
    (_n.prototype = {
      ...
      removeInner: function (e, t) {
        ...
        if (
          this.size - t < 25 &&
          (this.children.length > 1 || !(this.children[0] instanceof Yn))
        ) {
          var s = [];
          this.collapse(s),
            (this.children = [new Yn(s)]),
          ...
          if (o >= e) {
            if ((i.insertInner(e, t, r), i.lines && i.lines.length > 50)) {
              for (
                ...
                var a = new Yn(i.lines.slice(s, (s += 25)));
                (i.height -= a.height),
  ...
  var Sl = 0,
    Ll = (e.Doc = function (e, t, r, n) {
      if (!(this instanceof Ll)) return new Ll(e, t, r, n);
      null == r && (r = 0),
        _n.call(this, [new Yn([new wl("", null)])]),
        (this.first = r),
      ...
      (this.sel = de(i)),
        ...
        Xn(this, { from: i, to: i, text: e }),
        ke(this, de(i), zl);
    });
  (Ll.prototype = Ii(_n.prototype, {
    constructor: Ll,
    iter: function (e, t, r) {
      r
    ...
    setCursor: Dt(function (e, t, r) {
      Se(this, ge(this, "number" == typeof e ? Fo(e, t || 0) : e), null, r);
    }),
    ...
    replaceSelections: Dt(function (e, t, r) {
      ...
      for (
        var s = t && "end" != t && Sr(this, n, t), o = n.length - 1;
        o >= 0;
        o--
      )
        Tr(this, n[o]);
    ...
    unlinkDoc: function (t) {
      if ((t instanceof e && (t = t.doc), this.linked))
        for (var r = 0; r < this.linked.length; ++r) {
          var n = this.linked[r];
          if (n.doc == t) {
            this.linked.splice(r, 1), t.unlinkDoc(this), Zr(qr(this));
            break;
          }
        }
      if (t.history == this.history) {
        ...
        qn(
          ...
          (t.history.done = vi(this.history.done, i)),
          (t.history.undone = vi(this.history.undone, i));
      }
    },
    ...
    (Ll.prototype.eachLine = Ll.prototype.iter);
  var Tl = "iter insert remove copy getEditor constructor".split(" ");
  for (var kl in Ll.prototype)
    Ll.prototype.hasOwnProperty(kl) &&
      Hi(Tl, kl) < 0 &&
      (e.prototype[kl] = (function (e) {
        return function () {
          return e.apply(this.doc, arguments);
        };
      })(Ll.prototype[kl]));
  Wi(Ll);
  var Ml = (e.e_preventDefault = function (e) {
      e.preventDefault ? e.preventDefault() : (e.returnValue = !1);
    }),
    Nl = (e.e_stopPropagation = function (e) {
      e.stopPropagation ? e.stopPropagation() : (e.cancelBubble = !0);
    }),
    Wl = (e.e_stop = function (e) {
      Ml(e), Nl(e);
    }),
    Al = (e.on = function (e, t, r) {
  ...
  var Bl = (e.countColumn = function (e, t, r, n, i) {
    ...
    Gl = (e.findColumn = function (e, t, r) {
      for (var n = 0, i = 0; ; ) {
        var o = e.indexOf("	", n);
        -1 == o && (o = e.length);
        var l = o - n;
  ...
  var _l = (e.contains = function (e, t) {
    ...
    ss = (function () {
      ...
      return function (r) {
        ...
        for (var f = 0, p = u; c > f; ++f) {
          ...
          "1" == n && "r" == p
            ? (h[f] = "n")
            : l.test(n) && ((p = n), "r" == n && (h[f] = "R"));
        }
        for (var f = 1, d = h[0]; c - 1 > f; ++f) {
          var n = h[f];
          "+" == n && "1" == d && "1" == h[f + 1]
            ? (h[f] = "1")
            : "," != n || d != h[f + 1] || ("1" != d && "n" != d) || (h[f] = d),
            (d = n);
        }
        for (var f = 0; c > f; ++f) {
          var n = h[f];
        ...
        return (
          ...
          1 == Di(x).level &&
            (w = r.match(/\s+$/)) &&
            ((Di(x).to -= w[0].length), x.push(new t(0, c - w[0].length, c))),
          2 == x[0].level && x.unshift(new t(1, x[0].to, x[0].to)),
          x[0].level != Di(x).level && x.push(new t(x[0].level, c, c)),
          x
        );
      };
    })();
