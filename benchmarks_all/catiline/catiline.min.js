...
"undefined" == typeof document
  ...
  : !(function (a) {
      ...
      function Deferred() {
        ...
        var a = function (f, g, h) {
            if (f !== a) {
              var i = c();
              return (
                a.queue.push({ deferred: i, resolve: f, reject: g }), i.promise
              );
            }
            for (
              var j = g ? "resolve" : "reject", k = 0, l = a.queue.length;
              l > k;
              k++
            ) {
              var m = a.queue[k],
      ...
      function d(a, b, d) {
        return function (f, g) {
          var h = d ? f : g;
          if (typeof h !== E) return a;
          var i = c();
          return e(h, b, i), i.promise;
        };
      }
      function e(a, b, c) {
        w.nextTick(function () {
      ...
      function f(a) {
        for (
          ...
          (c = b.match(/(importScripts\(.*?\);?)/)),
            ...
            c &&
              c[0].replace(/importScripts\(\s*([\'\"].*?[\'\"])?\s*\);?/g, e);
      ...
      function h() {
        ...
        if ("SHIM_WORKER_PATH" in w) return w.SHIM_WORKER_PATH;
        for (
          var a = document.getElementsByTagName("script"), b = a.length, c = 0;
          b > c;
      ...
      function j(a, b) {
        ...
        var d = c.contentWindow.document,
          e = [
            ...
            a,
            "}catch(e){",
            "	window.parent.postMessage(['" + b + "','error'],'*')",
            "}",
          ].join("\n");
        return i(d, e), c;
      }
      ...
      function o(a, b) {
        var c,
          d = {};
        "undefined" != typeof __self__
          ? (c = __self__.postMessage)
          : b && (c = b),
          (a.on = function (b, c, e) {
            if (((e = e || a), b.indexOf(" ") > 0))
              return (
                b.split(" ").map(function (b) {
                  return a.on(b, c, e);
                }, this),
                a
              );
      ...
      function p(a) {
        if ("undefined" != typeof console) {
          ...
          "undefined" == typeof console[b].apply
            ? console[b](a[1].join(" "))
            : console[b].apply(console, a[1]);
        }
      }
      function q(a) {
        function b(b) {
      ...
      function Catiline(a) {
        ...
        var b =
          ...
          d = [];
        o(c, function (a, b) {
          w._noTransferable ? l.postMessage(a) : l.postMessage(a, b);
        });
        var e = function (a) {
          "string" != typeof a &&
            "preventDefault" in a &&
            (a.preventDefault(), (a = a.message)),
        ...
        if (
          ((a.__codeWord__ = b),
          (a.__initialize__ = [F, o, q]),
          "initialize" in a
            ? a.__initialize__.push(a.initialize)
            : "init" in a && a.__initialize__.push(a.init),
          "events" in a || (a.events = {}),
          "listners" in a && "function" != typeof a.listners)
        )
          for (var f in a.listners) c.on(f, a.listners[f]);
        var g = "var _db = {\n	",
          h = function (a) {
            var c = function (c, e) {
              var f = d.length;
              return (
                (d[f] = w.deferred()),
                w._noTransferable
                  ? l.postMessage([[b, f], a, c])
                  : l.postMessage([[b, f], a, c], e),
                d[f].promise
              );
            };
            return c;
        ...
        for (var j in a)
          if (!(["listners", "initialize", "init"].indexOf(j) > -1))
            if ((i ? (g += ",\n	") : (i = !0), "function" == typeof a[j]))
              (g = g + j + ":" + a[j].toString()), (c[j] = h(j));
            else {
              var k = w.stringify(a[j]);
        ...
        (l.onmessage = function (a) {
          c.trigger("message", a.data[1]),
            a.data[0][0] === b
              ? (d[a.data[0][1]].resolve(a.data[1]), (d[a.data[0][1]] = 0))
              : c.trigger(a.data[0][0], a.data[1]);
        }),
          c.on("error", e),
          ...
          c.on("console", p),
          (c._close = function () {
            return l.terminate(), e("closed"), w.resolve();
          }),
      ...
      function v(a, b, c) {
        for (var d = [], e = -1; ++e < a; ) (d[e] = new w.Worker(c)), b.push(e);
        return d;
      }
      function CatilineQueue(a, b, c) {
        function d(a) {
          (a = a || "canceled"), (k = 0);
          var b = j;
          return (
      ...
      function w(a, b, c) {
        return 1 === arguments.length || !b || 1 >= b
          ? new w.Worker(a)
          : new w.Queue(a, b, c);
      }
      function x(b) {
      ...
      var y,
        z = a.MutationObserver || a.WebKitMutationObserver;
      if (z) {
        var A = new z(b),
          B = document.createElement("div");
        A.observe(B, { attributes: !0 }),
          addEventListener(
            "unload",
            function () {
              A.disconnect(), (A = null);
          ...
          (y = function () {
            B.setAttribute("drainQueue", "drainQueue");
          });
      } else {
        var C = "com.catiline.setImmediate" + Math.random();
        addEventListener(
          "message",
          function (a) {
            a.source === window && a.data === C && b();
          },
          !1
        ),
          (y = function () {
      ...
      (w.deferred = c),
        (w.resolve = function (a) {
          var b = {};
          return (b.then = d(b, a, !0)), b;
        }),
        (w.reject = function (a) {
          var b = {};
          return (b.then = d(b, a, !1)), b;
        }),
        (w.all = function (a) {
          var b = c(),
            d = a.length,
        ...
        (w._hasWorker =
          "undefined" != typeof Worker && "undefined" == typeof fakeLegacy),
        (w.URL = window.URL || window.webkitURL),
        (w._noTransferable = !w.URL),
        (w.makeIWorker = function (a, b) {
          var c = g(a.join(""), "');eval(__scripts__);\n"),
            d = { onmessage: function () {} },
            e = k(c, b);
          return (
            window.addEventListener("message", function (a) {
              a.data.slice &&
                a.data.slice(0, b.length) === b &&
                d.onmessage({ data: JSON.parse(a.data.slice(b.length)) });
            }),
        ...
        (w.makeWorker = function (a, b) {
          if (!w._hasWorker) return w.makeIWorker(a, b);
          var c,
            d = g(a.join("\n"), "');\n");
          if (w._noTransferable) return l(d);
          try {
            c = new Worker(
              w.URL.createObjectURL(new Blob([d], { type: "text/javascript" }))
            );
          } catch (e) {
            try {
              c = l(d);
        ...
        (self.__iFrame__ = "undefined" != typeof document),
          (self.__self__ = {
            onmessage: function (c) {
              return (
                a.trigger("messege", c.data[1]),
                c.data[0][0] === a.__codeWord__
                  ? b(c)
                  : (a.trigger(c.data[0][0], c.data[1]), void 0)
              );
            },
          }),
          __iFrame__
          ...
          (__self__.postMessage = function (b, c) {
            if (self._noTransferable || __iFrame__)
              ...
              } else self._noTransferable && self.postMessage(b);
            else self.postMessage(b, c);
          }),
          (self.console = {});
        var b = function (b) {
          var c,
      ...
      (w.Worker = Catiline),
        (w.worker = function (a) {
          return new Catiline(a);
        }),
        (CatilineQueue.prototype.__batchcb__ = {}),
        (CatilineQueue.prototype.__batchtcb__ = {}),
        (CatilineQueue.prototype.batch = function (a) {
          return "function" == typeof a
            ? ((this.__cb__ = a), this.__batchcb__)
            : this.clearQueue(a);
        }),
        (CatilineQueue.prototype.batchTransfer = function (a) {
          return "function" == typeof a
            ? ((this.__batchtcb__.__cb__ = a), this.__batchtcb__)
            : this.clearQueue(a);
        }),
        (w.Queue = CatilineQueue),
        (w.queue = function (a, b, c) {
          return new w.Queue(a, b, c);
        }),
        (w.setImmediate = w.nextTick),
        "function" == typeof define
          ? define(function (a) {
              return (w.SHIM_WORKER_PATH = a.toUrl("./catiline.js")), w;
            })
