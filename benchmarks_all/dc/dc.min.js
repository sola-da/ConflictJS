  ...
  function a(a, b) {
    ...
    return (
      (c.chartRegistry = (function () {
        function a(a) {
          return (
            a || (a = c.constants.DEFAULT_CHART_GROUP), b[a] || (b[a] = []), a
          );
        }
        var b = {};
        return {
          has: function (a) {
            for (var c in b) if (b[c].indexOf(a) >= 0) return !0;
            return !1;
          },
      ...
      (c.deregisterAllCharts = function () {
        c.chartRegistry.clear();
      }),
      (c.filterAll = function (a) {
        for (var b = c.chartRegistry.list(a), d = 0; d < b.length; ++d)
          b[d].filterAll();
      }),
      ...
      (c.units.fp = {}),
      (c.units.fp.precision = function (a) {
        var b = function (a, d) {
          var e = Math.abs((d - a) / b.resolution);
          return c.utils.isNegligible(e - Math.floor(e))
            ? Math.floor(e)
            : Math.ceil(e);
        };
      ...
      (c.dateFormat = a.time.format("%m/%d/%Y")),
      (c.printers = {}),
      (c.printers.filters = function (a) {
        for (var b = "", d = 0; d < a.length; ++d)
          d > 0 && (b += ", "), (b += c.printers.filter(a[d]));
        return b;
      }),
          ...
          a &&
            (a instanceof Array
              ? a.length >= 2
                ? (b =
                    "[" +
                    c.utils.printSingleValue(a[0]) +
                    " -> " +
                    c.utils.printSingleValue(a[1]) +
                    "]")
                : a.length >= 1 && (b = c.utils.printSingleValue(a[0]))
              : (b = c.utils.printSingleValue(a))),
          b
        );
      }),
      (c.utils = {}),
      (c.utils.printSingleValue = function (a) {
        var b = "" + a;
        return (
          a instanceof Date
            ? (b = c.dateFormat(a))
            ...
            ? (b = a)
            : c.utils.isFloat(a)
            ? (b = c.utils.printSingleValue.fformat(a))
            : c.utils.isInteger(a) && (b = Math.round(a)),
          b
        );
      }),
      (c.utils.printSingleValue.fformat = a.format(".2f")),
      (c.utils.add = function (a, b) {
        if (
          ("string" == typeof b && (b = b.replace("%", "")), a instanceof Date)
        ) {
          "string" == typeof b && (b = +b);
          var c = new Date();
        ...
        (this.setDataPoint = function (b, d, e) {
          ...
          (this.toLayers = function () {
            for (var a = [], b = 0; b < c.length; ++b) {
              for (
                var d = { index: b, points: [] }, e = c[b], f = 0;
                f < e.length;
                ++f
              )
                d.points.push(e[f]);
      ...
      (c.utils.isNegligible = function (a) {
        return (
          void 0 === a ||
          (a < c.constants.NEGLIGIBLE_NUMBER &&
            a > -c.constants.NEGLIGIBLE_NUMBER)
        );
      }),
      (c.utils.groupMax = function (b, d) {
        var e = a.max(b.all(), function (a) {
          return d(a);
        });
        return c.utils.isNegligible(e) && (e = 0), e;
      }),
      (c.utils.groupMin = function (b, d) {
        var e = a.min(b.all(), function (a) {
          return d(a);
        });
        return c.utils.isNegligible(e) && (e = 0), e;
      }),
      ...
      (c.utils.appendOrSelect = function (a, b) {
        var c = a.select(b);
        return c.empty() && (c = a.append(b)), c;
      }),
      (c.utils.createLegendable = function (a, b, c, d) {
      ...
      (c.cumulative.Sum = function () {
        c.cumulative.Base.apply(this, arguments),
          (this.add = function (a, b) {
            b || (b = 0),
              void 0 === this.getValueByKey(a)
                ? (this.addToIndex(a), this.setValueByKey(a, b))
      ...
      (c.cumulative.Sum.prototype = new c.cumulative.Base()),
      (c.cumulative.CountUnique = function () {
        function a(a) {
          var b,
            c = 0;
        ...
        c.cumulative.Base.apply(this, arguments),
          (this.add = function (a, b) {
            void 0 === this.getValueByKey(a) &&
              (this.setValueByKey(a, {}), this.addToIndex(a)),
              void 0 !== b &&
                (void 0 === this.getValueByKey(a)[b] &&
                  (this.getValueByKey(a)[b] = 0),
      ...
      (c.cumulative.CountUnique.prototype = new c.cumulative.Base()),
      (c.baseChart = function (d) {
        function e(a, b, c) {
          var d = a.anchor(),
            e = "__names__";
        ...
        function g(a) {
          G.splice(G.indexOf(a), 1), j(), d._invokeFilteredListener(a);
        }
        function h(a) {
          G.push(a), j(), d._invokeFilteredListener(a);
        }
        function i() {
          (G = []), j(), d._invokeFilteredListener(null);
        }
        function j() {
          if (d.dataSet() && void 0 !== d.dimension().filter) {
            var a = H(d.dimension(), G);
            G = a ? a : G;
          }
        }
        function k() {
          for (var a = 0; a < C.length; ++a) C[a](d);
        }
        d.__dc_flag__ = !0;
        var l,
          m,
          ...
          z = !1,
          A = 750,
          B = c.printers.filters,
          C = [],
          D = c.constants.DEFAULT_CHART_GROUP,
          E = function () {},
          F = {
            preRender: E,
            postRender: E,
        ...
        return (
          ...
          (d.dimension = function (a) {
            return arguments.length ? ((l = a), d.expireCache(), d) : l;
          }),
          (d.group = function (a, b) {
            return arguments.length
              ? ((m = a),
                d.expireCache(),
                "string" == typeof b && d._setGroupName(m, b),
                d)
              : m;
          }),
          (d._getGroupName = function (a, b) {
            return e(d, a, b).name;
          }),
          (d._setGroupName = function (a, b, c) {
            e(d, a, c).name = b;
          }),
          (d.ordering = function (a) {
            return arguments.length ? ((v = a), d.expireCache(), d) : v;
          }),
          (d.computeOrderedGroups = function (a) {
            var c = a ? a : d.group().all().slice(0);
            if (c.length < 2) return c;
            var e = b.quicksort.by(d.ordering());
            return e(c, 0, c.length);
          }),
          (d.filterAll = function () {
            return d.filter(null);
          }),
          (d.dataSet = function () {
            return void 0 !== l && void 0 !== m;
          }),
          (d.select = function (a) {
            return o.select(a);
          }),
          (d.selectAll = function (a) {
            return o ? o.selectAll(a) : null;
          }),
          (d.anchor = function (b, e) {
            return arguments.length
              ? (c.instanceOfChart(b)
                  ...
                  : ((n = b),
                    (o = a.select(n)),
                    o.classed(c.constants.CHART_CLASS, !0),
                    c.registerChart(d, e)),
                (D = e),
                d)
              : n;
          ...
          (d.turnOnControls = function () {
            return (
              o &&
                (d.selectAll(".reset").style("display", null),
                d
                  .selectAll(".filter")
                  .text(B(d.filters()))
                  .style("display", null)),
          ...
          (d.turnOffControls = function () {
            return (
              o &&
                (d.selectAll(".reset").style("display", "none"),
                d
                  .selectAll(".filter")
                  .style("display", "none")
                  .text(d.filter())),
          ...
          (d.render = function () {
            if ((F.preRender(d), void 0 === l))
              throw new c.errors.InvalidStateException(
            ...
            var a = d.doRender();
            return q && q.render(), d.activateRenderlets("postRender"), a;
          }),
          (d.activateRenderlets = function (a) {
            d.transitionDuration() > 0 && p
              ? p
                  .transition()
          ...
          (d.redraw = function () {
            F.preRedraw(d);
            var a = d.doRedraw();
            return d.activateRenderlets("postRedraw"), a;
          }),
          ...
          (d.hasFilter = function (a) {
            return arguments.length ? G.indexOf(a) >= 0 : G.length > 0;
          }),
          (d.filter = function (a) {
            return arguments.length
              ? (null === a ? i() : d.hasFilter(a) ? g(a) : h(a),
                null !== o && d.hasFilter()
                  ? d.turnOnControls()
                  : d.turnOffControls(),
                d)
          ...
          (d.highlightSelected = function (b) {
            a.select(b).classed(c.constants.SELECTED_CLASS, !0),
              a.select(b).classed(c.constants.DESELECTED_CLASS, !1);
          }),
          (d.fadeDeselected = function (b) {
            a.select(b).classed(c.constants.SELECTED_CLASS, !1),
              a.select(b).classed(c.constants.DESELECTED_CLASS, !0);
          }),
          ...
          (d.onClick = function (a) {
            ...
            c.events.trigger(function () {
              d.filter(b), c.redrawAll(d.chartGroup());
            });
          }),
          ...
          (d.legendHighlight = function (a) {}),
          (d.legendReset = function (a) {}),
          ...
          (d.label = function (a) {
            return arguments.length ? ((w = a), (x = !0), d) : w;
          }),
          (d.renderLabel = function (a) {
            return arguments.length ? ((x = a), d) : x;
          }),
          (d.title = function (a) {
            return arguments.length ? ((y = a), (z = !0), d) : y;
          }),
          (d.renderTitle = function (a) {
            return arguments.length ? ((z = a), d) : z;
          }),
          (d.renderlet = function (a) {
            return C.push(a), d;
          }),
          (d.chartGroup = function (a) {
          ...
          (d.legend = function (a) {
            return arguments.length ? ((q = a), q.parent(d), d) : q;
          }),
          (d.on = function (a, b) {
            return (F[a] = b), d;
          }),
      ...
      (c.marginable = function (a) {
        var b = { top: 10, right: 50, bottom: 30, left: 30 };
        return (
          (a.margins = function (c) {
      ...
      (c.coordinateGridChart = function (b) {
        function d(a) {
          b.elasticX() && !b.isOrdinal()
            ? x.domain([b.xAxisMin(), b.xAxisMax()])
            : b.isOrdinal() &&
              0 === x.domain().length &&
              x.domain(
                b.computeOrderedGroups().map(function (a) {
                  return a.key;
                })
              ),
            b.isOrdinal()
              ? b.prepareOrdinalXAxis()
              : x.range([0, b.xAxisLength()]),
            (G = G.scale(b.x()).orient("bottom")),
            e(a);
        }
        function e(a) {
          ...
          if (S) {
            d.empty() &&
              (d = a
                ...
                .attr(
                  "transform",
                  "translate(" + b.yAxisX() + "," + b.margins().top + ")"
                ));
            var e = G.tickValues() ? G.tickValues() : x.ticks(G.ticks()[0]),
              ...
              g = f
                ...
                .attr("y1", b.xAxisY() - b.margins().top)
                .attr("x2", function (a) {
                  return x(a);
                })
                .attr("y2", 0)
                .attr("opacity", 0);
            c.transition(g, b.transitionDuration()).attr("opacity", 1),
              c
                .transition(f, b.transitionDuration())
                .attr("x1", function (a) {
                  return x(a);
                })
                .attr("y1", b.xAxisY() - b.margins().top)
        ...
        function f(c) {
          (void 0 === A || b.elasticY()) &&
            ((A = a.scale.linear()),
            A.domain([b.yAxisMin(), b.yAxisMax()]).rangeRound([
              b.yAxisHeight(),
              0,
            ])),
            A.range([b.yAxisHeight(), 0]),
        ...
        function i(a) {
          ...
          b.redrawBrush(v),
            b.brushIsEmpty(d)
              ? c.events.trigger(function () {
                  b.filter(null), c.redrawAll(b.chartGroup());
                })
              : c.events.trigger(function () {
                  b.filter(null),
                    b.filter([d[0], d[1]]),
                    c.redrawAll(b.chartGroup());
        ...
        function k() {
          var a = c.utils.appendOrSelect(u, "defs"),
            d = c.utils.appendOrSelect(a, "clipPath").attr("id", j()),
            e = 2 * X;
          c.utils
            .appendOrSelect(d, "rect")
            .attr("width", b.xAxisLength() + e)
            .attr("height", b.yAxisHeight() + e);
        }
        function l() {
          W &&
            b.root().call(
              a.behavior
                ...
                .scaleExtent(U)
                .on("zoom", function () {
                  b.focus(b.x().domain()), b._invokeZoomedListener(), m();
                })
            );
        }
        function m() {
        ...
        var o = "grid-line",
          ...
          s = "x-axis-label",
          t = 12;
        (b = c.colorChart(c.marginable(c.baseChart(b)))),
          b.colors(a.scale.category10());
        var u,
          v,
          w,
          x,
        ...
        return (
          ...
          (b.rescale = function () {
            (D = void 0), b.xUnitCount();
          }),
          (b.rangeChart = function (a) {
            return arguments.length ? ((E = a), E.focusChart(b), b) : E;
          }),
          ...
          (b._generateG = function (a) {
            return (
              ...
              (w = v
                ...
                .attr(
                  "transform",
                  "translate(" + b.margins().left + ", " + b.margins().top + ")"
                )
                .attr("clip-path", "url(#" + j() + ")")),
              v
            );
          }),
          (b.g = function (a) {
          ...
          (b.prepareOrdinalXAxis = function (a) {
            a || (a = b.xUnitCount());
            for (
              var c = [], d = b.xAxisLength() / (a + 1), e = d / 2, f = 0;
              a > f;
              f++
            )
              (c[f] = e), (e += d);
          ...
          (b.renderXAxis = function (a) {
            ...
            d.empty() &&
              (d = a
                ...
                .attr(
                  "transform",
                  "translate(" + b.margins().left + "," + b.xAxisY() + ")"
                ));
            ...
            e.empty() &&
              ...
              b.xAxisLabel() &&
                e.text() != b.xAxisLabel() &&
                axisYLab.text(b.xAxisLabel()),
              c.transition(d, b.transitionDuration()).call(G);
          }),
          (b.xAxisY = function () {
          ...
          (b.renderYAxis = function (a) {
            ...
            e.empty() &&
              ...
              (e = a
                ...
                .attr(
                  "transform",
                  "translate(" + O + "," + b.yAxisHeight() / 2 + "),rotate(-90)"
                )
                .attr("class", r)
                .attr("text-anchor", "middle")
                .text(b.yAxisLabel())),
              b.yAxisLabel() &&
                e.text() != b.yAxisLabel() &&
                e.text(b.yAxisLabel()),
              c.transition(d, b.transitionDuration()).call(L);
          }),
          (b.yAxisX = function () {
          ...
          (b.xAxisMin = function () {
            var d = a.min(b.group().all(), function (a) {
              return b.keyAccessor()(a);
            });
            return c.utils.subtract(d, I);
          }),
          (b.xAxisMax = function () {
            var d = a.max(b.group().all(), function (a) {
              return b.keyAccessor()(a);
            });
            return c.utils.add(d, I);
          }),
          (b.yAxisMin = function () {
            var d = a.min(b.group().all(), function (a) {
              return b.valueAccessor()(a);
            });
            return (d = c.utils.subtract(d, M));
          }),
          (b.yAxisMax = function () {
            var d = a.max(b.group().all(), function (a) {
              return b.valueAccessor()(a);
            });
            return (d = c.utils.add(d, M));
          }),
          ...
          c.override(b, "filter", function (a) {
            return arguments.length
              ? (b._filter(a), a ? b.brush().extent(a) : b.brush().clear(), b)
              : b._filter();
          }),
          (b.brush = function (a) {
          ...
          (b.renderBrush = function (a) {
            if ((b.isOrdinal() && (Q = !1), Q)) {
              ...
              var c = a
                ...
                .call(P.x(b.x()));
              c.selectAll("rect").attr("height", h()),
                c
                  .selectAll(".resize")
                  .append("path")
                  .attr("d", b.resizeHandlePath),
                b.hasFilter() && b.redrawBrush(a);
            }
          }),
          ...
          (b.doRedraw = function () {
            return (
              ...
              f(b.g()),
              b.plotData(),
              b.elasticY() && b.renderYAxis(b.g()),
              (b.elasticX() || T) && b.renderXAxis(b.g()),
              b.redrawBrush(b.g()),
              b
            );
          }),
          ...
          (b.focus = function (a) {
            (T = !0),
              n(a) ? b.x().domain(a) : b.x().domain(b.xOriginalDomain()),
              b.rescale(),
              b.redraw(),
              n(a) || (T = !1);
          }),
          ...
          (b.focusChart = function (a) {
            return arguments.length
              ? ((F = a),
                b.on("filtered", function (a) {
                  c.events.trigger(function () {
                    F.focus(a.filter()),
                      F.filter(a.filter()),
                      c.redrawAll(a.chartGroup());
                  });
                }),
                b)
              : F;
      ...
      (c.colorChart = function (b) {
        var d = a.scale.category20c(),
          e = [0, d.range().length],
          f = function (a) {
            var f = e;
            "function" == typeof e && (f = e.call(b));
            var g = f[0],
              h = f[1];
            if ((isNaN(a) && (a = 0), !c.utils.isNumber(h))) return d(a);
            var i = b.colors().range().length,
              j = (h - g) / i,
        ...
        return (
          (b.colors = function (c) {
            ...
            if (c instanceof Array) {
              d = a.scale.ordinal().range(c);
              for (var f = [], g = 0; g < c.length; ++g) f.push(g);
              d.domain(f);
            } else d = c;
            return (e = [0, d.range().length]), b;
          }),
      ...
      (c.stackableChart = function (b) {
        function d() {
          ...
          if (b.x()) {
            ...
            b.stackLayers().forEach(function (a) {
        ...
        function g(a, b) {
          for (var c = 0; c < a.length; ++c) {
            var d = a[c],
              g = e(b, d),
              h = f(b, d);
            l.setDataPoint(b, c, { data: d, x: g, y: h, layer: b });
          }
        }
        var h,
          i,
        ...
        return (
          (b.stack = function (a, c, d) {
            return (
              arguments.length || l.clear(),
              "string" == typeof c
                ? b._setGroupName(a, c, d)
                : "function" == typeof c && (d = c),
              l.setDefaultAccessor(b.valueAccessor()),
              l.addGroup(a, d),
              b.expireCache(),
              b
            );
          ...
          (b.expireCache = function () {
            return (h = null), (i = null), (j = null), (k = null), b;
          }),
          (b.allGroups = function () {
            if (null === h) {
              (h = []), h.push(b.group());
              for (var a = 0; a < l.size(); ++a) h.push(l.getGroupByIndex(a));
            }
            return h;
          }),
          (b.allValueAccessors = function () {
            if (null === i) {
              (i = []), i.push(b.valueAccessor());
          ...
          (b.yAxisMin = function () {
            var e,
              f = d();
            return (
              (e = a.min(f, function (a) {
                return a.y + a.y0 < a.y0 ? a.y + a.y0 : a.y0;
              })),
              (e = c.utils.subtract(e, b.yAxisPadding()))
            );
          }),
          (b.yAxisMax = function () {
            var e,
              f = d();
            return (
              (e = a.max(f, function (a) {
                return a.y + a.y0;
              })),
              (e = c.utils.add(e, b.yAxisPadding()))
            );
          }),
          (b.allKeyAccessors = function () {
            if (null === j) {
              (j = []), j.push(b.keyAccessor());
              for (var a = 0; a < l.size(); ++a) j.push(b.keyAccessor());
            }
            return j;
          }),
          ...
          (b.xAxisMin = function () {
            for (var a = null, d = b.allGroups(), e = 0; e < d.length; ++e) {
              var f = d[e],
                g = c.utils.groupMin(f, b.getKeyAccessorByIndex(e));
              (null === a || a > g) && (a = g);
            }
            return c.utils.subtract(a, b.xAxisPadding());
          }),
          (b.xAxisMax = function () {
            for (var a = null, d = b.allGroups(), e = 0; e < d.length; ++e) {
              var f = d[e],
                g = c.utils.groupMax(f, b.getKeyAccessorByIndex(e));
              (null === a || g > a) && (a = g);
            }
            return c.utils.add(a, b.xAxisPadding());
          }),
          ...
          c.override(b, "valueAccessor", function (a) {
            return arguments.length
              ? (b.expireCache(), b._valueAccessor(a))
              : b._valueAccessor();
          }),
          c.override(b, "keyAccessor", function (a) {
            return arguments.length
              ? (b.expireCache(), b._keyAccessor(a))
              : b._keyAccessor();
          }),
          ...
          (b.stackLayers = function (a) {
            return arguments.length
              ? void (k = a)
              : (null === k &&
                  (b.calculateDataPointMatrixForAll(),
                  (k = b.stackLayout()(l.toLayers()))),
                k);
          }),
          b.colorAccessor(function (a) {
          ...
          (b.legendables = function () {
            ...
            return (
              h.forEach(function (d, e) {
                a.push(
                  c.utils.createLegendable(
                    b,
                    d,
                    e,
                    b.getValueAccessorByIndex(e)
                  )
                );
              }),
              a
      ...
      (c.abstractBubbleChart = function (b) {
        var d = 0.3,
          e = 10;
        (b.BUBBLE_NODE_CLASS = "node"),
          (b.BUBBLE_CLASS = "bubble"),
          (b.MIN_RADIUS = 10),
          (b = c.colorChart(b)),
          b.renderLabel(!0),
          b.renderTitle(!1);
        ...
        (b.r = function (a) {
          ...
          (b.rMin = function () {
            var c = a.min(b.group().all(), function (a) {
              return b.radiusValueAccessor()(a);
            });
            return c;
          }),
          (b.rMax = function () {
            var c = a.max(b.group().all(), function (a) {
              return b.radiusValueAccessor()(a);
            });
            return c;
          }),
        ...
        return (
          ...
          (b.initBubbleColor = function (a, d) {
            return (this[c.constants.NODE_INDEX_NAME] = d), b.getColor(a, d);
          }),
          (b.updateBubbleColor = function (a, d) {
            return b.getColor(a, this[c.constants.NODE_INDEX_NAME]);
          }),
          (b.fadeDeselectedArea = function () {
            b.hasFilter()
              ? b.selectAll("g." + b.BUBBLE_NODE_CLASS).each(function (a) {
                  b.isSelectedNode(a)
                    ? b.highlightSelected(this)
                    : b.fadeDeselected(this);
                })
              : b.selectAll("g." + b.BUBBLE_NODE_CLASS).each(function (a) {
          ...
          (b.onClick = function (a) {
            var d = a.key;
            c.events.trigger(function () {
              b.filter(d), c.redrawAll(b.chartGroup());
            });
          }),
          b
        );
      ...
      (c.pieChart = function (b, d) {
        ...
        function j(a, b) {
          if (D.renderLabel()) {
            ...
            var e = d
              ...
              .on("click", v);
            c.transition(e, D.transitionDuration())
              .attr("transform", function (a) {
                (a.innerRadius = D.innerRadius()), (a.outerRadius = x);
                var c = b.centroid(a);
        ...
        function l(a, b) {
          ...
          c.transition(d, D.transitionDuration(), function (a) {
            a.attrTween("d", t);
          }).attr("fill", function (a, b) {
            return D.getColor(a, b);
          });
        ...
        function m(a, b) {
          if (D.renderLabel()) {
            var d = y.selectAll("text." + A).data(a);
            c.transition(d, D.transitionDuration())
              .attr("transform", function (a) {
                (a.innerRadius = D.innerRadius()), (a.outerRadius = x);
                var c = b.centroid(a);
                return isNaN(c[0]) || isNaN(c[1])
        ...
        function p() {
          D.hasFilter()
            ? D.selectAll("g." + A).each(function (a) {
                D.isSelectedSlice(a)
                  ? D.highlightSelected(this)
                  : D.fadeDeselected(this);
              })
            : D.selectAll("g." + A).each(function (a) {
        ...
        var x,
          ...
          B = 0,
          C = z,
          D = c.capped(c.colorChart(c.baseChart({})));
        return (
          (D.slicesCap = D.cap),
          D.label(function (a) {
      ...
      (c.barChart = function (b, d) {
        ...
        function f(a, b, d) {
          var f = a.selectAll("rect.bar").data(b.points);
          f
            .enter()
            .append("rect")
            .attr("class", "bar")
            .attr("fill", n.getColor)
            .append("title")
            .text(n.title()),
            n.isOrdinal() && f.on("click", i),
            c
              .transition(f, n.transitionDuration())
              .attr("x", function (a) {
                var b = n.x()(a.x);
                return (
                  (p || n.isOrdinal()) && (b -= k / 2), c.utils.safeNumber(b)
                );
              })
              .attr("y", function (a) {
                var b = n.y()(a.y + a.y0);
              ...
              .text(n.title()),
            c
              .transition(f.exit(), n.transitionDuration())
              .attr("height", 0)
              .remove();
        }
        function g() {
          if (void 0 === k) {
            ...
            (b == 1 / 0 || isNaN(b) || l > b) && (b = l), (k = b);
          }
        }
        function h() {
          return void 0 === j && (j = n.xUnitCount()), j;
        }
        function i(a) {
          n.onClick(a.data);
        }
        var j,
          ...
          l = 1,
          m = 2,
          n = c.stackableChart(c.coordinateGridChart({})),
          o = m,
          p = !1;
        return (
          c.override(n, "rescale", function () {
            n._rescale(), (j = void 0), (k = void 0), h();
          }),
          (n.plotData = function () {
          ...
          (n.fadeDeselectedArea = function () {
            ...
            if (n.isOrdinal())
              n.hasFilter()
                ? (a.classed(c.constants.SELECTED_CLASS, function (a) {
                    return n.hasFilter(n.keyAccessor()(a.data));
                  }),
                  a.classed(c.constants.DESELECTED_CLASS, function (a) {
                    return !n.hasFilter(n.keyAccessor()(a.data));
                  }))
                : (a.classed(c.constants.SELECTED_CLASS, !1),
                  a.classed(c.constants.DESELECTED_CLASS, !1));
            else if (n.brushIsEmpty(b))
              a.classed(c.constants.DESELECTED_CLASS, !1);
            else {
              var d = b[0],
                e = b[1];
      ...
      (c.lineChart = function (b, d) {
        function e(b, d) {
          ...
          n && e.defined(n),
            b
              .append("path")
              .attr("class", "line")
              .attr("stroke", t.getColor)
              .attr("fill", t.getColor),
            c
              .transition(d.select("path.line"), t.transitionDuration())
              .attr("d", function (a) {
                return g(e(a.points));
              });
        }
        function f(b, d) {
          if (u) {
            ...
            n && e.defined(n),
              ...
              c
                .transition(d.select("path.area"), t.transitionDuration())
                .attr("d", function (a) {
                  return g(e(a.points));
                });
          }
        ...
        function h(b) {
          t.brushOn() ||
            b.each(function (b, d) {
              var e = a.select(this),
                f = e.select("g." + p);
              f.empty() && (f = e.append("g").attr("class", p)), i(f);
              var g = f.selectAll("circle." + q).data(f.datum().points);
              g
                .enter()
                .append("circle")
                .attr("class", q)
                ...
                g
                  .attr("cx", function (a) {
                    return c.utils.safeNumber(t.x()(a.x));
                  })
                  .attr("cy", function (a) {
                    return c.utils.safeNumber(t.y()(a.y + a.y0));
                  })
                  .select("title")
                  .text(t.title()),
                g.exit().remove();
        ...
        function i(a) {
          var b = a.select("path." + r).empty()
            ? a.append("path").attr("class", r)
            : a.select("path." + r);
          b.style("display", "none").attr("stroke-dasharray", "5,5");
          var c = a.select("path." + s).empty()
            ? a.append("path").attr("class", s)
            : a.select("path." + s);
          c.style("display", "none").attr("stroke-dasharray", "5,5");
        }
        function j(a) {
          return (
            a.style("fill-opacity", 0.8), a.style("stroke-opacity", 0.8), a
          );
        }
        function k(a, b) {
          var c = a.attr("cx"),
          ...
          b
            ...
            b
              .select("path." + s)
              .style("display", "")
              .attr("d", "M" + c + " " + t.yAxisHeight() + "L" + c + " " + d);
        }
        function l(a) {
        ...
        var n,
          ...
          r = "yRef",
          s = "xRef",
          t = c.stackableChart(c.coordinateGridChart({})),
          u = !1,
          v = o,
          w = "linear",
          x = 0.7;
        return (
          t.transitionDuration(500),
          (t.plotData = function () {
            ...
            e(b, a), f(b, a), h(a), t.stackLayers(null);
          }),
          (t.interpolate = function (a) {
            return arguments.length ? ((w = a), t) : w;
          }),
          ...
          (t.dotRadius = function (a) {
            return arguments.length ? ((v = a), t) : v;
          }),
      ...
      (c.dataCount = function (b, d) {
        ...
        return (
          (f.doRender = function () {
            return (
              f.selectAll(".total-count").text(e(f.dimension().size())),
      ...
      (c.dataTable = function (d, e) {
        ...
        function g() {
          i || (i = b.quicksort.by(q));
          var c = n.dimension().top(o);
          return a
            .nest()
            .key(n.group())
            .sortKeys(r)
            .sortValues(r)
            .entries(i(c, 0, c.length));
        }
        function h(a) {
          for (
            var b = a
              ...
              c = b.enter().append("tr").attr("class", k),
              d = 0;
            d < p.length;
            ++d
          ) {
        ...
        return (
          (n.doRender = function () {
            return n.selectAll("tbody").remove(), h(f()), n;
          }),
          (n.doRedraw = function () {
            return n.doRender();
          }),
      ...
      (c.bubbleChart = function (a, b) {
        function d(a) {
          ...
          b
            .attr("class", i.BUBBLE_NODE_CLASS)
            .attr("transform", k)
            .append("circle")
            .attr("class", function (a, b) {
            ...
            .on("click", i.onClick)
            .attr("fill", i.initBubbleColor)
            .attr("r", 0),
            c
              .transition(a, i.transitionDuration())
              .attr("r", function (a) {
                return i.bubbleR(a);
              })
        ...
        function e(a) {
          c
            .transition(a, i.transitionDuration())
            .attr("transform", k)
            .selectAll("circle." + i.BUBBLE_CLASS)
            .attr("fill", i.updateBubbleColor)
            .attr("r", function (a) {
              return i.bubbleR(a);
            })
            .attr("opacity", function (a) {
        ...
        var i = c.abstractBubbleChart(c.coordinateGridChart({})),
          j = !1;
          ...
          (i.plotData = function () {
            j && i.r().domain([i.rMin(), i.rMax()]),
              i
                ...
                .range([
                  i.MIN_RADIUS,
                  i.xAxisLength() * i.maxBubbleRelativeSize(),
                ]);
            var a = i
              .chartBodyG()
              .selectAll("g." + i.BUBBLE_NODE_CLASS)
              .data(i.group().all());
            d(a), e(a), f(a), i.fadeDeselectedArea();
          }),
          (i.renderBrush = function (a) {}),
          (i.redrawBrush = function (a) {
      ...
      (c.compositeChart = function (b, d) {
        function e(a, b) {
          a._generateG(k.g()), a.g().attr("class", j + " _" + b);
        }
        function f() {
          for (var a = [], b = 0; b < l.length; ++b) a.push(l[b].yAxisMin());
          return a;
        }
        function g() {
          for (var a = [], b = 0; b < l.length; ++b) a.push(l[b].yAxisMax());
          return a;
        }
        function h() {
          for (var a = [], b = 0; b < l.length; ++b) a.push(l[b].xAxisMin());
          return a;
        }
        function i() {
          for (var a = [], b = 0; b < l.length; ++b) a.push(l[b].xAxisMax());
          return a;
        }
        var j = "sub",
          k = c.coordinateGridChart({}),
          l = [];
        return (
          k.transitionDuration(500),
          k.group({}),
          c.override(k, "_generateG", function () {
          ...
          (k.fadeDeselectedArea = function () {
            for (var a = 0; a < l.length; ++a) {
              var b = l[a];
              b.brush(k.brush()), b.fadeDeselectedArea();
            }
          }),
          (k.compose = function (a) {
            ...
            for (var b = 0; b < l.length; ++b) {
              var c = l[b];
              c.height(k.height()), c.width(k.width()), c.margins(k.margins());
            }
            return k;
          }),
          (k.children = function () {
          ...
          (k.yAxisMax = function () {
            return c.utils.add(a.max(g()), k.yAxisPadding());
          }),
          (k.xAxisMin = function () {
            return c.utils.subtract(a.min(h()), k.xAxisPadding());
          }),
          (k.xAxisMax = function () {
            return c.utils.add(a.max(i()), k.xAxisPadding());
          }),
      ...
      (c.geoChoroplethChart = function (b, d) {
        ...
        function o(a, b, c) {
          p.renderTitle() &&
            a.selectAll("title").text(function (a) {
              var d = l(b, a),
                e = c[d];
              return p.title()({ key: d, value: e });
            });
        }
        var p = c.colorChart(c.baseChart({}));
        p.colorAccessor(function (a, b) {
          return a;
        });
        var q,
          r = a.geo.path(),
        ...
        return (
          ...
          (p.onClick = function (a, b) {
            ...
            c.events.trigger(function () {
              p.filter(d), c.redrawAll(p.chartGroup());
            });
          }),
          (p.doRedraw = function () {
            for (var a = 0; a < s.length; ++a)
          ...
          (p.overlayGeoJson = function (a, b, c) {
            for (var d = 0; d < s.length; ++d)
              if (s[d].name == b)
                return (s[d].data = a), (s[d].keyAccessor = c), p;
            return s.push({ name: b, data: a, keyAccessor: c }), p;
          }),
      ...
      (c.bubbleOverlay = function (b, d) {
        ...
        function i() {
          ...
          o.forEach(function (b) {
            var d = h(b, a),
              e = d.select("circle." + m);
            c
              .transition(e, n.transitionDuration())
              .attr("r", function (a) {
                return n.bubbleR(a);
              })
        ...
        var j,
          ...
          l = "node",
          m = "bubble",
          n = c.abstractBubbleChart(c.baseChart({})),
          o = [];
        return (
          n.transitionDuration(750),
          n.radiusValueAccessor(function (a) {
            return a.value;
          }),
          (n.point = function (a, b, c) {
            return o.push({ name: a, x: b, y: c }), n;
          }),
          (n.doRender = function () {
            return (
              (j = e()),
              n
                .r()
                .range([n.MIN_RADIUS, n.width() * n.maxBubbleRelativeSize()]),
              f(),
            ...
            if (b) {
              ...
              d.empty() &&
                (d = n
                  .svg()
                  .append("g")
                  .attr("class", c.constants.DEBUG_GROUP_CLASS));
      ...
      (c.rowChart = function (b, d) {
          ...
          e(),
            a.empty() &&
              (a = q
                ...
                .attr(
                  "transform",
                  "translate(0, " + y.effectiveHeight() + ")"
                )),
            c.transition(a, y.transitionDuration()).call(z);
        }
        function g() {
        ...
        function i(a) {
          ...
          b.append("rect").attr("width", 0), m(b), n(a);
        }
        function j(a) {
          a.exit().remove();
        }
        function k(a) {
          ...
          c
            .transition(e, y.transitionDuration())
        ...
        function n(a) {
          if (y.renderLabel()) {
            ...
            c.transition(b, y.transitionDuration()).attr("transform", p);
          }
        }
        function o(a) {
          y.onClick(a);
        ...
        var q,
          ...
          w = 5,
          x = "row",
          y = c.capped(c.marginable(c.colorChart(c.baseChart({})))),
          z = a.svg.axis().orient("bottom");
        return (
          (y.rowsCap = y.cap),
          (y.doRender = function () {
            return (
              ...
              (q = y
                ...
                .attr(
                  "transform",
                  "translate(" + y.margins().left + "," + y.margins().top + ")"
                )),
              h(),
              y
            );
          ...
          (e.render = function () {
            ...
            e
              ...
              e
                ...
                .attr("y", function () {
                  return (
                    h / 2 + (this.clientHeight ? this.clientHeight : 13) / 2 - 2
                  );
                });
          }),
          (e.x = function (a) {
      ...
      (c.capped = function (b) {
        var d = 1 / 0,
          ...
          f = function (c) {
            ...
            c.push({ others: k, key: e, value: g - d });
          };
        return (
          (b.assembleCappedData = function () {
            if (d == 1 / 0) return b.computeOrderedGroups();
            var a = b.group().top(d);
            return (a = b.computeOrderedGroups(a)), f && f(a), a;
          }),
          (b.cap = function (a) {
            return arguments.length ? ((d = a), b) : d;
          }),
      ...
      (c.numberDisplay = function (b, d) {
        ...
        return (
          ...
          (g.doRender = function () {
            ...
            return (
              c.empty() &&
                (c = c.data([0]).enter().append("span").attr("class", e)),
              c
                .transition()
