...
!(function (a) {
  ...
  (function (a) {
    ...
    function b() {
      throw new Error(
        'You need to set the "key" attribute to your public reCaptcha key. If you don\'t have a key, please get one from https://www.google.com/recaptcha/admin/create'
      );
    }
    ...
    c.provider("vcRecaptchaService", function () {
      var c = this,
        d = {};
      (c.onLoadFunctionName = "vcRecaptchaApiLoaded"),
        ...
        (c.$get = [
          ...
          function (e, f, g) {
            ...
            var j,
              k = g.defer(),
              l = k.promise;
            f.vcRecaptchaApiLoadedCallback =
              f.vcRecaptchaApiLoadedCallback || [];
            var m = function () {
              (j = f.grecaptcha), k.resolve(j);
            };
            return (
              f.vcRecaptchaApiLoadedCallback.push(m),
              (f[c.onLoadFunctionName] = function () {
              ...
              a.isDefined(f.grecaptcha) && m(),
              {
                create: function (a, c) {
                  return (
                    (c.sitekey = c.key || d.key),
                    (c.theme = c.theme || d.theme),
                    (c.stoken = c.stoken || d.stoken),
                    (c.size = c.size || d.size),
                    (c.type = c.type || d.type),
                    (c.sitekey && 40 === c.sitekey.length) || b(),
                    h().then(function (b) {
                      return b.render(a, c);
                    })
                  );
      ...
      function (b, c, d) {
        return {
          ...
          link: function (e, f, g, h) {
            ...
            function j() {
              c(function () {
                (e.response = ""), k(), e.onExpire({ widgetId: e.widgetId });
              });
            }
            function k() {
              h &&
                h.$setValidity(
                  "recaptcha",
                  e.required === !1 ? null : Boolean(e.response)
                );
            }
            function l() {
              a.element(b[0].querySelectorAll(".pls-container"))
                .parent()
                .remove();
            }
            (e.widgetId = null),
              h && a.isDefined(g.required) && e.$watch("required", k);
            var m = e.$watch("key", function (b) {
              var h = function (a) {
                c(function () {
                  (e.response = a),
                    k(),
                    e.onSuccess({ response: a, widgetId: e.widgetId });
                });
              };
              d
                .create(f[0], {
                ...
                .then(function (b) {
                  k(),
                    (e.widgetId = b),
                    e.onCreate({ widgetId: b }),
                    e.$on("$destroy", i),
                    e.$on("reCaptchaReset", function (c, d) {
